...
public class PostAuthLog implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -791226471211224505L;
  ...
  * @param lastUpdate 異動日期
  ...
  public String toString() {
    return "PostAuthLog [postAuthLogId=" + postAuthLogId
           ...
           + ", amlRsp=" + amlRsp + ", createEmpNo=" + createEmpNo + ", createDate=" + createDate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + ", lastUpdate=" + lastUpdate + "]";
  }
}
