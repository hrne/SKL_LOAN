...
public class TxTellerServiceImpl extends ASpringJpaParm implements TxTellerService, InitializingBean {
	...
	public Slice<TxTeller> findByGroupNo(String brNo_0, String groupNo_1, String groupNo_2, int levelFg_3, int levelFg_4, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = txTellerReposDay.findAllByBrNoIsAndGroupNoGreaterThanEqualAndGroupNoLessThanEqualAndLevelFgGreaterThanEqualAndLevelFgLessThanEqualOrderByTlrNoAsc(brNo_0, groupNo_1, groupNo_2,
					levelFg_3, levelFg_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txTellerReposMon.findAllByBrNoIsAndGroupNoGreaterThanEqualAndGroupNoLessThanEqualAndLevelFgGreaterThanEqualAndLevelFgLessThanEqualOrderByTlrNoAsc(brNo_0, groupNo_1, groupNo_2,
					levelFg_3, levelFg_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txTellerReposHist.findAllByBrNoIsAndGroupNoGreaterThanEqualAndGroupNoLessThanEqualAndLevelFgGreaterThanEqualAndLevelFgLessThanEqualOrderByTlrNoAsc(brNo_0, groupNo_1, groupNo_2,
					levelFg_3, levelFg_4, pageable);
		else
			slice = txTellerRepos.findAllByBrNoIsAndGroupNoGreaterThanEqualAndGroupNoLessThanEqualAndLevelFgGreaterThanEqualAndLevelFgLessThanEqualOrderByTlrNoAsc(brNo_0, groupNo_1, groupNo_2,
					levelFg_3, levelFg_4, pageable);
