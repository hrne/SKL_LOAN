...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "LoanIntDetail [loanIntDetailId=" + loanIntDetailId
           + ", intStartDate=" + intStartDate + ", intEndDate=" + intEndDate + ", intDays=" + intDays + ", breachDays=" + breachDays + ", monthLimit=" + monthLimit
           + ", intFlag=" + intFlag + ", currencyCode=" + currencyCode + ", amount=" + amount + ", intRate=" + intRate + ", principal=" + principal + ", interest=" + interest
           + ", delayInt=" + delayInt + ", breachAmt=" + breachAmt + ", closeBreachAmt=" + closeBreachAmt + ", breachGetCode=" + breachGetCode + ", loanBal=" + loanBal + ", extraRepayFlag=" + extraRepayFlag
           + ", prodNo=" + prodNo + ", baseRateCode=" + baseRateCode + ", rateIncr=" + rateIncr + ", individualIncr=" + individualIncr + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
