...
@EmbeddedId
  ...
  // 負債主因
  /* 11:投資或創業失敗12:因消費而積欠債務13:遭逢重大傷病或災變14:個人與家庭收入減少(含失業、減薪)15:收入穩定但支付超過能力可負擔之費用、如昂貴教育、補習費或購置汽車、不動產16:收入穩定但因自宅貸款月付金提高，導致無法負荷17:被詐騙集團詐騙18:為他人作保證或遭他人倒帳 */
...
13:遭逢重大傷病或災變
14:個人與家庭收入減少(含失業、減薪)
15:收入穩定但支付超過能力可負擔之費用、如昂貴教育、補習費或購置汽車、不動產
16:收入穩定但因自宅貸款月付金提高，導致無法負荷
17:被詐騙集團詐騙
18:為他人作保證或遭他人倒帳
	* @return String
	*/
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicZ044Log [jcicZ044LogId=" + jcicZ044LogId + ", tranKey=" + tranKey + ", debtCode=" + debtCode + ", nonGageAmt=" + nonGageAmt + ", period=" + period
           + ", rate=" + rate + ", monthPayAmt=" + monthPayAmt + ", receYearIncome=" + receYearIncome + ", receYear=" + receYear + ", receYear2Income=" + receYear2Income + ", receYear2=" + receYear2
           ...
           + ", landCnt=" + landCnt + ", childCnt=" + childCnt + ", childRate=" + childRate + ", parentCnt=" + parentCnt + ", parentRate=" + parentRate + ", mouthCnt=" + mouthCnt
           + ", mouthRate=" + mouthRate + ", gradeType=" + gradeType + ", payLastAmt=" + payLastAmt + ", period2=" + period2 + ", rate2=" + rate2 + ", monthPayAmt2=" + monthPayAmt2
           + ", payLastAmt2=" + payLastAmt2 + ", outJcicTxtDate=" + outJcicTxtDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
           + "]";
  }
}
