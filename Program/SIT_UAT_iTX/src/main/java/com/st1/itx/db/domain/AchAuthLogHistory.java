...
public class AchAuthLogHistory implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5271210749861814284L;
...
// 序號
	...
	// 授權狀態
	/*
	 * CdCode:AuthStatus空白-未授權0-成功授權/取消授權1-印鑑不符2-無此帳號3-委繳戶統一編號不符4-已核印成功在案5-原交易不存在6-
	 * 電子資料與授權書內容不符7-帳戶已結清8-印鑑不清9-其他A-未收到授權書B-用戶號碼錯誤C-靜止戶D-未收到聲明書E-授權書資料不全F-警示戶G-
	 * 本帳戶不適用授權扣繳H-已於他行授權扣款I-該用戶已死亡Z-未交易或匯入失敗資料
	 */
	...
	/**
	 * 授權狀態<br>
	 * CdCode:AuthStatus 空白-未授權 0-成功授權/取消授權 1-印鑑不符 2-無此帳號 3-委繳戶統一編號不符 4-已核印成功在案
	 * 5-原交易不存在 6-電子資料與授權書內容不符 7-帳戶已結清 8-印鑑不清 9-其他 A-未收到授權書 B-用戶號碼錯誤 C-靜止戶 D-未收到聲明書
	 * E-授權書資料不全 F-警示戶 G-本帳戶不適用授權扣繳 H-已於他行授權扣款 I-該用戶已死亡 Z-未交易或匯入失敗資料
	 * 
	 * @return String
	 */
	...
	/**
	 * 授權方式<br>
	 * CdCode:AchAuthCode A:紙本新增 O:舊檔轉換
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "AchAuthLogHistory [logNo=" + logNo + ", custNo=" + custNo + ", facmNo=" + facmNo + ", authCreateDate=" + authCreateDate + ", repayBank=" + repayBank + ", repayAcct=" + repayAcct
				+ ", createFlag=" + createFlag + ", processDate=" + processDate + ", stampFinishDate=" + stampFinishDate + ", authStatus=" + authStatus + ", authMeth=" + authMeth + ", limitAmt="
				+ limitAmt + ", mediaCode=" + mediaCode + ", batchNo=" + batchNo + ", propDate=" + propDate + ", retrDate=" + retrDate + ", deleteDate=" + deleteDate + ", relationCode=" + relationCode
