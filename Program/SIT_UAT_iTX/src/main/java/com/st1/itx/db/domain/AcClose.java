...
/**
	* 上傳核心序號<br>
	* 只更新特定筆(09:放款)
預設為000，產生上傳媒體(02:支票繳款，09:放款)關帳時＋１
	* @return Integer
	*/
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "AcClose [acCloseId=" + acCloseId + ", clsFg=" + clsFg + ", batNo=" + batNo + ", clsNo=" + clsNo
           + ", slipNo=" + slipNo + ", coreSeqNo=" + coreSeqNo + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
           + "]";
  }
}
