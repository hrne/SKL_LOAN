...
// 序號
	...
	// 介紹單位件數累計計算金額
	/*
	 * 同一額度、同一撥款工作月、同一計件代碼，累計計算金額追回未繳足3期期款即結清（含部分還款達60萬之案件)同案件新貸件(代碼2&amp;B)於6個月內撥款，
	 * 連同(代碼1&amp;A)計算
	 */
	...
	// 房貸專員件數累計計算金額
	/*
	 * 同一額度、同一撥款工作月、同一計件代碼，累計計算金額追回未逾一個月即結清(含部分還款達60萬元)同案件新貸件(代碼2&amp;B)於6個月內撥款，連同(
	 * 代碼1&amp;A)計算
	 */
	...
	/**
	 * 業績日期<br>
	 * 業績日期=系統營業日 1.撥貸(計件代碼變更)，為撥款日期 2.部分償還、提前結案，為會計日
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 介紹單位件數累計計算金額<br>
	 * 同一額度、同一撥款工作月、同一計件代碼，累計計算金額 追回未繳足3期期款即結清（含部分還款達60萬之案件)
	 * 同案件新貸件(代碼2&amp;B)於6個月內撥款，連同(代碼1&amp;A)計算
	 * 
	 * @return BigDecimal
	 */
	...
	/**
	 * 介紹單位件數<br>
	 * 0,無計件 1.有計件 寫入介紹人業績明細檔時，代碼(2&amp;B)之是否計件寫入(代碼1&amp;A)
	 * 
	 * @return BigDecimal
	 */
	...
	/**
	 * 介紹人介紹獎金<br>
	 * 依累計金額計算，扣除已計 追回撥款後計息期間未逾一個月即結清(含部分還款達60萬元)案件
	 * 
	 * @return BigDecimal
	 */
	...
	/**
	 * 協辦人員協辦獎金<br>
	 * 依協辦人員協辦獎金計算金額計算，扣除已計 追回撥款後計息期間未逾一個月即結清(含部分還款達60萬元)案件
	 * 
	 * @return BigDecimal
	 */
	...
	/**
	 * 房貸專員件數累計計算金額<br>
	 * 同一額度、同一撥款工作月、同一計件代碼，累計計算金額 追回未逾一個月即結清(含部分還款達60萬元)
	 * 同案件新貸件(代碼2&amp;B)於6個月內撥款，連同(代碼1&amp;A)計算
	 * 
	 * @return BigDecimal
	 */
	...
	public String toString() {
		return "PfDetail [logNo=" + logNo + ", perfDate=" + perfDate + ", custNo=" + custNo + ", facmNo=" + facmNo + ", bormNo=" + bormNo + ", borxNo=" + borxNo + ", repayType=" + repayType
				+ ", drawdownDate=" + drawdownDate + ", drawdownAmt=" + drawdownAmt + ", pieceCode=" + pieceCode + ", repaidPeriod=" + repaidPeriod + ", prodCode=" + prodCode + ", creditSysNo="
				+ creditSysNo + ", introducer=" + introducer + ", coorgnizer=" + coorgnizer + ", interviewerA=" + interviewerA + ", interviewerB=" + interviewerB + ", isReNewEmpUnit=" + isReNewEmpUnit
				...
				+ ", computeItAmtFac=" + computeItAmtFac + ", itPerfCnt=" + itPerfCnt + ", computeItAmt=" + computeItAmt + ", itPerfAmt=" + itPerfAmt + ", itPerfEqAmt=" + itPerfEqAmt
				+ ", itPerfReward=" + itPerfReward + ", computeItBonusAmt=" + computeItBonusAmt + ", itBonus=" + itBonus + ", computeAddBonusAmt=" + computeAddBonusAmt + ", itAddBonus=" + itAddBonus
				+ ", computeCoBonusAmt=" + computeCoBonusAmt + ", coorgnizerBonus=" + coorgnizerBonus + ", bsOfficer=" + bsOfficer + ", bsDeptCode=" + bsDeptCode + ", computeBsAmtFac="
				+ computeBsAmtFac + ", bsPerfCnt=" + bsPerfCnt + ", computeBsAmt=" + computeBsAmt + ", bsPerfAmt=" + bsPerfAmt + ", workMonth=" + workMonth + ", workSeason=" + workSeason
				+ ", pieceCodeCombine=" + pieceCodeCombine + ", isProdFinancial=" + isProdFinancial + ", isIntroducerDay15=" + isIntroducerDay15 + ", isCoorgnizerDay15=" + isCoorgnizerDay15
				+ ", isProdExclude1=" + isProdExclude1 + ", isProdExclude2=" + isProdExclude2 + ", isProdExclude3=" + isProdExclude3 + ", isProdExclude4=" + isProdExclude4 + ", isProdExclude5="
				+ isProdExclude5 + ", isDeptExclude1=" + isDeptExclude1 + ", isDeptExclude2=" + isDeptExclude2 + ", isDeptExclude3=" + isDeptExclude3 + ", isDeptExclude4=" + isDeptExclude4
				+ ", isDeptExclude5=" + isDeptExclude5 + ", isDay15Exclude1=" + isDay15Exclude1 + ", isDay15Exclude2=" + isDay15Exclude2 + ", isDay15Exclude3=" + isDay15Exclude3 + ", isDay15Exclude4="
				+ isDay15Exclude4 + ", isDay15Exclude5=" + isDay15Exclude5 + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo="
				+ lastUpdateEmpNo + "]";
	}
}
