...
@Service("L7Ias34ApUpd")
@Scope("step")
/**
 * (每月日終批次)維護 Ias34Ap 每月IAS34資料欄位清單A檔
 *
 * @author Chih Wei
 * @version 1.0.0
 */
public class L7Ias34ApUpd extends BatchBase implements Tasklet, InitializingBean {
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		// logger = LoggerFactory.getLogger(L7Ias34ApUpd.class);
...
//		this.titaVo.putParam(ContentName.dataBase, ContentName.onLine);
		...
		sJobMainService.Usp_L7_Ias34Ap_Upd(tbsdyf, empNo, newAcFg);
	}
