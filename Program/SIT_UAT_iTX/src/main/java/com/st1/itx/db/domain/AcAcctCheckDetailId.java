...
/**
  ...
  * @param acSubBookCode 區隔帳冊
  ...
  public boolean equals(Object obj) {
    ...
    return acDate == acAcctCheckDetailId.acDate && branchNo.equals(acAcctCheckDetailId.branchNo) && currencyCode.equals(acAcctCheckDetailId.currencyCode) && acctCode.equals(acAcctCheckDetailId.acctCode) && custNo == acAcctCheckDetailId.custNo && facmNo == acAcctCheckDetailId.facmNo && bormNo == acAcctCheckDetailId.bormNo && acSubBookCode.equals(acAcctCheckDetailId.acSubBookCode);
  }

  @Override
  public String toString() {
    return "AcAcctCheckDetailId [acDate=" + acDate + ", branchNo=" + branchNo + ", currencyCode=" + currencyCode + ", acctCode=" + acctCode + ", custNo=" + custNo + ", facmNo=" + facmNo + ", bormNo=" + bormNo + ", acSubBookCode=" + acSubBookCode + "]";
  }
}
