...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "CollLetter [collLetterId=" + collLetterId
           + ", mailTypeCode=" + mailTypeCode + ", mailDate=" + mailDate + ", mailObj=" + mailObj + ", custName=" + custName + ", delvrYet=" + delvrYet + ", delvrCode=" + delvrCode
           + ", addressCode=" + addressCode + ", address=" + address + ", remark=" + remark + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
