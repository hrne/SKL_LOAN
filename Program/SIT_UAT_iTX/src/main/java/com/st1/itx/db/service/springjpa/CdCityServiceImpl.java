...
@Repository
public class CdCityServiceImpl implements CdCityService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(CdCityServiceImpl.class);
  ...
  public CdCity findById(String cityCode, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + cityCode);
...
em = null;
  ...
  public Slice<CdCity> findCityCode(String cityCode_0, String cityCode_1, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("findCityCode " + dbName + " : " + "cityCode_0 : " + cityCode_0 + " cityCode_1 : " +  cityCode_1);
    if (dbName.equals(ContentName.onDay))
  ...
  public CdCity holdById(String cityCode, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + cityCode);
    Optional<CdCity> cdCity = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public CdCity holdById(CdCity cdCity, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + cdCity.getCityCode());
  ...
  public CdCity insert(CdCity cdCity, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + cdCity.getCityCode());
  ...
  public CdCity update(CdCity cdCity, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + cdCity.getCityCode());
    if (!empNot.isEmpty())
      cdCity.setLastUpdateEmpNo(empNot);
  ...
  public void delete(CdCity cdCity, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + cdCity.getCityCode());
    if (dbName.equals(ContentName.onDay)) {
