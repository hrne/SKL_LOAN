 ...
 * @version 1.0.0
 */
public interface AchAuthLogHistoryRepositoryMon extends JpaRepository<AchAuthLogHistory, AchAuthLogHistoryId> {
  ...
  // AuthCreateDate = ,AND CustNo = ,AND RepayBank = ,AND RepayAcct = ,AND CreateFlag = 
  public Optional<AchAuthLogHistory> findTopByAuthCreateDateIsAndCustNoIsAndRepayBankIsAndRepayAcctIsAndCreateFlagIsOrderByDetailSeqDesc(int authCreateDate_0, int custNo_1, String repayBank_2, String repayAcct_3, String createFlag_4);
