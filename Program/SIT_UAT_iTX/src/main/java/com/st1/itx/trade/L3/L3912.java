...
//		C(5,#OTxCode,L3440,E(0,@RPTFG,12),$)
		if (tLoanBorTx.getTitaTxCd().equals("L3100")) {
			...
			RPTFG = 5;
		} else if (tLoanBorTx.getTitaTxCd().equals("L3600")) {
			RPTFG = 6;
		} else if (tLoanBorTx.getTitaTxCd().equals("L3610")) {
			RPTFG = 7;
		...
		if (tLoanBorTx.getDisplayflag().equals("I"))
			RPTFG = 10;
		...
		this.totaVo.putParam("OTxTypeCode", tLoanBorTx.getTxTypeCode());
