...
public class CdGseq implements Serializable {
	...
	/**
	 * 交易種類<br>
	 * 業務自行編制 例: GseqType="L2" 0001:戶號 0002:案件申請編號
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "CdGseq [cdGseqId=" + cdGseqId + ", offset=" + offset + ", seqNo=" + seqNo + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
