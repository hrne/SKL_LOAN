...
@Service("L3010")
@Scope("prototype")
public class L3010 extends TradeBuffer {
	private static final Logger logger = LoggerFactory.getLogger(L3010.class);
	/* DB服務注入 */
	@Autowired
...
//		}
		...
		slLoanSynd = loanSyndService.syndCustNoRange(wkCustNoStart, wkCustNoEnd, iLeadingBank,
				...
				iDrawdownEndDateStart + 19110000, iDrawdownEndDateEnd > 0 ? iDrawdownEndDateEnd + 19110000 : 99991231, this.index, this.limit, titaVo);
