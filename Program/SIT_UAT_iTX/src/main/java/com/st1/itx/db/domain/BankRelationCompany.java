...
@Table(name = "`BankRelationCompany`")
public class BankRelationCompany implements Serializable {


  /**
	 * 
	 */
	private static final long serialVersionUID = 6197477317254345157L;

@EmbeddedId
  private BankRelationCompanyId bankRelationCompanyId;
  ...
  // 關係企業統編
  @Column(name = "`CompanyId`", length = 11, insertable = false, updatable = false)
  ...
  public BankRelationCompanyId getBankRelationCompanyId() {
    return this.bankRelationCompanyId;
  }

  public void setBankRelationCompanyId(BankRelationCompanyId bankRelationCompanyId) {
    this.bankRelationCompanyId = bankRelationCompanyId;
  }
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "BankRelationCompany [bankRelationCompanyId=" + bankRelationCompanyId + ", lAW001=" + lAW001 + ", lAW002=" + lAW002 + ", lAW003=" + lAW003
           + ", lAW005=" + lAW005 + ", lAW008=" + lAW008 + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
           + "]";
  }
}
