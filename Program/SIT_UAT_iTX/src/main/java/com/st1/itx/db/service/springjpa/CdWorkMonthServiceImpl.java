...
@Repository
public class CdWorkMonthServiceImpl implements CdWorkMonthService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(CdWorkMonthServiceImpl.class);
  ...
  public CdWorkMonth findById(CdWorkMonthId cdWorkMonthId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + cdWorkMonthId);
...
em = null;
  ...
  public Slice<CdWorkMonth> findYearMonth(int year_0, int year_1, int month_2, int month_3, int index, int limit, TitaVo... titaVo) {
    ...
    logger.info("findYearMonth " + dbName + " : " + "year_0 : " + year_0 + " year_1 : " +  year_1 + " month_2 : " +  month_2 + " month_3 : " +  month_3);
    if (dbName.equals(ContentName.onDay))
      slice = cdWorkMonthReposDay.findAllByYearGreaterThanEqualAndYearLessThanEqualAndMonthGreaterThanEqualAndMonthLessThanEqualOrderByYearAscMonthAsc(year_0, year_1, month_2, month_3, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = cdWorkMonthReposMon.findAllByYearGreaterThanEqualAndYearLessThanEqualAndMonthGreaterThanEqualAndMonthLessThanEqualOrderByYearAscMonthAsc(year_0, year_1, month_2, month_3, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = cdWorkMonthReposHist.findAllByYearGreaterThanEqualAndYearLessThanEqualAndMonthGreaterThanEqualAndMonthLessThanEqualOrderByYearAscMonthAsc(year_0, year_1, month_2, month_3, pageable);
    else 
  ...
  public CdWorkMonth findDateFirst(int startDate_0, int endDate_1, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("findDateFirst " + dbName + " : " + "startDate_0 : " + startDate_0 + " endDate_1 : " +  endDate_1);
  ...
  public CdWorkMonth holdById(CdWorkMonthId cdWorkMonthId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + cdWorkMonthId);
    Optional<CdWorkMonth> cdWorkMonth = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public CdWorkMonth holdById(CdWorkMonth cdWorkMonth, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + cdWorkMonth.getCdWorkMonthId());
    Optional<CdWorkMonth> cdWorkMonthT = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public CdWorkMonth insert(CdWorkMonth cdWorkMonth, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + cdWorkMonth.getCdWorkMonthId());
  ...
  public CdWorkMonth update(CdWorkMonth cdWorkMonth, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + cdWorkMonth.getCdWorkMonthId());
    if (!empNot.isEmpty())
      cdWorkMonth.setLastUpdateEmpNo(empNot);
  ...
  public void delete(CdWorkMonth cdWorkMonth, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + cdWorkMonth.getCdWorkMonthId());
    if (dbName.equals(ContentName.onDay)) {
