...
public class ClBuildingPublic implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5656126996322607401L;
	...
	// 公設資料序號
	/* 公設資料流水號 */
	@Column(name = "`PublicSeq`", insertable = false, updatable = false)
	...
	public String toString() {
		return "ClBuildingPublic [clBuildingPublicId=" + clBuildingPublicId + ", publicBdNo1=" + publicBdNo1 + ", publicBdNo2=" + publicBdNo2 + ", area=" + area + ", ownerId=" + ownerId
				+ ", ownerName=" + ownerName + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
