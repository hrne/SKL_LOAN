 ...
 * @version 1.0.0
 */
public interface PfRewardRepositoryMon extends JpaRepository<PfReward, Long> {
	...
	public Slice<PfReward> findAllByWorkMonthGreaterThanEqualAndWorkMonthLessThanEqualOrderByCustNoAscFacmNoAscBormNoAsc(int workMonth_0, int workMonth_1, Pageable pageable);

	// Introducer= , AND WorkMonth>= , AND WorkMonth<=
	public Slice<PfReward> findAllByIntroducerIsAndWorkMonthGreaterThanEqualAndWorkMonthLessThanEqualOrderByCustNoAscFacmNoAscBormNoAsc(String introducer_0, int workMonth_1, int workMonth_2,
			Pageable pageable);
	...
	// PieceCode =
	public Optional<PfReward> findTopByCustNoIsAndFacmNoIsAndBormNoIsAndPerfDateIsAndRepayTypeIsAndPieceCodeIs(int custNo_0, int facmNo_1, int bormNo_2, int perfDate_3, int repayType_4,
			String pieceCode_5);
