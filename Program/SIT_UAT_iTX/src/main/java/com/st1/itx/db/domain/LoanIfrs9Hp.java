...
@Table(name = "`LoanIfrs9Hp`")
public class LoanIfrs9Hp implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4103135831133817352L;

	@EmbeddedId
	private LoanIfrs9HpId loanIfrs9HpId;
	...
	// 違約損失率模型
	/*
	 * 1=土地2=房地-台北市3=房地-新北市4=房地-桃園市5=房地-台中市6=房地-台南市7=房地-高雄市8=房地-其他(基隆市、新竹縣、新竹市、苗栗縣、
	 * 彰化縣、南投縣、雲林縣、嘉義縣、嘉義市、屏東縣、宜蘭縣、花蓮縣、臺東縣、金門縣、澎湖縣、連江縣、南海島、釣魚臺9=股票10=機器設備11=車子12=
	 * 銀行保證
	 */
	...
	public LoanIfrs9HpId getLoanIfrs9HpId() {
		return this.loanIfrs9HpId;
	}

	public void setLoanIfrs9HpId(LoanIfrs9HpId loanIfrs9HpId) {
		this.loanIfrs9HpId = loanIfrs9HpId;
	}
	...
	/**
	 * 違約損失率模型<br>
	 * 1=土地 2=房地-台北市 3=房地-新北市 4=房地-桃園市 5=房地-台中市 6=房地-台南市 7=房地-高雄市
	 * 8=房地-其他(基隆市、新竹縣、新竹市、苗栗縣、彰化縣、南投縣、雲林縣、嘉義縣、嘉義市、屏東縣、宜蘭縣、花蓮縣、臺東縣、金門縣、澎湖縣、連江縣、南海島、釣魚臺
	 * 9=股票 10=機器設備 11=車子 12=銀行保證
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "LoanIfrs9Hp [loanIfrs9HpId=" + loanIfrs9HpId + ", custId=" + custId + ", applNo=" + applNo + ", custKind=" + custKind + ", approveDate=" + approveDate + ", firstDrawdownDate="
				+ firstDrawdownDate + ", lineAmt=" + lineAmt + ", ifrs9ProdCode=" + ifrs9ProdCode + ", avblBal=" + avblBal + ", recycleCode=" + recycleCode + ", irrevocableFlag=" + irrevocableFlag
				+ ", industryCode=" + industryCode + ", oriRating=" + oriRating + ", oriModel=" + oriModel + ", rating=" + rating + ", model=" + model + ", lGDModel=" + lGDModel + ", lGD=" + lGD
				+ ", lineAmtCurr=" + lineAmtCurr + ", avblBalCurr=" + avblBalCurr + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo="
				+ lastUpdateEmpNo + "]";
	}
}
