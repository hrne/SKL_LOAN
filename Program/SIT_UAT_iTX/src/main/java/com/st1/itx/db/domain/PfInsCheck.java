...
public class PfInsCheck implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5592652646206705771L;
	...
	/**
	 * 類別<br>
	 * 0.換算業績、業務報酬 1.介紹獎金、協辦獎金 2.介紹人加碼獎勵津貼
	 * 
	 * @return Integer
	 */
	public int getKind() {
	...
	public String toString() {
		return "PfInsCheck [pfInsCheckId=" + pfInsCheckId + ", creditSysNo=" + creditSysNo + ", custId=" + custId + ", applDate=" + applDate + ", insDate=" + insDate + ", insNo=" + insNo
				+ ", checkResult=" + checkResult + ", checkWorkMonth=" + checkWorkMonth + ", returnMsg=" + returnMsg + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate="
