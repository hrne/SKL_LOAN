...
@Table(name = "`BankRelationFamily`")
public class BankRelationFamily implements Serializable {


  /**
	 * 
	 */
	private static final long serialVersionUID = -2677462524015658260L;

@EmbeddedId
  private BankRelationFamilyId bankRelationFamilyId;
  ...
  // 親屬統編
  @Column(name = "`RelationId`", length = 11, insertable = false, updatable = false)
  ...
  public BankRelationFamilyId getBankRelationFamilyId() {
    return this.bankRelationFamilyId;
  }

  public void setBankRelationFamilyId(BankRelationFamilyId bankRelationFamilyId) {
    this.bankRelationFamilyId = bankRelationFamilyId;
  }
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "BankRelationFamily [bankRelationFamilyId=" + bankRelationFamilyId + ", lAW001=" + lAW001 + ", lAW002=" + lAW002 + ", lAW003=" + lAW003
