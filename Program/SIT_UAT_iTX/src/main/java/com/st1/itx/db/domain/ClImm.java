...
@EmbeddedId
  ...
  // 最高抵押權確定事由
  /* 共用代碼檔1.擔保品遭查封(民事執行處)2.擔保品遭查封(行政執行處)3.本公司申請裁定拍賣抵押物4.擔保品經本公司聲請強制執行5.擔保品之查封經撤銷(民事執行處)6.擔保品之查封經撤銷(行政執行處) */
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "ClImm [clImmId=" + clImmId + ", evaNetWorth=" + evaNetWorth + ", lVITax=" + lVITax + ", rentEvaValue=" + rentEvaValue
           + ", rentPrice=" + rentPrice + ", ownershipCode=" + ownershipCode + ", mtgCode=" + mtgCode + ", mtgCheck=" + mtgCheck + ", mtgLoan=" + mtgLoan + ", mtgPledge=" + mtgPledge
