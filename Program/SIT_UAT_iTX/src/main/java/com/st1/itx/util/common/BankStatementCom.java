 ...
 * @version 1.0.0
 */
@Component("bankStatementCom")
@Scope("prototype")
public class BankStatementCom extends MakeReport {

	@Autowired
	BankStatementServiceImpl bankStatementServiceImpl;

	@Autowired
	BatxRateChangeService batxRateChangeService;
	...
	public void printHeader() {
		...
		this.info("BankStatementCom.printHeader");
	...
	/**
	 * titaVo需有戶號CustNo及額度FacmNo及利率調整日期AdjDate
	 * 
	 * @param titaVo   TitaVo
...
//		客戶檔 0:個金1:企金2:企金自然人
		...
		sBatxRateChange = batxRateChangeService.findL4321Report(adjDate, adjDate, custType1, custType2, txKind, 1, this.index, this.limit, titaVo);
...
//	暫時紀錄戶號額度
	private class tmpFacm {
		...
		private BankStatementCom getEnclosingInstance() {
			return BankStatementCom.this;
		}
	}
}
