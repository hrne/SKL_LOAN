...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicB204 [jcicB204Id=" + jcicB204Id
           + ", lineAmt=" + lineAmt + ", drawdownAmt=" + drawdownAmt + ", dBR22Amt=" + dBR22Amt
           + ", filler13=" + filler13 + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
           + "]";
  }
}
