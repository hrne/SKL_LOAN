...
@Component("L5061TelReport")
@Scope("prototype")

public class L5061TelReport extends MakeReport{
	private static final Logger logger = LoggerFactory.getLogger(L5061TelReport.class);
	...
	public long exec(TitaVo titaVo) throws LogicException{
		...
		this.info("L5061TelReport start success");
		...
		header.addAll(Arrays.asList("戶號","額度","戶名","戶況","放款餘額","繳息迄日","逾期數","電催日期","電催時間","通話結果","催收人員","法務人員"));
		
		List<Map<String, String>> c5061SqlReturn = new ArrayList<Map<String, String>>();
		
		String fileName = "催收催繳明細表_"+sDateS+"_"+sdateE+"(逾期件電催查詢)";
