...
@Repository
public class BatxChequeServiceImpl implements BatxChequeService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(BatxChequeServiceImpl.class);
  ...
  public BatxCheque findById(BatxChequeId batxChequeId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + batxChequeId);
...
em = null;
  ...
  public BatxCheque holdById(BatxChequeId batxChequeId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + batxChequeId);
    Optional<BatxCheque> batxCheque = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public BatxCheque holdById(BatxCheque batxCheque, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + batxCheque.getBatxChequeId());
  ...
  public BatxCheque insert(BatxCheque batxCheque, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + batxCheque.getBatxChequeId());
  ...
  public BatxCheque update(BatxCheque batxCheque, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + batxCheque.getBatxChequeId());
    if (!empNot.isEmpty())
      batxCheque.setLastUpdateEmpNo(empNot);
  ...
  public void delete(BatxCheque batxCheque, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + batxCheque.getBatxChequeId());
    if (dbName.equals(ContentName.onDay)) {
