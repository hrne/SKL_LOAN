...
public class LoanBook implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8894334885880119515L;
	...
	public String toString() {
		return "LoanBook [loanBookId=" + loanBookId + ", actualDate=" + actualDate + ", status=" + status + ", currencyCode=" + currencyCode + ", includeIntFlag=" + includeIntFlag + ", unpaidIntFlag="
				+ unpaidIntFlag + ", bookAmt=" + bookAmt + ", repayAmt=" + repayAmt + ", payMethod=" + payMethod + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate="
