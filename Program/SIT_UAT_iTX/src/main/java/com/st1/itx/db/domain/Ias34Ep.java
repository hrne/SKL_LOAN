...
public class Ias34Ep implements Serializable {
	...
	public String toString() {
		return "Ias34Ep [ias34EpId=" + ias34EpId + ", custId=" + custId + ", industryCode=" + industryCode + ", clTypeJCIC=" + clTypeJCIC + ", zip3=" + zip3 + ", prodNo=" + prodNo + ", custKind="
				+ custKind + ", derFg=" + derFg + ", ifrs9ProdCode=" + ifrs9ProdCode + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
