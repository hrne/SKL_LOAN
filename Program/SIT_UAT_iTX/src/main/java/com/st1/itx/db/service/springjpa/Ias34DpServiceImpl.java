...
@Repository
public class Ias34DpServiceImpl implements Ias34DpService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(Ias34DpServiceImpl.class);
  ...
  public Ias34Dp findById(Ias34DpId ias34DpId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + ias34DpId);
...
em = null;
  ...
  public Ias34Dp holdById(Ias34DpId ias34DpId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + ias34DpId);
    Optional<Ias34Dp> ias34Dp = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public Ias34Dp holdById(Ias34Dp ias34Dp, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + ias34Dp.getIas34DpId());
  ...
  public Ias34Dp insert(Ias34Dp ias34Dp, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + ias34Dp.getIas34DpId());
  ...
  public Ias34Dp update(Ias34Dp ias34Dp, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + ias34Dp.getIas34DpId());
    if (!empNot.isEmpty())
      ias34Dp.setLastUpdateEmpNo(empNot);
  ...
  public void delete(Ias34Dp ias34Dp, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + ias34Dp.getIas34DpId());
    if (dbName.equals(ContentName.onDay)) {
