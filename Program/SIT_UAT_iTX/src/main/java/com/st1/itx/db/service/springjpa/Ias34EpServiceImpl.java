...
@Repository
public class Ias34EpServiceImpl implements Ias34EpService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(Ias34EpServiceImpl.class);
  ...
  public Ias34Ep findById(Ias34EpId ias34EpId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + ias34EpId);
...
em = null;
  ...
  public Ias34Ep holdById(Ias34EpId ias34EpId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + ias34EpId);
    Optional<Ias34Ep> ias34Ep = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public Ias34Ep holdById(Ias34Ep ias34Ep, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + ias34Ep.getIas34EpId());
  ...
  public Ias34Ep insert(Ias34Ep ias34Ep, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + ias34Ep.getIas34EpId());
  ...
  public Ias34Ep update(Ias34Ep ias34Ep, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + ias34Ep.getIas34EpId());
    if (!empNot.isEmpty())
      ias34Ep.setLastUpdateEmpNo(empNot);
  ...
  public void delete(Ias34Ep ias34Ep, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + ias34Ep.getIas34EpId());
    if (dbName.equals(ContentName.onDay)) {
