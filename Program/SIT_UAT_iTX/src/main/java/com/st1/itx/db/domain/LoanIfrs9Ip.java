...
public class LoanIfrs9Ip implements Serializable {
	...
	public String toString() {
		return "LoanIfrs9Ip [loanIfrs9IpId=" + loanIfrs9IpId + ", custId=" + custId + ", applNo=" + applNo + ", drawdownFg=" + drawdownFg + ", approveDate=" + approveDate + ", firstDrawdownDate="
				...
				+ cityCode + ", prodNo=" + prodNo + ", custKind=" + custKind + ", ifrs9ProdCode=" + ifrs9ProdCode + ", evaAmt=" + evaAmt + ", avblBal=" + avblBal + ", recycleCode=" + recycleCode
