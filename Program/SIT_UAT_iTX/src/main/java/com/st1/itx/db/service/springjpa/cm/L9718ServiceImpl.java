...
public class L9718ServiceImpl extends ASpringJpaParm implements InitializingBean {
	...
	public List<Map<String, String>> findAll(TitaVo titaVo, ReportType reportType) throws Exception {
		...
		case Acct990:
			...
			sql += "  ,TO_NUMBER(SUBSTR(\"Fn_GetLastMonth\"(:inputYearMonth), 5, 2))+1 AS \"RocMonth\" ";
			...
			sql += "  WHERE M.\"YearMonth\" = \"Fn_GetLastMonth\"(:inputYearMonth) ";
		...
		case AcctOthers:
			sql += " SELECT ";
			sql += "   EMP.\"Fullname\" AS \"EmpName\" ";
			sql += "  ,TO_NUMBER(SUBSTR(\"Fn_GetLastMonth\"(:inputYearMonth), 5 ,2)) AS \"RocMonth\" ";
			sql += "  ,:inputEntryDateMin - 19110000 AS \"RocEntryDateMin\" ";
			sql += "  ,:inputEntryDateMax - 19110000 AS \"RocEntryDateMax\" ";
			sql += "  ,M.\"OvduTerm\" AS \"OvduTerm\" ";
			sql += "  ,M.\"CustNo\" AS \"CustNo\" ";
			...
			sql += "                              THEN TX.\"OvEntryDate\" ";
			sql += "                         ELSE TX.\"LnEntryDate\" END) - 19110000, 0)), ' ') AS \"EntryDate\" ";
		...
		this.info("inputEntryDateMin=" + parse.stringToInteger(titaVo.getParam("inputEntryDateMin")) + 19110000);
		this.info("inputEntryDateMax=" + parse.stringToInteger(titaVo.getParam("inputEntryDateMax")) + 19110000);
		this.info("inputYearMonth=" + parse.stringToInteger(titaVo.getParam("inputYearMonth")) + 19110000);
		this.info("inputCollectorShow=" + titaVo.getParam("inputCollector"));
		this.info("inputDrawdownDate=" + parse.stringToInteger(titaVo.getParam("inputDrawdownDate")) + 19110000);

		Query query;
		query = em.createNativeQuery(sql);
		query.setParameter("inputEntryDateMin", parse.stringToInteger(titaVo.getParam("inputEntryDateMin")) + 19110000);
		query.setParameter("inputEntryDateMax", parse.stringToInteger(titaVo.getParam("inputEntryDateMax")) + 19110000);
		query.setParameter("inputYearMonth", parse.stringToInteger(titaVo.getParam("inputYearMonth")) + 19110000);
		query.setParameter("inputCollector", titaVo.getParam("inputCollector"));
		query.setParameter("inputDrawdownDate", parse.stringToInteger(titaVo.getParam("inputDrawdownDate")) + 19110000);
