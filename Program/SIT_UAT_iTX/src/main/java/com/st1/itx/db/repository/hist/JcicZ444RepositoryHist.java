 ...
 * @version 1.0.0
 */
public interface JcicZ444RepositoryHist extends JpaRepository<JcicZ444, JcicZ444Id> {
	...
	public Slice<JcicZ444> findAllBySubmitKeyIsAndCustIdIsAndApplyDateIsAndCourtCodeIsOrderByCreateDateDesc(String submitKey_0, String custId_1, int applyDate_2, String courtCode_3,
			Pageable pageable);
