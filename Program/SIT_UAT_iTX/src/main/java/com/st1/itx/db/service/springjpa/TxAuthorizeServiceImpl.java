...
@Repository
public class TxAuthorizeServiceImpl implements TxAuthorizeService, InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(TxAuthorizeServiceImpl.class);
	...
	public Slice<TxAuthorize> findSupNo(int entdy_0, String supNo_1, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("findSupNo " + dbName + " : " + "entdy_0 : " + entdy_0 + " supNo_1 : " + supNo_1);
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<TxAuthorize> findEntdy(int entdy_0, int entdy_1, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("findEntdy " + dbName + " : " + "entdy_0 : " + entdy_0 + " entdy_1 : " + entdy_1);
		if (dbName.equals(ContentName.onDay))
	...
	public TxAuthorize holdById(TxAuthorize txAuthorize, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + txAuthorize.getAutoSeq());
	...
	public TxAuthorize insert(TxAuthorize txAuthorize, TitaVo... titaVo) throws DBException {
		...
		logger.info("Insert..." + dbName + " " + txAuthorize.getAutoSeq());
	...
	public TxAuthorize update(TxAuthorize txAuthorize, TitaVo... titaVo) throws DBException {
		...
		logger.info("Update..." + dbName + " " + txAuthorize.getAutoSeq());
		if (!empNot.isEmpty())
	...
	public void delete(TxAuthorize txAuthorize, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Delete..." + dbName + " " + txAuthorize.getAutoSeq());
		if (dbName.equals(ContentName.onDay)) {
