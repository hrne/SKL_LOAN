 ...
 * @version 1.0.0
 */
public interface EmpDeductScheduleRepositoryHist extends JpaRepository<EmpDeductSchedule, EmpDeductScheduleId> {
	...
	public Slice<EmpDeductSchedule> findAllByWorkMonthGreaterThanEqualAndWorkMonthLessThanEqualAndAgType1IsOrderByAgType1AscWorkMonthAsc(int workMonth_0, int workMonth_1, String agType1_2,
			Pageable pageable);
