...
public class JobMain implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1059065043403234335L;
	...
	public String toString() {
		return "JobMain [jobMainId=" + jobMainId + ", startTime=" + startTime + ", endTime=" + endTime + ", createEmpNo=" + createEmpNo + ", createDate=" + createDate + ", lastUpdateEmpNo="
				+ lastUpdateEmpNo + ", lastUpdate=" + lastUpdate + "]";
	}
}
