...
// 序號
	...
	public String toString() {
		return "PfItDetailAdjust [logNo=" + logNo + ", custNo=" + custNo + ", facmNo=" + facmNo + ", bormNo=" + bormNo + ", workMonth=" + workMonth + ", workSeason=" + workSeason + ", adjRange="
				+ adjRange + ", adjPerfEqAmt=" + adjPerfEqAmt + ", adjPerfReward=" + adjPerfReward + ", adjPerfAmt=" + adjPerfAmt + ", adjCntingCode=" + adjCntingCode + ", createDate=" + createDate
