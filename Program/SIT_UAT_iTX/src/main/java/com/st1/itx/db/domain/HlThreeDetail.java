...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "HlThreeDetail [hlThreeDetailId=" + hlThreeDetailId + ", aplAmount=" + aplAmount + ", ifCal=" + ifCal
           + ", tActAmt=" + tActAmt + ", empNo=" + empNo + ", empId=" + empId + ", hlEmpName=" + hlEmpName + ", deptNo=" + deptNo + ", branchNo=" + branchNo
           + ", unitNo=" + unitNo + ", deptName=" + deptName + ", branchName=" + branchName + ", unitName=" + unitName + ", firAppDate=" + firAppDate + ", biReteNo=" + biReteNo
           ...
           + ", id0=" + id0 + ", id0Name=" + id0Name + ", upNo=" + upNo + ", processDate=" + processDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
