 ...
 * @version 1.0.0
 */
public interface AcMainRepositoryHist extends JpaRepository<AcMain, AcMainId> {
	...
	// >= ,AND AcNoCode <= ,AND AcSubCode >= ,AND AcSubCode <= ,AND AcDtlCode >=
	// ,AND AcDtlCode <=
	public Slice<AcMain> (
			String acBookCode_0, String branchNo_1, String currencyCode_2, int acDate_3, String acNoCode_4, String acNoCode_5, String acSubCode_6, String acSubCode_7, String acDtlCode_8,
			String acDtlCode_9, Pageable pageable);
