...
public class MlaundryRecord implements Serializable {
	...
	public String toString() {
		return "MlaundryRecord [mlaundryRecordId=" + mlaundryRecordId + ", repayDate=" + repayDate + ", actualRepayDate=" + actualRepayDate + ", repayAmt=" + repayAmt + ", actualRepayAmt="
				+ actualRepayAmt + ", career=" + career + ", income=" + income + ", repaySource=" + repaySource + ", repayBank=" + repayBank + ", description=" + description + ", createDate="
