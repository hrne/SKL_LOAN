...
@Repository
public class JcicZ065ServiceImpl implements JcicZ065Service, InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(JcicZ065ServiceImpl.class);
	...
	public JcicZ065 findById(JcicZ065Id jcicZ065Id, TitaVo... titaVo) {
		...
		logger.info("findById " + dbName + " " + jcicZ065Id);
	...
	public JcicZ065 holdById(JcicZ065Id jcicZ065Id, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + jcicZ065Id);
		Optional<JcicZ065> jcicZ065 = null;
		if (dbName.equals(ContentName.onDay))
	...
	public JcicZ065 holdById(JcicZ065 jcicZ065, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + jcicZ065.getJcicZ065Id());
	...
	public JcicZ065 insert(JcicZ065 jcicZ065, TitaVo... titaVo) throws DBException {
		...
		logger.info("Insert..." + dbName + " " + jcicZ065.getJcicZ065Id());
	...
	public JcicZ065 update(JcicZ065 jcicZ065, TitaVo... titaVo) throws DBException {
		...
		logger.info("Update..." + dbName + " " + jcicZ065.getJcicZ065Id());
		if (!empNot.isEmpty())
	...
	public void delete(JcicZ065 jcicZ065, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Delete..." + dbName + " " + jcicZ065.getJcicZ065Id());
		if (dbName.equals(ContentName.onDay)) {
