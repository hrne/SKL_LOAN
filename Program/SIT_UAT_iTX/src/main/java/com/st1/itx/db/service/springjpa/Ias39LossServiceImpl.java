...
@Repository
public class Ias39LossServiceImpl implements Ias39LossService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(Ias39LossServiceImpl.class);
  ...
  public Ias39Loss findById(Ias39LossId ias39LossId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + ias39LossId);
...
em = null;
  ...
  public Slice<Ias39Loss> findFacmNo(int custNo_0, int facmNo_1, int facmNo_2, int index, int limit, TitaVo... titaVo) {
    ...
    logger.info("findFacmNo " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " +  facmNo_1 + " facmNo_2 : " +  facmNo_2);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<Ias39Loss> findCustNo(int custNo_0, int custNo_1, int facmNo_2, int facmNo_3, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("findCustNo " + dbName + " : " + "custNo_0 : " + custNo_0 + " custNo_1 : " +  custNo_1 + " facmNo_2 : " +  facmNo_2 + " facmNo_3 : " +  facmNo_3);
    if (dbName.equals(ContentName.onDay))
      slice = ias39LossReposDay.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCustNoAscFacmNoAscMarkDateAsc(custNo_0, custNo_1, facmNo_2, facmNo_3, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = ias39LossReposMon.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCustNoAscFacmNoAscMarkDateAsc(custNo_0, custNo_1, facmNo_2, facmNo_3, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = ias39LossReposHist.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCustNoAscFacmNoAscMarkDateAsc(custNo_0, custNo_1, facmNo_2, facmNo_3, pageable);
    else 
      slice = ias39LossRepos.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCustNoAscFacmNoAscMarkDateAsc(custNo_0, custNo_1, facmNo_2, facmNo_3, pageable);
  ...
  public Ias39Loss holdById(Ias39LossId ias39LossId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + ias39LossId);
    Optional<Ias39Loss> ias39Loss = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public Ias39Loss holdById(Ias39Loss ias39Loss, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + ias39Loss.getIas39LossId());
  ...
  public Ias39Loss insert(Ias39Loss ias39Loss, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + ias39Loss.getIas39LossId());
  ...
  public Ias39Loss update(Ias39Loss ias39Loss, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + ias39Loss.getIas39LossId());
    if (!empNot.isEmpty())
      ias39Loss.setLastUpdateEmpNo(empNot);
  ...
  public void delete(Ias39Loss ias39Loss, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + ias39Loss.getIas39LossId());
    if (dbName.equals(ContentName.onDay)) {
