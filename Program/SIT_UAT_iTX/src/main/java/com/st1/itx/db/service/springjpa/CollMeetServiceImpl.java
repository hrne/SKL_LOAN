...
public class CollMeetServiceImpl extends ASpringJpaParm implements CollMeetService, InitializingBean {
	...
	public Slice<CollMeet> telTimeBetween(int meetDate_0, int meetDate_1, String caseCode_2, int custNo_3, int facmNo_4, int index, int limit, TitaVo... titaVo) {
		...
		this.info("telTimeBetween " + dbName + " : " + "meetDate_0 : " + meetDate_0 + " meetDate_1 : " + meetDate_1 + " caseCode_2 : " + caseCode_2 + " custNo_3 : " + custNo_3 + " facmNo_4 : "
				+ facmNo_4);
		if (dbName.equals(ContentName.onDay))
			slice = collMeetReposDay.findAllByMeetDateGreaterThanEqualAndMeetDateLessThanEqualAndCaseCodeIsAndCustNoIsAndFacmNoIsOrderByMeetDateDesc(meetDate_0, meetDate_1, caseCode_2, custNo_3,
					facmNo_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = collMeetReposMon.findAllByMeetDateGreaterThanEqualAndMeetDateLessThanEqualAndCaseCodeIsAndCustNoIsAndFacmNoIsOrderByMeetDateDesc(meetDate_0, meetDate_1, caseCode_2, custNo_3,
					facmNo_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = collMeetReposHist.findAllByMeetDateGreaterThanEqualAndMeetDateLessThanEqualAndCaseCodeIsAndCustNoIsAndFacmNoIsOrderByMeetDateDesc(meetDate_0, meetDate_1, caseCode_2, custNo_3,
					facmNo_4, pageable);
		else
			slice = collMeetRepos.findAllByMeetDateGreaterThanEqualAndMeetDateLessThanEqualAndCaseCodeIsAndCustNoIsAndFacmNoIsOrderByMeetDateDesc(meetDate_0, meetDate_1, caseCode_2, custNo_3,
					facmNo_4, pageable);
	...
	public CollMeet insert(CollMeet collMeet, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(collMeet.getCollMeetId()) != null)
