...
public class LB093ServiceImpl extends ASpringJpaParm implements InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(LB093ServiceImpl.class);
...
//		boolean onLineMode = true;
		...
		logger.info("----------- LB093.findAll ---------------");
		logger.info("-----LB093 TitaVo=" + titaVo);
		logger.info("-----LB093 Tita ENTDY=" + titaVo.getEntDy().substring(0, 6));
