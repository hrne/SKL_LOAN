...
@Repository
public class LoanIfrsBpServiceImpl implements LoanIfrsBpService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(LoanIfrsBpServiceImpl.class);
  ...
  public LoanIfrsBp findById(LoanIfrsBpId loanIfrsBpId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + loanIfrsBpId);
...
em = null;
  ...
  public LoanIfrsBp holdById(LoanIfrsBpId loanIfrsBpId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + loanIfrsBpId);
    Optional<LoanIfrsBp> loanIfrsBp = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public LoanIfrsBp holdById(LoanIfrsBp loanIfrsBp, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + loanIfrsBp.getLoanIfrsBpId());
  ...
  public LoanIfrsBp insert(LoanIfrsBp loanIfrsBp, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + loanIfrsBp.getLoanIfrsBpId());
  ...
  public LoanIfrsBp update(LoanIfrsBp loanIfrsBp, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + loanIfrsBp.getLoanIfrsBpId());
    if (!empNot.isEmpty())
      loanIfrsBp.setLastUpdateEmpNo(empNot);
  ...
  public void delete(LoanIfrsBp loanIfrsBp, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + loanIfrsBp.getLoanIfrsBpId());
    if (dbName.equals(ContentName.onDay)) {
