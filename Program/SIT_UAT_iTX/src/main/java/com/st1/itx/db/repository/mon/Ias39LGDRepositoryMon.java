 ...
 * @version 1.0.0
 */
public interface Ias39LGDRepositoryMon extends JpaRepository<Ias39LGD, Ias39LGDId> {
	...
	public Slice<Ias39LGD> findAllByDateGreaterThanEqualAndDateLessThanEqualAndTypeGreaterThanEqualAndTypeLessThanEqualOrderByDateDescTypeAsc(int date_0, int date_1, String type_2, String type_3,
			Pageable pageable);
