...
public class JcicZ571Log implements Serializable {
	...
	public String toString() {
		return "JcicZ571Log [jcicZ571LogId=" + jcicZ571LogId + ", tranKey=" + tranKey + ", ownerYn=" + ownerYn + ", payYn=" + payYn + ", ownerAmt=" + ownerAmt + ", allotAmt=" + allotAmt
				+ ", unallotAmt=" + unallotAmt + ", outJcicTxtDate=" + outJcicTxtDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
