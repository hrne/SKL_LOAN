...
public class TxFile implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2024308701321361733L;
...
// 檔案序號
	...
	public String toString() {
		return "TxFile [fileNo=" + fileNo + ", fileDate=" + fileDate + ", fileCode=" + fileCode + ", fileItem=" + fileItem + ", fileType=" + fileType + ", fileOutput=" + fileOutput + ", fileFormat="
				+ fileFormat + ", fileData=" + fileData + ", brNo=" + brNo + ", signCode=" + signCode + ", groupNo=" + groupNo + ", tlrNo=" + tlrNo + ", supNo=" + supNo + ", createDate=" + createDate
