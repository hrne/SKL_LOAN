...
public class LM029ServiceImpl extends ASpringJpaParm implements InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(LM029ServiceImpl.class);
	...
	public List<Map<String, String>> findAll(TitaVo titaVo) throws Exception {
		logger.info("LM029ServiceImpl findAll ");
		...
		sql += "                        ,M.\"ClCode2\"";
		sql += "                        ,M.\"ClNo\"";
		sql += "                        ,NVL(CBO.\"OwnerId\", CLO.\"OwnerId\")     AS \"OwnerId\"";
		sql += "                        ,NVL(CBO.\"OwnerName\", CLO.\"OwnerName\") AS \"OwnerName\"";
