 ...
 * @version 1.0.0
 */
public interface TxAuthorizeRepositoryMon extends JpaRepository<TxAuthorize, Long> {
	...
	public Slice<TxAuthorize> findAllByCreateDateGreaterThanEqualAndCreateDateLessThanEqualAndSupNoLikeOrderByCreateDateAsc(java.sql.Timestamp createDate_0, java.sql.Timestamp createDate_1,
