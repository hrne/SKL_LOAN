...
public class TbJcicMu01 implements Serializable {
	...
	public String toString() {
		return "TbJcicMu01 [tbJcicMu01Id=" + tbJcicMu01Id + ", title=" + title + ", authQryType=" + authQryType + ", qryUserId=" + qryUserId + ", authItemQuery=" + authItemQuery + ", authItemReview="
				+ authItemReview + ", authItemOther=" + authItemOther + ", authStartDay=" + authStartDay + ", authMgrIdS=" + authMgrIdS + ", authEndDay=" + authEndDay + ", authMgrIdE=" + authMgrIdE
				+ ", emailAccount=" + emailAccount + ", modifyUserId=" + modifyUserId + ", outJcictxtDate=" + outJcictxtDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
