...
public class CdBank implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7822283149582330953L;
	...
	public String toString() {
		return "CdBank [cdBankId=" + cdBankId + ", bankItem=" + bankItem + ", branchItem=" + branchItem + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
