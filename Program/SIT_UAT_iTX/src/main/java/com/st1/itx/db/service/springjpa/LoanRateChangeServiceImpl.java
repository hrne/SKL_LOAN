...
@Repository
public class LoanRateChangeServiceImpl implements LoanRateChangeService, InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(LoanRateChangeServiceImpl.class);
	...
	public LoanRateChange findById(LoanRateChangeId loanRateChangeId, TitaVo... titaVo) {
		...
		logger.info("findById " + dbName + " " + loanRateChangeId);
	...
	public Slice<LoanRateChange> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		Pageable pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "CustNo", "FacmNo", "BormNo", "EffectDate"));
	...
	public Slice<LoanRateChange> rateChangeTxtNoEq(int acDate_0, String tellerNo_1, String txtNo_2, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("rateChangeTxtNoEq " + dbName + " : " + "acDate_0 : " + acDate_0 + " tellerNo_1 : " + tellerNo_1 + " txtNo_2 : " + txtNo_2);
		if (dbName.equals(ContentName.onDay))
	...
	public LoanRateChange rateChangeEffectDateDescFirst(int custNo_0, int facmNo_1, int bormNo_2, int effectDate_3, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("rateChangeEffectDateDescFirst " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " + facmNo_1 + " bormNo_2 : " + bormNo_2 + " effectDate_3 : " + effectDate_3);
	...
	public LoanRateChange rateChangeEffectDateAscFirst(int custNo_0, int facmNo_1, int bormNo_2, int effectDate_3, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("rateChangeEffectDateAscFirst " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " + facmNo_1 + " bormNo_2 : " + bormNo_2 + " effectDate_3 : " + effectDate_3);
		Optional<LoanRateChange> loanRateChangeT = null;
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<LoanRateChange> rateChangeBormNoEq(int custNo_0, int facmNo_1, int bormNo_2, int effectDate_3, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("rateChangeBormNoEq " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " + facmNo_1 + " bormNo_2 : " + bormNo_2 + " effectDate_3 : " + effectDate_3);
		if (dbName.equals(ContentName.onDay))
	...
	public LoanRateChange rateChangeEffectDateFirst(int custNo_0, int facmNo_1, int bormNo_2, int effectDate_3, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("rateChangeEffectDateFirst " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " + facmNo_1 + " bormNo_2 : " + bormNo_2 + " effectDate_3 : " + effectDate_3);
		Optional<LoanRateChange> loanRateChangeT = null;
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<LoanRateChange> rateChangeEffectDateRange(int custNo_0, int facmNo_1, int facmNo_2, int bormNo_3, int bormNo_4, int effectDate_5, int effectDate_6, int index, int limit,
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("rateChangeEffectDateRange " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " + facmNo_1 + " facmNo_2 : " + facmNo_2 + " bormNo_3 : " + bormNo_3 + " bormNo_4 : "
				+ bormNo_4 + " effectDate_5 : " + effectDate_5 + " effectDate_6 : " + effectDate_6);
		if (dbName.equals(ContentName.onDay))
			slice = loanRateChangeReposDay
					.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByEffectDateDesc(
							custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, effectDate_5, effectDate_6, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = loanRateChangeReposMon
					.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByEffectDateDesc(
							custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, effectDate_5, effectDate_6, pageable);
		else if (dbName.equals(ContentName.onHist))
	...
	public Slice<LoanRateChange> rateChangeFacmNoRange(int custNo_0, int facmNo_1, int facmNo_2, int bormNo_3, int bormNo_4, int effectDate_5, int effectDate_6, int index, int limit,
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("rateChangeFacmNoRange " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " + facmNo_1 + " facmNo_2 : " + facmNo_2 + " bormNo_3 : " + bormNo_3 + " bormNo_4 : " + bormNo_4
				+ " effectDate_5 : " + effectDate_5 + " effectDate_6 : " + effectDate_6);
		if (dbName.equals(ContentName.onDay))
			slice = loanRateChangeReposDay
	...
	public LoanRateChange holdById(LoanRateChangeId loanRateChangeId, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + loanRateChangeId);
		Optional<LoanRateChange> loanRateChange = null;
		if (dbName.equals(ContentName.onDay))
	...
	public LoanRateChange holdById(LoanRateChange loanRateChange, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + loanRateChange.getLoanRateChangeId());
		Optional<LoanRateChange> loanRateChangeT = null;
		if (dbName.equals(ContentName.onDay))
	...
	public LoanRateChange insert(LoanRateChange loanRateChange, TitaVo... titaVo) throws DBException {
		...
		logger.info("Insert..." + dbName + " " + loanRateChange.getLoanRateChangeId());
		if (this.findById(loanRateChange.getLoanRateChangeId()) != null)
	...
	public LoanRateChange update(LoanRateChange loanRateChange, TitaVo... titaVo) throws DBException {
		...
		logger.info("Update..." + dbName + " " + loanRateChange.getLoanRateChangeId());
		if (!empNot.isEmpty())
	...
	public void delete(LoanRateChange loanRateChange, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Delete..." + dbName + " " + loanRateChange.getLoanRateChangeId());
		if (dbName.equals(ContentName.onDay)) {
