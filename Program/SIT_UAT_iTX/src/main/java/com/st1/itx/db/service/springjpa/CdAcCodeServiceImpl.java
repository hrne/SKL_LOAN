...
public class CdAcCodeServiceImpl extends ASpringJpaParm implements CdAcCodeService, InitializingBean {
	...
	public Slice<CdAcCode> findAcCode(String acNoCode_0, String acNoCode_1, String acSubCode_2, String acSubCode_3, String acDtlCode_4, String acDtlCode_5, int index, int limit, TitaVo... titaVo) {
		...
		this.info("findAcCode " + dbName + " : " + "acNoCode_0 : " + acNoCode_0 + " acNoCode_1 : " + acNoCode_1 + " acSubCode_2 : " + acSubCode_2 + " acSubCode_3 : " + acSubCode_3 + " acDtlCode_4 : "
				+ acDtlCode_4 + " acDtlCode_5 : " + acDtlCode_5);
		if (dbName.equals(ContentName.onDay))
			slice = cdAcCodeReposDay
					.findAllByAcNoCodeGreaterThanEqualAndAcNoCodeLessThanEqualAndAcSubCodeGreaterThanEqualAndAcSubCodeLessThanEqualAndAcDtlCodeGreaterThanEqualAndAcDtlCodeLessThanEqualOrderByAcNoCodeAscAcSubCodeAscAcDtlCodeAsc(
							acNoCode_0, acNoCode_1, acSubCode_2, acSubCode_3, acDtlCode_4, acDtlCode_5, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = cdAcCodeReposMon
					.findAllByAcNoCodeGreaterThanEqualAndAcNoCodeLessThanEqualAndAcSubCodeGreaterThanEqualAndAcSubCodeLessThanEqualAndAcDtlCodeGreaterThanEqualAndAcDtlCodeLessThanEqualOrderByAcNoCodeAscAcSubCodeAscAcDtlCodeAsc(
							acNoCode_0, acNoCode_1, acSubCode_2, acSubCode_3, acDtlCode_4, acDtlCode_5, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = cdAcCodeReposHist
					.findAllByAcNoCodeGreaterThanEqualAndAcNoCodeLessThanEqualAndAcSubCodeGreaterThanEqualAndAcSubCodeLessThanEqualAndAcDtlCodeGreaterThanEqualAndAcDtlCodeLessThanEqualOrderByAcNoCodeAscAcSubCodeAscAcDtlCodeAsc(
							acNoCode_0, acNoCode_1, acSubCode_2, acSubCode_3, acDtlCode_4, acDtlCode_5, pageable);
		else
			slice = cdAcCodeRepos
	...
	@Override
	public Slice<CdAcCode> findAcCodeOld(String acNoCodeOld_0, String acNoCodeOld_1, String acSubCode_2, String acSubCode_3, String acDtlCode_4, String acDtlCode_5, int index, int limit,
			TitaVo... titaVo) {
		String dbName = "";
		Slice<CdAcCode> slice = null;
		if (titaVo.length != 0)
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findAcCodeOld " + dbName + " : " + "acNoCodeOld_0 : " + acNoCodeOld_0 + " acNoCodeOld_1 : " + acNoCodeOld_1 + " acSubCode_2 : " + acSubCode_2 + " acSubCode_3 : " + acSubCode_3
				+ " acDtlCode_4 : " + acDtlCode_4 + " acDtlCode_5 : " + acDtlCode_5);
		if (dbName.equals(ContentName.onDay))
			slice = cdAcCodeReposDay
					.findAllByAcNoCodeOldGreaterThanEqualAndAcNoCodeOldLessThanEqualAndAcSubCodeGreaterThanEqualAndAcSubCodeLessThanEqualAndAcDtlCodeGreaterThanEqualAndAcDtlCodeLessThanEqualOrderByAcNoCodeOldAscAcSubCodeAscAcDtlCodeAsc(
							acNoCodeOld_0, acNoCodeOld_1, acSubCode_2, acSubCode_3, acDtlCode_4, acDtlCode_5, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = cdAcCodeReposMon
					.findAllByAcNoCodeOldGreaterThanEqualAndAcNoCodeOldLessThanEqualAndAcSubCodeGreaterThanEqualAndAcSubCodeLessThanEqualAndAcDtlCodeGreaterThanEqualAndAcDtlCodeLessThanEqualOrderByAcNoCodeOldAscAcSubCodeAscAcDtlCodeAsc(
							acNoCodeOld_0, acNoCodeOld_1, acSubCode_2, acSubCode_3, acDtlCode_4, acDtlCode_5, pageable);
	...
	public CdAcCode insert(CdAcCode cdAcCode, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(cdAcCode.getCdAcCodeId()) != null)
