...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "CdEmp [employeeNo=" + employeeNo + ", agentCode=" + agentCode + ", commLineCode=" + commLineCode + ", commLineType=" + commLineType + ", origIntroducerId=" + origIntroducerId + ", introducerInd=" + introducerInd + ", registerLevel=" + registerLevel
           + ", registerDate=" + registerDate + ", centerCode=" + centerCode + ", administratId=" + administratId + ", inputDate=" + inputDate + ", inputUser=" + inputUser + ", agStatusCode=" + agStatusCode
           + ", agStatusDate=" + agStatusDate + ", tranDate=" + tranDate + ", tranUser=" + tranUser + ", reRegisterDate=" + reRegisterDate + ", directorId=" + directorId + ", directorIdF=" + directorIdF
           + ", introducerId=" + introducerId + ", introducerIdF=" + introducerIdF + ", agLevel=" + agLevel + ", lastLevel=" + lastLevel + ", levelDate=" + levelDate + ", topLevel=" + topLevel
           + ", occpInd=" + occpInd + ", quotaAmt=" + quotaAmt + ", applType=" + applType + ", taxRate=" + taxRate + ", socialInsuClass=" + socialInsuClass + ", promotLevelYM=" + promotLevelYM
           + ", directorYM=" + directorYM + ", recordDate=" + recordDate + ", exRecordDate=" + exRecordDate + ", rxTrDate=" + rxTrDate + ", exTrIdent=" + exTrIdent + ", exTrIdent2=" + exTrIdent2
           + ", exTrIdent3=" + exTrIdent3 + ", exTrDate=" + exTrDate + ", registerBefore=" + registerBefore + ", directorAfter=" + directorAfter + ", medicalCode=" + medicalCode + ", exChgDate=" + exChgDate
           + ", exDelDate=" + exDelDate + ", applCode=" + applCode + ", firstRegDate=" + firstRegDate + ", aginSource=" + aginSource + ", aguiCenter=" + aguiCenter + ", agentId=" + agentId
           + ", topId=" + topId + ", agDegree=" + agDegree + ", collectInd=" + collectInd + ", agType1=" + agType1 + ", contractInd=" + contractInd
           + ", contractIndYM=" + contractIndYM + ", agType2=" + agType2 + ", agType3=" + agType3 + ", agType4=" + agType4 + ", aginInd1=" + aginInd1 + ", agPoInd=" + agPoInd
           + ", agDocInd=" + agDocInd + ", newHireType=" + newHireType + ", agCurInd=" + agCurInd + ", agSendType=" + agSendType + ", agSendNo=" + agSendNo + ", registerDate2=" + registerDate2
           + ", agReturnDate=" + agReturnDate + ", agTransferDateF=" + agTransferDateF + ", agTransferDate=" + agTransferDate + ", promotYM=" + promotYM + ", promotYMF=" + promotYMF + ", agPostChgDate=" + agPostChgDate
           + ", familiesTax=" + familiesTax + ", agentCodeI=" + agentCodeI + ", agLevelSys=" + agLevelSys + ", agPostIn=" + agPostIn + ", centerCodeAcc=" + centerCodeAcc + ", evalueInd=" + evalueInd
           + ", evalueInd1=" + evalueInd1 + ", batchNo=" + batchNo + ", evalueYM=" + evalueYM + ", agTransferCode=" + agTransferCode + ", fullname=" + fullname + ", birth=" + birth
           + ", education=" + education + ", lrInd=" + lrInd + ", proceccDate=" + proceccDate + ", quitDate=" + quitDate + ", centerShortName=" + centerShortName + ", centerCodeName=" + centerCodeName
           + ", centerCode1=" + centerCode1 + ", centerCode1Short=" + centerCode1Short + ", centerCode1Name=" + centerCode1Name + ", centerCode2=" + centerCode2 + ", centerCode2Short=" + centerCode2Short + ", centerCode2Name=" + centerCode2Name
           + ", centerCodeAcc1=" + centerCodeAcc1 + ", centerCodeAcc1Name=" + centerCodeAcc1Name + ", centerCodeAcc2=" + centerCodeAcc2 + ", centerCodeAcc2Name=" + centerCodeAcc2Name + ", agPost=" + agPost + ", levelNameChs=" + levelNameChs
