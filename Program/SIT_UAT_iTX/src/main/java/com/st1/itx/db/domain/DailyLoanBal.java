...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "DailyLoanBal [dailyLoanBalId=" + dailyLoanBalId + ", latestFlag=" + latestFlag + ", monthEndYm=" + monthEndYm
           + ", currencyCode=" + currencyCode + ", acctCode=" + acctCode + ", facAcctCode=" + facAcctCode + ", prodNo=" + prodNo + ", loanBalance=" + loanBalance + ", storeRate=" + storeRate
           + ", intAmtRcv=" + intAmtRcv + ", intAmtAcc=" + intAmtAcc + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
           + "]";
  }
}
