...
public class CdBonusCo implements Serializable {
	...
	// 標準條件
	/*
	 * 條件記號=1時為計件代碼1位(1、2、A、B)條件記號=2時為協辦等級1位(1:初級、2:中級、3:高級)條件記號=3時為1個空白條件記號=
	 * 4時為商品別代號條件記號=5時為部門別代號條件記號=6時為Y/N
	 */
	...
	/**
	 * 條件記號<br>
	 * 1.篩選條件-計件代碼 2.協辦等級 3.專業獎勵金 4.排除商品別 5.排除部門別 6.是否排除15日薪非業績人員
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 標準條件<br>
	 * 條件記號=1時為計件代碼1位(1、2、A、B) 條件記號=2時為協辦等級1位(1:初級、2:中級、3:高級) 條件記號=3時為1個空白
	 * 條件記號=4時為商品別代號 條件記號=5時為部門別代號 條件記號=6時為Y/N
	 * 
	 * @return String
	 */
	...
	/**
	 * 獎勵津貼<br>
	 * 條件記號=2時輸入 初級 800 中級 1,000 高級 1,200 條件記號=3時輸入 一次性核發 3,000
	 * 
	 * @return BigDecimal
	 */
	...
	/**
	 * 獎勵津貼-初階授信通過<br>
	 * 條件記號=2時輸入 初級 900 中級 1,100 高級 1,300
	 * 
	 * @return BigDecimal
	 */
	...
	public String toString() {
		return "CdBonusCo [cdBonusCoId=" + cdBonusCoId + ", conditionAmt=" + conditionAmt + ", bonus=" + bonus + ", classPassBonus=" + classPassBonus + ", createDate=" + createDate + ", createEmpNo="
