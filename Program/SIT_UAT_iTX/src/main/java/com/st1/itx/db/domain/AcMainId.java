...
/**
  ...
  * @throws LogicException when Date Is Warn	*/
  ...
  public boolean equals(Object obj) {
    ...
    return acBookCode.equals(acMainId.acBookCode) && acSubBookCode.equals(acMainId.acSubBookCode) && branchNo.equals(acMainId.branchNo) && currencyCode.equals(acMainId.currencyCode) && acNoCode.equals(acMainId.acNoCode) && acSubCode.equals(acMainId.acSubCode) && acDtlCode.equals(acMainId.acDtlCode) && acDate == acMainId.acDate;
  }

  @Override
  public String toString() {
    return "AcMainId [acBookCode=" + acBookCode + ", acSubBookCode=" + acSubBookCode + ", branchNo=" + branchNo + ", currencyCode=" + currencyCode + ", acNoCode=" + acNoCode + ", acSubCode=" + acSubCode + ", acDtlCode=" + acDtlCode + ", acDate=" + acDate + "]";
  }
}
