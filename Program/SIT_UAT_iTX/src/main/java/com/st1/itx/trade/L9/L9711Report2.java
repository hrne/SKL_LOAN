...
public class L9711Report2 extends MakeReport {
	private static final Logger logger = LoggerFactory.getLogger(L9711Report2.class);
...
//			this.print(1, 1, "");
//			this.print(1, 1, "");
//			this.print(1, 10, tranNum(tL9711Vo.get("F17")) + tranNum(tL9711Vo.get("F18")));
//			this.print(1, 1, "");
//			String tmp = "";
//			if (tL9711Vo.get("F19") != null) {
//				tmp = tmp + tL9711Vo.get("F19");
//			}
//			if (tL9711Vo.get("F20") != null) {
//				tmp = tmp + tL9711Vo.get("F20");
//			}
//			if (tL9711Vo.get("F21") != null) {
//				tmp = tmp + tL9711Vo.get("F21") + "路";
//			}
//			if (tL9711Vo.get("F22") != null) {
//				tmp = tmp + tL9711Vo.get("F22") + "段";
//			}
//			if (tL9711Vo.get("F23") != null) {
//				tmp = tmp + tL9711Vo.get("F23") + "巷";
//			}
//			if (tL9711Vo.get("F24") != null) {
//				tmp = tmp + tL9711Vo.get("F24") + "弄";
//			}
//			if (tL9711Vo.get("F25") != null) {
//				tmp = tmp + tL9711Vo.get("F25") + "號";
//			}
//			if (tL9711Vo.get("F26") != null) {
//				tmp = tmp + "之" + tL9711Vo.get("F26") + "，";
//			}
//			if (tL9711Vo.get("F27") != null) {
//				tmp = tmp + tL9711Vo.get("F27") + "樓";
//			}
//			if (tL9711Vo.get("F28") != null) {
//				tmp = tmp + "之" + tL9711Vo.get("F28");
//			}
//			this.print(1, 10, tmp);
//			this.print(1, 1, "");
//			this.print(1, 10, String.format("%07d", Integer.valueOf(tL9711Vo.get("F4"))) + "   " + tL9711Vo.get("F6"));
//			this.print(1, 1, "");
//			this.print(1, 1, "");
//			this.print(1, 1, "");
//			this.print(1, 1, "");
...
//
//			this.print(1, 10, "戶號：　　　　　　　目前利率：　　　　%");
//			this.print(0, 16, String.format("%07d", Integer.valueOf(tL9711Vo.get("F4"))) + "-"
//					+ String.format("%03d", Integer.valueOf(tL9711Vo.get("F5"))));
//			this.print(0, 47, String.format("%.4f", IntRate), "R");
//			this.print(1, 10, "客戶名稱：　　　　　　　　　　　　　　　　　　　　　溢短繳：");
//			this.print(0, 20, tL9711Vo.get("F6"));
...
//			} else {
//				this.print(1, 8, "　　貴戶所貸上列款項。於　" + showDate(tL9711Vo.get("F8"), 2) + "到期，請依約到本公司辦理清償或展期手續，請勿延誤");
//			}
