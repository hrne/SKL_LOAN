...
@Repository
public class JobDetailServiceImpl implements JobDetailService, InitializingBean {
	...
	public JobDetail findById(JobDetailId jobDetailId, TitaVo... titaVo) {
		...
		logger.info("findById " + dbName + " " + jobDetailId);
	...
	public Slice<JobDetail> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		Pageable pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "ExecDate", "JobCode", "StepId"));
	...
	public Slice<JobDetail> jobCodeEq(int execDate_0, String jobCode_1, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("jobCodeEq " + dbName + " : " + "execDate_0 : " + execDate_0 + " jobCode_1 : " + jobCode_1);
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<JobDetail> execDateEq(int execDate_0, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("execDateEq " + dbName + " : " + "execDate_0 : " + execDate_0);
		if (dbName.equals(ContentName.onDay))
	...
	public JobDetail execDateFirst(int execDate_0, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("execDateFirst " + dbName + " : " + "execDate_0 : " + execDate_0);
	...
	public JobDetail holdById(JobDetailId jobDetailId, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + jobDetailId);
		Optional<JobDetail> jobDetail = null;
		if (dbName.equals(ContentName.onDay))
	...
	public JobDetail holdById(JobDetail jobDetail, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + jobDetail.getJobDetailId());
		Optional<JobDetail> jobDetailT = null;
		if (dbName.equals(ContentName.onDay))
	...
	public JobDetail insert(JobDetail jobDetail, TitaVo... titaVo) throws DBException {
		...
		logger.info("Insert..." + dbName + " " + jobDetail.getJobDetailId());
		if (this.findById(jobDetail.getJobDetailId()) != null)
	...
	public JobDetail update(JobDetail jobDetail, TitaVo... titaVo) throws DBException {
		...
		logger.info("Update..." + dbName + " " + jobDetail.getJobDetailId());
		if (!empNot.isEmpty())
	...
	public void delete(JobDetail jobDetail, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Delete..." + dbName + " " + jobDetail.getJobDetailId());
		if (dbName.equals(ContentName.onDay)) {
