 ...
 * @version 1.0.0
 */
public interface CdPerformanceRepositoryHist extends JpaRepository<CdPerformance, CdPerformanceId> {

  // WorkMonth = ,AND PieceCode >= ,AND PieceCode <=
  public Slice<CdPerformance> findAllByWorkMonthIsAndPieceCodeGreaterThanEqualAndPieceCodeLessThanEqualOrderByPieceCodeAsc(int workMonth_0, String pieceCode_1, String pieceCode_2, Pageable pageable);
