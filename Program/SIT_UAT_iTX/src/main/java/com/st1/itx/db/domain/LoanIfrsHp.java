...
public class LoanIfrsHp implements Serializable {
	...
	public String toString() {
		return "LoanIfrsHp [loanIfrsHpId=" + loanIfrsHpId + ", custId=" + custId + ", applNo=" + applNo + ", custKind=" + custKind + ", approveDate=" + approveDate + ", firstDrawdownDate="
				+ firstDrawdownDate + ", lineAmt=" + lineAmt + ", ifrsProdCode=" + ifrsProdCode + ", avblBal=" + avblBal + ", recycleCode=" + recycleCode + ", irrevocableFlag=" + irrevocableFlag
