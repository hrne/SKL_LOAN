...
@Repository
public class JcicB207ServiceImpl extends ASpringJpaParm implements JcicB207Service, InitializingBean {
	@Autowired
	...
	public JcicB207 findById(JcicB207Id jcicB207Id, TitaVo... titaVo) {
		...
		this.info("findById " + dbName + " " + jcicB207Id);
	...
	public Slice<JcicB207> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by(Sort.Direction.ASC, "DataYM", "BankItem", "CustId"));
		else
	...
	public JcicB207 holdById(JcicB207Id jcicB207Id, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Hold " + dbName + " " + jcicB207Id);
		Optional<JcicB207> jcicB207 = null;
		if (dbName.equals(ContentName.onDay))
	...
	public JcicB207 holdById(JcicB207 jcicB207, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Hold " + dbName + " " + jcicB207.getJcicB207Id());
	...
	public JcicB207 insert(JcicB207 jcicB207, TitaVo... titaVo) throws DBException {
		...
		this.info("Insert..." + dbName + " " + jcicB207.getJcicB207Id());
	...
	public JcicB207 update(JcicB207 jcicB207, TitaVo... titaVo) throws DBException {
		...
		this.info("Update..." + dbName + " " + jcicB207.getJcicB207Id());
		if (!empNot.isEmpty())
			jcicB207.setLastUpdateEmpNo(empNot);
	...
	public void delete(JcicB207 jcicB207, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Delete..." + dbName + " " + jcicB207.getJcicB207Id());
		if (dbName.equals(ContentName.onDay)) {
