...
@Repository
public class MonthlyLM028ServiceImpl implements MonthlyLM028Service, InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(MonthlyLM028ServiceImpl.class);
	...
	public MonthlyLM028 findById(MonthlyLM028Id monthlyLM028Id, TitaVo... titaVo) {
		...
		logger.info("findById " + dbName + " " + monthlyLM028Id);
	...
	public Slice<MonthlyLM028> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		Pageable pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "LMSACN", "LMSAPN", "LMSASQ"));
	...
	public MonthlyLM028 holdById(MonthlyLM028Id monthlyLM028Id, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + monthlyLM028Id);
		Optional<MonthlyLM028> monthlyLM028 = null;
		if (dbName.equals(ContentName.onDay))
	...
	public MonthlyLM028 holdById(MonthlyLM028 monthlyLM028, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + monthlyLM028.getMonthlyLM028Id());
	...
	public MonthlyLM028 insert(MonthlyLM028 monthlyLM028, TitaVo... titaVo) throws DBException {
		...
		logger.info("Insert..." + dbName + " " + monthlyLM028.getMonthlyLM028Id());
	...
	public MonthlyLM028 update(MonthlyLM028 monthlyLM028, TitaVo... titaVo) throws DBException {
		...
		logger.info("Update..." + dbName + " " + monthlyLM028.getMonthlyLM028Id());
		if (!empNot.isEmpty())
	...
	public void delete(MonthlyLM028 monthlyLM028, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Delete..." + dbName + " " + monthlyLM028.getMonthlyLM028Id());
		if (dbName.equals(ContentName.onDay)) {
