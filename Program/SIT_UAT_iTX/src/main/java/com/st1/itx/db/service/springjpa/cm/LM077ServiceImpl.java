...
public class LM077ServiceImpl extends ASpringJpaParm implements InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(LM077ServiceImpl.class);
	...
	public List<Map<String, String>> findAll(TitaVo titaVo, String RptMonth) throws Exception {
		logger.info("LM077.findAll ");
		logger.info("LM077ServiceImpl RptMonth: " + RptMonth);
