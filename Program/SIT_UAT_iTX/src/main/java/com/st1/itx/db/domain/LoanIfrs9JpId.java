...
/**
  ...
  * @param oldBormNo 舊撥款序號
  ...
  public boolean equals(Object obj) {
    ...
    return dataYM == loanIfrs9JpId.dataYM && acDateYM == loanIfrs9JpId.acDateYM && custNo == loanIfrs9JpId.custNo && newFacmNo == loanIfrs9JpId.newFacmNo && newBormNo == loanIfrs9JpId.newBormNo && oldFacmNo == loanIfrs9JpId.oldFacmNo && oldBormNo == loanIfrs9JpId.oldBormNo;
  }

  @Override
  public String toString() {
    return "LoanIfrs9JpId [dataYM=" + dataYM + ", acDateYM=" + acDateYM + ", custNo=" + custNo + ", newFacmNo=" + newFacmNo + ", newBormNo=" + newBormNo + ", oldFacmNo=" + oldFacmNo + ", oldBormNo=" + oldBormNo + "]";
  }
}
