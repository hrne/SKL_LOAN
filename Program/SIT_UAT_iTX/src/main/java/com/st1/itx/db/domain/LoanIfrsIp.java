...
@Table(name = "`LoanIfrsIp`")
public class LoanIfrsIp implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8343811097705591575L;

	@EmbeddedId
	private LoanIfrsIpId loanIfrsIpId;
	...
	public LoanIfrsIpId getLoanIfrsIpId() {
		return this.loanIfrsIpId;
	}

	public void setLoanIfrsIpId(LoanIfrsIpId loanIfrsIpId) {
		this.loanIfrsIpId = loanIfrsIpId;
	}
	...
	/**
	 * 核准日期<br>
	 * 1.優先取用對保日期 2.無對保日採用准駁日 3.若無上述二個日期，以空值提供
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 契約當時還款方式<br>
	 * 會計日當時契約當時還款方式 1=按期繳息(到期還本)； 2=平均攤還本息； 3=平均攤還本金； 4=到期繳息還本
	 * 
	 * @return String
	 */
	...
	/**
	 * 契約當時利率調整方式<br>
	 * 會計日當時契約當時利率調整方式 1=機動； 2=固定； 3=固定階梯； 4=浮動階梯
	 * 
	 * @return String
	 */
	...
	/**
	 * 企業戶/個人戶<br>
	 * 1=企業戶 2=個人戶 自然人採用企金自然人評等模型者，應歸類為企業戶
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "LoanIfrsIp [loanIfrsIpId=" + loanIfrsIpId + ", custId=" + custId + ", applNo=" + applNo + ", drawdownFg=" + drawdownFg + ", approveDate=" + approveDate + ", firstDrawdownDate="
				+ firstDrawdownDate + ", lineAmt=" + lineAmt + ", acctFee=" + acctFee + ", fee=" + fee + ", approveRate=" + approveRate + ", gracePeriod=" + gracePeriod + ", amortizedCode="
				+ amortizedCode + ", rateCode=" + rateCode + ", repayFreq=" + repayFreq + ", payIntFreq=" + payIntFreq + ", industryCode=" + industryCode + ", clTypeJCIC=" + clTypeJCIC + ", cityCode="
				+ cityCode + ", prodNo=" + prodNo + ", custKind=" + custKind + ", ifrsProdCode=" + ifrsProdCode + ", evaAmt=" + evaAmt + ", avblBal=" + avblBal + ", recycleCode=" + recycleCode
				+ ", irrevocableFlag=" + irrevocableFlag + ", loanTerm=" + loanTerm + ", acCode=" + acCode + ", acCurcd=" + acCurcd + ", acBookCode=" + acBookCode + ", currencyCode=" + currencyCode
				+ ", exchangeRate=" + exchangeRate + ", lineAmtCurr=" + lineAmtCurr + ", acctFeeCurr=" + acctFeeCurr + ", feeCurr=" + feeCurr + ", createDate=" + createDate + ", createEmpNo="
