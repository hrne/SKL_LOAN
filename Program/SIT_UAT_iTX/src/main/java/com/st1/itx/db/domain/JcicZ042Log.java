...
@Table(name = "`JcicZ042Log`")
public class JcicZ042Log implements Serializable {


  /**
	 * 
	 */
	private static final long serialVersionUID = -7964245686634107455L;

@EmbeddedId
  private JcicZ042LogId jcicZ042LogId;
  ...
  public JcicZ042LogId getJcicZ042LogId() {
    return this.jcicZ042LogId;
  }

  public void setJcicZ042LogId(JcicZ042LogId jcicZ042LogId) {
    this.jcicZ042LogId = jcicZ042LogId;
  }
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicZ042Log [jcicZ042LogId=" + jcicZ042LogId + ", tranKey=" + tranKey + ", isClaims=" + isClaims + ", guarLoanCnt=" + guarLoanCnt + ", expLoanAmt=" + expLoanAmt
           + ", civil323ExpAmt=" + civil323ExpAmt + ", receExpAmt=" + receExpAmt + ", cashCardAmt=" + cashCardAmt + ", civil323CashAmt=" + civil323CashAmt + ", receCashAmt=" + receCashAmt + ", creditCardAmt=" + creditCardAmt
           + ", civil323CreditAmt=" + civil323CreditAmt + ", receCreditAmt=" + receCreditAmt + ", receExpPrin=" + receExpPrin + ", receExpInte=" + receExpInte + ", receExpPena=" + receExpPena + ", receExpOther=" + receExpOther
           + ", cashCardPrin=" + cashCardPrin + ", cashCardInte=" + cashCardInte + ", cashCardPena=" + cashCardPena + ", cashCardOther=" + cashCardOther + ", creditCardPrin=" + creditCardPrin + ", creditCardInte=" + creditCardInte
           + ", creditCardPena=" + creditCardPena + ", creditCardOther=" + creditCardOther + ", outJcicTxtDate=" + outJcicTxtDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
