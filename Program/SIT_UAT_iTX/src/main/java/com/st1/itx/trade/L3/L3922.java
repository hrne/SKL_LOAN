...
public class L3922 extends TradeBuffer {
	private static final Logger logger = LoggerFactory.getLogger(L3922.class);
...
//		}
		...
		if (iCaseCloseCode >= 7) {
			...
			this.baTxList = baTxCom.settingUnPaid(this.txBuffer.getTxCom().getTbsdy(), iCustNo, iFacmNo, iBormNo, 0, BigDecimal.ZERO, titaVo); // 00-費用全部
