...
public class BankDeductDtl implements Serializable {
	...
	// 回應代碼
	/*
	 * 空白:未回, 00:扣款成功, &amp;gt;00 :扣款失敗失敗原因 : ref. CdCode ProcCode 處理說明 ACH : 002 +
	 * ReturnCode(2) 郵局 : 003 + ReturnCode(2)
	 */
	...
	/**
	 * 扣款銀行<br>
	 * L4451建檔交易產生者，此欄位由額度檔抓取 CdCode:BankCdAppl
	 * 
	 * @return String
	 */
	...
	/**
	 * 扣款金額<br>
	 * 期款時撥款會有多筆，多筆sum 扣款金額 = 應扣金額 - 暫收抵繳金額
	 * 
	 * @return BigDecimal
	 */
	...
	/**
	 * 郵局存款別<br>
	 * L4451建檔交易產生者，此欄位由額度檔抓取 CdCode:PostDepCode G: 劃撥 P: 存簿
	 * 
	 * @return String
	 */
	...
	/**
	 * 媒體碼<br>
	 * NA:未產 Y:已產 N:已產，檢核不正常(扣款金額為0，AML…)
	 * 
	 * @return String
	 */
	...
	/**
	 * 與借款人關係<br>
	 * L4451建檔交易產生者，此欄位由額度檔抓取 CdCode:RelationCode
	 * 
	 * @return String
	 */
	...
	/**
	 * 回應代碼<br>
	 * 空白:未回, 00:扣款成功, &amp;gt;00 :扣款失敗 失敗原因 : ref. CdCode ProcCode 處理說明 ACH : 002 +
	 * ReturnCode(2) 郵局 : 003 + ReturnCode(2)
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "BankDeductDtl [bankDeductDtlId=" + bankDeductDtlId + ", prevIntDate=" + prevIntDate + ", acctCode=" + acctCode + ", repayBank=" + repayBank + ", repayAcctNo=" + repayAcctNo
				+ ", repayAcctSeq=" + repayAcctSeq + ", unpaidAmt=" + unpaidAmt + ", tempAmt=" + tempAmt + ", repayAmt=" + repayAmt + ", intStartDate=" + intStartDate + ", intEndDate=" + intEndDate
				+ ", postCode=" + postCode + ", mediaCode=" + mediaCode + ", relationCode=" + relationCode + ", relCustName=" + relCustName + ", relCustId=" + relCustId + ", relAcctBirthday="
				+ relAcctBirthday + ", relAcctGender=" + relAcctGender + ", mediaDate=" + mediaDate + ", mediaKind=" + mediaKind + ", mediaSeq=" + mediaSeq + ", acDate=" + acDate + ", titaTlrNo="
				+ titaTlrNo + ", titaTxtNo=" + titaTxtNo + ", amlRsp=" + amlRsp + ", returnCode=" + returnCode + ", jsonFields=" + jsonFields + ", createDate=" + createDate + ", createEmpNo="
