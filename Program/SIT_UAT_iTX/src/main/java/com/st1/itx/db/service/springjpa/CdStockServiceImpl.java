...
@Repository
public class CdStockServiceImpl implements CdStockService, InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(CdStockServiceImpl.class);
	...
	public CdStock findById(String stockCode, TitaVo... titaVo) {
		...
		logger.info("findById " + dbName + " " + stockCode);
	...
	public Slice<CdStock> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		Pageable pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "StockCode"));
	...
	public CdStock holdById(String stockCode, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + stockCode);
		Optional<CdStock> cdStock = null;
		if (dbName.equals(ContentName.onDay))
	...
	public CdStock holdById(CdStock cdStock, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + cdStock.getStockCode());
	...
	public CdStock insert(CdStock cdStock, TitaVo... titaVo) throws DBException {
		...
		logger.info("Insert..." + dbName + " " + cdStock.getStockCode());
	...
	public CdStock update(CdStock cdStock, TitaVo... titaVo) throws DBException {
		...
		logger.info("Update..." + dbName + " " + cdStock.getStockCode());
		if (!empNot.isEmpty())
	...
	public void delete(CdStock cdStock, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Delete..." + dbName + " " + cdStock.getStockCode());
		if (dbName.equals(ContentName.onDay)) {
