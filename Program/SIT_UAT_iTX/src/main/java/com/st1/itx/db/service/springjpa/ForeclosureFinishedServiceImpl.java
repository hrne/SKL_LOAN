...
@Repository
public class ForeclosureFinishedServiceImpl implements ForeclosureFinishedService, InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(ForeclosureFinishedServiceImpl.class);
	...
	public ForeclosureFinished findById(ForeclosureFinishedId foreclosureFinishedId, TitaVo... titaVo) {
		...
		logger.info("findById " + dbName + " " + foreclosureFinishedId);
	...
	public ForeclosureFinished holdById(ForeclosureFinishedId foreclosureFinishedId, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + foreclosureFinishedId);
		Optional<ForeclosureFinished> foreclosureFinished = null;
		if (dbName.equals(ContentName.onDay))
	...
	public ForeclosureFinished holdById(ForeclosureFinished foreclosureFinished, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + foreclosureFinished.getForeclosureFinishedId());
	...
	public ForeclosureFinished insert(ForeclosureFinished foreclosureFinished, TitaVo... titaVo) throws DBException {
		...
		logger.info("Insert..." + dbName + " " + foreclosureFinished.getForeclosureFinishedId());
	...
	public ForeclosureFinished update(ForeclosureFinished foreclosureFinished, TitaVo... titaVo) throws DBException {
		...
		logger.info("Update..." + dbName + " " + foreclosureFinished.getForeclosureFinishedId());
		if (!empNot.isEmpty())
	...
	public void delete(ForeclosureFinished foreclosureFinished, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Delete..." + dbName + " " + foreclosureFinished.getForeclosureFinishedId());
		if (dbName.equals(ContentName.onDay)) {
