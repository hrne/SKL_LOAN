...
em = null;
  ...
  public Slice<AcReceivable> acrvClsFlagSubBook(int clsFlag_0, String acBookCode_1, String acSubBookCode_2, String branchNo_3, String currencyCode_4, String acNoCode_5, String acSubCode_6, String acDtlCode_7, int custNo_8, int custNo_9, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      ...
      slice = acReceivableReposMon.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndBranchNoIsAndCurrencyCodeIsAndAcNoCodeIsAndAcSubCodeIsAndAcDtlCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAsc(clsFlag_0, acBookCode_1, acSubBookCode_2, branchNo_3, currencyCode_4, acNoCode_5, acSubCode_6, acDtlCode_7, custNo_8, custNo_9, pageable);
    else if (dbName.equals(ContentName.onHist))
  ...
  public Slice<AcReceivable> acrvFacmNoSubBook(int clsFlag_0, String acBookCode_1, String acSubBookCode_2, int custNo_3, int acctFlag_4, int facmNo_5, int facmNo_6, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      ...
      slice = acReceivableReposMon.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByOpenAcDateAsc(clsFlag_0, acBookCode_1, acSubBookCode_2, custNo_3, acctFlag_4, facmNo_5, facmNo_6, pageable);
    else if (dbName.equals(ContentName.onHist))
  ...
  public Slice<AcReceivable> acctCodeSubBook(int clsFlag_0, String acBookCode_1, String acSubBookCode_2, String acctCode_3, int custNo_4, int custNo_5, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      ...
      slice = acReceivableReposMon.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndAcctCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAsc(clsFlag_0, acBookCode_1, acSubBookCode_2, acctCode_3, custNo_4, custNo_5, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = acReceivableReposHist.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndAcctCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAsc(clsFlag_0, acBookCode_1, acSubBookCode_2, acctCode_3, custNo_4, custNo_5, pageable);
    else 
