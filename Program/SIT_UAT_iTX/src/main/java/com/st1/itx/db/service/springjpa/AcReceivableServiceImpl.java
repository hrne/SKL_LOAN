...
public class AcReceivableServiceImpl extends ASpringJpaParm implements AcReceivableService, InitializingBean {
	...
	public Slice<AcReceivable> acrvFacmNoRange(int clsFlag_0, int custNo_1, int acctFlag_2, int facmNo_3, int facmNo_4, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = acReceivableReposDay.findAllByClsFlagIsAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByOpenAcDateAsc(clsFlag_0, custNo_1, acctFlag_2, facmNo_3,
					facmNo_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = acReceivableReposMon.findAllByClsFlagIsAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByOpenAcDateAsc(clsFlag_0, custNo_1, acctFlag_2, facmNo_3,
					facmNo_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = acReceivableReposHist.findAllByClsFlagIsAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByOpenAcDateAsc(clsFlag_0, custNo_1, acctFlag_2, facmNo_3,
					facmNo_4, pageable);
		else
			slice = acReceivableRepos.findAllByClsFlagIsAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByOpenAcDateAsc(clsFlag_0, custNo_1, acctFlag_2, facmNo_3, facmNo_4,
					pageable);
	...
	public Slice<AcReceivable> acrvFacmNoSubBook(int clsFlag_0, String acBookCode_1, String acSubBookCode_2, int custNo_3, int acctFlag_4, int facmNo_5, int facmNo_6, int index, int limit,
		...
		if (dbName.equals(ContentName.onDay))
			slice = acReceivableReposDay.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByOpenAcDateAsc(clsFlag_0,
					acBookCode_1, acSubBookCode_2, custNo_3, acctFlag_4, facmNo_5, facmNo_6, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = acReceivableReposMon.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByOpenAcDateAsc(clsFlag_0,
					acBookCode_1, acSubBookCode_2, custNo_3, acctFlag_4, facmNo_5, facmNo_6, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = acReceivableReposHist.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByOpenAcDateAsc(clsFlag_0,
					acBookCode_1, acSubBookCode_2, custNo_3, acctFlag_4, facmNo_5, facmNo_6, pageable);
		else
			slice = acReceivableRepos.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByOpenAcDateAsc(clsFlag_0,
					acBookCode_1, acSubBookCode_2, custNo_3, acctFlag_4, facmNo_5, facmNo_6, pageable);
	...
	public Slice<AcReceivable> acctCodeSubBook(int clsFlag_0, String acBookCode_1, String acSubBookCode_2, String acctCode_3, int custNo_4, int custNo_5, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = acReceivableReposDay.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndAcctCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAsc(clsFlag_0,
					acBookCode_1, acSubBookCode_2, acctCode_3, custNo_4, custNo_5, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = acReceivableReposMon.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndAcctCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAsc(clsFlag_0,
					acBookCode_1, acSubBookCode_2, acctCode_3, custNo_4, custNo_5, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = acReceivableReposHist.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndAcctCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAsc(clsFlag_0,
					acBookCode_1, acSubBookCode_2, acctCode_3, custNo_4, custNo_5, pageable);
		else
			slice = acReceivableRepos.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndAcctCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAsc(clsFlag_0,
					acBookCode_1, acSubBookCode_2, acctCode_3, custNo_4, custNo_5, pageable);
