...
public class TxAmlCredit implements Serializable {
	...
	public String toString() {
		return "TxAmlCredit [txAmlCreditId=" + txAmlCreditId + ", rRSeq=" + rRSeq + ", reviewType=" + reviewType + ", unit=" + unit + ", isStatus=" + isStatus + ", wlfConfirmStatus="
				+ wlfConfirmStatus + ", processType=" + processType + ", processCount=" + processCount + ", processBrNo=" + processBrNo + ", processGroupNo=" + processGroupNo + ", processTlrNo="
				+ processTlrNo + ", processDate=" + processDate + ", processMobile=" + processMobile + ", processAddress=" + processAddress + ", processName=" + processName + ", processNote="
				+ processNote + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
