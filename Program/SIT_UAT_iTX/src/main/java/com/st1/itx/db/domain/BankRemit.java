...
@EmbeddedId
  ...
  // 付款狀況碼
  /* I:建檔O:確認C:建檔取消A:已開票D:支票到期B:退件S:請款單位擋匯T:網銀擋匯W:匯款途中F:匯款失敗H:支票兌領/匯款成功R:退匯/退回情況改變成作廢L:支票掛失V:支票作廢J:空白票遺失Z:逾一年未兌領Y:逾二年未兌領P:繳款成功X:付款沖回Q:AML相似名單確認中U:禁止交易(AML) */
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "BankRemit [bankRemitId=" + bankRemitId + ", batchNo=" + batchNo + ", drawdownCode=" + drawdownCode + ", statusCode=" + statusCode
           ...
           + ", modifyContent=" + modifyContent + ", payCode=" + payCode + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
           + "]";
  }
}
