...
public class LoanBorTx implements Serializable {
	...
	/**
	 * 還款來源<br>
	 * CdCode.RepayCode 01 匯款轉帳 02 銀行扣款 03 員工扣薪 04 支票 05 特約金 06 人事特約金 07 定存特約 08
	 * 劃撥存款 09 其他
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "LoanBorTx [loanBorTxId=" + loanBorTxId + ", titaCalDy=" + titaCalDy + ", titaCalTm=" + titaCalTm + ", titaKinBr=" + titaKinBr + ", titaTlrNo=" + titaTlrNo + ", titaTxtNo=" + titaTxtNo
				+ ", titaTxCd=" + titaTxCd + ", titaCrDb=" + titaCrDb + ", titaHCode=" + titaHCode + ", titaCurCd=" + titaCurCd + ", titaEmpNoS=" + titaEmpNoS + ", repayCode=" + repayCode + ", desc="
				+ desc + ", acDate=" + acDate + ", correctSeq=" + correctSeq + ", displayflag=" + displayflag + ", entryDate=" + entryDate + ", dueDate=" + dueDate + ", txAmt=" + txAmt + ", loanBal="
				+ loanBal + ", intStartDate=" + intStartDate + ", intEndDate=" + intEndDate + ", repaidPeriod=" + repaidPeriod + ", rate=" + rate + ", principal=" + principal + ", interest="
				+ interest + ", delayInt=" + delayInt + ", breachAmt=" + breachAmt + ", closeBreachAmt=" + closeBreachAmt + ", tempAmt=" + tempAmt + ", extraRepay=" + extraRepay + ", unpaidInterest="
				+ unpaidInterest + ", unpaidPrincipal=" + unpaidPrincipal + ", unpaidCloseBreach=" + unpaidCloseBreach + ", shortfall=" + shortfall + ", overflow=" + overflow + ", otherFields="
				+ otherFields + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
