...
@Repository
public class PfCoOfficerServiceImpl implements PfCoOfficerService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(PfCoOfficerServiceImpl.class);
  ...
  public PfCoOfficer findById(PfCoOfficerId pfCoOfficerId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + pfCoOfficerId);
...
em = null;
  ...
  public PfCoOfficer EffectiveDateFirst(String empNo_0, int effectiveDate_1, int effectiveDate_2, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("EffectiveDateFirst " + dbName + " : " + "empNo_0 : " + empNo_0 + " effectiveDate_1 : " +  effectiveDate_1 + " effectiveDate_2 : " +  effectiveDate_2);
  ...
  public PfCoOfficer findByEmpNoFirst(String empNo_0, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("findByEmpNoFirst " + dbName + " : " + "empNo_0 : " + empNo_0);
    Optional<PfCoOfficer> pfCoOfficerT = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public PfCoOfficer holdById(PfCoOfficerId pfCoOfficerId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + pfCoOfficerId);
    Optional<PfCoOfficer> pfCoOfficer = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public PfCoOfficer holdById(PfCoOfficer pfCoOfficer, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + pfCoOfficer.getPfCoOfficerId());
    Optional<PfCoOfficer> pfCoOfficerT = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public PfCoOfficer insert(PfCoOfficer pfCoOfficer, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + pfCoOfficer.getPfCoOfficerId());
  ...
  public PfCoOfficer update(PfCoOfficer pfCoOfficer, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + pfCoOfficer.getPfCoOfficerId());
    if (!empNot.isEmpty())
      pfCoOfficer.setLastUpdateEmpNo(empNot);
  ...
  public void delete(PfCoOfficer pfCoOfficer, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + pfCoOfficer.getPfCoOfficerId());
    if (dbName.equals(ContentName.onDay)) {
