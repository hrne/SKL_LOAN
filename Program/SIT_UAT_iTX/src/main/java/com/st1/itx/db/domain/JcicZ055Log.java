...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicZ055Log [jcicZ055LogId=" + jcicZ055LogId + ", tranKey=" + tranKey + ", year=" + year + ", courtDiv=" + courtDiv + ", courtCaseNo=" + courtCaseNo
           + ", payDate=" + payDate + ", payEndDate=" + payEndDate + ", period=" + period + ", rate=" + rate + ", outstandAmt=" + outstandAmt + ", subAmt=" + subAmt
           + ", claimStatus1=" + claimStatus1 + ", saveDate=" + saveDate + ", claimStatus2=" + claimStatus2 + ", saveEndDate=" + saveEndDate + ", isImplement=" + isImplement + ", inspectName=" + inspectName
