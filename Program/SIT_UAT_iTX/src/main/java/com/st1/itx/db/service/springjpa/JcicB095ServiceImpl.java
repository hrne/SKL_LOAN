...
@Repository
public class JcicB095ServiceImpl implements JcicB095Service, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(JcicB095ServiceImpl.class);
  ...
  public JcicB095 findById(JcicB095Id jcicB095Id, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + jcicB095Id);
...
em = null;
  ...
  public JcicB095 holdById(JcicB095Id jcicB095Id, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicB095Id);
    Optional<JcicB095> jcicB095 = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicB095 holdById(JcicB095 jcicB095, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicB095.getJcicB095Id());
  ...
  public JcicB095 insert(JcicB095 jcicB095, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + jcicB095.getJcicB095Id());
  ...
  public JcicB095 update(JcicB095 jcicB095, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + jcicB095.getJcicB095Id());
    if (!empNot.isEmpty())
      jcicB095.setLastUpdateEmpNo(empNot);
  ...
  public void delete(JcicB095 jcicB095, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + jcicB095.getJcicB095Id());
    if (dbName.equals(ContentName.onDay)) {
