...
public class JobDetail implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = 3283012416465519062L;
...
/**
  ...
  * @param lastUpdate 最後維護日期
  ...
  public String toString() {
    return "JobDetail [jobDetailId=" + jobDetailId + ", batchType=" + batchType + ", status=" + status + ", errCode=" + errCode
           + ", errContent=" + errContent + ", stepStartTime=" + stepStartTime + ", stepEndTime=" + stepEndTime + ", createEmpNo=" + createEmpNo + ", createDate=" + createDate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
