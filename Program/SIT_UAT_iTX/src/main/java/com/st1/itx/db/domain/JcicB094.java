...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicB094 [jcicB094Id=" + jcicB094Id + ", dataType=" + dataType + ", bankItem=" + bankItem + ", branchItem=" + branchItem + ", filler4=" + filler4
           + ", clTypeJCIC=" + clTypeJCIC + ", evaAmt=" + evaAmt + ", evaDate=" + evaDate + ", loanLimitAmt=" + loanLimitAmt + ", settingDate=" + settingDate
           + ", companyCountry=" + companyCountry + ", currency=" + currency + ", settingBalance=" + settingBalance
           + ", loanBal=" + loanBal + ", insiderJobTitle=" + insiderJobTitle + ", insiderPosition=" + insiderPosition + ", legalPersonId=" + legalPersonId + ", dispPrice=" + dispPrice + ", filler19=" + filler19
