...
public class TxTeller implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3181474192232795693L;
...
// 使用者編號
	...
	public String toString() {
		return "TxTeller [tlrNo=" + tlrNo + ", brNo=" + brNo + ", adFg=" + adFg + ", tlrItem=" + tlrItem + ", levelFg=" + levelFg + ", status=" + status + ", groupNo=" + groupNo + ", authNo=" + authNo
				+ ", entdy=" + entdy + ", reportDb=" + reportDb + ", logonFg=" + logonFg + ", loggerFg=" + loggerFg + ", txtNo=" + txtNo + ", ltxDate=" + ltxDate + ", ltxTime=" + ltxTime + ", desc="
				+ desc + ", lastDate=" + lastDate + ", lastTime=" + lastTime + ", amlHighFg=" + amlHighFg + ", authNo1=" + authNo1 + ", authNo2=" + authNo2 + ", authNo3=" + authNo3 + ", authNo4="
				+ authNo4 + ", authNo5=" + authNo5 + ", authNo6=" + authNo6 + ", authNo7=" + authNo7 + ", authNo8=" + authNo8 + ", authNo9=" + authNo9 + ", authNo10=" + authNo10 + ", createDate="
