...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "CdAcBook [cdAcBookId=" + cdAcBookId + ", currencyCode=" + currencyCode + ", targetAmt=" + targetAmt + ", actualAmt=" + actualAmt + ", assignSeq=" + assignSeq
           + ", acctSource=" + acctSource + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
  }
}
