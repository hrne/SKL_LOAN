...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicZ049Log [jcicZ049LogId=" + jcicZ049LogId + ", tranKey=" + tranKey + ", claimStatus=" + claimStatus + ", applyDate=" + applyDate + ", courtCode=" + courtCode
           + ", year=" + year + ", courtDiv=" + courtDiv + ", courtCaseNo=" + courtCaseNo + ", approve=" + approve + ", claimDate=" + claimDate + ", outJcicTxtDate=" + outJcicTxtDate
