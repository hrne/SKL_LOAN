...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "CollListTmp [collListTmpId=" + collListTmpId + ", clCustNo=" + clCustNo
           + ", clFacmNo=" + clFacmNo + ", clRowNo=" + clRowNo + ", caseCode=" + caseCode + ", prevIntDate=" + prevIntDate + ", nextIntDate=" + nextIntDate + ", currencyCode=" + currencyCode
           + ", prinBalance=" + prinBalance + ", badDebtBal=" + badDebtBal + ", status=" + status + ", acctCode=" + acctCode + ", facAcctCode=" + facAcctCode + ", renewCode=" + renewCode
           + ", acDate=" + acDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
  }
}
