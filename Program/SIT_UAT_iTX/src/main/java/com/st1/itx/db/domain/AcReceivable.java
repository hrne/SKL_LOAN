...
public class AcReceivable implements Serializable {
	 ...
	 * ：撥款序號(3)10.'FacmNo'+額度編號(暫收款－借新還舊)11.聯貸手續費:SL-費用代號(2)-流水號(3)-攤提年月(YYYMM)
	 */
	 ...
	 * 9.短繳期金：撥款序號(3) 10.'FacmNo'+額度編號(暫收款－借新還舊)
	...
	public String toString() {
		return "AcReceivable [acReceivableId=" + acReceivableId + ", acNoCode=" + acNoCode + ", acSubCode=" + acSubCode + ", acDtlCode=" + acDtlCode + ", branchNo=" + branchNo + ", currencyCode="
				...
				+ slipNote + ", acBookCode=" + acBookCode + ", acSubBookCode=" + acSubBookCode + ", openAcDate=" + openAcDate + ", lastAcDate=" + lastAcDate + ", lastTxDate=" + lastTxDate
				+ ", titaTxCd=" + titaTxCd + ", titaKinBr=" + titaKinBr + ", titaTlrNo=" + titaTlrNo + ", titaTxtNo=" + titaTxtNo + ", jsonFields=" + jsonFields + ", createEmpNo=" + createEmpNo
