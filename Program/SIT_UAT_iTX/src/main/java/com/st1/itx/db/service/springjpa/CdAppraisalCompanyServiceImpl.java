...
@Repository
public class CdAppraisalCompanyServiceImpl implements CdAppraisalCompanyService, InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(CdAppraisalCompanyServiceImpl.class);
	...
	public CdAppraisalCompany findById(String appraisalCompany, TitaVo... titaVo) {
		...
		logger.info("findById " + dbName + " " + appraisalCompany);
	...
	public Slice<CdAppraisalCompany> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		Pageable pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "AppraisalCompany"));
	...
	public CdAppraisalCompany holdById(String appraisalCompany, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + appraisalCompany);
		Optional<CdAppraisalCompany> cdAppraisalCompany = null;
		if (dbName.equals(ContentName.onDay))
	...
	public CdAppraisalCompany holdById(CdAppraisalCompany cdAppraisalCompany, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + cdAppraisalCompany.getAppraisalCompany());
	...
	public CdAppraisalCompany insert(CdAppraisalCompany cdAppraisalCompany, TitaVo... titaVo) throws DBException {
		...
		logger.info("Insert..." + dbName + " " + cdAppraisalCompany.getAppraisalCompany());
	...
	public CdAppraisalCompany update(CdAppraisalCompany cdAppraisalCompany, TitaVo... titaVo) throws DBException {
		...
		logger.info("Update..." + dbName + " " + cdAppraisalCompany.getAppraisalCompany());
		if (!empNot.isEmpty())
	...
	public void delete(CdAppraisalCompany cdAppraisalCompany, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Delete..." + dbName + " " + cdAppraisalCompany.getAppraisalCompany());
		if (dbName.equals(ContentName.onDay)) {
