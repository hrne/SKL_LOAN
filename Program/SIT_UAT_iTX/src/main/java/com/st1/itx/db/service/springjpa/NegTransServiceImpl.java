...
@Repository
public class NegTransServiceImpl implements NegTransService, InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(NegTransServiceImpl.class);
	...
	public NegTrans findById(NegTransId negTransId, TitaVo... titaVo) {
		...
		logger.info("findById " + dbName + " " + negTransId);
	...
	public Slice<NegTrans> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		Pageable pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "AcDate", "TitaTlrNo", "TitaTxtNo"));
	...
	public Slice<NegTrans> custAndAcDate(int custNo_0, int acDate_1, int acDate_2, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("custAndAcDate " + dbName + " : " + "custNo_0 : " + custNo_0 + " acDate_1 : " + acDate_1 + " acDate_2 : " + acDate_2);
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<NegTrans> entryDateBetween(int entryDate_0, int entryDate_1, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("entryDateBetween " + dbName + " : " + "entryDate_0 : " + entryDate_0 + " entryDate_1 : " + entryDate_1);
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<NegTrans> custAndEntryDate(int custNo_0, int entryDate_1, int entryDate_2, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("custAndEntryDate " + dbName + " : " + "custNo_0 : " + custNo_0 + " entryDate_1 : " + entryDate_1 + " entryDate_2 : " + entryDate_2);
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<NegTrans> TxStatusBetween(int txStatus_0, int txStatus_1, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("TxStatusBetween " + dbName + " : " + "txStatus_0 : " + txStatus_0 + " txStatus_1 : " + txStatus_1);
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<NegTrans> TxStatusDateEq(int txStatus_0, int repayDate_1, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("TxStatusDateEq " + dbName + " : " + "txStatus_0 : " + txStatus_0 + " repayDate_1 : " + repayDate_1);
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<NegTrans> RepayDateBetween(int repayDate_0, int repayDate_1, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("RepayDateBetween " + dbName + " : " + "repayDate_0 : " + repayDate_0 + " repayDate_1 : " + repayDate_1);
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<NegTrans> RepayDateEq(int repayDate_0, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("RepayDateEq " + dbName + " : " + "repayDate_0 : " + repayDate_0);
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<NegTrans> ExportDateEq(int exportDate_0, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("ExportDateEq " + dbName + " : " + "exportDate_0 : " + exportDate_0);
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<NegTrans> ExportAcDateEq(int exportAcDate_0, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("ExportAcDateEq " + dbName + " : " + "exportAcDate_0 : " + exportAcDate_0);
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<NegTrans> BackFunc(int thisEntdy_0, String thisKinbr_1, String thisTlrNo_2, String thisTxtNo_3, String thisSeqNo_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("BackFunc " + dbName + " : " + "thisEntdy_0 : " + thisEntdy_0 + " thisKinbr_1 : " + thisKinbr_1 + " thisTlrNo_2 : " + thisTlrNo_2 + " thisTxtNo_3 : " + thisTxtNo_3
				+ " thisSeqNo_4 : " + thisSeqNo_4);
		if (dbName.equals(ContentName.onDay))
			slice = negTransReposDay.findAllByThisEntdyIsAndThisKinbrIsAndThisTlrNoIsAndThisTxtNoIsAndThisSeqNoIsOrderByThisEntdyAscThisSeqNoAsc(thisEntdy_0, thisKinbr_1, thisTlrNo_2, thisTxtNo_3,
					thisSeqNo_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = negTransReposMon.findAllByThisEntdyIsAndThisKinbrIsAndThisTlrNoIsAndThisTxtNoIsAndThisSeqNoIsOrderByThisEntdyAscThisSeqNoAsc(thisEntdy_0, thisKinbr_1, thisTlrNo_2, thisTxtNo_3,
					thisSeqNo_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = negTransReposHist.findAllByThisEntdyIsAndThisKinbrIsAndThisTlrNoIsAndThisTxtNoIsAndThisSeqNoIsOrderByThisEntdyAscThisSeqNoAsc(thisEntdy_0, thisKinbr_1, thisTlrNo_2, thisTxtNo_3,
					thisSeqNo_4, pageable);
		else
			slice = negTransRepos.findAllByThisEntdyIsAndThisKinbrIsAndThisTlrNoIsAndThisTxtNoIsAndThisSeqNoIsOrderByThisEntdyAscThisSeqNoAsc(thisEntdy_0, thisKinbr_1, thisTlrNo_2, thisTxtNo_3,
					thisSeqNo_4, pageable);
	...
	public NegTrans holdById(NegTransId negTransId, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + negTransId);
		Optional<NegTrans> negTrans = null;
		if (dbName.equals(ContentName.onDay))
	...
	public NegTrans holdById(NegTrans negTrans, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + negTrans.getNegTransId());
	...
	public NegTrans insert(NegTrans negTrans, TitaVo... titaVo) throws DBException {
		...
		logger.info("Insert..." + dbName + " " + negTrans.getNegTransId());
	...
	public NegTrans update(NegTrans negTrans, TitaVo... titaVo) throws DBException {
		...
		logger.info("Update..." + dbName + " " + negTrans.getNegTransId());
		if (!empNot.isEmpty())
	...
	public void delete(NegTrans negTrans, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Delete..." + dbName + " " + negTrans.getNegTransId());
		if (dbName.equals(ContentName.onDay)) {
