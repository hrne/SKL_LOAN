...
em = null;
  ...
  public Slice<CdBuildingCost> findAll(int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by(Sort.Direction.ASC, "CityCode", "Material", "FloorLowerLimit", "VersionDate"));
    else
         pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "CityCode", "Material", "FloorLowerLimit", "VersionDate"));
  ...
  public CdBuildingCost insert(CdBuildingCost cdBuildingCost, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(cdBuildingCost.getCdBuildingCostId(), titaVo) != null)
