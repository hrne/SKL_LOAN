...
@Repository
public class TxAmlLogServiceImpl implements TxAmlLogService, InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(TxAmlLogServiceImpl.class);
	...
	public Slice<TxAmlLog> findByConfirmStatus(String brNo_0, String confirmStatus_1, int entdy_2, int entdy_3, int index, int limit, TitaVo... titaVo) {
		...
		logger.info("findByConfirmStatus " + dbName + " : " + "brNo_0 : " + brNo_0 + " confirmStatus_1 : " + confirmStatus_1 + " entdy_2 : " + entdy_2 + " entdy_3 : " + entdy_3);
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<TxAmlLog> findByBrNo(String brNo_0, int entdy_1, int entdy_2, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		logger.info("findByBrNo " + dbName + " : " + "brNo_0 : " + brNo_0 + " entdy_1 : " + entdy_1 + " entdy_2 : " + entdy_2);
		if (dbName.equals(ContentName.onDay))
	...
	public TxAmlLog findByTransactionIdFirst(int entdy_0, String transactionId_1, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("findByTransactionIdFirst " + dbName + " : " + "entdy_0 : " + entdy_0 + " transactionId_1 : " + transactionId_1);
	...
	public TxAmlLog holdById(TxAmlLog txAmlLog, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + txAmlLog.getLogNo());
		Optional<TxAmlLog> txAmlLogT = null;
		if (dbName.equals(ContentName.onDay))
	...
	public TxAmlLog insert(TxAmlLog txAmlLog, TitaVo... titaVo) throws DBException {
		...
		logger.info("Insert..." + dbName + " " + txAmlLog.getLogNo());
	...
	public TxAmlLog update(TxAmlLog txAmlLog, TitaVo... titaVo) throws DBException {
		...
		logger.info("Update..." + dbName + " " + txAmlLog.getLogNo());
		if (!empNot.isEmpty())
	...
	public void delete(TxAmlLog txAmlLog, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Delete..." + dbName + " " + txAmlLog.getLogNo());
		if (dbName.equals(ContentName.onDay)) {
