...
// 序號
	...
	public String toString() {
		return "PfBsDetailAdjust [logNo=" + logNo + ", custNo=" + custNo + ", facmNo=" + facmNo + ", bormNo=" + bormNo + ", workMonth=" + workMonth + ", workSeason=" + workSeason + ", adjPerfCnt="
				+ adjPerfCnt + ", adjPerfAmt=" + adjPerfAmt + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
				+ "]";
	}
}
