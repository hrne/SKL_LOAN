...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicZ040Log [jcicZ040LogId=" + jcicZ040LogId + ", tranKey=" + tranKey + ", rbDate=" + rbDate + ", applyType=" + applyType + ", refBankId=" + refBankId
           + ", notBankId1=" + notBankId1 + ", notBankId2=" + notBankId2 + ", notBankId3=" + notBankId3 + ", notBankId4=" + notBankId4 + ", notBankId5=" + notBankId5 + ", notBankId6=" + notBankId6
