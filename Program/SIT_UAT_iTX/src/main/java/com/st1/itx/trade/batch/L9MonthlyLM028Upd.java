 ...
 * @version 1.0.0
 */
public class L9MonthlyLM028Upd extends BatchBase implements Tasklet, InitializingBean {
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		// logger = LoggerFactory.getLogger(L9MonthlyLM028Upd.class);
	...
	public void run() throws LogicException {
		this.info("active L9MonthlyLM028Upd ");
...
//		this.titaVo.putParam(ContentName.dataBase, ContentName.onLine);
		...
		sJobMainService.Usp_L9_MonthlyLM028_Upd(tbsdyf, empNo, titaVo);
	}
