...
@Service
@Repository
public class LM075ServiceImpl extends ASpringJpaParm implements InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(LM075ServiceImpl.class);
	...
	public List<Map<String, String>> findAll(TitaVo titaVo, String RptMonth) throws Exception {
		logger.info("LM075.findAll ");
		logger.info("LM075ServiceImpl RptMonth: " + RptMonth);
        ...
        sql += "                      AND fac.\"RuleCode\" IN ('01','02','03','04','05')";
