...
@EmbeddedId
  ...
  // 資產五分類代號(有擔保部分)
  /* 11=一之1,   12=一之2,21=二之1,   22=二之2,   23=二之3,3=三  4=四   5=五此為有擔保金額(PrinBalance-LawAmount)的分類 */
  ...
  * @param acSubBookCode 區隔帳冊
  ...
  public String toString() {
    return "MonthlyFacBal [monthlyFacBalId=" + monthlyFacBalId + ", prevIntDate=" + prevIntDate + ", nextIntDate=" + nextIntDate + ", dueDate=" + dueDate
           ...
           + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + ", acSubBookCode=" + acSubBookCode + "]";
  }
}
