...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "BatxCheque [batxChequeId=" + batxChequeId + ", chequeAmt=" + chequeAmt + ", custNo=" + custNo
           + ", statusCode=" + statusCode + ", adjDate=" + adjDate + ", titaTlrNo=" + titaTlrNo + ", titaTxtNo=" + titaTxtNo + ", chequeDate=" + chequeDate + ", entryDate=" + entryDate
           + ", processCode=" + processCode + ", outsideCode=" + outsideCode + ", mediaCode=" + mediaCode + ", bankCode=" + bankCode + ", mediaBatchNo=" + mediaBatchNo + ", officeCode=" + officeCode
           + ", exchangeAreaCode=" + exchangeAreaCode + ", chequeId=" + chequeId + ", chequeName=" + chequeName + ", amlRsp=" + amlRsp + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
