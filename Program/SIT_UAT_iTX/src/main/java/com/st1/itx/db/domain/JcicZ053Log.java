  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicZ053Log [jcicZ053LogId=" + jcicZ053LogId + ", tranKey=" + tranKey + ", agreeSend=" + agreeSend + ", agreeSendData1=" + agreeSendData1 + ", agreeSendData2=" + agreeSendData2
           + ", changePayDate=" + changePayDate + ", outJcicTxtDate=" + outJcicTxtDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
           + "]";
  }
}
