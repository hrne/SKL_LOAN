...
public class ClFacServiceImpl extends ASpringJpaParm implements ClFacService, InitializingBean {
	...
	public Slice<ClFac> findRange(int approveNo_0, int approveNo_1, int facmNo_2, int facmNo_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = clFacReposDay.findAllByApproveNoGreaterThanEqualAndApproveNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByClCode1AscClCode2AscClNoAscApproveNoAsc(approveNo_0,
					approveNo_1, facmNo_2, facmNo_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = clFacReposMon.findAllByApproveNoGreaterThanEqualAndApproveNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByClCode1AscClCode2AscClNoAscApproveNoAsc(approveNo_0,
					approveNo_1, facmNo_2, facmNo_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = clFacReposHist.findAllByApproveNoGreaterThanEqualAndApproveNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByClCode1AscClCode2AscClNoAscApproveNoAsc(approveNo_0,
					approveNo_1, facmNo_2, facmNo_3, pageable);
		else
			slice = clFacRepos.findAllByApproveNoGreaterThanEqualAndApproveNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByClCode1AscClCode2AscClNoAscApproveNoAsc(approveNo_0,
					approveNo_1, facmNo_2, facmNo_3, pageable);
	...
	@Override
	public Slice<ClFac> selectForL2038(int clCode1_0, int clCode2_1, int clNo_2, int approveNo_3, int approveNo_4, int custNo_5, int custNo_6, int facmNo_7, int facmNo_8, int index, int limit,
			TitaVo... titaVo) {
		String dbName = "";
		Slice<ClFac> slice = null;
		if (titaVo.length != 0)
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("selectForL2038 " + dbName + " : " + "clCode1_0 : " + clCode1_0 + " clCode2_1 : " + clCode2_1 + " clNo_2 : " + clNo_2 + " approveNo_3 : " + approveNo_3 + " approveNo_4 : "
				+ approveNo_4 + " custNo_5 : " + custNo_5 + " custNo_6 : " + custNo_6 + " facmNo_7 : " + facmNo_7 + " facmNo_8 : " + facmNo_8);
		if (dbName.equals(ContentName.onDay))
			slice = clFacReposDay
					.findAllByClCode1IsAndClCode2IsAndClNoIsAndApproveNoGreaterThanEqualAndApproveNoLessThanEqualAndCustNoGreaterThanEqualAndCustNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByClCode1AscClCode2AscClNoAscApproveNoAsc(
	...
	@Override
	public Slice<ClFac> selectForL2049(int clCode1_0, int clCode1_1, int clCode2_2, int clCode2_3, int clNo_4, int clNo_5, int custNo_6, int custNo_7, int facmNo_8, int facmNo_9, int approveNo_10,
			int approveNo_11, int index, int limit, TitaVo... titaVo) {
		String dbName = "";
		Slice<ClFac> slice = null;
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("selectForL2049 " + dbName + " : " + "clCode1_0 : " + clCode1_0 + " clCode1_1 : " + clCode1_1 + " clCode2_2 : " + clCode2_2 + " clCode2_3 : " + clCode2_3 + " clNo_4 : " + clNo_4
				+ " clNo_5 : " + clNo_5 + " custNo_6 : " + custNo_6 + " custNo_7 : " + custNo_7 + " facmNo_8 : " + facmNo_8 + " facmNo_9 : " + facmNo_9 + " approveNo_10 : " + approveNo_10
				+ " approveNo_11 : " + approveNo_11);
		if (dbName.equals(ContentName.onDay))
			slice = clFacReposDay
					.(
							clCode1_0, clCode1_1, clCode2_2, clCode2_3, clNo_4, clNo_5, custNo_6, custNo_7, facmNo_8, facmNo_9, approveNo_10, approveNo_11, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = clFacReposMon
					.(
							clCode1_0, clCode1_1, clCode2_2, clCode2_3, clNo_4, clNo_5, custNo_6, custNo_7, facmNo_8, facmNo_9, approveNo_10, approveNo_11, pageable);
