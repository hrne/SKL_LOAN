...
public class Ifrs9LoanData implements Serializable {
	...
	/**
	 * 業務科目代號<br>
	 * 310: 短期擔保放款 320: 中期擔保放款 330: 長期擔保放款 340: 三十年房貸 990: 催收款項
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "Ifrs9LoanData [ifrs9LoanDataId=" + ifrs9LoanDataId + ", custId=" + custId + ", acctCode=" + acctCode + ", acCode=" + acCode + ", acCodeOld=" + acCodeOld + ", status=" + status
				+ ", drawdownDate=" + drawdownDate + ", maturityDate=" + maturityDate + ", drawdownAmt=" + drawdownAmt + ", loanBal=" + loanBal + ", intAmt=" + intAmt + ", rate=" + rate
				+ ", ovduDays=" + ovduDays + ", ovduDate=" + ovduDate + ", badDebtDate=" + badDebtDate + ", badDebtAmt=" + badDebtAmt + ", approveRate=" + approveRate + ", amortizedCode="
				+ amortizedCode + ", rateCode=" + rateCode + ", repayFreq=" + repayFreq + ", payIntFreq=" + payIntFreq + ", firstDueDate=" + firstDueDate + ", totalPeriod=" + totalPeriod
				+ ", agreeBefFacmNo=" + agreeBefFacmNo + ", agreeBefBormNo=" + agreeBefBormNo + ", acBookCode=" + acBookCode + ", prevPayIntDate=" + prevPayIntDate + ", createDate=" + createDate
