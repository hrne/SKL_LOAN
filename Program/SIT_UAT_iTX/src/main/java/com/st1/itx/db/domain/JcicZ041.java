...
public class JcicZ041 implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -438645559001352958L;
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicZ041 [jcicZ041Id=" + jcicZ041Id + ", tranKey=" + tranKey + ", scDate=" + scDate + ", negoStartDate=" + negoStartDate
           + ", nonFinClaimAmt=" + nonFinClaimAmt + ", outJcicTxtDate=" + outJcicTxtDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
           + "]";
  }
}
