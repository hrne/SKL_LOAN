...
em = null;
  ...
  public Slice<NegAppr01> findBatch(String batchTxtNo_0, String finCode_1, int apprDate_2, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      ...
      slice = negAppr01ReposMon.findAllByBatchTxtNoIsAndFinCodeIsAndApprDateIs(batchTxtNo_0, finCode_1, apprDate_2, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = negAppr01ReposHist.findAllByBatchTxtNoIsAndFinCodeIsAndApprDateIs(batchTxtNo_0, finCode_1, apprDate_2, pageable);
    else 
      slice = negAppr01Repos.findAllByBatchTxtNoIsAndFinCodeIsAndApprDateIs(batchTxtNo_0, finCode_1, apprDate_2, pageable);
