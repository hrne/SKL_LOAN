...
public class LM082ServiceImpl extends ASpringJpaParm implements InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(LM082ServiceImpl.class);
	...
	public List<Map<String, String>> findAll(TitaVo titaVo, String RptMonth) throws Exception {
		logger.info("LM082.findAll ");
		logger.info("LM082ServiceImpl RptMonth: " + RptMonth);
        ...
        sql += "                      AND fac.\"RuleCode\" IN ('01','02','04')";
