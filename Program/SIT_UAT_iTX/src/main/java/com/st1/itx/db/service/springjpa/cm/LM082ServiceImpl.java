...
@Service
@Repository
public class LM082ServiceImpl extends ASpringJpaParm implements InitializingBean {
	...
	public List<Map<String, String>> findAll(TitaVo titaVo, int RptMonth, int ApplDateStart, int ApplDateEnd, String... RuleCode) throws Exception {
		this.info("LM082.findAll ");
		this.info("LM082ServiceImpl RptMonth: " + RptMonth);
		this.info("LM082ServiceImpl ApplDateStart: " + ApplDateStart);
		this.info("LM082ServiceImpl ApplDateEnd: " + ApplDateEnd);
		this.info("LM082ServiceImpl RuleCode: " + RuleCode);
