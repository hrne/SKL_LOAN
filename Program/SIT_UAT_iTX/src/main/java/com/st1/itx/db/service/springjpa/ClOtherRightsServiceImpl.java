...
@Repository
public class ClOtherRightsServiceImpl implements ClOtherRightsService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(ClOtherRightsServiceImpl.class);
  ...
  public ClOtherRights findById(ClOtherRightsId clOtherRightsId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + clOtherRightsId);
...
em = null;
  ...
  public Slice<ClOtherRights> findClCodeRange(int clCode1_0, int clCode1_1, int clCode2_2, int clCode2_3, int clNo_4, int clNo_5, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("findClCodeRange " + dbName + " : " + "clCode1_0 : " + clCode1_0 + " clCode1_1 : " +  clCode1_1 + " clCode2_2 : " +  clCode2_2 + " clCode2_3 : " +  clCode2_3 + " clNo_4 : " +  clNo_4 + " clNo_5 : " +  clNo_5);
    if (dbName.equals(ContentName.onDay))
      slice = clOtherRightsReposDay.findAllByClCode1GreaterThanEqualAndClCode1LessThanEqualAndClCode2GreaterThanEqualAndClCode2LessThanEqualAndClNoGreaterThanEqualAndClNoLessThanEqualOrderByClCode1AscClCode2AscClNoAscSeqAsc(clCode1_0, clCode1_1, clCode2_2, clCode2_3, clNo_4, clNo_5, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = clOtherRightsReposMon.findAllByClCode1GreaterThanEqualAndClCode1LessThanEqualAndClCode2GreaterThanEqualAndClCode2LessThanEqualAndClNoGreaterThanEqualAndClNoLessThanEqualOrderByClCode1AscClCode2AscClNoAscSeqAsc(clCode1_0, clCode1_1, clCode2_2, clCode2_3, clNo_4, clNo_5, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = clOtherRightsReposHist.findAllByClCode1GreaterThanEqualAndClCode1LessThanEqualAndClCode2GreaterThanEqualAndClCode2LessThanEqualAndClNoGreaterThanEqualAndClNoLessThanEqualOrderByClCode1AscClCode2AscClNoAscSeqAsc(clCode1_0, clCode1_1, clCode2_2, clCode2_3, clNo_4, clNo_5, pageable);
    else 
      slice = clOtherRightsRepos.findAllByClCode1GreaterThanEqualAndClCode1LessThanEqualAndClCode2GreaterThanEqualAndClCode2LessThanEqualAndClNoGreaterThanEqualAndClNoLessThanEqualOrderByClCode1AscClCode2AscClNoAscSeqAsc(clCode1_0, clCode1_1, clCode2_2, clCode2_3, clNo_4, clNo_5, pageable);
  ...
  public ClOtherRights holdById(ClOtherRightsId clOtherRightsId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + clOtherRightsId);
    Optional<ClOtherRights> clOtherRights = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public ClOtherRights holdById(ClOtherRights clOtherRights, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + clOtherRights.getClOtherRightsId());
  ...
  public ClOtherRights insert(ClOtherRights clOtherRights, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + clOtherRights.getClOtherRightsId());
  ...
  public ClOtherRights update(ClOtherRights clOtherRights, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + clOtherRights.getClOtherRightsId());
    if (!empNot.isEmpty())
      clOtherRights.setLastUpdateEmpNo(empNot);
  ...
  public void delete(ClOtherRights clOtherRights, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + clOtherRights.getClOtherRightsId());
    if (dbName.equals(ContentName.onDay)) {
