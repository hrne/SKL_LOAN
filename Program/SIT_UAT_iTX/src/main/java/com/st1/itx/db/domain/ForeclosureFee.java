...
// 記錄號碼
	...
	// 科目
	/*
	 * 共用代碼檔01: 郵費02: 支付命令03: 公示送達04: 裁定費05: 執行費06: 測量費07: 鑑價費08: 刊報費09: 假扣押擔保金10:
	 * 前項結餘11: 全額沖銷12: 退出納課13: 警察陪同費14: 查財產費用15: 催收沖銷(勿用)99: 其它
	 */
	...
	/**
	 * 科目<br>
	 * 共用代碼檔 01: 郵費 02: 支付命令 03: 公示送達 04: 裁定費 05: 執行費 06: 測量費 07: 鑑價費 08: 刊報費 09:
	 * 假扣押擔保金 10: 前項結餘 11: 全額沖銷 12: 退出納課 13: 警察陪同費 14: 查財產費用 15: 催收沖銷(勿用) 99: 其它
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "ForeclosureFee [recordNo=" + recordNo + ", custNo=" + custNo + ", facmNo=" + facmNo + ", receiveDate=" + receiveDate + ", docDate=" + docDate + ", openAcDate=" + openAcDate
				+ ", closeDate=" + closeDate + ", fee=" + fee + ", feeCode=" + feeCode + ", legalStaff=" + legalStaff + ", closeNo=" + closeNo + ", rmk=" + rmk + ", caseCode=" + caseCode
				+ ", remitBranch=" + remitBranch + ", remitter=" + remitter + ", caseNo=" + caseNo + ", overdueDate=" + overdueDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
