...
/**
	* 處理功能<br>
	* Y-有自動處理功能，執行後明細檔狀態改為已處理
C-連結或啟動原交易，執行後明細檔狀態改為已處理
M-人工自行處理，明細檔狀態不會變動
	* @return String
	*/
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "TxToDoMain [itemCode=" + itemCode + ", itemDesc=" + itemDesc + ", ydReserveFg=" + ydReserveFg + ", autoFg=" + autoFg + ", deleteFg=" + deleteFg + ", reserveFg=" + reserveFg
           + ", acClsCheck=" + acClsCheck + ", chainInqTxcd=" + chainInqTxcd + ", chainUpdTxcd=" + chainUpdTxcd + ", excuteTxcd=" + excuteTxcd + ", eraseFg=" + eraseFg + ", ydReserveCnt=" + ydReserveCnt
           + ", tdNewCnt=" + tdNewCnt + ", tdProcessCnt=" + tdProcessCnt + ", tdDeleteCNT=" + tdDeleteCNT + ", reserveCnt=" + reserveCnt + ", unProcessCnt=" + unProcessCnt + ", createDate=" + createDate
