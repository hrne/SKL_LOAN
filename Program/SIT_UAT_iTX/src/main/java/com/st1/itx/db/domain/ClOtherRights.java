...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "ClOtherRights [clOtherRightsId=" + clOtherRightsId + ", city=" + city + ", landAdm=" + landAdm
           + ", recYear=" + recYear + ", recWord=" + recWord + ", recNumber=" + recNumber + ", rightsNote=" + rightsNote + ", securedTotal=" + securedTotal + ", createDate=" + createDate
