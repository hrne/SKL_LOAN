...
public class LM021Report extends MakeReport {
	private static final Logger logger = LoggerFactory.getLogger(LM021Report.class);
	...
	private void exportExcel(TitaVo titaVo, List<Map<String, String>> LDList) throws LogicException {
		...
		makeExcel.open(titaVo, titaVo.getEntDyI(), titaVo.getKinbr(), "LM021", "已逾期未減損-帳齡分析", "LM021已逾期未減損-帳齡分析",
				"LM021已逾期未減損-帳齡分析.xlsx", "已逾期未減損-帳齡分析");
