...
//			退款:員編(6)+交易序號(8)
			...
			thisLine = thisLine + "," + FormatUtil.padX("" + t.getCustName(), 40) // 受款人 VARCHAR2 40
					+ "," + "                                             "// TODO:??? 付款摘要 VARCHAR2 45
					+ "," + " "// 支票格式 VARCHAR2 1
					+ "," + "         "// 支票號碼 VARCHAR2 9
					+ "," + "       "// 支票(匯款)日期 Date 7
					+ "," + "       "// 兌領日期 Date 7
					+ "," + "       "// 開票日期/匯款日期 Date 7
					+ "," + FormatUtil.padX("" + t.getRemitBank(), 3)// 受款總行 VARCHAR2 3
					+ "," + FormatUtil.padX("" + t.getRemitBranch(), 4)// 受款分行 VARCHAR2 4
					+ "," + FormatUtil.pad9("" + t.getRemitAcctNo(), 16)// 受款人帳號 VARCHAR2 16
					+ "," + FormatUtil.pad9("" + t.getRemitAmt(), 10)// 付款金額 NUMBER (12,2)
					+ "," + "        "// 程式代碼 VARCHAR2 8
					...
					// 80
					+ "," + " "// 付款開票格式 VARCHAR2 1
					+ "," + FormatUtil.padX("" + wkCustId, 10)// 受款人ID VARCHAR2 10
					+ "," + "            "// 前期建檔號碼 VARCHAR2 12
					+ "," + " "// 付款單位代送 VARCHAR2 1
					+ "," + "  "// 取消建檔原因碼 VARCHAR2 2
					+ "," + "            "// 群組請款序號 VARCHAR2 12
