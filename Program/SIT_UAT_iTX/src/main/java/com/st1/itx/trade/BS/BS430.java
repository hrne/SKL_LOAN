...
import com.st1.itx.db.service.springjpa.cm.BS430ServiceImpl;
 ...
 * @version 1.0.0
 */
public class BS430 extends TradeBuffer {
	private static final Logger logger = LoggerFactory.getLogger(BS430.class);
	...
	@Autowired
	public BS430ServiceImpl bS430ServiceImpl;
...
//      抓取資料
		...
		try {
			fnAllList = bS430ServiceImpl.findAll(titaVo);
		} catch (Exception e) {
...
//	暫時紀錄戶號額度
	private class tmpBorm {
		...
		private BS430 getEnclosingInstance() {
			return BS430.this;
		}
