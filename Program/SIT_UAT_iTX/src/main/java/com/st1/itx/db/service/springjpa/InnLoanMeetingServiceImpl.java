...
@Repository
public class InnLoanMeetingServiceImpl extends ASpringJpaParm implements InnLoanMeetingService, InitializingBean {
  @Autowired
  ...
  public InnLoanMeeting findById(int meetNo, TitaVo... titaVo) {
    ...
    this.info("findById " + dbName + " " + meetNo);
...
em = null;
  ...
  public Slice<InnLoanMeeting> findAll(int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by(Sort.Direction.ASC, "MeetNo"));
    else
         pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "MeetNo"));
  ...
  public Slice<InnLoanMeeting> meetingDateRg(int meetingDate_0, int meetingDate_1, int index, int limit, TitaVo... titaVo) {
    ...
    this.info("meetingDateRg " + dbName + " : " + "meetingDate_0 : " + meetingDate_0 + " meetingDate_1 : " +  meetingDate_1);
    if (dbName.equals(ContentName.onDay))
  ...
  public InnLoanMeeting holdById(InnLoanMeeting innLoanMeeting, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("Hold " + dbName + " " + innLoanMeeting.getMeetNo());
  ...
  public InnLoanMeeting insert(InnLoanMeeting innLoanMeeting, TitaVo... titaVo) throws DBException {
    ...
    this.info("Insert..." + dbName + " " + innLoanMeeting.getMeetNo());
    ...
    if(innLoanMeeting.getLastUpdateEmpNo() == null || innLoanMeeting.getLastUpdateEmpNo().isEmpty())
  ...
  public InnLoanMeeting update(InnLoanMeeting innLoanMeeting, TitaVo... titaVo) throws DBException {
    ...
    this.info("Update..." + dbName + " " + innLoanMeeting.getMeetNo());
    if (!empNot.isEmpty())
      innLoanMeeting.setLastUpdateEmpNo(empNot);
  ...
  public void delete(InnLoanMeeting innLoanMeeting, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("Delete..." + dbName + " " + innLoanMeeting.getMeetNo());
    if (dbName.equals(ContentName.onDay)) {
