...
// 序號
	...
	// 額外風險因子
	/*
	 * 每項風險因子以"|"符號區隔，共需回傳5項風險因子代碼。風險因子順序： 1.現有無記名股票/股東 2.實質受益人為第三層以後之第一類型之自然人大股東
	 * 3.客戶拒絕或無法填寫實質受益人聲明書 4.無法辨識第一類型實質受益人之自然人大股東 5.為高階管理人員如：101|201|302|401|502
	 */
	...
	/*
	 * 000：不適用LRA01：受款帳戶「非」本人或本人代償金融機構帳戶或履約保證或不動產出賣人帳戶LRA02：
	 * 受款帳戶為本人或本人代償金融機構帳戶或履約保證或不動產出賣人帳戶999：無法提供相關資訊
	 */
	 ...
	 * 額外風險因子<br>
	 * 每項風險因子以"|"符號區隔，共需回傳5項風險因子代碼。 風險因子順序： 1.現有無記名股票/股東 2.實質受益人為第三層以後之第一類型之自然人大股東
	 * 3.客戶拒絕或無法填寫實質受益人聲明書 4.無法辨識第一類型實質受益人之自然人大股東 5.為高階管理人員 如：101|201|302|401|502
	 * 
	 * @return String
	 */
	 ...
	 * 000：不適用 BRI01：無身分利害關係 BRI02：有身分利害關係 999：無法提供相關資訊
	 * 
	 * @return String
	 */
	 ...
	 * 000：不適用 BJP01：非要保人之法人/團體 BJP02：為要保人之法人/團體 999：無法提供相關資訊
	 * 
	 * @return String
	 */
	 ...
	 * 000：不適用 ABT01：為代理人代理 ABT02：非代理人代理 999：無法提供相關資訊
	 * 
	 * @return String
	 */
	 ...
	 * 000：不適用 PJP01：非要保人之法人/團體 PJP02：為要保人之法人/團體 999：無法提供相關資訊
	 * 
	 * @return String
	 */
	 ...
	 * 000：不適用 PRP01：無利害關係 PRP02：有利害關係 999：無法提供相關資訊
	 * 
	 * @return String
	 */
	...
	/**
	 * 繳費人-首期保費來自境外帳戶繳費<br>
	 * 000：不適用 POA01：來自境外帳戶繳費 POA02：非境外帳戶繳費 999：無法提供相關資訊
	 * 
	 * @return String
	 */
	...
	/**
	 * 過往往來紀錄-曾遭拒保(拒絕核貸)<br>
	 * 000：不適用 RAR01：曾遭拒保 RAR02：未曾拒保 999：無法提供相關資訊
	 * 
	 * @return String
	 */
	...
	/**
	 * 過往往來紀錄-首次投保(借款)<br>
	 * 000：不適用 RAF01：首次投保 RAF02：非首次投保 999：無法提供相關資訊
	 * 
	 * @return String
	 */
	 ...
	 * 000：不適用 GRP01：無居住/通訊地址 GRP02：有居住/通訊地址 999：無法提供相關資訊
	 * 
	 * @return String
	 */
	 ...
	 * 000：不適用 GRF01：無居住/通訊地址 GRF02：有居住/通訊地址 999：無法提供相關資訊
	 * 
	 * @return String
	 */
	...
	/**
	 * 存續狀態-AH2<br>
	 * 000：不適用 DJP02：籌備處 DJP03：停業/歇業中 DJP01：營業中 999：無法提供相關資訊
	 * 
	 * @return String
	 */
	...
	/**
	 * 擔保品-是否提供動產擔保<br>
	 * 000：不適用 LCM01：有提供動產擔保 LCM02：無提供動產擔保 999：無法提供相關資訊
	 * 
	 * @return String
	 */
	 ...
	 * 000：不適用 LCS01：有提供無記名有價證券擔保 LCS02：無提供無記名有價證券擔保 999：無法提供相關資訊
	 * 
	 * @return String
	 */
	 ...
	 * 000：不適用 LLP01：自然人未約定「提前清償違約金」（不綁約） LLP02：自然人有約定「提前清償違約金」（不綁約） 999：無法提供相關資訊
	 * 
	 * @return String
	 */
	...
	/**
	 * 資金用途-資金用途非為購置不動產<br>
	 * 000：不適用 LPE01：資金用途非為購置不動產 LPE02：資金用途為購置不動產
	 * 
	 * @return String
	 */
	...
	/**
	 * 保證-非利害關係人提供保證<br>
	 * 000：不適用 LMR01：非利害關係人提供保證 LMR02：為利害關係人提供保證 999：無法提供相關資訊
	 * 
	 * @return String
	 */
	 ...
	 * 000：不適用 LRA01：受款帳戶「非」本人或本人代償金融機構帳戶或履約保證或不動產出賣人帳戶
	 * LRA02：受款帳戶為本人或本人代償金融機構帳戶或履約保證或不動產出賣人帳戶 999：無法提供相關資訊
	 * 
	 * @return String
	 */
	...
	/**
	 * 狀態<br>
	 * Success : 表示處理完成，無需登入AML作業 Warning : 表示需登入AML作業 Fail : 表示處理過程有異常，無法正常處理
	 * 
	 * @return String
	 */
	 ...
	 * 
	 * 若Is_Similar="Y"時或同一筆案件第二次查詢時填入 H:高 M:中 L:低
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "TxAmlRating [logNo=" + logNo + ", unit=" + unit + ", acceptanceUnit=" + acceptanceUnit + ", roleId=" + roleId + ", transactionId=" + transactionId + ", acctNo=" + acctNo + ", caseNo="
				+ caseNo + ", acctId=" + acctId + ", insurCount=" + insurCount + ", birthEstDt=" + birthEstDt + ", sourceId=" + sourceId + ", modifyDate=" + modifyDate + ", ocupCd=" + ocupCd
				+ ", orgType=" + orgType + ", bcode=" + bcode + ", ocupNote=" + ocupNote + ", payMethod=" + payMethod + ", payType=" + payType + ", channel=" + channel + ", policyType=" + policyType
				+ ", insuranceCurrency=" + insuranceCurrency + ", insuranceAmount=" + insuranceAmount + ", addnCd=" + addnCd + ", insrStakesCd=" + insrStakesCd + ", bnfcryNHdrGrpCd=" + bnfcryNHdrGrpCd
				+ ", agentTradeCd=" + agentTradeCd + ", fstPayerNHdrGrpCd=" + fstPayerNHdrGrpCd + ", fstPayerNHdrStksCd=" + fstPayerNHdrStksCd + ", fstPrmOvrseaAcctCd=" + fstPrmOvrseaAcctCd
				+ ", totalAmtCd=" + totalAmtCd + ", declinatureCd=" + declinatureCd + ", fstInsuredCd=" + fstInsuredCd + ", tWAddrHoldCd=" + tWAddrHoldCd + ", tWAddrLegalCd=" + tWAddrLegalCd
				+ ", durationCd=" + durationCd + ", specialIdentity=" + specialIdentity + ", lawForceWarranty=" + lawForceWarranty + ", movableGrnteeCd=" + movableGrnteeCd + ", bearerScursGrnteeCd="
				+ bearerScursGrnteeCd + ", agreeDefaultFineCd=" + agreeDefaultFineCd + ", nonBuyingRealEstateCd=" + nonBuyingRealEstateCd + ", nonStkHolderGrnteeCd=" + nonStkHolderGrnteeCd
				+ ", reachCase=" + reachCase + ", accountTypeCd=" + accountTypeCd + ", queryType=" + queryType + ", identityCd=" + identityCd + ", rspRequestId=" + rspRequestId + ", rspStatus="
				+ rspStatus + ", rspStatusCode=" + rspStatusCode + ", rspStatusDesc=" + rspStatusDesc + ", rspUnit=" + rspUnit + ", rspTransactionId=" + rspTransactionId + ", rspAcctNo=" + rspAcctNo
				+ ", rspCaseNo=" + rspCaseNo + ", rspInsurCount=" + rspInsurCount + ", rspTotalRatingsScore=" + rspTotalRatingsScore + ", rspTotalRatings=" + rspTotalRatings + ", createDate="
