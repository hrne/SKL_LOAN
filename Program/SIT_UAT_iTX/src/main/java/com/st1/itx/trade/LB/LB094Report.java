...
public class LB094Report extends MakeReport {
	...
	public void exec(TitaVo titaVo) throws LogicException {
		...
		try {
			...
			List<Map<String, String>> LBList = lB094ServiceImpl.findAll(titaVo);
			if (LBList == null) {
				listCount = 0;
			} else {
	...
	private void genFile(TitaVo titaVo, List<Map<String, String>> LBList) throws LogicException {
		...
		try {
			...
			// 首筆
			strContent = "JCIC-DAT-B093-V01-458" + StringUtils.repeat(" ", 5) + strToday + "01" + StringUtils.repeat(" ", 10) + makeFile.fillStringR("02-23895858#7279", 16, ' ')
					+ makeFile.fillStringR("審查單位聯絡人－鄧雪美", 80, ' ') + StringUtils.repeat(" ", 51);
