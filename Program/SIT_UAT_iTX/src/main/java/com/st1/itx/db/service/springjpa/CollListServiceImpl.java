...
public class CollListServiceImpl extends ASpringJpaParm implements CollListService, InitializingBean {
	...
	public Slice<CollList> statusRng(int custNo_0, int custNo_1, int facmNo_2, int facmNo_3, List<Integer> status_4, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = collListReposDay.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndStatusIn(custNo_0, custNo_1, facmNo_2, facmNo_3, status_4,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = collListReposMon.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndStatusIn(custNo_0, custNo_1, facmNo_2, facmNo_3, status_4,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = collListReposHist.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndStatusIn(custNo_0, custNo_1, facmNo_2, facmNo_3, status_4,
					pageable);
		else
			slice = collListRepos.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndStatusIn(custNo_0, custNo_1, facmNo_2, facmNo_3, status_4,
					pageable);
