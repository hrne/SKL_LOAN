...
public class LM077Report extends MakeReport {
	private static final Logger logger = LoggerFactory.getLogger(LM077Report.class);
	...
	public boolean exec(TitaVo titaVo) throws LogicException {
		...
		try {
			lLM077 = lM077ServiceImpl.findAll(titaVo, Integer.toString(iAcDate).substring(0,6));
		} catch (Exception e) {
	...
	private void exportExcel(TitaVo titaVo, List<Map<String, String>> lList, int date) throws LogicException {
		...
		makeExcel.open(titaVo, titaVo.getEntDyI(), titaVo.getKinbr(), "LM077", "B043金融機構承作「餘屋貸款」統計表",
				"LM077_B043金融機構承作「餘屋貸款」統計表" + showRocDate(entdy, 0).substring(0, 7), "LM077_底稿_B043金融機構承作「餘屋貸款」統計表.xlsx", 1, "FOA");
