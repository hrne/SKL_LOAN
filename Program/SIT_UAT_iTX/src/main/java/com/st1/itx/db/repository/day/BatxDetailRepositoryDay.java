 ...
 * @version 1.0.0
 */
public interface BatxDetailRepositoryDay extends JpaRepository<BatxDetail, BatxDetailId> {
	...
	public Slice<BatxDetail> findAllByCustNoIsAndFacmNoIsAndRepayCodeIsAndRepayTypeIsOrderByCustNoAscFacmNoAscRepayCodeAsc(int custNo_0, int facmNo_1, int repayCode_2, int repayType_3,
			Pageable pageable);
	...
	// AcDate >= ,AND AcDate <= ,AND CustNo >= ,AND CustNo <= ,AND RepayCode >= ,AND
	// RepayCode <= ,AND ProcStsCode ^i
	public Slice<BatxDetail> findAllByAcDateGreaterThanEqualAndAcDateLessThanEqualAndCustNoGreaterThanEqualAndCustNoLessThanEqualAndRepayCodeGreaterThanEqualAndRepayCodeLessThanEqualAndProcStsCodeInOrderByCustNoAscFacmNoAscRepayCodeAscDetailSeqAsc(
			int acDate_0, int acDate_1, int custNo_2, int custNo_3, int repayCode_4, int repayCode_5, List<String> procStsCode_6, Pageable pageable);
	...
	public Optional<BatxDetail> findTopByAcDateIsAndFileNameIsAndCustNoIsAndRepayAmtIsAndProcStsCodeInOrderByBatchNoDescDetailSeqDesc(int acDate_0, String fileName_1, int custNo_2,
			BigDecimal repayAmt_3, List<String> procStsCode_4);

	// AcDate = ,AND BatchNo = ,AND CustNo = ,AND ProcStsCode ^i
	public Slice<BatxDetail> findAllByAcDateIsAndBatchNoIsAndCustNoIsAndProcStsCodeInOrderByCustNoAscFacmNoAscRepayCodeDescDetailSeqAsc(int acDate_0, String batchNo_1, int custNo_2,
			List<String> procStsCode_3, Pageable pageable);

	// AcDate = ,AND BatchNo = ,AND CustNo = ,AND ProcStsCode ^i
	public Slice<BatxDetail> findAllByAcDateIsAndBatchNoIsAndCustNoIsAndProcStsCodeInOrderByCustNoDescFacmNoDescRepayCodeAscDetailSeqDesc(int acDate_0, String batchNo_1, int custNo_2,
			List<String> procStsCode_3, Pageable pageable);

	// AcDate = ,AND BatchNo = ,AND ProcStsCode ^i
	public Slice<BatxDetail> findAllByAcDateIsAndBatchNoIsAndProcStsCodeInOrderByCustNoAscFacmNoAscRepayCodeDescDetailSeqAsc(int acDate_0, String batchNo_1, List<String> procStsCode_2,
			Pageable pageable);

	// AcDate = ,AND BatchNo = ,AND ProcStsCode ^i
	public Slice<BatxDetail> findAllByAcDateIsAndBatchNoIsAndProcStsCodeInOrderByCustNoDescFacmNoDescRepayCodeAscDetailSeqDesc(int acDate_0, String batchNo_1, List<String> procStsCode_2,
			Pageable pageable);

	// AcDate = ,AND BatchNo = ,AND ReconCode = ,AND ProcStsCode ^i
	public Slice<BatxDetail> findAllByAcDateIsAndBatchNoIsAndReconCodeIsAndProcStsCodeInOrderByCustNoAscFacmNoAscRepayCodeDescDetailSeqAsc(int acDate_0, String batchNo_1, String reconCode_2,
			List<String> procStsCode_3, Pageable pageable);

	// AcDate = ,AND BatchNo = ,AND ReconCode = ,AND ProcStsCode ^i
	public Slice<BatxDetail> findAllByAcDateIsAndBatchNoIsAndReconCodeIsAndProcStsCodeInOrderByCustNoDescFacmNoDescRepayCodeAscDetailSeqDesc(int acDate_0, String batchNo_1, String reconCode_2,
			List<String> procStsCode_3, Pageable pageable);
