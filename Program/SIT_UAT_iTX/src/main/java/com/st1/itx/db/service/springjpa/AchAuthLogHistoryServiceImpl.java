...
public class AchAuthLogHistoryServiceImpl extends ASpringJpaParm implements AchAuthLogHistoryService, InitializingBean {
	...
	public AchAuthLogHistory findById(AchAuthLogHistoryId achAuthLogHistoryId, TitaVo... titaVo) {
		...
		this.info("findById " + dbName + " " + achAuthLogHistoryId);
	...
	public AchAuthLogHistory facmNoCFirst(int custNo_0, int facmNo_1, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("facmNoCFirst " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " + facmNo_1);
		Optional<AchAuthLogHistory> achAuthLogHistoryT = null;
		if (dbName.equals(ContentName.onDay))
	...
	public AchAuthLogHistory AuthLogKeyFirst(int authCreateDate_0, int custNo_1, String repayBank_2, String repayAcct_3, String createFlag_4, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("AuthLogKeyFirst " + dbName + " : " + "authCreateDate_0 : " + authCreateDate_0 + " custNo_1 : " + custNo_1 + " repayBank_2 : " + repayBank_2 + " repayAcct_3 : " + repayAcct_3
				+ " createFlag_4 : " + createFlag_4);
		Optional<AchAuthLogHistory> achAuthLogHistoryT = null;
		if (dbName.equals(ContentName.onDay))
			achAuthLogHistoryT = achAuthLogHistoryReposDay.findTopByAuthCreateDateIsAndCustNoIsAndRepayBankIsAndRepayAcctIsAndCreateFlagIsOrderByDetailSeqDesc(authCreateDate_0, custNo_1, repayBank_2,
					repayAcct_3, createFlag_4);
		else if (dbName.equals(ContentName.onMon))
			achAuthLogHistoryT = achAuthLogHistoryReposMon.findTopByAuthCreateDateIsAndCustNoIsAndRepayBankIsAndRepayAcctIsAndCreateFlagIsOrderByDetailSeqDesc(authCreateDate_0, custNo_1, repayBank_2,
					repayAcct_3, createFlag_4);
		else if (dbName.equals(ContentName.onHist))
			achAuthLogHistoryT = achAuthLogHistoryReposHist.findTopByAuthCreateDateIsAndCustNoIsAndRepayBankIsAndRepayAcctIsAndCreateFlagIsOrderByDetailSeqDesc(authCreateDate_0, custNo_1, repayBank_2,
					repayAcct_3, createFlag_4);
		else
			achAuthLogHistoryT = achAuthLogHistoryRepos.findTopByAuthCreateDateIsAndCustNoIsAndRepayBankIsAndRepayAcctIsAndCreateFlagIsOrderByDetailSeqDesc(authCreateDate_0, custNo_1, repayBank_2,
					repayAcct_3, createFlag_4);
		return achAuthLogHistoryT.isPresent() ? achAuthLogHistoryT.get() : null;
	}
	...
	public AchAuthLogHistory holdById(AchAuthLogHistoryId achAuthLogHistoryId, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Hold " + dbName + " " + achAuthLogHistoryId);
		Optional<AchAuthLogHistory> achAuthLogHistory = null;
		if (dbName.equals(ContentName.onDay))
	...
	public AchAuthLogHistory holdById(AchAuthLogHistory achAuthLogHistory, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Hold " + dbName + " " + achAuthLogHistory.getAchAuthLogHistoryId());
		Optional<AchAuthLogHistory> achAuthLogHistoryT = null;
		if (dbName.equals(ContentName.onDay))
	...
	public AchAuthLogHistory insert(AchAuthLogHistory achAuthLogHistory, TitaVo... titaVo) throws DBException {
		...
		this.info("Insert..." + dbName + " " + achAuthLogHistory.getAchAuthLogHistoryId());
	...
	public AchAuthLogHistory update(AchAuthLogHistory achAuthLogHistory, TitaVo... titaVo) throws DBException {
		...
		this.info("Update..." + dbName + " " + achAuthLogHistory.getAchAuthLogHistoryId());
		if (!empNot.isEmpty())
			achAuthLogHistory.setLastUpdateEmpNo(empNot);
	...
	public void delete(AchAuthLogHistory achAuthLogHistory, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Delete..." + dbName + " " + achAuthLogHistory.getAchAuthLogHistoryId());
		if (dbName.equals(ContentName.onDay)) {
