...
public interface PostAuthLogHistoryRepositoryHist extends JpaRepository<PostAuthLogHistory, PostAuthLogHistoryId> {
  ...
  // CustNo = ,AND FacmNo = 
  public Slice<PostAuthLogHistory> findAllByCustNoIsAndFacmNoIsOrderByRepayAcctSeqDesc(int custNo_0, int facmNo_1, Pageable pageable);
  ...
  // CustNo = ,AND FacmNo = 
  public Optional<PostAuthLogHistory> findTopByCustNoIsAndFacmNoIsOrderByAuthCreateDateDescCreateDateDesc(int custNo_0, int facmNo_1);
  ...
  public Optional<PostAuthLogHistory> findTopByAuthCreateDateIsAndAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsOrderByDetailSeqDesc(int authCreateDate_0, String authApplCode_1, int custNo_2, String postDepCode_3, String repayAcct_4, String authCode_5);
