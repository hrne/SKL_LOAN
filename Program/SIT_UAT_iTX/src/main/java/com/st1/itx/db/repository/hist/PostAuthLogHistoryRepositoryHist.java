 ...
 * @version 1.0.0
 */
public interface PostAuthLogHistoryRepositoryHist extends JpaRepository<PostAuthLogHistory, Long> {
	...
	public Optional<PostAuthLogHistory> findTopByAuthCreateDateIsAndAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsOrderByLogNoDesc(int authCreateDate_0, String authApplCode_1,
			int custNo_2, String postDepCode_3, String repayAcct_4, String authCode_5);
