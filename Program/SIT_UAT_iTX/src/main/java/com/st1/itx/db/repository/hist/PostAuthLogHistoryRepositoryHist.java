 ...
 * @version 1.0.0
 */
public interface PostAuthLogHistoryRepositoryHist extends JpaRepository<PostAuthLogHistory, PostAuthLogHistoryId> {
	...
	// AuthApplCode = ,AND CustNo = ,AND PostDepCode = ,AND RepayAcct = ,AND
	// AuthCode = ,AND FacmNo =
	public Optional<PostAuthLogHistory> findTopByAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsAndFacmNoIsOrderByRepayAcctSeqDesc(String authApplCode_0, int custNo_1,
			String postDepCode_2, String repayAcct_3, String authCode_4, int facmNo_5);
	...
	// CustNo = ,AND FacmNo =
	public Slice<PostAuthLogHistory> findAllByCustNoIsAndFacmNoIsOrderByDetailSeqDescAuthCodeAsc(int custNo_0, int facmNo_1, Pageable pageable);

	// CustNo = ,AND PostDepCode = ,AND RepayAcct = ,AND AuthCode =
	public Optional<PostAuthLogHistory> findTopByCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsOrderByAuthCreateDateDescCreateDateDesc(int custNo_0, String postDepCode_1, String repayAcct_2,
			String authCode_3);

	// CustNo = ,AND FacmNo =
	public Optional<PostAuthLogHistory> findTopByCustNoIsAndFacmNoIsOrderByDetailSeqDescAuthCodeAsc(int custNo_0, int facmNo_1);

	// CustNo = ,AND FacmNo = ,AND AuthCode =
	public Optional<PostAuthLogHistory> findTopByCustNoIsAndFacmNoIsAndAuthCodeIsOrderByDetailSeqDesc(int custNo_0, int facmNo_1, String authCode_2);

	// AuthCreateDate = ,AND AuthApplCode = ,AND CustNo = ,AND PostDepCode = ,AND
	// RepayAcct = ,AND AuthCode =
	public Optional<PostAuthLogHistory> findTopByAuthCreateDateIsAndAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsOrderByDetailSeqDesc(int authCreateDate_0,
			String authApplCode_1, int custNo_2, String postDepCode_3, String repayAcct_4, String authCode_5);

	// Hold
	@Lock(value = LockModeType.PESSIMISTIC_READ)
	@Transactional(readOnly = false)
	public Optional<PostAuthLogHistory> findByPostAuthLogHistoryId(PostAuthLogHistoryId postAuthLogHistoryId);
