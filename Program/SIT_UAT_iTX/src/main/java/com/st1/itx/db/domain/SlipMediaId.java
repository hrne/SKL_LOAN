...
// 單位別
	...
	@Column(name = "`MediaSlipNo`", length = 10)
	...
	public boolean equals(Object obj) {
		...
		return branchNo.equals(slipMediaId.branchNo) && acDate == slipMediaId.acDate && batchNo == slipMediaId.batchNo && acBookCode.equals(slipMediaId.acBookCode) && mediaSeq == slipMediaId.mediaSeq
				&& mediaSlipNo.equals(slipMediaId.mediaSlipNo) && seq == slipMediaId.seq;
	}

	@Override
	public String toString() {
		return "SlipMediaId [branchNo=" + branchNo + ", acDate=" + acDate + ", batchNo=" + batchNo + ", acBookCode=" + acBookCode + ", mediaSeq=" + mediaSeq + ", mediaSlipNo=" + mediaSlipNo + ", seq="
				+ seq + "]";
	}
}
