...
public class BatxDetailServiceImpl extends ASpringJpaParm implements BatxDetailService, InitializingBean {
	...
	@Override
	public Slice<BatxDetail> findL4925AEq(int acDate_0, int acDate_1, int custNo_2, int custNo_3, int repayCode_4, int repayCode_5, List<String> procStsCode_6, int index, int limit,
			TitaVo... titaVo) {
		String dbName = "";
		Slice<BatxDetail> slice = null;
		if (titaVo.length != 0)
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findL4925AEq " + dbName + " : " + "acDate_0 : " + acDate_0 + " acDate_1 : " + acDate_1 + " custNo_2 : " + custNo_2 + " custNo_3 : " + custNo_3 + " repayCode_4 : " + repayCode_4
				+ " repayCode_5 : " + repayCode_5 + " procStsCode_6 : " + procStsCode_6);
		if (dbName.equals(ContentName.onDay))
			slice = batxDetailReposDay
					.findAllByAcDateGreaterThanEqualAndAcDateLessThanEqualAndCustNoGreaterThanEqualAndCustNoLessThanEqualAndRepayCodeGreaterThanEqualAndRepayCodeLessThanEqualAndProcStsCodeInOrderByCustNoAscFacmNoAscRepayCodeAscDetailSeqAsc(
							acDate_0, acDate_1, custNo_2, custNo_3, repayCode_4, repayCode_5, procStsCode_6, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = batxDetailReposMon
					.findAllByAcDateGreaterThanEqualAndAcDateLessThanEqualAndCustNoGreaterThanEqualAndCustNoLessThanEqualAndRepayCodeGreaterThanEqualAndRepayCodeLessThanEqualAndProcStsCodeInOrderByCustNoAscFacmNoAscRepayCodeAscDetailSeqAsc(
							acDate_0, acDate_1, custNo_2, custNo_3, repayCode_4, repayCode_5, procStsCode_6, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = batxDetailReposHist
					.findAllByAcDateGreaterThanEqualAndAcDateLessThanEqualAndCustNoGreaterThanEqualAndCustNoLessThanEqualAndRepayCodeGreaterThanEqualAndRepayCodeLessThanEqualAndProcStsCodeInOrderByCustNoAscFacmNoAscRepayCodeAscDetailSeqAsc(
							acDate_0, acDate_1, custNo_2, custNo_3, repayCode_4, repayCode_5, procStsCode_6, pageable);
		else
			slice = batxDetailRepos
					.findAllByAcDateGreaterThanEqualAndAcDateLessThanEqualAndCustNoGreaterThanEqualAndCustNoLessThanEqualAndRepayCodeGreaterThanEqualAndRepayCodeLessThanEqualAndProcStsCodeInOrderByCustNoAscFacmNoAscRepayCodeAscDetailSeqAsc(
							acDate_0, acDate_1, custNo_2, custNo_3, repayCode_4, repayCode_5, procStsCode_6, pageable);
	...
	public BatxDetail findL4200BFirst(int acDate_0, String fileName_1, int custNo_2, BigDecimal repayAmt_3, List<String> procStsCode_4, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("findL4200BFirst " + dbName + " : " + "acDate_0 : " + acDate_0 + " fileName_1 : " + fileName_1 + " custNo_2 : " + custNo_2 + " repayAmt_3 : " + repayAmt_3 + " procStsCode_4 : "
				+ procStsCode_4);
		Optional<BatxDetail> batxDetailT = null;
		if (dbName.equals(ContentName.onDay))
			batxDetailT = batxDetailReposDay.findTopByAcDateIsAndFileNameIsAndCustNoIsAndRepayAmtIsAndProcStsCodeInOrderByBatchNoDescDetailSeqDesc(acDate_0, fileName_1, custNo_2, repayAmt_3,
					procStsCode_4);
		else if (dbName.equals(ContentName.onMon))
			batxDetailT = batxDetailReposMon.findTopByAcDateIsAndFileNameIsAndCustNoIsAndRepayAmtIsAndProcStsCodeInOrderByBatchNoDescDetailSeqDesc(acDate_0, fileName_1, custNo_2, repayAmt_3,
					procStsCode_4);
		else if (dbName.equals(ContentName.onHist))
			batxDetailT = batxDetailReposHist.findTopByAcDateIsAndFileNameIsAndCustNoIsAndRepayAmtIsAndProcStsCodeInOrderByBatchNoDescDetailSeqDesc(acDate_0, fileName_1, custNo_2, repayAmt_3,
					procStsCode_4);
		else
			batxDetailT = batxDetailRepos.findTopByAcDateIsAndFileNameIsAndCustNoIsAndRepayAmtIsAndProcStsCodeInOrderByBatchNoDescDetailSeqDesc(acDate_0, fileName_1, custNo_2, repayAmt_3,
					procStsCode_4);
	...
	public Slice<BatxDetail> findL4930CAEq(int acDate_0, String batchNo_1, int custNo_2, List<String> procStsCode_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = batxDetailReposDay.findAllByAcDateIsAndBatchNoIsAndCustNoIsAndProcStsCodeInOrderByCustNoAscFacmNoAscRepayCodeDescDetailSeqAsc(acDate_0, batchNo_1, custNo_2, procStsCode_3,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = batxDetailReposMon.findAllByAcDateIsAndBatchNoIsAndCustNoIsAndProcStsCodeInOrderByCustNoAscFacmNoAscRepayCodeDescDetailSeqAsc(acDate_0, batchNo_1, custNo_2, procStsCode_3,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = batxDetailReposHist.findAllByAcDateIsAndBatchNoIsAndCustNoIsAndProcStsCodeInOrderByCustNoAscFacmNoAscRepayCodeDescDetailSeqAsc(acDate_0, batchNo_1, custNo_2, procStsCode_3,
					pageable);
		else
	...
	public Slice<BatxDetail> findL4930CHEq(int acDate_0, String batchNo_1, int custNo_2, List<String> procStsCode_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = batxDetailReposDay.findAllByAcDateIsAndBatchNoIsAndCustNoIsAndProcStsCodeInOrderByCustNoDescFacmNoDescRepayCodeAscDetailSeqDesc(acDate_0, batchNo_1, custNo_2, procStsCode_3,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = batxDetailReposMon.findAllByAcDateIsAndBatchNoIsAndCustNoIsAndProcStsCodeInOrderByCustNoDescFacmNoDescRepayCodeAscDetailSeqDesc(acDate_0, batchNo_1, custNo_2, procStsCode_3,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = batxDetailReposHist.findAllByAcDateIsAndBatchNoIsAndCustNoIsAndProcStsCodeInOrderByCustNoDescFacmNoDescRepayCodeAscDetailSeqDesc(acDate_0, batchNo_1, custNo_2, procStsCode_3,
					pageable);
		else
			slice = batxDetailRepos.findAllByAcDateIsAndBatchNoIsAndCustNoIsAndProcStsCodeInOrderByCustNoDescFacmNoDescRepayCodeAscDetailSeqDesc(acDate_0, batchNo_1, custNo_2, procStsCode_3,
					pageable);
	...
	public Slice<BatxDetail> findL4930RAEq(int acDate_0, String batchNo_1, String reconCode_2, List<String> procStsCode_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = batxDetailReposDay.findAllByAcDateIsAndBatchNoIsAndReconCodeIsAndProcStsCodeInOrderByCustNoAscFacmNoAscRepayCodeDescDetailSeqAsc(acDate_0, batchNo_1, reconCode_2, procStsCode_3,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = batxDetailReposMon.findAllByAcDateIsAndBatchNoIsAndReconCodeIsAndProcStsCodeInOrderByCustNoAscFacmNoAscRepayCodeDescDetailSeqAsc(acDate_0, batchNo_1, reconCode_2, procStsCode_3,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = batxDetailReposHist.findAllByAcDateIsAndBatchNoIsAndReconCodeIsAndProcStsCodeInOrderByCustNoAscFacmNoAscRepayCodeDescDetailSeqAsc(acDate_0, batchNo_1, reconCode_2, procStsCode_3,
					pageable);
		else
			slice = batxDetailRepos.findAllByAcDateIsAndBatchNoIsAndReconCodeIsAndProcStsCodeInOrderByCustNoAscFacmNoAscRepayCodeDescDetailSeqAsc(acDate_0, batchNo_1, reconCode_2, procStsCode_3,
					pageable);
	...
	public Slice<BatxDetail> findL4930RHEq(int acDate_0, String batchNo_1, String reconCode_2, List<String> procStsCode_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = batxDetailReposDay.findAllByAcDateIsAndBatchNoIsAndReconCodeIsAndProcStsCodeInOrderByCustNoDescFacmNoDescRepayCodeAscDetailSeqDesc(acDate_0, batchNo_1, reconCode_2, procStsCode_3,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = batxDetailReposMon.findAllByAcDateIsAndBatchNoIsAndReconCodeIsAndProcStsCodeInOrderByCustNoDescFacmNoDescRepayCodeAscDetailSeqDesc(acDate_0, batchNo_1, reconCode_2, procStsCode_3,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = batxDetailReposHist.findAllByAcDateIsAndBatchNoIsAndReconCodeIsAndProcStsCodeInOrderByCustNoDescFacmNoDescRepayCodeAscDetailSeqDesc(acDate_0, batchNo_1, reconCode_2, procStsCode_3,
					pageable);
		else
			slice = batxDetailRepos.findAllByAcDateIsAndBatchNoIsAndReconCodeIsAndProcStsCodeInOrderByCustNoDescFacmNoDescRepayCodeAscDetailSeqDesc(acDate_0, batchNo_1, reconCode_2, procStsCode_3,
					pageable);
