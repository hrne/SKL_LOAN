...
@Repository
public class LoanIfrsHpServiceImpl implements LoanIfrsHpService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(LoanIfrsHpServiceImpl.class);
  ...
  public LoanIfrsHp findById(LoanIfrsHpId loanIfrsHpId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + loanIfrsHpId);
...
em = null;
  ...
  public LoanIfrsHp holdById(LoanIfrsHpId loanIfrsHpId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + loanIfrsHpId);
    Optional<LoanIfrsHp> loanIfrsHp = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public LoanIfrsHp holdById(LoanIfrsHp loanIfrsHp, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + loanIfrsHp.getLoanIfrsHpId());
  ...
  public LoanIfrsHp insert(LoanIfrsHp loanIfrsHp, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + loanIfrsHp.getLoanIfrsHpId());
  ...
  public LoanIfrsHp update(LoanIfrsHp loanIfrsHp, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + loanIfrsHp.getLoanIfrsHpId());
    if (!empNot.isEmpty())
      loanIfrsHp.setLastUpdateEmpNo(empNot);
  ...
  public void delete(LoanIfrsHp loanIfrsHp, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + loanIfrsHp.getLoanIfrsHpId());
    if (dbName.equals(ContentName.onDay)) {
