...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "PfDeparment [pfDeparmentId=" + pfDeparmentId + ", empNo=" + empNo + ", unitItem=" + unitItem + ", distItem=" + distItem
           + ", deptItem=" + deptItem + ", directorCode=" + directorCode + ", empName=" + empName + ", departOfficer=" + departOfficer + ", goalCnt=" + goalCnt + ", sumGoalCnt=" + sumGoalCnt
           + ", goalAmt=" + goalAmt + ", sumGoalAmt=" + sumGoalAmt + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
           + "]";
  }
}
