...
public class L5511ServiceImpl extends ASpringJpaParm implements InitializingBean {
	...
	public List<Map<String, String>> FindData(TitaVo titaVo, int workYM) throws Exception {
		...
		String sql = "select a.\"PieceCode\",a.\"ProdCode\",a.\"EmployeeNo\",d.\"Fullname\",a.\"CustNo\",a.\"FacmNo\",a.\"BormNo\",a.\"BonusType\",e.\"CustName\",b.\"DrawdownDate\",b.\"DrawdownAmt\",a.\"AdjustBonus\",f.\"AcSubBookCode\" from \"PfRewardMedia\" a " + 
				"left join \"PfItDetail\" b on b.\"PerfDate\" = a.\"PerfDate\" and b.\"CustNo\"=a.\"CustNo\" and b.\"FacmNo\"=a.\"FacmNo\" and b.\"BormNo\"=a.\"BormNo\" and a.\"BonusType\" != 6 " + 
				"left join \"FacMain\" c on c.\"CustNo\"=a.\"CustNo\" and c.\"FacmNo\"=a.\"FacmNo\" and a.\"BonusType\" != 6 " + 
				"left join \"CdEmp\" d on d.\"EmployeeNo\"=a.\"EmployeeNo\" " + 
...
//				"left join \"FacProd\" f on f.\"ProdNo\"=a.\"ProdCode\" " +
		        "where a.\"WorkMonth\"=:workMonth " +
				"order by a.\"EmployeeNo\",a.\"PieceCode\",a.\"CustNo\",a.\"FacmNo\",a.\"BormNo\" ";
