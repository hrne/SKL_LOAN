...
@Table(name = "`LoanIfrsFp`")
public class LoanIfrsFp implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1614825117912591795L;

	@EmbeddedId
	private LoanIfrsFpId loanIfrsFpId;
	...
	public LoanIfrsFpId getLoanIfrsFpId() {
		return this.loanIfrsFpId;
	}

	public void setLoanIfrsFpId(LoanIfrsFpId loanIfrsFpId) {
		this.loanIfrsFpId = loanIfrsFpId;
	}
	...
	public String toString() {
		return "LoanIfrsFp [loanIfrsFpId=" + loanIfrsFpId + ", custId=" + custId + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo="
				+ lastUpdateEmpNo + "]";
	}
}
