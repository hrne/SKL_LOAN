...
public class L9716Report extends MakeReport {
	private static final Logger logger = LoggerFactory.getLogger(L9716Report.class);
	...
	public boolean exec(TitaVo titaVo) throws LogicException {
		...
		List<Map<String, String>> lL9716 = null;

		try {
			lL9716 = l9716ServiceImpl.findAll(titaVo);
		} catch (Exception e) {
