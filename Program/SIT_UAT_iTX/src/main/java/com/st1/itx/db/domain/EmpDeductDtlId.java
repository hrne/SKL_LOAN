...
// 入帳日期
	...
	public boolean equals(Object obj) {
		...
		return entryDate == empDeductDtlId.entryDate && custNo == empDeductDtlId.custNo && achRepayCode == empDeductDtlId.achRepayCode && perfMonth == empDeductDtlId.perfMonth
				&& procCode.equals(empDeductDtlId.procCode) && repayCode.equals(empDeductDtlId.repayCode) && acctCode.equals(empDeductDtlId.acctCode) && facmNo == empDeductDtlId.facmNo
				&& bormNo == empDeductDtlId.bormNo;
	}

	@Override
	public String toString() {
		return "EmpDeductDtlId [entryDate=" + entryDate + ", custNo=" + custNo + ", achRepayCode=" + achRepayCode + ", perfMonth=" + perfMonth + ", procCode=" + procCode + ", repayCode=" + repayCode
				+ ", acctCode=" + acctCode + ", facmNo=" + facmNo + ", bormNo=" + bormNo + "]";
	}
}
