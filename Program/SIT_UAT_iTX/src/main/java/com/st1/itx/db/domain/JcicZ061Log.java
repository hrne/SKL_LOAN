...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicZ061Log [jcicZ061LogId=" + jcicZ061LogId + ", tranKey=" + tranKey + ", expBalanceAmt=" + expBalanceAmt + ", cashBalanceAmt=" + cashBalanceAmt + ", creditBalanceAmt=" + creditBalanceAmt
           + ", maxMainNote=" + maxMainNote + ", isGuarantor=" + isGuarantor + ", isChangePayment=" + isChangePayment + ", outJcicTxtDate=" + outJcicTxtDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
