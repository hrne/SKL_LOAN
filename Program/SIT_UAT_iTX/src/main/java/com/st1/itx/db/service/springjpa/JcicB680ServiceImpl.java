...
@Repository
public class JcicB680ServiceImpl implements JcicB680Service, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(JcicB680ServiceImpl.class);
  ...
  public JcicB680 findById(JcicB680Id jcicB680Id, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + jcicB680Id);
...
em = null;
  ...
  public JcicB680 holdById(JcicB680Id jcicB680Id, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicB680Id);
    Optional<JcicB680> jcicB680 = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicB680 holdById(JcicB680 jcicB680, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicB680.getJcicB680Id());
  ...
  public JcicB680 insert(JcicB680 jcicB680, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + jcicB680.getJcicB680Id());
  ...
  public JcicB680 update(JcicB680 jcicB680, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + jcicB680.getJcicB680Id());
    if (!empNot.isEmpty())
      jcicB680.setLastUpdateEmpNo(empNot);
  ...
  public void delete(JcicB680 jcicB680, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + jcicB680.getJcicB680Id());
    if (dbName.equals(ContentName.onDay)) {
