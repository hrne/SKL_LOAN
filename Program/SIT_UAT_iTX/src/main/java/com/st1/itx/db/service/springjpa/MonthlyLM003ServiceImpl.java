...
@Repository
public class MonthlyLM003ServiceImpl extends ASpringJpaParm implements MonthlyLM003Service, InitializingBean {
	@Autowired
	...
	public MonthlyLM003 findById(MonthlyLM003Id monthlyLM003Id, TitaVo... titaVo) {
		...
		this.info("findById " + dbName + " " + monthlyLM003Id);
	...
	public Slice<MonthlyLM003> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by(Sort.Direction.ASC, "EntType", "DataYear", "DataMonth"));
		else
			pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "EntType", "DataYear", "DataMonth"));
	...
	public MonthlyLM003 holdById(MonthlyLM003Id monthlyLM003Id, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Hold " + dbName + " " + monthlyLM003Id);
		Optional<MonthlyLM003> monthlyLM003 = null;
		if (dbName.equals(ContentName.onDay))
	...
	public MonthlyLM003 holdById(MonthlyLM003 monthlyLM003, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Hold " + dbName + " " + monthlyLM003.getMonthlyLM003Id());
	...
	public MonthlyLM003 insert(MonthlyLM003 monthlyLM003, TitaVo... titaVo) throws DBException {
		...
		this.info("Insert..." + dbName + " " + monthlyLM003.getMonthlyLM003Id());
		...
		if (monthlyLM003.getLastUpdateEmpNo() == null || monthlyLM003.getLastUpdateEmpNo().isEmpty())
	...
	public MonthlyLM003 update(MonthlyLM003 monthlyLM003, TitaVo... titaVo) throws DBException {
		...
		this.info("Update..." + dbName + " " + monthlyLM003.getMonthlyLM003Id());
		if (!empNot.isEmpty())
			monthlyLM003.setLastUpdateEmpNo(empNot);
	...
	public void delete(MonthlyLM003 monthlyLM003, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Delete..." + dbName + " " + monthlyLM003.getMonthlyLM003Id());
		if (dbName.equals(ContentName.onDay)) {
