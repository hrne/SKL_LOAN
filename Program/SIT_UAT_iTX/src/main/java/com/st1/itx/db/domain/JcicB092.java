...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicB092 [jcicB092Id=" + jcicB092Id + ", dataType=" + dataType + ", bankItem=" + bankItem + ", branchItem=" + branchItem + ", filler4=" + filler4
           + ", evaAmt=" + evaAmt + ", evaDate=" + evaDate + ", loanLimitAmt=" + loanLimitAmt + ", settingDate=" + settingDate
           ...
           + ", zip=" + zip + ", insuFg=" + insuFg + ", lVITax=" + lVITax + ", lVITaxYearMonth=" + lVITaxYearMonth + ", contractPrice=" + contractPrice
           + ", contractDate=" + contractDate + ", parkingTypeCode=" + parkingTypeCode + ", area=" + area + ", landOwnedArea=" + landOwnedArea + ", bdTypeCode=" + bdTypeCode + ", filler33=" + filler33
