...
public class AchAuthLog implements Serializable {
	...
	// 授權狀態
	/*
	 * 空白-未授權0-成功新增或取消授權扣款1-印鑑不符2-無此帳號3-委繳戶統一編號不符4-已核印成功在案5-原交易不存在6-電子資料與授權書內容不符7-
	...
	/**
	 * 授權狀態<br>
	 * 空白-未授權 0-成功新增或取消授權扣款 1-印鑑不符 2-無此帳號 3-委繳戶統一編號不符 4-已核印成功在案 5-原交易不存在
	...
	public String toString() {
		return "AchAuthLog [achAuthLogId=" + achAuthLogId + ", facmNo=" + facmNo + ", processDate=" + processDate + ", stampFinishDate=" + stampFinishDate + ", authStatus=" + authStatus
				...
				+ relAcctGender + ", amlRsp=" + amlRsp + ", createEmpNo=" + createEmpNo + ", createDate=" + createDate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + ", lastUpdate=" + lastUpdate + "]";
	}
}
