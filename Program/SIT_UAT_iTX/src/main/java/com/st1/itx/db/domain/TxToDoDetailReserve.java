...
public class TxToDoDetailReserve implements Serializable {
	...
	public String toString() {
		return "TxToDoDetailReserve [txToDoDetailReserveId=" + txToDoDetailReserveId + ", status=" + status + ", processNote=" + processNote + ", excuteTxcd=" + excuteTxcd + ", dataDate=" + dataDate
				+ ", titaEntdy=" + titaEntdy + ", titaKinbr=" + titaKinbr + ", titaTlrNo=" + titaTlrNo + ", titaTxtNo=" + titaTxtNo + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
