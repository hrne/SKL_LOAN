...
@Repository
public class MonthlyLM032ServiceImpl implements MonthlyLM032Service, InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(MonthlyLM032ServiceImpl.class);
	...
	public MonthlyLM032 findById(MonthlyLM032Id monthlyLM032Id, TitaVo... titaVo) {
		...
		logger.info("findById " + dbName + " " + monthlyLM032Id);
	...
	public Slice<MonthlyLM032> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		Pageable pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "ADTYMT", "LMSACN", "LMSAPN"));
	...
	public MonthlyLM032 holdById(MonthlyLM032Id monthlyLM032Id, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + monthlyLM032Id);
		Optional<MonthlyLM032> monthlyLM032 = null;
		if (dbName.equals(ContentName.onDay))
	...
	public MonthlyLM032 holdById(MonthlyLM032 monthlyLM032, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + monthlyLM032.getMonthlyLM032Id());
	...
	public MonthlyLM032 insert(MonthlyLM032 monthlyLM032, TitaVo... titaVo) throws DBException {
		...
		logger.info("Insert..." + dbName + " " + monthlyLM032.getMonthlyLM032Id());
	...
	public MonthlyLM032 update(MonthlyLM032 monthlyLM032, TitaVo... titaVo) throws DBException {
		...
		logger.info("Update..." + dbName + " " + monthlyLM032.getMonthlyLM032Id());
		if (!empNot.isEmpty())
	...
	public void delete(MonthlyLM032 monthlyLM032, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Delete..." + dbName + " " + monthlyLM032.getMonthlyLM032Id());
		if (dbName.equals(ContentName.onDay)) {
