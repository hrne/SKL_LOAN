 ...
 * @version 1.0.0
 */
public interface PfItDetailRepositoryHist extends JpaRepository<PfItDetail, Long> {
	...
	// PieceCode =
	public Optional<PfItDetail> findTopByCustNoIsAndFacmNoIsAndBormNoIsAndPerfDateIsAndRepayTypeIsAndPieceCodeIs(int custNo_0, int facmNo_1, int bormNo_2, int perfDate_3, int repayType_4,
			String pieceCode_5);

	// CustNo = ,AND FacmNo = ,AND BormNo =
	public Optional<PfItDetail> findTopByCustNoIsAndFacmNoIsAndBormNoIsOrderByPerfDateDesc(int custNo_0, int facmNo_1, int bormNo_2);
