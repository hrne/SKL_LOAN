...
public class InnReCheckServiceImpl extends ASpringJpaParm implements InnReCheckService, InitializingBean {
	...
	public Slice<InnReCheck> findCustNo(int yearMonth_0, int conditionCode_1, int custNo_2, int custNo_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = innReCheckReposDay.findAllByYearMonthIsAndConditionCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAsc(yearMonth_0, conditionCode_1, custNo_2, custNo_3,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = innReCheckReposMon.findAllByYearMonthIsAndConditionCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAsc(yearMonth_0, conditionCode_1, custNo_2, custNo_3,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = innReCheckReposHist.findAllByYearMonthIsAndConditionCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAsc(yearMonth_0, conditionCode_1, custNo_2, custNo_3,
					pageable);
		else
			slice = innReCheckRepos.findAllByYearMonthIsAndConditionCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAsc(yearMonth_0, conditionCode_1, custNo_2, custNo_3,
					pageable);
	...
	public Slice<InnReCheck> findYearMonth(int yearMonth_0, int yearMonth_1, int custNo_2, int custNo_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = innReCheckReposDay.findAllByYearMonthGreaterThanEqualAndYearMonthLessThanEqualAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByYearMonthAscConditionCodeAscCustNoAscFacmNoAsc(
					yearMonth_0, yearMonth_1, custNo_2, custNo_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = innReCheckReposMon.findAllByYearMonthGreaterThanEqualAndYearMonthLessThanEqualAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByYearMonthAscConditionCodeAscCustNoAscFacmNoAsc(
					yearMonth_0, yearMonth_1, custNo_2, custNo_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = innReCheckReposHist.findAllByYearMonthGreaterThanEqualAndYearMonthLessThanEqualAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByYearMonthAscConditionCodeAscCustNoAscFacmNoAsc(
					yearMonth_0, yearMonth_1, custNo_2, custNo_3, pageable);
		else
			slice = innReCheckRepos.findAllByYearMonthGreaterThanEqualAndYearMonthLessThanEqualAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByYearMonthAscConditionCodeAscCustNoAscFacmNoAsc(
					yearMonth_0, yearMonth_1, custNo_2, custNo_3, pageable);
