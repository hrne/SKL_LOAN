...
public class BatxRateChangeServiceImpl extends ASpringJpaParm implements BatxRateChangeService, InitializingBean {
	...
	public Slice<BatxRateChange> findL4321Report(int adjDate_0, int adjDate_1, int custCode_2, int custCode_3, int txKind_4, int confirmFlag_5, int index, int limit, TitaVo... titaVo) {
		...
		this.info("findL4321Report " + dbName + " : " + "adjDate_0 : " + adjDate_0 + " adjDate_1 : " + adjDate_1 + " custCode_2 : " + custCode_2 + " custCode_3 : " + custCode_3 + " txKind_4 : "
				+ txKind_4 + " confirmFlag_5 : " + confirmFlag_5);
		if (dbName.equals(ContentName.onDay))
			slice = batxRateChangeReposDay
					.findAllByAdjDateGreaterThanEqualAndAdjDateLessThanEqualAndCustCodeGreaterThanEqualAndCustCodeLessThanEqualAndTxKindIsAndConfirmFlagIsOrderByCustNoAscFacmNoAscBormNoAsc(adjDate_0,
							adjDate_1, custCode_2, custCode_3, txKind_4, confirmFlag_5, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = batxRateChangeReposMon
					.findAllByAdjDateGreaterThanEqualAndAdjDateLessThanEqualAndCustCodeGreaterThanEqualAndCustCodeLessThanEqualAndTxKindIsAndConfirmFlagIsOrderByCustNoAscFacmNoAscBormNoAsc(adjDate_0,
							adjDate_1, custCode_2, custCode_3, txKind_4, confirmFlag_5, pageable);
	...
	public BatxRateChange insert(BatxRateChange batxRateChange, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(batxRateChange.getBatxRateChangeId()) != null)
