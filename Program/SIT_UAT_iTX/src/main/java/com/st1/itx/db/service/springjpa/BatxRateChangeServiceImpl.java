...
@Repository
public class BatxRateChangeServiceImpl implements BatxRateChangeService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(BatxRateChangeServiceImpl.class);
  ...
  public BatxRateChange findById(BatxRateChangeId batxRateChangeId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + batxRateChangeId);
...
em = null;
  ...
  public Slice<BatxRateChange> baseRateCodeEq(int adjDate_0, int adjDate_1, String baseRateCode_2, int index, int limit, TitaVo... titaVo) {
    ...
    logger.info("baseRateCodeEq " + dbName + " : " + "adjDate_0 : " + adjDate_0 + " adjDate_1 : " +  adjDate_1 + " baseRateCode_2 : " +  baseRateCode_2);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<BatxRateChange> custCodeEq(int adjDate_0, int adjDate_1, int custCode_2, int custCode_3, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("custCodeEq " + dbName + " : " + "adjDate_0 : " + adjDate_0 + " adjDate_1 : " +  adjDate_1 + " custCode_2 : " +  custCode_2 + " custCode_3 : " +  custCode_3);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<BatxRateChange> findL4931AEq(int custCode_0, int custCode_1, int txKind_2, int txKind_3, int adjCode_4, int adjCode_5, int adjDate_6, int adjDate_7, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("findL4931AEq " + dbName + " : " + "custCode_0 : " + custCode_0 + " custCode_1 : " +  custCode_1 + " txKind_2 : " +  txKind_2 + " txKind_3 : " +  txKind_3 + " adjCode_4 : " +  adjCode_4 + " adjCode_5 : " +  adjCode_5 + " adjDate_6 : " +  adjDate_6 + " adjDate_7 : " +  adjDate_7);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<BatxRateChange> adjCodeEq(int adjDate_0, int adjDate_1, int adjCode_2, int adjCode_3, int rateKeyInCode_4, int rateKeyInCode_5, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("adjCodeEq " + dbName + " : " + "adjDate_0 : " + adjDate_0 + " adjDate_1 : " +  adjDate_1 + " adjCode_2 : " +  adjCode_2 + " adjCode_3 : " +  adjCode_3 + " rateKeyInCode_4 : " +  rateKeyInCode_4 + " rateKeyInCode_5 : " +  rateKeyInCode_5);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<BatxRateChange> findL4321Report(int adjDate_0, int adjDate_1, int custCode_2, int custCode_3, int txKind_4, int confirmFlag_5, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("findL4321Report " + dbName + " : " + "adjDate_0 : " + adjDate_0 + " adjDate_1 : " +  adjDate_1 + " custCode_2 : " +  custCode_2 + " custCode_3 : " +  custCode_3 + " txKind_4 : " +  txKind_4 + " confirmFlag_5 : " +  confirmFlag_5);
    if (dbName.equals(ContentName.onDay))
  ...
  public BatxRateChange holdById(BatxRateChangeId batxRateChangeId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + batxRateChangeId);
    Optional<BatxRateChange> batxRateChange = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public BatxRateChange holdById(BatxRateChange batxRateChange, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + batxRateChange.getBatxRateChangeId());
  ...
  public BatxRateChange insert(BatxRateChange batxRateChange, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + batxRateChange.getBatxRateChangeId());
  ...
  public BatxRateChange update(BatxRateChange batxRateChange, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + batxRateChange.getBatxRateChangeId());
    if (!empNot.isEmpty())
      batxRateChange.setLastUpdateEmpNo(empNot);
  ...
  public void delete(BatxRateChange batxRateChange, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + batxRateChange.getBatxRateChangeId());
    if (dbName.equals(ContentName.onDay)) {
