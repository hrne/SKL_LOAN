...
public class PfCoOfficer implements Serializable {
	...
	public String toString() {
		return "PfCoOfficer [pfCoOfficerId=" + pfCoOfficerId + ", ineffectiveDate=" + ineffectiveDate + ", areaCode=" + areaCode + ", distCode=" + distCode + ", deptCode=" + deptCode + ", areaItem="
				+ areaItem + ", distItem=" + distItem + ", deptItem=" + deptItem + ", empClass=" + empClass + ", classPass=" + classPass + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
