...
public class CollList implements Serializable {
	...
	// 戶況
	/*
	 * 00: 正常戶 02: 催收戶03: 結案戶04: 逾期戶(逾期期數&amp;gt;=1)05: 催收結案戶06: 呆帳戶 07: 部分轉呆戶08:
	 * 債權轉讓戶09: 呆帳結案戶
	 */
	@Column(name = "`Status`")
	...
	/**
	 * 戶況<br>
	 * 00: 正常戶 02: 催收戶 03: 結案戶 04: 逾期戶(逾期期數&amp;gt;=1) 05: 催收結案戶 06: 呆帳戶 07: 部分轉呆戶
	 * 08: 債權轉讓戶 09: 呆帳結案戶
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "CollList [collListId=" + collListId + ", caseCode=" + caseCode + ", txDate=" + txDate + ", txCode=" + txCode + ", prevIntDate=" + prevIntDate + ", nextIntDate=" + nextIntDate
				...
				+ cityCode + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
