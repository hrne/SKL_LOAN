...
/**
  ...
  * @param clFlag 抵押品別
  ...
  public boolean equals(Object obj) {
    ...
    return dataYM == monthlyLM014BId.dataYM && acctCode.equals(monthlyLM014BId.acctCode) && accountType == monthlyLM014BId.accountType && acBookCode.equals(monthlyLM014BId.acBookCode) && entCode.equals(monthlyLM014BId.entCode) && relsFlag.equals(monthlyLM014BId.relsFlag) && clFlag.equals(monthlyLM014BId.clFlag);
  }

  @Override
  public String toString() {
    return "MonthlyLM014BId [dataYM=" + dataYM + ", acctCode=" + acctCode + ", accountType=" + accountType + ", acBookCode=" + acBookCode + ", entCode=" + entCode + ", relsFlag=" + relsFlag + ", clFlag=" + clFlag + "]";
  }
}
