...
em = null;
  ...
  public Slice<TxInquiry> findEntdyImportFg(int entdy_0, int entdy_1, String importFg_2, int custNo_3, int custNo_4, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("findEntdyImportFg " + dbName + " : " + "entdy_0 : " + entdy_0 + " entdy_1 : " +  entdy_1 + " importFg_2 : " +  importFg_2 + " custNo_3 : " +  custNo_3 + " custNo_4 : " +  custNo_4);
    if (dbName.equals(ContentName.onDay))
      slice = txInquiryReposDay.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndImportFgIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCreateDateAsc(entdy_0, entdy_1, importFg_2, custNo_3, custNo_4, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = txInquiryReposMon.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndImportFgIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCreateDateAsc(entdy_0, entdy_1, importFg_2, custNo_3, custNo_4, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = txInquiryReposHist.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndImportFgIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCreateDateAsc(entdy_0, entdy_1, importFg_2, custNo_3, custNo_4, pageable);
    else 
      slice = txInquiryRepos.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndImportFgIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCreateDateAsc(entdy_0, entdy_1, importFg_2, custNo_3, custNo_4, pageable);
