...
public class AcReceivableServiceImpl extends ASpringJpaParm implements AcReceivableService, InitializingBean {
	...
	@Override
	public Slice<AcReceivable> acrvClsFlagEq(int clsFlag_0, String branchNo_1, String currencyCode_2, String acNoCode_3, String acSubCode_4, String acDtlCode_5, int custNo_6, int custNo_7, int index,
		...
		this.info("acrvClsFlagEq " + dbName + " : " + "clsFlag_0 : " + clsFlag_0 + " branchNo_1 : " + branchNo_1 + " currencyCode_2 : " + currencyCode_2 + " acNoCode_3 : " + acNoCode_3
				+ " acSubCode_4 : " + acSubCode_4 + " acDtlCode_5 : " + acDtlCode_5 + " custNo_6 : " + custNo_6 + " custNo_7 : " + custNo_7);
		if (dbName.equals(ContentName.onDay))
			slice = acReceivableReposDay
					.findAllByClsFlagIsAndBranchNoIsAndCurrencyCodeIsAndAcNoCodeIsAndAcSubCodeIsAndAcDtlCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAsc(clsFlag_0,
							branchNo_1, currencyCode_2, acNoCode_3, acSubCode_4, acDtlCode_5, custNo_6, custNo_7, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = acReceivableReposMon
					.findAllByClsFlagIsAndBranchNoIsAndCurrencyCodeIsAndAcNoCodeIsAndAcSubCodeIsAndAcDtlCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAsc(clsFlag_0,
							branchNo_1, currencyCode_2, acNoCode_3, acSubCode_4, acDtlCode_5, custNo_6, custNo_7, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = acReceivableReposHist
					.findAllByClsFlagIsAndBranchNoIsAndCurrencyCodeIsAndAcNoCodeIsAndAcSubCodeIsAndAcDtlCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAsc(clsFlag_0,
							branchNo_1, currencyCode_2, acNoCode_3, acSubCode_4, acDtlCode_5, custNo_6, custNo_7, pageable);
		else
			slice = acReceivableRepos.findAllByClsFlagIsAndBranchNoIsAndCurrencyCodeIsAndAcNoCodeIsAndAcSubCodeIsAndAcDtlCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAsc(
					clsFlag_0, branchNo_1, currencyCode_2, acNoCode_3, acSubCode_4, acDtlCode_5, custNo_6, custNo_7, pageable);
	...
	public Slice<AcReceivable> acrvFacmNoRange(int clsFlag_0, int custNo_1, int acctFlag_2, int facmNo_3, int facmNo_4, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = acReceivableReposDay.findAllByClsFlagIsAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByOpenAcDateAscRvNoAsc(clsFlag_0, custNo_1, acctFlag_2, facmNo_3,
					facmNo_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = acReceivableReposMon.findAllByClsFlagIsAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByOpenAcDateAscRvNoAsc(clsFlag_0, custNo_1, acctFlag_2, facmNo_3,
					facmNo_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = acReceivableReposHist.findAllByClsFlagIsAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByOpenAcDateAscRvNoAsc(clsFlag_0, custNo_1, acctFlag_2,
					facmNo_3, facmNo_4, pageable);
		else
			slice = acReceivableRepos.findAllByClsFlagIsAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByOpenAcDateAscRvNoAsc(clsFlag_0, custNo_1, acctFlag_2, facmNo_3,
					facmNo_4, pageable);
	...
	@Override
	public Slice<AcReceivable> acrvOpenAcDateRange(String branchNo_0, String currencyCode_1, String acNoCode_2, String acSubCode_3, String acDtlCode_4, int openAcDate_5, int openAcDate_6, int index,
			int limit, TitaVo... titaVo) {
		String dbName = "";
		Slice<AcReceivable> slice = null;
		if (titaVo.length != 0)
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("acrvOpenAcDateRange " + dbName + " : " + "branchNo_0 : " + branchNo_0 + " currencyCode_1 : " + currencyCode_1 + " acNoCode_2 : " + acNoCode_2 + " acSubCode_3 : " + acSubCode_3
				+ " acDtlCode_4 : " + acDtlCode_4 + " openAcDate_5 : " + openAcDate_5 + " openAcDate_6 : " + openAcDate_6);
		if (dbName.equals(ContentName.onDay))
			slice = acReceivableReposDay
					.findAllByBranchNoIsAndCurrencyCodeIsAndAcNoCodeIsAndAcSubCodeIsAndAcDtlCodeIsAndOpenAcDateGreaterThanEqualAndOpenAcDateLessThanEqualOrderByOpenAcDateAscCustNoAscFacmNoAsc(
							branchNo_0, currencyCode_1, acNoCode_2, acSubCode_3, acDtlCode_4, openAcDate_5, openAcDate_6, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = acReceivableReposMon
					.findAllByBranchNoIsAndCurrencyCodeIsAndAcNoCodeIsAndAcSubCodeIsAndAcDtlCodeIsAndOpenAcDateGreaterThanEqualAndOpenAcDateLessThanEqualOrderByOpenAcDateAscCustNoAscFacmNoAsc(
							branchNo_0, currencyCode_1, acNoCode_2, acSubCode_3, acDtlCode_4, openAcDate_5, openAcDate_6, pageable);
	...
	public Slice<AcReceivable> useL2062Eq(String acctCode_0, int custNo_1, int facmNo_2, int facmNo_3, int clsFlag_4, int clsFlag_5, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("useL2062Eq " + dbName + " : " + "acctCode_0 : " + acctCode_0 + " custNo_1 : " + custNo_1 + " facmNo_2 : " + facmNo_2 + " facmNo_3 : " + facmNo_3 + " clsFlag_4 : " + clsFlag_4
				+ " clsFlag_5 : " + clsFlag_5);
		if (dbName.equals(ContentName.onDay))
			slice = acReceivableReposDay.findAllByAcctCodeIsAndCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndClsFlagGreaterThanEqualAndClsFlagLessThanEqualOrderByOpenAcDateAsc(acctCode_0,
					custNo_1, facmNo_2, facmNo_3, clsFlag_4, clsFlag_5, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = acReceivableReposMon.findAllByAcctCodeIsAndCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndClsFlagGreaterThanEqualAndClsFlagLessThanEqualOrderByOpenAcDateAsc(acctCode_0,
					custNo_1, facmNo_2, facmNo_3, clsFlag_4, clsFlag_5, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = acReceivableReposHist.findAllByAcctCodeIsAndCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndClsFlagGreaterThanEqualAndClsFlagLessThanEqualOrderByOpenAcDateAsc(acctCode_0,
					custNo_1, facmNo_2, facmNo_3, clsFlag_4, clsFlag_5, pageable);
		else
			slice = acReceivableRepos.findAllByAcctCodeIsAndCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndClsFlagGreaterThanEqualAndClsFlagLessThanEqualOrderByOpenAcDateAsc(acctCode_0,
					custNo_1, facmNo_2, facmNo_3, clsFlag_4, clsFlag_5, pageable);
	...
	@Override
	public Slice<AcReceivable> acrvClsFlagSubBook(int clsFlag_0, String acBookCode_1, String acSubBookCode_2, String branchNo_3, String currencyCode_4, String acNoCode_5, String acSubCode_6,
			String acDtlCode_7, int custNo_8, int custNo_9, int index, int limit, TitaVo... titaVo) {
		String dbName = "";
		Slice<AcReceivable> slice = null;
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("acrvClsFlagSubBook " + dbName + " : " + "clsFlag_0 : " + clsFlag_0 + " acBookCode_1 : " + acBookCode_1 + " acSubBookCode_2 : " + acSubBookCode_2 + " branchNo_3 : " + branchNo_3
				+ " currencyCode_4 : " + currencyCode_4 + " acNoCode_5 : " + acNoCode_5 + " acSubCode_6 : " + acSubCode_6 + " acDtlCode_7 : " + acDtlCode_7 + " custNo_8 : " + custNo_8 + " custNo_9 : "
				+ custNo_9);
		if (dbName.equals(ContentName.onDay))
			slice = acReceivableReposDay
					.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndBranchNoIsAndCurrencyCodeIsAndAcNoCodeIsAndAcSubCodeIsAndAcDtlCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByAcctCodeAscCustNoAscFacmNoAsc(
	...
	@Override
	public Slice<AcReceivable> acrvFacmNoSubBook(int clsFlag_0, String acBookCode_1, String acSubBookCode_2, int custNo_3, int acctFlag_4, int facmNo_5, int facmNo_6, int index, int limit,
			TitaVo... titaVo) {
		String dbName = "";
		Slice<AcReceivable> slice = null;
		if (titaVo.length != 0)
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("acrvFacmNoSubBook " + dbName + " : " + "clsFlag_0 : " + clsFlag_0 + " acBookCode_1 : " + acBookCode_1 + " acSubBookCode_2 : " + acSubBookCode_2 + " custNo_3 : " + custNo_3
				+ " acctFlag_4 : " + acctFlag_4 + " facmNo_5 : " + facmNo_5 + " facmNo_6 : " + facmNo_6);
		if (dbName.equals(ContentName.onDay))
			slice = acReceivableReposDay
					.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByAcctCodeAscCustNoAscFacmNoAsc(clsFlag_0,
							acBookCode_1, acSubBookCode_2, custNo_3, acctFlag_4, facmNo_5, facmNo_6, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = acReceivableReposMon
					.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByAcctCodeAscCustNoAscFacmNoAsc(clsFlag_0,
							acBookCode_1, acSubBookCode_2, custNo_3, acctFlag_4, facmNo_5, facmNo_6, pageable);
			...
			slice = acReceivableRepos.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByAcctCodeAscCustNoAscFacmNoAsc(
					clsFlag_0, acBookCode_1, acSubBookCode_2, custNo_3, acctFlag_4, facmNo_5, facmNo_6, pageable);
	...
	public Slice<AcReceivable> acctCodeSubBook(int clsFlag_0, String acBookCode_1, String acSubBookCode_2, String acctCode_3, int custNo_4, int custNo_5, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("acctCodeSubBook " + dbName + " : " + "clsFlag_0 : " + clsFlag_0 + " acBookCode_1 : " + acBookCode_1 + " acSubBookCode_2 : " + acSubBookCode_2 + " acctCode_3 : " + acctCode_3
				+ " custNo_4 : " + custNo_4 + " custNo_5 : " + custNo_5);
		if (dbName.equals(ContentName.onDay))
			slice = acReceivableReposDay.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndAcctCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByAcctCodeAscCustNoAscFacmNoAsc(
					clsFlag_0, acBookCode_1, acSubBookCode_2, acctCode_3, custNo_4, custNo_5, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = acReceivableReposMon.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndAcctCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByAcctCodeAscCustNoAscFacmNoAsc(
					clsFlag_0, acBookCode_1, acSubBookCode_2, acctCode_3, custNo_4, custNo_5, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = acReceivableReposHist.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndAcctCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByAcctCodeAscCustNoAscFacmNoAsc(
					clsFlag_0, acBookCode_1, acSubBookCode_2, acctCode_3, custNo_4, custNo_5, pageable);
		else
			slice = acReceivableRepos.findAllByClsFlagIsAndAcBookCodeIsAndAcSubBookCodeLikeAndAcctCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByAcctCodeAscCustNoAscFacmNoAsc(clsFlag_0,
					acBookCode_1, acSubBookCode_2, acctCode_3, custNo_4, custNo_5, pageable);
	...
	public Slice<AcReceivable> useL2r58Eq(int custNo_0, int facmNo_1, int acctFlag_2, int acctFlag_3, String rvNo_4, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = acReceivableReposDay.findAllByCustNoIsAndFacmNoIsAndAcctFlagGreaterThanEqualAndAcctFlagLessThanEqualAndRvNoLikeOrderByFacmNoAscRvNoAsc(custNo_0, facmNo_1, acctFlag_2, acctFlag_3,
					rvNo_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = acReceivableReposMon.findAllByCustNoIsAndFacmNoIsAndAcctFlagGreaterThanEqualAndAcctFlagLessThanEqualAndRvNoLikeOrderByFacmNoAscRvNoAsc(custNo_0, facmNo_1, acctFlag_2, acctFlag_3,
					rvNo_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = acReceivableReposHist.findAllByCustNoIsAndFacmNoIsAndAcctFlagGreaterThanEqualAndAcctFlagLessThanEqualAndRvNoLikeOrderByFacmNoAscRvNoAsc(custNo_0, facmNo_1, acctFlag_2, acctFlag_3,
					rvNo_4, pageable);
		else
			slice = acReceivableRepos.findAllByCustNoIsAndFacmNoIsAndAcctFlagGreaterThanEqualAndAcctFlagLessThanEqualAndRvNoLikeOrderByFacmNoAscRvNoAsc(custNo_0, facmNo_1, acctFlag_2, acctFlag_3,
					rvNo_4, pageable);
	...
	public Slice<AcReceivable> useBs902Eq(int custNo_0, int custNo_1, int clsFlag_2, int receivableFlag_3, String rvNo_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("useBs902Eq " + dbName + " : " + "custNo_0 : " + custNo_0 + " custNo_1 : " + custNo_1 + " clsFlag_2 : " + clsFlag_2 + " receivableFlag_3 : " + receivableFlag_3 + " rvNo_4 : "
				+ rvNo_4);
		if (dbName.equals(ContentName.onDay))
			slice = acReceivableReposDay.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndClsFlagIsAndReceivableFlagIsAndRvNoLikeOrderByCustNoAscFacmNoAsc(custNo_0, custNo_1, clsFlag_2,
					receivableFlag_3, rvNo_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = acReceivableReposMon.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndClsFlagIsAndReceivableFlagIsAndRvNoLikeOrderByCustNoAscFacmNoAsc(custNo_0, custNo_1, clsFlag_2,
					receivableFlag_3, rvNo_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = acReceivableReposHist.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndClsFlagIsAndReceivableFlagIsAndRvNoLikeOrderByCustNoAscFacmNoAsc(custNo_0, custNo_1, clsFlag_2,
					receivableFlag_3, rvNo_4, pageable);
		else
			slice = acReceivableRepos.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndClsFlagIsAndReceivableFlagIsAndRvNoLikeOrderByCustNoAscFacmNoAsc(custNo_0, custNo_1, clsFlag_2,
					receivableFlag_3, rvNo_4, pageable);
	...
	@Override
	public Slice<AcReceivable> acrvClsFlag2SubBook(String acBookCode_0, String acSubBookCode_1, String branchNo_2, String currencyCode_3, String acNoCode_4, String acSubCode_5, String acDtlCode_6,
			int custNo_7, int custNo_8, int index, int limit, TitaVo... titaVo) {
		String dbName = "";
		Slice<AcReceivable> slice = null;
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("acrvClsFlag2SubBook " + dbName + " : " + "acBookCode_0 : " + acBookCode_0 + " acSubBookCode_1 : " + acSubBookCode_1 + " branchNo_2 : " + branchNo_2 + " currencyCode_3 : "
				+ currencyCode_3 + " acNoCode_4 : " + acNoCode_4 + " acSubCode_5 : " + acSubCode_5 + " acDtlCode_6 : " + acDtlCode_6 + " custNo_7 : " + custNo_7 + " custNo_8 : " + custNo_8);
		if (dbName.equals(ContentName.onDay))
			slice = acReceivableReposDay
	...
	public Slice<AcReceivable> acrvFacmNo2SubBook(String acBookCode_0, String acSubBookCode_1, int custNo_2, int acctFlag_3, int facmNo_4, int facmNo_5, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("acrvFacmNo2SubBook " + dbName + " : " + "acBookCode_0 : " + acBookCode_0 + " acSubBookCode_1 : " + acSubBookCode_1 + " custNo_2 : " + custNo_2 + " acctFlag_3 : " + acctFlag_3
				+ " facmNo_4 : " + facmNo_4 + " facmNo_5 : " + facmNo_5);
		if (dbName.equals(ContentName.onDay))
			slice = acReceivableReposDay.findAllByAcBookCodeIsAndAcSubBookCodeLikeAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByAcctCodeAscCustNoAscFacmNoAsc(
					acBookCode_0, acSubBookCode_1, custNo_2, acctFlag_3, facmNo_4, facmNo_5, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = acReceivableReposMon.findAllByAcBookCodeIsAndAcSubBookCodeLikeAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByAcctCodeAscCustNoAscFacmNoAsc(
					acBookCode_0, acSubBookCode_1, custNo_2, acctFlag_3, facmNo_4, facmNo_5, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = acReceivableReposHist.findAllByAcBookCodeIsAndAcSubBookCodeLikeAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByAcctCodeAscCustNoAscFacmNoAsc(
					acBookCode_0, acSubBookCode_1, custNo_2, acctFlag_3, facmNo_4, facmNo_5, pageable);
		else
			slice = acReceivableRepos.findAllByAcBookCodeIsAndAcSubBookCodeLikeAndCustNoIsAndAcctFlagIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByAcctCodeAscCustNoAscFacmNoAsc(acBookCode_0,
					acSubBookCode_1, custNo_2, acctFlag_3, facmNo_4, facmNo_5, pageable);
	...
	public Slice<AcReceivable> acctCode2SubBook(String acBookCode_0, String acSubBookCode_1, String acctCode_2, int custNo_3, int custNo_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("acctCode2SubBook " + dbName + " : " + "acBookCode_0 : " + acBookCode_0 + " acSubBookCode_1 : " + acSubBookCode_1 + " acctCode_2 : " + acctCode_2 + " custNo_3 : " + custNo_3
				+ " custNo_4 : " + custNo_4);
		if (dbName.equals(ContentName.onDay))
			slice = acReceivableReposDay.findAllByAcBookCodeIsAndAcSubBookCodeLikeAndAcctCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByAcctCodeAscCustNoAscFacmNoAsc(acBookCode_0,
					acSubBookCode_1, acctCode_2, custNo_3, custNo_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = acReceivableReposMon.findAllByAcBookCodeIsAndAcSubBookCodeLikeAndAcctCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByAcctCodeAscCustNoAscFacmNoAsc(acBookCode_0,
					acSubBookCode_1, acctCode_2, custNo_3, custNo_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = acReceivableReposHist.findAllByAcBookCodeIsAndAcSubBookCodeLikeAndAcctCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByAcctCodeAscCustNoAscFacmNoAsc(acBookCode_0,
					acSubBookCode_1, acctCode_2, custNo_3, custNo_4, pageable);
		else
			slice = acReceivableRepos.findAllByAcBookCodeIsAndAcSubBookCodeLikeAndAcctCodeIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByAcctCodeAscCustNoAscFacmNoAsc(acBookCode_0,
					acSubBookCode_1, acctCode_2, custNo_3, custNo_4, pageable);
