...
public class JcicZ448 implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4348614538226516784L;
	...
	public String toString() {
		return "JcicZ448 [jcicZ448Id=" + jcicZ448Id + ", tranKey=" + tranKey + ", signPrin=" + signPrin + ", signOther=" + signOther + ", ownPercentage=" + ownPercentage + ", acQuitAmt=" + acQuitAmt
