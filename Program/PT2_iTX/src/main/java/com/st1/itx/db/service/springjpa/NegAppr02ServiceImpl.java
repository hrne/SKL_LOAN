...
em = null;
  ...
  @Override
  public Slice<NegAppr02> bringUpDate2(int bringUpDate_0, int acDate_1, int index, int limit, TitaVo... titaVo) {
    String dbName = "";
    Slice<NegAppr02> slice = null;
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("bringUpDate2 " + dbName + " : " + "bringUpDate_0 : " + bringUpDate_0 + " acDate_1 : " +  acDate_1);
    if (dbName.equals(ContentName.onDay))
      slice = negAppr02ReposDay.findAllByBringUpDateLessThanEqualAndAcDateIsOrderByBringUpDateDescCustIdAsc(bringUpDate_0, acDate_1, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = negAppr02ReposMon.findAllByBringUpDateLessThanEqualAndAcDateIsOrderByBringUpDateDescCustIdAsc(bringUpDate_0, acDate_1, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = negAppr02ReposHist.findAllByBringUpDateLessThanEqualAndAcDateIsOrderByBringUpDateDescCustIdAsc(bringUpDate_0, acDate_1, pageable);
    else 
      slice = negAppr02Repos.findAllByBringUpDateLessThanEqualAndAcDateIsOrderByBringUpDateDescCustIdAsc(bringUpDate_0, acDate_1, pageable);
  ...
  public NegAppr02 insert(NegAppr02 negAppr02, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(negAppr02.getNegAppr02Id(), titaVo) != null)
