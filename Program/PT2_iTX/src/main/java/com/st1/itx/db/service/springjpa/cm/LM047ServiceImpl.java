...
public class LM047ServiceImpl extends ASpringJpaParm implements InitializingBean {
	...
	public List<Map<String, String>> findAll(TitaVo titaVo) throws Exception {
		...
		sql += " 								AND R.\"OldFacmNo\"  = T.\"FacmNo\" ";
		sql += "    LEFT JOIN \"TEMP\" N ON N.\"CustNo\" = R.\"CustNo\" ";
		sql += " 						AND N.\"FacmNo\" = R.\"NewFacmNo\" ";
		sql += "	WHERE N.\"Status\" IN (0,2,4,7)   "; // 展期新額度為0:正常戶 2:催收戶 4 :逾期戶 7:部分轉呆戶
		sql += " ) ";
		...
		sql += "      LEFT JOIN BORM M ON M.\"CustNo\" = D.\"CustNo\" ";
		sql += "                      AND M.\"FacmNo\" = D.\"FacmNo\" ";
