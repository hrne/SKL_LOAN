...
@Component
@Scope("prototype")
public class L9132ReportB extends MakeReport {
...
//	private String reportItem = "傳票媒體明細表-交易序號";
	private String reportItem = "傳票號碼";
...
//		open(titaVo, reportDate, brno, reportCode, reportItem, security, pageSize, pageOrientation);
		...
		// 查資料庫
		resultList = sL9132ServiceImpl.doQueryL9132B(this.reportDate, iBatchNo, titaVo);
