...
public class JcicZ061ServiceImpl extends ASpringJpaParm implements JcicZ061Service, InitializingBean {
	...
	public Slice<JcicZ061> otherEq(String submitKey_0, String custId_1, int rcDate_2, int changePayDate_3, String maxMainCode_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("otherEq " + dbName + " : " + "submitKey_0 : " + submitKey_0 + " custId_1 : " + custId_1 + " rcDate_2 : " + rcDate_2 + " changePayDate_3 : " + changePayDate_3 + " maxMainCode_4 : "
				+ maxMainCode_4);
		if (dbName.equals(ContentName.onDay))
			slice = jcicZ061ReposDay.findAllBySubmitKeyIsAndCustIdIsAndRcDateIsAndChangePayDateIsAndMaxMainCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, rcDate_2, changePayDate_3, maxMainCode_4,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = jcicZ061ReposMon.findAllBySubmitKeyIsAndCustIdIsAndRcDateIsAndChangePayDateIsAndMaxMainCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, rcDate_2, changePayDate_3, maxMainCode_4,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = jcicZ061ReposHist.findAllBySubmitKeyIsAndCustIdIsAndRcDateIsAndChangePayDateIsAndMaxMainCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, rcDate_2, changePayDate_3, maxMainCode_4,
					pageable);
		else
			slice = jcicZ061Repos.findAllBySubmitKeyIsAndCustIdIsAndRcDateIsAndChangePayDateIsAndMaxMainCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, rcDate_2, changePayDate_3, maxMainCode_4,
					pageable);
	...
	public JcicZ061 otherFirst(String submitKey_0, String custId_1, int rcDate_2, int changePayDate_3, String maxMainCode_4, TitaVo... titaVo) {
		...
		this.info("otherFirst " + dbName + " : " + "submitKey_0 : " + submitKey_0 + " custId_1 : " + custId_1 + " rcDate_2 : " + rcDate_2 + " changePayDate_3 : " + changePayDate_3
				+ " maxMainCode_4 : " + maxMainCode_4);
		Optional<JcicZ061> jcicZ061T = null;
		if (dbName.equals(ContentName.onDay))
			jcicZ061T = jcicZ061ReposDay.findTopBySubmitKeyIsAndCustIdIsAndRcDateIsAndChangePayDateIsAndMaxMainCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, rcDate_2, changePayDate_3,
					maxMainCode_4);
		else if (dbName.equals(ContentName.onMon))
			jcicZ061T = jcicZ061ReposMon.findTopBySubmitKeyIsAndCustIdIsAndRcDateIsAndChangePayDateIsAndMaxMainCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, rcDate_2, changePayDate_3,
					maxMainCode_4);
		else if (dbName.equals(ContentName.onHist))
			jcicZ061T = jcicZ061ReposHist.findTopBySubmitKeyIsAndCustIdIsAndRcDateIsAndChangePayDateIsAndMaxMainCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, rcDate_2, changePayDate_3,
					maxMainCode_4);
		else
			jcicZ061T = jcicZ061Repos.findTopBySubmitKeyIsAndCustIdIsAndRcDateIsAndChangePayDateIsAndMaxMainCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, rcDate_2, changePayDate_3,
					maxMainCode_4);
	...
	public JcicZ061 insert(JcicZ061 jcicZ061, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(jcicZ061.getJcicZ061Id(), titaVo) != null)
