...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "BatxHead [batxHeadId=" + batxHeadId + ", batxTotAmt=" + batxTotAmt + ", batxTotCnt=" + batxTotCnt + ", unfinishCnt=" + unfinishCnt + ", batxExeCode=" + batxExeCode
           + ", batxStsCode=" + batxStsCode + ", titaTlrNo=" + titaTlrNo + ", titaTxCd=" + titaTxCd + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
