...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "BatxBaseRateChange [batxBaseRateChangeId=" + batxBaseRateChangeId + ", prodNo=" + prodNo + ", baseRateCode=" + baseRateCode
           + ", oriBaseRate=" + oriBaseRate + ", baseRateEffectDate=" + baseRateEffectDate + ", baseRate=" + baseRate + ", fitRate=" + fitRate + ", txEffectDate=" + txEffectDate + ", jsonFields=" + jsonFields
