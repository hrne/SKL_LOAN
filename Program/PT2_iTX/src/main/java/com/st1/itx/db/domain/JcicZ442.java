...
public class JcicZ442 implements Serializable {
	...
	public String toString() {
		return "JcicZ442 [jcicZ442Id=" + jcicZ442Id + ", tranKey=" + tranKey + ", isMaxMain=" + isMaxMain + ", isClaims=" + isClaims + ", guarLoanCnt=" + guarLoanCnt + ", civil323ExpAmt="
				...
				+ guarObliOther + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
