...
public class JcicZ055ServiceImpl extends ASpringJpaParm implements JcicZ055Service, InitializingBean {
	...
	public Slice<JcicZ055> otherEq(String submitKey_0, String custId_1, String caseStatus_2, int claimDate_3, String courtCode_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("otherEq " + dbName + " : " + "submitKey_0 : " + submitKey_0 + " custId_1 : " + custId_1 + " caseStatus_2 : " + caseStatus_2 + " claimDate_3 : " + claimDate_3 + " courtCode_4 : "
				+ courtCode_4);
		if (dbName.equals(ContentName.onDay))
			slice = jcicZ055ReposDay.findAllBySubmitKeyIsAndCustIdIsAndCaseStatusIsAndClaimDateIsAndCourtCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, caseStatus_2, claimDate_3, courtCode_4,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = jcicZ055ReposMon.findAllBySubmitKeyIsAndCustIdIsAndCaseStatusIsAndClaimDateIsAndCourtCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, caseStatus_2, claimDate_3, courtCode_4,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = jcicZ055ReposHist.findAllBySubmitKeyIsAndCustIdIsAndCaseStatusIsAndClaimDateIsAndCourtCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, caseStatus_2, claimDate_3, courtCode_4,
					pageable);
		else
			slice = jcicZ055Repos.findAllBySubmitKeyIsAndCustIdIsAndCaseStatusIsAndClaimDateIsAndCourtCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, caseStatus_2, claimDate_3, courtCode_4,
					pageable);
	...
	public JcicZ055 otherFirst(String submitKey_0, String custId_1, String caseStatus_2, int claimDate_3, String courtCode_4, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("otherFirst " + dbName + " : " + "submitKey_0 : " + submitKey_0 + " custId_1 : " + custId_1 + " caseStatus_2 : " + caseStatus_2 + " claimDate_3 : " + claimDate_3 + " courtCode_4 : "
				+ courtCode_4);
		Optional<JcicZ055> jcicZ055T = null;
		if (dbName.equals(ContentName.onDay))
			...
			jcicZ055T = jcicZ055ReposHist.findTopBySubmitKeyIsAndCustIdIsAndCaseStatusIsAndClaimDateIsAndCourtCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, caseStatus_2, claimDate_3,
					courtCode_4);
		else
	...
	public JcicZ055 insert(JcicZ055 jcicZ055, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(jcicZ055.getJcicZ055Id(), titaVo) != null)
