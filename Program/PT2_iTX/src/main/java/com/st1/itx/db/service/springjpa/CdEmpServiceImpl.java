...
em = null;
  ...
  @Override
  public CdEmp findAgentCodeFirst(String agentCode_0, TitaVo... titaVo) {
    String dbName = "";
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("findAgentCodeFirst " + dbName + " : " + "agentCode_0 : " + agentCode_0);
    Optional<CdEmp> cdEmpT = null;
    if (dbName.equals(ContentName.onDay))
      cdEmpT = cdEmpReposDay.findTopByAgentCodeIsOrderByInputDateDesc(agentCode_0);
    else if (dbName.equals(ContentName.onMon))
      cdEmpT = cdEmpReposMon.findTopByAgentCodeIsOrderByInputDateDesc(agentCode_0);
    else if (dbName.equals(ContentName.onHist))
      cdEmpT = cdEmpReposHist.findTopByAgentCodeIsOrderByInputDateDesc(agentCode_0);
    else 
      cdEmpT = cdEmpRepos.findTopByAgentCodeIsOrderByInputDateDesc(agentCode_0);
