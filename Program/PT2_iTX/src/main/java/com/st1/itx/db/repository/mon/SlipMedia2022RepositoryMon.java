...
public interface SlipMedia2022RepositoryMon extends JpaRepository<SlipMedia2022, SlipMedia2022Id> {
	...
	public Slice<SlipMedia2022> findAllByAcDateIsAndBatchNoIsAndMediaSeqIsAndLatestFlagIsOrderByMediaSlipNoAscSeqAsc(int acDate_0, int batchNo_1, int mediaSeq_2, String latestFlag_3,
			Pageable pageable);
