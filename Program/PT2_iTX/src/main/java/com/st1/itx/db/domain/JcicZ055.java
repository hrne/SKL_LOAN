...
public class JcicZ055 implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5697347861406578597L;
	...
	public String toString() {
		return "JcicZ055 [jcicZ055Id=" + jcicZ055Id + ", tranKey=" + tranKey + ", year=" + year + ", courtDiv=" + courtDiv + ", courtCaseNo=" + courtCaseNo + ", payDate=" + payDate + ", payEndDate="
				+ payEndDate + ", period=" + period + ", rate=" + rate + ", outstandAmt=" + outstandAmt + ", subAmt=" + subAmt + ", claimStatus1=" + claimStatus1 + ", saveDate=" + saveDate
				+ ", claimStatus2=" + claimStatus2 + ", saveEndDate=" + saveEndDate + ", isImplement=" + isImplement + ", inspectName=" + inspectName + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey="
				+ ukey + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + ", actualFilingDate="
				+ actualFilingDate + ", actualFilingMark=" + actualFilingMark + "]";
	}
}
