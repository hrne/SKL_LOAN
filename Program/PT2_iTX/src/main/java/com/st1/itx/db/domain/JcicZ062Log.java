...
public class JcicZ062Log implements Serializable {
	...
	public String toString() {
		return "JcicZ062Log [jcicZ062LogId=" + jcicZ062LogId + ", tranKey=" + tranKey + ", completePeriod=" + completePeriod + ", period=" + period + ", rate=" + rate + ", expBalanceAmt="
				+ expBalanceAmt + ", cashBalanceAmt=" + cashBalanceAmt + ", creditBalanceAmt=" + creditBalanceAmt + ", chaRepayAmt=" + chaRepayAmt + ", chaRepayAgreeDate=" + chaRepayAgreeDate
				+ ", chaRepayViewDate=" + chaRepayViewDate + ", chaRepayEndDate=" + chaRepayEndDate + ", chaRepayFirstDate=" + chaRepayFirstDate + ", payAccount=" + payAccount + ", postAddr="
				+ postAddr + ", monthPayAmt=" + monthPayAmt + ", gradeType=" + gradeType + ", period2=" + period2 + ", rate2=" + rate2 + ", monthPayAmt2=" + monthPayAmt2 + ", outJcicTxtDate="
