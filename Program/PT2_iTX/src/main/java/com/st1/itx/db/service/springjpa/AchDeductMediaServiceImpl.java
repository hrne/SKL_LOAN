...
@Repository
public class AchDeductMediaServiceImpl extends ASpringJpaParm implements AchDeductMediaService, InitializingBean {
	@Autowired
	...
	public AchDeductMedia findById(AchDeductMediaId achDeductMediaId, TitaVo... titaVo) {
		...
		this.info("findById " + dbName + " " + achDeductMediaId);
	...
	public AchDeductMedia reseiveCheckFirst(int custNo_0, int facmNo_1, String achRepayCode_2, int prevIntDate_3, BigDecimal repayAmt_4, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("reseiveCheckFirst " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " + facmNo_1 + " achRepayCode_2 : " + achRepayCode_2 + " prevIntDate_3 : " + prevIntDate_3
				+ " repayAmt_4 : " + repayAmt_4);
		Optional<AchDeductMedia> achDeductMediaT = null;
		if (dbName.equals(ContentName.onDay))
			achDeductMediaT = achDeductMediaReposDay.findTopByCustNoIsAndFacmNoIsAndAchRepayCodeIsAndPrevIntDateIsAndRepayAmtIsOrderByMediaDateDesc(custNo_0, facmNo_1, achRepayCode_2, prevIntDate_3,
					repayAmt_4);
		else if (dbName.equals(ContentName.onMon))
			achDeductMediaT = achDeductMediaReposMon.findTopByCustNoIsAndFacmNoIsAndAchRepayCodeIsAndPrevIntDateIsAndRepayAmtIsOrderByMediaDateDesc(custNo_0, facmNo_1, achRepayCode_2, prevIntDate_3,
					repayAmt_4);
		else if (dbName.equals(ContentName.onHist))
			achDeductMediaT = achDeductMediaReposHist.findTopByCustNoIsAndFacmNoIsAndAchRepayCodeIsAndPrevIntDateIsAndRepayAmtIsOrderByMediaDateDesc(custNo_0, facmNo_1, achRepayCode_2, prevIntDate_3,
					repayAmt_4);
		else
			achDeductMediaT = achDeductMediaRepos.findTopByCustNoIsAndFacmNoIsAndAchRepayCodeIsAndPrevIntDateIsAndRepayAmtIsOrderByMediaDateDesc(custNo_0, facmNo_1, achRepayCode_2, prevIntDate_3,
					repayAmt_4);
	...
	public Slice<AchDeductMedia> mediaDateEq(int mediaDate_0, String mediaKind_1, int index, int limit, TitaVo... titaVo) {
		...
		this.info("mediaDateEq " + dbName + " : " + "mediaDate_0 : " + mediaDate_0 + " mediaKind_1 : " + mediaKind_1);
		if (dbName.equals(ContentName.onDay))
	...
	public AchDeductMedia holdById(AchDeductMediaId achDeductMediaId, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Hold " + dbName + " " + achDeductMediaId);
		Optional<AchDeductMedia> achDeductMedia = null;
		if (dbName.equals(ContentName.onDay))
	...
	public AchDeductMedia holdById(AchDeductMedia achDeductMedia, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Hold " + dbName + " " + achDeductMedia.getAchDeductMediaId());
		Optional<AchDeductMedia> achDeductMediaT = null;
		if (dbName.equals(ContentName.onDay))
	...
	public AchDeductMedia insert(AchDeductMedia achDeductMedia, TitaVo... titaVo) throws DBException {
		...
		this.info("Insert..." + dbName + " " + achDeductMedia.getAchDeductMediaId());
	...
	public AchDeductMedia update(AchDeductMedia achDeductMedia, TitaVo... titaVo) throws DBException {
		...
		this.info("Update..." + dbName + " " + achDeductMedia.getAchDeductMediaId());
		if (!empNot.isEmpty())
			achDeductMedia.setLastUpdateEmpNo(empNot);
	...
	public void delete(AchDeductMedia achDeductMedia, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Delete..." + dbName + " " + achDeductMedia.getAchDeductMediaId());
		if (dbName.equals(ContentName.onDay)) {
