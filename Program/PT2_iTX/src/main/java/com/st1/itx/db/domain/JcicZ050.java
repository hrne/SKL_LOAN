...
public class JcicZ050 implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -9044807157763645689L;
	...
	/**
	 * 進入第二階梯還款年月<br>
	 * JcicZ050消費者債務清理條例 書上沒有此欄位 新光提供的資料有 故保留之
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "JcicZ050 [jcicZ050Id=" + jcicZ050Id + ", tranKey=" + tranKey + ", payAmt=" + payAmt + ", sumRepayActualAmt=" + sumRepayActualAmt + ", sumRepayShouldAmt=" + sumRepayShouldAmt
				+ ", status=" + status + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey + ", secondRepayYM=" + secondRepayYM + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
