...
public class TxFile implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4686659895224542454L;
...
// 檔案序號
	...
	// 檔案型態
	/* 1.PDF2.EXCEL3.TXT4.DBF5.CSV6.套印7.任意檔 */
	...
	/**
	 * 檔案型態<br>
	 * 1.PDF 2.EXCEL 3.TXT 4.DBF 5.CSV 6.套印 7.任意檔
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "TxFile [fileNo=" + fileNo + ", fileDate=" + fileDate + ", fileCode=" + fileCode + ", fileItem=" + fileItem + ", fileType=" + fileType + ", fileOutput=" + fileOutput + ", fileFormat="
				+ fileFormat + ", fileData=" + fileData + ", fileZip=" + fileZip + ", brNo=" + brNo + ", signCode=" + signCode + ", groupNo=" + groupNo + ", tlrNo=" + tlrNo + ", supNo=" + supNo
				+ ", batchNo=" + batchNo + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
