...
public class LoanSyndServiceImpl extends ASpringJpaParm implements LoanSyndService, InitializingBean {
	...
	public Slice<LoanSynd> syndNoRange(int syndNo_0, int syndNo_1, String leadingBank_2, int signingDate_3, int signingDate_4, int index, int limit, TitaVo... titaVo) {
		...
		this.info("syndNoRange " + dbName + " : " + "syndNo_0 : " + syndNo_0 + " syndNo_1 : " + syndNo_1 + " leadingBank_2 : " + leadingBank_2 + " signingDate_3 : " + signingDate_3
				+ " signingDate_4 : " + signingDate_4);
		if (dbName.equals(ContentName.onDay))
			slice = loanSyndReposDay.findAllBySyndNoGreaterThanEqualAndSyndNoLessThanEqualAndLeadingBankLikeAndSigningDateGreaterThanEqualAndSigningDateLessThanEqualOrderBySyndNoAsc(syndNo_0,
					syndNo_1, leadingBank_2, signingDate_3, signingDate_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = loanSyndReposMon.findAllBySyndNoGreaterThanEqualAndSyndNoLessThanEqualAndLeadingBankLikeAndSigningDateGreaterThanEqualAndSigningDateLessThanEqualOrderBySyndNoAsc(syndNo_0,
					syndNo_1, leadingBank_2, signingDate_3, signingDate_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = loanSyndReposHist.findAllBySyndNoGreaterThanEqualAndSyndNoLessThanEqualAndLeadingBankLikeAndSigningDateGreaterThanEqualAndSigningDateLessThanEqualOrderBySyndNoAsc(syndNo_0,
					syndNo_1, leadingBank_2, signingDate_3, signingDate_4, pageable);
		else
			slice = loanSyndRepos.findAllBySyndNoGreaterThanEqualAndSyndNoLessThanEqualAndLeadingBankLikeAndSigningDateGreaterThanEqualAndSigningDateLessThanEqualOrderBySyndNoAsc(syndNo_0, syndNo_1,
					leadingBank_2, signingDate_3, signingDate_4, pageable);
	...
	public LoanSynd insert(LoanSynd loanSynd, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(loanSynd.getSyndNo(), titaVo) != null)
