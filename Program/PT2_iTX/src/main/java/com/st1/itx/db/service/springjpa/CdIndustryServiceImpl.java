...
em = null;
  ...
  @Override
  public Slice<CdIndustry> findIndustryCodeItem(String industryCode_0, String industryItem_1, int index, int limit, TitaVo... titaVo) {
    String dbName = "";
    Slice<CdIndustry> slice = null;
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("findIndustryCodeItem " + dbName + " : " + "industryCode_0 : " + industryCode_0 + " industryItem_1 : " +  industryItem_1);
    if (dbName.equals(ContentName.onDay))
      slice = cdIndustryReposDay.findAllByIndustryCodeLikeOrIndustryItemLikeOrderByIndustryCodeAsc(industryCode_0, industryItem_1, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = cdIndustryReposMon.findAllByIndustryCodeLikeOrIndustryItemLikeOrderByIndustryCodeAsc(industryCode_0, industryItem_1, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = cdIndustryReposHist.findAllByIndustryCodeLikeOrIndustryItemLikeOrderByIndustryCodeAsc(industryCode_0, industryItem_1, pageable);
    else 
      slice = cdIndustryRepos.findAllByIndustryCodeLikeOrIndustryItemLikeOrderByIndustryCodeAsc(industryCode_0, industryItem_1, pageable);
