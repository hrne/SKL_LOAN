...
public class CdCode implements Serializable {
	...
	/**
	 * 代碼檔業務類別<br>
	 * 01:顧客管理作業 02:業務作業 03:帳務作業 04:批次作業 05:管理性作業 06:共同作業 07:介接外部系統 08:遵循法令作業
	 * 09:報表作業
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "CdCode [cdCodeId=" + cdCodeId + ", defType=" + defType + ", item=" + item + ", enable=" + enable + ", effectFlag=" + effectFlag + ", minCodeLength=" + minCodeLength
				+ ", maxCodeLength=" + maxCodeLength + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
