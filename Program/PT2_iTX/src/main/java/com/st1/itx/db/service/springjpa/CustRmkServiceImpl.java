...
em = null;
  ...
  public Slice<CustRmk> findCustNo(int custNo_0, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      slice = custRmkReposDay.findAllByCustNoIsOrderByCreateDateDescRmkNoAsc(custNo_0, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = custRmkReposMon.findAllByCustNoIsOrderByCreateDateDescRmkNoAsc(custNo_0, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = custRmkReposHist.findAllByCustNoIsOrderByCreateDateDescRmkNoAsc(custNo_0, pageable);
    else 
      slice = custRmkRepos.findAllByCustNoIsOrderByCreateDateDescRmkNoAsc(custNo_0, pageable);
  ...
  public CustRmk insert(CustRmk custRmk, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(custRmk.getCustRmkId(), titaVo) != null)
