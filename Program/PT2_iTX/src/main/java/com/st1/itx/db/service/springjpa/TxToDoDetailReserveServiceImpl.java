...
public class TxToDoDetailReserveServiceImpl extends ASpringJpaParm implements TxToDoDetailReserveService, InitializingBean {
	...
	public Slice<TxToDoDetailReserve> findTxNoEq(String itemCode_0, int titaEntdy_1, String titaKinbr_2, String titaTlrNo_3, int titaTxtNo_4, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = txToDoDetailReserveReposDay.findAllByItemCodeIsAndTitaEntdyIsAndTitaKinbrIsAndTitaTlrNoIsAndTitaTxtNoIsOrderByItemCodeAscCustNoAscBormNoAscDtlValueAsc(itemCode_0, titaEntdy_1,
					titaKinbr_2, titaTlrNo_3, titaTxtNo_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txToDoDetailReserveReposMon.findAllByItemCodeIsAndTitaEntdyIsAndTitaKinbrIsAndTitaTlrNoIsAndTitaTxtNoIsOrderByItemCodeAscCustNoAscBormNoAscDtlValueAsc(itemCode_0, titaEntdy_1,
					titaKinbr_2, titaTlrNo_3, titaTxtNo_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txToDoDetailReserveReposHist.findAllByItemCodeIsAndTitaEntdyIsAndTitaKinbrIsAndTitaTlrNoIsAndTitaTxtNoIsOrderByItemCodeAscCustNoAscBormNoAscDtlValueAsc(itemCode_0, titaEntdy_1,
					titaKinbr_2, titaTlrNo_3, titaTxtNo_4, pageable);
		else
			slice = txToDoDetailReserveRepos.findAllByItemCodeIsAndTitaEntdyIsAndTitaKinbrIsAndTitaTlrNoIsAndTitaTxtNoIsOrderByItemCodeAscCustNoAscBormNoAscDtlValueAsc(itemCode_0, titaEntdy_1,
					titaKinbr_2, titaTlrNo_3, titaTxtNo_4, pageable);
	...
	public TxToDoDetailReserve FindL2880First(String itemCode_0, int custNo_1, int facmNo_2, int bormNo_3, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			...
			txToDoDetailReserveT = txToDoDetailReserveReposMon.findTopByItemCodeIsAndCustNoIsAndFacmNoIsAndBormNoIsOrderByLogNoAsc(itemCode_0, custNo_1, facmNo_2, bormNo_3);
		else if (dbName.equals(ContentName.onHist))
			txToDoDetailReserveT = txToDoDetailReserveReposHist.findTopByItemCodeIsAndCustNoIsAndFacmNoIsAndBormNoIsOrderByLogNoAsc(itemCode_0, custNo_1, facmNo_2, bormNo_3);
		else
			txToDoDetailReserveT = txToDoDetailReserveRepos.findTopByItemCodeIsAndCustNoIsAndFacmNoIsAndBormNoIsOrderByLogNoAsc(itemCode_0, custNo_1, facmNo_2, bormNo_3);
	...
	public TxToDoDetailReserve insert(TxToDoDetailReserve txToDoDetailReserve, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(txToDoDetailReserve.getLogNo(), titaVo) != null)
