...
/**
	* 業績追回之部分還款金額條件<br>
	* L6501維護
追回繳納1期但未繳足3期期款即結清（含部分還款達60萬之案件)，未曾繳款者則同時追回房貸專員業績
預設值=600,000
	* @return BigDecimal
	*/
...
設為N時，整批入帳檢核訊息[未收當月火險費:xxx,xxx]
	* @return String
	*/
  public String getBatchFireFeeFg() {
    return this.batchFireFeeFg == null ? "" : this.batchFireFeeFg;
  }
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "SystemParas [businessType=" + businessType + ", graceDays=" + graceDays + ", achAuthOneTime=" + achAuthOneTime + ", achDeductFlag=" + achDeductFlag + ", achDeductDD1=" + achDeductDD1 + ", achDeductDD2=" + achDeductDD2
