...
public class FacMain implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -6537305156114304061L;
...
@EmbeddedId
  ...
  // 約定動工年月
  /* 2022.9.15異動欄位:規定管制代碼RuleCode=08:購地貸款(央行管制)使用 */
  @Column(name = "`PreStarBuildingYM`")
  private int preStarBuildingYM = 0;

  // 實際興建年月
  /* 2022.8.3新增欄位:規定管制代碼RuleCode=08:購地貸款(央行管制)使用 */
...
/**
	...
	* @return Integer
	*/
  public int getPreStarBuildingYM() {
    return this.preStarBuildingYM;
  }
...
/**
  ...
  * @param preStarBuildingYM 約定動工年月
	*/
  public void setPreStarBuildingYM(int preStarBuildingYM) {
