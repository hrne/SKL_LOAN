 ...
 * @version 1.0.0
 */
public interface MlaundryRecordRepositoryMon extends JpaRepository<MlaundryRecord, Long> {

	// RecordDate >= ,AND RecordDate <= ,AND ActualRepayDate >= ,AND ActualRepayDate
	// <=
	public Slice<MlaundryRecord> findAllByRecordDateGreaterThanEqualAndRecordDateLessThanEqualAndActualRepayDateGreaterThanEqualAndActualRepayDateLessThanEqualOrderByRecordDateAscActualRepayDateAsc(
			int recordDate_0, int recordDate_1, int actualRepayDate_2, int actualRepayDate_3, Pageable pageable);
	...
	public Slice<MlaundryRecord> findAllByActualRepayDateGreaterThanEqualAndActualRepayDateLessThanEqualOrderByRecordDateAscActualRepayDateAsc(int actualRepayDate_0, int actualRepayDate_1,
			Pageable pageable);

	// CustNo = ,AND FacmNo >= ,AND FacmNo <= ,AND BormNo >= ,AND BormNo <= ,AND
	// RepayDate >=
	public Slice<MlaundryRecord> findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndRepayDateGreaterThanEqualOrderByRepayDateAsc(
			int custNo_0, int facmNo_1, int facmNo_2, int bormNo_3, int bormNo_4, int repayDate_5, Pageable pageable);
	...
	public Optional<MlaundryRecord> findTopByCustNoIsAndActualRepayDateGreaterThanEqualAndActualRepayDateLessThanEqualOrderByActualRepayDateDescLogNoDesc(int custNo_0, int actualRepayDate_1,
			int actualRepayDate_2);
