...
public interface JcicZ446RepositoryHist extends JpaRepository<JcicZ446, JcicZ446Id> {
  ...
  public Slice<JcicZ446> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
