...
//	自訂表頭
	...
	private void printHeaderCustomerize() {
		...
		this.print(-8, this.getMidXAxis(), stEntryDate + "－" + edEntryDate, "C");
		this.print(-10, 3, "樣態 入帳日 　戶號　　戶名　　　　　累積金額　　　　總筆數　　經辦　　　合理性　　　　同意日期");
		this.print(-11, 3, "－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－");
	}
	...
	public boolean exec(TitaVo titaVo) throws LogicException {
		...
		try {
			listL8205 = l8205ServiceImpl.L8205Rpt1(titaVo);
		} catch (Exception e) {
	...
	public void makeReport(TitaVo titaVo) throws LogicException {
		...
		if (listL8205 != null && listL8205.size() > 0) {
			...
			for (Map<String, String> tL8205Vo : listL8205) {
				...
				// 同意日
				print(0, 81, tL8205Vo.get("F8") == "0" || tL8205Vo.get("F8") == null || tL8205Vo.get("F8").length() == 0
