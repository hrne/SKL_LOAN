...
public class JcicZ054ServiceImpl extends ASpringJpaParm implements JcicZ054Service, InitializingBean {
	...
	public Slice<JcicZ054> otherEq(String submitKey_0, String custId_1, int rcDate_2, String maxMainCode_3, int payOffDate_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("otherEq " + dbName + " : " + "submitKey_0 : " + submitKey_0 + " custId_1 : " + custId_1 + " rcDate_2 : " + rcDate_2 + " maxMainCode_3 : " + maxMainCode_3 + " payOffDate_4 : "
				+ payOffDate_4);
		if (dbName.equals(ContentName.onDay))
			slice = jcicZ054ReposDay.findAllBySubmitKeyIsAndCustIdIsAndRcDateIsAndMaxMainCodeIsAndPayOffDateIsOrderByCreateDateDesc(submitKey_0, custId_1, rcDate_2, maxMainCode_3, payOffDate_4,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = jcicZ054ReposMon.findAllBySubmitKeyIsAndCustIdIsAndRcDateIsAndMaxMainCodeIsAndPayOffDateIsOrderByCreateDateDesc(submitKey_0, custId_1, rcDate_2, maxMainCode_3, payOffDate_4,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = jcicZ054ReposHist.findAllBySubmitKeyIsAndCustIdIsAndRcDateIsAndMaxMainCodeIsAndPayOffDateIsOrderByCreateDateDesc(submitKey_0, custId_1, rcDate_2, maxMainCode_3, payOffDate_4,
					pageable);
		else
			slice = jcicZ054Repos.findAllBySubmitKeyIsAndCustIdIsAndRcDateIsAndMaxMainCodeIsAndPayOffDateIsOrderByCreateDateDesc(submitKey_0, custId_1, rcDate_2, maxMainCode_3, payOffDate_4,
					pageable);
	...
	public JcicZ054 otherFirst(String submitKey_0, String custId_1, int rcDate_2, String maxMainCode_3, int payOffDate_4, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("otherFirst " + dbName + " : " + "submitKey_0 : " + submitKey_0 + " custId_1 : " + custId_1 + " rcDate_2 : " + rcDate_2 + " maxMainCode_3 : " + maxMainCode_3 + " payOffDate_4 : "
				+ payOffDate_4);
		Optional<JcicZ054> jcicZ054T = null;
		if (dbName.equals(ContentName.onDay))
