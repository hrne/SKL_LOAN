...
@Table(name = "`LoanIfrsDp`")
public class LoanIfrsDp implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6165305403293353908L;

	@EmbeddedId
	private LoanIfrsDpId loanIfrsDpId;
	...
	public LoanIfrsDpId getLoanIfrsDpId() {
		return this.loanIfrsDpId;
	}

	public void setLoanIfrsDpId(LoanIfrsDpId loanIfrsDpId) {
		this.loanIfrsDpId = loanIfrsDpId;
	}
	...
	/**
	 * 資料類別<br>
	 * 媒體檔排序用 1=法拍完成資料檔 2=逾期天數&amp;gt;=90天且未在法拍完成資料檔中
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 案件狀態<br>
	 * 1=正常 2=催收 3=呆帳(新壽有部份轉呆的狀態，但若屬本項情形，狀態轉列為"呆帳")
	 * 
	 * @return Integer
	 */
	...
	/**
	 * stage3發生日期<br>
	 * YYYYMMDD 例：20100108 一般 :繳息迄日+120 協議件:60~62, MIN(撥款日期, 繳息迄日+120)
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 上述發生日期時之本金餘額(台幣)<br>
	 * 轉催本金+轉催利息-還款金額-轉銷呆帳金額 正常戶本金-還款金額-轉銷呆帳金額 stage3發生日期 當月底餘額
	 * 
	 * @return BigDecimal
	 */
	 ...
	 * 以月底資料判斷，計算方式同本金回收金額 實收利息(不含延遲息,違約金)
	 * 
	 * @return BigDecimal
	 */
	...
	public String toString() {
		return "LoanIfrsDp [loanIfrsDpId=" + loanIfrsDpId + ", custId=" + custId + ", dataFg=" + dataFg + ", acCode=" + acCode + ", status=" + status + ", firstDrawdownDate=" + firstDrawdownDate
				+ ", drawdownDate=" + drawdownDate + ", maturityDate=" + maturityDate + ", lineAmt=" + lineAmt + ", drawdownAmt=" + drawdownAmt + ", loanBal=" + loanBal + ", intAmt=" + intAmt
				+ ", fee=" + fee + ", ovduDays=" + ovduDays + ", ovduDate=" + ovduDate + ", badDebtDate=" + badDebtDate + ", badDebtAmt=" + badDebtAmt + ", derDate=" + derDate + ", derRate=" + derRate
				+ ", derLoanBal=" + derLoanBal + ", derIntAmt=" + derIntAmt + ", derFee=" + derFee + ", derY1Amt=" + derY1Amt + ", derY2Amt=" + derY2Amt + ", derY3Amt=" + derY3Amt + ", derY4Amt="
				+ derY4Amt + ", derY5Amt=" + derY5Amt + ", derY1Int=" + derY1Int + ", derY2Int=" + derY2Int + ", derY3Int=" + derY3Int + ", derY4Int=" + derY4Int + ", derY5Int=" + derY5Int
				+ ", derY1Fee=" + derY1Fee + ", derY2Fee=" + derY2Fee + ", derY3Fee=" + derY3Fee + ", derY4Fee=" + derY4Fee + ", derY5Fee=" + derY5Fee + ", industryCode=" + industryCode
				+ ", clTypeJCIC=" + clTypeJCIC + ", areaCode=" + areaCode + ", prodCode=" + prodCode + ", custKind=" + custKind + ", ifrsProdCode=" + ifrsProdCode + ", createDate=" + createDate
