...
@Component("L2304Vo")
@Scope("prototype")
public class L2304Vo extends FileVo {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2984423537105409608L;
	// 設定首筆筆數
...
//關係人統編
				...
				// 設定明細欄位的擷取位置
				occursList.putParam("RelsId", thisLine);
...
//			relsType		關係人戶別	X	9	
			...
			String thisLine = occursList.get("relsUKey") + "," + occursList.get("relsId") + "," + occursList.get("relsName") + "," + occursList.get("relsCode") + "," + occursList.get("relsType");
