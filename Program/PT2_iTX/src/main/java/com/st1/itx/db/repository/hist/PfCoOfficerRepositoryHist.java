 ...
 * @version 1.0.0
 */
public interface PfCoOfficerRepositoryHist extends JpaRepository<PfCoOfficer, PfCoOfficerId> {
	...
	// EmpNo = ,AND EffectiveDate >= ,AND EffectiveDate <=
	public Slice<PfCoOfficer> findAllByEmpNoIsAndEffectiveDateGreaterThanEqualAndEffectiveDateLessThanEqualOrderByEffectiveDateDesc(String empNo_0, int effectiveDate_1, int effectiveDate_2,
			Pageable pageable);
