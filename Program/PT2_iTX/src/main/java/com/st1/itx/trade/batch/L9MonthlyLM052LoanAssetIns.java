...
@Service("L9MonthlyLM052LoanAssetIns")
@Scope("step")
/**
 * (月底日日終批次)維護MonthlyLM052LoanAsset
 * 
 * @author Chih Wei
 * @version 1.0.0
 */
public class L9MonthlyLM052LoanAssetIns extends BatchBase implements Tasklet, InitializingBean {
