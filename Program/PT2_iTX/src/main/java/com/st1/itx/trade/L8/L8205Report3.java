...
//		print(-66, this.getMidXAxis(), "　經辦:　　　　　　　　　　　　　　經理:　　　　　　　　　　　　　　協理:　　　　　　　　　　　　　　", "C");
	...
	public boolean exec(TitaVo titaVo) throws LogicException {
		...
		try {
			listL8205 = l8205ServiceImpl.L8205Rpt3(titaVo);
		} catch (Exception e) {
	...
	public void makeReport(TitaVo titaVo) throws LogicException {
		...
		if (listL8205 != null && listL8205.size() > 0) {
			...
			for (Map<String, String> tL8205Vo : listL8205) {
				...
				// 同意日
				print(0, 77,
						tL8205Vo.get("F11") == "0" || tL8205Vo.get("F11") == null || tL8205Vo.get("F11").length() == 0
								|| tL8205Vo.get("F11").equals(" ") ? " " : showDate(tL8205Vo.get("F11"), 1));

				// 異動日
				print(0, 87, tL8205Vo.get("F8") == "0" || tL8205Vo.get("F8") == null || tL8205Vo.get("F8").length() == 0
						|| tL8205Vo.get("F8").equals(" ") ? " " : showDate(tL8205Vo.get("F8"), 1));
			...
			for (Map<String, String> tL8205Vo : listL8205) {
				...
				makeExcel
						.setValue(rowCursor, 9,
								tL8205Vo.get("F11") == "0" || tL8205Vo.get("F11") == null
										|| tL8205Vo.get("F11").length() == 0 || tL8205Vo.get("F11").equals(" ") ? " "
												: showDate(tL8205Vo.get("F11"), 1));

				makeExcel
						.setValue(rowCursor, 10,
								tL8205Vo.get("F8") == "0" || tL8205Vo.get("F8") == null
										|| tL8205Vo.get("F8").length() == 0 || tL8205Vo.get("F8").equals(" ") ? " "
												: showDate(tL8205Vo.get("F8"), 1));
