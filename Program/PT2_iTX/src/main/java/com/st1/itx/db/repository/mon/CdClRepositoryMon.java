 ...
 * @version 1.0.0
 */
public interface CdClRepositoryMon extends JpaRepository<CdCl, CdClId> {
	...
	public Slice<CdCl> findAllByClCode1GreaterThanEqualAndClCode1LessThanEqualAndClCode2GreaterThanEqualAndClCode2LessThanEqualOrderByClCode1AscClCode2Asc(int clCode1_0, int clCode1_1, int clCode2_2,
			int clCode2_3, Pageable pageable);
