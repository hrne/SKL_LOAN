...
import com.st1.itx.db.service.springjpa.cm.L9737ServiceImpl;
...
@Component
@Scope("prototype")
public class L9737Report extends MakeReport {

	@Autowired
	L9737ServiceImpl l9737ServiceImpl;
	...
	public boolean exec(TitaVo titaVo) throws LogicException {
		...
		String defaultExcel = "L9737_底稿_催收戶餘額明細.xlsx";
		...
		if (resultList == null || resultList.isEmpty()) {
			...
			for (Map<String, String> result : resultList) {
				...
				BigDecimal ltv = "0".equals(result.get("EvaNetWorth")) ||  "0".equals(result.get("LineAmt")) ? BigDecimal.ZERO
