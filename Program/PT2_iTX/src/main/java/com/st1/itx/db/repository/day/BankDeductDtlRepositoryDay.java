 ...
 * @version 1.0.0
 */
public interface BankDeductDtlRepositoryDay extends JpaRepository<BankDeductDtl, BankDeductDtlId> {
	...
	public Slice<BankDeductDtl> findAllByRepayBankIsAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualOrderByCustNoAscFacmNoAscPayIntDateAscRepayTypeDesc(String repayBank_0, int entryDate_1,
			int entryDate_2, Pageable pageable);
	...
	public Slice<BankDeductDtl> findAllByEntryDateIsAndCustNoIsAndFacmNoIsAndRepayTypeIsAndPayIntDateIs(int entryDate_0, int custNo_1, int facmNo_2, int repayType_3, int payIntDate_4,
			Pageable pageable);

	// EntryDate >= ,AND EntryDate <= ,AND RepayBank = ,AND RepayType =
	public Slice<BankDeductDtl> findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndRepayBankIsAndRepayTypeIs(int entryDate_0, int entryDate_1, String repayBank_2, int repayType_3,
			Pageable pageable);
	...
	// RepayBank <> , AND EntryDate >= ,AND EntryDate <=
	public Slice<BankDeductDtl> findAllByRepayBankNotAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualOrderByCustNoAscFacmNoAscPayIntDateAscRepayTypeDesc(String repayBank_0, int entryDate_1,
			int entryDate_2, Pageable pageable);
