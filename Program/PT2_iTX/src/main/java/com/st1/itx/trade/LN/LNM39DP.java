 ...
 * @version 1.0.0
 */
public class LNM39DP extends BatchBase implements Tasklet, InitializingBean {
	...
	public void run() throws LogicException {
		...
		lnm39dpReport.setTxBuffer(this.txBuffer);
...
//		this.info("active LNM39DP ");
//		this.totaVo.init(titaVo);
//
//		lnm39dpReport.exec(titaVo);
//
