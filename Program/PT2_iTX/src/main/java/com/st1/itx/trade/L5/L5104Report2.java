 ...
 * @version 1.0.0
 */
public class L5104Report2 extends MakeReport {
	...
	private String brno = "";
	private String reportCode = "L5104B";
	private String reportItem = "法拍件月報表";
	...
	public void printHeader() {
		...
		this.print(-5, 1, "戶號　　　　         戶名　　　　　　　　　　　　         　　    　　　借閱人　　　　　　　　　　   　管理人　　　　　    　　借閱日期");
		this.print(-6, 1,
				"---------------------------------------------------------------------------------------------------------------------------------------------------------------------");
		// 明細起始列(自訂亦必須)
		this.setBeginRow(7);
	...
	public void exec(int startDate, int endDate, TitaVo titaVo) throws LogicException {
		...
		if (resultList == null || resultList.isEmpty()) {
			...
			//	print(1, 7, result.get("F0") + '-' + ixFacmNo);
