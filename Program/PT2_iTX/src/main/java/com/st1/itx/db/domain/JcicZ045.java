...
@Table(name = "`JcicZ045`")
public class JcicZ045 implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6437506420428130761L;

	@EmbeddedId
	private JcicZ045Id jcicZ045Id;
	...
	public JcicZ045Id getJcicZ045Id() {
		return this.jcicZ045Id;
	}

	public void setJcicZ045Id(JcicZ045Id jcicZ045Id) {
		this.jcicZ045Id = jcicZ045Id;
	}
	...
	public String toString() {
		return "JcicZ045 [jcicZ045Id=" + jcicZ045Id + ", tranKey=" + tranKey + ", agreeCode=" + agreeCode + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey + ", createDate=" + createDate
