...
@Component
@Scope("prototype")
public class L4961ReportC extends MakeReport {
	...
	private String brno = "";
	private String reportCode = "L4961-C";
	private String reportItem = "應收未收火險保費明細表";
...
//		this.print(-5, this.getMidXAxis(), showRocDate(this.reportDate), "C");
		this.print(-3, this.getMidXAxis(), this.reportItem, "C");
		...
		this.print(-7, 1, "┌————┬————┬———————————————┬——————┬————————┬————————┬————————┬————————┬————————┐");
		this.print(-8, 1, "｜　戶號　｜　額度　｜　被保人　　　　　　　　　　　｜　續單年月　｜　　 總保費 　　｜　　火險保額　　｜　　火險保費　　｜　 地震險保額 　｜　 地震險保費 　｜");
...
//				print(1, 1, "｜　　　　　　　　　　　　　｜　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　｜　　　　　　　　｜　　　　　　　　　　　　　｜");
				...
				print(0, 61, "" + insuYearMonth, "C"); // 到期年月
