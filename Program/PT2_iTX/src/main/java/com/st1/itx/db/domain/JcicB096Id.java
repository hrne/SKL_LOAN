...
// 資料日期
	...
	public boolean equals(Object obj) {
		...
		return dataYM == jcicB096Id.dataYM && clActNo.equals(jcicB096Id.clActNo) && landSeq == jcicB096Id.landSeq && ownerId.equals(jcicB096Id.ownerId) && cityJCICCode.equals(jcicB096Id.cityJCICCode)
				&& areaJCICCode == jcicB096Id.areaJCICCode && irCode.equals(jcicB096Id.irCode) && landNo1 == jcicB096Id.landNo1 && landNo2 == jcicB096Id.landNo2;
	}

	@Override
	public String toString() {
		return "JcicB096Id [dataYM=" + dataYM + ", clActNo=" + clActNo + ", landSeq=" + landSeq + ", ownerId=" + ownerId + ", cityJCICCode=" + cityJCICCode + ", areaJCICCode=" + areaJCICCode
				+ ", irCode=" + irCode + ", landNo1=" + landNo1 + ", landNo2=" + landNo2 + "]";
	}
}
