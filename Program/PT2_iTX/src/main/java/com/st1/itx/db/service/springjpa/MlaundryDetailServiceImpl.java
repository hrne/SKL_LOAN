...
em = null;
  ...
  public MlaundryDetail findEntryDateRangeFactorCustNoFirst(int entryDate_0, int entryDate_1, int factor_2, int custNo_3, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      ...
      mlaundryDetailT = mlaundryDetailReposHist.findTopByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsAndCustNoIsOrderByEntryDateAsc(entryDate_0, entryDate_1, factor_2, custNo_3);
    else 
  ...
  @Override
  public Slice<MlaundryDetail> findEntryDateRangeFactor(int entryDate_0, int entryDate_1, int factor_2, List<String> rational_3, int index, int limit, TitaVo... titaVo) {
    String dbName = "";
    Slice<MlaundryDetail> slice = null;
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("findEntryDateRangeFactor " + dbName + " : " + "entryDate_0 : " + entryDate_0 + " entryDate_1 : " +  entryDate_1 + " factor_2 : " +  factor_2 + " rational_3 : " +  rational_3);
    if (dbName.equals(ContentName.onDay))
      slice = mlaundryDetailReposDay.findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsAndRationalInOrderByEntryDateAscCustNoAsc(entryDate_0, entryDate_1, factor_2, rational_3, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = mlaundryDetailReposMon.findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsAndRationalInOrderByEntryDateAscCustNoAsc(entryDate_0, entryDate_1, factor_2, rational_3, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = mlaundryDetailReposHist.findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsAndRationalInOrderByEntryDateAscCustNoAsc(entryDate_0, entryDate_1, factor_2, rational_3, pageable);
    else 
      slice = mlaundryDetailRepos.findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsAndRationalInOrderByEntryDateAscCustNoAsc(entryDate_0, entryDate_1, factor_2, rational_3, pageable);
  ...
  @Override
  public Slice<MlaundryDetail> findFactor(int entryDate_0, int entryDate_1, int factor_2, int index, int limit, TitaVo... titaVo) {
    String dbName = "";
    Slice<MlaundryDetail> slice = null;
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    ...
    if (dbName.equals(ContentName.onDay))
      slice = mlaundryDetailReposDay.findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsOrderByEntryDateAscCustNoAsc(entryDate_0, entryDate_1, factor_2, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = mlaundryDetailReposMon.findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsOrderByEntryDateAscCustNoAsc(entryDate_0, entryDate_1, factor_2, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = mlaundryDetailReposHist.findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsOrderByEntryDateAscCustNoAsc(entryDate_0, entryDate_1, factor_2, pageable);
    else 
      slice = mlaundryDetailRepos.findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsOrderByEntryDateAscCustNoAsc(entryDate_0, entryDate_1, factor_2, pageable);
