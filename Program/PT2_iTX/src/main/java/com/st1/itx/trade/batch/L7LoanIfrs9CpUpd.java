...
@Service("L7LoanIfrs9CpUpd")
@Scope("step")
/**
 * (每月日終批次)維護 LoanIfrs9Cp 每月IFRS9欄位清單C檔
 *
 * @author Chih Wei
 * @version 1.0.0
 */
public class L7LoanIfrs9CpUpd extends BatchBase implements Tasklet, InitializingBean {
	...
	public void run() throws LogicException {
		this.info("active L7LoanIfrs9CpUpd ");
		...
		this.info("active L7LoanIfrs9CpUpd tbsdyf=" + tbsdyf);
		this.info("active L7LoanIfrs9CpUpd empNo =" + empNo);
...
//		this.titaVo.putParam(ContentName.dataBase, ContentName.onLine);
		...
		sJobMainService.Usp_L7_LoanIfrs9Cp_Upd(tbsdyf, empNo, txSeq, titaVo);
	}
