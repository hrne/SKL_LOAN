...
public class JcicZ056ServiceImpl extends ASpringJpaParm implements JcicZ056Service, InitializingBean {
	...
	public Slice<JcicZ056> otherEq(String submitKey_0, String custId_1, String caseStatus_2, int claimDate_3, String courtCode_4, int index, int limit, TitaVo... titaVo) {
		...
		this.info("otherEq " + dbName + " : " + "submitKey_0 : " + submitKey_0 + " custId_1 : " + custId_1 + " caseStatus_2 : " + caseStatus_2 + " claimDate_3 : " + claimDate_3 + " courtCode_4 : "
				+ courtCode_4);
		if (dbName.equals(ContentName.onDay))
			slice = jcicZ056ReposDay.findAllBySubmitKeyIsAndCustIdIsAndCaseStatusIsAndClaimDateIsAndCourtCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, caseStatus_2, claimDate_3, courtCode_4,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = jcicZ056ReposMon.findAllBySubmitKeyIsAndCustIdIsAndCaseStatusIsAndClaimDateIsAndCourtCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, caseStatus_2, claimDate_3, courtCode_4,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = jcicZ056ReposHist.findAllBySubmitKeyIsAndCustIdIsAndCaseStatusIsAndClaimDateIsAndCourtCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, caseStatus_2, claimDate_3, courtCode_4,
					pageable);
		else
			slice = jcicZ056Repos.findAllBySubmitKeyIsAndCustIdIsAndCaseStatusIsAndClaimDateIsAndCourtCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, caseStatus_2, claimDate_3, courtCode_4,
					pageable);
	...
	public JcicZ056 otherFirst(String submitKey_0, String custId_1, String caseStatus_2, int claimDate_3, String courtCode_4, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			...
			jcicZ056T = jcicZ056ReposHist.findTopBySubmitKeyIsAndCustIdIsAndCaseStatusIsAndClaimDateIsAndCourtCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, caseStatus_2, claimDate_3,
					courtCode_4);
		else
	...
	public JcicZ056 insert(JcicZ056 jcicZ056, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(jcicZ056.getJcicZ056Id(), titaVo) != null)
