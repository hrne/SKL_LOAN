 ...
 * @version 1.0.0
 */
public interface CdAreaRepositoryHist extends JpaRepository<CdArea, CdAreaId> {
	...
	public Slice<CdArea> findAllByCityCodeGreaterThanEqualAndCityCodeLessThanEqualAndAreaCodeGreaterThanEqualAndAreaCodeLessThanEqualOrderByCityCodeAscAreaCodeAsc(String cityCode_0, String cityCode_1,
			String areaCode_2, String areaCode_3, Pageable pageable);
