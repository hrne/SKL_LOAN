...
public class MonthlyBookValue implements Serializable {
	...
	public String toString() {
		return "MonthlyBookValue [monthlyBookValueId=" + monthlyBookValueId + ", loanBal=" + loanBal + ", bookValue=" + bookValue + ", amortizedAmt=" + amortizedAmt + ", unamortizedAmt="
				+ unamortizedAmt + ", amortizeCnts=" + amortizeCnts + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo="
				+ lastUpdateEmpNo + "]";
	}
}
