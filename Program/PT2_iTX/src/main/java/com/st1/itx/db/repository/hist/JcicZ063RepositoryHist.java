 ...
 * @version 1.0.0
 */
public interface JcicZ063RepositoryHist extends JpaRepository<JcicZ063, JcicZ063Id> {
  ...
  public Slice<JcicZ063> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
