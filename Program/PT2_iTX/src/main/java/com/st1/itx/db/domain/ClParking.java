...
public class ClParking implements Serializable {
	...
	public String toString() {
		return "ClParking [clParkingId=" + clParkingId + ", parkingNo=" + parkingNo + ", parkingQty=" + parkingQty + ", parkingTypeCode=" + parkingTypeCode + ", ownerPart=" + ownerPart
				+ ", ownerTotal=" + ownerTotal + ", cityCode=" + cityCode + ", areaCode=" + areaCode + ", irCode=" + irCode + ", bdNo1=" + bdNo1 + ", bdNo2=" + bdNo2 + ", landNo1=" + landNo1
				+ ", landNo2=" + landNo2 + ", parkingArea=" + parkingArea + ", amount=" + amount + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
