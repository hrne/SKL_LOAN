...
public class EmpDeductDtl implements Serializable {
  ...
  // 扣款代碼
  /* CdCode.PerfRepayCode1:扣薪件2:特約件3:滯繳件4:人事特約件5:房貸扣薪件8:帳管費9:火險費 */
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "EmpDeductDtl [empDeductDtlId=" + empDeductDtlId
           + ", empNo=" + empNo + ", custId=" + custId + ", txAmt=" + txAmt
           + ", errMsg=" + errMsg + ", acdate=" + acdate + ", titaTlrNo=" + titaTlrNo + ", titaTxtNo=" + titaTxtNo + ", batchNo=" + batchNo + ", repayAmt=" + repayAmt
           + ", resignCode=" + resignCode + ", deptCode=" + deptCode + ", unitCode=" + unitCode + ", intStartDate=" + intStartDate + ", intEndDate=" + intEndDate + ", positCode=" + positCode
           + ", principal=" + principal + ", interest=" + interest + ", sumOvpayAmt=" + sumOvpayAmt + ", jsonFields=" + jsonFields + ", currIntAmt=" + currIntAmt + ", currPrinAmt=" + currPrinAmt
           + ", mediaDate=" + mediaDate + ", mediaKind=" + mediaKind + ", mediaSeq=" + mediaSeq + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
