...
public class JcicMonthlyLoanData implements Serializable {
	...
	// 融資分類
	/*
	 * 法人特殊融資分為五類A:專案融資B:商品融資C:標的融資D:收益型商用不動產融資E:高風險商用不動產融資K:非屬前述特殊融資之其他一般法人金融貸款個人(
	 * 含非法人組織)金融貸款分類為L:購買住宅貸款(非自用) M:購買住宅貸款(自用) N:一般房屋抵押貸款(房屋修繕貸款) O:由信用卡衍生之小額信用貸款
	 * R:由現金卡衍生之小額信用貸款 S:創業貸款 T:所營事業營運周轉金貸款 U:建築用融資貸款 V:代墊投標保證金貸款 W:農業用途貸款
	 * X:參與都市更新更新計畫貸款 Y:企業員工認購股票(或可轉換公司債)貸款Z:其他個人金融貸款1:個人投資理財貸款
	 */
	...
	/**
	 * 負責人IDN/負責之事業體BAN<br>
	 * 企業負責人之身分證統一編號 個人授信戶負責之事業體(僅限非法人組織)營利事業統一編號
	 * 
	 * @return String
	 */
	 ...
	 * 
	 * 個人(含非法人組織)金融貸款分類為 L:購買住宅貸款(非自用) M:購買住宅貸款(自用) N:一般房屋抵押貸款(房屋修繕貸款)
	 * O:由信用卡衍生之小額信用貸款 R:由現金卡衍生之小額信用貸款 S:創業貸款 T:所營事業營運周轉金貸款 U:建築用融資貸款 V:代墊投標保證金貸款
	 * W:農業用途貸款 X:參與都市更新更新計畫貸款 Y:企業員工認購股票(或可轉換公司債)貸款 Z:其他個人金融貸款 1:個人投資理財貸款
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "JcicMonthlyLoanData [jcicMonthlyLoanDataId=" + jcicMonthlyLoanDataId + ", custId=" + custId + ", status=" + status + ", entCode=" + entCode + ", suvId=" + suvId + ", overseasId="
				+ overseasId + ", industryCode=" + industryCode + ", acctCode=" + acctCode + ", subAcctCode=" + subAcctCode + ", origAcctCode=" + origAcctCode + ", utilAmt=" + utilAmt + ", utilBal="
				+ utilBal + ", recycleCode=" + recycleCode + ", recycleDeadline=" + recycleDeadline + ", irrevocableFlag=" + irrevocableFlag + ", finCode=" + finCode + ", projCode=" + projCode
				+ ", nonCreditCode=" + nonCreditCode + ", usageCode=" + usageCode + ", approveRate=" + approveRate + ", storeRate=" + storeRate + ", drawdownDate=" + drawdownDate + ", maturityDate="
				+ maturityDate + ", amortizedCode=" + amortizedCode + ", currencyCode=" + currencyCode + ", drawdownAmt=" + drawdownAmt + ", loanBal=" + loanBal + ", prevAmt=" + prevAmt + ", intAmt="
				+ intAmt + ", prevAmtRcv=" + prevAmtRcv + ", intAmtRcv=" + intAmtRcv + ", feeAmtRcv=" + feeAmtRcv + ", prevPayIntDate=" + prevPayIntDate + ", prevRepaidDate=" + prevRepaidDate
				+ ", nextPayIntDate=" + nextPayIntDate + ", nextRepayDate=" + nextRepayDate + ", intDelayMon=" + intDelayMon + ", repayDelayMon=" + repayDelayMon + ", repaidEndMon=" + repaidEndMon
				+ ", clCode1=" + clCode1 + ", clCode2=" + clCode2 + ", clNo=" + clNo + ", clTypeCode=" + clTypeCode + ", clType=" + clType + ", evaAmt=" + evaAmt + ", dispDate=" + dispDate
				+ ", syndNo=" + syndNo + ", syndCode=" + syndCode + ", signingDate=" + signingDate + ", syndAmt=" + syndAmt + ", partAmt=" + partAmt + ", ovduDate=" + ovduDate + ", badDebtDate="
				+ badDebtDate + ", badDebtSkipFg=" + badDebtSkipFg + ", acBookCode=" + acBookCode + ", acSubBookCode=" + acSubBookCode + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
