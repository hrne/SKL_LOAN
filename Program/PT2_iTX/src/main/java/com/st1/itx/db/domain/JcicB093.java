...
public class JcicB093 implements Serializable {
	...
	public String toString() {
		return "JcicB093 [jcicB093Id=" + jcicB093Id + ", dataType=" + dataType + ", bankItem=" + bankItem + ", branchItem=" + branchItem + ", filler4=" + filler4 + ", clTypeJCIC=" + clTypeJCIC
				+ ", ownerId=" + ownerId + ", evaAmt=" + evaAmt + ", evaDate=" + evaDate + ", loanLimitAmt=" + loanLimitAmt + ", settingDate=" + settingDate + ", monthSettingAmt=" + monthSettingAmt
				+ ", settingSeq=" + settingSeq + ", settingAmt=" + settingAmt + ", preSettingAmt=" + preSettingAmt + ", dispPrice=" + dispPrice + ", issueEndDate=" + issueEndDate + ", insuFg="
				+ insuFg + ", filler19=" + filler19 + ", jcicDataYM=" + jcicDataYM + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo="
				+ lastUpdateEmpNo + "]";
	}
}
