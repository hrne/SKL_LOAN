...
public class FinReportQuality implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -7580801520327468743L;
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "FinReportQuality [finReportQualityId=" + finReportQualityId + ", reportType=" + reportType + ", opinion=" + opinion + ", isCheck=" + isCheck + ", isChange=" + isChange
           + ", officeType=" + officeType + ", punishRecord=" + punishRecord + ", changeReason=" + changeReason + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
