...
public class ClMainServiceImpl extends ASpringJpaParm implements ClMainService, InitializingBean {
	...
	public Slice<ClMain> findRange(int clCode1_0, int clCode1_1, String clTypeCode_2, String clTypeCode_3, int clNo_4, int clNo_5, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findRange " + dbName + " : " + "clCode1_0 : " + clCode1_0 + " clCode1_1 : " + clCode1_1 + " clTypeCode_2 : " + clTypeCode_2 + " clTypeCode_3 : " + clTypeCode_3 + " clNo_4 : "
				+ clNo_4 + " clNo_5 : " + clNo_5);
		if (dbName.equals(ContentName.onDay))
			slice = clMainReposDay.findAllByClCode1GreaterThanEqualAndClCode1LessThanEqualAndClTypeCodeGreaterThanEqualAndClTypeCodeLessThanEqualAndClNoGreaterThanEqualAndClNoLessThanEqual(clCode1_0,
					clCode1_1, clTypeCode_2, clTypeCode_3, clNo_4, clNo_5, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = clMainReposMon.findAllByClCode1GreaterThanEqualAndClCode1LessThanEqualAndClTypeCodeGreaterThanEqualAndClTypeCodeLessThanEqualAndClNoGreaterThanEqualAndClNoLessThanEqual(clCode1_0,
					clCode1_1, clTypeCode_2, clTypeCode_3, clNo_4, clNo_5, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = clMainReposHist.findAllByClCode1GreaterThanEqualAndClCode1LessThanEqualAndClTypeCodeGreaterThanEqualAndClTypeCodeLessThanEqualAndClNoGreaterThanEqualAndClNoLessThanEqual(clCode1_0,
					clCode1_1, clTypeCode_2, clTypeCode_3, clNo_4, clNo_5, pageable);
		else
			slice = clMainRepos.findAllByClCode1GreaterThanEqualAndClCode1LessThanEqualAndClTypeCodeGreaterThanEqualAndClTypeCodeLessThanEqualAndClNoGreaterThanEqualAndClNoLessThanEqual(clCode1_0,
					clCode1_1, clTypeCode_2, clTypeCode_3, clNo_4, clNo_5, pageable);
	...
	public Slice<ClMain> selectForL2038(int clCode1_0, int clCode1_1, String clTypeCode_2, String clTypeCode_3, int clNo_4, int clNo_5, String custUKey_6, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("selectForL2038 " + dbName + " : " + "clCode1_0 : " + clCode1_0 + " clCode1_1 : " + clCode1_1 + " clTypeCode_2 : " + clTypeCode_2 + " clTypeCode_3 : " + clTypeCode_3 + " clNo_4 : "
				+ clNo_4 + " clNo_5 : " + clNo_5 + " custUKey_6 : " + custUKey_6);
		if (dbName.equals(ContentName.onDay))
			slice = clMainReposDay
					.findAllByClCode1GreaterThanEqualAndClCode1LessThanEqualAndClTypeCodeGreaterThanEqualAndClTypeCodeLessThanEqualAndClNoGreaterThanEqualAndClNoLessThanEqualAndCustUKeyIs(clCode1_0,
							clCode1_1, clTypeCode_2, clTypeCode_3, clNo_4, clNo_5, custUKey_6, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = clMainReposMon
					.findAllByClCode1GreaterThanEqualAndClCode1LessThanEqualAndClTypeCodeGreaterThanEqualAndClTypeCodeLessThanEqualAndClNoGreaterThanEqualAndClNoLessThanEqualAndCustUKeyIs(clCode1_0,
							clCode1_1, clTypeCode_2, clTypeCode_3, clNo_4, clNo_5, custUKey_6, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = clMainReposHist
					.findAllByClCode1GreaterThanEqualAndClCode1LessThanEqualAndClTypeCodeGreaterThanEqualAndClTypeCodeLessThanEqualAndClNoGreaterThanEqualAndClNoLessThanEqualAndCustUKeyIs(clCode1_0,
							clCode1_1, clTypeCode_2, clTypeCode_3, clNo_4, clNo_5, custUKey_6, pageable);
		else
			slice = clMainRepos.findAllByClCode1GreaterThanEqualAndClCode1LessThanEqualAndClTypeCodeGreaterThanEqualAndClTypeCodeLessThanEqualAndClNoGreaterThanEqualAndClNoLessThanEqualAndCustUKeyIs(
					clCode1_0, clCode1_1, clTypeCode_2, clTypeCode_3, clNo_4, clNo_5, custUKey_6, pageable);
	...
	@Override
	public Slice<ClMain> selectForL2049(int clCode1_0, int clCode1_1, int clCode2_2, int clCode2_3, int clNo_4, int clNo_5, String clTypeCode_6, String clTypeCode_7, int index, int limit,
			TitaVo... titaVo) {
		String dbName = "";
		Slice<ClMain> slice = null;
		if (titaVo.length != 0)
		...
		this.info("selectForL2049 " + dbName + " : " + "clCode1_0 : " + clCode1_0 + " clCode1_1 : " + clCode1_1 + " clCode2_2 : " + clCode2_2 + " clCode2_3 : " + clCode2_3 + " clNo_4 : " + clNo_4
				+ " clNo_5 : " + clNo_5 + " clTypeCode_6 : " + clTypeCode_6 + " clTypeCode_7 : " + clTypeCode_7);
		if (dbName.equals(ContentName.onDay))
			slice = clMainReposDay
	...
	public ClMain insert(ClMain clMain, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(clMain.getClMainId()) != null)
