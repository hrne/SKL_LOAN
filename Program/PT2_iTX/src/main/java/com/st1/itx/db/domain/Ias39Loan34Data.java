...
public class Ias39Loan34Data implements Serializable {
	...
	// 戶況
	/*
	 * 0: 正常戶(含未核撥)1: 展期2: 催收戶3: 結案戶4: 逾期戶5: 催收結案戶6: 呆帳戶7: 部分轉呆戶8: 債權轉讓戶9:
	...
	// 可動用餘額
	/*
	 * 當【可循環動用】=1且【循環動用期限】&amp;gt;=月底日→【可動用餘額】=【核准額度】-【放款餘額】當【可循環動用】=0且【動支期限】&amp;gt
	 * ;=月底日→【可動用餘額】=【核准額度】-【已用額度】
	 */
	@Column(name = "`AvblBal`")
	...
	/**
	 * 業務科目代號<br>
	 * 未核撥: 額度核准科目 310: 短期擔保放款 320: 中期擔保放款 330: 長期擔保放款 340: 三十年房貸 990: 催收款項
	 * 
	 * @return String
	 */
	...
	/**
	 * 戶況<br>
	 * 0: 正常戶(含未核撥) 1: 展期 2: 催收戶 3: 結案戶 4: 逾期戶 5: 催收結案戶 6: 呆帳戶 7: 部分轉呆戶 8: 債權轉讓戶 9:
	...
	public String toString() {
		return "Ias39Loan34Data [ias39Loan34DataId=" + ias39Loan34DataId + ", custId=" + custId + ", drawdownFg=" + drawdownFg + ", acctCode=" + acctCode + ", status=" + status
				+ ", firstDrawdownDate=" + firstDrawdownDate + ", drawdownDate=" + drawdownDate + ", facLineDate=" + facLineDate + ", maturityDate=" + maturityDate + ", lineAmt=" + lineAmt
				+ ", drawdownAmt=" + drawdownAmt + ", acctFee=" + acctFee + ", loanBal=" + loanBal + ", intAmt=" + intAmt + ", fee=" + fee + ", rate=" + rate + ", ovduDays=" + ovduDays + ", ovduDate="
				+ ovduDate + ", badDebtDate=" + badDebtDate + ", badDebtAmt=" + badDebtAmt + ", derCode=" + derCode + ", gracePeriod=" + gracePeriod + ", approveRate=" + approveRate
				+ ", amortizedCode=" + amortizedCode + ", rateCode=" + rateCode + ", repayFreq=" + repayFreq + ", payIntFreq=" + payIntFreq + ", industryCode=" + industryCode + ", clTypeJCIC="
				+ clTypeJCIC + ", cityCode=" + cityCode + ", areaCode=" + areaCode + ", zip3=" + zip3 + ", baseRateCode=" + baseRateCode + ", custKind=" + custKind + ", assetKind=" + assetKind
				+ ", prodNo=" + prodNo + ", evaAmt=" + evaAmt + ", firstDueDate=" + firstDueDate + ", totalPeriod=" + totalPeriod + ", agreeBefFacmNo=" + agreeBefFacmNo + ", agreeBefBormNo="
				+ agreeBefBormNo + ", utilAmt=" + utilAmt + ", utilBal=" + utilBal + ", tempAmt=" + tempAmt + ", avblBal=" + avblBal + ", currencyCode=" + currencyCode + ", exchangeRate="
				+ exchangeRate + ", approveDate=" + approveDate + ", loanTerm=" + loanTerm + ", recycleDeadline=" + recycleDeadline + ", recycleCode=" + recycleCode + ", irrevocableFlag="
				+ irrevocableFlag + ", acBookCode=" + acBookCode + ", acNoCode=" + acNoCode + ", facAmortizedCode=" + facAmortizedCode + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
