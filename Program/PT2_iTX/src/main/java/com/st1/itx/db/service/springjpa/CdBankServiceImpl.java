...
em = null;
  ...
  public Slice<CdBank> bankCodeLike(String bankCode_0, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      slice = cdBankReposDay.findAllByBankCodeLikeOrderByBankCodeAscBranchCodeAsc(bankCode_0, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = cdBankReposMon.findAllByBankCodeLikeOrderByBankCodeAscBranchCodeAsc(bankCode_0, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = cdBankReposHist.findAllByBankCodeLikeOrderByBankCodeAscBranchCodeAsc(bankCode_0, pageable);
    else 
      slice = cdBankRepos.findAllByBankCodeLikeOrderByBankCodeAscBranchCodeAsc(bankCode_0, pageable);
  ...
  public CdBank insert(CdBank cdBank, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(cdBank.getCdBankId(), titaVo) != null)
