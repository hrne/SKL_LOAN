 ...
 * @version 1.0.0
 */
public interface PostAuthLogRepositoryHist extends JpaRepository<PostAuthLog, PostAuthLogId> {
	...
	// AuthCode = ,AND FacmNo =
	public Optional<PostAuthLog> findTopByAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsAndFacmNoIsOrderByRepayAcctSeqDesc(String authApplCode_0, int custNo_1,
	...
	public Optional<PostAuthLog> findTopByCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsOrderByAuthCreateDateDescCreateDateDesc(int custNo_0, String postDepCode_1, String repayAcct_2,
			String authCode_3);
	...
	public Slice<PostAuthLog> findAllByCustNoIsAndAuthApplCodeInAndAuthErrorCodeInOrderByRepayAcctDescAuthCreateDateDesc(int custNo_0, List<String> authApplCode_1, List<String> authErrorCode_2,
			Pageable pageable);
