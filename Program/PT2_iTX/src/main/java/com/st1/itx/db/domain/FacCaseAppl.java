...
public class FacCaseAppl implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -5107965191581928205L;
...
// 申請號碼
  ...
  // 計件代碼
  /* 共用代碼檔A:新貸件B:其他額度C:原額度D:新增額度E:展期1:新貸件2:其他額度3:原額度4:新增額度5:展期件6:六個月動支7:服務件8:特殊件9:固特利契轉 */
  ...
  // 核准層級
  /* CdCode.ApprovedLevel2023/6/1會議新增核准層級 */
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "FacCaseAppl [applNo=" + applNo + ", custUKey=" + custUKey + ", applDate=" + applDate + ", creditSysNo=" + creditSysNo + ", syndNo=" + syndNo + ", currencyCode=" + currencyCode
           ...
           + ", loanOfficer=" + loanOfficer + ", introducer=" + introducer + ", coorgnizer=" + coorgnizer + ", interviewerA=" + interviewerA + ", interviewerB=" + interviewerB + ", approvedLevel=" + approvedLevel
           + ", supervisor=" + supervisor + ", processCode=" + processCode + ", approveDate=" + approveDate + ", groupUKey=" + groupUKey + ", branchNo=" + branchNo + ", isLimit=" + isLimit
           + ", isRelated=" + isRelated + ", isLnrelNear=" + isLnrelNear + ", isSuspected=" + isSuspected + ", isSuspectedCheck=" + isSuspectedCheck + ", isSuspectedCheckType=" + isSuspectedCheckType + ", isDate=" + isDate
