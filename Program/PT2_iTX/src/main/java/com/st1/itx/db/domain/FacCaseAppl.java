...
// 申請號碼
	...
	public String toString() {
		return "FacCaseAppl [applNo=" + applNo + ", custUKey=" + custUKey + ", applDate=" + applDate + ", creditSysNo=" + creditSysNo + ", syndNo=" + syndNo + ", currencyCode=" + currencyCode
				...
				+ isRelated + ", isLnrelNear=" + isLnrelNear + ", isSuspected=" + isSuspected + ", isSuspectedCheck=" + isSuspectedCheck + ", isSuspectedCheckType=" + isSuspectedCheckType
				+ ", isDate=" + isDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
