...
// 年月份
	...
	public boolean equals(Object obj) {
		...
		return dataYM == loanIfrsJpId.dataYM && acDateYM == loanIfrsJpId.acDateYM && custNo == loanIfrsJpId.custNo && newFacmNo == loanIfrsJpId.newFacmNo && newBormNo == loanIfrsJpId.newBormNo
				&& oldFacmNo == loanIfrsJpId.oldFacmNo && oldBormNo == loanIfrsJpId.oldBormNo;
	}

	@Override
	public String toString() {
		return "LoanIfrsJpId [dataYM=" + dataYM + ", acDateYM=" + acDateYM + ", custNo=" + custNo + ", newFacmNo=" + newFacmNo + ", newBormNo=" + newBormNo + ", oldFacmNo=" + oldFacmNo
				+ ", oldBormNo=" + oldBormNo + "]";
	}
}
