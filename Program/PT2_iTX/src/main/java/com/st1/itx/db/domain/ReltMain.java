...
public class ReltMain implements Serializable {
	...
	// 關係
	/*
	 * 共用代碼檔(CustRelationType)01:本人02:配偶03:祖(外祖)父母04:父母05:兄弟姊妹06:子女07:孫(外孫)子女08:
	 * 有控制與從屬關係09:相互投資關係10:董事長11:董事12:監察人99:其他
	 */
	...
	/**
	 * 關係<br>
	 * 共用代碼檔(CustRelationType) 01:本人 02:配偶 03:祖(外祖)父母 04:父母 05:兄弟姊妹 06:子女 07:孫(外孫)子女
	 * 08:有控制與從屬關係 09:相互投資關係 10:董事長 11:董事 12:監察人 99:其他
	 * 
	 * @return String
	 */
	...
	/**
	 * 備註類型<br>
	 * 1:持股比例 2:被持股比例 3:持有股份 4:出資額 5:關係人 9:其它
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "ReltMain [reltMainId=" + reltMainId + ", reltCode=" + reltCode + ", remarkType=" + remarkType + ", reltmark=" + reltmark + ", finalFg=" + finalFg + ", applDate=" + applDate
