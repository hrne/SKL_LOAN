...
em = null;
  ...
  public Slice<TxFlow> findAll(int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by(Sort.Direction.ASC, "Entdy", "FlowNo"));
    else
  ...
  public Slice<TxFlow> findByLC003(int entdy_0, int entdy_1, String flowBrNo_2, int flowMode_3, String tranNo_4, List<String> flowGroupNo_5, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("findByLC003 " + dbName + " : " + "entdy_0 : " + entdy_0 + " entdy_1 : " +  entdy_1 + " flowBrNo_2 : " +  flowBrNo_2 + " flowMode_3 : " +  flowMode_3 + " tranNo_4 : " +  tranNo_4 + " flowGroupNo_5 : " +  flowGroupNo_5);
    if (dbName.equals(ContentName.onDay))
      slice = txFlowReposDay.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndFlowBrNoIsAndFlowModeIsAndTranNoLikeAndFlowGroupNoInOrderByFlowNoAsc(entdy_0, entdy_1, flowBrNo_2, flowMode_3, tranNo_4, flowGroupNo_5, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = txFlowReposMon.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndFlowBrNoIsAndFlowModeIsAndTranNoLikeAndFlowGroupNoInOrderByFlowNoAsc(entdy_0, entdy_1, flowBrNo_2, flowMode_3, tranNo_4, flowGroupNo_5, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = txFlowReposHist.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndFlowBrNoIsAndFlowModeIsAndTranNoLikeAndFlowGroupNoInOrderByFlowNoAsc(entdy_0, entdy_1, flowBrNo_2, flowMode_3, tranNo_4, flowGroupNo_5, pageable);
    else 
      slice = txFlowRepos.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndFlowBrNoIsAndFlowModeIsAndTranNoLikeAndFlowGroupNoInOrderByFlowNoAsc(entdy_0, entdy_1, flowBrNo_2, flowMode_3, tranNo_4, flowGroupNo_5, pageable);
  ...
  public TxFlow insert(TxFlow txFlow, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(txFlow.getTxFlowId(), titaVo) != null)
      throw new DBException(2);

    if (!empNot.isEmpty())
      txFlow.setCreateEmpNo(empNot);

    if(txFlow.getLastUpdateEmpNo() == null || txFlow.getLastUpdateEmpNo().isEmpty())
