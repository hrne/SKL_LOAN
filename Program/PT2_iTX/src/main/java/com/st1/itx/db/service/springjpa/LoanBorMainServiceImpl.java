...
public class LoanBorMainServiceImpl extends ASpringJpaParm implements LoanBorMainService, InitializingBean {
	...
	public Slice<LoanBorMain> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by(Sort.Direction.ASC, "CustNo", "FacmNo", "BormNo"));
		else
	...
	public Slice<LoanBorMain> bormCustNoEq(int custNo_0, int facmNo_1, int facmNo_2, int bormNo_3, int bormNo_4, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = loanBorMainReposDay.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualOrderByFacmNoAscBormNoAsc(custNo_0, facmNo_1,
					facmNo_2, bormNo_3, bormNo_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = loanBorMainReposMon.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualOrderByFacmNoAscBormNoAsc(custNo_0, facmNo_1,
					facmNo_2, bormNo_3, bormNo_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = loanBorMainReposHist.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualOrderByFacmNoAscBormNoAsc(custNo_0, facmNo_1,
					facmNo_2, bormNo_3, bormNo_4, pageable);
		else
			slice = loanBorMainRepos.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualOrderByFacmNoAscBormNoAsc(custNo_0, facmNo_1,
					facmNo_2, bormNo_3, bormNo_4, pageable);
	...
	public Slice<LoanBorMain> bormDrawdownDateRange(int drawdownDate_0, int drawdownDate_1, int bormNo_2, int bormNo_3, List<Integer> status_4, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			...
			slice = loanBorMainReposMon
					.findAllByDrawdownDateGreaterThanEqualAndDrawdownDateLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndStatusInOrderByDrawdownDateAscCustNoAscFacmNoAscBormNoAsc(
							drawdownDate_0, drawdownDate_1, bormNo_2, bormNo_3, status_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = loanBorMainReposHist
					.findAllByDrawdownDateGreaterThanEqualAndDrawdownDateLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndStatusInOrderByDrawdownDateAscCustNoAscFacmNoAscBormNoAsc(
							drawdownDate_0, drawdownDate_1, bormNo_2, bormNo_3, status_4, pageable);
		else
			slice = loanBorMainRepos
					.findAllByDrawdownDateGreaterThanEqualAndDrawdownDateLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndStatusInOrderByDrawdownDateAscCustNoAscFacmNoAscBormNoAsc(
							drawdownDate_0, drawdownDate_1, bormNo_2, bormNo_3, status_4, pageable);
	...
	public Slice<LoanBorMain> nextPayIntDateRange(int nextPayIntDate_0, int nextPayIntDate_1, int status_2, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = loanBorMainReposDay.findAllByNextPayIntDateGreaterThanEqualAndNextPayIntDateLessThanEqualAndStatusIsOrderByCustNoAscFacmNoAscBormNoAscNextPayIntDateAsc(nextPayIntDate_0,
					nextPayIntDate_1, status_2, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = loanBorMainReposMon.findAllByNextPayIntDateGreaterThanEqualAndNextPayIntDateLessThanEqualAndStatusIsOrderByCustNoAscFacmNoAscBormNoAscNextPayIntDateAsc(nextPayIntDate_0,
					nextPayIntDate_1, status_2, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = loanBorMainReposHist.findAllByNextPayIntDateGreaterThanEqualAndNextPayIntDateLessThanEqualAndStatusIsOrderByCustNoAscFacmNoAscBormNoAscNextPayIntDateAsc(nextPayIntDate_0,
					nextPayIntDate_1, status_2, pageable);
		else
			slice = loanBorMainRepos.findAllByNextPayIntDateGreaterThanEqualAndNextPayIntDateLessThanEqualAndStatusIsOrderByCustNoAscFacmNoAscBormNoAscNextPayIntDateAsc(nextPayIntDate_0,
					nextPayIntDate_1, status_2, pageable);
	...
	public Slice<LoanBorMain> findStatusRange(List<Integer> status_0, int drawdownDate_1, int drawdownDate_2, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = loanBorMainReposDay.findAllByStatusInAndDrawdownDateGreaterThanEqualAndDrawdownDateLessThanEqualOrderByCustNoAscFacmNoAscBormNoAsc(status_0, drawdownDate_1, drawdownDate_2,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = loanBorMainReposMon.findAllByStatusInAndDrawdownDateGreaterThanEqualAndDrawdownDateLessThanEqualOrderByCustNoAscFacmNoAscBormNoAsc(status_0, drawdownDate_1, drawdownDate_2,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = loanBorMainReposHist.findAllByStatusInAndDrawdownDateGreaterThanEqualAndDrawdownDateLessThanEqualOrderByCustNoAscFacmNoAscBormNoAsc(status_0, drawdownDate_1, drawdownDate_2,
					pageable);
		else
	...
	public LoanBorMain insert(LoanBorMain loanBorMain, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(loanBorMain.getLoanBorMainId(), titaVo) != null)
