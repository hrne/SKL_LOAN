...
public class CdInsurer implements Serializable {
	...
	/**
	 * 公司名稱<br>
	 * 目前最長19個中文字 美商美國環球產物保險有限公司台灣分公司
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "CdInsurer [cdInsurerId=" + cdInsurerId + ", insurerId=" + insurerId + ", insurerItem=" + insurerItem + ", insurerShort=" + insurerShort + ", telArea=" + telArea + ", telNo=" + telNo
