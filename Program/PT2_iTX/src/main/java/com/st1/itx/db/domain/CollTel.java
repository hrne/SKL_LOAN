...
public class CollTel implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3792705965258017475L;
	...
	public String toString() {
		return "CollTel [collTelId=" + collTelId + ", telDate=" + telDate + ", telTime=" + telTime + ", contactCode=" + contactCode + ", recvrCode=" + recvrCode + ", telArea=" + telArea + ", telNo="
				+ telNo + ", telExt=" + telExt + ", resultCode=" + resultCode + ", remark=" + remark + ", callDate=" + callDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
