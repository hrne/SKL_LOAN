...
public class BankRmtf implements Serializable {
	...
	public String toString() {
		return "BankRmtf [bankRmtfId=" + bankRmtfId + ", custNo=" + custNo + ", repayType=" + repayType + ", repayAmt=" + repayAmt + ", depAcctNo=" + depAcctNo + ", entryDate=" + entryDate
				+ ", dscptCode=" + dscptCode + ", virtualAcctNo=" + virtualAcctNo + ", withdrawAmt=" + withdrawAmt + ", depositAmt=" + depositAmt + ", balance=" + balance + ", remintBank="
				+ remintBank + ", traderInfo=" + traderInfo + ", amlRsp=" + amlRsp + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo="
				+ lastUpdateEmpNo + "]";
	}
}
