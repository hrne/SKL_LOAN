...
//			  全部筆數統計
				...
				if (j != fnAllList.size()) {
					...
					if (!fnAllList.get(i).get("BaTxNo").equals(fnAllList.get(j).get("BaTxNo")) || !fnAllList.get(i).get("RepayCode").equals(fnAllList.get(j).get("RepayCode"))
							|| !fnAllList.get(i).get("AcctCode").equals(fnAllList.get(j).get("AcctCode")) || !fnAllList.get(i).get("ProcCode").equals(fnAllList.get(j).get("ProcCode"))) {
