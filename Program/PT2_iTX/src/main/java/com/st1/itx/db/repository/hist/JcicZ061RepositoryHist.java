 ...
 * @version 1.0.0
 */
public interface JcicZ061RepositoryHist extends JpaRepository<JcicZ061, JcicZ061Id> {
	...
	// SubmitKey= , AND CustId= , AND RcDate= , AND ChangePayDate= , AND
	// MaxMainCode=
	public Slice<JcicZ061> findAllBySubmitKeyIsAndCustIdIsAndRcDateIsAndChangePayDateIsAndMaxMainCodeIsOrderByCreateDateDesc(String submitKey_0, String custId_1, int rcDate_2, int changePayDate_3,
	...
	// SubmitKey= , AND CustId= , AND RcDate= , AND ChangePayDate= , AND
	// MaxMainCode=
	public Optional<JcicZ061> findTopBySubmitKeyIsAndCustIdIsAndRcDateIsAndChangePayDateIsAndMaxMainCodeIsOrderByCreateDateDesc(String submitKey_0, String custId_1, int rcDate_2, int changePayDate_3,
