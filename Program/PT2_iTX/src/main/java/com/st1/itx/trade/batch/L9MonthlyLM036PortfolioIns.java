...
@Service("L9MonthlyLM036PortfolioIns")
@Scope("step")
/**
 * (月底日日終批次)維護MonthlyLM036月報工作檔
 * 
 * @author Chih Wei
 * @version 1.0.0
 */
public class L9MonthlyLM036PortfolioIns extends BatchBase implements Tasklet, InitializingBean {
	...
	public void run() throws LogicException {
		this.info("active L9MonthlyLM036PortfolioIns ");
...
//		this.titaVo.putParam(ContentName.dataBase, ContentName.onLine);
		...
		sJobMainService.Usp_L9_MonthlyLM036Portfolio_Ins(tbsdyf, empNo, txSeq, titaVo);
	}
}