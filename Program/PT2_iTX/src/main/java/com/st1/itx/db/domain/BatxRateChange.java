...
public class BatxRateChange implements Serializable {
	...
	/**
	 * 作業項目<br>
	 * CdCode.TxKind 1:定期機動調整 2:指數型利率調整 3:機動利率調整 4:員工利率調整 5:按商品別調整
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 調整記號<br>
	 * 1:批次自動調整 2:按地區別調整 3:人工調整 4.批次自動調整(提醒件) (下次利率調整日為到期日、非下次利率調整日調整)
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 確認記號<br>
	 * 0:未確認 1:確認未放行 2:已確認放行 L4321維護，確認後Table欄位不可更改
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 戶別<br>
	 * CdCode.EntCode 0:個金 1:企金 2:企金自然人
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 指標利率代碼<br>
	 * CdCode.ProdBaseRateCode 01:保單分紅利率 02:郵政儲金利率 99:自訂利率 RateType
	 * 
	 * @return String
	 */
	...
	/**
	 * 利率區分<br>
	 * CdCode.FacmRateCode 1:機動 2:固定 3:定期機動
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "BatxRateChange [batxRateChangeId=" + batxRateChangeId + ", txKind=" + txKind + ", drawdownAmt=" + drawdownAmt + ", cityCode=" + cityCode + ", areaCode=" + areaCode + ", incrFlag="
				+ incrFlag + ", adjCode=" + adjCode + ", rateKeyInCode=" + rateKeyInCode + ", confirmFlag=" + confirmFlag + ", totBalance=" + totBalance + ", loanBalance=" + loanBalance
				+ ", presEffDate=" + presEffDate + ", curtEffDate=" + curtEffDate + ", preNextAdjDate=" + preNextAdjDate + ", preNextAdjFreq=" + preNextAdjFreq + ", prevIntDate=" + prevIntDate
				+ ", custCode=" + custCode + ", prodNo=" + prodNo + ", rateIncr=" + rateIncr + ", contractRate=" + contractRate + ", presentRate=" + presentRate + ", proposalRate=" + proposalRate
				+ ", adjustedRate=" + adjustedRate + ", contrBaseRate=" + contrBaseRate + ", contrRateIncr=" + contrRateIncr + ", individualIncr=" + individualIncr + ", baseRateCode=" + baseRateCode
				+ ", rateCode=" + rateCode + ", currBaseRate=" + currBaseRate + ", txEffectDate=" + txEffectDate + ", txRateAdjFreq=" + txRateAdjFreq + ", jsonFields=" + jsonFields + ", ovduTerm="
				+ ovduTerm + ", titaTlrNo=" + titaTlrNo + ", titaTxtNo=" + titaTxtNo + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
