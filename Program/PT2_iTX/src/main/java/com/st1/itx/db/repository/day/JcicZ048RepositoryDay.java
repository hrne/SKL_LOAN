 ...
 * @version 1.0.0
 */
public interface JcicZ048RepositoryDay extends JpaRepository<JcicZ048, JcicZ048Id> {
  ...
  // CustId= , AND RcDate=
  public Optional<JcicZ048> findTopByCustIdIsAndRcDateIsOrderByOutJcicTxtDateDesc(String custId_0, int rcDate_1);

  // ActualFilingDate= , AND ActualFilingMark= 
  public Slice<JcicZ048> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
