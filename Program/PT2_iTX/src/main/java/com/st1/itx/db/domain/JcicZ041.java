...
public class JcicZ041 implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3452524542301819788L;
	...
	public String toString() {
		return "JcicZ041 [jcicZ041Id=" + jcicZ041Id + ", tranKey=" + tranKey + ", scDate=" + scDate + ", negoStartDate=" + negoStartDate + ", nonFinClaimAmt=" + nonFinClaimAmt + ", outJcicTxtDate="
