...
em = null;
  ...
  public Slice<FacCaseAppl> caseApplNoRange(int applNo_0, int applNo_1, String processCode_2, String processCode_3, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      slice = facCaseApplReposDay.findAllByApplNoGreaterThanEqualAndApplNoLessThanEqualAndProcessCodeGreaterThanEqualAndProcessCodeLessThanEqualOrderByApplNoAsc(applNo_0, applNo_1, processCode_2, processCode_3, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = facCaseApplReposMon.findAllByApplNoGreaterThanEqualAndApplNoLessThanEqualAndProcessCodeGreaterThanEqualAndProcessCodeLessThanEqualOrderByApplNoAsc(applNo_0, applNo_1, processCode_2, processCode_3, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = facCaseApplReposHist.findAllByApplNoGreaterThanEqualAndApplNoLessThanEqualAndProcessCodeGreaterThanEqualAndProcessCodeLessThanEqualOrderByApplNoAsc(applNo_0, applNo_1, processCode_2, processCode_3, pageable);
    else 
      slice = facCaseApplRepos.findAllByApplNoGreaterThanEqualAndApplNoLessThanEqualAndProcessCodeGreaterThanEqualAndProcessCodeLessThanEqualOrderByApplNoAsc(applNo_0, applNo_1, processCode_2, processCode_3, pageable);
  ...
  public FacCaseAppl insert(FacCaseAppl facCaseAppl, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(facCaseAppl.getApplNo(), titaVo) != null)
