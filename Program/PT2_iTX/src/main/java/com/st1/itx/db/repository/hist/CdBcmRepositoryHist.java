 ...
 * @version 1.0.0
 */
public interface CdBcmRepositoryHist extends JpaRepository<CdBcm, String> {
  ...
  // DistItem %
  public Optional<CdBcm> findTopByDistItemLikeOrderByUnitCodeAsc(String distItem_0);
