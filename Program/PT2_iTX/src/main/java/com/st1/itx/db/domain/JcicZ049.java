...
public class JcicZ049 implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1536935694628240660L;
	...
	public String toString() {
		return "JcicZ049 [jcicZ049Id=" + jcicZ049Id + ", tranKey=" + tranKey + ", claimStatus=" + claimStatus + ", applyDate=" + applyDate + ", courtCode=" + courtCode + ", year=" + year
				+ ", courtDiv=" + courtDiv + ", courtCaseNo=" + courtCaseNo + ", approve=" + approve + ", claimDate=" + claimDate + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey
