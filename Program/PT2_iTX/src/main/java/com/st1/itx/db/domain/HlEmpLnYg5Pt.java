...
public class HlEmpLnYg5Pt implements Serializable {
	...
	public String toString() {
		return "HlEmpLnYg5Pt [hlEmpLnYg5PtId=" + hlEmpLnYg5PtId + ", fullname=" + fullname + ", areaCode=" + areaCode + ", areaItem=" + areaItem + ", deptCode=" + deptCode + ", depItem=" + depItem
				+ ", distCode=" + distCode + ", distItem=" + distItem + ", stationName=" + stationName + ", goalAmt=" + goalAmt + ", hlAppNum=" + hlAppNum + ", hlAppAmt=" + hlAppAmt + ", clAppNum="
				+ clAppNum + ", clAppAmt=" + clAppAmt + ", serviceAppNum=" + serviceAppNum + ", serviceAppAmt=" + serviceAppAmt + ", calDate=" + calDate + ", upNo=" + upNo + ", createDate="
