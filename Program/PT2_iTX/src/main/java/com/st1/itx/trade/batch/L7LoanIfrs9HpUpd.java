...
@Service("L7LoanIfrs9HpUpd")
@Scope("step")
/**
 * (每月日終批次)維護 LoanIfrs9Hp 每月IFRS9欄位清單H檔
 *
 * @author Chih Wei
 * @version 1.0.0
 */
public class L7LoanIfrs9HpUpd extends BatchBase implements Tasklet, InitializingBean {
	...
	public void run() throws LogicException {
		this.info("active L7LoanIfrs9HpUpd ");
		...
		this.info("active L7LoanIfrs9HpUpd tbsdyf=" + tbsdyf);
		this.info("active L7LoanIfrs9HpUpd empNo =" + empNo);
...
//		this.titaVo.putParam(ContentName.dataBase, ContentName.onLine);
		...
		sJobMainService.Usp_L7_LoanIfrs9Hp_Upd(tbsdyf, empNo, txSeq, titaVo);
	}
