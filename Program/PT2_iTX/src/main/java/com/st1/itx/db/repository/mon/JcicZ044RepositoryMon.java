 ...
 * @version 1.0.0
 */
public interface JcicZ044RepositoryMon extends JpaRepository<JcicZ044, JcicZ044Id> {
  ...
  public Slice<JcicZ044> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
