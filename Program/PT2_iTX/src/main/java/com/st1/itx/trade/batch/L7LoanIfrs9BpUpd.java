...
@Service("L7LoanIfrs9BpUpd")
@Scope("step")
/**
 * (每月日終批次)維護 LoanIfrs9Bp 每月IFRS9欄位清單B檔
 *
 * @author Chih Wei
 * @version 1.0.0
 */
public class L7LoanIfrs9BpUpd extends BatchBase implements Tasklet, InitializingBean {
	...
	public void run() throws LogicException {
		this.info("active L7LoanIfrs9BpUpd ");
		...
		this.info("active L7LoanIfrs9BpUpd tbsdyf=" + tbsdyf);
		this.info("active L7LoanIfrs9BpUpd empNo =" + empNo);
...
//		this.titaVo.putParam(ContentName.dataBase, ContentName.onLine);
		...
		sJobMainService.Usp_L7_LoanIfrs9Bp_Upd(tbsdyf, empNo, txSeq, titaVo);
	}
