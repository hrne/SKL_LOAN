...
public class BankAuthAct implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -2974587645808616195L;
...
@EmbeddedId
  ...
  // 狀態碼
  /* 空白:未授權0:授權成功       授權提回更新      1:停止使用       0：授權成功時維護；恢復=&amp;gt;維護回0：授權成功2:取消授權       授權提回更新 8:授權失敗9:已送出授權 */
...
/**
  ...
  * @param otherFields 其他欄位
  ...
  public String toString() {
    return "BankAuthAct [bankAuthActId=" + bankAuthActId + ", repayBank=" + repayBank + ", postDepCode=" + postDepCode + ", repayAcct=" + repayAcct
           + ", status=" + status + ", limitAmt=" + limitAmt + ", acctSeq=" + acctSeq + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
           + ", lastUpdateEmpNo=" + lastUpdateEmpNo + ", otherFields=" + otherFields + "]";
  }
}
