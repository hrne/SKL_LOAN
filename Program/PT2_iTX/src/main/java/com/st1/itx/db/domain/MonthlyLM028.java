...
public class MonthlyLM028 implements Serializable {
	...
	public String toString() {
		return "MonthlyLM028 [monthlyLM028Id=" + monthlyLM028Id + ", status=" + status + ", entCode=" + entCode + ", branchNo=" + branchNo + ", storeRate=" + storeRate + ", payIntFreq=" + payIntFreq
				+ ", maturityYear=" + maturityYear + ", maturityMonth=" + maturityMonth + ", maturityDay=" + maturityDay + ", loanBal=" + loanBal + ", rateCode=" + rateCode + ", postDepCode="
				+ postDepCode + ", specificDd=" + specificDd + ", firstRateAdjFreq=" + firstRateAdjFreq + ", prodNo=" + prodNo + ", fitRate1=" + fitRate1 + ", fitRate2=" + fitRate2 + ", fitRate3="
				+ fitRate3 + ", fitRate4=" + fitRate4 + ", fitRate5=" + fitRate5 + ", clCode1=" + clCode1 + ", clCode2=" + clCode2 + ", drawdownYear=" + drawdownYear + ", drawdownMonth="
				+ drawdownMonth + ", drawdownDay=" + drawdownDay + ", w08Code=" + w08Code + ", isRelation=" + isRelation + ", agType1=" + agType1 + ", acctSource=" + acctSource + ", lastestRate="
				+ lastestRate + ", lastestRateStartDate=" + lastestRateStartDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo="
				+ lastUpdateEmpNo + "]";
	}
}
