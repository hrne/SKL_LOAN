...
@Repository
public class CdOverdueServiceImpl extends ASpringJpaParm implements CdOverdueService, InitializingBean {
	@Autowired
	...
	public CdOverdue findById(CdOverdueId cdOverdueId, TitaVo... titaVo) {
		...
		this.info("findById " + dbName + " " + cdOverdueId);
	...
	public Slice<CdOverdue> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by(Sort.Direction.ASC, "OverdueSign", "OverdueCode"));
		else
	...
	public Slice<CdOverdue> findOverdueSign(String overdueSign_0, int index, int limit, TitaVo... titaVo) {
		...
		this.info("findOverdueSign " + dbName + " : " + "overdueSign_0 : " + overdueSign_0);
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<CdOverdue> findOverdueCode(String overdueCode_0, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findOverdueCode " + dbName + " : " + "overdueCode_0 : " + overdueCode_0);
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<CdOverdue> overdueCodeRange(String overdueSign_0, String overdueSign_1, String overdueCode_2, String overdueCode_3, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("overdueCodeRange " + dbName + " : " + "overdueSign_0 : " + overdueSign_0 + " overdueSign_1 : " + overdueSign_1 + " overdueCode_2 : " + overdueCode_2 + " overdueCode_3 : "
				+ overdueCode_3);
		if (dbName.equals(ContentName.onDay))
			slice = cdOverdueReposDay.findAllByOverdueSignGreaterThanEqualAndOverdueSignLessThanEqualAndOverdueCodeGreaterThanEqualAndOverdueCodeLessThanEqualOrderByOverdueSignAscOverdueCodeAsc(
					overdueSign_0, overdueSign_1, overdueCode_2, overdueCode_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = cdOverdueReposMon.findAllByOverdueSignGreaterThanEqualAndOverdueSignLessThanEqualAndOverdueCodeGreaterThanEqualAndOverdueCodeLessThanEqualOrderByOverdueSignAscOverdueCodeAsc(
					overdueSign_0, overdueSign_1, overdueCode_2, overdueCode_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = cdOverdueReposHist.findAllByOverdueSignGreaterThanEqualAndOverdueSignLessThanEqualAndOverdueCodeGreaterThanEqualAndOverdueCodeLessThanEqualOrderByOverdueSignAscOverdueCodeAsc(
					overdueSign_0, overdueSign_1, overdueCode_2, overdueCode_3, pageable);
		else
			slice = cdOverdueRepos.findAllByOverdueSignGreaterThanEqualAndOverdueSignLessThanEqualAndOverdueCodeGreaterThanEqualAndOverdueCodeLessThanEqualOrderByOverdueSignAscOverdueCodeAsc(
					overdueSign_0, overdueSign_1, overdueCode_2, overdueCode_3, pageable);
	...
	public CdOverdue holdById(CdOverdueId cdOverdueId, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Hold " + dbName + " " + cdOverdueId);
		Optional<CdOverdue> cdOverdue = null;
		if (dbName.equals(ContentName.onDay))
	...
	public CdOverdue holdById(CdOverdue cdOverdue, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Hold " + dbName + " " + cdOverdue.getCdOverdueId());
	...
	public CdOverdue insert(CdOverdue cdOverdue, TitaVo... titaVo) throws DBException {
		...
		this.info("Insert..." + dbName + " " + cdOverdue.getCdOverdueId());
	...
	public CdOverdue update(CdOverdue cdOverdue, TitaVo... titaVo) throws DBException {
		...
		this.info("Update..." + dbName + " " + cdOverdue.getCdOverdueId());
		if (!empNot.isEmpty())
			cdOverdue.setLastUpdateEmpNo(empNot);
	...
	public void delete(CdOverdue cdOverdue, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Delete..." + dbName + " " + cdOverdue.getCdOverdueId());
		if (dbName.equals(ContentName.onDay)) {
