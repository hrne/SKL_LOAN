...
public class SlipMedia2022 implements Serializable {
	...
	// 上傳核心序號
	/*
	 * 相關說明有二:1.關帳時,由L6101連動,以AcClose.CoreSeqNo放在titaVo.MediaSeq傳入2.上傳EBS
	 * Webservice此欄位使用於ETL批號(GROUP_ID)
	 */
	...
	// 區隔帳冊
	/*
	 * 00A:傳統帳冊101:分紅帳冊201:利變年金帳冊203:利變萬能帳冊204:利變壽險帳冊30A:OIU傳統帳冊301:OIU利變年金303:
	 * OIU利變萬能304:OIU利變壽險
	 */
	...
	/**
	 * 上傳核心序號<br>
	 * 相關說明有二: 1.關帳時,由L6101連動,以AcClose.CoreSeqNo放在titaVo.MediaSeq傳入 2.上傳EBS
	 * Webservice此欄位使用於ETL批號(GROUP_ID)
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 區隔帳冊<br>
	 * 00A:傳統帳冊 101:分紅帳冊 201:利變年金帳冊 203:利變萬能帳冊 204:利變壽險帳冊 30A:OIU傳統帳冊 301:OIU利變年金
	 * 303:OIU利變萬能 304:OIU利變壽險
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "SlipMedia2022 [slipMedia2022Id=" + slipMedia2022Id + ", acBookCode=" + acBookCode + ", acDate=" + acDate + ", batchNo=" + batchNo + ", mediaSeq=" + mediaSeq + ", acNoCode=" + acNoCode
				+ ", acSubCode=" + acSubCode + ", deptCode=" + deptCode + ", dbCr=" + dbCr + ", txAmt=" + txAmt + ", slipRmk=" + slipRmk + ", receiveCode=" + receiveCode + ", costMonth=" + costMonth
				+ ", insuNo=" + insuNo + ", salesmanCode=" + salesmanCode + ", salaryCode=" + salaryCode + ", currencyCode=" + currencyCode + ", acSubBookCode=" + acSubBookCode + ", CostUnit="
				+ CostUnit + ", salesChannelType=" + salesChannelType + ", ifrsType=" + ifrsType + ", relationId=" + relationId + ", relateCode=" + relateCode + ", ifrs17Group=" + ifrs17Group
				+ ", latestFlag=" + latestFlag + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
