...
public interface JcicZ054RepositoryMon extends JpaRepository<JcicZ054, JcicZ054Id> {
  ...
  public Slice<JcicZ054> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
