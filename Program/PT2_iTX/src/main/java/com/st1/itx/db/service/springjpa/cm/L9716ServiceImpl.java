...
//		inputYearMonth = inputYearMonth.minusMonths(1);
		...
		sql += "            ,NVL(CB.\"ParkingArea\",0) AS F32";
		sql += "            ,NVL(CB.\"EvaUnitPrice\",0) AS F33";
		sql += "            ,DECODE(CB.\"BdDate\",0,0,TRUNC(CB.\"BdDate\" / 10000)) AS F34";
		sql += "            ,F.\"CreditOfficer\" F35";
		sql += "            ,F.\"BusinessOfficer\" F36";
		sql += "            ,L.\"DrawdownAmt\" F37";
		sql += "            ,0 AS F38";
		...
		// sql += " || DECODE(C.\"CurrNumDash\",NULL";
		// sql += " ,DECODE(C.\"CurrNum\",NULL,'',C.\"CurrNum\" || '號')";
		// sql += " ,DECODE(C.\"CurrNum\",NULL,'',C.\"CurrNum\" || '之') ||
		// C.\"CurrNumDash\" || '號')";
		// sql += " || DECODE(C.\"CurrFloor\",NULL,'',C.\"CurrFloor\" || '樓')";
		// sql += " || DECODE(C.\"CurrFloorDash\",NULL,'','之' || C.\"CurrFloorDash\") AS
		// F14";
		// sql += " ,\"Fn_GetTelNo\"(C.\"CustUKey\",'01',1) AS F15";
		// sql += " ,C3.\"CityItem\"";
		// sql += " || C4.\"AreaItem\"";
		...
		// sql += " || DECODE(C.\"RegNumDash\",NULL";
		// sql += " ,DECODE(C.\"RegNum\",NULL,'',C.\"RegNum\" || '號')";
		// sql += " ,DECODE(C.\"RegNum\",NULL,'',C.\"RegNum\" || '之') ||
		// C.\"RegNumDash\" || '號')";
		// sql += " || DECODE(C.\"RegFloor\",NULL,'',C.\"RegFloor\" || '樓')";
		// sql += " || DECODE(C.\"RegFloorDash\",NULL,'','之' || C.\"RegFloorDash\") AS
		// F16";
		// sql += " ,:inputYearMonth AS F17";
		// sql += " ,CL.\"CityCode\" F18";
		// sql += " ,Cl.\"ClCode1\" F19";
