 ...
 * @version 1.0.0
 */
public class L9MonthlyFacBalUpd extends BatchBase implements Tasklet, InitializingBean {
	...
	public void run() throws LogicException {
		this.info("active L9MonthlyFacBalUpd ");
...
//		this.titaVo.putParam(ContentName.dataBase, ContentName.onLine);
		...
		sJobMainService.Usp_L9_MonthlyFacBal_Upd(tbsdyf, empNo, txSeq, titaVo);
	}
