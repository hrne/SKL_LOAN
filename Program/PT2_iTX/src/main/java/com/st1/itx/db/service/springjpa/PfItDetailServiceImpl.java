...
em = null;
  ...
  public PfItDetail findBormNoLatestFirst(int custNo_0, int facmNo_1, int bormNo_2, TitaVo... titaVo) {
    ...
    Optional<PfItDetail> pfItDetailT = null;
    if (dbName.equals(ContentName.onDay))
      pfItDetailT = pfItDetailReposDay.findTopByCustNoIsAndFacmNoIsAndBormNoIsOrderByPerfDateDescLogNoDesc(custNo_0, facmNo_1, bormNo_2);
    else if (dbName.equals(ContentName.onMon))
      pfItDetailT = pfItDetailReposMon.findTopByCustNoIsAndFacmNoIsAndBormNoIsOrderByPerfDateDescLogNoDesc(custNo_0, facmNo_1, bormNo_2);
    else if (dbName.equals(ContentName.onHist))
      pfItDetailT = pfItDetailReposHist.findTopByCustNoIsAndFacmNoIsAndBormNoIsOrderByPerfDateDescLogNoDesc(custNo_0, facmNo_1, bormNo_2);
    else 
      pfItDetailT = pfItDetailRepos.findTopByCustNoIsAndFacmNoIsAndBormNoIsOrderByPerfDateDescLogNoDesc(custNo_0, facmNo_1, bormNo_2);

    return pfItDetailT.isPresent() ? pfItDetailT.get() : null;
  }

  @Override
  public PfItDetail findBormNoFirst(int custNo_0, int facmNo_1, int bormNo_2, TitaVo... titaVo) {
    String dbName = "";
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    ...
    Optional<PfItDetail> pfItDetailT = null;
    if (dbName.equals(ContentName.onDay))
      pfItDetailT = pfItDetailReposDay.findTopByCustNoIsAndFacmNoIsAndBormNoIsOrderByPerfDateAscLogNoAsc(custNo_0, facmNo_1, bormNo_2);
    else if (dbName.equals(ContentName.onMon))
      pfItDetailT = pfItDetailReposMon.findTopByCustNoIsAndFacmNoIsAndBormNoIsOrderByPerfDateAscLogNoAsc(custNo_0, facmNo_1, bormNo_2);
    else if (dbName.equals(ContentName.onHist))
      pfItDetailT = pfItDetailReposHist.findTopByCustNoIsAndFacmNoIsAndBormNoIsOrderByPerfDateAscLogNoAsc(custNo_0, facmNo_1, bormNo_2);
    else 
      pfItDetailT = pfItDetailRepos.findTopByCustNoIsAndFacmNoIsAndBormNoIsOrderByPerfDateAscLogNoAsc(custNo_0, facmNo_1, bormNo_2);
