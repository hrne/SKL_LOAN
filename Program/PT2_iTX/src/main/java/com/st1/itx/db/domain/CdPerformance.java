...
public class CdPerformance implements Serializable {
	...
	/**
	 * 介紹單位_計件金額門檻<br>
	 * 介紹單位_件數&amp;gt;0時有值 例: 600000=1件(60萬以上)
	 * 
	 * @return BigDecimal
	 */
	...
	/**
	 * 介紹人_換算業績率(分子)<br>
	 * 介紹人_換算業績金額基準=0時必須為0 例: 0=無 , 35=以每一萬元計算35元業績獎金
	 * 
	 * @return BigDecimal
	 */
	...
	/**
	 * 介紹人_業務報酬率(分子)<br>
	 * 介紹人_二階(或三階承攬)業務報酬_金額基準=0時必須為0 例: 0=無 , 12.5=以每一萬元計算12.5元業績獎金
	 * 
	 * @return BigDecimal
	 */
	...
	/**
	 * 房貸專員_撥款業績_比例<br>
	 * 輸入比例 例: 0=無 , 1=全部計算 , 0.5=撥款金額*1/2
	 * 
	 * @return BigDecimal
	 */
	...
	public String toString() {
		return "CdPerformance [cdPerformanceId=" + cdPerformanceId + ", unitCnt=" + unitCnt + ", unitAmtCond=" + unitAmtCond + ", unitPercent=" + unitPercent + ", introdPerccent=" + introdPerccent
				+ ", introdAmtCond=" + introdAmtCond + ", introdPfEqBase=" + introdPfEqBase + ", introdPfEqAmt=" + introdPfEqAmt + ", introdRewardBase=" + introdRewardBase + ", introdReward="
				+ introdReward + ", bsOffrCnt=" + bsOffrCnt + ", bsOffrCntLimit=" + bsOffrCntLimit + ", bsOffrAmtCond=" + bsOffrAmtCond + ", bsOffrPerccent=" + bsOffrPerccent + ", createDate="
