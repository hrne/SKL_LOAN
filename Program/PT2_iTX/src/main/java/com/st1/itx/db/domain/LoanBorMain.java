...
public class LoanBorMain implements Serializable {
	...
	// 戶況
	/*
	 * 0:正常戶1:展期2:催收戶3:結案戶4:逾期戶(顯示用)5:催收結案戶6:呆帳戶7:部分轉呆戶8:債權轉讓戶9:呆帳結案戶97:預約撥款已刪除98:
	 * 預約已撥款99:預約撥款
	 */
	@Column(name = "`Status`")
	...
	// 計件代碼
	/*
	 * 共用代碼檔(PieceCode)A:新貸件B:其他額度C:原額度D:新增額度E:展期1:新貸件2:其他額度3:原額度4:新增額度5:展期件6:六個月動支7
	 * :服務件8:特殊件9:固特利契轉
	 */
	...
	/**
	 * 戶況<br>
	 * 0:正常戶 1:展期 2:催收戶 3:結案戶 4:逾期戶(顯示用) 5:催收結案戶 6:呆帳戶 7:部分轉呆戶 8:債權轉讓戶 9:呆帳結案戶
	...
	/**
	 * 計件代碼<br>
	 * 共用代碼檔(PieceCode) A:新貸件 B:其他額度 C:原額度 D:新增額度 E:展期 1:新貸件 2:其他額度 3:原額度 4:新增額度
	 * 5:展期件 6:六個月動支 7:服務件 8:特殊件 9:固特利契轉
	 * 
	 * @return String
	 */
	...
	/**
	 * 與借款人關係<br>
	 * 共用代碼檔 00:本人 01:夫 02:妻 03:父 04:母 05:子 06:女 07:兄 08:弟 09:姊 10:妹 11:姪子 99:其他
	 * 
	 * @return String
	 */
	...
	/**
	 * 交易進行記號<br>
	 * 0:1STEP TX 1/2:2STEP TX 1/2/3/4:3STEP TX
	 * 
	 * @return Integer
	 */
	public int getActFg() {
	...
	public String toString() {
		return "LoanBorMain [loanBorMainId=" + loanBorMainId + ", lastBorxNo=" + lastBorxNo + ", lastOvduNo=" + lastOvduNo + ", status=" + status + ", rateIncr=" + rateIncr + ", individualIncr="
				+ individualIncr + ", approveRate=" + approveRate + ", storeRate=" + storeRate + ", rateCode=" + rateCode + ", rateAdjFreq=" + rateAdjFreq + ", drawdownCode=" + drawdownCode
				+ ", currencyCode=" + currencyCode + ", drawdownAmt=" + drawdownAmt + ", loanBal=" + loanBal + ", drawdownDate=" + drawdownDate + ", loanTermYy=" + loanTermYy + ", loanTermMm="
				+ loanTermMm + ", loanTermDd=" + loanTermDd + ", maturityDate=" + maturityDate + ", intCalcCode=" + intCalcCode + ", amortizedCode=" + amortizedCode + ", freqBase=" + freqBase
				+ ", payIntFreq=" + payIntFreq + ", repayFreq=" + repayFreq + ", totalPeriod=" + totalPeriod + ", repaidPeriod=" + repaidPeriod + ", paidTerms=" + paidTerms + ", prevPayIntDate="
				+ prevPayIntDate + ", prevRepaidDate=" + prevRepaidDate + ", nextPayIntDate=" + nextPayIntDate + ", nextRepayDate=" + nextRepayDate + ", dueAmt=" + dueAmt + ", gracePeriod="
				+ gracePeriod + ", graceDate=" + graceDate + ", specificDd=" + specificDd + ", specificDate=" + specificDate + ", firstDueDate=" + firstDueDate + ", firstAdjRateDate="
				+ firstAdjRateDate + ", nextAdjRateDate=" + nextAdjRateDate + ", acctFee=" + acctFee + ", handlingFee=" + handlingFee + ", finalBal=" + finalBal + ", notYetFlag=" + notYetFlag
				+ ", renewFlag=" + renewFlag + ", pieceCode=" + pieceCode + ", pieceCodeSecond=" + pieceCodeSecond + ", pieceCodeSecondAmt=" + pieceCodeSecondAmt + ", usageCode=" + usageCode
				+ ", syndNo=" + syndNo + ", relationCode=" + relationCode + ", relationName=" + relationName + ", relationId=" + relationId + ", relationBirthday=" + relationBirthday
				...
				+ ", remitBank=" + remitBank + ", remitBranch=" + remitBranch + ", remitAcctNo=" + remitAcctNo + ", compensateAcct=" + compensateAcct + ", paymentBank=" + paymentBank + ", remark="
				+ remark + ", acDate=" + acDate + ", nextAcDate=" + nextAcDate + ", branchNo=" + branchNo + ", graceFlag=" + graceFlag + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
