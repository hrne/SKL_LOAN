...
public class LoanBorMain implements Serializable {
	...
	// 戶況
	/*
	 * 0: 正常戶1:展期2: 催收戶3: 結案戶4: 逾期戶(顯示用)5: 催收結案戶6: 呆帳戶7: 部分轉呆戶8: 債權轉讓戶9:
	...
	// 計件代碼
	/*
	 * 共用代碼檔(PieceCode)A: 新貸件B: 其他額度C: 原額度D: 新增額度E: 展期1: 新貸件2: 其他額度3: 原額度4: 新增額度5:
	 * 展期件6: 六個月動支7: 服務件8: 特殊件9: 固特利契轉
	 */
	...
	/**
	 * 戶況<br>
	 * 0: 正常戶 1:展期 2: 催收戶 3: 結案戶 4: 逾期戶(顯示用) 5: 催收結案戶 6: 呆帳戶 7: 部分轉呆戶 8: 債權轉讓戶 9:
	 * 呆帳結案戶 97:預約撥款已刪除 98:預約已撥款 99:預約撥款
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 計件代碼<br>
	 * 共用代碼檔(PieceCode) A: 新貸件 B: 其他額度 C: 原額度 D: 新增額度 E: 展期 1: 新貸件 2: 其他額度 3: 原額度 4:
	 * 新增額度 5: 展期件 6: 六個月動支 7: 服務件 8: 特殊件 9: 固特利契轉
	 * 
	 * @return String
	 */
	...
	/**
	 * 交易進行記號<br>
	 * 1STEP TX -&amp;gt; 0 2STEP TX -&amp;gt; 1 2 3STEP TX -&amp;gt; 1 2 3 4
	 * 
	 * @return Integer
	 */
	public int getActFg() {
	...
	public String toString() {
		return "LoanBorMain [loanBorMainId=" + loanBorMainId + ", lastBorxNo=" + lastBorxNo + ", lastOvduNo=" + lastOvduNo + ", status=" + status + ", rateIncr=" + rateIncr + ", individualIncr="
				...
				+ remark + ", acDate=" + acDate + ", nextAcDate=" + nextAcDate + ", branchNo=" + branchNo + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
