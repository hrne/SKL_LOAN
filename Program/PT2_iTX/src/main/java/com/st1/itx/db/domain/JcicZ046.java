...
public class JcicZ046 implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8545275102978156150L;
	...
	public String toString() {
		return "JcicZ046 [jcicZ046Id=" + jcicZ046Id + ", tranKey=" + tranKey + ", closeCode=" + closeCode + ", breakCode=" + breakCode + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey
