 ...
 * @version 1.0.0
 */
public interface TxRecordRepositoryHist extends JpaRepository<TxRecord, TxRecordId> {
  ...
  public Slice<TxRecord> findAllByCalDateGreaterThanEqualAndCalDateLessThanEqualAndBrNoIsAndImportFgIsOrderByCreateDateAsc(int calDate_0, int calDate_1, String brNo_2, String importFg_3, Pageable pageable);
