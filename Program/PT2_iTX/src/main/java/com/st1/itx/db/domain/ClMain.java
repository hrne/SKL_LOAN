...
public class ClMain implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -6293025416447730328L;
...
@EmbeddedId
  ...
  // 他項權利最後序號
  @Column(name = "`LastClOtherSeq`")
  private int lastClOtherSeq = 0;
...
/**
	...
	* @return Integer
	*/
  public int getLastClOtherSeq() {
    return this.lastClOtherSeq;
  }
...
/**
	...
	* 
  *
  * @param lastClOtherSeq 他項權利最後序號
	*/
  public void setLastClOtherSeq(int lastClOtherSeq) {
    this.lastClOtherSeq = lastClOtherSeq;
  }
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "ClMain [clMainId=" + clMainId + ", custUKey=" + custUKey + ", clTypeCode=" + clTypeCode + ", cityCode=" + cityCode
           ...
           + ", syndCode=" + syndCode + ", dispPrice=" + dispPrice + ", dispDate=" + dispDate + ", newNote=" + newNote + ", lastClOtherSeq=" + lastClOtherSeq + ", createDate=" + createDate
