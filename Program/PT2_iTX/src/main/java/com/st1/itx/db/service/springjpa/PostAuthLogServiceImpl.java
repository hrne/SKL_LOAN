...
em = null;
  ...
  public Slice<PostAuthLog> findAll(int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by(Sort.Direction.ASC, "AuthCreateDate", "AuthApplCode", "CustNo", "PostDepCode", "RepayAcct", "AuthCode"));
    else
  ...
  public PostAuthLog pkFacmNoFirst(String authApplCode_0, int custNo_1, String postDepCode_2, String repayAcct_3, String authCode_4, int facmNo_5, TitaVo... titaVo) {
    ...
    Optional<PostAuthLog> postAuthLogT = null;
    if (dbName.equals(ContentName.onDay))
      postAuthLogT = postAuthLogReposDay.findTopByAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsAndFacmNoIsOrderByRepayAcctSeqDesc(authApplCode_0, custNo_1, postDepCode_2, repayAcct_3, authCode_4, facmNo_5);
    else if (dbName.equals(ContentName.onMon))
      postAuthLogT = postAuthLogReposMon.findTopByAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsAndFacmNoIsOrderByRepayAcctSeqDesc(authApplCode_0, custNo_1, postDepCode_2, repayAcct_3, authCode_4, facmNo_5);
    else if (dbName.equals(ContentName.onHist))
      postAuthLogT = postAuthLogReposHist.findTopByAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsAndFacmNoIsOrderByRepayAcctSeqDesc(authApplCode_0, custNo_1, postDepCode_2, repayAcct_3, authCode_4, facmNo_5);
    else 
      postAuthLogT = postAuthLogRepos.findTopByAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsAndFacmNoIsOrderByRepayAcctSeqDesc(authApplCode_0, custNo_1, postDepCode_2, repayAcct_3, authCode_4, facmNo_5);
  ...
  public Slice<PostAuthLog> custNoAuthErrorCodeEq(int custNo_0, List<String> authApplCode_1, List<String> authErrorCode_2, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("custNoAuthErrorCodeEq " + dbName + " : " + "custNo_0 : " + custNo_0 + " authApplCode_1 : " +  authApplCode_1 + " authErrorCode_2 : " +  authErrorCode_2);
    if (dbName.equals(ContentName.onDay))
      slice = postAuthLogReposDay.findAllByCustNoIsAndAuthApplCodeInAndAuthErrorCodeInOrderByRepayAcctDescAuthCreateDateDesc(custNo_0, authApplCode_1, authErrorCode_2, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = postAuthLogReposMon.findAllByCustNoIsAndAuthApplCodeInAndAuthErrorCodeInOrderByRepayAcctDescAuthCreateDateDesc(custNo_0, authApplCode_1, authErrorCode_2, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = postAuthLogReposHist.findAllByCustNoIsAndAuthApplCodeInAndAuthErrorCodeInOrderByRepayAcctDescAuthCreateDateDesc(custNo_0, authApplCode_1, authErrorCode_2, pageable);
    else 
      slice = postAuthLogRepos.findAllByCustNoIsAndAuthApplCodeInAndAuthErrorCodeInOrderByRepayAcctDescAuthCreateDateDesc(custNo_0, authApplCode_1, authErrorCode_2, pageable);
  ...
  public PostAuthLog insert(PostAuthLog postAuthLog, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(postAuthLog.getPostAuthLogId(), titaVo) != null)
