...
public class FinReportRate implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = 5118050380473674616L;
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "FinReportRate [finReportRateId=" + finReportRateId + ", isSameTrade=" + isSameTrade + ", tradeType=" + tradeType + ", flow=" + flow + ", speed=" + speed
           + ", rateGuar=" + rateGuar + ", debt=" + debt + ", net=" + net + ", cashFlow=" + cashFlow + ", fixLong=" + fixLong + ", finSpend=" + finSpend
           + ", grossProfit=" + grossProfit + ", afterTaxNet=" + afterTaxNet + ", netReward=" + netReward + ", totalAssetReward=" + totalAssetReward + ", stock=" + stock + ", receiveAccount=" + receiveAccount
           + ", totalAsset=" + totalAsset + ", payAccount=" + payAccount + ", aveTotalAsset=" + aveTotalAsset + ", aveNetBusCycle=" + aveNetBusCycle + ", finLever=" + finLever + ", loanDebtNet=" + loanDebtNet
           + ", busRate=" + busRate + ", payFinLever=" + payFinLever + ", aDE=" + aDE + ", cashGuar=" + cashGuar + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
