...
public class PfCoOfficerLogServiceImpl extends ASpringJpaParm implements PfCoOfficerLogService, InitializingBean {
  ...
  public PfCoOfficerLog findById(Long logNo, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      pfCoOfficerLog = pfCoOfficerLogReposDay.findById(logNo);
    else if (dbName.equals(ContentName.onMon))
      pfCoOfficerLog = pfCoOfficerLogReposMon.findById(logNo);
    else if (dbName.equals(ContentName.onHist))
      pfCoOfficerLog = pfCoOfficerLogReposHist.findById(logNo);
    else 
      pfCoOfficerLog = pfCoOfficerLogRepos.findById(logNo);
...
em = null;
  ...
  public Slice<PfCoOfficerLog> findEmpNoEq(String empNo_0, int index, int limit, TitaVo... titaVo) {
    ...
    this.info("findEmpNoEq " + dbName + " : " + "empNo_0 : " + empNo_0);
    if (dbName.equals(ContentName.onDay))
      slice = pfCoOfficerLogReposDay.findAllByEmpNoIsOrderByLogNoDesc(empNo_0, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = pfCoOfficerLogReposMon.findAllByEmpNoIsOrderByLogNoDesc(empNo_0, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = pfCoOfficerLogReposHist.findAllByEmpNoIsOrderByLogNoDesc(empNo_0, pageable);
    else 
      slice = pfCoOfficerLogRepos.findAllByEmpNoIsOrderByLogNoDesc(empNo_0, pageable);
  ...
  public PfCoOfficerLog holdById(Long logNo, TitaVo... titaVo) {
    ...
    Optional<PfCoOfficerLog> pfCoOfficerLog = null;
    if (dbName.equals(ContentName.onDay))
      pfCoOfficerLog = pfCoOfficerLogReposDay.findByLogNo(logNo);
    else if (dbName.equals(ContentName.onMon))
      pfCoOfficerLog = pfCoOfficerLogReposMon.findByLogNo(logNo);
    else if (dbName.equals(ContentName.onHist))
      pfCoOfficerLog = pfCoOfficerLogReposHist.findByLogNo(logNo);
    else 
      pfCoOfficerLog = pfCoOfficerLogRepos.findByLogNo(logNo);
  ...
  public PfCoOfficerLog holdById(PfCoOfficerLog pfCoOfficerLog, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("Hold " + dbName + " " + pfCoOfficerLog.getLogNo());
    Optional<PfCoOfficerLog> pfCoOfficerLogT = null;
    if (dbName.equals(ContentName.onDay))
      pfCoOfficerLogT = pfCoOfficerLogReposDay.findByLogNo(pfCoOfficerLog.getLogNo());
    else if (dbName.equals(ContentName.onMon))
      pfCoOfficerLogT = pfCoOfficerLogReposMon.findByLogNo(pfCoOfficerLog.getLogNo());
    else if (dbName.equals(ContentName.onHist))
      pfCoOfficerLogT = pfCoOfficerLogReposHist.findByLogNo(pfCoOfficerLog.getLogNo());
    else 
      pfCoOfficerLogT = pfCoOfficerLogRepos.findByLogNo(pfCoOfficerLog.getLogNo());
  ...
  public PfCoOfficerLog insert(PfCoOfficerLog pfCoOfficerLog, TitaVo... titaVo) throws DBException {
    ...
    this.info("Insert..." + dbName + " " + pfCoOfficerLog.getLogNo());
    if (this.findById(pfCoOfficerLog.getLogNo(), titaVo) != null)
  ...
  public PfCoOfficerLog update(PfCoOfficerLog pfCoOfficerLog, TitaVo... titaVo) throws DBException {
    ...
    this.info("Update..." + dbName + " " + pfCoOfficerLog.getLogNo());
    if (!empNot.isEmpty())
      pfCoOfficerLog.setLastUpdateEmpNo(empNot);
  ...
  public PfCoOfficerLog update2(PfCoOfficerLog pfCoOfficerLog, TitaVo... titaVo) throws DBException {
    ...
    return this.findById(pfCoOfficerLog.getLogNo());
  }
  ...
  public void delete(PfCoOfficerLog pfCoOfficerLog, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("Delete..." + dbName + " " + pfCoOfficerLog.getLogNo());
    if (dbName.equals(ContentName.onDay)) {
