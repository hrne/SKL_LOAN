...
public class AchDeductMedia implements Serializable {
	...
	// 還款類別
	/*
	 * CdCode:RepayType1.期款2.部分償還3.結案4.帳管費5.火險費6.契變手續費7.法務費9.其他銀扣媒體檔用1.火險費 2.帳管費
	 * 3.期款 4.貸後契變手續費
	 */
	 ...
	 * 
	 * 銀扣媒體檔用 1.火險費 2.帳管費 3.期款 4.貸後契變手續費
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "AchDeductMedia [achDeductMediaId=" + achDeductMediaId + ", custNo=" + custNo + ", facmNo=" + facmNo + ", repayType=" + repayType + ", repayAmt=" + repayAmt + ", returnCode="
				+ returnCode + ", entryDate=" + entryDate + ", prevIntDate=" + prevIntDate + ", repayBank=" + repayBank + ", repayAcctNo=" + repayAcctNo + ", achRepayCode=" + achRepayCode
				+ ", acctCode=" + acctCode + ", intStartDate=" + intStartDate + ", intEndDate=" + intEndDate + ", depCode=" + depCode + ", relationCode=" + relationCode + ", relCustName="
				+ relCustName + ", relCustId=" + relCustId + ", acDate=" + acDate + ", batchNo=" + batchNo + ", detailSeq=" + detailSeq + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
