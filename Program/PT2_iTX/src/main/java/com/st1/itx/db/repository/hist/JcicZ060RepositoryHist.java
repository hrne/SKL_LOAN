 ...
 * @version 1.0.0
 */
public interface JcicZ060RepositoryHist extends JpaRepository<JcicZ060, JcicZ060Id> {
  ...
  public Slice<JcicZ060> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
