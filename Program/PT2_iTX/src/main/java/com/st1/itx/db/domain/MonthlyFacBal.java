...
public class MonthlyFacBal implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -196751124117590305L;
	...
	// 戶況
	/*
	 * 00: 正常戶02: 催收戶03: 結案戶(結清日=本月)04: 逾期戶(改為00:正常戶)05: 催收結案戶(結清日=本月)06: 呆帳戶07:
	 * 部分轉呆戶08: 債權轉讓戶(結清日=本月)09: 呆帳結案戶(結清日=本月)(不含債協)
	 */
	@Column(name = "`Status`")
	...
	// 無擔保債權設定金額(法務進度:901)
	/* 1.無擔保債權設定金額，資產分類一律為五 */
	@Column(name = "`LawAmount`")
	private BigDecimal lawAmount = new BigDecimal("0");

	// 資產五分類代號(有擔保部分)
	/*
	 * 11=一之1, 12=一之2,21=二之1, 22=二之2, 23=二之3,3=三 4=四
	 * 5=五此為有擔保金額(PrinBalance-LawAmount)的分類
	 */
	...
	/**
	 * 戶況<br>
	 * 00: 正常戶 02: 催收戶 03: 結案戶(結清日=本月) 04: 逾期戶(改為00:正常戶) 05: 催收結案戶(結清日=本月) 06: 呆帳戶
	 * 07: 部分轉呆戶 08: 債權轉讓戶(結清日=本月) 09: 呆帳結案戶(結清日=本月) (不含債協)
	 * 
	 * @return Integer
	 */
	 ...
	 * 1.無擔保債權設定金額，資產分類一律為五
	 *
	 * @param lawAmount 無擔保債權設定金額(法務進度:901)
	 */
	...
	/**
	 * 資產五分類代號(有擔保部分)<br>
	 * 11=一之1, 12=一之2, 21=二之1, 22=二之2, 23=二之3, 3=三 4=四 5=五
	...
	public String toString() {
		return "MonthlyFacBal [monthlyFacBalId=" + monthlyFacBalId + ", prevIntDate=" + prevIntDate + ", nextIntDate=" + nextIntDate + ", dueDate=" + dueDate + ", ovduTerm=" + ovduTerm + ", ovduDays="
				+ ovduDays + ", currencyCode=" + currencyCode + ", prinBalance=" + prinBalance + ", badDebtBal=" + badDebtBal + ", accCollPsn=" + accCollPsn + ", legalPsn=" + legalPsn + ", status="
				+ status + ", acctCode=" + acctCode + ", facAcctCode=" + facAcctCode + ", clCustNo=" + clCustNo + ", clFacmNo=" + clFacmNo + ", clRowNo=" + clRowNo + ", renewCode=" + renewCode
				+ ", prodNo=" + prodNo + ", acBookCode=" + acBookCode + ", entCode=" + entCode + ", relsCode=" + relsCode + ", departmentCode=" + departmentCode + ", unpaidPrincipal="
				+ unpaidPrincipal + ", unpaidInterest=" + unpaidInterest + ", unpaidBreachAmt=" + unpaidBreachAmt + ", unpaidDelayInt=" + unpaidDelayInt + ", acdrPrincipal=" + acdrPrincipal
				...
				+ ", acctFee=" + acctFee + ", shortfallPrin=" + shortfallPrin + ", shortfallInt=" + shortfallInt + ", tempAmt=" + tempAmt + ", clCode1=" + clCode1 + ", clCode2=" + clCode2 + ", clNo="
				+ clNo + ", cityCode=" + cityCode + ", ovduDate=" + ovduDate + ", ovduPrinBal=" + ovduPrinBal + ", ovduIntBal=" + ovduIntBal + ", ovduBreachBal=" + ovduBreachBal + ", ovduBal="
				+ ovduBal + ", lawAmount=" + lawAmount + ", assetClass=" + assetClass + ", storeRate=" + storeRate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate="
				+ lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + ", acSubBookCode=" + acSubBookCode + "]";
	}
}
