...
em = null;
  ...
  @Override
  public InnFundApl acDateFirst(int acDate_0, BigDecimal resrvStndrd_1, TitaVo... titaVo) {
    String dbName = "";
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("acDateFirst " + dbName + " : " + "acDate_0 : " + acDate_0 + " resrvStndrd_1 : " +  resrvStndrd_1);
    Optional<InnFundApl> innFundAplT = null;
    if (dbName.equals(ContentName.onDay))
      innFundAplT = innFundAplReposDay.findTopByAcDateLessThanEqualAndResrvStndrdGreaterThanOrderByAcDateDesc(acDate_0, resrvStndrd_1);
    else if (dbName.equals(ContentName.onMon))
      innFundAplT = innFundAplReposMon.findTopByAcDateLessThanEqualAndResrvStndrdGreaterThanOrderByAcDateDesc(acDate_0, resrvStndrd_1);
    else if (dbName.equals(ContentName.onHist))
      innFundAplT = innFundAplReposHist.findTopByAcDateLessThanEqualAndResrvStndrdGreaterThanOrderByAcDateDesc(acDate_0, resrvStndrd_1);
    else 
      innFundAplT = innFundAplRepos.findTopByAcDateLessThanEqualAndResrvStndrdGreaterThanOrderByAcDateDesc(acDate_0, resrvStndrd_1);
  ...
  public InnFundApl insert(InnFundApl innFundApl, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(innFundApl.getAcDate(), titaVo) != null)
