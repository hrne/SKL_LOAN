...
public class MonthlyLoanBal implements Serializable {
	...
	public String toString() {
		return "MonthlyLoanBal [monthlyLoanBalId=" + monthlyLoanBalId + ", acctCode=" + acctCode + ", facAcctCode=" + facAcctCode + ", currencyCode=" + currencyCode + ", loanBalance=" + loanBalance
				+ ", maxLoanBal=" + maxLoanBal + ", storeRate=" + storeRate + ", intAmtRcv=" + intAmtRcv + ", intAmtAcc=" + intAmtAcc + ", unpaidInt=" + unpaidInt + ", unexpiredInt=" + unexpiredInt
				+ ", sumRcvInt=" + sumRcvInt + ", intAmt=" + intAmt + ", prodNo=" + prodNo + ", acBookCode=" + acBookCode + ", entCode=" + entCode + ", relsCode=" + relsCode + ", departmentCode="
				+ departmentCode + ", clCode1=" + clCode1 + ", clCode2=" + clCode2 + ", clNo=" + clNo + ", cityCode=" + cityCode + ", ovduPrinAmt=" + ovduPrinAmt + ", ovduIntAmt=" + ovduIntAmt
				+ ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + ", acSubBookCode=" + acSubBookCode + "]";
	}
}
