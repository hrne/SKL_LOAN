...
public class AcLoanRenewServiceImpl extends ASpringJpaParm implements AcLoanRenewService, InitializingBean {
	...
	public Slice<AcLoanRenew> NewFacmNoNoRange(int custNo_0, int newFacmNo_1, int newFacmNo_2, int newBormNo_3, int newBormNo_4, int index, int limit, TitaVo... titaVo) {
		...
		this.info("NewFacmNoNoRange " + dbName + " : " + "custNo_0 : " + custNo_0 + " newFacmNo_1 : " + newFacmNo_1 + " newFacmNo_2 : " + newFacmNo_2 + " newBormNo_3 : " + newBormNo_3
				+ " newBormNo_4 : " + newBormNo_4);
		if (dbName.equals(ContentName.onDay))
			slice = acLoanRenewReposDay.findAllByCustNoIsAndNewFacmNoGreaterThanEqualAndNewFacmNoLessThanEqualAndNewBormNoGreaterThanEqualAndNewBormNoLessThanEqualOrderByNewFacmNoAscNewBormNoAsc(
					custNo_0, newFacmNo_1, newFacmNo_2, newBormNo_3, newBormNo_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = acLoanRenewReposMon.findAllByCustNoIsAndNewFacmNoGreaterThanEqualAndNewFacmNoLessThanEqualAndNewBormNoGreaterThanEqualAndNewBormNoLessThanEqualOrderByNewFacmNoAscNewBormNoAsc(
					custNo_0, newFacmNo_1, newFacmNo_2, newBormNo_3, newBormNo_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = acLoanRenewReposHist.findAllByCustNoIsAndNewFacmNoGreaterThanEqualAndNewFacmNoLessThanEqualAndNewBormNoGreaterThanEqualAndNewBormNoLessThanEqualOrderByNewFacmNoAscNewBormNoAsc(
					custNo_0, newFacmNo_1, newFacmNo_2, newBormNo_3, newBormNo_4, pageable);
		else
			slice = acLoanRenewRepos.findAllByCustNoIsAndNewFacmNoGreaterThanEqualAndNewFacmNoLessThanEqualAndNewBormNoGreaterThanEqualAndNewBormNoLessThanEqualOrderByNewFacmNoAscNewBormNoAsc(
					custNo_0, newFacmNo_1, newFacmNo_2, newBormNo_3, newBormNo_4, pageable);
	...
	@Override
	public Slice<AcLoanRenew> findL2079(int custNo_0, int custNo_1, int oldFacmNo_2, int oldFacmNo_3, int newFacmNo_4, int newFacmNo_5, int acDate_6, int acDate_7, int index, int limit,
			TitaVo... titaVo) {
		String dbName = "";
		Slice<AcLoanRenew> slice = null;
		if (titaVo.length != 0)
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findL2079 " + dbName + " : " + "custNo_0 : " + custNo_0 + " custNo_1 : " + custNo_1 + " oldFacmNo_2 : " + oldFacmNo_2 + " oldFacmNo_3 : " + oldFacmNo_3 + " newFacmNo_4 : "
				+ newFacmNo_4 + " newFacmNo_5 : " + newFacmNo_5 + " acDate_6 : " + acDate_6 + " acDate_7 : " + acDate_7);
		if (dbName.equals(ContentName.onDay))
			slice = acLoanRenewReposDay
					.(
							custNo_0, custNo_1, oldFacmNo_2, oldFacmNo_3, newFacmNo_4, newFacmNo_5, acDate_6, acDate_7, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = acLoanRenewReposMon
					.(
							custNo_0, custNo_1, oldFacmNo_2, oldFacmNo_3, newFacmNo_4, newFacmNo_5, acDate_6, acDate_7, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = acLoanRenewReposHist
					.(
							custNo_0, custNo_1, oldFacmNo_2, oldFacmNo_3, newFacmNo_4, newFacmNo_5, acDate_6, acDate_7, pageable);
		else
			slice = acLoanRenewRepos
					.(
							custNo_0, custNo_1, oldFacmNo_2, oldFacmNo_3, newFacmNo_4, newFacmNo_5, acDate_6, acDate_7, pageable);
