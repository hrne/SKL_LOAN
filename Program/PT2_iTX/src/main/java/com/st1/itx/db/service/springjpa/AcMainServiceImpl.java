...
public class AcMainServiceImpl extends ASpringJpaParm implements AcMainService, InitializingBean {
	...
	@Override
	public Slice<AcMain> acmainAcDateRange(String acBookCode_0, String branchNo_1, String currencyCode_2, String acNoCode_3, String acSubCode_4, String acDtlCode_5, int acDate_6, int acDate_7,
		...
		this.info("acmainAcDateRange " + dbName + " : " + "acBookCode_0 : " + acBookCode_0 + " branchNo_1 : " + branchNo_1 + " currencyCode_2 : " + currencyCode_2 + " acNoCode_3 : " + acNoCode_3
				+ " acSubCode_4 : " + acSubCode_4 + " acDtlCode_5 : " + acDtlCode_5 + " acDate_6 : " + acDate_6 + " acDate_7 : " + acDate_7);
		if (dbName.equals(ContentName.onDay))
			slice = acMainReposDay.findAllByAcBookCodeIsAndBranchNoIsAndCurrencyCodeIsAndAcNoCodeIsAndAcSubCodeIsAndAcDtlCodeIsAndAcDateGreaterThanEqualAndAcDateLessThanEqualOrderByAcDateAsc(
					acBookCode_0, branchNo_1, currencyCode_2, acNoCode_3, acSubCode_4, acDtlCode_5, acDate_6, acDate_7, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = acMainReposMon.findAllByAcBookCodeIsAndBranchNoIsAndCurrencyCodeIsAndAcNoCodeIsAndAcSubCodeIsAndAcDtlCodeIsAndAcDateGreaterThanEqualAndAcDateLessThanEqualOrderByAcDateAsc(
					acBookCode_0, branchNo_1, currencyCode_2, acNoCode_3, acSubCode_4, acDtlCode_5, acDate_6, acDate_7, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = acMainReposHist.findAllByAcBookCodeIsAndBranchNoIsAndCurrencyCodeIsAndAcNoCodeIsAndAcSubCodeIsAndAcDtlCodeIsAndAcDateGreaterThanEqualAndAcDateLessThanEqualOrderByAcDateAsc(
					acBookCode_0, branchNo_1, currencyCode_2, acNoCode_3, acSubCode_4, acDtlCode_5, acDate_6, acDate_7, pageable);
		else
			slice = acMainRepos.findAllByAcBookCodeIsAndBranchNoIsAndCurrencyCodeIsAndAcNoCodeIsAndAcSubCodeIsAndAcDtlCodeIsAndAcDateGreaterThanEqualAndAcDateLessThanEqualOrderByAcDateAsc(
					acBookCode_0, branchNo_1, currencyCode_2, acNoCode_3, acSubCode_4, acDtlCode_5, acDate_6, acDate_7, pageable);
	...
	@Override
	public Slice<AcMain> acmainAcCodeRange(String acBookCode_0, String branchNo_1, String currencyCode_2, int acDate_3, String acNoCode_4, String acNoCode_5, String acSubCode_6, String acSubCode_7,
			String acDtlCode_8, String acDtlCode_9, int index, int limit, TitaVo... titaVo) {
		String dbName = "";
		Slice<AcMain> slice = null;
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("acmainAcCodeRange " + dbName + " : " + "acBookCode_0 : " + acBookCode_0 + " branchNo_1 : " + branchNo_1 + " currencyCode_2 : " + currencyCode_2 + " acDate_3 : " + acDate_3
				+ " acNoCode_4 : " + acNoCode_4 + " acNoCode_5 : " + acNoCode_5 + " acSubCode_6 : " + acSubCode_6 + " acSubCode_7 : " + acSubCode_7 + " acDtlCode_8 : " + acDtlCode_8
				+ " acDtlCode_9 : " + acDtlCode_9);
		if (dbName.equals(ContentName.onDay))
			slice = acMainReposDay
					.(
							acBookCode_0, branchNo_1, currencyCode_2, acDate_3, acNoCode_4, acNoCode_5, acSubCode_6, acSubCode_7, acDtlCode_8, acDtlCode_9, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = acMainReposMon
					.(
							acBookCode_0, branchNo_1, currencyCode_2, acDate_3, acNoCode_4, acNoCode_5, acSubCode_6, acSubCode_7, acDtlCode_8, acDtlCode_9, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = acMainReposHist
					.(
							acBookCode_0, branchNo_1, currencyCode_2, acDate_3, acNoCode_4, acNoCode_5, acSubCode_6, acSubCode_7, acDtlCode_8, acDtlCode_9, pageable);
		else
			slice = acMainRepos
	...
	@Override
	public Slice<AcMain> acmainAcBookCodeRange(String acBookCode_0, String acSubBookCode_1, String branchNo_2, String currencyCode_3, String acNoCode_4, String acSubCode_5, String acDtlCode_6,
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("acmainAcBookCodeRange " + dbName + " : " + "acBookCode_0 : " + acBookCode_0 + " acSubBookCode_1 : " + acSubBookCode_1 + " branchNo_2 : " + branchNo_2 + " currencyCode_3 : "
	...
	@Override
	public Slice<AcMain> acmainAcBookCodeRange2(String acBookCode_0, String acSubBookCode_1, String branchNo_2, String currencyCode_3, String acNoCode_4, String acSubCode_5, int acDate_6,
			int acDate_7, int index, int limit, TitaVo... titaVo) {
		String dbName = "";
		Slice<AcMain> slice = null;
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("acmainAcBookCodeRange2 " + dbName + " : " + "acBookCode_0 : " + acBookCode_0 + " acSubBookCode_1 : " + acSubBookCode_1 + " branchNo_2 : " + branchNo_2 + " currencyCode_3 : "
