...
public class HlAreaLnYg6PtServiceImpl extends ASpringJpaParm implements HlAreaLnYg6PtService, InitializingBean {
	...
	public Slice<HlAreaLnYg6Pt> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by(Sort.Direction.ASC, "WorkYM", "AreaCode"));
		else
			pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "WorkYM", "AreaCode"));
	...
	@Override
	public Slice<HlAreaLnYg6Pt> findCalDate(int calDate_0, int index, int limit, TitaVo... titaVo) {
		String dbName = "";
		Slice<HlAreaLnYg6Pt> slice = null;
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		...
		this.info("findCalDate " + dbName + " : " + "calDate_0 : " + calDate_0);
		if (dbName.equals(ContentName.onDay))
			slice = hlAreaLnYg6PtReposDay.findAllByCalDateIs(calDate_0, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = hlAreaLnYg6PtReposMon.findAllByCalDateIs(calDate_0, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = hlAreaLnYg6PtReposHist.findAllByCalDateIs(calDate_0, pageable);
		else
			slice = hlAreaLnYg6PtRepos.findAllByCalDateIs(calDate_0, pageable);
	...
	public HlAreaLnYg6Pt insert(HlAreaLnYg6Pt hlAreaLnYg6Pt, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(hlAreaLnYg6Pt.getHlAreaLnYg6PtId(), titaVo) != null)
