...
public class LP005ServiceImpl extends ASpringJpaParm implements InitializingBean {
	...
	public List<Map<String, String>> queryDept(int pfYear, int pfSeason, String inputDeptCode, int effectiveDateS,
			int effectiveDateE, TitaVo titaVo) {
		...
		sql += "  LEFT JOIN \"PfItDetail\" PI ON PI.\"CustNo\" = PR.\"CustNo\" ";
		sql += "                             AND PI.\"RepayType\" = 0 ";
		sql += "                             AND PI.\"WorkSeason\" = :inputWorkSeason ";
