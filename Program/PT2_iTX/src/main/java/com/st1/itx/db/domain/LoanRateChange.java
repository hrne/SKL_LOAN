...
public class LoanRateChange implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = 849916822642441725L;
...
@EmbeddedId
  ...
  // 狀態
  /* 0:一般利率1:批次新增利率2:階梯利率 */
  @Column(name = "`Status`")
  private int status = 0;

  // 利率區分
  /* 共用代碼檔1:機動 2:固動 3:定期機動同撥款主檔指數型階梯式利率的固定利率與撥款主檔不同(ex.中華郵政二年期定儲機動利率) */
  ...
  // 指標利率代碼
  /* 共用代碼檔01:保單分紅利率02:中華郵政二年期定儲機動利率99:自訂利率階梯式利率時可能與主檔不同 */
...
/**
  ...
  * @param otherFields JsonFields
  ...
  public String toString() {
    return "LoanRateChange [loanRateChangeId=" + loanRateChangeId + ", status=" + status + ", rateCode=" + rateCode
           + ", prodNo=" + prodNo + ", baseRateCode=" + baseRateCode + ", incrFlag=" + incrFlag + ", rateIncr=" + rateIncr + ", individualIncr=" + individualIncr + ", fitRate=" + fitRate
           + ", remark=" + remark + ", acDate=" + acDate + ", tellerNo=" + tellerNo + ", txtNo=" + txtNo + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
           + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + ", otherFields=" + otherFields + "]";
  }
}
