...
public class LoanCheque implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7778593106924986481L;
	...
	// 交換區號
	/*
	 * 共用代碼檔01: 總所03: 台中市分所04: 台南市分所05: 高雄市分所07: 桃園縣分所08: 新竹市分所09: 苗栗縣分所11: 南投縣分所13:
	 * 雲林縣分所14: 嘉義市分所15: 台南縣分所17: 屏東縣分所18: 宜蘭縣分所19: 花蓮縣分所20: 台東縣分所21: 澎湖縣分所
	 */
	...
	/**
	 * 票據狀況碼<br>
	 * 共用代碼檔 0: 未處理 1: 兌現入帳 2: 退票 3: 抽票 4: 兌現未入帳 5: 即期票
	 * 
	 * @return String
	 */
	...
	/**
	 * 交換區號<br>
	 * 共用代碼檔 01: 總所 03: 台中市分所 04: 台南市分所 05: 高雄市分所 07: 桃園縣分所 08: 新竹市分所 09: 苗栗縣分所 11:
	 * 南投縣分所 13: 雲林縣分所 14: 嘉義市分所 15: 台南縣分所 17: 屏東縣分所 18: 宜蘭縣分所 19: 花蓮縣分所 20: 台東縣分所
	 * 21: 澎湖縣分所
	 * 
	 * @return String
	 */
	...
	/**
	 * 支票用途<br>
	 * 共用代碼檔 01:期款 02:部分償還 03:結案 04:帳管費 05:火險費 06:契變手續費 07:法務費 09:其他
	 * 
	 * @return String
	 */
	...
	/**
	 * 服務中心別<br>
	 * 共用代碼檔 A:建北 B:台中 D:台南 E:高雄 F:板橋 H:桃園 N:彰化 Y:站前
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "LoanCheque [loanChequeId=" + loanChequeId + ", custNo=" + custNo + ", statusCode=" + statusCode + ", processCode=" + processCode + ", acDate=" + acDate + ", kinbr=" + kinbr
				+ ", tellerNo=" + tellerNo + ", txtNo=" + txtNo + ", receiveDate=" + receiveDate + ", entryDate=" + entryDate + ", currencyCode=" + currencyCode + ", chequeAmt=" + chequeAmt
				+ ", chequeName=" + chequeName + ", chequeDate=" + chequeDate + ", areaCode=" + areaCode + ", bankCode=" + bankCode + ", outsideCode=" + outsideCode + ", bktwFlag=" + bktwFlag
				+ ", tsibFlag=" + tsibFlag + ", mediaFlag=" + mediaFlag + ", usageCode=" + usageCode + ", serviceCenter=" + serviceCenter + ", creditorId=" + creditorId + ", creditorBankCode="
				+ creditorBankCode + ", otherAcctCode=" + otherAcctCode + ", receiptNo=" + receiptNo + ", repaidAmt=" + repaidAmt + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
