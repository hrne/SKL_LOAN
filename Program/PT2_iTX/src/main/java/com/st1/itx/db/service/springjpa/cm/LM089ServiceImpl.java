...
@Service
@Repository
public class LM089ServiceImpl extends ASpringJpaParm implements InitializingBean {
	...
	public List<Map<String, String>> findAll(TitaVo titaVo, int RptMonth) throws Exception {
		this.info("LM089.findAll ");
		this.info("LM089ServiceImpl RptMonth: " + RptMonth);

		String ruleCode = "'B049%'";
...
//		sql += "                                      Lm.\"BormNo\" = Fac.\"LastBormNo\"";
		...
		sql += "         , MAX(\"ApproveRate\")                                                     AS \"maxRate\"";
		sql += "         , MIN(\"ApproveRate\")                                                     AS \"minRate\"";
		sql += "    FROM \"Tmp\"";
