...
/**
  ...
  * @param actualFilingMark 實際報送記號
  ...
  public String toString() {
    return "JcicZ573 [jcicZ573Id=" + jcicZ573Id + ", tranKey=" + tranKey + ", payAmt=" + payAmt
           + ", totalPayAmt=" + totalPayAmt + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
