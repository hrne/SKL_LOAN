...
@Table(name = "`JcicZ573`")
public class JcicZ573 implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3666825720951346208L;

	@EmbeddedId
	private JcicZ573Id jcicZ573Id;
	...
	public JcicZ573Id getJcicZ573Id() {
		return this.jcicZ573Id;
	}

	public void setJcicZ573Id(JcicZ573Id jcicZ573Id) {
		this.jcicZ573Id = jcicZ573Id;
	}
	...
	public String toString() {
		return "JcicZ573 [jcicZ573Id=" + jcicZ573Id + ", tranKey=" + tranKey + ", payAmt=" + payAmt + ", totalPayAmt=" + totalPayAmt + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey
