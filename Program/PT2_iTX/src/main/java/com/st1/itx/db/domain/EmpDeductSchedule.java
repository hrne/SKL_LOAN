...
public class EmpDeductSchedule implements Serializable {
	...
	// 流程別
	/*
	 * 同CdEmp.AgType1制度別(3、4：15日薪)；流程別對應之扣薪種類，建立於CdCode(EmpDeductType)，1:15日薪-12個月2:
	 * 非15日薪-13個工作月
	 */
	...
	/**
	 * 流程別<br>
	 * 同CdEmp.AgType1制度別(3、4：15日薪)； 流程別對應之扣薪種類，建立於CdCode(EmpDeductType)， 1:15日薪-12個月
	 * 2:非15日薪-13個工作月
	 * 
	 * @return String
	 */
	...
	/**
	 * 應繳截止日<br>
	 * 2022-03-11新增 原系統有此欄位 TBYGYMP.YGEPDT
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "EmpDeductSchedule [empDeductScheduleId=" + empDeductScheduleId + ", entryDate=" + entryDate + ", mediaDate=" + mediaDate + ", repayEndDate=" + repayEndDate + ", createDate="
