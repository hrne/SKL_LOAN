 ...
 * @version 1.0.0
 */
public interface ClBuildingReasonRepositoryMon extends JpaRepository<ClBuildingReason, ClBuildingReasonId> {

  // ClCode1 = ,AND ClCode2 = ,AND ClNo = 
  public Optional<ClBuildingReason> findTopByClCode1IsAndClCode2IsAndClNoIsOrderByClCode1AscClCode2AscClNoAsc(int clCode1_0, int clCode2_1, int clNo_2);
