...
@Table(name = "`MonthlyLM014B`")
public class MonthlyLM014B implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1631546458802390190L;

	@EmbeddedId
	private MonthlyLM014BId monthlyLM014BId;
	...
	@Column(name = "`EntCode`", length = 1, insertable = false, updatable = false)
	...
	public MonthlyLM014BId getMonthlyLM014BId() {
		return this.monthlyLM014BId;
	}

	public void setMonthlyLM014BId(MonthlyLM014BId monthlyLM014BId) {
		this.monthlyLM014BId = monthlyLM014BId;
	}
	...
	public String toString() {
		return "MonthlyLM014B [monthlyLM014BId=" + monthlyLM014BId + ", monthLoanIns=" + monthLoanIns + ", monthLoanBal=" + monthLoanBal + ", yearLoanIns=" + yearLoanIns + ", yearLoanBal="
