...
em = null;
  ...
  public Slice<FacClose> findAll(int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by(Sort.Direction.ASC, "ApplDate", "CloseNo"));
    else
         pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "ApplDate", "CloseNo"));
  ...
  public Slice<FacClose> findCloseNo(int closeDate_0, int closeNo_1, int closeNo_2, int carLoan_3, int carLoan_4, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("findCloseNo " + dbName + " : " + "closeDate_0 : " + closeDate_0 + " closeNo_1 : " +  closeNo_1 + " closeNo_2 : " +  closeNo_2 + " carLoan_3 : " +  carLoan_3 + " carLoan_4 : " +  carLoan_4);
    if (dbName.equals(ContentName.onDay))
      slice = facCloseReposDay.findAllByCloseDateIsAndCloseNoGreaterThanEqualAndCloseNoLessThanEqualAndCarLoanGreaterThanEqualAndCarLoanLessThanEqualOrderByCustNoAscFacmNoAscCloseDateAsc(closeDate_0, closeNo_1, closeNo_2, carLoan_3, carLoan_4, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = facCloseReposMon.findAllByCloseDateIsAndCloseNoGreaterThanEqualAndCloseNoLessThanEqualAndCarLoanGreaterThanEqualAndCarLoanLessThanEqualOrderByCustNoAscFacmNoAscCloseDateAsc(closeDate_0, closeNo_1, closeNo_2, carLoan_3, carLoan_4, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = facCloseReposHist.findAllByCloseDateIsAndCloseNoGreaterThanEqualAndCloseNoLessThanEqualAndCarLoanGreaterThanEqualAndCarLoanLessThanEqualOrderByCustNoAscFacmNoAscCloseDateAsc(closeDate_0, closeNo_1, closeNo_2, carLoan_3, carLoan_4, pageable);
    else 
      slice = facCloseRepos.findAllByCloseDateIsAndCloseNoGreaterThanEqualAndCloseNoLessThanEqualAndCarLoanGreaterThanEqualAndCarLoanLessThanEqualOrderByCustNoAscFacmNoAscCloseDateAsc(closeDate_0, closeNo_1, closeNo_2, carLoan_3, carLoan_4, pageable);
  ...
  public Slice<FacClose> findCustNoRange(int custNo_0, int custNo_1, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("findCustNoRange " + dbName + " : " + "custNo_0 : " + custNo_0 + " custNo_1 : " +  custNo_1);
    if (dbName.equals(ContentName.onDay))
      slice = facCloseReposDay.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAscCloseNoAscCloseDateAsc(custNo_0, custNo_1, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = facCloseReposMon.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAscCloseNoAscCloseDateAsc(custNo_0, custNo_1, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = facCloseReposHist.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAscCloseNoAscCloseDateAsc(custNo_0, custNo_1, pageable);
    else 
      slice = facCloseRepos.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscFacmNoAscCloseNoAscCloseDateAsc(custNo_0, custNo_1, pageable);
  ...
  public FacClose findLastCloseNoFirst(int applDate_0, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("findLastCloseNoFirst " + dbName + " : " + "applDate_0 : " + applDate_0);
    Optional<FacClose> facCloseT = null;
    if (dbName.equals(ContentName.onDay))
      facCloseT = facCloseReposDay.findTopByApplDateIsOrderByCloseNoDesc(applDate_0);
    else if (dbName.equals(ContentName.onMon))
      facCloseT = facCloseReposMon.findTopByApplDateIsOrderByCloseNoDesc(applDate_0);
    else if (dbName.equals(ContentName.onHist))
      facCloseT = facCloseReposHist.findTopByApplDateIsOrderByCloseNoDesc(applDate_0);
    else 
      facCloseT = facCloseRepos.findTopByApplDateIsOrderByCloseNoDesc(applDate_0);
  ...
  public FacClose insert(FacClose facClose, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(facClose.getFacCloseId(), titaVo) != null)
