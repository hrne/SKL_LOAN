...
public interface AcMainService {
	...
	/**
	 * AcBookCode = ,AND BranchNo = ,AND CurrencyCode = ,AND AcNoCode = ,AND
	 * AcSubCode = ,AND AcDtlCode = ,AND AcDate &gt;= ,AND AcDate &lt;=
	 *
	...
	/**
	 * AcBookCode = ,AND BranchNo = ,AND CurrencyCode = ,AND AcDate = ,AND AcNoCode
	 * &gt;= ,AND AcNoCode &lt;= ,AND AcSubCode &gt;= ,AND AcSubCode &lt;= ,AND
	 * AcDtlCode &gt;= ,AND AcDtlCode &lt;=
	 *
	 * @param acBookCode_0   acBookCode_0
	 * @param branchNo_1     branchNo_1
	 * @param currencyCode_2 currencyCode_2
