...
public class InsuOrignal implements Serializable {
	...
	public String toString() {
		return "InsuOrignal [insuOrignalId=" + insuOrignalId + ", insuCompany=" + insuCompany + ", insuTypeCode=" + insuTypeCode + ", fireInsuCovrg=" + fireInsuCovrg + ", ethqInsuCovrg="
				+ ethqInsuCovrg + ", fireInsuPrem=" + fireInsuPrem + ", ethqInsuPrem=" + ethqInsuPrem + ", insuStartDate=" + insuStartDate + ", insuEndDate=" + insuEndDate + ", commericalFlag="
				+ commericalFlag + ", remark=" + remark + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
