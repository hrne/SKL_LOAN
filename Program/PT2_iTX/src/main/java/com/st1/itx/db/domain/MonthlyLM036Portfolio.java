...
// 資料年月
	...
	public String toString() {
		return "MonthlyLM036Portfolio [dataMonth=" + dataMonth + ", monthEndDate=" + monthEndDate + ", portfolioTotal=" + portfolioTotal + ", naturalPersonLoanBal=" + naturalPersonLoanBal
				+ ", legalPersonLoanBal=" + legalPersonLoanBal + ", syndLoanBal=" + syndLoanBal + ", stockLoanBal=" + stockLoanBal + ", otherLoanbal=" + otherLoanbal + ", amortizeTotal="
				+ amortizeTotal + ", ovduExpense=" + ovduExpense + ", naturalPersonLargeCounts=" + naturalPersonLargeCounts + ", naturalPersonLargeTotal=" + naturalPersonLargeTotal
				+ ", legalPersonLargeCounts=" + legalPersonLargeCounts + ", legalPersonLargeTotal=" + legalPersonLargeTotal + ", naturalPersonPercent=" + naturalPersonPercent + ", legalPersonPercent="
				+ legalPersonPercent + ", syndPercent=" + syndPercent + ", stockPercent=" + stockPercent + ", otherPercent=" + otherPercent + ", entUsedPercent=" + entUsedPercent
				+ ", insuDividendRate=" + insuDividendRate + ", naturalPersonRate=" + naturalPersonRate + ", legalPersonRate=" + legalPersonRate + ", syndRate=" + syndRate + ", stockRate=" + stockRate
				+ ", otherRate=" + otherRate + ", avgRate=" + avgRate + ", houseRateOfReturn=" + houseRateOfReturn + ", entRateOfReturn=" + entRateOfReturn + ", rateOfReturn=" + rateOfReturn
