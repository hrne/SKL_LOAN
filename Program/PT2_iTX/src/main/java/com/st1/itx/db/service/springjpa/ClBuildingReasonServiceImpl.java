...
public class ClBuildingReasonServiceImpl extends ASpringJpaParm implements ClBuildingReasonService, InitializingBean {
	...
	public ClBuildingReason clNoFirst(int clCode1_0, int clCode2_1, int clNo_2, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			clBuildingReasonT = clBuildingReasonReposDay.findTopByClCode1IsAndClCode2IsAndClNoIsOrderByClCode1AscClCode2AscClNoAsc(clCode1_0, clCode2_1, clNo_2);
		else if (dbName.equals(ContentName.onMon))
			clBuildingReasonT = clBuildingReasonReposMon.findTopByClCode1IsAndClCode2IsAndClNoIsOrderByClCode1AscClCode2AscClNoAsc(clCode1_0, clCode2_1, clNo_2);
		else if (dbName.equals(ContentName.onHist))
			clBuildingReasonT = clBuildingReasonReposHist.findTopByClCode1IsAndClCode2IsAndClNoIsOrderByClCode1AscClCode2AscClNoAsc(clCode1_0, clCode2_1, clNo_2);
		else
			clBuildingReasonT = clBuildingReasonRepos.findTopByClCode1IsAndClCode2IsAndClNoIsOrderByClCode1AscClCode2AscClNoAsc(clCode1_0, clCode2_1, clNo_2);
	...
	public ClBuildingReason insert(ClBuildingReason clBuildingReason, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(clBuildingReason.getClBuildingReasonId(), titaVo) != null)
