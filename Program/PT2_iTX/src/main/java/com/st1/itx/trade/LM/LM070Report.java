...
public class LM070Report extends MakeReport {
	...
	public boolean exec(TitaVo titaVo) throws LogicException {
		...
		String txcd = "LM070";
		String fileItem = "介紹人加碼獎勵津貼明細";
		String fileName = "LM070介紹人加碼獎勵津貼明細";
		String defaultExcel = "LM070_底稿_介紹人加碼獎勵津貼明細.xlsx";
		String defaultSheet = "Q2573_13";
	...
	private boolean excelQ2573_23(TitaVo titaVo) throws LogicException {
		...
		if (fnAllList.size() > 0) {
			...
			for (Map<String, String> tLDVo : fnAllList) {
				...
				//F19 業務報酬
				makeExcel.setValue(row,20, tLDVo.get("F17"));
				//F20 核發獎金
