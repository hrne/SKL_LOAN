...
public class FinReportDebt implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = 7631212387981252913L;
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "FinReportDebt [finReportDebtId=" + finReportDebtId + ", startYY=" + startYY + ", startMM=" + startMM + ", endYY=" + endYY + ", endMM=" + endMM
           + ", assetTotal=" + assetTotal + ", flowAsset=" + flowAsset + ", cash=" + cash + ", finAsset=" + finAsset + ", receiveTicket=" + receiveTicket + ", receiveAccount=" + receiveAccount
           + ", receiveRelation=" + receiveRelation + ", otherReceive=" + otherReceive + ", stock=" + stock + ", prepayItem=" + prepayItem + ", otherFlowAsset=" + otherFlowAsset + ", accountItem01=" + accountItem01
           + ", accountItem02=" + accountItem02 + ", accountItem03=" + accountItem03 + ", accountValue01=" + accountValue01 + ", accountValue02=" + accountValue02 + ", accountValue03=" + accountValue03 + ", longInvest=" + longInvest
           + ", fixedAsset=" + fixedAsset + ", land=" + land + ", houseBuild=" + houseBuild + ", machineEquip=" + machineEquip + ", otherEquip=" + otherEquip + ", prepayEquip=" + prepayEquip
           + ", unFinish=" + unFinish + ", depreciation=" + depreciation + ", invisibleAsset=" + invisibleAsset + ", otherAsset=" + otherAsset + ", accountItem04=" + accountItem04 + ", accountItem05=" + accountItem05
           + ", accountItem06=" + accountItem06 + ", accountValue04=" + accountValue04 + ", accountValue05=" + accountValue05 + ", accountValue06=" + accountValue06 + ", debtNetTotal=" + debtNetTotal + ", flowDebt=" + flowDebt
           + ", shortLoan=" + shortLoan + ", payShortTicket=" + payShortTicket + ", payTicket=" + payTicket + ", payAccount=" + payAccount + ", payRelation=" + payRelation + ", otherPay=" + otherPay
           + ", preReceiveItem=" + preReceiveItem + ", longDebtOneYear=" + longDebtOneYear + ", shareholder=" + shareholder + ", otherFlowDebt=" + otherFlowDebt + ", accountItem07=" + accountItem07 + ", accountItem08=" + accountItem08
           + ", accountItem09=" + accountItem09 + ", accountValue07=" + accountValue07 + ", accountValue08=" + accountValue08 + ", accountValue09=" + accountValue09 + ", longDebt=" + longDebt + ", otherDebt=" + otherDebt
           + ", debtTotal=" + debtTotal + ", netValue=" + netValue + ", capital=" + capital + ", capitalSurplus=" + capitalSurplus + ", retainProfit=" + retainProfit + ", otherRight=" + otherRight
           + ", treasuryStock=" + treasuryStock + ", unControlRight=" + unControlRight + ", accountItem10=" + accountItem10 + ", accountItem11=" + accountItem11 + ", accountValue10=" + accountValue10 + ", accountValue11=" + accountValue11
