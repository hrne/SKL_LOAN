 ...
 * @version 1.0.0
 */
public interface CdBaseRateRepositoryMon extends JpaRepository<CdBaseRate, CdBaseRateId> {

	// CurrencyCode = ,AND BaseRateCode = ,AND EffectDate >= ,AND EffectDate <=
	public Slice<CdBaseRate> findAllByCurrencyCodeIsAndBaseRateCodeIsAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByEffectDateAsc(String currencyCode_0, String baseRateCode_1,
			int effectDate_2, int effectDate_3, Pageable pageable);

	// CurrencyCode = ,AND BaseRateCode = ,AND EffectDate >= ,AND EffectDate <=
	public Optional<CdBaseRate> findTopByCurrencyCodeIsAndBaseRateCodeIsAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByEffectDateDesc(String currencyCode_0, String baseRateCode_1,
			int effectDate_2, int effectDate_3);

	// CurrencyCode = ,AND BaseRateCode = ,AND EffectDate >= ,AND EffectDate <=
	public Optional<CdBaseRate> findTopByCurrencyCodeIsAndBaseRateCodeIsAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByEffectDateAsc(String currencyCode_0, String baseRateCode_1,
			int effectDate_2, int effectDate_3);

	// CurrencyCode = ,AND BaseRateCode >= ,AND BaseRateCode <= ,AND EffectDate >=
	// ,AND EffectDate <=
	...
	public Slice<CdBaseRate> findAllByCurrencyCodeIsAndBaseRateCodeIsAndEffectFlagIsAndEffectDateGreaterThanEqualOrderByEffectDateAsc(String currencyCode_0, String baseRateCode_1, int effectFlag_2,
			int effectDate_3, Pageable pageable);
