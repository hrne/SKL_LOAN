...
public class CdLandOffice implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -41959443512202074L;
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "CdLandOffice [cdLandOfficeId=" + cdLandOfficeId + ", recWordItem=" + recWordItem + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
