...
//				+ "order by a.\"WorkMonth\" asc , b.\"DrawdownDate\" asc ,a.\"CustNo\" asc ,a.\"FacmNo\" asc ,a.\"BormNo\" asc ";
		...
		String sql = "select a.\"WorkMonth\"," + "a.\"DrawdownDate\"," + "a.\"CustNo\"," + "a.\"FacmNo\"," + "a.\"BormNo\"," + "a.\"DrawdownAmt\"," + "a.\"ProdCode\"," + "d.\"ProdName\","
				+ "a.\"PieceCode\"," + "a.\"BsOfficer\"," + "g.\"Fullname\"," + "b.\"LoanBal\" ," + "b.\"StoreRate\"," + "b.\"ApproveRate\" as \"LoanApproveRate\" ,"
				+ "b.\"RateIncr\" as \"LBMRateIncr\"," + "c.\"RegCityCode\"," + "e.\"ApproveRate\" as \"FacApproveRate\"," + "r2.\"FitRate\"," + "r2.\"IncrFlag\","
				+ "r2.\"RateIncr\" as \"LRCRateIncr\"," + "r2.\"IndividualIncr\"," + "g.\"DeptCode\"" + " from \"PfBsDetail\" a"
				+ " left join \"LoanBorMain\" b on a.\"CustNo\" = b.\"CustNo\" and a.\"FacmNo\" = b.\"FacmNo\" and a.\"BormNo\" = b.\"BormNo\""
				+ " left join \"FacProd\" d on a.\"ProdCode\" = d.\"ProdNo\"" + " left join \"PfBsOfficer\" g on a.\"BsOfficer\" = g.\"EmpNo\" and a.\"WorkMonth\" = g.\"WorkMonth\""
				+ " left join \"CustMain\" c on c.\"CustNo\" = a.\"CustNo\"" + " left join \"FacMain\" e on e.\"CustNo\" = a.\"CustNo\" and e.\"FacmNo\" = a.\"FacmNo\"" + "left join ("
				+ "				select rb.\"CustNo\"," + "				rb.\"FacmNo\"," + "				rb.\"BormNo\"," + "				rb.\"FitRate\"," + "				rb.\"EffectDate\","
				+ "				rb.\"IncrFlag\"," + "				rb.\"RateIncr\"," + "             rb.\"IndividualIncr\","
				+ "				row_number() over (partition by rb.\"CustNo\", rb.\"FacmNo\", rb.\"BormNo\" order by rb.\"EffectDate\" Desc) as seq" + "             from \"LoanRateChange\" rb"
				+ "          ) r2 on r2.\"CustNo\" = a.\"CustNo\" and r2.\"FacmNo\" = a.\"FacmNo\" and r2.\"BormNo\" = a.\"BormNo\" and r2.seq = 1 "
				+ " where a.\"DrawdownDate\" between :StartDate and :EndDate and \"RepayType\" = '0' " + " order by a.\"WorkMonth\" ,a.\"DrawdownDate\" asc ";
