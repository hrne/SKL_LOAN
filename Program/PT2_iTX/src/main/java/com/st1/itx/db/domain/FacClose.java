...
@EmbeddedId
  ...
  // 申請日期
  /* 日曆日 */
  @Column(name = "`ApplDate`", insertable = false, updatable = false)
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "FacClose [facCloseId=" + facCloseId + ", custNo=" + custNo + ", facmNo=" + facmNo + ", actFlag=" + actFlag + ", funCode=" + funCode
           + ", carLoan=" + carLoan + ", closeDate=" + closeDate + ", closeInd=" + closeInd + ", closeReasonCode=" + closeReasonCode + ", closeAmt=" + closeAmt + ", collectFlag=" + collectFlag
