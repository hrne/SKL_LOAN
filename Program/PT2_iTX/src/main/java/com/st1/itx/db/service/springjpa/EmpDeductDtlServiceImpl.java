...
public class EmpDeductDtlServiceImpl extends ASpringJpaParm implements EmpDeductDtlService, InitializingBean {
	...
	public Slice<EmpDeductDtl> entryDateRng(int entryDate_1, int entryDate_2, List<String> procCode_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = empDeductDtlReposDay.findAllByErrMsgIsNullAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndProcCodeInOrderByEntryDateAscCustNoAscAchRepayCodeDesc(entryDate_1, entryDate_2,
					procCode_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = empDeductDtlReposMon.findAllByErrMsgIsNullAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndProcCodeInOrderByEntryDateAscCustNoAscAchRepayCodeDesc(entryDate_1, entryDate_2,
					procCode_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = empDeductDtlReposHist.findAllByErrMsgIsNullAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndProcCodeInOrderByEntryDateAscCustNoAscAchRepayCodeDesc(entryDate_1, entryDate_2,
					procCode_3, pageable);
		else
			slice = empDeductDtlRepos.findAllByErrMsgIsNullAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndProcCodeInOrderByEntryDateAscCustNoAscAchRepayCodeDesc(entryDate_1, entryDate_2,
					procCode_3, pageable);
