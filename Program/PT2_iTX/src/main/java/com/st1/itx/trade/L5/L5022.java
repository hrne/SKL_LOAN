...
import com.st1.itx.trade.LP.LP006Report;
...
public class L5022 extends TradeBuffer {
	...
	public ArrayList<TotaVo> run(TitaVo titaVo) throws LogicException {
		...
		if ("1".equals(titaVo.getParam("FunCd")) || "2".equals(titaVo.getParam("FunCd"))) {
			...
			try {
				l5022SqlReturn = l5022ServiceImpl.findByStatus(cDate, iEffectiveDateS, iEffectiveDateE, iEmpNo,
						iStatusFg, this.index, this.limit, titaVo);
			} catch (Exception e) {
