...
public class JcicZ043 implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3830727829486173993L;
	...
	public String toString() {
		return "JcicZ043 [jcicZ043Id=" + jcicZ043Id + ", tranKey=" + tranKey + ", collateralType=" + collateralType + ", originLoanAmt=" + originLoanAmt + ", creditBalance=" + creditBalance
				+ ", perPeriordAmt=" + perPeriordAmt + ", lastPayAmt=" + lastPayAmt + ", lastPayDate=" + lastPayDate + ", outstandAmt=" + outstandAmt + ", repayPerMonDay=" + repayPerMonDay
				+ ", contractStartYM=" + contractStartYM + ", contractEndYM=" + contractEndYM + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey + ", createDate=" + createDate
				+ ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + ", actualFilingDate=" + actualFilingDate + ", actualFilingMark="
				+ actualFilingMark + "]";
	}
}
