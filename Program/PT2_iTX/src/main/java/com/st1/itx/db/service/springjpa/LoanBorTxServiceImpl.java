...
em = null;
  ...
  public Slice<LoanBorTx> borxAcDateRange(int custNo_0, int facmNo_1, int facmNo_2, int bormNo_3, int bormNo_4, int acDate_5, int acDate_6, List<String> displayflag_7, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      slice = loanBorTxReposDay.(custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, acDate_5, acDate_6, displayflag_7, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = loanBorTxReposMon.(custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, acDate_5, acDate_6, displayflag_7, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = loanBorTxReposHist.(custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, acDate_5, acDate_6, displayflag_7, pageable);
    else 
  ...
  public Slice<LoanBorTx> borxEntryDateRange(int custNo_0, int facmNo_1, int facmNo_2, int bormNo_3, int bormNo_4, int entryDate_5, int entryDate_6, List<String> displayflag_7, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      slice = loanBorTxReposDay.(custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, entryDate_5, entryDate_6, displayflag_7, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = loanBorTxReposMon.(custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, entryDate_5, entryDate_6, displayflag_7, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = loanBorTxReposHist.(custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, entryDate_5, entryDate_6, displayflag_7, pageable);
    else 
      slice = loanBorTxRepos.(custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, entryDate_5, entryDate_6, displayflag_7, pageable);
