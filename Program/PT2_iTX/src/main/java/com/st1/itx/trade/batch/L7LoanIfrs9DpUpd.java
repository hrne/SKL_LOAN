...
@Service("L7LoanIfrs9DpUpd")
@Scope("step")
/**
 * (每月日終批次)維護 LoanIfrs9Dp 每月IFRS9欄位清單D檔
 *
 * @author Chih Wei
 * @version 1.0.0
 */
public class L7LoanIfrs9DpUpd extends BatchBase implements Tasklet, InitializingBean {
	...
	public void run() throws LogicException {
		this.info("active L7LoanIfrs9DpUpd ");
		...
		this.info("active L7LoanIfrs9DpUpd tbsdyf=" + tbsdyf);
		this.info("active L7LoanIfrs9DpUpd empNo =" + empNo);
...
//		this.titaVo.putParam(ContentName.dataBase, ContentName.onLine);
		...
		sJobMainService.Usp_L7_LoanIfrs9Dp_Upd(tbsdyf, empNo, newAcFg, txSeq, titaVo);
	}
