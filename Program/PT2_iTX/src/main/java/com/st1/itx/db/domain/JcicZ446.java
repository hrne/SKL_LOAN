...
public class JcicZ446 implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6739601082296468001L;
	...
	public String toString() {
		return "JcicZ446 [jcicZ446Id=" + jcicZ446Id + ", tranKey=" + tranKey + ", closeCode=" + closeCode + ", closeDate=" + closeDate + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey
