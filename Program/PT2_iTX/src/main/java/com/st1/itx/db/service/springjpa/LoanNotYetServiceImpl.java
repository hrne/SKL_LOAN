...
em = null;
  ...
  public Slice<LoanNotYet> notYetCustNoEq(int custNo_0, int facmNo_1, int facmNo_2, int yetDate_3, int yetDate_4, int closeDate_5, int closeDate_6, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      ...
      slice = loanNotYetReposMon.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndYetDateGreaterThanEqualAndYetDateLessThanEqualAndCloseDateGreaterThanEqualAndCloseDateLessThanEqualOrderByCustNoAscFacmNoAscNotYetCodeAsc(custNo_0, facmNo_1, facmNo_2, yetDate_3, yetDate_4, closeDate_5, closeDate_6, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = loanNotYetReposHist.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndYetDateGreaterThanEqualAndYetDateLessThanEqualAndCloseDateGreaterThanEqualAndCloseDateLessThanEqualOrderByCustNoAscFacmNoAscNotYetCodeAsc(custNo_0, facmNo_1, facmNo_2, yetDate_3, yetDate_4, closeDate_5, closeDate_6, pageable);
    else 
      slice = loanNotYetRepos.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndYetDateGreaterThanEqualAndYetDateLessThanEqualAndCloseDateGreaterThanEqualAndCloseDateLessThanEqualOrderByCustNoAscFacmNoAscNotYetCodeAsc(custNo_0, facmNo_1, facmNo_2, yetDate_3, yetDate_4, closeDate_5, closeDate_6, pageable);
  ...
  public LoanNotYet insert(LoanNotYet loanNotYet, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(loanNotYet.getLoanNotYetId(), titaVo) != null)
