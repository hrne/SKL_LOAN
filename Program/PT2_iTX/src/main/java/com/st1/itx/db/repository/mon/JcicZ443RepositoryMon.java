...
public interface JcicZ443RepositoryMon extends JpaRepository<JcicZ443, JcicZ443Id> {
  ...
  public Slice<JcicZ443> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
