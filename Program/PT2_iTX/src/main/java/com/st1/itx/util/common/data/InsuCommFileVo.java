...
//			13      0.65  
	...
	// 明細資料容器
	private List<OccursList> listOfOccursList = new ArrayList<>();
...
//					不符合Case1、Case2、Case3的則為0
			...
			this.listOfOccursList.add(occursList);
		}
	}
	...
	public ArrayList<String> toFile() {
		...
		// 組明細
		for (OccursList occursList : listOfOccursList) {
...
//			ColumnH			H		X	1	0
	...
	public List<OccursList> getOccursList() {
		return listOfOccursList;
	}

	public void setOccursList(List<OccursList> occursList) {
		this.listOfOccursList = occursList;
	}
