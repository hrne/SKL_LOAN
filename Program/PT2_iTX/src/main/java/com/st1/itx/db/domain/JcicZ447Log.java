...
public class JcicZ447Log implements Serializable {
	...
	public String toString() {
		return "JcicZ447Log [jcicZ447LogId=" + jcicZ447LogId + ", tranKey=" + tranKey + ", civil323Amt=" + civil323Amt + ", totalAmt=" + totalAmt + ", signDate=" + signDate + ", firstPayDate="
				+ firstPayDate + ", period=" + period + ", rate=" + rate + ", monthPayAmt=" + monthPayAmt + ", payAccount=" + payAccount + ", outJcicTxtDate=" + outJcicTxtDate + ", createDate="
