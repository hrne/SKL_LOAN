 ...
 * @version 1.0.0
 */
public class LM065 extends BatchBase implements Tasklet, InitializingBean {
	...
	public void run() throws LogicException {
		this.info("active LM065 ");
		lm065report.setTxBuffer(this.getTxBuffer());
		// 帳務日(西元)
		...
		lm065report.exec(titaVo, thisYM);
	}
}