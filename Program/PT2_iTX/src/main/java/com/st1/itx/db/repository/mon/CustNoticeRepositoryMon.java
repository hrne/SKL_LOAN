 ...
 * @version 1.0.0
 */
public interface CustNoticeRepositoryMon extends JpaRepository<CustNotice, CustNoticeId> {
	...
	// CustNo = ,AND FormNo =
	public Slice<CustNotice> findAllByCustNoIsAndFormNoIsOrderByFacmNoAsc(int custNo_0, String formNo_1, Pageable pageable);
