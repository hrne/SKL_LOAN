 ...
 * @version 1.0.0
 */
public interface JcicZ053RepositoryMon extends JpaRepository<JcicZ053, JcicZ053Id> {
  ...
  public Slice<JcicZ053> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
