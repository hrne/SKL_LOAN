...
@Service("L7LoanIfrs9ApUpd")
@Scope("step")
/**
 * (每月日終批次)維護 LoanIfrs9Ap 每月IFRS9欄位清單A檔
 *
 * @author Chih Wei
 * @version 1.0.0
 */
public class L7LoanIfrs9ApUpd extends BatchBase implements Tasklet, InitializingBean {
	...
	public void run() throws LogicException {
		this.info("active L7LoanIfrs9ApUpd ");
		...
		this.info("active L7LoanIfrs9ApUpd tbsdyf=" + tbsdyf);
		this.info("active L7LoanIfrs9ApUpd empNo =" + empNo);
...
//		this.titaVo.putParam(ContentName.dataBase, ContentName.onLine);
		...
		sJobMainService.Usp_L7_LoanIfrs9Ap_Upd(tbsdyf, empNo, newAcFg, txSeq, titaVo);
	}
