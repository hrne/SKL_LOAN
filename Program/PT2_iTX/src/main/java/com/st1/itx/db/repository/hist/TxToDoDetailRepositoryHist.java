 ...
 * @version 1.0.0
 */
public interface TxToDoDetailRepositoryHist extends JpaRepository<TxToDoDetail, TxToDoDetailId> {
  ...
  public Slice<TxToDoDetail> findAllByItemCodeIsAndDtlValueLikeOrderByStatusAscCustNoAscFacmNoAscBormNoAsc(String itemCode_0, String dtlValue_1, Pageable pageable);
