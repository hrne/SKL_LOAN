...
@Service("L9DailyTavIns")
@Scope("step")
/**
 * (日終批次)維護 DailyTav 每日暫收款餘額檔
 * 
 * @author Chih Wei
 * @version 1.0.0
 */
public class L9DailyTavIns extends BatchBase implements Tasklet, InitializingBean {
	...
	public void run() throws LogicException {
		this.info("active L9DailyTavIns ");
