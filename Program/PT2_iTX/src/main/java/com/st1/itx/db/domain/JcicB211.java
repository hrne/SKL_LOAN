...
public class JcicB211 implements Serializable {
	...
	// 交易代碼
	/*
	 * A 新增 C 異動 D刪除 ;1. 新增資料時填A;2. 修改非key值欄位值時填C; 3. 刪除原報送資料時填D;4.
	...
	public String toString() {
		return "JcicB211 [jcicB211Id=" + jcicB211Id + ", tranCode=" + tranCode + ", subTranCode=" + subTranCode + ", txAmt=" + txAmt + ", loanBal=" + loanBal + ", repayCode=" + repayCode
				...
				+ ", usageCode=" + usageCode + ", filler18=" + filler18 + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo="
				+ lastUpdateEmpNo + "]";
	}
}
