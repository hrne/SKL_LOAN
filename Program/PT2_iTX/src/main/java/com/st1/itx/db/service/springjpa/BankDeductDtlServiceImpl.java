...
em = null;
  ...
  @Override
  public Slice<BankDeductDtl> findTxSeq(int acDate_0, String titaTlrNo_1, String titaTxtNo_2, int index, int limit, TitaVo... titaVo) {
    String dbName = "";
    Slice<BankDeductDtl> slice = null;
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    ...
    if (dbName.equals(ContentName.onDay))
      slice = bankDeductDtlReposDay.findAllByAcDateIsAndTitaTlrNoIsAndTitaTxtNoIs(acDate_0, titaTlrNo_1, titaTxtNo_2, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = bankDeductDtlReposMon.findAllByAcDateIsAndTitaTlrNoIsAndTitaTxtNoIs(acDate_0, titaTlrNo_1, titaTxtNo_2, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = bankDeductDtlReposHist.findAllByAcDateIsAndTitaTlrNoIsAndTitaTxtNoIs(acDate_0, titaTlrNo_1, titaTxtNo_2, pageable);
    else 
      slice = bankDeductDtlRepos.findAllByAcDateIsAndTitaTlrNoIsAndTitaTxtNoIs(acDate_0, titaTlrNo_1, titaTxtNo_2, pageable);
  ...
  public BankDeductDtl insert(BankDeductDtl bankDeductDtl, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(bankDeductDtl.getBankDeductDtlId(), titaVo) != null)
