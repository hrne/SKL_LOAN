...
public class BankDeductDtlServiceImpl extends ASpringJpaParm implements BankDeductDtlService, InitializingBean {
	...
	public Slice<BankDeductDtl> repayBankEq(String repayBank_0, int entryDate_1, int entryDate_2, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = bankDeductDtlReposDay.findAllByRepayBankIsAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualOrderByCustNoAscFacmNoAscPayIntDateAscRepayTypeDesc(repayBank_0, entryDate_1,
					entryDate_2, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = bankDeductDtlReposMon.findAllByRepayBankIsAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualOrderByCustNoAscFacmNoAscPayIntDateAscRepayTypeDesc(repayBank_0, entryDate_1,
					entryDate_2, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = bankDeductDtlReposHist.findAllByRepayBankIsAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualOrderByCustNoAscFacmNoAscPayIntDateAscRepayTypeDesc(repayBank_0, entryDate_1,
					entryDate_2, pageable);
		else
			slice = bankDeductDtlRepos.findAllByRepayBankIsAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualOrderByCustNoAscFacmNoAscPayIntDateAscRepayTypeDesc(repayBank_0, entryDate_1,
					entryDate_2, pageable);
	...
	public Slice<BankDeductDtl> facmNoRange(int entryDate_0, int custNo_1, int facmNo_2, int repayType_3, int payIntDate_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("facmNoRange " + dbName + " : " + "entryDate_0 : " + entryDate_0 + " custNo_1 : " + custNo_1 + " facmNo_2 : " + facmNo_2 + " repayType_3 : " + repayType_3 + " payIntDate_4 : "
				+ payIntDate_4);
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<BankDeductDtl> repayBankNotEq(String repayBank_0, int entryDate_1, int entryDate_2, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = bankDeductDtlReposDay.findAllByRepayBankNotAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualOrderByCustNoAscFacmNoAscPayIntDateAscRepayTypeDesc(repayBank_0, entryDate_1,
					entryDate_2, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = bankDeductDtlReposMon.findAllByRepayBankNotAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualOrderByCustNoAscFacmNoAscPayIntDateAscRepayTypeDesc(repayBank_0, entryDate_1,
					entryDate_2, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = bankDeductDtlReposHist.findAllByRepayBankNotAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualOrderByCustNoAscFacmNoAscPayIntDateAscRepayTypeDesc(repayBank_0, entryDate_1,
					entryDate_2, pageable);
		else
			slice = bankDeductDtlRepos.findAllByRepayBankNotAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualOrderByCustNoAscFacmNoAscPayIntDateAscRepayTypeDesc(repayBank_0, entryDate_1,
					entryDate_2, pageable);
