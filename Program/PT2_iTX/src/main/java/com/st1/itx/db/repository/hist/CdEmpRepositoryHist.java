 ...
 * @version 1.0.0
 */
public interface CdEmpRepositoryHist extends JpaRepository<CdEmp, String> {
	...
	public Slice<CdEmp> findAllByEmployeeNoGreaterThanEqualAndEmployeeNoLessThanEqualAndAgStatusCodeIsOrderByEmployeeNoAsc(String employeeNo_0, String employeeNo_1, String agStatusCode_2,
			Pageable pageable);
