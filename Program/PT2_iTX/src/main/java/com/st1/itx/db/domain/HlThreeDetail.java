...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "HlThreeDetail [hlThreeDetailId=" + hlThreeDetailId + ", actAmt=" + actAmt + ", pieceCode=" + pieceCode + ", cntingCode=" + cntingCode
           + ", tActAmt=" + tActAmt + ", empNo=" + empNo + ", empId=" + empId + ", empName=" + empName + ", deptCode=" + deptCode + ", distCode=" + distCode
           + ", unitCode=" + unitCode + ", deptName=" + deptName + ", distName=" + distName + ", unitName=" + unitName + ", firAppDate=" + firAppDate + ", biReteNo=" + biReteNo
           + ", twoYag=" + twoYag + ", threeYag=" + threeYag + ", twoPay=" + twoPay + ", threePay=" + threePay + ", unitChiefNo=" + unitChiefNo + ", unitChiefName=" + unitChiefName
           + ", areaChiefNo=" + areaChiefNo + ", areaChiefName=" + areaChiefName + ", id3=" + id3 + ", id3Name=" + id3Name + ", teamChiefNo=" + teamChiefNo + ", teamChiefName=" + teamChiefName
           + ", id0=" + id0 + ", id0Name=" + id0Name + ", upNo=" + upNo + ", calDate=" + calDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
