...
public class MlaundryRecord implements Serializable {
	...
	/**
	 * 還款來源<br>
	 * 01:他行代償 02:家人代償 03:內部代償 04:房屋出售 05:土地出售 06:投資獲利 07:保險滿期金 08:退休金 09:存款 10:不願告知
	 * 11:其他
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "MlaundryRecord [logNo=" + logNo + ", recordDate=" + recordDate + ", custNo=" + custNo + ", facmNo=" + facmNo + ", bormNo=" + bormNo + ", repayDate=" + repayDate + ", actualRepayDate="
				+ actualRepayDate + ", repayAmt=" + repayAmt + ", actualRepayAmt=" + actualRepayAmt + ", career=" + career + ", income=" + income + ", repaySource=" + repaySource + ", repayBank="
				+ repayBank + ", description=" + description + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
				+ "]";
	}
}
