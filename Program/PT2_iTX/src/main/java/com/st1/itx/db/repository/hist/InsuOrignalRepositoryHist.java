 ...
 * @version 1.0.0
 */
public interface InsuOrignalRepositoryHist extends JpaRepository<InsuOrignal, InsuOrignalId> {
  ...
  // OrigInsuNo =
  public Slice<InsuOrignal> findAllByOrigInsuNoIsOrderByClCode1AscClCode2AscClNoAsc(String origInsuNo_0, Pageable pageable);

  // ClCode1 = ,AND ClCode2 = ,AND ClNo = ,AND OrigInsuNo =
  public Optional<InsuOrignal> findTopByClCode1IsAndClCode2IsAndClNoIsAndOrigInsuNoIsOrderByCreateDateAsc(int clCode1_0, int clCode2_1, int clNo_2, String origInsuNo_3);
