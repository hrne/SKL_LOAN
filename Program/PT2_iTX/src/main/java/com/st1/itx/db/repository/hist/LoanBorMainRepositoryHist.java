 ...
 * @version 1.0.0
 */
public interface LoanBorMainRepositoryHist extends JpaRepository<LoanBorMain, LoanBorMainId> {

	// CustNo = ,AND FacmNo >= ,AND FacmNo <= ,AND BormNo >= ,AND BormNo <=
	public Slice<LoanBorMain> findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualOrderByFacmNoAscBormNoAsc(int custNo_0, int facmNo_1,
			int facmNo_2, int bormNo_3, int bormNo_4, Pageable pageable);

	// CustNo = ,AND FacmNo ^i ,AND BormNo >= ,AND BormNo <=
	public Slice<LoanBorMain> findAllByCustNoIsAndFacmNoInAndBormNoGreaterThanEqualAndBormNoLessThanEqualOrderByFacmNoAscBormNoAsc(int custNo_0, List<Integer> facmNo_1, int bormNo_2, int bormNo_3,
			Pageable pageable);
	...
	public Slice<LoanBorMain> findAllByNextPayIntDateGreaterThanEqualAndNextPayIntDateLessThanEqualAndStatusIsOrderByCustNoAscFacmNoAscBormNoAscNextPayIntDateAsc(int nextPayIntDate_0,
			int nextPayIntDate_1, int status_2, Pageable pageable);

	// Status ^i ,AND DrawdownDate >= ,AND DrawdownDate <=
	public Slice<LoanBorMain> findAllByStatusInAndDrawdownDateGreaterThanEqualAndDrawdownDateLessThanEqualOrderByCustNoAscFacmNoAscBormNoAsc(List<Integer> status_0, int drawdownDate_1,
	...
	public Slice<LoanBorMain> findAllByStatusInAndCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByFacmNoAscBormNoAsc(List<Integer> status_0, int custNo_1, int facmNo_2, int facmNo_3,
			Pageable pageable);
