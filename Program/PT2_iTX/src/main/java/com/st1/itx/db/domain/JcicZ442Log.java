...
public class JcicZ442Log implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = 2171249998504372049L;
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicZ442Log [jcicZ442LogId=" + jcicZ442LogId + ", tranKey=" + tranKey + ", isMaxMain=" + isMaxMain + ", isClaims=" + isClaims + ", guarLoanCnt=" + guarLoanCnt
           + ", civil323ExpAmt=" + civil323ExpAmt + ", civil323CashAmt=" + civil323CashAmt + ", civil323CreditAmt=" + civil323CreditAmt + ", civil323GuarAmt=" + civil323GuarAmt + ", receExpPrin=" + receExpPrin + ", receExpInte=" + receExpInte
           ...
           + ", creditCardPrin=" + creditCardPrin + ", creditCardInte=" + creditCardInte + ", creditCardPena=" + creditCardPena + ", creditCardOther=" + creditCardOther + ", guarObliPrin=" + guarObliPrin + ", guarObliInte=" + guarObliInte
           + ", guarObliPena=" + guarObliPena + ", guarObliOther=" + guarObliOther + ", outJcicTxtDate=" + outJcicTxtDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
