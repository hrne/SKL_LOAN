...
em = null;
  ...
  public Slice<ClOtherRights> findAll(int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by(Sort.Direction.ASC, "ClCode1", "ClCode2", "ClNo", "Seq"));
    else
  ...
  public ClOtherRights insert(ClOtherRights clOtherRights, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(clOtherRights.getClOtherRightsId(), titaVo) != null)
