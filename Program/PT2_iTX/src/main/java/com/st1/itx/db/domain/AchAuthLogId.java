...
Z:暫停授權(DeleteDate &amp;gt; 0時，顯示用)
  ...
  * @param createFlag 新增或取消記號
  ...
  public boolean equals(Object obj) {
    ...
    return authCreateDate == achAuthLogId.authCreateDate && custNo == achAuthLogId.custNo && repayBank.equals(achAuthLogId.repayBank) && repayAcct.equals(achAuthLogId.repayAcct) && createFlag.equals(achAuthLogId.createFlag);
  }
