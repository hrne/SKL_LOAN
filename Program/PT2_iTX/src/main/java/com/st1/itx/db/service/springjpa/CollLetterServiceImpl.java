...
public class CollLetterServiceImpl extends ASpringJpaParm implements CollLetterService, InitializingBean {
	...
	public Slice<CollLetter> telTimeBetween(int mailDate_0, int mailDate_1, String caseCode_2, int custNo_3, int facmNo_4, int index, int limit, TitaVo... titaVo) {
		...
		this.info("telTimeBetween " + dbName + " : " + "mailDate_0 : " + mailDate_0 + " mailDate_1 : " + mailDate_1 + " caseCode_2 : " + caseCode_2 + " custNo_3 : " + custNo_3 + " facmNo_4 : "
				+ facmNo_4);
		if (dbName.equals(ContentName.onDay))
			slice = collLetterReposDay.findAllByMailDateGreaterThanEqualAndMailDateLessThanEqualAndCaseCodeIsAndCustNoIsAndFacmNoIsOrderByMailDateDesc(mailDate_0, mailDate_1, caseCode_2, custNo_3,
					facmNo_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = collLetterReposMon.findAllByMailDateGreaterThanEqualAndMailDateLessThanEqualAndCaseCodeIsAndCustNoIsAndFacmNoIsOrderByMailDateDesc(mailDate_0, mailDate_1, caseCode_2, custNo_3,
					facmNo_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = collLetterReposHist.findAllByMailDateGreaterThanEqualAndMailDateLessThanEqualAndCaseCodeIsAndCustNoIsAndFacmNoIsOrderByMailDateDesc(mailDate_0, mailDate_1, caseCode_2, custNo_3,
					facmNo_4, pageable);
		else
			slice = collLetterRepos.findAllByMailDateGreaterThanEqualAndMailDateLessThanEqualAndCaseCodeIsAndCustNoIsAndFacmNoIsOrderByMailDateDesc(mailDate_0, mailDate_1, caseCode_2, custNo_3,
					facmNo_4, pageable);
