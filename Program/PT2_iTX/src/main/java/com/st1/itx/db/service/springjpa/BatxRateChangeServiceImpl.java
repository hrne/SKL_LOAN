...
public class BatxRateChangeServiceImpl extends ASpringJpaParm implements BatxRateChangeService, InitializingBean {
	...
	public Slice<BatxRateChange> custCodeEq(int adjDate_0, int adjDate_1, int custCode_2, int custCode_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = batxRateChangeReposDay.findAllByAdjDateGreaterThanEqualAndAdjDateLessThanEqualAndCustCodeGreaterThanEqualAndCustCodeLessThanEqual(adjDate_0, adjDate_1, custCode_2, custCode_3,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = batxRateChangeReposMon.findAllByAdjDateGreaterThanEqualAndAdjDateLessThanEqualAndCustCodeGreaterThanEqualAndCustCodeLessThanEqual(adjDate_0, adjDate_1, custCode_2, custCode_3,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = batxRateChangeReposHist.findAllByAdjDateGreaterThanEqualAndAdjDateLessThanEqualAndCustCodeGreaterThanEqualAndCustCodeLessThanEqual(adjDate_0, adjDate_1, custCode_2, custCode_3,
					pageable);
		else
			slice = batxRateChangeRepos.findAllByAdjDateGreaterThanEqualAndAdjDateLessThanEqualAndCustCodeGreaterThanEqualAndCustCodeLessThanEqual(adjDate_0, adjDate_1, custCode_2, custCode_3,
					pageable);
	...
	@Override
	public Slice<BatxRateChange> findL4931AEq(int custCode_0, int custCode_1, int txKind_2, int txKind_3, int adjCode_4, int adjCode_5, int adjDate_6, int adjDate_7, int index, int limit,
			TitaVo... titaVo) {
		String dbName = "";
		Slice<BatxRateChange> slice = null;
		if (titaVo.length != 0)
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findL4931AEq " + dbName + " : " + "custCode_0 : " + custCode_0 + " custCode_1 : " + custCode_1 + " txKind_2 : " + txKind_2 + " txKind_3 : " + txKind_3 + " adjCode_4 : " + adjCode_4
				+ " adjCode_5 : " + adjCode_5 + " adjDate_6 : " + adjDate_6 + " adjDate_7 : " + adjDate_7);
		if (dbName.equals(ContentName.onDay))
			slice = batxRateChangeReposDay
					.findAllByCustCodeGreaterThanEqualAndCustCodeLessThanEqualAndTxKindGreaterThanEqualAndTxKindLessThanEqualAndAdjCodeGreaterThanEqualAndAdjCodeLessThanEqualAndAdjDateGreaterThanEqualAndAdjDateLessThanEqual(
							custCode_0, custCode_1, txKind_2, txKind_3, adjCode_4, adjCode_5, adjDate_6, adjDate_7, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = batxRateChangeReposMon
					.findAllByCustCodeGreaterThanEqualAndCustCodeLessThanEqualAndTxKindGreaterThanEqualAndTxKindLessThanEqualAndAdjCodeGreaterThanEqualAndAdjCodeLessThanEqualAndAdjDateGreaterThanEqualAndAdjDateLessThanEqual(
							custCode_0, custCode_1, txKind_2, txKind_3, adjCode_4, adjCode_5, adjDate_6, adjDate_7, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = batxRateChangeReposHist
					.findAllByCustCodeGreaterThanEqualAndCustCodeLessThanEqualAndTxKindGreaterThanEqualAndTxKindLessThanEqualAndAdjCodeGreaterThanEqualAndAdjCodeLessThanEqualAndAdjDateGreaterThanEqualAndAdjDateLessThanEqual(
							custCode_0, custCode_1, txKind_2, txKind_3, adjCode_4, adjCode_5, adjDate_6, adjDate_7, pageable);
		else
			slice = batxRateChangeRepos
					.findAllByCustCodeGreaterThanEqualAndCustCodeLessThanEqualAndTxKindGreaterThanEqualAndTxKindLessThanEqualAndAdjCodeGreaterThanEqualAndAdjCodeLessThanEqualAndAdjDateGreaterThanEqualAndAdjDateLessThanEqual(
							custCode_0, custCode_1, txKind_2, txKind_3, adjCode_4, adjCode_5, adjDate_6, adjDate_7, pageable);
	...
	@Override
	public Slice<BatxRateChange> findL4321Report(int adjDate_0, int adjDate_1, int custCode_2, int custCode_3, int txKind_4, int adjCode_5, int adjCode_6, int confirmFlag_7, int index, int limit,
			TitaVo... titaVo) {
		String dbName = "";
		Slice<BatxRateChange> slice = null;
		if (titaVo.length != 0)
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findL4321Report " + dbName + " : " + "adjDate_0 : " + adjDate_0 + " adjDate_1 : " + adjDate_1 + " custCode_2 : " + custCode_2 + " custCode_3 : " + custCode_3 + " txKind_4 : "
				+ txKind_4 + " adjCode_5 : " + adjCode_5 + " adjCode_6 : " + adjCode_6 + " confirmFlag_7 : " + confirmFlag_7);
		if (dbName.equals(ContentName.onDay))
			slice = batxRateChangeReposDay
					.findAllByAdjDateGreaterThanEqualAndAdjDateLessThanEqualAndCustCodeGreaterThanEqualAndCustCodeLessThanEqualAndTxKindIsAndAdjCodeGreaterThanEqualAndAdjCodeLessThanEqualAndConfirmFlagIsOrderByCustNoAscFacmNoAscBormNoAsc(
