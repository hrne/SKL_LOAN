...
em = null;
  ...
  @Override
  public BatxRateChange adjDateDescFirst(int custNo_0, int facmNo_1, int bormNo_2, TitaVo... titaVo) {
    String dbName = "";
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("adjDateDescFirst " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " +  facmNo_1 + " bormNo_2 : " +  bormNo_2);
    Optional<BatxRateChange> batxRateChangeT = null;
    if (dbName.equals(ContentName.onDay))
      batxRateChangeT = batxRateChangeReposDay.findTopByCustNoIsAndFacmNoIsAndBormNoIsOrderByAdjDateDesc(custNo_0, facmNo_1, bormNo_2);
    else if (dbName.equals(ContentName.onMon))
      batxRateChangeT = batxRateChangeReposMon.findTopByCustNoIsAndFacmNoIsAndBormNoIsOrderByAdjDateDesc(custNo_0, facmNo_1, bormNo_2);
    else if (dbName.equals(ContentName.onHist))
      batxRateChangeT = batxRateChangeReposHist.findTopByCustNoIsAndFacmNoIsAndBormNoIsOrderByAdjDateDesc(custNo_0, facmNo_1, bormNo_2);
    else 
      batxRateChangeT = batxRateChangeRepos.findTopByCustNoIsAndFacmNoIsAndBormNoIsOrderByAdjDateDesc(custNo_0, facmNo_1, bormNo_2);
