...
public class NegMainServiceImpl extends ASpringJpaParm implements NegMainService, InitializingBean {
	...
	public Slice<NegMain> l5705HadCustId(List<String> status_0, String isMainFin_1, int nextPayDate_2, int nextPayDate_3, int custNo_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("l5705HadCustId " + dbName + " : " + "status_0 : " + status_0 + " isMainFin_1 : " + isMainFin_1 + " nextPayDate_2 : " + nextPayDate_2 + " nextPayDate_3 : " + nextPayDate_3
				+ " custNo_4 : " + custNo_4);
		if (dbName.equals(ContentName.onDay))
			slice = negMainReposDay.findAllByStatusInAndIsMainFinIsAndNextPayDateGreaterThanEqualAndNextPayDateLessThanEqualAndCustNoIsOrderByCustNoDescCaseSeqAsc(status_0, isMainFin_1, nextPayDate_2,
					nextPayDate_3, custNo_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = negMainReposMon.findAllByStatusInAndIsMainFinIsAndNextPayDateGreaterThanEqualAndNextPayDateLessThanEqualAndCustNoIsOrderByCustNoDescCaseSeqAsc(status_0, isMainFin_1, nextPayDate_2,
					nextPayDate_3, custNo_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = negMainReposHist.findAllByStatusInAndIsMainFinIsAndNextPayDateGreaterThanEqualAndNextPayDateLessThanEqualAndCustNoIsOrderByCustNoDescCaseSeqAsc(status_0, isMainFin_1,
					nextPayDate_2, nextPayDate_3, custNo_4, pageable);
		else
			slice = negMainRepos.findAllByStatusInAndIsMainFinIsAndNextPayDateGreaterThanEqualAndNextPayDateLessThanEqualAndCustNoIsOrderByCustNoDescCaseSeqAsc(status_0, isMainFin_1, nextPayDate_2,
					nextPayDate_3, custNo_4, pageable);
	...
	public Slice<NegMain> l5705NoCustId(List<String> status_0, String isMainFin_1, int nextPayDate_2, int nextPayDate_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = negMainReposDay.findAllByStatusInAndIsMainFinIsAndNextPayDateGreaterThanEqualAndNextPayDateLessThanEqualOrderByCustNoDescCaseSeqAsc(status_0, isMainFin_1, nextPayDate_2,
					nextPayDate_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = negMainReposMon.findAllByStatusInAndIsMainFinIsAndNextPayDateGreaterThanEqualAndNextPayDateLessThanEqualOrderByCustNoDescCaseSeqAsc(status_0, isMainFin_1, nextPayDate_2,
					nextPayDate_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = negMainReposHist.findAllByStatusInAndIsMainFinIsAndNextPayDateGreaterThanEqualAndNextPayDateLessThanEqualOrderByCustNoDescCaseSeqAsc(status_0, isMainFin_1, nextPayDate_2,
					nextPayDate_3, pageable);
		else
			slice = negMainRepos.findAllByStatusInAndIsMainFinIsAndNextPayDateGreaterThanEqualAndNextPayDateLessThanEqualOrderByCustNoDescCaseSeqAsc(status_0, isMainFin_1, nextPayDate_2,
					nextPayDate_3, pageable);
