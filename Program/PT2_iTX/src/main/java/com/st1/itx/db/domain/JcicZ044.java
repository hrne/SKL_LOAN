...
/**
  ...
  * @param actualFilingMark 實際報送記號
  ...
  public String toString() {
    return "JcicZ044 [jcicZ044Id=" + jcicZ044Id + ", tranKey=" + tranKey + ", debtCode=" + debtCode + ", nonGageAmt=" + nonGageAmt
           + ", period=" + period + ", rate=" + rate + ", monthPayAmt=" + monthPayAmt + ", receYearIncome=" + receYearIncome + ", receYear=" + receYear + ", receYear2Income=" + receYear2Income
