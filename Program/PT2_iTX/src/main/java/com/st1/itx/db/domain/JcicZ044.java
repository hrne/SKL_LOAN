...
@Table(name = "`JcicZ044`")
public class JcicZ044 implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3637590072569216514L;
	...
	// 屬二階段還款方案之階段註記
	/* 單格空白:非屬二階段還款1:屬二階段還款方案之第一階段2:屬二階段還款方案之第二階段 */
	...
	public JcicZ044Id getJcicZ044Id() {
		return this.jcicZ044Id;
	}

	public void setJcicZ044Id(JcicZ044Id jcicZ044Id) {
		this.jcicZ044Id = jcicZ044Id;
	}
	...
	/**
	 * 屬二階段還款方案之階段註記<br>
	 * 單格空白:非屬二階段還款 1:屬二階段還款方案之第一階段 2:屬二階段還款方案之第二階段
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "JcicZ044 [jcicZ044Id=" + jcicZ044Id + ", tranKey=" + tranKey + ", debtCode=" + debtCode + ", nonGageAmt=" + nonGageAmt + ", period=" + period + ", rate=" + rate + ", monthPayAmt="
				+ monthPayAmt + ", receYearIncome=" + receYearIncome + ", receYear=" + receYear + ", receYear2Income=" + receYear2Income + ", receYear2=" + receYear2 + ", currentMonthIncome="
				+ currentMonthIncome + ", livingCost=" + livingCost + ", compName=" + compName + ", compId=" + compId + ", carCnt=" + carCnt + ", houseCnt=" + houseCnt + ", landCnt=" + landCnt
				+ ", childCnt=" + childCnt + ", childRate=" + childRate + ", parentCnt=" + parentCnt + ", parentRate=" + parentRate + ", mouthCnt=" + mouthCnt + ", mouthRate=" + mouthRate
				+ ", gradeType=" + gradeType + ", payLastAmt=" + payLastAmt + ", period2=" + period2 + ", rate2=" + rate2 + ", monthPayAmt2=" + monthPayAmt2 + ", payLastAmt2=" + payLastAmt2
				+ ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo="
				+ lastUpdateEmpNo + ", actualFilingDate=" + actualFilingDate + ", actualFilingMark=" + actualFilingMark + "]";
	}
}
