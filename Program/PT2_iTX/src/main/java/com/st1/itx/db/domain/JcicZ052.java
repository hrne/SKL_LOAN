...
public class JcicZ052 implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7572561797034500148L;
	...
	public String toString() {
		return "JcicZ052 [jcicZ052Id=" + jcicZ052Id + ", tranKey=" + tranKey + ", bankCode1=" + bankCode1 + ", dataCode1=" + dataCode1 + ", bankCode2=" + bankCode2 + ", dataCode2=" + dataCode2
				+ ", bankCode3=" + bankCode3 + ", dataCode3=" + dataCode3 + ", bankCode4=" + bankCode4 + ", dataCode4=" + dataCode4 + ", bankCode5=" + bankCode5 + ", dataCode5=" + dataCode5
				+ ", changePayDate=" + changePayDate + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate="
				+ lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + ", actualFilingDate=" + actualFilingDate + ", actualFilingMark=" + actualFilingMark + "]";
	}
}
