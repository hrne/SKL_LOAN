 ...
 * @version 1.0.0
 */
public interface JcicZ051RepositoryHist extends JpaRepository<JcicZ051, JcicZ051Id> {
  ...
  public Slice<JcicZ051> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
