...
public class JcicZ450ServiceImpl extends ASpringJpaParm implements JcicZ450Service, InitializingBean {
	...
	public Slice<JcicZ450> otherEq(String submitKey_0, String custId_1, int applyDate_2, String courtCode_3, int payDate_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("otherEq " + dbName + " : " + "submitKey_0 : " + submitKey_0 + " custId_1 : " + custId_1 + " applyDate_2 : " + applyDate_2 + " courtCode_3 : " + courtCode_3 + " payDate_4 : "
				+ payDate_4);
		if (dbName.equals(ContentName.onDay))
			...
			slice = jcicZ450ReposHist.findAllBySubmitKeyIsAndCustIdIsAndApplyDateIsAndCourtCodeIsAndPayDateIsOrderByCreateDateDesc(submitKey_0, custId_1, applyDate_2, courtCode_3, payDate_4,
					pageable);
		else
	...
	public JcicZ450 otherFirst(String submitKey_0, String custId_1, int applyDate_2, String courtCode_3, int payDate_4, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("otherFirst " + dbName + " : " + "submitKey_0 : " + submitKey_0 + " custId_1 : " + custId_1 + " applyDate_2 : " + applyDate_2 + " courtCode_3 : " + courtCode_3 + " payDate_4 : "
				+ payDate_4);
		Optional<JcicZ450> jcicZ450T = null;
		if (dbName.equals(ContentName.onDay))
