...
import com.st1.itx.db.service.springjpa.cm.L8442ServiceImpl;
 ...
 * @version 1.0.0
 */
public class L8442 extends TradeBuffer {
	...
	@Autowired
	public L8442ServiceImpl iL8442;

	@Override
	public ArrayList<TotaVo> run(TitaVo titaVo) throws LogicException {
		this.info("active L8442 ");
		...
		List<Map<String, String>> sL8442 = new ArrayList<Map<String, String>>();
		for (int x : intArray) {
			
			String c = Integer.toString(x);
			this.info("c   = " + c);
			try {
				sL8442 = iL8442.FindData(titaVo, c);
			} catch (Exception e) {
				this.info("L8440 have JcicDate ===");
				throw new LogicException(titaVo, "E2003", "查無可轉出資料");
			}
			
			for(Map<String, String> isL8442 : sL8442) {
				String iJcicDate = isL8442.get("F1");
				String iReportTotal= isL8442.get("F2");
				String iCorrectCount = isL8442.get("F3");
				String iMistakeCount = isL8442.get("F4");
				...
				case "040":
					...
					OccursList.putParam("OOJcicDate", iJcicDate);
					OccursList.putParam("OOReportTotal", iReportTotal);
					OccursList.putParam("OOCorrectCount", iCorrectCount);
					OccursList.putParam("OOMistakeCount", iMistakeCount);
