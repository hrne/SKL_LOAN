...
public class BankRemit implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6386826420743264726L;
	...
	// 狀態
	/*
	 * CdCode.DrawdownStatus0:正常1:未放行(ActFg=1時顯示用)2:產檔後訂正3:產檔後修正4:產檔後改單筆匯款5:被修正或訂正(
	 * 顯示用)
	 */
	...
	// 付款狀況碼
	/*
	 * CdCode.PayCodeI:建檔O:確認C:建檔取消A:已開票D:支票到期B:退件S:請款單位擋匯T:網銀擋匯W:匯款途中F:匯款失敗H:支票兌領/
	 * 匯款成功R:退匯/退回情況改變成作廢L:支票掛失V:支票作廢J:空白票遺失Z:逾一年未兌領Y:逾二年未兌領P:繳款成功X:付款沖回Q:
	 * AML相似名單確認中U:禁止交易(AML)
	 */
	...
	/**
	 * 狀態<br>
	 * CdCode.DrawdownStatus 0:正常 1:未放行(ActFg=1時顯示用) 2:產檔後訂正 3:產檔後修正 4:產檔後改單筆匯款
	 * 5:被修正或訂正(顯示用)
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 付款狀況碼<br>
	 * CdCode.PayCode I:建檔 O:確認 C:建檔取消 A:已開票 D:支票到期 B:退件 S:請款單位擋匯 T:網銀擋匯 W:匯款途中
	 * F:匯款失敗 H:支票兌領/匯款成功 R:退匯/退回情況改變成作廢 L:支票掛失 V:支票作廢 J:空白票遺失 Z:逾一年未兌領 Y:逾二年未兌領
	 * P:繳款成功 X:付款沖回 Q:AML相似名單確認中 U:禁止交易(AML)
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "BankRemit [bankRemitId=" + bankRemitId + ", batchNo=" + batchNo + ", drawdownCode=" + drawdownCode + ", statusCode=" + statusCode + ", remitBank=" + remitBank + ", remitBranch="
				+ remitBranch + ", remitAcctNo=" + remitAcctNo + ", custNo=" + custNo + ", facmNo=" + facmNo + ", bormNo=" + bormNo + ", custName=" + custName + ", custId=" + custId
				+ ", custBirthday=" + custBirthday + ", custGender=" + custGender + ", remark=" + remark + ", currencyCode=" + currencyCode + ", remitAmt=" + remitAmt + ", amlRsp=" + amlRsp
				+ ", actFg=" + actFg + ", modifyContent=" + modifyContent + ", payCode=" + payCode + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
