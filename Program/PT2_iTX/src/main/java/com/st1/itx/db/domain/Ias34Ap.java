...
public class Ias34Ap implements Serializable {
	...
	// 契約當時還款方式
	/* 1:按期繳息(到期還本)2:平均攤還本息3:平均攤還本金4:到期繳息還本 */
	@Column(name = "`AmortizedCode`")
	private int amortizedCode = 0;

	// 契約當時利率調整方式
	/* 1:機動2:固定3:固定階梯4:浮動階梯 */
	...
	public String toString() {
		return "Ias34Ap [ias34ApId=" + ias34ApId + ", custId=" + custId + ", applNo=" + applNo + ", acCode=" + acCode + ", status=" + status + ", firstDrawdownDate=" + firstDrawdownDate
				...
				+ ", badDebtAmt=" + badDebtAmt + ", derCode=" + derCode + ", gracePeriod=" + gracePeriod + ", approveRate=" + approveRate + ", amortizedCode=" + amortizedCode + ", rateCode="
				+ rateCode + ", repayFreq=" + repayFreq + ", payIntFreq=" + payIntFreq + ", industryCode=" + industryCode + ", clTypeJCIC=" + clTypeJCIC + ", zip3=" + zip3 + ", prodNo=" + prodNo
				+ ", custKind=" + custKind + ", assetClass=" + assetClass + ", ifrs9ProdCode=" + ifrs9ProdCode + ", evaAmt=" + evaAmt + ", firstDueDate=" + firstDueDate + ", totalPeriod="
				+ totalPeriod + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
