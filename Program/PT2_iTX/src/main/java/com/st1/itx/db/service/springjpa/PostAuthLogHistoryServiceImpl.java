...
public class PostAuthLogHistoryServiceImpl extends ASpringJpaParm implements PostAuthLogHistoryService, InitializingBean {
	...
	public PostAuthLogHistory authLogFirst(int authCreateDate_0, String authApplCode_1, int custNo_2, String postDepCode_3, String repayAcct_4, String authCode_5, TitaVo... titaVo) {
		...
		Optional<PostAuthLogHistory> postAuthLogHistoryT = null;
		if (dbName.equals(ContentName.onDay))
			postAuthLogHistoryT = postAuthLogHistoryReposDay.findTopByAuthCreateDateIsAndAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsOrderByLogNoDesc(authCreateDate_0,
					authApplCode_1, custNo_2, postDepCode_3, repayAcct_4, authCode_5);
		else if (dbName.equals(ContentName.onMon))
			postAuthLogHistoryT = postAuthLogHistoryReposMon.findTopByAuthCreateDateIsAndAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsOrderByLogNoDesc(authCreateDate_0,
					authApplCode_1, custNo_2, postDepCode_3, repayAcct_4, authCode_5);
		else if (dbName.equals(ContentName.onHist))
			postAuthLogHistoryT = postAuthLogHistoryReposHist.findTopByAuthCreateDateIsAndAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsOrderByLogNoDesc(authCreateDate_0,
					authApplCode_1, custNo_2, postDepCode_3, repayAcct_4, authCode_5);
		else
			postAuthLogHistoryT = postAuthLogHistoryRepos.findTopByAuthCreateDateIsAndAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsOrderByLogNoDesc(authCreateDate_0,
					authApplCode_1, custNo_2, postDepCode_3, repayAcct_4, authCode_5);
	...
	public PostAuthLogHistory insert(PostAuthLogHistory postAuthLogHistory, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(postAuthLogHistory.getLogNo(), titaVo) != null)
