...
//		sql += "		  ,CE2.\"Fullname\" AS \"SupNoName\"";
		...
		sql += "			  ,TO_NUMBER( ";
		sql += "		      	  CASE";
		sql += "		      		WHEN LENGTH(TRIM(T.\"MrKey\")) IS NULL ";
		sql += "		      		THEN '0'";
		sql += "		      		WHEN LENGTH(TRIM(T.\"MrKey\")) IN (7,11,15,17) ";
		...
		sql += "		      		WHEN LENGTH(TRIM(T.\"MrKey\")) IS NULL ";
		sql += "		      		THEN '0'";
		sql += "		      		WHEN LENGTH(TRIM(T.\"MrKey\")) IN (11,15,17)";
		...
		sql += "		      		WHEN LENGTH(TRIM(T.\"MrKey\")) IS NULL ";
		sql += "		      		THEN '0'";
		sql += "		      		WHEN LENGTH(TRIM(T.\"MrKey\")) IN (15,17)";
		...
		sql += "	LEFT JOIN \"CdCode\" CC ON CC.\"DefCode\" = 'ClCode2' || Cl.\"ClCode1\"";
		sql += "						   AND CC.\"Code\" = LPAD(Cl.\"ClCode2\",2,0)";
		sql += "	LEFT JOIN \"tmpData\" R ON R.\"TxSeq\" = T.\"TxSeq\"";
