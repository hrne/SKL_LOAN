...
public class FacProdServiceImpl extends ASpringJpaParm implements FacProdService, InitializingBean {
	...
	@Override
	public Slice<FacProd> fildStatus(String prodNo_0, List<String> statusCode_1, List<String> govOfferFlag_2, List<String> financialFlag_3, List<String> empFlag_4, int index, int limit,
			TitaVo... titaVo) {
		String dbName = "";
		Slice<FacProd> slice = null;
		if (titaVo.length != 0)
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("fildStatus " + dbName + " : " + "prodNo_0 : " + prodNo_0 + " statusCode_1 : " + statusCode_1 + " govOfferFlag_2 : " + govOfferFlag_2 + " financialFlag_3 : " + financialFlag_3
				+ " empFlag_4 : " + empFlag_4);
		if (dbName.equals(ContentName.onDay))
			slice = facProdReposDay.findAllByProdNoLikeAndStatusCodeInAndGovOfferFlagInAndFinancialFlagInAndEmpFlagInOrderByProdNoAsc(prodNo_0, statusCode_1, govOfferFlag_2, financialFlag_3,
					empFlag_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = facProdReposMon.findAllByProdNoLikeAndStatusCodeInAndGovOfferFlagInAndFinancialFlagInAndEmpFlagInOrderByProdNoAsc(prodNo_0, statusCode_1, govOfferFlag_2, financialFlag_3,
					empFlag_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = facProdReposHist.findAllByProdNoLikeAndStatusCodeInAndGovOfferFlagInAndFinancialFlagInAndEmpFlagInOrderByProdNoAsc(prodNo_0, statusCode_1, govOfferFlag_2, financialFlag_3,
					empFlag_4, pageable);
		else
			slice = facProdRepos.findAllByProdNoLikeAndStatusCodeInAndGovOfferFlagInAndFinancialFlagInAndEmpFlagInOrderByProdNoAsc(prodNo_0, statusCode_1, govOfferFlag_2, financialFlag_3, empFlag_4,
					pageable);
	...
	@Override
	public Slice<FacProd> fildProdNo(String prodNo_0, List<String> statusCode_1, List<String> enterpriseFg_2, List<String> govOfferFlag_3, List<String> financialFlag_4, List<String> empFlag_5,
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("fildProdNo " + dbName + " : " + "prodNo_0 : " + prodNo_0 + " statusCode_1 : " + statusCode_1 + " enterpriseFg_2 : " + enterpriseFg_2 + " govOfferFlag_3 : " + govOfferFlag_3
				+ " financialFlag_4 : " + financialFlag_4 + " empFlag_5 : " + empFlag_5);
		if (dbName.equals(ContentName.onDay))
			slice = facProdReposDay.findAllByProdNoLikeAndStatusCodeInAndEnterpriseFgInAndGovOfferFlagInAndFinancialFlagInAndEmpFlagInOrderByProdNoAsc(prodNo_0, statusCode_1, enterpriseFg_2,
					govOfferFlag_3, financialFlag_4, empFlag_5, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = facProdReposMon.findAllByProdNoLikeAndStatusCodeInAndEnterpriseFgInAndGovOfferFlagInAndFinancialFlagInAndEmpFlagInOrderByProdNoAsc(prodNo_0, statusCode_1, enterpriseFg_2,
					govOfferFlag_3, financialFlag_4, empFlag_5, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = facProdReposHist.findAllByProdNoLikeAndStatusCodeInAndEnterpriseFgInAndGovOfferFlagInAndFinancialFlagInAndEmpFlagInOrderByProdNoAsc(prodNo_0, statusCode_1, enterpriseFg_2,
					govOfferFlag_3, financialFlag_4, empFlag_5, pageable);
		else
			slice = facProdRepos.findAllByProdNoLikeAndStatusCodeInAndEnterpriseFgInAndGovOfferFlagInAndFinancialFlagInAndEmpFlagInOrderByProdNoAsc(prodNo_0, statusCode_1, enterpriseFg_2,
					govOfferFlag_3, financialFlag_4, empFlag_5, pageable);
