...
public class MonthlyLM052LoanAsset implements Serializable {
	...
	/*
	 * ref
	 * CdCode.LoanAssetCode特定資產：S1：購置住宅+修繕貸款S2：建築貸款非特定資產：NS1：100年後政策性貸款NS2：股票質押NS3：
	 * 不動產抵押貸款
	 */
	...
	/**
	 * 放款資產項目<br>
	 * ref CdCode.LoanAssetCode 特定資產： S1：購置住宅+修繕貸款 S2：建築貸款 非特定資產： NS1：100年後政策性貸款
	 * NS2：股票質押 NS3：不動產抵押貸款
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "MonthlyLM052LoanAsset [monthlyLM052LoanAssetId=" + monthlyLM052LoanAssetId + ", loanBal=" + loanBal + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate="
