...
@Repository
public class CustNoticeServiceImpl extends ASpringJpaParm implements CustNoticeService, InitializingBean {
  @Autowired
  ...
  public CustNotice findById(CustNoticeId custNoticeId, TitaVo... titaVo) {
    ...
    this.info("findById " + dbName + " " + custNoticeId);
...
em = null;
  ...
  public Slice<CustNotice> findAll(int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by(Sort.Direction.ASC, "CustNo", "FacmNo", "FormNo"));
    else
  ...
  public Slice<CustNotice> findCustNo(int custNo_0, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      slice = custNoticeReposDay.findAllByCustNoIsOrderByFacmNoAsc(custNo_0, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = custNoticeReposMon.findAllByCustNoIsOrderByFacmNoAsc(custNo_0, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = custNoticeReposHist.findAllByCustNoIsOrderByFacmNoAsc(custNo_0, pageable);
    else 
      slice = custNoticeRepos.findAllByCustNoIsOrderByFacmNoAsc(custNo_0, pageable);
  ...
  public Slice<CustNotice> findFormNo(String formNo_0, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("findFormNo " + dbName + " : " + "formNo_0 : " + formNo_0);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<CustNotice> facmNoEq(int custNo_0, int facmNo_1, int facmNo_2, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("facmNoEq " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " +  facmNo_1 + " facmNo_2 : " +  facmNo_2);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<CustNotice> findCustNoFormNo(int custNo_0, String formNo_1, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("findCustNoFormNo " + dbName + " : " + "custNo_0 : " + custNo_0 + " formNo_1 : " +  formNo_1);
    if (dbName.equals(ContentName.onDay))
      slice = custNoticeReposDay.findAllByCustNoIsAndFormNoIsOrderByFacmNoAsc(custNo_0, formNo_1, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = custNoticeReposMon.findAllByCustNoIsAndFormNoIsOrderByFacmNoAsc(custNo_0, formNo_1, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = custNoticeReposHist.findAllByCustNoIsAndFormNoIsOrderByFacmNoAsc(custNo_0, formNo_1, pageable);
    else 
      slice = custNoticeRepos.findAllByCustNoIsAndFormNoIsOrderByFacmNoAsc(custNo_0, formNo_1, pageable);
  ...
  public CustNotice holdById(CustNoticeId custNoticeId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("Hold " + dbName + " " + custNoticeId);
    Optional<CustNotice> custNotice = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public CustNotice holdById(CustNotice custNotice, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("Hold " + dbName + " " + custNotice.getCustNoticeId());
  ...
  public CustNotice insert(CustNotice custNotice, TitaVo... titaVo) throws DBException {
    ...
    this.info("Insert..." + dbName + " " + custNotice.getCustNoticeId());
    if (this.findById(custNotice.getCustNoticeId(), titaVo) != null)
  ...
  public CustNotice update(CustNotice custNotice, TitaVo... titaVo) throws DBException {
    ...
    this.info("Update..." + dbName + " " + custNotice.getCustNoticeId());
    if (!empNot.isEmpty())
      custNotice.setLastUpdateEmpNo(empNot);
  ...
  public void delete(CustNotice custNotice, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("Delete..." + dbName + " " + custNotice.getCustNoticeId());
    if (dbName.equals(ContentName.onDay)) {
