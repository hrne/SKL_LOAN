	...
	$.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
				...
				QueryObject = function(d, q) {
					...
					return d.length > 0 && (_useProperties = "object" == typeof d[0]), this._hasData = function() {
						...
						if (null !== c) switch (h) {
							case "int":
							case "integer":
								g = isNaN(Number(g)) || "" === g ? Number.NEGATIVE_INFINITY : g, f = "parseInt(" + f + ",10)", g = "parseInt(" + g + ",10)";
								break;
							case "float":
							case "number":
							case "numeric":
								g = String(g).replace(_stripNum, ""), g = isNaN(Number(g)) || "" === g ? Number.NEGATIVE_INFINITY : Number(g), f = "parseFloat(" + f + ")", g = "parseFloat(" + g + ")";
								break;
							case "date":
							case "datetime":
					...
					}, this.user = function(a, b, c) {
						return self._append("$t.p.customFilterDef." + a + '.action.call($t ,{rowItem:this, searchName:"' + b + '",searchValue:"' + c + '"})'), self._setCommand(self.user, b), self._resetNegate(), self
					}, this.inData = function(a, b, c) {
						var d = void
						0 === b ? "" : self._getStr('"' + self._toStr(b) + '"');
						return _useProperties ? self._append(d + ".split(',').indexOf( jQuery.jgrid.getAccessor(this,'" + a + "') ) > -1") : self._append(d + ".split(',').indexOf(this." + a + ") > -1"), self._setCommand(self.inData, a), self._resetNegate(), self
		...
		getTextWidth: function(a, b) {
			if (!jQuery._cacheCanvas) {
				...
				document.createDocumentFragment().appendChild(c), jQuery._cacheCanvas = c.getContext("2d"), b && (jQuery._cacheCanvas.font = b)
			}
		...
		setSelNavIndex: function(a, b) {
			var c = $(".ui-pg-button", a.p.pager);
			$.each(c, function(c, d) {
				if (b === d) return a.p.navIndex = c, !1
			}), $(b).attr("tabindex", "0")
		},
		styleUI: {
			jQueryUI: {
		...
		return this.each(function() {
			...
			if (!this.grid) {
				...
				var e = this,
					f = {
						...
						scrollGrid: function() {
							...
							f.hDiv.scrollLeft = f.bDiv.scrollLeft, d.footerrow && (f.sDiv.scrollLeft = f.bDiv.scrollLeft), d.headerrow && (f.hrDiv.scrollLeft = f.bDiv.scrollLeft), d.frozenColumns && $(f.fbDiv).scrollTop(f.bDiv.scrollTop);
							try {
								$("#column_menu").remove()
							} catch (a) {}
						},
							...
							var b = a.p,
								...
								f = function() {
									...
									if (b.multiselect && d && d.length > 0)
										for (g = 0; g < d.length; g++) d[g] && $(a).jqGrid("setSelection", d[g], !1, "_sp_");
				...
				if (1 === k && g !== d.regional && (d.regional = g), $(this).empty().attr("tabindex", "0"), this.p = d, this.p.useProp = !!$.fn.prop, 0 === this.p.colNames.length)
				...
				var l, m = $.jgrid.getMethod("getStyleUI"),
					n = e.p.styleUI + ".common",
					o = m(n, "disabled", !0),
					p = m(n, "highlight", !0),
					q = m(n, "hover", !0),
					r = m(n, "cornerall", !0),
					s = m(n, "icon_base", !0),
					t = $.jgrid.styleUI[e.p.styleUI || "jQueryUI"].colmenu,
					u = $.jgrid.msie(),
					v = [],
					w = [],
					x = [];
				...
				var z, A = ["shiftKey", "altKey", "ctrlKey"],
					B = $.jgrid.getFont(e),
					C = function(a, b) {
					...
					F = function(a, b, c, d, f) {
						...
						return h.autosize && (h._maxsize || (h._maxsize = 0), h._maxsize = Math.max($.jgrid.getTextWidth(g, B), h._maxsize)), g
					},
					G = function(a, b, c, d, e, f) {
						var g;
						return g = F(a, b, c, e, "add"), '<td role="gridcell" ' + D(c, d, g, e, a, f) + ">" + g + "</td>"
					},
					...
					L = function(a, b) {
						...
						this.p.deepempty ? $(this.rows).slice(1).remove() : (c = this.rows.length > 0 ? this.rows[0] : null, $(this.firstChild).empty().append(c)), a && this.p.scroll && ($(this.grid.bDiv.firstChild).css({
							...
							height: "0px",
							display: "none"
						}), 0 !== this.grid.bDiv.scrollTop && (this.grid.bDiv.scrollTop = 0)), !0 === b && (this.p.data = [], this.p._index = {})
					},
					M = function() {
						...
						if ("local" === m.datatype && !0 === p.repeatitems)
							for (j = K(s), k = J("local"), d = !1 === m.keyName ? $.isFunction(p.id) ? p.id.call(e, n) : p.id : m.keyName, a = 0; a < o; a++) {
					...
					N = function() {
						...
						for (a = !1 !== e.p.keyName ? e.p.keyName : a = e.p.localReader.id, e.p._index = [], b = 0; b < d; b++) c = $.jgrid.getAccessor(e.p.data[b], a), void
					...
					R = function(a, b, c, d) {
						var f = new
						Date, g = "local" !== e.p.datatype && e.p.loadonce || "xmlstring" === e.p.datatype, h = "_id_", i = e.p.xmlReader, k = "local" === e.p.datatype ? "local" : "xml";
						if (g && (e.p.data = [], e.p._index = {}, e.p.localReader.id = h), e.p.reccount = 0, $.isXMLDoc(a)) {
							-1 !== e.p.treeANode || e.p.scroll ? b = b > 1 ? b : 1 : (L.call(e, !1, !1), b = 1);
							var l, o, p, q, r, s, t, u, v, w = $(e),
								x = 0,
								y = !0 === e.p.multiselect ? 1 : 0,
								z = 0,
								A = !0 === e.p.rownumbers ? 1 : 0,
								B = [],
								D = {},
								E = [],
								F = m(n, "rowBox", !0, "jqgrow ui-row-" + e.p.direction);
							!0 === e.p.subGrid && (z = 1, q = $.jgrid.getMethod("addSubGridCell")), i.repeatitems || (B = J(k)), r = !1 === e.p.keyName ? $.isFunction(i.id) ? i.id.call(e, a) : i.id : e.p.keyName, i.repeatitems && e.p.keyName && isNaN(r) && (r = e.p.keyIndex), s = -1 === String(r).indexOf("[") ? B.length ? function(a, b) {
								return $(r, a).text() || b
							} : function(a, b) {
								return $(i.cell, a).eq(r).text() || b
							} : function(a, b) {
								return a.getAttribute(r.replace(/[\[\]]/g, "")) || b
							}, e.p.userData = {}, e.p.page = C($.jgrid.getXmlData(a, i.page), e.p.page), e.p.lastpage = C($.jgrid.getXmlData(a, i.total), 1), e.p.records = C($.jgrid.getXmlData(a, i.records)), $.isFunction(i.userdata) ? e.p.userData = i.userdata.call(e, a) || {} : $.jgrid.getXmlData(a, i.userdata, !0).each(function() {
							...
							var N, P, Q = M.length,
								...
								V = $(e).find("tbody:first"),
								W = !1;
							if (e.p.grouping && (W = !0 === e.p.groupingView.groupCollapse, N = $.jgrid.getMethod("groupingPrepare")), Q > 0 && e.p.page <= 0 && (e.p.page = 1), M && Q) {
								d && (T *= d + 1);
								for (var X = $.isFunction(e.p.afterInsertRow), Y = A ? m(n, "rownumBox", !1, "jqgrid-rownum") : "", Z = y ? m(n, "multiBox", !1, "cbox") : ""; R < Q;) {
									...
									var aa = E.length;
									if (E.push(""), A && E.push(I(0, R, e.p.page, e.p.rowNum, Y)), y && E.push(H(v, A, R, P, Z)), z && E.push(q.call(w, y + A, R + b)), i.repeatitems) {
										t || (t = K(y + z + A));
										var ba = $.jgrid.getXmlData(u, i.cell, !0);
										$.each(t, function(a) {
											var c = ba[this];
											if (!c) return !1;
											p = c.textContent || c.text || "", D[e.p.colModel[a + y + z + A].name] = p, E.push(G(v, p, a + y + z + A, R + b, u, D))
										})
									} else
										for (l = 0; l < B.length; l++) p = $.jgrid.getXmlData(u, B[l]), D[e.p.colModel[l + y + z + A].name] = p, E.push(G(v, p, l + y + z + A, R + b, u, D));
									if (E[aa] = O(v, W, F, D, u), E.push("</tr>"), e.p.grouping && (S.push(E), e.p.groupingView._locgr || N.call(w, D, R), E = []), (g || !0 === e.p.treeGrid && !e.p._ald) && (D[h] = $.jgrid.stripPref(e.p.idPrefix, v), e.p.data.push(D), e.p._index[D[h]] = e.p.data.length - 1), !1 === e.p.gridview && (V.append(E.join("")), w.triggerHandler("jqGridAfterInsertRow", [v, D, u]), X && e.p.afterInsertRow.call(e, v, D, u), E = []), D = {}, x++, R++, x === T) break
								}
							}
							...
							if (e.p.reccount = x, e.p.treeANode = -1, e.p.userDataOnFooter && w.jqGrid("footerData", "set", e.p.userData, e.p.formatFooterData), e.p.userDataOnHeader && w.jqGrid("headerData", "set", e.p.userData, e.p.formatHeaderData), g && (e.p.records = Q, e.p.lastpage = Math.ceil(Q / T)), c || e.updatepager(!1, !0), j && _(!0), g) {
								for (; x < Q;) {
									if (u = M[x], v = s(u, x + U), v = e.p.idPrefix + v, i.repeatitems) {
										...
										for (l = 0; l < B.length; l++) p = $.jgrid.getXmlData(u, B[l]), D[e.p.colModel[l + y + z + A].name] = p;
									D[h] = $.jgrid.stripPref(e.p.idPrefix, v), e.p.grouping && N.call(w, D, x), e.p.data.push(D), e.p._index[D[h]] = e.p.data.length - 1, D = {}, x++
								}
					...
					S = function(a, b, c, d) {
						...
						if (a) {
							...
							var i, k, l, o, q, r, s, t, u, v, w, x, y, z = "_id_",
								A = "local" !== e.p.datatype && e.p.loadonce || "jsonstring" === e.p.datatype,
								B = $(e),
								D = 0,
								E = [],
								F = e.p.multiselect ? 1 : 0,
								M = !0 === e.p.subGrid ? 1 : 0,
								N = !0 === e.p.rownumbers ? 1 : 0,
								P = e.p.scroll && "local" !== e.p.datatype ? $.jgrid.randId() : 1,
								Q = parseInt(e.p.rowNum, 10),
								R = !1,
								S = K(F + M + N),
								T = J(h),
								U = {},
							...
							for (A && (e.p.data = [], e.p._index = {}, e.p.localReader.id = z), e.p.reccount = 0, e.p.page = C($.jgrid.getAccessor(a, g.page), e.p.page), e.p.lastpage = C($.jgrid.getAccessor(a, g.total), 1), e.p.records = C($.jgrid.getAccessor(a, g.records)), e.p.userData = $.jgrid.getAccessor(a, g.userdata) || {}, M && (q = $.jgrid.getMethod("addSubGridCell")), v = !1 === e.p.keyName ? $.isFunction(g.id) ? g.id.call(e, a) : g.id : e.p.keyName, g.repeatitems && e.p.keyName && isNaN(v) && (v = e.p.keyIndex), u = $.jgrid.getAccessor(a, g.root), null == u && $.isArray(a) && (u = a), u || (u = []), t = u.length, k = 0, t > 0 && e.p.page <= 0 && (e.p.page = 1), d && (Q *= d + 1), "local" !== e.p.datatype || e.p.deselectAfterSort || (R = !0), e.p.grouping && (Z = !0 === e.p.groupingView.groupCollapse, y = $.jgrid.getMethod("groupingPrepare")); k < t;) {
								...
								var ea = V.length;
								for (V.push(""), N && V.push(I(0, k, e.p.page, e.p.rowNum, ba)), F && V.push(H(x, N, k, r, ca)), M && V.push(q.call(B, F + N, k + b)), s = T, g.repeatitems && (g.cell && (o = $.jgrid.getAccessor(o, g.cell) || o), $.isArray(o) && (s = S)), l = 0; l < s.length; l++) i = $.jgrid.getAccessor(o, s[l]), U[e.p.colModel[l + F + M + N].name] = i, V.push(G(x, i, l + F + M + N, k + b, o, U));
								if (V[ea] = O(x, Z, r ? W + " " + p : W, U, o), V.push("</tr>"), e.p.grouping && (Y.push(V), e.p.groupingView._locgr || y.call(B, U, k), V = []), (A || !0 === e.p.treeGrid && !e.p._ald) && (U[z] = $.jgrid.stripPref(e.p.idPrefix, x), e.p.data.push(U), e.p._index[U[z]] = e.p.data.length - 1), !1 === e.p.gridview && (aa.append(V.join("")), B.triggerHandler("jqGridAfterInsertRow", [x, U, o]), X && e.p.afterInsertRow.call(e, x, U, o), V = []), U = {}, D++, k++, D === Q) break
							}
							if (j = e.p.multiselect && (e.p.preserveSelection || R) && D === j, !0 === e.p.gridview && (w = e.p.treeANode > -1 ? e.p.treeANode : 0, e.p.grouping ? A || (B.jqGrid("groupingRender", Y, e.p.colModel.length, e.p.page, Q), Y = null) : !0 === e.p.treeGrid && w > 0 ? $(e.rows[w]).after(V.join("")) : (aa.append(V.join("")), e.grid.cols = e.rows[0].cells)), e.p.totaltime = new Date - f, V = null, D > 0 && 0 === e.p.records && (e.p.records = t), !0 === e.p.treeGrid) try {
								B.jqGrid("setTreeNode", w + 1, D + w + 1)
							} catch (a) {}
							if (e.p.reccount = D, e.p.treeANode = -1, e.p.userDataOnFooter && B.jqGrid("footerData", "set", e.p.userData, e.p.formatFooterData), e.p.userDataOnHeader && B.jqGrid("headerData", "set", e.p.userData, e.p.formatHeaderData), A && (e.p.records = t, e.p.lastpage = Math.ceil(t / Q)), c || e.updatepager(!1, !0), j && _(!0), A) {
								for (; D < t && u[D];) {
									if (o = u[D], void 0 === (x = $.jgrid.getAccessor(o, v)) && ("number" == typeof v && null != e.p.colModel[v + F + M + N] && (x = $.jgrid.getAccessor(o, e.p.colModel[v + F + M + N].name)), void 0 === x && (x = P + D, 0 === E.length && g.cell))) {
										var fa = $.jgrid.getAccessor(o, g.cell) || o;
										x = null != fa && void
										0 !== fa[v] ? fa[v] : x, fa = null
									}
									if (o) {
										for (x = e.p.idPrefix + x, s = T, g.repeatitems && (g.cell && (o = $.jgrid.getAccessor(o, g.cell) || o), $.isArray(o) && (s = S)), l = 0; l < s.length; l++) U[e.p.colModel[l + F + M + N].name] = $.jgrid.getAccessor(o, s[l]);
										U[z] = $.jgrid.stripPref(e.p.idPrefix, x), e.p.grouping && y.call(B, U, D), e.p.data.push(U), e.p._index[U[z]] = e.p.data.length - 1, U = {}
									}
									D++
								}
					...
					T = function(a) {
						...
						b(a) {
							...
							if (null != a.rules) try {
								...
								for (c = 0; c < a.rules.length; c++) {
									...
									0 !== e.p.customFilterDef[h.op] && $.isFunction(e.p.customFilterDef[h.op].action) && (s = s.user.call(e, h.op, h.field, h.data));
									j++
								}
								f && s.orEnd()
							} catch (a) {
						...
						if ($.isArray(e.p.data)) {
							...
							var r = {
									...
									ni: function(a, b) {
										return "OR" === b ? a.orNot().inData : a.andNot().inData
									},
									in : function(a) {
										return a.inData
									},
							...
							if (e.p.treeGrid && "nested" === e.p.treeGridModel && s.orderBy(e.p.treeReader.left_field, "asc", "integer", "", null), e.p.treeGrid && "adjacency" === e.p.treeGridModel && (n = 0, h = null), e.p.grouping)
							...
							if ((e.p.search || e.p.resetsearch) && e.p.grouping && e.p.groupingView._locgr) {
								...
								for (C = 0; C < y; C++) {
									if (E)
										for (D in e.p.userData) e.p.userData.hasOwnProperty(D) && (e.p.userData[D] += parseFloat(u[C][D] || 0));
									F.call($(e), u[C], C, x)
								}
							}
					...
					U = function(a, b) {
						var c, d, g, h, i, j, k, l, p = "",
							r = e.p.pager ? e.p.pager.substring(1) : "",
							s = r ? "_" + r : "",
							t = e.p.toppager ? "_" + e.p.toppager.substr(1) : "";
						if (g = parseInt(e.p.page, 10) - 1, g < 0 && (g = 0), g *= parseInt(e.p.rowNum, 10), i = g + e.p.reccount, e.p.scroll) {
							var u = $("tbody:first > tr:gt(0)", e.grid.bDiv);
							i > e.p.records && (i = e.p.records), g = i - u.length, e.p.reccount = u.length;
							var v = u.outerHeight() || e.grid.prevRowHeight;
							if (v) {
								var w = g * v,
									x = parseInt(e.p.records, 10) * v;
								$(">div:first", e.grid.bDiv).css({
									height: x
								}).children("div:first").css({
									height: w,
									display: w ? "" : "none"
								}), 0 === e.grid.bDiv.scrollTop && e.p.page > 1 && (e.grid.bDiv.scrollTop = e.p.rowNum * (e.p.page - 1) * v)
							}
							e.grid.bDiv.scrollLeft = e.grid.hDiv.scrollLeft
						}
						if (p = e.p.pager || "", p += e.p.toppager ? p ? "," + e.p.toppager : e.p.toppager : "") {
							if (k = $.jgrid.getRegional(e, "formatter.integer"), c = C(e.p.page), d = C(e.p.lastpage), $(".selbox", p)[this.p.useProp ? "prop" : "attr"]("disabled", !1), !0 === e.p.pginput && ($("#input" + s).html($.jgrid.template($.jgrid.getRegional(e, "defaults.pgtext", e.p.pgtext) || "", "<input " + m(n, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + r + "'></span>")), e.p.toppager && $("#input_t" + t).html($.jgrid.template($.jgrid.getRegional(e, "defaults.pgtext", e.p.pgtext) || "", "<input " + m(n, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + r + "_toppager'></span>")), $(".ui-pg-input", p).val(e.p.page), l = e.p.toppager ? "#sp_1" + s + ",#sp_1" + s + "_toppager" : "#sp_1" + s, $(l).html($.fmatter ? $.fmatter.util.NumberFormat(e.p.lastpage, k) : e.p.lastpage)), e.p.viewrecords)
								if (0 === e.p.reccount) $(".ui-paging-info", p).html($.jgrid.getRegional(e, "defaults.emptyrecords", e.p.emptyrecords));
								else {
									h = g + 1, j = e.p.records, $.fmatter && (h = $.fmatter.util.NumberFormat(h, k), i = $.fmatter.util.NumberFormat(i, k), j = $.fmatter.util.NumberFormat(j, k));
									var y = $.jgrid.getRegional(e, "defaults.recordtext", e.p.recordtext);
									$(".ui-paging-info", p).html($.jgrid.template(y, h, i, j))
						...
						if (!0 === a && !0 === e.p.rownumbers && $(">td.jqgrid-rownum", e.rows).each(function(a) {
								$(this).html(g + 1 + a)
							}), 0 === e.p.reccount) {
							var z = m(n, "rowBox", !0, "jqgrow ui-row-" + e.p.direction),
								A = O("norecs", !1, z, {}, "");
							A += "<td style='text-align:center' colspan='" + f.headers.length + "'>" + $.jgrid.getRegional(e, "defaults.emptyrecords", e.p.emptyrecords) + "</td>", A += "</tr>", $("table:first", f.bDiv).append(A)
						}
					...
					Y = function(a, b) {
						$(e).triggerHandler("jqGridLoadComplete", [a]), b && e.p.loadComplete.call(e, a), $(e).triggerHandler("jqGridAfterLoadComplete", [a]), e.p.datatype = "local", e.p.datastr = null, W()
					},
					Z = function(a) {
						if (!e.grid.hDiv.loading) {
							...
							if (a = a || 1, a > 1 ? null !== g.npage ? (f[g.npage] = a, k = a - 1, a = 1) : i = function(b) {
									e.p.page++, e.grid.hDiv.loading = !1, h && e.p.loadComplete.call(e, b), Z(a - 1)
								} : null !== g.npage && delete e.p.postData[g.npage], e.p.grouping) {
								$(e).jqGrid("groupingSetup");
								var l, m = e.p.groupingView,
									n = "",
									o = [];
								for (l = 0; l < m.groupField.length; l++) {
									var p = m.groupField[l];
									$.each(e.p.colModel, function(a, b) {
										b.name === p && b.index && (p = b.index)
									}), o.push(p + " " + m.groupOrder[l])
								}
								n = o.join(), "" !== $.trim(f[g.sort]) ? f[g.sort] = n + " ," + f[g.sort] : (f[g.sort] = n, f[g.order] = "")
							}
							$.extend(e.p.postData, f);
							var q = e.p.scroll ? e.rows.length - 1 : 1;
							if ($.isFunction(e.p.datatype)) return void
							e.p.datatype.call(e, e.p.postData, "load_" + e.p.id, q, a, k);
							var r = $(e).triggerHandler("jqGridBeforeRequest");
							if (!1 === r || "stop" === r) return;
							...
							switch ($.isFunction(e.treeGrid_beforeRequest) && e.treeGrid_beforeRequest.call(e), b = e.p.datatype.toLowerCase()) {
								...
								case "script":
									...
									break;
								case "xmlstring":
									if (V(), c = "string" != typeof e.p.datastr ? e.p.datastr : $.parseXML(e.p.datastr), !X(c, 200, null)) return void
									W();
									R(c), Y(c, h);
									break;
								case "jsonstring":
									if (V(), c = "string" == typeof e.p.datastr ? $.jgrid.parse(e.p.datastr) : e.p.datastr, !X(c, 200, null)) return void
									W();
									S(c), Y(c, h);
									break;
								case "local":
								case "clientside":
									V(), e.p.datatype = "local", e.p._ald = !0;
									var s = T(!1);
									if (!X(s, 200, null)) return void
									W();
									S(s, q, a > 1, k), $(e).triggerHandler("jqGridLoadComplete", [s]), i && i.call(e, s), $(e).triggerHandler("jqGridAfterLoadComplete", [s]), d && e.grid.populateVisible(), W(), e.p._ald = !1
							}
							e.p._sort = !1
						}
					},
					...
					aa = function(a, b) {
						var c, d, f, g, h, j, k, l, p = "<td class='ui-pg-button " + o + "'><span class='ui-separator'></span></td>",
							r = "",
							t = "<table class='ui-pg-table ui-common-table ui-paging-pager'><tbody><tr>",
							u = "",
							v = function(a, b) {
								var c;
								return "stop" !== (c = $(e).triggerHandler("jqGridPaging", [a, b])) && ($.isFunction(e.p.onPaging) && (c = e.p.onPaging.call(e, a, b)), "stop" !== c && (e.p.selrow = null, e.p.multiselect && (e.p.preserveSelection || (e.p.selarrrow = []), _(!1)), e.p.savedRow = [], !0))
							};
						if (b += "_" + a, c = "pg_" + a, d = a + "_left", f = a + "_center", g = a + "_right", $("#" + $.jgrid.jqID(a)).append("<div id='" + c + "' class='ui-pager-control' role='group'><table " + m(n, "pagerTable", !1, "ui-pg-table ui-common-table ui-pager-table") + "><tbody><tr><td id='" + d + "' align='left'></td><td id='" + f + "' align='center' style='white-space:pre;'></td><td id='" + g + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr"), e.p.rowList.length > 0) {
							u = '<td dir="' + i + '">', u += "<select " + m(n, "pgSelectBox", !1, "ui-pg-selbox") + ' size="1" role="listbox" title="' + ($.jgrid.getRegional(e, "defaults.pgrecs", e.p.pgrecs) || "") + '">';
							var w;
							for (k = 0; k < e.p.rowList.length; k++) w = e.p.rowList[k].toString().split(":"), 1 === w.length && (w[1] = w[0]), u += '<option role="option" value="' + w[0] + '"' + (C(e.p.rowNum, 0) === C(w[0], 0) ? ' selected="selected"' : "") + ">" + w[1] + "</option>";
							u += "</select></td>"
						}
						if ("rtl" === i && (t += u), !0 === e.p.pginput && (r = "<td id='input" + b + "' dir='" + i + "'>" + $.jgrid.template($.jgrid.getRegional(e, "defaults.pgtext", e.p.pgtext) || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(a) + "'></span>") + "</td>"), !0 === e.p.pgbuttons) {
							var x = ["first" + b, "prev" + b, "next" + b, "last" + b],
								y = m(n, "pgButtonBox", !0, "ui-pg-button"),
								z = [$.jgrid.getRegional(e, "defaults.pgfirst", e.p.pgfirst) || "", $.jgrid.getRegional(e, "defaults.pgprev", e.p.pgprev) || "", $.jgrid.getRegional(e, "defaults.pgnext", e.p.pgnext) || "", $.jgrid.getRegional(e, "defaults.pglast", e.p.pglast) || ""];
							"rtl" === i && (x.reverse(), z.reverse()), t += "<td id='" + x[0] + "' class='" + y + "' title='" + z[0] + "'><span " + m(n, "icon_first", !1, s) + "></span></td>", t += "<td id='" + x[1] + "' class='" + y + "'  title='" + z[1] + "'><span " + m(n, "icon_prev", !1, s) + "></span></td>", t += "" !== r ? p + r + p : "", t += "<td id='" + x[2] + "' class='" + y + "' title='" + z[2] + "'><span " + m(n, "icon_next", !1, s) + "></span></td>", t += "<td id='" + x[3] + "' class='" + y + "' title='" + z[3] + "'><span " + m(n, "icon_end", !1, s) + "></span></td>"
						} else "" !== r && (t += r);
						"ltr" === i && (t += u), t += "</tr></tbody></table>", a = $.jgrid.jqID(a), c = $.jgrid.jqID(c), !0 === e.p.viewrecords && $("td#" + a + "_" + e.p.recordpos, "#" + c).append("<div dir='" + i + "' style='text-align:" + e.p.recordpos + "' class='ui-paging-info'></div>"), $("td#" + a + "_" + e.p.pagerpos, "#" + c).append(t), j = $("#gbox_" + $.jgrid.jqID(e.p.id)).css("font-size") || "11px", $("#gbox_" + $.jgrid.jqID(e.p.id)).append("<div id='testpg' " + m(n, "entrieBox", !1, "ui-jqgrid") + " style='font-size:" + j + ";visibility:hidden;' ></div>"), h = $(t).clone().appendTo("#testpg").width(), $("#testpg").remove(), h > 0 && ("" !== r && (h += 50), l = h > $("td#" + a + "_" + e.p.pagerpos, "#" + c).innerWidth(), $("td#" + a + "_" + e.p.pagerpos, "#" + c).width(h)), e.p._nvtd = [], e.p._nvtd[0] = h ? Math.floor((e.p.width - h) / 2) : Math.floor(e.p.width / 3), e.p._nvtd[1] = 0, t = null, $(".ui-pg-selbox", "#" + c).on("change", function() {
							return !!v("records", this) && (e.p.page = Math.round(e.p.rowNum * (e.p.page - 1) / this.value - .5) + 1, e.p.rowNum = this.value, e.p.pager && $(".ui-pg-selbox", e.p.pager).val(this.value), e.p.toppager && $(".ui-pg-selbox", e.p.toppager).val(this.value), Z(), !1)
							...
							var a = C(e.p.page, 1),
								...
								h = !0,
								i = !0;
							return 0 === c || 1 === c ? (f = !1, g = !1, h = !1, i = !1) : c > 1 && a >= 1 ? 1 === a ? (f = !1, g = !1) : a === c && (h = !1, i = !1) : c > 1 && 0 === a && (h = !1, i = !1, a = c - 1), !!v(this.id.split("_")[0], this) && (this.id === "first" + b && f && (e.p.page = 1, d = !0), this.id === "prev" + b && g && (e.p.page = a - 1, d = !0), this.id === "next" + b && h && (e.p.page = a + 1, d = !0), this.id === "last" + b && i && (e.p.page = c, d = !0), d && Z(), $.jgrid.setSelNavIndex(e, this), !1)
						})), !0 === e.p.pginput && $("#" + c).on("keypress", "input.ui-pg-input", function(a) {
							return 13 === (a.charCode || a.keyCode || 0) ? !!v("user", this) && ($(this).val(C($(this).val(), 1)), e.p.page = $(this).val() > 0 ? $(this).val() : e.p.page, Z(), !1) : this
						}), l && e.p.responsive && !e.p.forcePgButtons && ($("#" + x[0] + ",#" + x[3] + ",#input" + $.jgrid.jqID(b)).hide(), $(".ui-paging-info", "td#" + a + "_" + e.p.recordpos).hide(), $(".ui-pg-selbox", "td#" + a + "_" + e.p.pagerpos).hide())
					},
					ba = function(a, b, c) {
						var d, f = e.p.colModel,
							g = e.p.frozenColumns ? b : e.grid.headers[a].el,
							h = "";
						$("span.ui-grid-ico-sort", g).addClass(o), $(g).attr({
							"aria-selected": "false",
							"aria-sort": "none"
						}), d = f[a].index || f[a].name, void
						0 === c ? f[a].lso ? "asc" === f[a].lso ? (f[a].lso += "-desc", h = "desc") : "desc" === f[a].lso ? (f[a].lso += "-asc", h = "asc") : "asc-desc" !== f[a].lso && "desc-asc" !== f[a].lso || (f[a].lso = "") : f[a].lso = h = f[a].firstsortorder || "asc" : f[a].lso = h = c, h ? ($("span.s-ico", g).show(), $("span.ui-icon-" + h, g).removeClass(o), $(g).attr({
							"aria-selected": "true",
							"aria-sort": h + "ending"
						})) : e.p.viewsortcols[0] || $("span.s-ico", g).hide();
						var i = v.indexOf(d); - 1 === i ? (v.push(d), w.push(h)) : h ? w[i] = h : (w.splice(i, 1), v.splice(i, 1)), e.p.sortorder = "", e.p.sortname = "";
					...
					ca = function(a, b, c, d, f) {
						if (e.p.colModel[b].sortable && !(e.p.savedRow.length > 0)) {
							if (c || (e.p.lastsort === b && "" !== e.p.sortname ? "asc" === e.p.sortorder ? e.p.sortorder = "desc" : "desc" === e.p.sortorder && (e.p.sortorder = "asc") : e.p.sortorder = e.p.colModel[b].firstsortorder || "asc", e.p.page = 1), e.p.multiSort) ba(b, f, d);
							else {
								if (d) {
								...
								g = $(h).find("span.ui-grid-ico-sort"), g.addClass(o), j && $(g).css("display", "none"), $(h).attr({
									"aria-selected": "false",
									"aria-sort": "none"
								}), e.p.frozenColumns && (g = e.grid.fhDiv.find("span.ui-grid-ico-sort"), g.addClass(o), j && g.css("display", "none"), e.grid.fhDiv.find("th").attr({
									"aria-selected": "false",
									"aria-sort": "none"
								})), g = $(i).find("span.ui-icon-" + e.p.sortorder), g.removeClass(o), j && g.css("display", ""), $(i).attr({
									"aria-selected": "true",
									"aria-sort": e.p.sortorder + "ending"
								}), e.p.viewsortcols[0] || (e.p.lastsort !== b ? (e.p.frozenColumns && e.grid.fhDiv.find("span.s-ico").hide(), $("span.s-ico", h).hide(), $("span.s-ico", i).show()) : "" === e.p.sortname && $("span.s-ico", i).show()), a = a.substring(5 + e.p.id.length + 1), e.p.sortname = e.p.colModel[b].index || a
							}
							...
							if (_(!1), "local" === e.p.datatype ? e.p.deselectAfterSort && !e.p.preserveSelection && $(e).jqGrid("resetSelection") : (e.p.selrow = null, e.p.multiselect && (e.p.preserveSelection || (e.p.selarrrow = [])), e.p.savedRow = []), e.p.scroll) {
								var k = e.grid.bDiv.scrollLeft;
								L.call(e, !0, !1), e.grid.hDiv.scrollLeft = k
							}
							e.p.subGrid && "local" === e.p.datatype && $("td.sgexpanded", "#" + $.jgrid.jqID(e.p.id)).each(function() {
								$(this).trigger("click")
							}), e.p._sort = !0, Z(), e.p.lastsort = b, e.p.sortname !== a && b && (e.p.lastsort = b)
						}
					},
					da = function() {
						var a, b, c, d, g, h = 0,
							i = $.jgrid.cell_width ? 0 : C(e.p.cellLayout, 0),
							j = 0,
							k = C(e.p.scrollOffset, 0),
							l = !1,
							m = 0;
						...
						}), isNaN(e.p.width) && (e.p.width = h + (!1 !== e.p.shrinkToFit || isNaN(e.p.height) ? 0 : k)), f.width = parseInt(e.p.width, 10), e.p.tblwidth = h, !1 === e.p.shrinkToFit && !0 === e.p.forceFit && (e.p.forceFit = !1), !0 === e.p.shrinkToFit && j > 0 && (c = f.width - i * j - m, isNaN(e.p.height) || (c -= k, l = !0), h = 0, $.each(e.p.colModel, function(d) {
							!1 !== this.hidden || this.fixed || (b = Math.round(c * this.width / (e.p.tblwidth - i * j - m)), this.width = b, h += b, a = d)
						}), d = 0, g = 0 === Ha ? -1 : 0, l ? f.width - m - (h + i * j) !== k && (d = f.width - m - (h + i * j) - k) : l || 0 === Math.abs(f.width - m - (h + i * j)) || (d = f.width - m - (h + i * j) - Ha), e.p.colModel[a].width += d + g, e.p.tblwidth = h + d + i * j + m, e.p.tblwidth > e.p.width && (e.p.colModel[a].width -= e.p.tblwidth - parseInt(e.p.width, 10), e.p.tblwidth = e.p.width))
					},
					ea = function(a) {
						var b, c = a,
							d = a;
					...
					ha = function(a, b, c, d) {
						var f, g, h = e.p.colModel,
							i = h.length,
							j = [],
							k = !0,
							l = [],
							m = $.jgrid.getRegional(e, "colmenu"),
							n = '<ul id="col_menu" class="ui-search-menu  ui-col-menu modal-content" role="menu" tabindex="0" style="left:' + b + 'px;">';
						for (d.columns_selectAll && (n += '<li class="ui-menu-item disabled" role="presentation" draggable="false"><a class="g-menu-item" tabindex="0" role="menuitem" ><table class="ui-common-table" ><tr><td class="menu_icon" title="' + m.reorder + '"><span class="' + s + " " + t.icon_move + ' notclick" style="visibility:hidden"></span></td><td class="menu_icon"><input id="chk_all" class="' + t.input_checkbox + '" type="checkbox" name="check_all"></td><td class="menu_text">Check/Uncheck</td></tr></table></a></li>'), f = 0; f < i; f++) {
							var o = h[f].hidden ? "" : "checked",
								p = h[f].name,
								r = e.p.colNames[f];
							g = "cb" === p || "subgrid" === p || "rn" === p || h[f].hidedlg ? "style='display:none'" : "", n += "<li " + g + ' class="ui-menu-item" role="presentation" draggable="true"><a class="g-menu-item" tabindex="0" role="menuitem" ><table class="ui-common-table" ><tr><td class="menu_icon" title="' + m.reorder + '"><span class="' + s + " " + t.icon_move + ' notclick"></span></td><td class="menu_icon"><input class="' + t.input_checkbox + ' chk_selected" type="checkbox" name="' + p + '" ' + o + '></td><td class="menu_text">' + r + "</td></tr></table></a></li>", j.push(f), "" === g && l.push(p), k && "" === o && (k = !1)
						}
						n += "</ul>", $(c).append(n), $("#col_menu").addClass("ui-menu " + t.menu_widget), $("#chk_all", "#col_menu").prop("checked", k), $.jgrid.isElementInViewport($("#col_menu")[0]) || $("#col_menu").css("left", -parseInt($("#column_menu").innerWidth(), 10) + "px"), $.fn.html5sortable() && $("#col_menu").html5sortable({
							handle: "span",
							items: ":not(.disabled)",
							forcePlaceholderSize: !0
						}).on("sortupdate", function(a, b) {
							for (j.splice(b.startindex, 1), j.splice(b.endindex, 0, b.startindex), $(e).jqGrid("destroyFrozenColumns"), $(e).jqGrid("remapColumns", j, !0), $(e).triggerHandler("jqGridColMenuColumnDone", [j, null, null]), $.isFunction(e.p.colMenuColumnDone) && e.p.colMenuColumnDone.call(e, j, null, null), $(e).jqGrid("setFrozenColumns"), f = 0; f < i; f++) j[f] = f
						}), $("#col_menu > li > a").on("click", function(a) {
							var b, c;
							$(a.target).hasClass("notclick") || ($(a.target).is(":input") ? b = $(a.target).is(":checked") : (b = !$("input", this).is(":checked"), $("input", this).prop("checked", b)), c = $("input", this).attr("name"), "check_all" === c ? b ? ($("input", "#col_menu").prop("checked", !0), $(e).jqGrid("showCol", l)) : ($("input", "#col_menu").prop("checked", !1), $(e).jqGrid("hideCol", l)) : ($(e).triggerHandler("jqGridColMenuColumnDone", [j, c, b]), $.isFunction(e.p.colMenuColumnDone) && e.p.colMenuColumnDone.call(e, j, c, b), b ? ($(e).jqGrid("showCol", c), $(this).parent().attr("draggable", "true")) : ($(e).jqGrid("hideCol", c), $(this).parent().attr("draggable", "false")), d.columns_selectAll && $("#chk_all", "#col_menu").prop("checked", $(".chk_selected:checked", "#col_menu").length === $(".chk_selected", "#col_menu").length)))
						}).hover(function() {
							$(this).addClass(q)
						}, function() {
							$(this).removeClass(q)
					...
					ia = function(a, b, c, d) {
						...
						if (k) {
							...
							$(A).addClass(t.filter_input), x = $("<div></div>").append(A), j.append(x), x = '<div><select size="1" id="operand" class="' + t.filter_select + '">', $.each(h, function(a, b) {
								...
								e.p.colFilters[k.name] = {}, e.p.postData.filters = ja(), e.p.search = !1, $(e).trigger("reloadGrid"), $("#column_menu").remove()
								...
								}, e.p.postData.filters = ja(), e.p.search = !0, $(e).trigger("reloadGrid"), $("#column_menu").remove()
							})
						}
					},
					ja = function() {
					...
					ma = function(a, b, c) {
						var d = $(f.hDiv).height();
						$(".ui-search-toolbar", f.hDiv)[0] && !isNaN($(".ui-search-toolbar", f.hDiv).height()) && (d -= $(".ui-search-toolbar", f.hDiv).height()), $(f.cDiv).is(":hidden") || (d += $(f.cDiv).outerHeight()), e.p.toolbar[1] && "bottom" !== e.p.toolbar[2] && null !== $(f.uDiv) && (d += $(f.uDiv).outerHeight()), e.p.toppager && (d += $("#" + $.jgrid.jqID(e.p.id) + "_toppager").outerHeight()), b = parseInt(b, 10), c = d;
						var g, h, i = '<ul id="column_menu" role="menu" tabindex="0">',
							j = "",
							k = "</ul>",
							l = "",
							m = e.p.colModel[a],
						...
						$("#column_menu > li > a").hover(function() {
							...
							var b, c;
							"columns" === $(this).attr("data-value") && (b = $(this).parent().width() + 8, c = $(this).parent().position().top - 5, ha(c, b, $(this).parent(), n)), "filtering" === $(this).attr("data-value") && (b = $(this).parent().width() + 8, c = $(this).parent().position().top - 5, ia(a, c, b, $(this).parent())), $(this).addClass(q)
						}, function() {
							$(this).removeClass(q)
						}).click(function() {
							var b = $(this).attr("data-value"),
								c = e.grid.headers[a].el;
							if ("sortasc" === b ? ca("jqgh_" + e.p.id + "_" + m.name, a, !0, "asc", c) : "sortdesc" === b ? ca("jqgh_" + e.p.id + "_" + m.name, a, !0, "desc", c) : "grouping" === b ? ka(a, g) : "freeze" === b && la(a, h), -1 === b.indexOf("sort") && "grouping" !== b && "freeze" !== b || $(this).remove(), e.p.colMenuCustom.hasOwnProperty(b)) {
				...
				e.p.sortorder = e.p.sortorder.toLowerCase(), $.jgrid.cell_width = $.jgrid.cellWidth();
				var na = $("<table style='visibility:hidden'><tr class='jqgrow'><td>1</td></tr></table)").addClass(m(n, "rowTable", !0, "ui-jqgrid-btable ui-common-table"));
				if ($(y).append(na), e.p.cellLayout = parseInt($("td", na).css("padding-left"), 10) + parseInt($("td", na).css("padding-right"), 10) + 1, e.p.cellLayout <= 0 && (e.p.cellLayout = 5), $(na).remove(), na = null, !0 === e.p.grouping && (e.p.scroll = !1, e.p.rownumbers = !1, e.p.treeGrid = !1, e.p.gridview = !0), !0 === this.p.treeGrid) {
					try {
						$(this).jqGrid("setTreeGrid")
					} catch (a) {}
					"local" !== e.p.datatype ? e.p.localReader = {
						id: "_id_"
					} : !1 !== e.p.keyName && (e.p.localReader = {
						id: e.p.keyName
					})
				}
				...
				}, e.p.localReader), e.p.scroll && (e.p.pgbuttons = !1, e.p.pginput = !1, e.p.rowList = []), e.p.data.length && (M(), N());
				var oa, pa, qa, ra, sa, ta, ua, va, wa, xa = "<thead><tr class='ui-jqgrid-labels' role='row'>",
					ya = "",
					za = "",
					Aa = "";
				...
				if (xa += "</tr></thead>", va = null, wa = null, $(this).append(xa), $("thead tr:first th", this).hover(function() {
					...
					$("#cb_" + $.jgrid.jqID(e.p.id), this).on("click", function() {
						...
						}), Ca = !0, Da = []) : ($(e.rows).each(function(b) {
							if (b > 0 && !($(this).hasClass("ui-subgrid") || $(this).hasClass("jqgroup") || $(this).hasClass(o) || $(this).hasClass("jqfoot"))) {
								if ($("#jqg_" + $.jgrid.jqID(e.p.id) + "_" + $.jgrid.jqID(this.id))[e.p.useProp ? "prop" : "attr"]("checked", !1), $(this).removeClass(p).attr("aria-selected", "false"), Da.push(this.id), e.p.preserveSelection) {
						...
						}), e.p.selrow = null, Ca = !1), $(e).triggerHandler("jqGridSelectAll", [Ca ? e.p.selarrrow : Da, Ca]), $.isFunction(e.p.onSelectAll) && e.p.onSelectAll.call(e, Ca ? e.p.selarrrow : Da, Ca)
					})
				}
				if (!0 === e.p.autowidth) {
					var Ea = $(y).parent().width();
					wa = $(window).width(), e.p.width = wa - Ea > 3 ? Ea : wa
				}
				var Fa = "",
					Ga = "",
					Ha = -1 === e.p.styleUI.search("Bootstrap") || isNaN(e.p.height) ? 0 : 2;
				da(), na = -1 !== e.p.styleUI.search("Bootstrap"), $(y).css("width", f.width + "px").append("<div class='ui-jqgrid-resize-mark' id='rs_m" + e.p.id + "'>&#160;</div>"), e.p.scrollPopUp && $(y).append("<div " + m(n, "scrollBox", !1, "loading ui-scroll-popup") + " id='scroll_g" + e.p.id + "'></div>"), $(l).css("width", f.width + "px"), xa = $("thead:first", e).get(0), e.p.footerrow && (Fa += "<table role='presentation' style='width:" + e.p.tblwidth + "px' " + m(n, "footerTable", !1, "ui-jqgrid-ftable ui-common-table") + "><tbody><tr role='row' " + m(n, "footerBox", !1, "footrow footrow-" + i) + ">"), e.p.headerrow && (Ga += "<table role='presentation' style='width:" + e.p.tblwidth + "px' " + m(n, "headerRowTable", !1, "ui-jqgrid-hrtable ui-common-table") + "><tbody><tr role='row' " + m(n, "headerRowBox", !1, "hrheadrow hrheadrow-" + i) + ">");
				var Ia = $("tr:first", xa),
					Ja = "<tr class='jqgfirstrow' role='row'>",
					Ka = 0;
				if (e.p.disableClick = !1, $("th", Ia).each(function(a) {
						wa = e.p.colModel[a], qa = wa.width, void
						0 === wa.resizable && (wa.resizable = !0), wa.resizable ? (ra = document.createElement("span"), $(ra).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + i).css("cursor", "col-resize"), $(this).addClass(e.p.resizeclass)) : ra = "", $(this).css("width", qa + "px").prepend(ra), ra = null;
						var b = "";
						wa.hidden && ($(this).css("display", "none"), b = "display:none;"), Ja += "<td role='gridcell' style='height:0px;width:" + qa + "px;" + b + "'></td>", f.headers[a] = {
							width: qa,
							el: this
						}, "boolean" != typeof(ya = wa.sortable) && (wa.sortable = !0, ya = !0);
						var c = wa.name;
						"cb" !== c && "subgrid" !== c && "rn" !== c && e.p.viewsortcols[2] && $(">div", this).addClass("ui-jqgrid-sortable"), ya && (e.p.multiSort ? e.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), wa.lso && $("div span.ui-icon-" + wa.lso, this).removeClass(o).css("display", "")) : wa.lso && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + wa.lso, this).removeClass(o).css("display", "")) : e.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), a === e.p.lastsort && $("div span.ui-icon-" + e.p.sortorder, this).removeClass(o).css("display", "")) : a === e.p.lastsort && "" !== e.p.sortname && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + e.p.sortorder, this).removeClass(o).css("display", ""))), e.p.footerrow && (Fa += "<td role='gridcell' " + D(a, 0, "", null, "", !1) + ">&#160;</td>"), e.p.headerrow && (Ga += "<td role='gridcell' " + D(a, 0, "", null, "", !1) + ">&#160;</td>")
					}).mousedown(function(a) {
						if (1 === $(a.target).closest("th>span.ui-jqgrid-resize").length) {
							var b, c = ga(this);
							if (a.preventDefault(), Ka++, setTimeout(function() {
									Ka = 0
								}, 400), 2 !== Ka) return !0 === e.p.forceFit && (e.p.nv = ea(c)), f.dragStart(c, a, fa(c)), !1;
							try {
								!0 === e.p.colModel[c].autosize && (b = $(e).jqGrid("getCol", c, !1, "maxwidth"), $(e).jqGrid("resizeColumn", c, b + (na ? e.p.cellLayout : 0)))
							} catch (a) {} finally {
								Ka = 0
							}
						}
						...
						var g = $(a.target).closest(d);
						if (1 === g.length) {
							var h;
							if (e.p.frozenColumns) {
								var i = $(this)[0].id.substring(e.p.id.length + 1);
								$(e.p.colModel).each(function(a) {
									if (this.name === i) return h = a, !1
								})
							} else h = ga(this);
							if ($(a.target).hasClass("colmenuspan")) {
								if (null != $("#column_menu")[0] && $("#column_menu").remove(), void 0 === h) return;
								var j = $("#gbox_" + e.p.id).offset(),
									k = $(this).offset(),
									l = k.left - j.left;
								return "ltr" === e.p.direction && (l += $(this).outerWidth()), ma(h, l, 0, g), !0 === e.p.menubar && $("#" + e.p.id + "_menubar").hide(), void
								a.stopPropagation()
							}
					...
					}), wa = null, e.p.sortable && $.fn.sortable) try {
					$(e).jqGrid("sortableColumns", Ia)
				} catch (a) {}
				e.p.footerrow && (Fa += "</tr></tbody></table>"), e.p.headerrow && (Ga += "</tr></tbody></table>"), Ja += "</tr>", ua = document.createElement("tbody"), this.appendChild(ua), $(this).addClass(m(n, "rowTable", !0, "ui-jqgrid-btable ui-common-table")).append(Ja), e.p.altRows && $(this).addClass(m(n, "stripedTable", !0, "")), Ja = null;
				var La = $("<table " + m(n, "headerTable", !1, "ui-jqgrid-htable ui-common-table") + " style='width:" + e.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "'></table>").append(xa),
					Ma = !(!e.p.caption || !0 !== e.p.hiddengrid),
					Na = $("<div class='ui-jqgrid-hbox" + ("rtl" === i ? "-rtl" : "") + "'></div>");
				xa = null, f.hDiv = document.createElement("div"), f.hDiv.style.width = f.width - Ha + "px", f.hDiv.className = m(n, "headerDiv", !0, "ui-jqgrid-hdiv"), $(f.hDiv).append(Na), $(Na).append(La), La = null, Ma && $(f.hDiv).hide(), e.p.pager && ("string" == typeof e.p.pager ? "#" === e.p.pager.substr(0, 1) && (e.p.pager = e.p.pager.substring(1)) : e.p.pager = $(e.p.pager).attr("id"), $("#" + $.jgrid.jqID(e.p.pager)).css({
					width: f.width - Ha + "px"
				}).addClass(m(n, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(y), Ma && $("#" + $.jgrid.jqID(e.p.pager)).hide(), aa(e.p.pager, ""), e.p.pager = "#" + $.jgrid.jqID(e.p.pager)), !1 === e.p.cellEdit && !0 === e.p.hoverrows && $(e).on({
					mouseover: function(a) {
						ta = $(a.target).closest("tr.jqgrow"), "ui-subgrid" !== $(ta).attr("class") && $(ta).addClass(q)
					},
					mouseout: function(a) {
						ta = $(a.target).closest("tr.jqgrow"), $(ta).removeClass(q)
					}
				});
				var Oa, Pa, Qa;
				$(e).before(f.hDiv).on({
					click: function(a) {
						if (sa = a.target, ta = $(sa, e.rows).closest("tr.jqgrow"), 0 === $(ta).length || ta[0].className.indexOf(o) > -1 || ($(sa, e).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== e.id) return this;
						var c = $(sa).filter(":enabled").hasClass("cbox"),
							d = $(e).triggerHandler("jqGridBeforeSelectRow", [ta[0].id, a]);
						if (d = !1 !== d && "stop" !== d, $.isFunction(e.p.beforeSelectRow)) {
							var f = e.p.beforeSelectRow.call(e, ta[0].id, a);
							!1 !== f && "stop" !== f || (d = !1)
						}
						if ("A" !== sa.tagName && ("INPUT" !== sa.tagName && "TEXTAREA" !== sa.tagName && "OPTION" !== sa.tagName && "SELECT" !== sa.tagName || c))
							if (Oa = ta[0].id, sa = $(sa).closest("tr.jqgrow>td"), sa.length > 0 && (Pa = $.jgrid.getCellIndex(sa)), !0 !== e.p.cellEdit) {
								if (sa.length > 0 && (Qa = $(sa).closest("td,th").html(), $(e).triggerHandler("jqGridCellSelect", [Oa, Pa, Qa, a]), $.isFunction(e.p.onCellSelect) && e.p.onCellSelect.call(e, Oa, Pa, Qa, a)), d)
									if (e.p.multimail && e.p.multiselect) {
										if (a.shiftKey) {
											if (c) {
												var g = $(e).jqGrid("getGridParam", "selrow"),
													h = $(e).jqGrid("getInd", Oa),
													i = $(e).jqGrid("getInd", g),
													j = "",
													k = "";
												h > i ? (j = g, k = Oa) : (j = Oa, k = g);
												var l = !1,
													m = !1,
													n = !0;
												return $.inArray(Oa, e.p.selarrrow) > -1 && (n = !1), $.each($(this).getDataIDs(), function(a, b) {
										...
										b(Oa, c, a, !1)
									} else e.p.multikey ? a[e.p.multikey] ? $(e).jqGrid("setSelection", Oa, !0, a) : e.p.multiselect && c && (c = $("#jqg_" + $.jgrid.jqID(e.p.id) + "_" + Oa).is(":checked"), $("#jqg_" + $.jgrid.jqID(e.p.id) + "_" + Oa)[e.p.useProp ? "prop" : "attr"]("checked", !c)) : b(Oa, c, a, !0)
							} else
						if (e.p.multiselect && c && d) $(e).jqGrid("setSelection", Oa, !0, a);
						else
						if (sa.length > 0) try {
							$(e).jqGrid("editCell", ta[0].rowIndex, Pa, !0, a)
						} catch (a) {}
					},
					...
					dblclick: function(a) {
						if (sa = a.target, ta = $(sa, e.rows).closest("tr.jqgrow"), 0 !== $(ta).length) {
							Oa = ta[0].rowIndex, Pa = $.jgrid.getCellIndex(sa);
							var b = $(e).triggerHandler("jqGridDblClickRow", [$(ta).attr("id"), Oa, Pa, a]);
							return null != b ? b : $.isFunction(e.p.ondblClickRow) && null != (b = e.p.ondblClickRow.call(e, $(ta).attr("id"), Oa, Pa, a)) ? b : void
							0
						}
					},
					contextmenu: function(a) {
						if (sa = a.target, ta = $(sa, e.rows).closest("tr.jqgrow"), 0 !== $(ta).length) {
							e.p.multiselect || $(e).jqGrid("setSelection", ta[0].id, !0, a), Oa = ta[0].rowIndex, Pa = $.jgrid.getCellIndex(sa);
							var b = $(e).triggerHandler("jqGridRightClickRow", [$(ta).attr("id"), Oa, Pa, a]);
							return null != b ? b : $.isFunction(e.p.onRightClickRow) && null != (b = e.p.onRightClickRow.call(e, $(ta).attr("id"), Oa, Pa, a)) ? b : void
							0
						}
					}
					...
					width: f.width - Ha + "px"
				}).on("scroll", f.scrollGrid), $("table:first", f.bDiv).css({
				...
				var Ra = s + " " + m(n, "icon_caption_open", !0),
					Sa = s + " " + m(n, "icon_caption_close", !0);
				f.cDiv = document.createElement("div");
				var Ta = !0 === e.p.hidegrid ? $("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton " + r + "' title='" + ($.jgrid.getRegional(e, "defaults.showhide", e.p.showhide) || "") + "' />").hover(function() {
					Ta.addClass(q)
				}, function() {
					Ta.removeClass(q)
				}).append("<span class='ui-jqgrid-headlink " + Ra + "'></span>").css("rtl" === i ? "left" : "right", "0px") : "";
				if ($(f.cDiv).append(Ta).append("<span class='ui-jqgrid-title'>" + e.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === i ? "-rtl" : "") + " " + m(n, "gridtitleBox", !0)), !0 === e.p.menubar) {
					var Ua = '<ul id="' + e.p.id + '_menubar" class="ui-search-menu modal-content column-menu ui-menu jqgrid-caption-menu ' + t.menu_widget + '" role="menubar" tabindex="0"></ul>';
					$("#gbox_" + e.p.id).append(Ua), $(f.cDiv).append("<a role='link' class='ui-jqgrid-menubar menubar-" + ("rtl" === i ? "rtl" : "ltr") + "' style=''><span class='colmenuspan " + s + " " + t.icon_toolbar_menu + "'></span></a>"), $(".ui-jqgrid-menubar", f.cDiv).hover(function() {
						$(this).addClass(q)
					}, function() {
						$(this).removeClass(q)
					}).on("click", function(a) {
				...
				if (e.p.toppager && (e.p.toppager = $.jgrid.jqID(e.p.id) + "_toppager", f.topDiv = $("<div id='" + e.p.toppager + "'></div>")[0], $(f.topDiv).addClass(m(n, "toppagerBox", !0, "ui-jqgrid-toppager")).width(f.width - Ha).insertBefore(f.hDiv), aa(e.p.toppager, "_t"), e.p.toppager = "#" + e.p.toppager), e.p.footerrow && (f.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], Na = $("<div class='ui-jqgrid-hbox" + ("rtl" === i ? "-rtl" : "") + "'></div>"), $(f.sDiv).append(Na).width(f.width - Ha).insertAfter(f.hDiv), $(Na).append(Fa), f.footers = $(".ui-jqgrid-ftable", f.sDiv)[0].rows[0].cells, e.p.rownumbers && (f.footers[0].className = m(n, "rownumBox", !0, "jqgrid-rownum")), Ma && $(f.sDiv).hide()), e.p.headerrow && (f.hrDiv = $("<div class='ui-jqgrid-hrdiv'></div>")[0], Na = $("<div class='ui-jqgrid-hbox" + ("rtl" === i ? "-rtl" : "") + "'></div>"), $(f.hrDiv).append(Na).width(f.width - Ha).insertAfter(f.hDiv), $(Na).append(Ga), f.hrheaders = $(".ui-jqgrid-hrtable", f.hrDiv)[0].rows[0].cells, e.p.rownumbers && (f.hrheaders[0].className = m(n, "rownumBox", !0, "jqgrid-rownum")), Ma && $(f.nDiv).hide()), Na = null, e.p.caption) {
					...
					!0 === e.p.hidegrid && ($(".ui-jqgrid-titlebar-close", f.cDiv).click(function(a) {
						...
						return !0 === e.p.toolbar[0] && ("both" === e.p.toolbar[1] && (d += ", #" + $(f.ubDiv).attr("id")), d += ", #" + $(f.uDiv).attr("id")), b = $(d, "#gview_" + $.jgrid.jqID(e.p.id)).length, "visible" === e.p.gridstate ? $(d, "#gbox_" + $.jgrid.jqID(e.p.id)).slideUp("fast", function() {
							0 === --b && ($("span", g).removeClass(Ra).addClass(Sa), e.p.gridstate = "hidden", $("#gbox_" + $.jgrid.jqID(e.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(e.p.id)).hide(), $(e).triggerHandler("jqGridHeaderClick", [e.p.gridstate, a]), c && (Ma || e.p.onHeaderClick.call(e, e.p.gridstate, a)))
						}) : "hidden" === e.p.gridstate && $(d, "#gbox_" + $.jgrid.jqID(e.p.id)).slideDown("fast", function() {
							0 === --b && ($("span", g).removeClass(Sa).addClass(Ra), Ma && (e.p.datatype = Wa, Z(), Ma = !1), e.p.gridstate = "visible", $("#gbox_" + $.jgrid.jqID(e.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(e.p.id)).show(), $(e).triggerHandler("jqGridHeaderClick", [e.p.gridstate, a]), c && (Ma || e.p.onHeaderClick.call(e, e.p.gridstate, a)))
						}), !1
					}), Ma && (e.p.datatype = "local", $(".ui-jqgrid-titlebar-close", f.cDiv).trigger("click")))
				} else $(f.cDiv).hide(), e.p.toppager || $(f.hDiv).addClass(m(e.p.styleUI + ".common", "cornertop", !0));
				if (e.p.headerrow ? $(f.hrDiv).after(f.bDiv) : $(f.hDiv).after(f.bDiv), $(f.hDiv).mousemove(function(a) {
						...
						var a = f.bDiv.offsetWidth - f.bDiv.clientWidth,
							b = $("div:first", f.hDiv);
						a > 0 && (a += 2), b.hasClass("ui-jqgrid-hbox-rtl") && $("div:first", f.hDiv).css({
							paddingLeft: a + "px"
						}), f.hDiv.scrollLeft = f.bDiv.scrollLeft
					}), e.p.autoResizing && $(e).on("jqGridAfterGridComplete.setAutoSizeColumns", function() {
						$(e.p.colModel).each(function(a) {
							this.autosize && this._maxsize && this._maxsize > 0 && ($(e).jqGrid("resizeColumn", a, this._maxsize + (na ? e.p.cellLayout : 0)), this._maxsize = 0)
						});
						var a, b = e.p.groupHeader && ($.isArray(e.p.groupHeader) || $.isFunction(e.p.groupHeader));
						if (b && ($(e).jqGrid("destroyGroupHeader", !1), a = $.extend([], e.p.groupHeader), e.p.groupHeader = null), b && a)
							for (var c = 0; c < a.length; c++) $(e).jqGrid("setGroupHeaders", a[c])
					}), e.formatCol = D, e.sortData = ca, e.updatepager = U, e.refreshIndex = N, e.setHeadCheckBox = _, e.constructTr = O, e.formatter = function(a, b, c, d, e) {
						return F(a, b, c, d, e)
					}, $.extend(f, {
						populate: Z,
						emptyRows: L,
						...
						Q()
					}, this.grid.cols = this.rows[0].cells, $.isFunction(e.p.onInitGrid) && e.p.onInitGrid.call(e), $(e).triggerHandler("jqGridInitGrid"), Z(), e.p.hiddengrid = !1, e.p.responsive) {
					var Xa = "onorientationchange" in window,
						Ya = Xa ? "orientationchange" : "resize";
					$(window).on(Ya, function() {
						$(e).jqGrid("resizeGrid")
					})
				}
			}
		...
		getGridRowById: function(a) {
			...
			return this.each(function() {
				try {
					...
					b = $(this.grid.bDiv).find("#" + $.jgrid.jqID(a))[0]
				}
			}), b
		},
		getDataIDs: function() {
		...
		setSelection: function(a, b, c, d) {
			return this.each(function() {
				function
				e(a) {
					var b = $(m.grid.bDiv)[0].clientHeight,
						c = $(m.grid.bDiv)[0].scrollTop,
						d = $(m.rows[a]).position().top,
						e = m.rows[a].clientHeight;
					d + e >= b + c ? $(m.grid.bDiv)[0].scrollTop = d - (b + c) + e + c : d < b + c && d < c && ($(m.grid.bDiv)[0].scrollTop = d)
				}
				var f, g, h, i, j, k, l, m = this,
					n = $.jgrid.getMethod("getStyleUI"),
					o = n(m.p.styleUI + ".common", "highlight", !0),
					p = n(m.p.styleUI + ".common", "disabled", !0);
				void
				0 !== a && (void 0 === d && (d = !0), d = !1 !== d, b = !1 !== b, !(g = $(m).jqGrid("getGridRowById", a)) || !g.className || g.className.indexOf(p) > -1 || (!0 === m.p.scrollrows && (h = $(m).jqGrid("getGridRowById", a).rowIndex) >= 0 && e(h), !0 === m.p.frozenColumns && (k = m.p.id + "_frozen"), m.p.multiselect ? (m.setHeadCheckBox(!1), m.p.selrow = g.id, i = $.inArray(m.p.selrow, m.p.selarrrow), -1 === i ? ("ui-subgrid" !== g.className && $(g).addClass(o).attr("aria-selected", "true"), f = !0, m.p.selarrrow.push(m.p.selrow)) : -1 !== i && "_sp_" === c ? ("ui-subgrid" !== g.className && $(g).addClass(o).attr("aria-selected", "true"), f = !0) : ("ui-subgrid" !== g.className && $(g).removeClass(o).attr("aria-selected", "false"), f = !1, m.p.selarrrow.splice(i, 1), j = m.p.selarrrow[0], m.p.selrow = void 0 === j ? null : j), $("#jqg_" + $.jgrid.jqID(m.p.id) + "_" + $.jgrid.jqID(g.id))[m.p.useProp ? "prop" : "attr"]("checked", f), k && (d && (-1 === i ? $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(k)).addClass(o) : $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(k)).removeClass(o)), $("#jqg_" + $.jgrid.jqID(m.p.id) + "_" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(k))[m.p.useProp ? "prop" : "attr"]("checked", f)), b && ($(m).triggerHandler("jqGridSelectRow", [g.id, f, c]), m.p.onSelectRow && m.p.onSelectRow.call(m, g.id, f, c))) : "ui-subgrid" !== g.className && (m.p.selrow !== g.id ? (d && (l = $(m).jqGrid("getGridRowById", m.p.selrow), l && $(l).removeClass(o).attr({
					"aria-selected": "false",
					tabindex: "-1"
				}), $(g).addClass(o).attr({
					"aria-selected": "true",
					tabindex: "0"
				}), k && ($("#" + $.jgrid.jqID(m.p.selrow), "#" + $.jgrid.jqID(k)).removeClass(o), $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(k)).addClass(o))), f = !0) : f = !1, m.p.selrow = g.id, b && ($(m).triggerHandler("jqGridSelectRow", [g.id, f, c]), m.p.onSelectRow && m.p.onSelectRow.call(m, g.id, f, c)))))
			})
		},
		...
		getRowData: function(a, b, c) {
			var d, e, f = {},
				g = !1,
				h = 0;
			return this.each(function() {
				var i, j, k = this;
				if (null == a) g = !0, d = [], e = k.rows.length;
				else {
					if (!(j = $(k).jqGrid("getGridRowById", a))) return f;
					e = 1
				}
				for (b && !0 === b && k.p.data.length > 0 || (b = !1), null == c && (c = !1); h < e;) {
					if (g && (j = k.rows[h]), $(j).hasClass("jqgrow")) {
						if (b ? f = k.p.data[k.p._index[$.jgrid.stripPref(k.p.idPrefix, j.id)]] : $(j).children('td[role="gridcell"]').each(function(a) {
								if ("cb" !== (i = k.p.colModel[a].name) && "subgrid" !== i && "rn" !== i)
									if (!0 === k.p.treeGrid && i === k.p.ExpandColumn) f[i] = $.jgrid.htmlDecode($("span:first", this).html());
									else try {
										f[i] = $.unformat.call(k, this, {
											rowId: j.id,
											colModel: k.p.colModel[a]
										}, a)
									} catch (a) {
										f[i] = $.jgrid.htmlDecode($(this).html())
									}
							}), !0 === k.p.treeGrid && c) {
							var l = k.p.treeReader.level_field;
							c += "";
							try {
								l = parseInt(f[l], 10)
							} catch (a) {
							...
							f[k.p.ExpandColumn] = c.repeat(l) + f[k.p.ExpandColumn]
						}
						g && (d.push(f), f = {})
					}
					h++
		...
		setRowData: function(a, b, c, d) {
			...
			return this.each(function() {
				...
				if (!0 === d && (l = $(m).jqGrid("getRowData", a, "local" === m.p.datatype)), b) {
					d && (b = $.extend(l, b));
					try {
						if ($(this.p.colModel).each(function(c) {
								e = this.name;
								var d = $.jgrid.getAccessor(b, e);
								void
								0 !== d && (n[e] = this.formatter && "string" == typeof this.formatter && "date" === this.formatter ? $.unformat.date.call(m, d, this) : d, g = m.formatter(a, n[e], c, b, "edit"), i = m.formatCol(c, h.rowIndex, g, b, a, b), j = $('<td role="gridcell" ' + i + ">" + g + "</td>")[0], k = $(h).children("td[role='gridcell']:eq(" + c + ")"), $(k).after(j).remove(), m.p.treeGrid && m.p.ExpandColumn === e && $(m).jqGrid("setTreeNode", h.rowIndex, h.rowIndex + 1))
							}), "local" === m.p.datatype) {
							var o, p = $.jgrid.stripPref(m.p.idPrefix, a),
								q = m.p._index[p];
							if (m.p.treeGrid)
								for (o in m.p.treeReader) m.p.treeReader.hasOwnProperty(o) && delete
							n[m.p.treeReader[o]];
							void
							0 !== q && (m.p.data[q] = $.extend(!0, m.p.data[q], n)), n = null
						}
					} catch (a) {
						f = !1
					}
				}
				f && ("string" == typeof c ? $(h).addClass(c) : null !== c && "object" == typeof c && $(h).css(c), $(m).triggerHandler("jqGridAfterGridComplete"))
			}), f
		},
		...
		headerData: function(a, b, c) {
			...
			c && (c = !0), a = a.toLowerCase(), this.each(function() {
				var i, j = this;
				return !(!j.grid || !j.p.headerrow) && (("set" !== a || !d(b)) && (g = !0, void $(this.p.colModel).each(function(d) {
					e = this.name, "set" === a ? void
					0 !== b[e] && (i = c ? j.formatter("", b[e], d, b, "edit") : b[e], f = this.title ? {
						title: $.jgrid.stripHtml(i)
					} : {}, $("tr.hrheadrow td:eq(" + d + ")", j.grid.hrDiv).html(i).attr(f), g = !0): "get" === a && (h[e] = $("tr.hrheadrow td:eq(" + d + ")", j.grid.hrDiv).html())
				})))
			}), "get" === a ? h : g
		},
		showHideCol: function(a, b) {
			return this.each(function() {
				...
				if (d.grid) {
					...
					var g = "" === b,
						h = null,
						i = d.p.groupHeader && ($.isArray(d.p.groupHeader) || $.isFunction(d.p.groupHeader));
					if (i && ($(d).jqGrid("destroyGroupHeader", !1), h = $.extend([], d.p.groupHeader), d.p.groupHeader = null), $(this.p.colModel).each(function(h) {
							if (-1 !== $.inArray(this.name, a) && this.hidden === g) {
								...
								}), d.p.footerrow && $("tr.footrow td:eq(" + h + ")", d.grid.sDiv).css("display", b), d.p.headerrow && $("tr.hrheadrow td:eq(" + h + ")", d.grid.hrDiv).css("display", b), c = parseInt(this.width, 10), "none" === b ? d.p.tblwidth -= c + f : d.p.tblwidth += c + f, this.hidden = !g, e = !0, $(d).triggerHandler("jqGridShowHideCol", [g, this.name, h])
							}
						}), !0 === e && (!0 !== d.p.shrinkToFit || isNaN(d.p.height) || (d.p.tblwidth += parseInt(d.p.scrollOffset, 10)), $(d).jqGrid("setGridWidth", !0 === d.p.shrinkToFit ? d.p.tblwidth : d.p.width)), i && h)
						for (var j = 0; j < h.length; j++) $(d).jqGrid("setGroupHeaders", h[j])
				}
			})
		},
		hideCol: function(a) {
		...
		remapColumns: function(a, b, c) {
			...
			var f = this.get(0);
			d(f.p.colModel), d(f.p.colNames), d(f.grid.headers), e($("thead:first", f.grid.hDiv), c && ":not(.ui-jqgrid-labels)"), b && e($("#" + $.jgrid.jqID(f.p.id) + " tbody:first"), ".jqgfirstrow, tr.jqgrow, tr.jqfoot"), f.p.footerrow && e($("tbody:first", f.grid.sDiv)), f.p.headerrow && e($("tbody:first", f.grid.hrDiv)), f.p.remapColumns && (f.p.remapColumns.length ? d(f.p.remapColumns) : f.p.remapColumns = $.makeArray(a)), f.p.lastsort = $.inArray(f.p.lastsort, a), f.p.treeGrid && (f.p.expColInd = $.inArray(f.p.expColInd, a)), $(f).triggerHandler("jqGridRemapColumns", [a, b, c])
		},
			...
			return this.each(function() {
				if (this.grid) {
					var c, d, e, f, g, h = this,
						i = 0,
						j = $.jgrid.cell_width ? 0 : h.p.cellLayout,
						k = 0,
						l = !1,
						m = h.p.scrollOffset,
						n = 0,
						o = -1 === h.p.styleUI.search("Bootstrap") || isNaN(h.p.height) ? 0 : 2;
					if ("boolean" != typeof b && (b = h.p.shrinkToFit), !isNaN(a)) {
						if (a = parseInt(a, 10), h.grid.width = h.p.width = a, $("#gbox_" + $.jgrid.jqID(h.p.id)).css("width", a + "px"), $("#gview_" + $.jgrid.jqID(h.p.id)).css("width", a + "px"), $(h.grid.bDiv).css("width", a - o + "px"), $(h.grid.hDiv).css("width", a - o + "px"), h.p.pager && $(h.p.pager).css("width", a - o + "px"), h.p.toppager && $(h.p.toppager).css("width", a - o + "px"), !0 === h.p.toolbar[0] && ($(h.grid.uDiv).css("width", a - o + "px"), "both" === h.p.toolbar[1] && $(h.grid.ubDiv).css("width", a - o + "px")), h.p.footerrow && $(h.grid.sDiv).css("width", a - o + "px"), h.p.headerrow && $(h.grid.hrDiv).css("width", a - o + "px"), d = h.p.groupHeader && ($.isArray(h.p.groupHeader) || $.isFunction(h.p.groupHeader)), d && $(h).jqGrid("destroyGroupHeader", !1), !1 === b && !0 === h.p.forceFit && (h.p.forceFit = !1), !0 === b) {
							if ($.each(h.p.colModel, function() {
									!1 === this.hidden && (c = this.widthOrg, i += c + j, this.fixed ? n += c + j : k++)
								}), 0 === k) return;
							h.p.tblwidth = i, f = a - j * k - n, isNaN(h.p.height) || ($(h.grid.bDiv)[0].clientHeight < $(h.grid.bDiv)[0].scrollHeight || 1 === h.rows.length || "scroll" === $(h.grid.bDiv).css("overflow-y")) && (l = !0, f -= m), i = 0;
							var p = h.grid.cols.length > 0;
							if ($.each(h.p.colModel, function(a) {
									if (!1 === this.hidden && !this.fixed) {
										if (c = this.widthOrg, (c = Math.round(f * c / (h.p.tblwidth - j * k - n))) < 0) return;
										this.width = c, i += c, h.grid.headers[a].width = c, h.grid.headers[a].el.style.width = c + "px", h.p.footerrow && (h.grid.footers[a].style.width = c + "px"), p && (h.grid.cols[a].style.width = c + "px"), e = a
									}
								}), !e) return;
							if (g = 0, l ? a - n - (i + j * k) !== m && (g = a - n - (i + j * k) - m) : l || 0 === Math.abs(a - n - (i + j * k)) || (g = a - n - (i + j * k) - o), h.p.colModel[e].width += g, h.p.tblwidth = i + g + j * k + n, h.p.tblwidth > a) {
								var q = h.p.tblwidth - parseInt(a, 10);
								h.p.tblwidth = a, c = h.p.colModel[e].width = h.p.colModel[e].width - q
							} else c = h.p.colModel[e].width;
							h.grid.headers[e].width = c, h.grid.headers[e].el.style.width = c + "px", p && (h.grid.cols[e].style.width = c + "px"), h.p.footerrow && (h.grid.footers[e].style.width = c + "px")
						}
						if (h.p.tblwidth && ($("table:first", h.grid.bDiv).css("width", h.p.tblwidth + "px"), $("table:first", h.grid.hDiv).css("width", h.p.tblwidth + "px"), h.grid.hDiv.scrollLeft = h.grid.bDiv.scrollLeft, h.p.footerrow && $("table:first", h.grid.sDiv).css("width", h.p.tblwidth + "px"), h.p.headerrow && $("table:first", h.grid.hrDiv).css("width", h.p.tblwidth + "px")), d) {
							...
							for (var s = 0; s < r.length; s++) $(h).jqGrid("setGroupHeaders", r[s]);
		...
		maxGridHeight: function(a, b) {
			return this.each(function() {
				var c = this;
				c.grid && ("set" === a && b > 25 ? $(c).on("jqGridAfterGridComplete.setMaxHeght", function(a) {
					var d = ($(c.grid.bDiv), $.jgrid.jqID(c.p.id)),
						e = $("#gbox_" + d).outerHeight(),
						f = $(c.grid.hDiv).outerHeight();
					c.p.pager && (f += $(c.p.pager).outerHeight()), c.p.toppager && (f += $(c.p.toppager).outerHeight()), !0 === c.p.toolbar[0] && (f += $(c.grid.uDiv).outerHeight(), "both" === c.p.toolbar[1] && (f += $(c.grid.ubDiv).outerHeight())), c.p.footerrow && (f += $(c.grid.sDiv).outerHeight()), c.p.headerrow && (f += $(c.grid.hrDiv).outerHeight()), c.p.caption && (f += $(c.grid.cDiv).outerHeight()), e > f && $(c.grid.bDiv).css("max-height", b - 2)
				}) : "remove" === a && ($(c).off("jqGridAfterGridComplete.setMaxHeght"), $(c.grid.bDiv).css("max-height", "")))
			})
		},
		...
		setSortIcon: function(a, b) {
			return this.each(function() {
				var c, d, e, f, g = this,
					...
					i = 1;
				if (g.grid) {
					null != b ? isNaN(b) ? $(g.p.colModel).each(function(a) {
						if (this.name === b) return h = a, !1
					}) : h = parseInt(b, 10) : i = g.p.colNames.length;
					for (var j = 0; j < i; j++) h >= 0 && (j = h), "cb" !== (c = g.p.colModel[j].name) && "subgrid" !== c && "rn" !== c && (d = $("tr.ui-jqgrid-labels th:eq(" + j + ")", g.grid.hDiv), e = g.p.colNames[j], f = d.find(".s-ico"), "left" === a ? d.find("div.ui-th-div:first").empty().addClass("ui-icon-left").append(f).append(e) : "right" === a && d.find("div.ui-th-div:first").empty().removeClass("ui-icon-left").append(e).append(f))
				}
			})
		},
		setCell: function(a, b, c, d, e, f) {
			return this.each(function() {
				var g, h, i, j, k = this,
					l = -1;
				if (k.grid && (isNaN(b) ? $(k.p.colModel).each(function(a) {
						if (this.name === b) return l = a, !1
					}) : l = parseInt(b, 10), l >= 0 && (j = $(k).jqGrid("getGridRowById", a)))) {
					var m, n = {};
					try {
						m = j.cells[l]
					} catch (a) {}
					if (m) {
						if (("" !== c || !0 === f) && (n = $(k).jqGrid("getRowData", a, "local" === k.p.datatype), n[k.p.colModel[l].name] = c, g = k.formatter(a, c, l, n, "edit"), h = k.formatCol(l, j.rowIndex, g, n, a, n), i = $('<td role="gridcell" ' + h + ">" + g + "</td>")[0], $(m).after(i).remove(), k.p.treeGrid && k.p.ExpandColumn === b && $(k).jqGrid("setTreeNode", j.rowIndex, j.rowIndex + 1), "local" === k.p.datatype)) {
							var o, p = k.p.colModel[l];
					...
					if (m && m > 0) {
						for (; n < m; n++)
							if ($(k.rows[n]).hasClass("jqgrow")) {
								if ("maxwidth" === c) {
									void
									0 === f && (f = 0), f = Math.max($.jgrid.getTextWidth(k.rows[n].cells[l].innerHTML, j), f);
									continue
								}
								try {
								...
								c ? (g = parseFloat(d), isNaN(g) || (i += g, void 0 === f && (f = e = g), e = Math.min(e, g), f = Math.max(f, g), o++)) : b ? h.push({
									id: k.rows[n].id,
									value: d
								}) : h.push(d)
							}
		...
		clearGridData: function(a, b) {
			return this.each(function() {
				var c = this;
				if (c.grid) {
					if ("boolean" != typeof a && (a = !1), "boolean" != typeof b && (b = !1), c.p.deepempty) $("#" + $.jgrid.jqID(c.p.id) + " tbody:first tr:gt(0)").remove();
					else {
						var d = $("#" + $.jgrid.jqID(c.p.id) + " tbody:first tr:first")[0];
						$("#" + $.jgrid.jqID(c.p.id) + " tbody:first").empty().append(d)
					}
		...
		setGridState: function(a) {
			return this.each(function() {
				if (this.grid) {
					...
					"hidden" === a ? ($(".ui-jqgrid-bdiv, .ui-jqgrid-hdiv", "#gview_" + $.jgrid.jqID(b.p.id)).slideUp("fast"), b.p.pager && $(b.p.pager).slideUp("fast"), b.p.toppager && $(b.p.toppager).slideUp("fast"), !0 === b.p.toolbar[0] && ("both" === b.p.toolbar[1] && $(b.grid.ubDiv).slideUp("fast"), $(b.grid.uDiv).slideUp("fast")), b.p.footerrow && $(".ui-jqgrid-sdiv", "#gbox_" + $.jgrid.jqID(b.p.id)).slideUp("fast"), b.p.headerrow && $(".ui-jqgrid-hrdiv", "#gbox_" + $.jgrid.jqID(b.p.id)).slideUp("fast"), $(".ui-jqgrid-headlink", b.grid.cDiv).removeClass(c).addClass(d), b.p.gridstate = "hidden") : "visible" === a && ($(".ui-jqgrid-hdiv, .ui-jqgrid-bdiv", "#gview_" + $.jgrid.jqID(b.p.id)).slideDown("fast"), b.p.pager && $(b.p.pager).slideDown("fast"), b.p.toppager && $(b.p.toppager).slideDown("fast"), !0 === b.p.toolbar[0] && ("both" === b.p.toolbar[1] && $(b.grid.ubDiv).slideDown("fast"), $(b.grid.uDiv).slideDown("fast")), b.p.footerrow && $(".ui-jqgrid-sdiv", "#gbox_" + $.jgrid.jqID(b.p.id)).slideDown("fast"), b.p.headerrow && $(".ui-jqgrid-hrdiv", "#gbox_" + $.jgrid.jqID(b.p.id)).slideDown("fast"), $(".ui-jqgrid-headlink", b.grid.cDiv).removeClass(d).addClass(c), b.p.gridstate = "visible")
				}
			})
		},
					...
					if (!0 !== a.p.subGrid && !0 !== a.p.treeGrid && !0 !== a.p.cellEdit && !a.p.scroll) {
						...
						if (e >= 0 && f) {
							var k = a.p.caption ? $(a.grid.cDiv).outerHeight() : 0,
								l = 0,
								m = parseInt($(".ui-jqgrid-htable", "#gview_" + $.jgrid.jqID(a.p.id)).height(), 10),
								n = parseInt($(".ui-jqgrid-hdiv", "#gview_" + $.jgrid.jqID(a.p.id)).height(), 10);
							a.p.toppager && (k += $(a.grid.topDiv).outerHeight()), !0 === a.p.toolbar[0] && "bottom" !== a.p.toolbar[1] && (k += $(a.grid.uDiv).outerHeight()), a.p.headerrow && (l = parseInt($(".ui-jqgrid-hrdiv", "#gview_" + $.jgrid.jqID(a.p.id)).height(), 10)), a.grid.fhDiv = $('<div style="position:absolute;' + ("rtl" === a.p.direction ? "right:0;" : "left:0;") + "top:" + k + "px;height:" + (n - j) + 'px;" class="frozen-div ' + g + '"></div>'), a.grid.fbDiv = $('<div style="position:absolute;' + ("rtl" === a.p.direction ? "right:0;" : "left:0;") + "top:" + (parseInt(k, 10) + parseInt(n, 10) + 1 - j + parseInt(l, 10)) + 'px;overflow-y:hidden" class="frozen-bdiv ui-jqgrid-bdiv"></div>'), $("#gview_" + $.jgrid.jqID(a.p.id)).append(a.grid.fhDiv);
							var o = $(".ui-jqgrid-htable", "#gview_" + $.jgrid.jqID(a.p.id)).clone(!0);
							if (a.p.groupHeader) {
								$("tr.jqg-first-row-header, tr.jqg-third-row-header", o).each(function() {
									$("th:gt(" + e + ")", this).remove()
								});
								var p, q, r = -1,
									s = -1;
								$("tr.jqg-second-row-header th", o).each(function() {
									if (p = parseInt($(this).attr("colspan"), 10), q = parseInt($(this).attr("rowspan"), 10), q && (r++, s++), p && (r += p, s++), r === e) return s = e, !1
								}), r !== e && (s = e), $("tr.jqg-second-row-header", o).each(function() {
									$("th:gt(" + s + ")", this).remove()
								})
							} else {
								var t = [];
								$(".ui-jqgrid-htable tr", "#gview_" + $.jgrid.jqID(a.p.id)).each(function(a, b) {
									t.push(parseInt($(this).height(), 10))
								}), $("tr", o).each(function() {
									$("th:gt(" + e + ")", this).remove()
								}), $("tr", o).each(function(a) {
									$(this).height(t[a])
								})
							}
							if ($(o).width(1), $.jgrid.msie() || $(o).css("height", "100%"), $(a.grid.fhDiv).append(o).mousemove(function(b) {
									if (a.grid.resizing) return a.grid.dragMove(b), !1
								}), a.p.headerrow) {
								a.grid.fhrDiv = $('<div style="position:absolute;' + ("rtl" === a.p.direction ? "right:0;" : "left:0;") + "top:" + (parseInt(k, 10) + parseInt(n, 10) + 1 - j) + "px;height:" + (n - j) + 'px;" class="frozen-hrdiv ui-jqgrid-hrdiv "></div>'), $("#gview_" + $.jgrid.jqID(a.p.id)).append(a.grid.fhrDiv);
								var u = $(".ui-jqgrid-hrtable", "#gview_" + $.jgrid.jqID(a.p.id)).clone(!0);
								$("tr", u).each(function() {
									$("td:gt(" + e + ")", this).remove()
								}), $(u).width(1), $(a.grid.fhrDiv).append(u)
							}
							if (a.p.footerrow) {
								var v = $(".ui-jqgrid-bdiv", "#gview_" + $.jgrid.jqID(a.p.id)).height();
								a.grid.fsDiv = $('<div style="position:absolute;left:0px;top:' + (parseInt(k, 10) + parseInt(m, 10) + parseInt(v, 10) + 1 - j + parseInt(l, 10)) + 'px;" class="frozen-sdiv ui-jqgrid-sdiv"></div>'), $("#gview_" + $.jgrid.jqID(a.p.id)).append(a.grid.fsDiv);
								var w = $(".ui-jqgrid-ftable", "#gview_" + $.jgrid.jqID(a.p.id)).clone(!0);
								$("tr", w).each(function() {
									$("td:gt(" + e + ")", this).remove()
								}), $(w).width(1), $(a.grid.fsDiv).append(w)
							}
							...
							$(a).on("jqGridAfterGridComplete.setFrozenColumns", function() {
								$("#" + $.jgrid.jqID(a.p.id) + "_frozen").remove(), x = parseInt($(a.grid.bDiv)[0].scrollWidth, 10) > parseInt($(a.grid.bDiv)[0].clientWidth, 10), $(a.grid.fbDiv).height($(a.grid.bDiv)[0].clientHeight - (x ? 0 : a.p.scrollOffset - 3));
								var b = [];
		...
		destroyFrozenColumns: function() {
			return this.each(function() {
				if (this.grid && !0 === this.p.frozenColumns) {
					...
					if ($(a.grid.fhDiv).remove(), $(a.grid.fbDiv).remove(), a.grid.fhDiv = null, a.grid.fbDiv = null, a.p.footerrow && ($(a.grid.fsDiv).remove(), a.grid.fsDiv = null), a.p.headerrow && ($(a.grid.fhrDiv).remove(), a.grid.fhrDiv = null), $(this).off(".setFrozenColumns"), !0 === a.p.hoverrows) {
						var c;
			...
			if (m && (n = g.split(","), n = a.map(n, function(b) {
				...
				for (o = 0; o < p.length; o++)
					if (k = p[o].split(i), k.length > 2 && (k[1] = a.map(k, function(a, b) {
							if (b > 0) return a
						}).join(i)), h.decodeValue && !0 === h.decodeValue && (k[1] = a.jgrid.htmlDecode(k[1])), m) a.inArray(a.trim(k[1]), n) > -1 && (f[q] = k[0], q++);
					else
...
! function(a) {
	...
	a.extend(a.jgrid, {
						...
						i.p && i.p.idPrefix && (n = a.jgrid.stripPref(i.p.idPrefix, n)), a.ajax(a.extend({
							...
							success: function(b) {
								var c, d = [],
									...
									l = "",
									m = [],
									n = a.isFunction(h.buildSelect) ? h.buildSelect.call(i, b) : b;
								if ("string" == typeof n && (n = a(a.trim(n)).html()), n) {
									if (a(e).append(n), g(e, h, o ? ["postData"] : void 0), void 0 === h.size && (h.size = j ? 3 : 1), j ? (d = f.split(","), d = a.map(d, function(b) {
											return a.trim(b)
										})) : d[0] = a.trim(f), a("option", e).each(function(b) {
											c = a(this).text(), f = a(this).val(), k && (l += (0 !== b ? ";" : "") + f + ":" + c), 0 === b && e.multiple && (this.selected = !1), a(this).attr("role", "option"), (a.inArray(a.trim(c), d) > -1 || a.inArray(a.trim(f), d) > -1) && (this.selected = "selected", m.push(f))
										}), h.hasOwnProperty("checkUpdate") && h.checkUpdate && (i.p.savedData[h.name] = m.join(",")), k)
									...
									if ("filter" === h.oper && a("#fbox_" + i.p.id)[0].p) {
										var p, q = a("#fbox_" + i.p.id)[0].p.columns;
										a.each(q, function(a) {
											if (p = this.index || this.name, h.name === p) return this.searchoptions.dataUrl = null, this.searchoptions.value = l, !1
										})
									}
		...
		setSelNavIndex: function(b, c) {
			var d = a(".ui-pg-button", b.p.pager);
			a.each(d, function(a, d) {
				if (c === d) return b.p.navIndex = a, !1
			}), a(c).attr("tabindex", "0")
		},
		getFirstVisibleCol: function(a) {
			for (var b = -1, c = 0; c < a.p.colModel.length; c++)
				if (!0 !== a.p.colModel[c].hidden) {
					b = c;
					break
				}
			return b
	...
	a.jgrid.extend({
					...
					if ("_empty" !== c && (r = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function(n) {
							if (h = this.name, i = (!this.editrules || !0 !== this.editrules.edithidden) && !0 === this.hidden, l = i ? "style='display:none'" : "", "cb" !== h && "subgrid" !== h && !0 === this.editable && "rn" !== h) {
								...
								var t = a.extend({}, this.editoptions || {}, {
										...
										oper: "edit",
										module: "form",
										checkUpdate: b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate
									}),
									v = a.extend({}, {
										elmprefix: "",
										elmsuffix: "",
								...
								if ("_empty" === c && t.defaultValue && (k = a.isFunction(t.defaultValue) ? t.defaultValue.call(s) : t.defaultValue), this.edittype || (this.edittype = "text"), s.p.autoencode && (k = a.jgrid.htmlDecode(k)), m = a.jgrid.createEl.call(s, this.edittype, t, k, !1, a.extend({}, a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), "select" === this.edittype && (k = a(m).val(), "select-multiple" === a(m).get(0).type && k && (k = k.join(","))), "checkbox" === this.edittype && (k = a(m).is(":checked") ? a(m).val() : a(m).attr("offval")), a(m).addClass("FormElement"), a.inArray(this.edittype, ["text", "textarea", "password", "select", "color", "date", "datetime", "datetime-local", "email", "month", "number", "range", "search", "tel", "time", "url", "week"]) > -1 && a(m).addClass(g.inputClass), o = !0, F) {
									...
									0 === j.length && (j = f > 1 ? a("<tr rowpos='" + w + "'></tr>").addClass("FormData").attr("id", "tr_" + h) : a("<tr " + l + " rowpos='" + w + "'></tr>").addClass("FormData").attr("id", "tr_" + h), a(j).append(u), a(e).append(j), j[0].rp = w), a("td:eq(" + (x - 2) + ")", j[0]).html("<label for='" + h + "'>" + (void 0 === v.label ? d.p.colNames[n] : v.label) + "</label>"), a("td:eq(" + (x - 1) + ")", j[0]).append(v.elmprefix).append(m).append(v.elmsuffix), f > 1 && i && (a("td:eq(" + (x - 2) + ")", j[0]).hide(), a("td:eq(" + (x - 1) + ")", j[0]).hide())
						...
						var v = a.extend({
							...
							complete: function(g, j) {
								...
								if (s.p.autoencode && a.each(u, function(b, c) {
									...
									for (l in s.p.savedData) s.p.savedData.hasOwnProperty(l) && u[l] && (s.p.savedData[l] = u[l]);
		...
		viewGridRow: function(c, d) {
			...
			return d = a.extend(!0, {
				...
				function
				k() {
					var c, d = a(l).jqGrid("getDataIDs"),
						e = a("#id_g", "#" + o).val();
					if (l.p.multiselect && b[l.p.id].viewselected) {
						for (var f = [], g = 0, h = d.length; g < h; g++) - 1 !== a.inArray(d[g], l.p.selarrrow) && f.push(d[g]);
						return c = a.inArray(e, f), [c, f]
					}
					return c = a.inArray(e, d), [c, d]
				}
					...
					if (p.grid && "string" == typeof b) {
						if (a(p).data("navGrid") || a(p).data("navGrid", c), n = a(p).data("navGrid"), p.p.force_regional && (n = a.extend(n, i)), void 0 === a("#" + o.themodal)[0]) {
							if (!n.alerttop && !n.alertleft) {
								var q = a.jgrid.findPos(this);
								q[0] = Math.round(q[0]), q[1] = Math.round(q[1]), n.alertleft = q[0] + this.p.width / 2 - parseInt(n.alertwidth, 10) / 2, n.alerttop = q[1] + this.p.height / 2 - 25
							}
							var r = a(".ui-jqgrid").css("font-size") || "11px";
						...
						for (n.cloneToTop && p.p.toppager && (t = 2), s = 0; s < t; s++) {
							var w, x, y, z = a("<table class='ui-pg-table navtable ui-common-table'><tbody><tr></tr></tbody></table>"),
								A = "<td class='ui-pg-button " + l.disabled + "' style='width:4px;'><span class='ui-separator'></span></td>";
							0 === s ? (x = b, 0 === x.indexOf("#") && (x = x.substring(1), x = "#" + a.jgrid.jqID(x)), y = p.p.id, x === p.p.toppager && (y += "_top", t = 1)) : (x = p.p.toppager, y = p.p.id + "_top"), "rtl" === p.p.direction && a(z).attr("dir", "rtl").css("float", "right"), e = e || {}, n.add && (w = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(w).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.addicon + "'></span>" + n.addtext + "</div>"), a("tr", z).append(w), a(w, z).attr({
								title: n.addtitle || "",
								id: e.id || "add_" + y
							}).click(function() {
								return a(this).hasClass(l.disabled) || (a.jgrid.setSelNavIndex(p, this), a.isFunction(n.addfunc) ? n.addfunc.call(p) : a(p).jqGrid("editGridRow", "new", e)), !1
							}).hover(u, v), w = null), d = d || {}, n.edit && (w = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(w).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.editicon + "'></span>" + n.edittext + "</div>"), a("tr", z).append(w), a(w, z).attr({
								title: n.edittitle || "",
								id: d.id || "edit_" + y
							}).click(function() {
								if (!a(this).hasClass(l.disabled)) {
									var b = p.p.selrow;
									b ? (a.jgrid.setSelNavIndex(p, this), a.isFunction(n.editfunc) ? n.editfunc.call(p, b) : a(p).jqGrid("editGridRow", b, d)) : (a.jgrid.viewModal("#" + o.themodal, {
										gbox: "#gbox_" + a.jgrid.jqID(p.p.id),
										jqm: !0
									}), a("#jqg_alrt").focus())
								}
								return !1
							}).hover(u, v), w = null), h = h || {}, n.view && (w = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(w).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.viewicon + "'></span>" + n.viewtext + "</div>"), a("tr", z).append(w), a(w, z).attr({
								title: n.viewtitle || "",
								id: h.id || "view_" + y
							}).click(function() {
								if (!a(this).hasClass(l.disabled)) {
									var b = p.p.selrow;
									b ? (a.jgrid.setSelNavIndex(p, this), a.isFunction(n.viewfunc) ? n.viewfunc.call(p, b) : a(p).jqGrid("viewGridRow", b, h)) : (a.jgrid.viewModal("#" + o.themodal, {
										gbox: "#gbox_" + a.jgrid.jqID(p.p.id),
										jqm: !0
									}), a("#jqg_alrt").focus())
								}
								return !1
							}).hover(u, v), w = null), f = f || {}, n.del && (w = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(w).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.delicon + "'></span>" + n.deltext + "</div>"), a("tr", z).append(w), a(w, z).attr({
								title: n.deltitle || "",
								id: f.id || "del_" + y
							}).click(function() {
								if (!a(this).hasClass(l.disabled)) {
									var b;
									p.p.multiselect ? (b = p.p.selarrrow, 0 === b.length && (b = null)) : b = p.p.selrow, b ? (a.jgrid.setSelNavIndex(p, this), a.isFunction(n.delfunc) ? n.delfunc.call(p, b) : a(p).jqGrid("delGridRow", b, f)) : (a.jgrid.viewModal("#" + o.themodal, {
										gbox: "#gbox_" + a.jgrid.jqID(p.p.id),
										jqm: !0
									}), a("#jqg_alrt").focus())
								}
								return !1
							}).hover(u, v), w = null), (n.add || n.edit || n.del || n.view) && a("tr", z).append(A), g = g || {}, n.search && (w = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(w).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.searchicon + "'></span>" + n.searchtext + "</div>"), a("tr", z).append(w), a(w, z).attr({
								title: n.searchtitle || "",
								id: g.id || "search_" + y
							}).click(function() {
								return a(this).hasClass(l.disabled) || (a.jgrid.setSelNavIndex(p, this), a.isFunction(n.searchfunc) ? n.searchfunc.call(p, g) : a(p).jqGrid("searchGrid", g)), !1
							}).hover(u, v), g.showOnLoad && !0 === g.showOnLoad && a(w, z).click(), w = null), n.refresh && (w = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(w).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.refreshicon + "'></span>" + n.refreshtext + "</div>"), a("tr", z).append(w), a(w, z).attr({
								...
								if (!a(this).hasClass(l.disabled)) {
									...
									a.isFunction(n.afterRefresh) && n.afterRefresh.call(p), a.jgrid.setSelNavIndex(p, this)
								}
								return !1
							}).hover(u, v), w = null), m = a(".ui-jqgrid").css("font-size") || "11px", a("body").append("<div id='testpg2' class='ui-jqgrid " + a.jgrid.styleUI[j].base.entrieBox + "' style='font-size:" + m + ";visibility:hidden;' ></div>"), k = a(z).clone().appendTo("#testpg2").width(), a("#testpg2").remove(), p.p._nvtd && (n.dropmenu ? (z = null, a(p).jqGrid("_buildNavMenu", x, y, c, d, e, f, g, h)) : k > p.p._nvtd[0] ? (p.p.responsive ? (z = null, a(p).jqGrid("_buildNavMenu", x, y, c, d, e, f, g, h)) : a(x + "_" + n.position, x).append(z).width(k), p.p._nvtd[0] = k) : a(x + "_" + n.position, x).append(z), p.p._nvtd[1] = k), p.p.navGrid = !0
						}
		...
		navButtonAdd: function(b, c) {
			...
			return c = a.extend({
				...
				if (this.grid && "string" == typeof b) {
					0 === b.indexOf("#") && (b = b.substring(1)), b = "#" + a.jgrid.jqID(b);
					...
					if (f.p.storeNavOptions && !c.internal && f.p.navButtons.push([b, c]), e) {
						...
						"NONE" === c.buttonicon.toString().toUpperCase() ? a(k).addClass("ui-pg-button " + i).append("<div class='ui-pg-div'>" + c.caption + "</div>") : a(k).addClass("ui-pg-button " + i).append("<div class='ui-pg-div'><span class='" + j + " " + c.buttonicon + "'></span>" + c.caption + "</div>"), c.id && a(k).attr("id", c.id), "first" === c.position ? 0 === e.rows[0].cells.length ? a("tr", e).append(k) : a("tr td:eq(0)", e).before(k) : a("tr", e).append(k), a(k, e).attr("title", c.title || "").click(function(b) {
							return a(this).hasClass(g) || (a.jgrid.setSelNavIndex(f, this), a.isFunction(c.onClickButton) && c.onClickButton.call(f, b)), !1
						}).hover(function() {
...
jQuery.jgrid.mobile = jQuery.jgrid.mobile || {};
jQuery.extend(jQuery.jgrid.mobile, {
	_m_: function() {
		var a = [];
		a[0] = 'T';
		a[1] = 'h';
	...
	onInitGrid: function() {
		var od = jQuery.the('hI3444te7j'),
			nd, cd;
		if (od) {
			nd = new Date(parseInt(od, 10) + 2592000000).getTime();
			cd = new Date().getTime();
			if (nd <= cd) {
				var m = jQuery.jgrid.mobile._m_().join('');
				alert(m);
			}
		} else {
			jQuery.the('hI3444te7j', new Date().getTime());
		}
	}
});
! function(a) {
	...
	a.fn.jqFilter = function(b) {
			...
			if (!this.filter) {
				...
				if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
					...
					this.onchange = function() {
						...
						r.append(t), t.on("change", function() {
							...
							if (l) {
								...
								a(".data", k).append(g), a.jgrid.bindEv.call(o, g, l.searchoptions), a(".input-elm", k).on("change", function(c) {
									...
									b.data = a(g).val(), ("nu" === b.op || "nn" === b.op || a.inArray(b.op, n.p.unaryOperations) >= 0) && (a(g).attr("readonly", "true"), a(g).attr("disabled", "true")), "select" === l.inputtype && l.searchoptions.multiple && a.isArray(b.data) && (b.data = b.data.join(",")), n.onchange()
								}, 0)
							}
						});
						var v = 0;
						...
						("nu" === b.op || "nn" === b.op || a.inArray(b.op, n.p.unaryOperations) >= 0) && (a(z).attr("readonly", "true"), a(z).attr("disabled", "true"));
						...
						for (y.append(A), A.on("change", function() {
								...
								"nu" === b.op || "nn" === b.op || a.inArray(b.op, n.p.unaryOperations) >= 0 ? (b.data = "", "SELECT" !== c.tagName.toUpperCase() && (c.value = ""), c.setAttribute("readonly", "true"), c.setAttribute("disabled", "true")) : ("SELECT" === c.tagName.toUpperCase() && (b.data = c.value), c.removeAttribute("readonly"), c.removeAttribute("disabled")), n.onchange()
						...
						return void
						0 === d ? "" : (f = this.p.autoencode ? a.jgrid.htmlEncode(b.data) : b.data, "bw" !== h && "bn" !== h || (f += "%"), "ew" !== h && "en" !== h || (f = "%" + f), "cn" !== h && "nc" !== h || (f = "%" + f + "%"), "in" !== h && "ni" !== h || (f = " (" + f + ")"), e.errorcheck && k(b.data, d), -1 !== a.inArray(d.searchtype, i) || "nn" === h || "nu" === h || a.inArray(b.op, this.p.unaryOperations) >= 0 ? b.field + " " + g + " " + f : b.field + " " + g + ' "' + f + '"')
		...
		filterRefactor: function(b) {
			var c, d, e, f, g, h = {};
			try {
				if (h = "string" == typeof b.ruleGroup ? a.jgrid.parse(b.ruleGroup) : b.ruleGroup, h.rules && h.rules.length)
		...
		filterToolbar: function(b) {
			...
			return b = a.extend({
				...
				if (!d.p.filterToolbar) {
					if (a(d).data("filterToolbar") || a(d).data("filterToolbar", b), d.p.force_regional && (b = a.extend(b, c)), void 0 !== d.p.customFilterDef)
						for (var f in d.p.customFilterDef) d.p.customFilterDef.hasOwnProperty(f) && !b.operands.hasOwnProperty(f) && (b.odata.push({
							oper: f,
							text: d.p.customFilterDef[f].text
						}), b.operands[f] = d.p.customFilterDef[f].operand, !0 === d.p.customFilterDef[f].unary && e.push(f));
					var g, h, i, j = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].filter,
						k = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common,
						l = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].base,
						m = function() {
							var c, f, g, h, i = {},
								j = 0,
								k = {},
							...
							if (a.each(d.p.colModel, function() {
								...
								if (!0 === b.stringResult || "local" === d.p.datatype || !0 === b.searchOperators) {
									...
									a.each(i, function(a, b) {
										s > 0 && (r += ","), r += '{"field":"' + a + '",', r += '"op":"' + k[a] + '",', b += "", r += '"data":"' + b.replace(/\\/g, "\\\\").replace(/\"/g, '\\"') + '"}', s++
									}), r += "]}";
									var t, u, v, w, x, y, z;
									if (l && (t = a.jgrid.filterRefactor({
											ruleGroup: r,
											ssfield: m,
											splitSelect: b.splitSelect,
											groupOpSelect: b.groupOpSelect
										}), r = JSON.stringify(t)), n && (a.isPlainObject(t) || (t = a.jgrid.parse(r)), t.rules && t.rules.length))
										for (u = t.rules, v = 0; v < u.length; v++) x = u[v], "bt" === x.op && (y = x.data.split("..."), y.length > 1 && (void 0 === t.groups && (t.groups = []), z = {
											groupOp: "AND",
											groups: [],
											rules: []
										}, t.groups.push(z), a.each(y, function(a) {
											var b = 0 === a ? "ge" : "le";
											(w = y[a]) && z.rules.push({
												data: y[a],
												op: b,
									...
									(n || l) && (r = JSON.stringify(t)), a.extend(d.p.postData, {
										filters: r
									}), a.each(["searchField", "searchString", "searchOper"], function(a, b) {
										d.p.postData.hasOwnProperty(b) && delete
										d.p.postData[b]
									})
								} else a.extend(d.p.postData, i);
								var A;
								b.url && (A = d.p.url, a(d).jqGrid("setGridParam", {
									url: b.url
								}));
								var B = "stop" === a(d).triggerHandler("jqGridToolbarBeforeSearch");
								!B && a.isFunction(b.beforeSearch) && (B = b.beforeSearch.call(d)), B || a(d).jqGrid("setGridParam", {
									search: q
								}).trigger("reloadGrid", [{
									page: 1
							...
							if (a.isFunction(p)) p.call(d, o[1]);
							else {
								var C = a.jgrid.getRegional(d, "errors");
								a.jgrid.info_dialog(C.errcap, o[1], "", {
									styleUI: d.p.styleUI
								})
							}
						},
						...
						p = function(c, f, g) {
							...
							for (var h, i, l = a(".ui-jqgrid").css("font-size") || "11px", n = '<ul id="sopt_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="font-size:' + l + ";left:" + f + "px;top:" + g + 'px;">', o = a(c).attr("soper"), p = [], q = 0, r = a(c).attr("colname"), s = d.p.colModel.length; q < s && d.p.colModel[q].name !== r;) q++;
							var t = d.p.colModel[q],
								u = a.extend({}, t.searchoptions);
							for (u.sopt || (u.sopt = [], u.sopt[0] = "select" === t.stype ? "eq" : b.defaultSearch), a.each(b.odata, function() {
									p.push(this.oper)
								}), q = 0; q < u.sopt.length; q++) - 1 !== (i = a.inArray(u.sopt[q], p)) && (h = o === b.odata[i].oper ? k.highlight : "", n += '<li class="ui-menu-item ' + h + '" role="presentation"><a class="' + k.cornerall + ' g-menu-item" tabindex="0" role="menuitem" value="' + b.odata[i].oper + '" oper="' + b.operands[b.odata[i].oper] + '"><table class="ui-common-table"><tr><td width="25px">' + b.operands[b.odata[i].oper] + "</td><td>" + b.odata[i].text + "</td></tr></table></a></li>");
							n += "</ul>", a("body").append(n), a("#sopt_menu").addClass("ui-menu " + j.menu_widget), a("#sopt_menu > li > a").hover(function() {
								...
								var f = a(this).attr("value"),
									g = a(this).attr("oper");
								if (a(d).triggerHandler("jqGridToolbarSelectOper", [f, g, c]), a("#sopt_menu").hide(), a(c).text(g).attr("soper", f), !0 === b.autosearch) {
									var h = a(c).parent().next().children()[0];
									(a(h).val() || "nu" === f || "nn" === f || a.inArray(f, e) >= 0) && m()
								}
							})
						},
						q = a("<tr class='ui-search-toolbar' role='row'></tr>");
					b.restoreFromFilters && (i = d.p.postData.filters) && ("string" == typeof i && (i = a.jgrid.parse(i)), h = !!i.rules.length && i.rules), a.each(d.p.colModel, function(c) {
						var e, f, i, k, n, o, p, r, s = this,
							t = "",
							u = "=",
							v = a("<th role='columnheader' class='" + l.headerBox + " ui-th-" + d.p.direction + "' id='gsh_" + d.p.id + "_" + s.name + "' ></th>"),
							w = a("<div></div>"),
						...
						if (!0 === this.hidden && a(v).css("display", "none"), this.search = !1 !== this.search, void 0 === this.stype && (this.stype = "text"), this.searchoptions = this.searchoptions || {}, void 0 === this.searchoptions.searchOperMenu && (this.searchoptions.searchOperMenu = !0), e = a.extend({}, this.searchoptions, {
								name: s.index || s.name,
								id: "gs_" + d.p.idPrefix + s.name,
								oper: "search"
							}), this.search) {
							if (b.restoreFromFilters && h) {
								r = !1;
							...
							if (b.searchOperators) {
								for (f = e.sopt ? e.sopt[0] : "select" === s.stype ? "eq" : b.defaultSearch, b.restoreFromFilters && r && (f = r.op), i = 0; i < b.odata.length; i++)
									if (b.odata[i].oper === f) {
										u = b.operands[f] || "";
										break
									}
								k = null != e.searchtitle ? e.searchtitle : b.operandTitle, t = this.searchoptions.searchOperMenu ? "<a title='" + k + "' style='padding-right: 0.5em;' soper='" + f + "' class='soptclass' colname='" + this.name + "'>" + u + "</a>" : ""
							}
							switch (a("td:eq(0)", x).attr("columname", s.name).append(t), void 0 === e.clearSearch && (e.clearSearch = !0), e.clearSearch ? (n = b.resetTitle || "Clear Search Value", a("td:eq(2)", x).append("<a title='" + n + "' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>" + b.resetIcon + "</a>")) : a("td:eq(2)", x).hide(), this.surl && (e.dataUrl = this.surl), o = "", e.defaultValue && (o = a.isFunction(e.defaultValue) ? e.defaultValue.call(d) : e.defaultValue), b.restoreFromFilters && r && (o = r.data), p = a.jgrid.createEl.call(d, this.stype, e, o, !1, a.extend({}, a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), a(p).addClass(j.srInput), a("td:eq(1)", x).append(p), a(w).append(x), null == e.dataEvents && (e.dataEvents = []), this.stype) {
								case "select":
									!0 === b.autosearch && e.dataEvents.push({
										type: "change",
										fn: function() {
											return m(), !1
										}
									...
									break;
								case "text":
									!0 === b.autosearch && (b.searchOnEnter ? e.dataEvents.push({
										type: "keypress",
										fn: function(a) {
											return 13 === (a.charCode || a.keyCode || 0) ? (m(), !1) : this
										}
									}) : e.dataEvents.push({
										type: "keydown",
										fn: function(a) {
						...
						a(v).append(w), a(q).append(v), b.searchOperators && "" !== t || a("td:eq(0)", x).hide()
					}), a("table thead", d.grid.hDiv).append(q), b.searchOperators && (a(".soptclass", q).click(function(b) {
						var c = a(this).offset(),
							d = c.left,
							e = c.top;
						p(this, d, e), b.stopPropagation()
					}), a("body").on("click", function(b) {
						"soptclass" !== b.target.className && a("#sopt_menu").remove()
					})), a(".clearsearchclass", q).click(function() {
						for (var c, f, g = a(this).parents("tr:first"), h = a("td.ui-search-oper", g).attr("columname"), i = 0, j = d.p.colModel.length, k = a("td.ui-search-oper a", g).attr("soper"); i < j;) {
							if (d.p.colModel[i].name === h) {
								c = d.p.colModel[i];
								break
							}
							i++
						}
						var l, n = a.extend({}, d.p.colModel[i].searchoptions || {}),
							o = n.defaultValue ? n.defaultValue : "";
						if ("select" === d.p.colModel[i].stype ? (l = a("td.ui-search-input select", g), o ? l.val(o) : l[0].selectedIndex = 0) : (l = a("td.ui-search-input input", g), l.val(o)), a(d).triggerHandler("jqGridToolbarClearVal", [l[0], i, n, o]), a.isFunction(b.onClearSearchValue) && b.onClearSearchValue.call(d, l[0], i, n, o), "nu" === k || "nn" === k || a.inArray(k, e) >= 0) {
							f = n.sopt ? n.sopt[0] : "select" === c.stype ? "eq" : b.defaultSearch;
							var p = null != d.p.customFilterDef && null != d.p.customFilterDef[f] ? d.p.customFilterDef[f].operand : b.operands[f] || "";
							f === k ? a("td.ui-search-oper a", g).attr("soper", "dummy").text(p) : a("td.ui-search-oper a", g).attr("soper", f).text(p)
						}!0 === b.autosearch && (m(), f === k && a("td.ui-search-oper a", g).attr("soper", f).text(p))
					}), a(d.grid.hDiv).on("scroll", function(a) {
						d.grid.bDiv.scrollLeft = d.grid.hDiv.scrollLeft
					}), this.p.filterToolbar = !0, this.triggerToolbar = m, this.clearToolbar = n, this.toggleToolbar = o
				}
			})
		},
		...
		refreshFilterToolbar: function(b) {
			return b = a.extend(!0, {
				...
				c(g) {
					if (g && g.rules) {
						for (h = g.rules, m = h.length, d = 0; d < m; d++)
							if (i = h[d], -1 !== (j = a.inArray(i.field, n)) && (f = a("#gs_" + k.p.idPrefix + a.jgrid.jqID(l[j].name)), f.length > 0 && ("select" === l[j].stype ? f.find("option[value='" + a.jgrid.jqID(i.data) + "']").prop("selected", !0) : "text" === l[j].stype && f.val(i.data), a.isFunction(b.onSetVal) && b.onSetVal.call(k, f, l[j].name), e && e.searchOperators))) {
								var o = f.parent().prev();
						...
						if (g.groups)
							for (var p = 0; p < g.groups.length; p++) c(g.groups[p])
					}
				}
				var d, e, f, g, h, i, j, k = this,
					l = k.p.colModel,
					m = k.p.colModel.length,
					n = [];
			...
			return b = a.extend(!0, {
				...
				if (d.grid) {
					var e, f = "fbox_" + d.p.id,
						...
						k = [],
						l = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].filter,
						m = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common;
					if (b.styleUI = d.p.styleUI, "string" == typeof j && (j = a.jgrid.parse(j)), !0 === b.recreateFilter && a("#" + a.jgrid.jqID(i.themodal)).remove(), void 0 !== a("#" + a.jgrid.jqID(i.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID(d.p.id)));
						...
						var n = a("<div><div id='" + f + "' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_" + a.jgrid.jqID(d.p.id)),
							o = "left",
							p = "";
						"rtl" === d.p.direction && (o = "right", p = " style='text-align:left'", n.attr("dir", "rtl"));
						var q, r, s = a.extend([], d.p.colModel),
							t = "<a id='" + f + "_search' class='fm-button " + m.button + " fm-button-icon-right ui-search'><span class='" + m.icon_base + " " + l.icon_search + "'></span>" + b.Find + "</a>",
							u = "<a id='" + f + "_reset' class='fm-button " + m.button + " fm-button-icon-left ui-reset'><span class='" + m.icon_base + " " + l.icon_reset + "'></span>" + b.Reset + "</a>",
							v = "",
							w = "",
							x = !1,
							y = -1,
							z = !1,
							A = [];
						b.showQuery && (v = "<a id='" + f + "_query' class='fm-button " + m.button + " fm-button-icon-left'><span class='" + m.icon_base + " " + l.icon_query + "'></span>Query</a>");
						var B = a.jgrid.buildButtons(b.buttons, v + t, m),
							C = null;
						if (d.p.groupHeader && d.p.groupHeader.length > 0) {
							var D = a("table.ui-jqgrid-htable", d.grid.hDiv),
								E = D.find(".jqg-second-row-header"),
								F = d.p.groupHeader.length;
							void
							0 !== E[0] && (C = d.p.groupHeader[F - 1])
						}
						var G = function(a, b) {
							var c, d = b.length;
							for (c = 0; c < d; c++)
						...
						if (b.columns.length) s = b.columns, y = 0, q = s[0].index || s[0].name;
						else {
							if (null !== C)
								for (var H = 0; H < s.length; H++) {
									var I = G(s[H].name, C.groupHeaders);
									if (I >= 0) {
										s[H].label = C.groupHeaders[I].titleText + "::" + d.p.colNames[H];
										for (var J = 1; J <= C.groupHeaders[I].numberOfColumns - 1; J++) s[H + J].label = C.groupHeaders[I].titleText + "::" + d.p.colNames[H + J];
										H = H + C.groupHeaders[I].numberOfColumns - 1
									}
								}
							a.each(s, function(a, b) {
								if (b.label || (b.label = d.p.colNames[a]), !x) {
									var c = void
									0 === b.search || b.search, e = !0 === b.hidden;
									(b.searchoptions && !0 === b.searchoptions.searchhidden && c || c && !e) && (x = !0, q = b.index || b.name, y = a)
								}
								"select" === b.stype && b.searchoptions && b.searchoptions.multiple && (z = !0, A.push(b.index || b.name))
							})
						}
						if (!j && q || !1 === b.multipleSearch) {
							var K = "eq";
							y >= 0 && s[y].searchoptions && s[y].searchoptions.sopt ? K = s[y].searchoptions.sopt[0] : b.sopt && b.sopt.length && (K = b.sopt[0]), j = {
								groupOp: "AND",
								rules: [{
									field: q,
									op: K,
						...
						if (x = !1, b.tmplNames && b.tmplNames.length && (x = !0, w = "<tr><td class='ui-search-label'>" + b.tmplLabel + "</td>", w += "<td><select size='1' class='ui-template " + l.srSelect + "'>", w += "<option value='default'>Default</option>", a.each(b.tmplNames, function(a, b) {
								w += "<option value='" + a + "'>" + b + "</option>"
							}), w += "</select></td></tr>"), void 0 !== d.p.customFilterDef)
							for (var L in d.p.customFilterDef) d.p.customFilterDef.hasOwnProperty(L) && !b.operands.hasOwnProperty(L) && (b.odata.push({
								oper: L,
								text: d.p.customFilterDef[L].text
							}), b.operands[L] = d.p.customFilterDef[L].operand, !0 === d.p.customFilterDef[L].unary && k.push(L));
						r = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + f + "_2'><tbody><tr><td colspan='2'><hr class='" + m.content + "' style='margin:1px'/></td></tr>" + w + "<tr><td class='EditButton' style='text-align:" + o + "'>" + u + "</td><td class='EditButton' " + p + ">" + B + "</td></tr></tbody></table>", f = a.jgrid.jqID(f), a("#" + f).jqFilter({
							columns: s,
							...
							id: d.p.id
						}), n.append(r), a("#" + f + "_2").find("[data-index]").each(function() {
							var c = parseInt(a(this).attr("data-index"), 10);
							c >= 0 && a(this).on("click", function(e) {
								b.buttons[c].click.call(d, a("#" + f), b, e)
							})
						}), x && b.tmplFilters && b.tmplFilters.length && a(".ui-template", n).on("change", function() {
							var c = a(this).val();
						...
						var M = a(".ui-jqgrid").css("font-size") || "11px";
						b.layer ? a.jgrid.createModal(i, n, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0], "string" == typeof b.layer ? "#" + a.jgrid.jqID(b.layer) : b.layer, "string" == typeof b.layer ? {
							position: "relative",
							"font-size": M
						} : {
							"font-size": M
						}) : a.jgrid.createModal(i, n, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0], null, {
							"font-size": M
						...
						}), v && a("#" + f + "_query").on("click", function() {
							return a(".queryresult", n).toggle(), !1
						}), void
						0 === b.stringResult && (b.stringResult = b.multipleSearch), a("#" + f + "_search").on("click", function() {
							var c, g, j = {};
							if (e = a("#" + f), e.find(".input-elm:focus").change(), z && b.multipleSearch ? (d.p_savedFilter = {}, g = a.jgrid.filterRefactor({
							...
							var c = {},
								e = a("#" + f);
							return d.p.search = !1, d.p.resetsearch = !0, !1 === b.multipleSearch ? c[b.sField] = c[b.sValue] = c[b.sOper] = "" : c[b.sFilter] = "", e[0].resetFilter(), x && a(".ui-template", n).val("default"), a.extend(d.p.postData, c), h = a(d).triggerHandler("jqGridFilterReset"), void
						...
						}), c(a("#" + f)), a(".fm-button:not(." + m.disabled + ")", n).hover(function() {
		...
		autoSelect: function(b) {
			return b = a.extend(!0, {
				...
				var c, d = this,
					e = "";
				if (b.field && d.p.data && a.isArray(d.p.data)) {
					var f, g, h, i, j, k, l, m = [];
					try {
						f = a.jgrid.from.call(d, d.p.data), k = f.groupBy(b.field, b.direction, "text", b.src_date), l = k.length
					} catch (a) {}
					if (k && k.length) {
						for (g = a("#gsh_" + d.p.id + "_" + b.field).find("td.ui-search-input > select"), l = k.length, b.allValues && (e = "<option value=''>" + b.allValues + "</option>", m.push(":" + b.allValues)); l--;) c = k[l], h = b.count_item ? " (" + c.items.length + ")" : "", e += "<option value='" + c.unique + "'>" + c.unique + h + "</option>", m.push(c.unique + ":" + c.unique + h);
						if (g.append(e), g.on("change", function() {
								d.triggerToolbar()
							}), b.create_value) {
							for (l = 0, j = d.p.colModel.length; l < j; l++)
								if (d.p.colModel[l].name === b.field) {
									i = d.p.colModel[l];
									break
								}
							i && (i.searchoptions ? a.extend(i.searchoptions, {
								value: m.join(";")
							}) : (i.searchoptions = {}, i.searchoptions.value = m.join(";")))
						}
					}
				}
			})
		...
		editRow: function(b, c, d, e, f, g, h, i, j) {
			...
			return "object" === a.type(l[0]) ? k = l[0] : (void 0 !== c && (k.keys = c), a.isFunction(d) && (k.oneditfunc = d), a.isFunction(e) && (k.successfunc = e), void 0 !== f && (k.url = f), void 0 !== g && (k.extraparam = g), a.isFunction(h) && (k.aftersavefunc = h), a.isFunction(i) && (k.errorfunc = i), a.isFunction(j) && (k.afterrestorefunc = j)), k = a.extend(!0, {
				...
				if (m.grid && !1 !== (f = a(m).jqGrid("getInd", b, !0))) {
					...
					e = a(f).attr("editable") || "0", "0" !== e || a(f).hasClass("not-editable-row") || (g = m.p.colModel, a(f).children('td[role="gridcell"]').each(function(e) {
						c = g[e].name;
						...
						if ("cb" !== c && "subgrid" !== c && "rn" !== c && (m.p.autoencode && (d = a.jgrid.htmlDecode(d)), !0 === g[e].editable)) {
							l[c] = d, null === j && (j = e), f ? a("span:first", this).html("") : a(this).html("");
							...
							g[e].edittype || (g[e].edittype = "text"), ("&nbsp;" === d || "&#160;" === d || null !== d && 1 === d.length && 160 === d.charCodeAt(0)) && (d = "");
		...
		saveRow: function(b, c, d, e, f, g, h) {
			...
			if (void 0 === y && (y = !0), y) {
				if (m = a(p).attr("editable"), j.url = j.url || k.p.editurl, "1" === m) {
					var z, A, B;
					if (a(p).children('td[role="gridcell"]').each(function(b) {
					...
					if ("clientArray" === j.url) {
						...
						}), r = a.isFunction(k.p.serializeRowData) ? k.p.serializeRowData.call(k, r) : r;
					...
					if (i = j.p.colModel[c], "subgrid" !== (f = i.name) && "cb" !== f && "rn" !== f) {
						...
						if (h.addClass("edit-cell " + k), a(j.rows[b]).addClass("selected-row " + l), !0 !== i.editable || !0 !== d || h.hasClass("not-editable-cell") || a.isFunction(j.p.isCellEditable) && !j.p.isCellEditable.call(j, f, b, c)) g = h.html().replace(/\&#160\;/gi, ""), a(j).triggerHandler("jqGridCellSelect", [j.rows[b].id, c, g, e]), a.isFunction(j.p.onCellSelect) && j.p.onCellSelect.call(j, j.rows[b].id, c, g, e);
							...
							a.inArray(i.edittype, ["text", "textarea", "password", "select"]) > -1 && a(q).addClass(m), h.html("").append(q).attr("tabindex", "0"), a.jgrid.bindEv.call(j, q, p), window.setTimeout(function() {
								...
								if (27 === d.keyCode && (a("input.hasDatepicker", h).length > 0 ? a(".ui-datepicker").is(":hidden") ? a(j).jqGrid("restoreCell", b, c) : a("input.hasDatepicker", h).datepicker("hide") : a(j).jqGrid("restoreCell", b, c)), 13 === d.keyCode && d.altKey && "TEXTAREA" === this.nodeName) return this.value = this.value + "\r", !0;
								if (13 === d.keyCode && !d.shiftKey) return a(j).jqGrid("saveCell", b, c), !1;
								if (9 === d.keyCode) {
					...
					if (null !== e) {
						...
						switch (l.edittype) {
							case "select":
								...
								} else h = a("#" + b + "_" + n + " option:selected", j).val(), i = a("#" + b + "_" + n + " option:selected", j).text();
								l.formatter && (i = h);
								break;
							case "checkbox":
								var r = ["Yes", "No"];
		...
		nextCell: function(b, c, d) {
			...
			return this.each(function() {
				...
				if (g.grid && !0 === g.p.cellEdit) {
					for (f = c + 1; f < g.p.colModel.length; f++)
						if (!0 === g.p.colModel[f].editable && (!a.isFunction(g.p.isCellEditable) || g.p.isCellEditable.call(g, g.p.colModel[f].name, b, f))) {
							h = f;
							break
						...
						m = function(b, c) {
							...
							a(h).append(i), b && (g = d.p.xmlReader.subgrid, a(g.root + " " + g.row, b).each(function() {
								if (i = a("<tr class='" + k.content + " ui-subtblcell'></tr>"), !0 === g.repeatitems) a(g.cell, this).each(function(b) {
									...
									if (b)
										for (f = 0; f < b.length; f++) l(i, a.jgrid.getXmlData(this, b[f]) || "&#160;", f)
								}
								a(h).append(i)
							}));
							...
							if (a(n).append(o), b && (i = d.p.jsonReader.subgrid, void 0 !== (f = a.jgrid.getAccessor(b, i.root))))
								for (g = 0; g < f.length; g++) {
									if (h = f[g], o = a("<tr class='" + k.content + " ui-subtblcell'></tr>"), !0 === i.repeatitems)
										...
										if (p.length)
											for (m = 0; m < p.length; m++) l(o, a.jgrid.getAccessor(h, p[m]) || "&#160;", m)
									}
									a(n).append(o)
								}
		...
		SortTree: function(b, c, d, e) {
			return this.each(function() {
				if (this.grid && this.p.treeGrid) {
					...
					var o = a(this).jqGrid("getDataIDs"),
						p = 1;
					a.each(k, function(b) {
						var c = a.jgrid.getAccessor(this, l.p.localReader.id); - 1 !== a.inArray(c, o) && (a("#" + a.jgrid.jqID(l.p.id) + " tbody tr:eq(" + p + ")").after(a("#" + a.jgrid.jqID(l.p.id) + " tbody tr#" + a.jgrid.jqID(c))), p++)
					}), i = null, j = null, k = null
				}
			})
		},
		searchTree: function(b) {
			var c, d, e, f, g, h, i, j = b.length || 0,
				k = [],
				l = [],
				m = [];
			return this.each(function() {
				if (this.grid && this.p.treeGrid && j)
					for (c = this.p.localReader.id, i = 0; i < j; i++) {
						if (k = a(this).jqGrid("getNodeAncestors", b[i], !0, !0), Boolean(this.p.FullTreeSearchResult)) {
							var n = a(this).jqGrid("getFullTreeNode", b[i], !0);
							k = k.concat(n)
						} else k.push(b[i]);
						if (d = k[0][c], -1 === a.inArray(d, l)) l.push(d), m = m.concat(k);
						else
			...
			return this.each(function() {
				...
				if (h.grid && h.p.treeGrid) {
					...
					if (void 0 !== l) {
						...
						if (m.length > 0)
							for (c = 0; c < m.length; c++) a(h).jqGrid("delRowData", h.p.idPrefix + m[c][i]);
			...
			return this.each(function() {
				...
				if (g.grid && g.p.treeGrid) {
					...
					if (void 0 !== k) {
						...
						if (l.length > 0)
							for (var m = 0; m < l.length; m++) l[m][h] !== b && a(g).jqGrid("delRowData", g.p.idPrefix + l[m][h]);
		...
		addChildNode: function(b, c, d, e) {
			...
			if (d) {
				...
				if (l = k + 1, void 0 === d[o] && (d[o] = !1), void 0 === d[u] && (d[u] = !1), d[q] = j, void 0 === d[p] && (d[p] = !0), "adjacency" === f.p.treeGridModel && (d[r] = c), "nested" === f.p.treeGridModel) {
					var A, B, C;
					if (null !== c) {
						if (n = parseInt(i[t], 10), A = a.jgrid.from.call(f, f.p.data), A = A.greaterOrEquals(t, n, {
								stype: "integer"
							}), B = A.select(), B.length)
							for (C in B) B.hasOwnProperty(C) && (B[C][s] = B[C][s] > n ? parseInt(B[C][s], 10) + 2 : B[C][s], B[C][t] = B[C][t] >= n ? parseInt(B[C][t], 10) + 2 : B[C][t]);
						d[s] = n, d[t] = n + 1
					} else {
						if (n = parseInt(a(f).jqGrid("getCol", t, !1, "max"), 10), B = a.jgrid.from.call(f, f.p.data).greater(s, n, {
								stype: "integer"
							}).select(), B.length)
							for (C in B) B.hasOwnProperty(C) && (B[C][s] = parseInt(B[C][s], 10) + 2);
						if (B = a.jgrid.from.call(f, f.p.data).greater(t, n, {
								stype: "integer"
							}).select(), B.length)
							for (C in B) B.hasOwnProperty(C) && (B[C][t] = parseInt(B[C][t], 10) + 2);
						d[s] = n + 1, d[t] = n + 2
					}
			...
			return this.each(function() {
				...
				f(b) {
					...
					jQuery(g).jqGrid(a.extend(!0, {
						...
						colModel: j.colModel,
						viewrecords: !0,
						formatFooterData: !0 === c.colTotals,
			...
			if (d = a.extend({
				...
				if (c) {
					...
					if ((e = a.jgrid.parseFunc(c)) && "object" === a.type(e)) {
						...
						var m = a("#" + b).jqGrid(e);
						if (m.jqGrid("delRowData", "norecs"), d.restoreData && "" !== a.trim(g) && m.append(g), m.jqGrid("setGridParam", l), e.storeNavOptions && e.navGrid && (m[0].p.navGrid = !1, m.jqGrid("navGrid", e.pager, e.navOptions, e.editOptions, e.addOptions, e.delOptions, e.searchOptions, e.viewOptions), e.navButtons && e.navButtons.length))
							for (var n = 0; n < e.navButtons.length; n++) "sepclass" in e.navButtons[n][1] ? m.jqGrid("navSeparatorAdd", e.navButtons[n][0], e.navButtons[n][1]) : m.jqGrid("navButtonAdd", e.navButtons[n][0], e.navButtons[n][1]);
...
! function(a) {
	...
	a.jgrid = a.jgrid || {}, a.extend(a.jgrid, {
		...
		formatCellCsv: function(b, c) {
			b = null == b ? "" : String(b);
			try {
				b = a.jgrid.stripHtml(b.replace(c._regexsep, c.separatorReplace).replace(/\r\n/g, c.replaceNewLine).replace(/\n/g, c.replaceNewLine))
			} catch (a) {
				b = ""
			}
			return c.escquote && (b = b.replace(c._regexquot, c.escquote + c.quote)), -1 !== b.indexOf(c.separator) && -1 !== b.indexOf(c.qoute) || (b = c.quote + b + c.quote), b
		},
		...
		makeNode: function(b, c, d) {
			...
			return d && (d.attr && a(e).attr(d.attr), d.children && a.each(d.children, function(a, b) {
				e.appendChild(b)
			}), d.hasOwnProperty("text") && e.appendChild(b.createTextNode(d.text))), e
		},
		...
		exportToCsv: function(b) {
			...
			if (this.each(function() {
					...
					d(b, c) {
								...
								if (m[j]._excol) {
									...
									a.each(k.summary, function() {
										if (this.nm === m[j].name) {
											...
											try {
												this.groupCount = k.cnt, this.groupIndex = k.dataIndex, this.groupValue = k.value, h = i.formatter("", this.v, j, this)
											} catch (a) {
												h = this.v
											}
						...
						if (r.reverse(), "local" === i.p.datatype && !i.p.loadonce) {
							a(i).jqGrid("groupingSetup");
							for (var s = a.jgrid.getMethod("groupingPrepare"), t = 0; t < k; t++) s.call(a(i), j[t], t)
						}
						return a.each(g.groups, function(d, j) {
							o++;
							try {
								p = a.isArray(g.formatDisplayField) && a.isFunction(g.formatDisplayField[j.idx]) ? g.formatDisplayField[j.idx].call(i, j.displayValue, j.value, i.p.colModel[h[j.idx]], j.idx, g) : i.formatter("", j.displayValue, h[j.idx], j.value)
							} catch (a) {
								p = j.displayValue
							}
							var k = "";
							"string" != typeof(k = a.isFunction(g.groupText[j.idx]) ? g.groupText[j.idx].call(i, p, j.cnt, j.summary) : a.jgrid.template(g.groupText[j.idx], p, j.cnt, j.summary)) && "number" != typeof
							k && (k = p);
							var n;
							if (n = "header" === g.groupSummaryPos[j.idx] ? e(d, 0, g.groups, 0) : new Array(c.collen), n[0] = a.jgrid.formatCellCsv(a.jgrid.stripHtml(k), c), f += n.join(c.separator) + c.newLine, l - 1 === j.idx) {
								...
								for (s = x; s < y && b[s - w]; s++) {
									for (u = b[s - w], q = 0, t = 0; t < m.length; t++) m[t]._expcol && (n[q] = a.jgrid.formatCellCsv(a.jgrid.formatCell(a.jgrid.getAccessor(u, m[t].name), t, u, m[t], i, "csv"), c), q++);
					...
					RegExp(b.quote, "g");
					var e, f, g, h, i = this,
						j = i.p.treeGrid ? a(i).jqGrid("getRowData", null, !0, b.treeindent) : i.addLocalData(!0),
						k = j.length,
						l = i.p.colModel,
						m = l.length,
						n = i.p.colNames,
						...
						u = [],
						v = "";
					a.isFunction(b.loadIndicator) ? b.loadIndicator("show") : b.loadIndicator && a(i).jqGrid("progressBar", {
						method: "show",
						loadtype: i.p.loadui,
						htmlcontent: a.jgrid.getRegional(i, "defaults.loadtext")
					});
					var w, x = [];
					if (a.each(l, function(c, d) {
							d._expcol = !0, void
							0 === d.exportcol ? d.hidden && (d._expcol = !1) : d._expcol = d.exportcol, "cb" !== d.name && "rn" !== d.name && "subgrid" !== d.name || (d._expcol = !1), d._expcol && (u.push(a.jgrid.formatCellCsv(n[c], b)), x.push(d.name))
						}), b.includeLabels && (t = u.join(b.separator) + b.newLine), b.collen = u.length, i.p.grouping) {
						var y = !!i.p.groupingView._locgr;
						i.p.groupingView._locgr = !1, p += d(j, b), i.p.groupingView._locgr = y
					} else
						for (; o < k;) {
							for (f = j[o], g = [], h = 0, e = 0; e < m; e++) l[e]._expcol && (g[h] = a.jgrid.formatCellCsv(a.jgrid.formatCell(a.jgrid.getAccessor(f, l[e].name), e, f, l[e], i, "csv"), b), h++);
							p += g.join(b.separator) + b.newLine, o++
						}
					if (j = null, g = new Array(b.collen), b.includeCaption && i.p.caption) {
						for (o = b.collen; --o;) g[o] = "";
						g[0] = a.jgrid.formatCellCsv(i.p.caption, b), q += g.join(b.separator) + b.newLine
					}
					if (b.includeGroupHeader && i.p.groupHeader && i.p.groupHeader.length) {
						var z = i.p.groupHeader;
						for (e = 0; e < z.length; e++) {
							var A = z[e].groupHeaders;
							for (o = 0, g = [], w = 0; w < x.length; w++) {
								for (g[o] = "", h = 0; h < A.length; h++) A[h].startColumnName === x[w] && (g[o] = a.jgrid.formatCellCsv(A[h].titleText, b));
								o++
							}
					...
					if (b.includeFooter && i.p.footerrow) {
						if (a(".ui-jqgrid-ftable", this.sDiv).length) {
							var B = a(i).jqGrid("footerData", "get");
							for (e = 0, g = []; e < b.collen;) {
								var C = x[e];
								B.hasOwnProperty(C) && g.push(a.jgrid.formatCellCsv(a.jgrid.stripHtml(B[C]), b)), e++
							}
							s += g.join(b.separator) + b.newLine
						}
					}
					if (b.includeHeader && i.p.headerrow) {
						var D = a(i).jqGrid("headerData", "get");
						for (e = 0, g = []; e < b.collen;) {
							var E = x[e];
							D.hasOwnProperty(E) && g.push(a.jgrid.formatCellCsv(a.jgrid.stripHtml(D[E]), b)), e++
						}
						v += g.join(b.separator) + b.newLine
					}
					c = q + r + t + v + p + s, a.isFunction(b.loadIndicator) ? b.loadIndicator("hide") : b.loadIndicator && a(i).jqGrid("progressBar", {
						method: "hide",
						loadtype: i.p.loadui
					})
				}), b.returnAsString) return c;
			if (-1 !== b.mimetype.toUpperCase().indexOf("UTF-8") && (c = "\ufeff" + c), a.isFunction(b.onBeforeExport) && !(c = b.onBeforeExport(c))) throw "Before export does not return data!";
		...
		exportToExcel: function(b) {
			b = a.extend(!0, {
				...
				function
				d(b, c) {
					return a.jgrid.makeNode(n, "c", {
						attr: b,
						children: [a.jgrid.makeNode(n, "v", {
							text: c
						})]
					})
				}
				...
				f(b, c) {
					return a.jgrid.makeNode(n, "c", {
						...
						children: {
							row: a.jgrid.makeNode(n, "is", {
								children: {
									row: a.jgrid.makeNode(n, "t", {
										text: c
									})
								}
							})
				...
				g(a) {
					var b, c;
					(b = document.createElement("div")).innerHTML = a;
					var c = b.firstChild;
					return "A" === c.nodeName ? [c.href, c.text] : "#text" === c.nodeName && [c.textContent, c.textContent]
				}
				...
				h(b) {
						...
						for (j = g; j < i; j++)
							if (u[j]._expcol) {
								...
								a.each(l.summary, function() {
									if (this.nm === u[j].name) {
										u[j].summaryTpl && (o = u[j].summaryTpl), "string" == typeof
										this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && m > 0 && (this.v = this.v / m));
										try {
											this.groupCount = l.cnt, this.groupIndex = l.dataIndex, this.groupValue = l.value, h = k.formatter("", this.v, j, this)
										} catch (a) {
											h = this.v
										}
										return n[this.nm] = a.jgrid.stripHtml(a.jgrid.template(o, h)), !1
									}
								})
							}
						return n
					...
					var l, m = a.makeArray(f.groupSummary);
					if (m.reverse(), "local" === k.p.datatype && !k.p.loadonce) {
						a(k).jqGrid("groupingSetup");
						for (var n = a.jgrid.getMethod("groupingPrepare"), o = 0; o < w.body.length; o++) n.call(a(k), w.body[o], o)
					}
					a.each(f.groups, function(c, i) {
						j++;
						try {
							l = a.isArray(f.formatDisplayField) && a.isFunction(f.formatDisplayField[i.idx]) ? f.formatDisplayField[i.idx].call(k, i.displayValue, i.value, k.p.colModel[g[i.idx]], i.idx, f) : k.formatter("", i.displayValue, g[i.idx], i.value)
						} catch (a) {
							l = i.displayValue
						}
						var n = "";
						"string" != typeof(n = a.isFunction(f.groupText[i.idx]) ? f.groupText[i.idx].call(k, l, i.cnt, i.summary) : a.jgrid.template(f.groupText[i.idx], l, i.cnt, i.summary)) && "number" != typeof
						n && (n = l);
						var o;
						if (o = "header" === f.groupSummaryPos[i.idx] ? d(c, 0, f.groups, 0) : e(w.header), o[Object.keys(o)[0]] = a.jgrid.stripHtml(new Array(5 * i.idx).join(" ") + n), B(o, !0), h - 1 === i.idx) {
							var p, q, r = f.groups[c + 1],
								s = 0,
								t = i.startRow,
								u = void
							0 !== r ? r.startRow : f.groups[c].startRow + f.groups[c].cnt;
							for (p = t; p < u && b[p - s]; p++) {
								var v = b[p - s];
								B(v, !1)
							}
							if ("header" !== f.groupSummaryPos[i.idx]) {
								var x;
								if (void 0 !== r) {
									for (x = 0; x < f.groupField.length && r.dataIndex !== f.groupField[x]; x++);
									j = f.groupField.length - x
								}
								for (q = 0; q < j; q++) m[q] && (o = d(c, q, f.groups, 0), B(o, !0));
								j = x
							}
						}
					})
				...
				var i, j, k = this,
					l = a.jgrid.excelStrings,
					m = 0,
					n = a.parseXML(l["xl/worksheets/sheet1.xml"]),
					o = n.getElementsByTagName("sheetData")[0],
					p = a.parseXML(l["xl/styles.xml"]),
					q = p.getElementsByTagName("numFmts")[0],
					r = a(q.getElementsByTagName("numFmt")),
					s = p.getElementsByTagName("cellXfs")[0],
					t = {
						_rels: {
							".rels": a.parseXML(l["_rels/.rels"])
						},
						xl: {
							_rels: {
								"workbook.xml.rels": a.parseXML(l["xl/_rels/workbook.xml.rels"])
							},
							"workbook.xml": a.parseXML(l["xl/workbook.xml"]),
							"styles.xml": p,
							worksheets: {
								"sheet1.xml": n
							}
						},
						"[Content_Types].xml": a.parseXML(l["[Content_Types].xml"])
					},
					u = k.p.colModel,
					v = 0,
					w = {
						body: k.p.treeGrid ? a(k).jqGrid("getRowData", null, !0, b.treeindent) : k.addLocalData(!0),
						header: [],
						footer: [],
						width: [],
						map: [],
					...
					x = function(b) {
						if (a.isEmptyObject(b)) b.excel_parsers = !0;
						else
						if (b.excel_format && !b.excel_style) {
							var c = 0,
								d = 0;
							a.each(r, function(b, e) {
								c++, d = Math.max(d, parseInt(a(e).attr("numFmtId"), 10))
							});
							var e = a.jgrid.makeNode(p, "numFmt", {
								attr: {
									numFmtId: d + 1,
									formatCode: b.excel_format
								}
							});
							q.appendChild(e), a(q).attr("count", c + 1), c = 0, e = a.jgrid.makeNode(p, "xf", {
								attr: {
									numFmtId: d + 1 + "",
									fontId: "0",
									fillId: "0",
							...
							}), s.appendChild(e), c = parseInt(a(s).attr("count"), 10), a(s).attr("count", c + 1), b.excel_style = c + 1
						}
						return b
					};
				for (i = 0, j = u.length; i < j; i++) u[i]._expcol = !0, void
				0 === u[i].exportcol ? u[i].hidden && (u[i]._expcol = !1) : u[i]._expcol = u[i].exportcol, "cb" !== u[i].name && "rn" !== u[i].name && "subgrid" !== u[i].name && u[i]._expcol && (w.header[v] = u[i].name, w.width[v] = 5, w.map[v] = i, w.parser[i] = x(u[i].hasOwnProperty("exportoptions") ? u[i].exportoptions : {}), v++);
				var y, z, A = a.isFunction(b.replaceStr) ? b.replaceStr : c,
					B = function(c, h) {
						y = m + 1, z = a.jgrid.makeNode(n, "row", {
							attr: {
								r: y
							}
						});
						for (var i, j = 15, l = 0; l < w.header.length; l++) {
							var p, q, r = a.jgrid.excelCellPos(l) + "" + y,
								s = a.isArray(c) && h ? k.p.colNames[w.map[l]] : a.jgrid.getAccessor(c, w.header[l]);
							null == s && (s = ""), h || (s = a.jgrid.formatCell(s, w.map[l], c, u[w.map[l]], k, "excel")), w.width[l] = Math.max(w.width[l], Math.min(parseInt(s.toString().length, 10), b.maxlength)), p = null;
							var t = w.parser[w.map[l]];
							if (!0 !== t.excel_parsers || h) void
							0 === t.excel_format || void
							0 === t.excel_style || h || p || (t.replace_format && (s = t.replace_format(s)), p = d({
								r: r,
								s: t.excel_style
							}, s), z.appendChild(p));
							else
								for (var v = 0, x = a.jgrid.excelParsers.length; v < x; v++) {
									var B = a.jgrid.excelParsers[v];
									if (s.match && !s.match(/^0\d+/) && s.match(B.match)) {
										var C = s;
										if (s = s.replace(/[^\d\.\-]/g, ""), B.fmt && (s = B.fmt(s)), 67 === B.style) p = d({
											t: "d",
											r: r,
											s: B.style
										}, s);
										else
										if (4 === B.style) s = g(C), p = s ? e({
											t: "str",
											r: r,
											s: B.style
										}, 'HYPERLINK("' + s[0] + '","' + s[1] + '")') : f(r, C);
										else {
											if (a.inArray(B.style, ["63", "64", "65", "66"]) && s.toString().length > j) {
												i = C.replace ? A(C) : C, p = f(r, i), z.appendChild(p);
												break
											}
											p = d({
												r: r,
							...
							p || (s.match && (q = s.match(/^-?([1-9]\d+)(\.(\d+))?$/)), "number" == typeof s && s.toString().length <= j || q && q[1].length + (q[2] ? q[3].length : 0) <= j ? p = d({
								t: "n",
								r: r
							}, s) : (i = s.replace ? A(s) : s, p = f(r, i)), z.appendChild(p))
						}
						o.appendChild(z), m++
					};
				if (a.isFunction(b.loadIndicator) ? b.loadIndicator("show") : b.loadIndicator && a(k).jqGrid("progressBar", {
						method: "show",
						loadtype: k.p.loadui,
						htmlcontent: a.jgrid.getRegional(k, "defaults.loadtext")
					}), a("sheets sheet", t.xl["workbook.xml"]).attr("name", b.sheetName), b.includeGroupHeader && k.p.groupHeader && k.p.groupHeader.length) {
					var C, D, E = k.p.groupHeader,
						F = [],
						G = 0;
					for (D = 0; D < E.length; D++) {
						var H = E[D].groupHeaders,
							I = {};
						for (G++, i = 0, i = 0; i < w.header.length; i++) {
							C = w.header[i], I[C] = "";
							for (var J = 0; J < H.length; J++)
								if (H[J].startColumnName === C) {
									I[C] = H[J].titleText;
									var K = a.jgrid.excelCellPos(i) + G,
										L = a.jgrid.excelCellPos(i + H[J].numberOfColumns - 1) + G;
									F.push({
										ref: K + ":" + L
									})
								}
					...
					a("row c", n).attr("s", "2");
					var M = a.jgrid.makeNode(n, "mergeCells", {
						attr: {
							count: F.length
						}
					});
					for (a("worksheet", n).append(M), v = 0; v < F.length; v++) M.appendChild(a.jgrid.makeNode(n, "mergeCell", {
						attr: F[v]
					}))
				}
				if (b.includeLabels && (B(w.header, !0), a("row:last c", n).attr("s", "2")), b.includeHeader || k.p.headerrow) {
					var N = a(k).jqGrid("headerData", "get");
					for (v in N) N.hasOwnProperty(v) && (N[v] = a.jgrid.stripHtml(N[v]));
					B(N, !1), a("row:last c", n).attr("s", "2")
				}
				if (k.p.grouping) {
					var O = !!k.p.groupingView._locgr;
					k.p.groupingView._locgr = !1, h(w.body), k.p.groupingView._locgr = O
				} else
					for (var P = 0, Q = w.body.length; P < Q; P++) B(w.body[P], !1);
				if (b.includeFooter || k.p.footerrow) {
					w.footer = a(k).jqGrid("footerData", "get");
					for (v in w.footer) w.footer.hasOwnProperty(v) && (w.footer[v] = a.jgrid.stripHtml(w.footer[v]));
					B(w.footer, !1), a("row:last c", n).attr("s", "2")
				}
				var R = a.jgrid.makeNode(n, "cols");
				for (a("worksheet", n).prepend(R), v = 0, j = w.width.length; v < j; v++) R.appendChild(a.jgrid.makeNode(n, "col", {
					attr: {
						min: v + 1,
						max: v + 1,
						width: w.width[v],
				...
				a.isFunction(b.onBeforeExport) && b.onBeforeExport(t, m), w = null;
				try {
					var S = new
					JSZip, T = {
						type: "blob",
					...
					a.jgrid.xmlToZip(S, t), S.generateAsync ? S.generateAsync(T).then(function(c) {
						a.jgrid.saveAs(c, b.fileName, {
							type: b.mimetype
						})
					}) : a.jgrid.saveAs(S.generate(T), b.fileName, {
						type: b.mimetype
					})
				} catch (a) {
					throw a
				} finally {
					a.isFunction(b.loadIndicator) ? b.loadIndicator("hide") : b.loadIndicator && a(k).jqGrid("progressBar", {
						method: "hide",
						loadtype: k.p.loadui
					})
				}
		...
		exportToPdf: function(b) {
			return b = a.extend(!0, {
				...
				c(b) {
					function
					c(b, c) {
						for (var d = 0, e = [], f = 0; f < l.length; f++) j = {
							text: null == b[l[f]] ? "" : c ? a.jgrid.formatCell(b[l[f]] + "", n[d], k[m], r[n[d]], g, "pdf") : b[l[f]],
							alignment: q[f],
							style: "tableBody"
						}, e.push(j), d++;
						return e
							...
							if (r[j]._expcol) {
								...
								a.each(k.summary, function() {
									if (this.nm === r[j].name) {
										...
										this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && m > 0 && (this.v = this.v / m));
										try {
											this.groupCount = k.cnt, this.groupIndex = k.dataIndex, this.groupValue = k.value, i = g.formatter("", this.v, j, this)
										} catch (a) {
											i = this.v
										}
					...
					var i = g.p.groupingView,
						o = [],
						p = i.groupField.length,
						r = g.p.colModel,
						s = r.length,
						t = 0;
					...
					var u, v = a.makeArray(i.groupSummary);
					if (v.reverse(), "local" === g.p.datatype && !g.p.loadonce) {
						a(g).jqGrid("groupingSetup");
						for (var w = a.jgrid.getMethod("groupingPrepare"), x = 0; x < k.length; x++) w.call(a(g), k[x], x)
					}
					a.each(i.groups, function(d, j) {
						t++;
						try {
							u = a.isArray(i.formatDisplayField) && a.isFunction(i.formatDisplayField[j.idx]) ? i.formatDisplayField[j.idx].call(g, j.displayValue, j.value, g.p.colModel[o[j.idx]], j.idx, i) : g.formatter("", j.displayValue, o[j.idx], j.value)
						} catch (a) {
							u = j.displayValue
						}
						var k = "";
						"string" != typeof(k = a.isFunction(i.groupText[j.idx]) ? i.groupText[j.idx].call(g, u, j.cnt, j.summary) : a.jgrid.template(i.groupText[j.idx], u, j.cnt, j.summary)) && "number" != typeof
						k && (k = u);
						var m;
						if (m = "header" === i.groupSummaryPos[j.idx] ? e(d, 0, i.groups, 0) : f(l), m[Object.keys(m)[0]] = a.jgrid.stripHtml(new Array(5 * j.idx).join(" ") + k), h.push(c(m, !1)), p - 1 === j.idx) {
							var n, q, r = i.groups[d + 1],
								s = 0,
								w = j.startRow,
								x = void
							0 !== r ? r.startRow : i.groups[d].startRow + i.groups[d].cnt;
							for (n = w; n < x && b[n - s]; n++) {
								var y = b[n - s];
								h.push(c(y, !0))
							}
							if ("header" !== i.groupSummaryPos[j.idx]) {
								var z;
								if (void 0 !== r) {
									for (z = 0; z < i.groupField.length && r.dataIndex !== i.groupField[z]; z++);
									t = i.groupField.length - z
								}
								for (q = 0; q < t; q++) v[q] && (m = e(d, q, i.groups, 0), h.push(c(m, !1)));
								t = z
							}
						}
					})
				...
				var d, e, f, g = this,
					...
					i = g.p.colModel,
					j = {},
					k = g.p.treeGrid ? a(g).jqGrid("getRowData", null, !0, b.treeindent) : g.addLocalData(!0),
					l = [],
					m = 0,
					n = [],
					o = [],
					p = [],
					q = {};
				a.isFunction(b.loadIndicator) ? b.loadIndicator("show") : b.loadIndicator && a(g).jqGrid("progressBar", {
					method: "show",
					loadtype: g.p.loadui,
					htmlcontent: a.jgrid.getRegional(g, "defaults.loadtext")
				});
				var r;
				for (d = 0, e = i.length; d < e; d++) i[d]._expcol = !0, void
				0 === i[d].exportcol ? i[d].hidden && (i[d]._expcol = !1) : i[d]._expcol = i[d].exportcol, "cb" !== i[d].name && "rn" !== i[d].name && "subgrid" !== i[d].name && i[d]._expcol && (j = {
					text: g.p.colNames[d],
					style: "tableHeader"
				}, o.push(j), l[m] = i[d].name, n[m] = d, p.push(i[d].width), q[i[d].name] = i[d].align || "left", m++);
				var s;
				if (b.includeGroupHeader && g.p.groupHeader && g.p.groupHeader.length)
					for (s = g.p.groupHeader, m = 0; m < s.length; m++) {
						var t = [],
							u = s[m].groupHeaders;
						for (f = 0; f < l.length; f++) {
							for (j = {
									text: "",
									style: "tableHeader"
								}, r = 0; r < u.length; r++) u[r].startColumnName === l[f] && (j = {
								text: u[r].titleText,
								colSpan: u[r].numberOfColumns,
								style: "tableHeader"
							});
							t.push(j), d++
						}
				...
				if (b.includeLabels && h.push(o), b.includeHeader && g.p.headerrow) {
					var v = a(g).jqGrid("headerData", "get");
					for (o = [], f = 0; f < l.length; f++) j = {
						text: a.jgrid.stripHtml(a.jgrid.getAccessor(v, l[f])),
						style: "tableFooter",
						alignment: q[l[f]]
					}, o.push(j);
					h.push(o)
				...
				if (g.p.grouping) {
					var w = !!g.p.groupingView._locgr;
					g.p.groupingView._locgr = !1, c(k), g.p.groupingView._locgr = w
				} else {
					var x;
					for (m = 0, e = k.length; m < e; m++) {
						for (r = 0, o = [], x = k[m], f = 0; f < l.length; f++) j = {
							text: null == x[l[f]] ? "" : a.jgrid.stripHtml(a.jgrid.formatCell(a.jgrid.getAccessor(x, l[f]) + "", n[r], k[m], i[n[r]], g, "pdf")),
							alignment: q[l[f]],
							style: "tableBody"
						}, o.push(j), r++;
						h.push(o)
				...
				if (b.includeFooter && g.p.footerrow) {
					var y = a(g).jqGrid("footerData", "get");
					for (o = [], f = 0; f < l.length; f++) j = {
						text: a.jgrid.stripHtml(a.jgrid.getAccessor(y, l[f])),
						style: "tableFooter",
						alignment: q[l[f]]
					}, o.push(j);
					h.push(o)
				...
				b.description && z.content.unshift({
					text: b.description,
					style: "description",
					margin: [0, 0, 0, 12]
				}), b.title && z.content.unshift({
					text: b.title,
					style: "title",
					margin: [0, 0, 0, 12]
				}), a.isFunction(b.onBeforeExport) && b.onBeforeExport.call(g, z);
				try {
					var A = pdfMake.createPdf(z);
					A.getDataUrl(function(c) {
						a.isFunction(b.loadIndicator) ? b.loadIndicator("hide") : b.loadIndicator && a(g).jqGrid("progressBar", {
							method: "hide",
							loadtype: g.p.loadui
						})
					}), "open" === b.download ? A.open() : A.getBuffer(function(c) {
						a.jgrid.saveAs(c, b.fileName, {
							type: b.mimetype
						})
					})
		...
		exportToHtml: function(b) {
			...
			return this.each(function() {
				...
				var e, f, g = this,
					...
					i = 0,
					j = {
						body: g.p.treeGrid ? a(g).jqGrid("getRowData", null, !0, b.treeindent) : g.addLocalData(!0),
						header: [],
						footer: [],
						width: [],
						map: [],
				...
				var k = document.createElement("a"),
					...
					o = function(b, c, d, e, f) {
						for (var i, k, l = "<tr>", m = 0, n = j.header.length; m < n && (k = f ? ' colspan= "' + j.header.length + '" style=text-align:left' : !0 === e ? " style=width:" + j.width[m] + "px;text-align:" + j.align[m] + ";" : " style=text-align:" + j.align[m] + ";", i = j.header[m], b.hasOwnProperty(i) && (l += "<" + c + k + ">" + (d ? a.jgrid.formatCell(a.jgrid.getAccessor(b, i), j.map[m], b, h[j.map[m]], g, "html") : b[i]) + "</" + c + ">"), !f); m++);
						return l + "</tr>"
					};
				a.isFunction(b.loadIndicator) ? b.loadIndicator("show") : b.loadIndicator && a(g).jqGrid("progressBar", {
					method: "show",
				...
				var p = '<table class="' + b.tableClass + '">';
				if (b.includeLabels && (p += "<thead>" + n(j.header, "th", !0) + "</thead>"), p += "<tbody>", b.includeHeader && g.p.headerrow) {
					var q = a(g).jqGrid("headerData", "get", null, !1);
					p += o(q, "td", !1)
				}
				if (g.p.grouping) {
					var r = !!g.p.groupingView._locgr;
					g.p.groupingView._locgr = !1, p += d(j.body), g.p.groupingView._locgr = r
				} else
				...
				if (b.includeFooter && g.p.footerrow && (j.footer = a(g).jqGrid("footerData", "get", null, !1), p += o(j.footer, "td", !1)), p += "</tbody>", p += "</table>", b.returnAsString) c = p;
					...
					var s = window.open("", "");
					s.document.close();
					var t = b.title ? "<title>" + b.title + "</title>" : "";
					a("style, link").each(function() {
						t += l(this)
					});
					try {
						s.document.head.innerHTML = t
					} catch (b) {
						a(s.document.head).html(t)
					}
					s.document.body.innerHTML = (b.title ? "<h1>" + b.title + "</h1>" : "") + "<div>" + (b.topText || "") + "</div>" + p + "<div>" + (b.bottomText || "") + "</div>", a(s.document.body).addClass("html-view"), a("img", s.document.body).each(function(a, b) {
						b.setAttribute("src", m(b.getAttribute("src")))
					}), b.onBeforeExport && b.onBeforeExport(s), Boolean(s.chrome) ? b.autoPrint && (s.print(), s.close()) : setTimeout(function() {
						b.autoPrint && (s.print(), s.close())
					}, 1e3)
				}
				a.isFunction(b.loadIndicator) ? b.loadIndicator("hide") : b.loadIndicator && a(g).jqGrid("progressBar", {
					method: "hide",
...
! function(a) {
	...
	"use strict";
	a.extend(a.jgrid, {
		focusableElementsList: [">a[href]", ">button:not([disabled])", ">area[href]", ">input:not([disabled])", ">select:not([disabled])", ">textarea:not([disabled])", ">iframe", ">object", ">embed", ">*[tabindex]", ">*[contenteditable]"]
	}), a.jgrid.extend({
		ariaBodyGrid: function(b) {
			...
			return this.each(function() {
				function
				b(a, b) {
					return !isNaN(a) && !isNaN(b) && a >= 0 && b >= 0 && g.rows.length && a < g.rows.length && b < g.p.colModel.length
				}
				...
				d(a, c) {
					var d = g.p.iRow + c,
						...
						h = 0 !== a;
					if (!f) return !1;
					var i = g.p.colModel.length;
					return h && (e < 0 && d >= 2 && (e = i - 1, d--), e >= i && (e = 0, d++)), h || (d < 1 ? (e--, d = f - 1, g.rows[d] && e >= 0 && !g.rows[d].cells[e] && d--) : (d >= f || !g.rows[d].cells[e]) && (d = 1, e++)), b(d, e) ? {
						row: d,
						col: e
					} : !!b(g.p.iRow, g.p.iCol) && {
						row: g.p.iRow,
				...
				e(b, c) {
					var e = d(b, c);
					if (!e) return !1;
					for (; a(g.rows[e.row].cells[e.col]).is(":hidden");)
						if (g.p.iRow = e.row, g.p.iCol = e.col, e = d(b, c), g.p.iRow === e.row && g.p.iCol === e.col) return !1;
					return 0 !== c && a(g).jqGrid("setSelection", g.rows[e.row].id, !1, null, !1), e
				}
				...
				f(a) {
					var b = g.p.page,
						c = g.p.lastpage;
					b += a, b <= 0 && (b = 1), b > c && (b = c), g.p.page !== b && (g.p.page = b, g.grid.populate())
				}
				var g = this,
					h = a.jgrid.getMethod("getStyleUI"),
					i = h(g.p.styleUI + ".common", "highlight", !0),
					j = a.jgrid.focusableElementsList.join();
				a(g).removeAttr("tabindex"), a(g).on("jqGridAfterGridComplete.setAriaGrid", function(b) {
					...
					0 !== g.p.iRow && void
					0 !== g.p.iCol && g.rows[g.p.iRow] && a(g.rows[g.p.iRow].cells[g.p.iCol]).attr("tabindex", 0).focus(function() {
						a(this).addClass(i)
					}).blur(function() {
						a(this).removeClass(i)
					})
				}), g.p.iRow = 1, g.p.iCol = a.jgrid.getFirstVisibleCol(g);
				var k = 0,
					l = 0;
				a(g).on("keydown", function(b) {
					if (!g.p.navigationDisabled || !0 !== g.p.navigationDisabled) {
						var d, j = b.which || b.keyCode;
						switch (j) {
							case
							38:
								d = e(0, -1), k = d.row, l = d.col, b.preventDefault();
								break;
							case
							40:
								d = e(0, 1), k = d.row, l = d.col, b.preventDefault();
							...
							case
							37:
								d = e(-1, 0), k = d.row, l = d.col, b.preventDefault();
								break;
							case
							39:
								d = e(1, 0), k = d.row, l = d.col, b.preventDefault();
							...
							case
							36:
								k = b.ctrlKey ? 1 : g.p.iRow, l = 0, b.preventDefault();
								break;
							case
							35:
								k = b.ctrlKey ? g.rows.length - 1 : g.p.iRow, l = g.p.colModel.length - 1, b.preventDefault();
								break;
							case
							33:
								f(-1), l = g.p.iCol, k = g.p.iRow, b.preventDefault();
								break;
							case
							34:
								f(1), l = g.p.iCol, k = g.p.iRow, k > g.rows.length - 1 && (k = g.rows.length - 1, g.p.iRow = g.rows.length - 1), b.preventDefault();
								break;
							case
							13:
								return void(a.isFunction(c.onEnterCell) && (c.onEnterCell.call(g, g.rows[g.p.iRow].id, g.p.iRow, g.p.iCol, b), b.preventDefault()));
							default:
								return
						}
						a(g).jqGrid("focusBodyCell", k, l, h, i)
					}
				}), a(g).on("jqGridBeforeSelectRow.ariaGridClick", function() {
					return !1
				}), a(g).on("jqGridCellSelect.ariaGridClick", function(b, c, d, e, f) {
					var h = f.target;
					if (g.p.iRow > 0 && g.p.iCol >= 0 && a(g.rows[g.p.iRow].cells[g.p.iCol]).attr("tabindex", -1), a(h).is("td") || a(h).is("th")) {
						g.p.iCol = h.cellIndex;
						var j = a(h).closest("tr.jqgrow");
						g.p.iRow = j[0].rowIndex, a(h).attr("tabindex", 0).addClass(i).focus().blur(function() {
							a(this).removeClass(i)
						})
					}
				})
		...
		focusBodyCell: function(b, c, d, e) {
			return this.each(function() {
				...
				var g, h = this,
					i = d || a.jgrid.getMethod("getStyleUI"),
					j = e || i(h.p.styleUI + ".common", "highlight", !0),
					k = a.jgrid.focusableElementsList.join();
				void
				0 !== b && void
				0 !== c ? !isNaN(h.p.iRow) && !isNaN(h.p.iCol) && h.p.iCol >= 0 && (g = f(h.rows[h.p.iRow].cells[h.p.iCol]), g ? a(g).attr("tabindex", -1) : a(h.rows[h.p.iRow].cells[h.p.iCol]).attr("tabindex", -1)) : (b = h.p.iRow, c = h.p.iCol), b = parseInt(b, 10), c = parseInt(c, 10), b > 0 && c >= 0 && (g = f(h.rows[b].cells[c]), g ? a(g).attr("tabindex", 0).addClass(j).focus().blur(function() {
					a(this).removeClass(j)
				}) : a(h.rows[b].cells[c]).attr("tabindex", 0).addClass(j).focus().blur(function() {
					a(this).removeClass(j)
				}), h.p.iRow = b, h.p.iCol = c)
			})
		},
		resetAriaBody: function() {
			return this.each(function() {
				var b = this;
				a(b).attr("tabindex", "0").off("keydown").off("jqGridBeforeSelectRow.ariaGridClick").off("jqGridCellSelect.ariaGridClick").off("jqGridAfterGridComplete.setAriaGrid");
				var c = a.jgrid.focusableElementsList.join();
				a("tbody:first>tr:not(.jqgfirstrow)>td:not(:hidden, :has(" + c + "))", b).removeAttr("tabindex").off("focus"), a("tbody:first>tr:not(.jqgfirstrow)", b).attr("tabindex", -1)
			})
		},
		ariaHeaderGrid: function() {
			return this.each(function() {
				var b = this,
					c = a.jgrid.getMethod("getStyleUI"),
					d = c(b.p.styleUI + ".common", "highlight", !0),
					e = a(".ui-jqgrid-hbox>table:first", "#gbox_" + b.p.id);
				a("tr.ui-jqgrid-labels", e).on("keydown", function(c) {
					var d = b.p.selHeadInd,
						e = c.which || c.keyCode,
						f = b.grid.headers.length;
					switch (e) {
						case
						37:
							if (d - 1 >= 0) {
								for (d--; a(b.grid.headers[d].el).is(":hidden") && d - 1 >= 0 && !(--d < 0););
								d >= 0 && (a(b.grid.headers[d].el).focus(), a(b.grid.headers[b.p.selHeadInd].el).attr("tabindex", "-1"), b.p.selHeadInd = d, c.preventDefault())
							}
							break;
						case
						39:
							if (d + 1 < f) {
								for (d++; a(b.grid.headers[d].el).is(":hidden") && d + 1 < f && !(++d > f - 1););
								d < f && (a(b.grid.headers[d].el).focus(), a(b.grid.headers[b.p.selHeadInd].el).attr("tabindex", "-1"), b.p.selHeadInd = d, c.preventDefault())
							}
							break;
						case
						13:
							a("div:first", b.grid.headers[d].el).trigger("click"), c.preventDefault();
							break;
						default:
							return
					}
				}), a("tr.ui-jqgrid-labels>th:not(:hidden)", e).attr("tabindex", -1).focus(function() {
					a(this).addClass(d).attr("tabindex", "0")
				}).blur(function() {
					a(this).removeClass(d)
				}), b.p.selHeadInd = a.jgrid.getFirstVisibleCol(b), a(b.grid.headers[b.p.selHeadInd].el).attr("tabindex", "0")
			})
		},
		...
		resetAriaHeader: function() {
			return this.each(function() {
				var b = a(".ui-jqgrid-hbox>table:first", "#gbox_" + this.p.id);
				a("tr.ui-jqgrid-labels", b).off("keydown"), a("tr.ui-jqgrid-labels>th:not(:hidden)", b).removeAttr("tabindex").off("focus blur")
			})
		},
		ariaPagerGrid: function() {
			return this.each(function() {
				var b = this,
					c = a.jgrid.getMethod("getStyleUI"),
					d = c(b.p.styleUI + ".common", "highlight", !0),
					e = "." + c(b.p.styleUI + ".common", "disabled", !0),
					f = a(".ui-pg-button", b.p.pager),
					g = f.length;
				f.attr("tabindex", "-1").focus(function() {
					a(this).addClass(d)
				}).blur(function() {
					a(this).removeClass(d)
				}), b.p.navIndex = 0, setTimeout(function() {
					var a = f.not(e).first().attr("tabindex", "0");
					b.p.navIndex = a[0].cellIndex ? a[0].cellIndex - 1 : 0
					...
					switch (d) {
						...
						37:
							if (h - 1 >= 0) {
								for (h--; a(f[h]).is(e) && h - 1 >= 0 && !(--h < 0););
								h >= 0 && (a(f[b.p.navIndex]).attr("tabindex", "-1"), a(f[h]).attr("tabindex", "0").focus(), b.p.navIndex = h), c.preventDefault()
							}
							break;
						case
						39:
							if (h + 1 < g) {
								for (h++; a(f[h]).is(e) && h + 1 < g + 1 && !(++h > g - 1););
								h < g && (a(f[b.p.navIndex]).attr("tabindex", "-1"), a(f[h]).attr("tabindex", "0").focus(), b.p.navIndex = h), c.preventDefault()
							}
							break;
						case
						13:
							a(f[h]).trigger("click"), c.preventDefault();
							break;
						default:
							return
					}
		...
		resetAriaPager: function() {
			return this.each(function() {
				a(".ui-pg-button", this.p.pager).removeAttr("tabindex").off("focus"), a("table.ui-pager-table tr:first", this.p.pager).off("keydown")
			})
		},
		setAriaGrid: function(b) {
			var c = a.extend({
				header: !0,
				body: !0,
				pager: !0,
			...
			return this.each(function() {
				c.header && a(this).jqGrid("ariaHeaderGrid"), c.body && a(this).jqGrid("ariaBodyGrid", {
					onEnterCell: c.onEnterCell
				}), c.pager && a(this).jqGrid("ariaPagerGrid")
			})
		},
		resetAriaGrid: function(b) {
			...
			return this.each(function() {
				var b = this;
				c.body && a(b).jqGrid("resetAriaBody"), c.header && a(b).jqGrid("resetAriaHeader"), c.pager && a(b).jqGrid("resetAriaPager")
			})
		}
	})
});
