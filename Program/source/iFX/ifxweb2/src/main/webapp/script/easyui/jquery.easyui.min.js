	...
	$.fn.combogrid = function(_b74, _b75) {
		...
		return this.each(function() {
			...
			if (_b77) {
				...
				_b77 = $.data(this, "combogrid", {
					options: $.extend({}, $.fn.combogrid.defaults, $.fn.combogrid.parseOptions(this), _b74)
				});
			}
			_b3a(this);
		});
...
(function($) {
	...
	$.fn.combotreegrid = function(_b9b, _b9c) {
		...
		return this.each(function() {
			...
			if (_b9e) {
				...
				_b9e = $.data(this, "combotreegrid", {
					options: $.extend({}, $.fn.combotreegrid.defaults, $.fn.combotreegrid.parseOptions(this), _b9b)
				});
			}
			_b7e(this);
		});
	...
	$.fn.combotreegrid.parseOptions = function(_ba3) {
		var t = $(_ba3);
		return $.extend({}, $.fn.combo.parseOptions(_ba3), $.fn.treegrid.parseOptions(_ba3), $.parser.parseOptions(_ba3, ["mode", {
			limitToGrid: "boolean"
		}]));
	};
	...
	function _ba5(_ba6) {
		...
		$(_ba6).addClass("tagbox-f").combobox($.extend({}, opts, {
			...
			onResizing: function(_bab, _bac) {
				...
				tb.css({
					height: "",
					paddingLeft: _bad.css("marginLeft"),
					paddingRight: _bad.css("marginRight")
				});
				_bad.css("margin", 0);
				tb._outerWidth(_bae);
				_bc1(_ba6);
	...
	$.fn.tagbox = function(_bd0, _bd1) {
		...
		return this.each(function() {
			...
			if (_bd3) {
				...
				$.data(this, "tagbox", {
					options: $.extend({}, $.fn.tagbox.defaults, $.fn.tagbox.parseOptions(this), _bd0)
				});
			}
			_ba5(this);
			_bbc(this);
	...
	$.fn.datebox = function(_bfb, _bfc) {
		...
		return this.each(function() {
			...
			if (_bfe) {
				...
				$.data(this, "datebox", {
					options: $.extend({}, $.fn.datebox.defaults, $.fn.datebox.parseOptions(this), _bfb)
				});
			}
			_bde(this);
		});
...
(function($) {
		...
		return this.each(function() {
			...
			if (_c1e) {
				...
				$.data(this, "datetimebox", {
					options: $.extend({}, $.fn.datetimebox.defaults, $.fn.datetimebox.parseOptions(this), _c1b)
				});
			}
			_c09(this);
		});
	...
	$.fn.datetimebox.parseOptions = function(_c23) {
		var t = $(_c23);
		return $.extend({}, $.fn.datebox.parseOptions(_c23), $.parser.parseOptions(_c23, ["timeSeparator", "spinnerWidth", {
			showSeconds: "boolean"
		}]));
	};
