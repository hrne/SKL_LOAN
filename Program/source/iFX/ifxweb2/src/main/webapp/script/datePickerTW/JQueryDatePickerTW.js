...
(function(){
    ...
    var funcColle = {
        onSelect: {
            basic: function(dateText, inst){
                ...
                dateTW = new Date(
                    (parseInt(yearTW, 10) + 1911) + '-' +
                    (monthTW.length == 3 ? monthTW.substring(1) : monthTW) + '-' +
                    dayTW + 'T00:00:00.000Z'
                );

                var dateRoc = $.datepicker.formatDate(twSettings.dateFormat, dateTW);
                dateRoc = yearTW.replace(/^0+/g,"") + dateRoc.substring(4);
    ...
    var twSettings = {
        ...
        onSelect: function(dateText, inst){
            ...
            // IfxUtl.ifx.jumpOrBack($("#" + inst.id).attr("dc-index"));
        }
    };
