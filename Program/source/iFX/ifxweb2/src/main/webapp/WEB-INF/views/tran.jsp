...
<body style="margin: 10px; margin-top: 3px; margin-right: 0px; border: 0">
	<div id='center-part' class="ui-layout-center" style="margin: 0; padding: 0">
        <div style='height: 10px;'> <span id="var_version" style='color: rgba(255, 255, 255, 1)'></span></div>
        <div id='main-container' style="display: none; width: 97%; height: 100%">
            ...
            <div id="queryArea">
                <table id="grid"></table>
                <div id="pager"></div>
                <input type="button" id="btnBatch_0" style='display:none;color: blue' class='querybutton' value=" 整批處理 " />
                <input type="button" id="btnBatch_1" style='display:none;color: blue' class='querybutton' value="" />
                <input type="button" id="btnBatch_2" style='display:none;color: blue' class='querybutton' value="" />
                <input type="button" id="btnBatch_3" style='display:none;color: blue' class='querybutton' value="" />
                <input type="button" id="btnBatch_4" style='display:none;color: blue' class='querybutton' value="" />
                <input type="button" id="btnBatch_5" style='display:none;color: blue' class='querybutton' value="" />
                <input type="button" id="btnBatch_6" style='display:none;color: blue' class='querybutton' value="" />
                <input type="button" id="btnBatch_7" style='display:none;color: blue' class='querybutton' value="" />
                <input type="button" id="btnBatch_8" style='display:none;color: blue' class='querybutton' value="" />
                <input type="button" id="btnBatch_9" style='display:none;color: blue' class='querybutton' value="" />
                <input type="button" id="btnSearch"  style='display:none;color: rosy' class='querybutton' value=" 搜　尋 " />
                <input type="button" id="btnReset"   style='display:none;color: rosy' class='querybutton' value=" 重　設 " />
                <input type='button' id='btnExport'  style='display:none;color: rosy' class='querybutton' data-url='viewgrid.jsp' value=' 匯出Excel ' />
                <input type='button' id='btnExportxml' style='display:none;color: rosy' class='querybutton' data-url='viewgrid.jsp' value=' 匯出XML ' />
                <input type='button' id='btnMoreData' style='display:none;color: blue' class='querybutton' data-url='viewgrid.jsp' value=' 擷取更多資料... ' />
                <input type='button' id='openWin' style='display:none;color: blue' class='querybutton' data-url='viewgrid.jsp' value=' 在新視窗檢視 ' />
            </div>
            <div id="queryArea2">
                <table id="grid2"></table>
                <div id="pager2"></div>
                <input type="BUTTON" id="btnBatch2" style='display:none;color: blue' class='querybutton' value=" 整批處理 " />
                <input type="BUTTON" id="btnSearch2" style='display:none;color: rosy' class='querybutton' value=" 搜　尋 " />
                <input type="BUTTON" id="btnReset2" style='display:none;color: rosy' class='querybutton' value=" 重　設 " />
                <input type='button' id='btnExport2' style='display:none;color: rosy' class='querybutton' data-url='viewgrid.jsp' value=' 匯出Excel ' />
                <input type='button' id='btnExportxml2' style='display:none;color: rosy' class='querybutton' data-url='viewgrid.jsp' value=' 匯出XML ' />
                <input type='button' id='btnMoreData2' style='display:none;color: blue' class='querybutton' data-url='viewgrid.jsp' value=' 擷取更多資料... ' />
                <input type='button' id='openWin2' style='display:none;color: blue' class='querybutton' data-url='viewgrid.jsp' value=' 在新視窗檢視 ' />
            </div>
    ...
    <div id="dialog-locovr" title="本機主管授權" style='display: none'>
        <fieldset>
            ...
            <input type="text" name="_superId" id="_superId" class="text ui-widget-content ui-corner-all" maxlength="6" />

            <label for="_superPassword">密碼</label>
            <input type="password" name="_superPassword" id="_superPassword" value="" class="text ui-widget-content ui-corner-all" maxlength="20" />
        </fieldset>
        ...
        <div id="swift_result" style="margin:5px;display:none">
            <table border='0' style="padding:3px;">
                <tr>
                    ...
                    <td><span id="swift_code"></span></td>
                </tr>
                <tr>
                    <td align='right'>BANK NAME:</td>
                    <td><span id="swift_bankName"></span></td>
                </tr>
                <tr>
                    <td align='right'>Address 1:</td>
                    <td><span id="swift_addr1"></span></td>
                </tr>
                <tr>
                    <td align='right'>Address 2:</td>
                    <td><span id="swift_addr2"></span></td>
                </tr>
                <tr>
                    <td align='right'>Address 3:</td>
                    <td><span id="swift_addr3"></span></td>
                </tr>
            </table>
        </div>
    </div>
