 ...
 */
public class Base64 {
	static final Logger logger = LoggerFactory.getLogger(Base64.class);
	...
	public static Object decodeToObject(String encodedObject, int options, final ClassLoader loader) throws java.io.IOException, java.lang.ClassNotFoundException {
		...
		try {
			...
			obj = ois.readObject();
			// http://pittafairy.blogspot.com/2016/06/fortify-dynamic-code-evaluation-unsafe.html
		} // end try
		catch (java.io.IOException e) {
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		public void flushBase64() throws java.io.IOException {
			if (position > 0) {
				if (encode) {
					byte te[] = encode3to4(b4, buffer, position, options);
					out.write(FilterUtils.stripXSS(te));
