package com.st1.util.getContent;

public class ContentName {
	public static int minHostSeq = 1;
	public static int maxHostSeq = 999999;

	public static int maxresvlen = 8500;

	public static int hostSeqStart = 6;
	public static int hostSeqLen = 8;
	public static int hostSeqEnd = hostSeqStart + hostSeqLen;
	public static int txrsutPos = 35;
	public static int msgIdPos = 36;
	public static int titamsgIdPos = 34;
	...
	public static final String pBrno = "PBRNO";
	...
	public static final String errorMsgId = "errorMsgId";
