...
public class AStarLoadUtils {
	...
	private static TB_Big5_NHC n = null;
	private static TB_UCS2_Web n8 = null;
	private static TB_CNS_UCS2 n7 = null;
	private static TB_UCS2_CNS n6 = null;
	private static TB_Big5_UCS2 n5 = null;
	private static TB_NHC_UCS2 n4 = null;
	private static TB_NHC_UCS2 n3 = null;
	private static TB_UCS2_NHC n2 = null;
	private static TB_NHC_Big5 n1 = null;

	public static void init() {
		logger.info("AStarLoadUtils.init !!!!");
		// System.out.println("AStarLoadUtils init ");
		// isloaded = false;

		long nRet = 0;
		try {
			// String twnbconfigFilePath = GlobalValues.twnbconfigFilePath;
			String twnbconfigFilePath = GlobalValues.twnbconfigFilePath;
			if (twnbconfigFilePath == null || twnbconfigFilePath.isEmpty()) {
				twnbconfigFilePath = "C:/D/work/st1/ifxpara/AStar/TBConvert.conf";
			}
	...
	public static byte[] convertBIG5StrToIBM937Bytes(String data) throws Exception {
		validateTNSCode();
	...
	public static String convertIBM937BytesToBIG5(byte[] data) throws Exception {
	...
	public static byte[] convertUnicodeStrToIBM937Bytes(String data) throws Exception {
		validateTNSCode();
	...
	// public static String convertIBM937BytesToUnicodeStrA(byte[] data) throws
	// Exception
	// {
	// validateTNSCode();
	//
	...
	public static String convertIBM937BytesToUnicodeStr(byte[] data) throws Exception {
		validateTNSCode();
	...
	public static String convertIBM937BytesToUnicodeStrorg(byte[] data) throws Exception {
		validateTNSCode();
	...
	public static String convertBIG5BytesToUnicodeStr(byte[] data) throws Exception {
		validateTNSCode();
	...
	public static String convertUnicodeStrToCNSStr(String data) throws Exception {
		validateTNSCode();
	...
	public static String convertCNSStrToUnicodeStr(String data) throws Exception {
		validateTNSCode();
