...
public class HexDump3 {
	...
	public static void dumpHexData(PrintStream out, String title, byte[] buf, int numBytes) {
		...
		HexDump3.dumpHexData(wrtr, title, buf, 0, numBytes);
	...
	public static void dump(String title, String s) {
		byte[] bb = s.getBytes();
		HexDump3.dumpHexData(System.out, title, bb, bb.length);
	}
	...
	static public void main(String[] args) {
		...
		HexDump3.dumpHexData(System.out, "Test HexDump", data, 132);
	}
