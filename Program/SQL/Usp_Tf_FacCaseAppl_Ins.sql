...
BEGIN
    ...
    INSERT INTO "FacCaseAppl" (
      ...
      , "ApplDate"            -- 申請日期 DECIMALD 8 
      , "CreditSysNo"         -- 案件編號 DECIMAL 7
      , "SyndNo"              -- 聯貸案編號 DECIMAL 6
      , "CurrencyCode"        -- 申請幣別 VARCHAR2 3 
      , "ApplAmt"             -- 申請金額 DECIMAL 16 2
      , "ProdNo"              -- 申請商品代碼 VARCHAR2 5 
      , "Estimate"            -- 估價 VARCHAR2 6 
      , "DepartmentCode"      -- 案件隸屬單位 VARCHAR2 1
      , "PieceCode"           -- 計件代碼 VARCHAR2 1 
      , "CreditOfficer"       -- 授信 VARCHAR2 6 
      , "LoanOfficer"         -- 放款專員 VARCHAR2 6 
      , "Introducer"          -- 介紹人 VARCHAR2 6 
      , "Coorgnizer"          -- 協辦人 VARCHAR2(6 BYTE)
      , "InterviewerA"        -- 晤談一 VARCHAR2(6 BYTE)
      , "InterviewerB"        -- 晤談二 VARCHAR2(6 BYTE)	
      , "Supervisor"          -- 核決主管 VARCHAR2 6 
      , "ProcessCode"         -- 處理情形 VARCHAR2 1 
      , "ApproveDate"         -- 准駁日期 DECIMALD 8 
      , "GroupUKey"           -- 團體戶識別碼 VARCHAR2 32 
      , "BranchNo"
      , "IsLimit"
      , "IsRelated"
      , "IsLnrelNear"
