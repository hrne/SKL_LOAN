...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "Usp_Tf_BankRelationSuspected_Ins" 
(
    -- 參數
...
BEGIN
    ...
    INSERT INTO "BankRelationSuspected" (
        "RepCusName"          -- 自然人姓名 NVARCHAR2 100
      , "CustId"              -- 該自然人擔任董事長之公司統一編號 VARCHAR2 11
      , "CustName"            -- 公司名稱 NVARCHAR2 100
      , "SubCom"              -- 職務名稱 NVARCHAR2 100
