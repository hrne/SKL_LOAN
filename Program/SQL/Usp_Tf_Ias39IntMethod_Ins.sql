...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "Usp_Tf_Ias39IntMethod_Ins" 
(
    -- 參數
...
BEGIN
    ...
    INSERT INTO "Ias39IntMethod" (
      ...
      , "Principal"           -- 本期本金餘額 DECIMAL 16 2
      , "BookValue"           -- 本期帳面價值 DECIMAL 16 2
      , "AccumDPAmortized"    -- 本期累應攤銷折溢價 DECIMAL 16 2
      , "AccumDPunAmortized"  -- 本期累未攤銷折溢價 DECIMAL 16 2
      , "DPAmortized"         -- 本期折溢價攤銷數 DECIMAL 16 2
