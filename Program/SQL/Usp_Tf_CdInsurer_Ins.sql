...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "Usp_Tf_CdInsurer_Ins" 
(
    -- 參數
...
BEGIN
    ...
    INSERT INTO "CdInsurer" (
        "InsurerType"         -- 公司種類 VARCHAR2 1 
      , "InsurerCode"         -- 公司代號 VARCHAR2 2 
      , "InsurerId"           -- 公司統編 VARCHAR2 10
      , "InsurerItem"         -- 公司名稱 NVARCHAR2 40 
      , "InsurerShort"        -- 公司簡稱 NVARCHAR2 10 
      , "TelArea"             -- 連絡電話區碼 VARCHAR2 5 
      , "TelNo"               -- 連絡電話號碼 VARCHAR2 10 
      , "TelExt"              -- 連絡電話分機號碼 VARCHAR2 5 
