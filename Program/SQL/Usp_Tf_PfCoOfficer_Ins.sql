...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "Usp_Tf_PfCoOfficer_Ins" 
(
    -- 參數
...
BEGIN
    ...
    INSERT INTO "PfCoOfficer" (
      ...
      , "EffectiveDate"       -- 生效日期 DecimalD 8 0
      , "IneffectiveDate"     -- 停效日期 DecimalD 8 0
      , "AreaCode"            -- 單位代號 VARCHAR2 6 0
      , "DistCode"            -- 區部代號 VARCHAR2 6 0
      , "DeptCode"            -- 部室代號 VARCHAR2 6 0
      , "AreaItem"            -- 單位中文 NVARCHAR2 20 0
      , "DistItem"            -- 區部中文 NVARCHAR2 20 0
      , "DeptItem"            -- 部室中文 NVARCHAR2 20 0
      , "EmpClass"            -- 協辦等級 VARCHAR2 1 0
      , "ClassPass"           -- 初階授信通過 VARCHAR2 1 0
