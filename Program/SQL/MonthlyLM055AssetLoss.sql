...
create table "MonthlyLM055AssetLoss" (
  ...
  "LoanType" varchar2(1),
  "OverdueAmount" decimal(16, 2) default 0 not null,
  "ObserveAmount" decimal(16, 2) default 0 not null,
  "NormalAmount" decimal(16, 2) default 0 not null,
...
alter table "MonthlyLM055AssetLoss" add constraint "MonthlyLM055AssetLoss_PK" primary key("YearMonth", "LoanType");
...
comment on column "MonthlyLM055AssetLoss"."OverdueAmount" is '逾期放款';
comment on column "MonthlyLM055AssetLoss"."ObserveAmount" is '未列入逾期應予評估放款';
comment on column "MonthlyLM055AssetLoss"."NormalAmount" is '正常放款';
