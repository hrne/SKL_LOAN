...
BEGIN
    ...
    INSERT INTO "CustFin" (
      ...
      , "DataYear"            -- 年度 DECIMAL 4 
      , "AssetTotal"          -- 資產總額 DECIMAL 16 2
      , "Cash"                -- 現金/銀存 DECIMAL 16 2
      , "ShortInv"            -- 短期投資 DECIMAL 16 2
      , "AR"                  -- 應收帳款票據 DECIMAL 16 2
      , "Inventory"           -- 存貨 DECIMAL 16 2
      , "LongInv"             -- 長期投資 DECIMAL 16 2
      , "FixedAsset"          -- 固定資產 DECIMAL 16 2
      , "OtherAsset"          -- 其他資產 DECIMAL 16 2
      , "LiabTotal"           -- 負債總額 DECIMAL 16 2
      , "BankLoan"            -- 銀行借款 DECIMAL 16 2
      , "OtherCurrLiab"       -- 其他流動負債 DECIMAL 16 2
      , "LongLiab"            -- 長期負債 DECIMAL 16 2
      , "OtherLiab"           -- 其他負債 DECIMAL 16 2
      , "NetWorthTotal"       -- 淨值總額 DECIMAL 16 2
      , "Capital"             -- 資本 DECIMAL 16 2
      , "RetainEarning"       -- 公積保留盈餘 DECIMAL 16 2
      , "OpIncome"            -- 營業收入 DECIMAL 16 2
      , "OpCost"              -- 營業成本 DECIMAL 16 2
      , "OpProfit"            -- 營業毛利 DECIMAL 16 2
      , "OpExpense"           -- 管銷費用 DECIMAL 16 2
      , "OpRevenue"           -- 營業利益 DECIMAL 16 2
      , "NopIncome"           -- 營業外收入 DECIMAL 16 2
      , "FinExpense"          -- 財務支出 DECIMAL 16 2
      , "NopExpense"          -- 其他營業外支 DECIMAL 16 2
      , "NetIncome"           -- 稅後淨利 DECIMAL 16 2
      , "Accountant"          -- 簽證會計師 NVARCHAR2 14 0
      , "AccountDate"         -- 簽證日期 Decimald 8 0
