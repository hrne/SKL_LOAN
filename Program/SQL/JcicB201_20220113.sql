...
create table "JcicB201" (
  ...
  "Filler741" varchar2(5),
  "GraceStartYM" varchar2(5),
  "GraceEndYM" varchar2(5),
  "GreenFg" varchar2(1),
  "GreenCode" varchar2(1),
  "SustainFg" varchar2(1),
  "SustainCode" varchar2(1),
  "SustainNoReachFg" varchar2(1),
...
comment on column "JcicB201"."Filler741" is '就學貸款逾期案件信保基金代償金額';
comment on column "JcicB201"."GraceStartYM" is '房貸寬限期起始年月';
comment on column "JcicB201"."GraceEndYM" is '房貸寬限期截止年月';
comment on column "JcicB201"."GreenFg" is '綠色授信註記';
comment on column "JcicB201"."GreenCode" is '綠色支出類別';
comment on column "JcicB201"."SustainFg" is '永續績效連結授信註記';
comment on column "JcicB201"."SustainCode" is '永續績效連結授信類別';
comment on column "JcicB201"."SustainNoReachFg" is '永續績效連結授信約定條件全部未達成通報';
