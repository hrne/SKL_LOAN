...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "Usp_Tf_CdIndustry_Ins" 
(
    -- 參數
...
BEGIN
    ...
    INSERT INTO "CdIndustry" (
        "IndustryCode"        -- 行業代號 VARCHAR2 6 0 -- 2021-07-22修改: 位數不足6碼者，前補零
      , "IndustryItem"        -- 行業說明 NVARCHAR2 50 0
      , "MainType"            -- 主計處大類 VARCHAR2 1 0
      , "IndustryRating"      -- 企金放款產業評等 VARCHAR2 1 0
      , "Enable"              -- 啟用記號 VARCHAR2 1 0
