...
--     JOB_START_TIME := SYSTIMESTAMP;
    ...
    -- 寫入資料
    INSERT INTO "CdBcm" (
          "UnitCode"        -- 單位代號 VARCHAR2 6
        , "UnitItem"        -- 單位名稱 NVARCHAR2 20
        , "DeptCode"        -- 部室代號 VARCHAR2 6
        , "DeptItem"        -- 部室名稱 NVARCHAR2 20
        , "DistCode"        -- 區部代號 VARCHAR2 6
        , "DistItem"        -- 區部名稱 NVARCHAR2 20
        , "UnitManager"     -- 單位經理代號 VARCHAR2 6
        , "DeptManager"     -- 部室經理代號 VARCHAR2 6
        , "DistManager"     -- 區部經理代號 VARCHAR2 6
        , "ShortDeptItem"   -- 部室名稱簡寫 VARCHAR2 6
        , "ShortDistItem"   -- 區部名稱簡寫 VARCHAR2 6
