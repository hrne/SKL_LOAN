...
BEGIN
    ...
    SELECT APLP."LMSACN"                  AS "CustNo"              -- 借款人戶號 DECIMAL 7 
          ...
          ,APLP."APLLSQ"                  AS "LastBormNo"          -- 已撥款序號 DECIMAL 3 
          ,900                            AS "LastBormRvNo"        -- 已預約序號 DECIMAL 3 
          ...
          ,APLP."APLLAM"                  AS "UtilAmt"             -- 累計撥款金額 DECIMAL 16 2
          ,CASE
             WHEN APLP."APLRCD" = 0 
             THEN NVL(LMSP."LMSFLA",0)
           ELSE NVL(LMSP."LMSLBL",0)
           END                            AS "UtilBal"             -- 已動用餘額 DECIMAL 16 2
          ...
          ,APLP."APLFSD"                  AS "FirstDrawdownDate"   -- 初貸日 DECIMALD 8 
