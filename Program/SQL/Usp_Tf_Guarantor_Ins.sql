...
BEGIN
    ...
    INSERT INTO "Guarantor" (
      ...
      , "GuaUKey"             -- 保證人客戶識別碼 VARCHAR2 32 
      , "GuaRelCode"          -- 保證人關係代碼 VARCHAR2 2 
      , "GuaAmt"              -- 保證金額 DECIMAL 16 2
      , "GuaTypeCode"         -- 保證類別代碼 VARCHAR2 2 
      , "GuaDate"             -- 對保日期 DecimalD 8 
      , "GuaStatCode"         -- 保證狀況碼 VARCHAR2 1 
      , "CancelDate"          -- 解除日期 DecimalD 8 
