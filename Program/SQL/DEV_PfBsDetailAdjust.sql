...
create index "PfBsDetailAdjust_Index1" on "PfBsDetailAdjust"("CustNo" asc, "FacmNo" asc, "WorkMonth" asc);
...
comment on column "PfBsDetailAdjust"."AdjPerfCnt" is '週整加減件數';
comment on column "PfBsDetailAdjust"."AdjPerfAmt" is '週整加減業績金額';
