...
create table "MonthlyLM042Statis" (
  ...
  "HouseAndRepairBal" decimal(16, 2) default 0 not null,
...
comment on column "MonthlyLM042Statis"."ReserveLossDiff" is '備呆差額';
comment on column "MonthlyLM042Statis"."NetAmt" is '淨額';
comment on column "MonthlyLM042Statis"."HouseAndRepairBal" is '(購置住宅+修繕貸款)餘額';
