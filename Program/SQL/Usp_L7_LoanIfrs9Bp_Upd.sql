...
BEGIN
  ...
  BEGIN
    ...
    -- 刪除舊資料
    DBMS_OUTPUT.PUT_LINE('DELETE LoanIfrs9Bp');

    DELETE FROM "LoanIfrs9Bp"
    WHERE "DataYM" = YYYYMM
    ;

    -- 寫入資料
    DBMS_OUTPUT.PUT_LINE('INSERT LoanIfrs9Bp');
    INS_CNT := 0;
    ...
    DBMS_OUTPUT.PUT_LINE('INSERT LoanIfrs9Bp END');
    DBMS_OUTPUT.PUT_LINE('INSERT LoanIfrs9Bp INS_CNT=' || INS_CNT);
    ...
    "Usp_L9_UspErrorLog_Ins"(
        'Usp_L7_LoanIfrs9Bp_Upd' -- UspName 預存程序名稱
