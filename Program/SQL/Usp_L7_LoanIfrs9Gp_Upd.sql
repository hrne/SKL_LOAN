CREATE OR REPLACE PROCEDURE "Usp_L7_LoanIfrs9Gp_Upd"
(
...
--       , 0         AS "Stage1"            -- IAS39減損客觀條件1 (1=是 2=否)
--       , 0         AS "Stage2"            -- IAS39減損客觀條件2 (1=是 2=否)
--       , 0         AS "Stage3"            -- IAS39減損客觀條件3 (1=是 2=否)
--       , 0         AS "Stage4"            -- IAS39減損客觀條件4 (1=是 2=否)
--       , 0         AS "Stage5"            -- IAS39減損客觀條件5 (1=是 2=否)
--       , ' '       AS "PdFlagToD"         -- 內部違約機率降至D評等 (空白)
