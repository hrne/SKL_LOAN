...
comment on column "MonthlyLM028"."RepayBank" is '扣款銀行';
comment on column "MonthlyLM028"."LoanTermMm" is '貸款期間－月';
comment on column "MonthlyLM028"."LoanTermDd" is '貸款期間－日';
