...
BEGIN
    ...
    INSERT INTO "Ias39LoanCommit" (
        "DataYm"              -- 年月份 DECIMAL 6 0
      , "CustNo"              -- 戶號 DECIMAL 7 0
      , "FacmNo"              -- 額度編號 DECIMAL 3 0
      , "ApplNo"              -- 核准號碼 DECIMAL 7 0
      , "ApproveDate"         -- 核准日期 DECIMALD 8 0
      , "FirstDrawdownDate"   -- 初貸日期 DECIMALD 8 0
      , "MaturityDate"        -- 到期日 DECIMALD 8 0
      , "LoanTermYy"          -- 貸款期間年 DECIMAL 2 0
      , "LoanTermMm"          -- 貸款期間月 DECIMAL 2 0
      , "LoanTermDd"          -- 貸款期間日 DECIMAL 3 0
      , "UtilDeadline"        -- 動支期限 DECIMALD 8 0
      , "RecycleDeadline"     -- 循環動用期限 DECIMALD 8 0
      , "LineAmt"             -- 核准額度 DECIMAL 13 2
      , "UtilBal"             -- 放款餘額 DECIMAL 13 2
      , "AvblBal"             -- 可動用餘額 DECIMAL 13 2
      , "RecycleCode"         -- 該筆額度是否可循環動用 DECIMAL 1 0
      , "IrrevocableFlag"     -- 該筆額度是否為不可徹銷 DECIMAL 1 0
      , "AcBookCode"          -- 帳冊別 VARCHAR2 3 0
      , "AcSubBookCode"       -- 區隔帳冊 VARCHAR2 3 0
      , "Ccf"                 -- 信用風險轉換係數 DECIMAL 5 2
      , "ExpLimitAmt"         -- 表外曝險金額 DECIMAL 13 2
      , "DbAcNoCode"          -- 借方：備忘分錄會計科目 VARCHAR2 8 0
      , "CrAcNoCode"          -- 貸方：備忘分錄會計科目 VARCHAR2 8 0
      , "DrawdownFg"          -- 已核撥記號 DECIMAL 1 0
