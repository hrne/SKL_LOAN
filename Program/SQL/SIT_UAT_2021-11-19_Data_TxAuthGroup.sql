...
--------------------------------------------------------
--  已建立檔案 - 星期五-十一月-19-2021   
--------------------------------------------------------
REM INSERTING into "TxAuthGroup"
SET DEFINE OFF;
Insert into "TxAuthGroup" ("AuthNo","AuthItem","Desc","Status","CreateDate","CreateEmpNo","LastUpdate","LastUpdateEmpNo","BranchNo","LevelFg") values ('0000T1','放款部經辦','限放款部經辦',0,null,null,to_date('2021-11-17 14:26:30','YYYY-MM-DD HH24:MI:SS'),'001712','0000',3);
Insert into "TxAuthGroup" ("AuthNo","AuthItem","Desc","Status","CreateDate","CreateEmpNo","LastUpdate","LastUpdateEmpNo","BranchNo","LevelFg") values ('0000S1','放款部主管','限放款部主管',0,null,null,to_date('2021-11-03 18:34:57','YYYY-MM-DD HH24:MI:SS'),'001709','0000',1);
...
Insert into "TxAuthGroup" ("AuthNo","AuthItem","Desc","Status","CreateDate","CreateEmpNo","LastUpdate","LastUpdateEmpNo","BranchNo","LevelFg") values ('K000T1','高雄服務課',null,0,to_date('2021-11-12 14:29:30','YYYY-MM-DD HH24:MI:SS'),'001709',to_date('2021-11-12 14:29:30','YYYY-MM-DD HH24:MI:SS'),null,'0001',3);
