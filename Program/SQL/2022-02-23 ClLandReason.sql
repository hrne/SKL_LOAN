...
alter table "ClLandReason" add constraint "ClLandReason_PK" primary key("ClCode1", "ClCode2", "ClNo", "LandSeq");

create unique index "ClLandReason_Index1" on "ClLandReason"("ClCode1" asc, "ClCode2" asc, "ClNo" asc, "LandSeq" asc);
...
comment on column "ClLandReason"."LandSeq" is '土地序號';
