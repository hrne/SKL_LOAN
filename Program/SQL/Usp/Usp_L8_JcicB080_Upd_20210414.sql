  ...
  BEGIN
    ...
    SELECT
       ...
       --, NVL(M."ClTypeCode",' ')               AS "ClTypeCode"        -- 擔保品類別(JCIC)
         , CASE WHEN M."ClCode1" IS NULL THEN '  '
                WHEN M."ClCode1" = '1' THEN '25'
                WHEN M."ClCode1" = '2' THEN '20'
                WHEN M."ClCode1" = '3' THEN '14'
                WHEN M."ClCode1" = '4' THEN '11'
                WHEN M."ClCode1" = '5' THEN '02'
                WHEN M."ClCode1" = '9' AND  NVL(M."ClCode2",'0') = '1' THEN '31'
                WHEN M."ClCode1" = '9' THEN '30'
                ELSE '  '
