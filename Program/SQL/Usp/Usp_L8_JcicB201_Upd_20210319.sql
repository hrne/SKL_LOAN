...
--                             Order By R."EffectDate" DESC)   AS "Seq"
--                       ,  NVL(R."FitRate",0)                 AS "StoreRate"
--                  FROM  "LoanRateChange" R
--                    LEFT JOIN "LoanBorMain" L  ON L."CustNo"   = R."CustNo"
--                                              AND L."FacmNo"   = R."FacmNo"
--                                              AND L."BormNo"   = R."BormNo"
--                  WHERE R."EffectDate" <= YYYYMMDD
--                    AND R."EffectDate" <  L."PrevPayIntDate"
--               ) R             ON R."CustNo"   = M."CustNo"
--                              AND R."FacmNo"   = M."FacmNo"
--                              AND R."BormNo"   = M."BormNo"
--                              AND R."Seq"      = 1            -- 撈上次繳息日的利率
        LEFT JOIN ( SELECT  Tx."CustNo"
                    ...
                    WHERE Tx."TitaTxCd"  IN ('L3410', 'L3420')
                      ...
                      AND JSON_VALUE  (Tx."OtherFields", '$.CaseCloseCode') IN (0, 3, 4, 5)
