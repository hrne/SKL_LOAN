...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "Usp_Tf_RptRelationFamily_Ins" 
(
    -- 參數
...
BEGIN
    ...
    INSERT INTO "RptRelationFamily" (
        "CusId"               -- CusId NVARCHAR2 20 0
      , "CusSCD"              -- CusSCD NVARCHAR2 2 0
      , "RlbID"               -- RlbID NVARCHAR2 20 0
      , "RlbName"             -- RlbName NVARCHAR2 40 0
      , "FamilyCD"            -- FamilyCD NVARCHAR2 3 0
      , "LAW001"              -- LAW001 NVARCHAR2 1 0
      , "LAW002"              -- LAW002 NVARCHAR2 1 0
      , "LAW003"              -- LAW003 NVARCHAR2 1 0
      , "LAW004"              -- LAW004 NVARCHAR2 1 0
      , "LAW005"              -- LAW005 NVARCHAR2 1 0
      , "LAW006"              -- LAW006 NVARCHAR2 1 0
      , "LAW007"              -- LAW007 NVARCHAR2 1 0
      , "LAW008"              -- LAW008 NVARCHAR2 1 0
      , "LAW009"              -- LAW009 NVARCHAR2 1 0
      , "LAW0010"             -- LAW0010 NVARCHAR2 1 0
      , "RlbCusCCD"           -- RlbCusCCD NVARCHAR2 1 0
