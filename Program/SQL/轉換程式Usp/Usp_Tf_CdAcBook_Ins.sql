...
BEGIN
    ...
    INSERT INTO "CdAcBook" (
        "AcBookCode"          -- 帳冊別 VARCHAR2 3 -- 2021-07-15 修改: 000:全公司
      , "AcSubBookCode"       -- 區隔帳冊 VARCHAR2 3 -- 2021-07-15 新增 00A:傳統帳冊、201:利變帳冊
      , "CurrencyCode"        -- 幣別
      , "TargetAmt"           -- 放款目標金額 DECIMAL 16 2
      , "ActualAmt"           -- 放款實際金額 DECIMAL 16 2
      , "AssignSeq"           -- 分配順序 DECIMAL 2 
      , "AcctSource"          --	VARCHAR2(1 BYTE)	Yes		6	資金來源
