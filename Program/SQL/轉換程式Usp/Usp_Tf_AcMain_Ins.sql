...
BEGIN 
    ...
    SELECT '000'                          AS "AcBookCode"          -- 帳冊別 VARCHAR2 3 0 
          ,S2."AcSubBookCode"             AS "AcSubBookCode"       -- 區隔帳冊 VARCHAR2 3 0 -- 2021-07-15 新增 
          ...
          ,S3."AcSubCode"                 AS "AcSubCode"           -- 子目代號 VARCHAR2 5 0 
          ,S3."AcDtlCode"                 AS "AcDtlCode"           -- 細目代號 VARCHAR2 2 0 
          ...
          ,SUM(CASE -- "LCDPDA" > 0 表示為借方科目 , 用前日借方金額 - 前日貸方金額 + 本日借方金額 - 本日貸方金額 
             WHEN S3."DbCr" = 'D' THEN S1."LCDPDA" - S1."LCDPCA" + S1."LDGCDA" - S1."LDGCCA" 
           ELSE 0 - S1."LCDPDA" + S1."LCDPCA" - S1."LDGCDA" + S1."LDGCCA" END) -- 貸方科目 , 用0 - 前日借方金額 + 前日貸方金額 - 本日借方金額 + 本日貸方金額 
