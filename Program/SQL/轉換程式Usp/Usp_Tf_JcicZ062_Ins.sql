...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "Usp_Tf_JcicZ062_Ins" 
(
    -- 參數
...
BEGIN
    ...
    SELECT "TBJCICZ062"."TRANSACTIONSID"  AS "TranKey"             -- 交易代碼 VARCHAR2 1 0
          ...
          ,"TBJCICZ062".LASTUPDATEDATE    AS "CreateDate"          -- 建檔日期時間 DATE 8 0
          ,"TBJCICZ062".MODIFYUSERID      AS "CreateEmpNo"         -- 建檔人員 VARCHAR2 6 0
          ,"TBJCICZ062".LASTUPDATEDATE    AS "LastUpdate"          -- 最後更新日期時間 DATE 8 0
          ,"TBJCICZ062".MODIFYUSERID      AS "LastUpdateEmpNo"     -- 最後更新人員 VARCHAR2 6 0
