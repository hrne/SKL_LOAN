...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "Usp_Tf_RptRelationCompany_Ins" 
(
    -- 參數
...
BEGIN
    ...
    INSERT INTO "RptRelationCompany" (
      ...
      , "ComNo"               -- ComNo NVARCHAR2 10 0
      , "ComName"             -- ComName NVARCHAR2 50 0
      , "ComCRA"              -- ComCRA NVARCHAR2 18 0
      , "STSCD"               -- STSCD NVARCHAR2 2 0
