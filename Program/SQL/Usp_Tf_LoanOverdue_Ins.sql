...
BEGIN
    ...
    INSERT INTO "LoanOverdue" (
      ...
      , "Status"              -- 狀態 DECIMAL 1 
      , "AcctCode"            -- 帳務科目 VARCHAR2 3 
      , "OvduDate"            -- 轉催收日期 DECIMALD 8 
      , "BadDebtDate"         -- 轉呆帳日期 DECIMALD 8 
      , "ReplyDate"           -- 催收回復日期 DECIMALD 8 
      , "OvduPrinAmt"         -- 轉催收本金 DECIMAL 16 2
      , "OvduIntAmt"          -- 轉催收利息 DECIMAL 16 2
      , "OvduBreachAmt"       -- 轉催收違約金 DECIMAL 16 2
      , "OvduAmt"             -- 轉催收金額 DECIMAL 16 2
      , "OvduPrinBal"         -- 催收本金餘額 DECIMAL 16 2
      , "OvduIntBal"          -- 催收利息餘額 DECIMAL 16 2
      , "OvduBreachBal"       -- 催收違約金餘額 DECIMAL 16 2
      , "OvduBal"             -- 催收餘額 DECIMAL 16 2
      , "ReduceInt"           -- 減免利息金額 NUMBER(16,2)
      , "ReduceBreach"        -- 減免違約金金額 NUMBER(16,2)
      , "BadDebtAmt"          -- 轉呆帳金額 DECIMAL 16 2
      , "BadDebtBal"          -- 呆帳餘額 DECIMAL 16 2
      , "ReplyReduceAmt"      -- 催收回復減免金額 DECIMAL 16 2
      , "ProcessDate"         -- 處理日期 NUMBER(8,0)
      , "OvduSituaction"      -- 催收處理情形 NVARCHAR2 30 
      , "Remark"              -- 附言 NVARCHAR2 60 
