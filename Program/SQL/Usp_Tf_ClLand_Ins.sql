...
BEGIN 
    ...
    SELECT S1."ClCode1"                   AS "ClCode1"             -- 擔保品代號1 DECIMAL 1  
          ...
          ,CASE 
             ...
             -- 2023-05-04 Wei 新增以下邏輯 from SKL 承憲 email 三項問題IT負責人　FW: 統整智偉提出資料轉換問題尚未收到回覆資料共三封
             WHEN S2."LGTUSE" = 'A'  THEN '01'
             WHEN S2."LGTUSE" = 'B'  THEN '02'
             WHEN S2."LGTUSE" = 'C'  THEN '04'
             WHEN S2."LGTUSE" = 'D'  THEN '05'
             WHEN S2."LGTUSE" = 'E'  THEN '06'
             WHEN S2."LGTUSE" = 'F'  THEN '07'
             WHEN S2."LGTUSE" = 'G'  THEN '08'
             WHEN S2."LGTUSE" = 'H'  THEN '09'
             WHEN S2."LGTUSE" = 'I'  THEN '12'
             WHEN S2."LGTUSE" = 'J'  THEN '13'
             WHEN S2."LGTUSE" = 'K'  THEN '14'
             WHEN S2."LGTUSE" = 'L'  THEN '15'
             WHEN S2."LGTUSE" = 'M'  THEN '16'
             WHEN S2."LGTUSE" = 'N'  THEN '17'
             WHEN S2."LGTUSE" = 'O'  THEN '18'
             WHEN S2."LGTUSE" = 'P'  THEN '19'
             WHEN S2."LGTUSE" = 'Q'  THEN '20'
             WHEN S2."LGTUSE" = 'R'  THEN '21'
             WHEN S2."LGTUSE" = 'S'  THEN '22'
             WHEN S2."LGTUSE" = 'T'  THEN '23'
             WHEN S2."LGTUSE" = 'U'  THEN '25'
             WHEN S2."LGTUSE" = 'V'  THEN '26'
             WHEN S2."LGTUSE" = 'W'  THEN '27'
             WHEN S2."LGTUSE" = 'X'  THEN '28'
             WHEN S2."LGTUSE" = 'Y'  THEN '29'
             WHEN S2."LGTUSE" = 'Z'  THEN '30'
