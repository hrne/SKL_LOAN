create or replace NONEDITIONABLE PROCEDURE "Usp_L7_L7206Cust_Ins" 
( 
    -- 參數 
...
AS 
BEGIN  
-- exec "Usp_L7_L7206Cust_Ins"('001702'); 

  -- 刪除舊資料 
  EXECUTE IMMEDIATE 'ALTER TABLE "L7206Cust" DISABLE PRIMARY KEY CASCADE'; 
  EXECUTE IMMEDIATE 'TRUNCATE TABLE "L7206Cust" DROP STORAGE'; 
  EXECUTE IMMEDIATE 'ALTER TABLE "L7206Cust" ENABLE PRIMARY KEY'; 
 
  -- 寫入資料 
  INSERT INTO "L7206Cust" (
      "LogNo" -- 序號 AUTO 
  ...
  SELECT "L7206Cust_SEQ".nextval  AS "LogNo" -- 序號 AUTO 
  ...
  "Usp_L9_UspErrorLog_Ins"(
      'Usp_L7_L7206Cust_Ins' -- UspName 預存程序名稱
