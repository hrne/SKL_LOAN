 ...
 * @version 1.0.0
 */
public interface ClLandReasonRepositoryHist extends JpaRepository<ClLandReason, ClLandReasonId> {
	...
	// ClCode1 = ,AND ClCode2 = ,AND ClNo = ,AND LandSeq =
	public Slice<ClLandReason> findAllByClCode1IsAndClCode2IsAndClNoIsAndLandSeqIsOrderByClCode1AscClCode2AscClNoAscLandSeqAsc(int clCode1_0, int clCode2_1, int clNo_2, int landSeq_3,
			Pageable pageable);
