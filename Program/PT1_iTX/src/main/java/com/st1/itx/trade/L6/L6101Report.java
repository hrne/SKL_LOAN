...
@Component("L6101Report")
@Scope("prototype")
public class L6101Report extends MakeReport {
	...
	public void exec(TitaVo titaVo) throws LogicException {
		...
		int Entdy = Integer.parseInt(titaVo.getEntDy()) + 19110000;
		String Brno = titaVo.getBrno();

		this.info("Entdy==" + Entdy + ",Brno==" + Brno);

		Slice<TxRecord> sTxRecord = sTxRecordService.findImportFg(Entdy, Brno, "1", 0, Integer.MAX_VALUE, titaVo);
