...
public class JcicZ056 implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5546178619593079329L;
	...
	/**
	 * 法院裁定免責確定<br>
	 * Y;N 指該次法院是否裁定債務人免責 報送時間點為案件狀態B、C、D時
	 * 
	 * @return String
	 */
	...
	/**
	 * 清算損失金額<br>
	 * 清算案件於清算分配後損失之債權金額 報送時間點為案件狀態B、C
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "JcicZ056 [jcicZ056Id=" + jcicZ056Id + ", tranKey=" + tranKey + ", year=" + year + ", courtDiv=" + courtDiv + ", courtCaseNo=" + courtCaseNo + ", approve=" + approve + ", outstandAmt="
				+ outstandAmt + ", subAmt=" + subAmt + ", claimStatus1=" + claimStatus1 + ", saveDate=" + saveDate + ", claimStatus2=" + claimStatus2 + ", saveEndDate=" + saveEndDate + ", adminName="
				+ adminName + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
