...
public class FinReportReview implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -962874651335000095L;
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "FinReportReview [finReportReviewId=" + finReportReviewId + ", currentAsset=" + currentAsset + ", totalAsset=" + totalAsset + ", propertyAsset=" + propertyAsset + ", investment=" + investment
           + ", investmentProperty=" + investmentProperty + ", depreciation=" + depreciation + ", currentDebt=" + currentDebt + ", totalDebt=" + totalDebt + ", totalEquity=" + totalEquity + ", bondsPayable=" + bondsPayable
           + ", longTermBorrowings=" + longTermBorrowings + ", nonCurrentLease=" + nonCurrentLease + ", longTermPayable=" + longTermPayable + ", preference=" + preference + ", operatingRevenue=" + operatingRevenue + ", interestExpense=" + interestExpense
           + ", profitBeforeTax=" + profitBeforeTax + ", profitAfterTax=" + profitAfterTax + ", workingCapitalRatio=" + workingCapitalRatio + ", interestCoverageRatio1=" + interestCoverageRatio1 + ", interestCoverageRatio2=" + interestCoverageRatio2 + ", leverageRatio=" + leverageRatio
           + ", equityRatio=" + equityRatio + ", longFitRatio=" + longFitRatio + ", netProfitRatio=" + netProfitRatio + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
