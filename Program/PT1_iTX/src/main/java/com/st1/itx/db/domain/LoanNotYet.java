...
public class LoanNotYet implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6460110955196182511L;
	...
	/**
	 * 未齊件代碼<br>
	 * 共用代碼檔 01:代償後謄本 02:火險單 03:借款申請書 04:顧客資料表 05:公司章程 06:公司執照 07:董監名冊 08:股東名冊
	 * 09:會計師簽證或期中報表 10:公司戶營業稅或所得稅申報資料 11:資金運用計畫書 12:土地使用計畫書 13:建築執照 14:董監會借款決議紀錄
	 * 15:個人戶所得稅申報資料 16:債權憑證補章 17:補辦對保手續 18:謄本 20:定存單 99:其他
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "LoanNotYet [loanNotYetId=" + loanNotYetId + ", yetDate=" + yetDate + ", closeDate=" + closeDate + ", reMark=" + reMark + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
