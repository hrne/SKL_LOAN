...
public class LoanChequeServiceImpl extends ASpringJpaParm implements LoanChequeService, InitializingBean {
	...
	public Slice<LoanCheque> chequeDateRange(int chequeDate_0, int chequeDate_1, int chequeAcct_2, int chequeAcct_3, int chequeNo_4, int chequeNo_5, int index, int limit, TitaVo... titaVo) {
		...
		this.info("chequeDateRange " + dbName + " : " + "chequeDate_0 : " + chequeDate_0 + " chequeDate_1 : " + chequeDate_1 + " chequeAcct_2 : " + chequeAcct_2 + " chequeAcct_3 : " + chequeAcct_3
				+ " chequeNo_4 : " + chequeNo_4 + " chequeNo_5 : " + chequeNo_5);
		if (dbName.equals(ContentName.onDay))
			slice = loanChequeReposDay
					.findAllByChequeDateGreaterThanEqualAndChequeDateLessThanEqualAndChequeAcctGreaterThanEqualAndChequeAcctLessThanEqualAndChequeNoGreaterThanEqualAndChequeNoLessThanEqualOrderByChequeDateAscCustNoAscChequeAcctAscChequeNoAsc(
							chequeDate_0, chequeDate_1, chequeAcct_2, chequeAcct_3, chequeNo_4, chequeNo_5, pageable);
		else if (dbName.equals(ContentName.onMon))
	...
	public Slice<LoanCheque> chequeCustNoEq(int custNo_0, List<String> statusCode_1, int chequeDate_2, int chequeDate_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = loanChequeReposDay.findAllByCustNoIsAndStatusCodeInAndChequeDateGreaterThanEqualAndChequeDateLessThanEqualOrderByChequeAcctAscChequeNoAsc(custNo_0, statusCode_1, chequeDate_2,
					chequeDate_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = loanChequeReposMon.findAllByCustNoIsAndStatusCodeInAndChequeDateGreaterThanEqualAndChequeDateLessThanEqualOrderByChequeAcctAscChequeNoAsc(custNo_0, statusCode_1, chequeDate_2,
					chequeDate_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = loanChequeReposHist.findAllByCustNoIsAndStatusCodeInAndChequeDateGreaterThanEqualAndChequeDateLessThanEqualOrderByChequeAcctAscChequeNoAsc(custNo_0, statusCode_1, chequeDate_2,
					chequeDate_3, pageable);
		else
			slice = loanChequeRepos.findAllByCustNoIsAndStatusCodeInAndChequeDateGreaterThanEqualAndChequeDateLessThanEqualOrderByChequeAcctAscChequeNoAsc(custNo_0, statusCode_1, chequeDate_2,
					chequeDate_3, pageable);
	...
	public Slice<LoanCheque> statusCodeRange(List<String> statusCode_0, int chequeDate_1, int chequeDate_2, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = loanChequeReposDay.findAllByStatusCodeInAndChequeDateGreaterThanEqualAndChequeDateLessThanEqualOrderByChequeDateAscChequeAcctAscChequeNoAsc(statusCode_0, chequeDate_1,
					chequeDate_2, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = loanChequeReposMon.findAllByStatusCodeInAndChequeDateGreaterThanEqualAndChequeDateLessThanEqualOrderByChequeDateAscChequeAcctAscChequeNoAsc(statusCode_0, chequeDate_1,
					chequeDate_2, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = loanChequeReposHist.findAllByStatusCodeInAndChequeDateGreaterThanEqualAndChequeDateLessThanEqualOrderByChequeDateAscChequeAcctAscChequeNoAsc(statusCode_0, chequeDate_1,
					chequeDate_2, pageable);
		else
			slice = loanChequeRepos.findAllByStatusCodeInAndChequeDateGreaterThanEqualAndChequeDateLessThanEqualOrderByChequeDateAscChequeAcctAscChequeNoAsc(statusCode_0, chequeDate_1, chequeDate_2,
					pageable);
	...
	@Override
	public Slice<LoanCheque> forStatusCodeSelect(int chequeDate_0, int chequeDate_1, int chequeAcct_2, int chequeAcct_3, int chequeNo_4, int chequeNo_5, String statusCode_6, int index, int limit,
			TitaVo... titaVo) {
		String dbName = "";
		Slice<LoanCheque> slice = null;
		if (titaVo.length != 0)
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("forStatusCodeSelect " + dbName + " : " + "chequeDate_0 : " + chequeDate_0 + " chequeDate_1 : " + chequeDate_1 + " chequeAcct_2 : " + chequeAcct_2 + " chequeAcct_3 : " + chequeAcct_3
				+ " chequeNo_4 : " + chequeNo_4 + " chequeNo_5 : " + chequeNo_5 + " statusCode_6 : " + statusCode_6);
		if (dbName.equals(ContentName.onDay))
			slice = loanChequeReposDay
					.findAllByChequeDateGreaterThanEqualAndChequeDateLessThanEqualAndChequeAcctGreaterThanEqualAndChequeAcctLessThanEqualAndChequeNoGreaterThanEqualAndChequeNoLessThanEqualAndStatusCodeIsOrderByChequeDateAscCustNoAscChequeAcctAscChequeNoAsc(
							chequeDate_0, chequeDate_1, chequeAcct_2, chequeAcct_3, chequeNo_4, chequeNo_5, statusCode_6, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = loanChequeReposMon
					.findAllByChequeDateGreaterThanEqualAndChequeDateLessThanEqualAndChequeAcctGreaterThanEqualAndChequeAcctLessThanEqualAndChequeNoGreaterThanEqualAndChequeNoLessThanEqualAndStatusCodeIsOrderByChequeDateAscCustNoAscChequeAcctAscChequeNoAsc(
							chequeDate_0, chequeDate_1, chequeAcct_2, chequeAcct_3, chequeNo_4, chequeNo_5, statusCode_6, pageable);
	...
	@Override
	public Slice<LoanCheque> custNoChequeRange(int custNo_0, int custNo_1, List<String> statusCode_2, int chequeNo_3, int chequeNo_4, int chequeDate_5, int chequeDate_6, int index, int limit,
			TitaVo... titaVo) {
		String dbName = "";
		Slice<LoanCheque> slice = null;
		if (titaVo.length != 0)
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("custNoChequeRange " + dbName + " : " + "custNo_0 : " + custNo_0 + " custNo_1 : " + custNo_1 + " statusCode_2 : " + statusCode_2 + " chequeNo_3 : " + chequeNo_3 + " chequeNo_4 : "
				+ chequeNo_4 + " chequeDate_5 : " + chequeDate_5 + " chequeDate_6 : " + chequeDate_6);
		if (dbName.equals(ContentName.onDay))
			slice = loanChequeReposDay
					.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndStatusCodeInAndChequeNoGreaterThanEqualAndChequeNoLessThanEqualAndChequeDateGreaterThanEqualAndChequeDateLessThanEqualOrderByChequeAcctAscChequeNoAsc(
							custNo_0, custNo_1, statusCode_2, chequeNo_3, chequeNo_4, chequeDate_5, chequeDate_6, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = loanChequeReposMon
					.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndStatusCodeInAndChequeNoGreaterThanEqualAndChequeNoLessThanEqualAndChequeDateGreaterThanEqualAndChequeDateLessThanEqualOrderByChequeAcctAscChequeNoAsc(
							custNo_0, custNo_1, statusCode_2, chequeNo_3, chequeNo_4, chequeDate_5, chequeDate_6, pageable);
	...
	public LoanCheque insert(LoanCheque loanCheque, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(loanCheque.getLoanChequeId()) != null)
