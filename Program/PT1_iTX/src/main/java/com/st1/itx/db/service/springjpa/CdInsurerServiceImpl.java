...
@Repository
public class CdInsurerServiceImpl extends ASpringJpaParm implements CdInsurerService, InitializingBean {
	@Autowired
	...
	public CdInsurer findById(CdInsurerId cdInsurerId, TitaVo... titaVo) {
		...
		this.info("findById " + dbName + " " + cdInsurerId);
	...
	public Slice<CdInsurer> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by(Sort.Direction.ASC, "InsurerType", "InsurerCode"));
		else
	...
	public Slice<CdInsurer> insurerItemLike(String insurerItem_0, int index, int limit, TitaVo... titaVo) {
		...
		this.info("insurerItemLike " + dbName + " : " + "insurerItem_0 : " + insurerItem_0);
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<CdInsurer> insurerTypeRange(String insurerType_0, String insurerType_1, String insurerCode_2, String insurerCode_3, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("insurerTypeRange " + dbName + " : " + "insurerType_0 : " + insurerType_0 + " insurerType_1 : " + insurerType_1 + " insurerCode_2 : " + insurerCode_2 + " insurerCode_3 : "
				+ insurerCode_3);
		if (dbName.equals(ContentName.onDay))
			slice = cdInsurerReposDay.findAllByInsurerTypeGreaterThanEqualAndInsurerTypeLessThanEqualAndInsurerCodeGreaterThanEqualAndInsurerCodeLessThanEqualOrderByInsurerTypeAscInsurerCodeAsc(
					insurerType_0, insurerType_1, insurerCode_2, insurerCode_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = cdInsurerReposMon.findAllByInsurerTypeGreaterThanEqualAndInsurerTypeLessThanEqualAndInsurerCodeGreaterThanEqualAndInsurerCodeLessThanEqualOrderByInsurerTypeAscInsurerCodeAsc(
					insurerType_0, insurerType_1, insurerCode_2, insurerCode_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = cdInsurerReposHist.findAllByInsurerTypeGreaterThanEqualAndInsurerTypeLessThanEqualAndInsurerCodeGreaterThanEqualAndInsurerCodeLessThanEqualOrderByInsurerTypeAscInsurerCodeAsc(
					insurerType_0, insurerType_1, insurerCode_2, insurerCode_3, pageable);
		else
			slice = cdInsurerRepos.findAllByInsurerTypeGreaterThanEqualAndInsurerTypeLessThanEqualAndInsurerCodeGreaterThanEqualAndInsurerCodeLessThanEqualOrderByInsurerTypeAscInsurerCodeAsc(
					insurerType_0, insurerType_1, insurerCode_2, insurerCode_3, pageable);
	...
	public CdInsurer holdById(CdInsurerId cdInsurerId, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Hold " + dbName + " " + cdInsurerId);
		Optional<CdInsurer> cdInsurer = null;
		if (dbName.equals(ContentName.onDay))
	...
	public CdInsurer holdById(CdInsurer cdInsurer, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Hold " + dbName + " " + cdInsurer.getCdInsurerId());
	...
	public CdInsurer insert(CdInsurer cdInsurer, TitaVo... titaVo) throws DBException {
		...
		this.info("Insert..." + dbName + " " + cdInsurer.getCdInsurerId());
	...
	public CdInsurer update(CdInsurer cdInsurer, TitaVo... titaVo) throws DBException {
		...
		this.info("Update..." + dbName + " " + cdInsurer.getCdInsurerId());
		if (!empNot.isEmpty())
			cdInsurer.setLastUpdateEmpNo(empNot);
	...
	public void delete(CdInsurer cdInsurer, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Delete..." + dbName + " " + cdInsurer.getCdInsurerId());
		if (dbName.equals(ContentName.onDay)) {
