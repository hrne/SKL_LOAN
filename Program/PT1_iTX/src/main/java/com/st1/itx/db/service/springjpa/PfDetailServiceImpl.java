...
public class PfDetailServiceImpl extends ASpringJpaParm implements PfDetailService, InitializingBean {
	...
	public Slice<PfDetail> findFacmNoRange(int custNo_0, int facmNo_1, int facmNo_2, int workMonth_3, int workMonth_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findFacmNoRange " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " + facmNo_1 + " facmNo_2 : " + facmNo_2 + " workMonth_3 : " + workMonth_3 + " workMonth_4 : "
				+ workMonth_4);
		if (dbName.equals(ContentName.onDay))
			slice = pfDetailReposDay.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndWorkMonthGreaterThanEqualAndWorkMonthLessThanEqualOrderByPerfDateAscFacmNoAscBormNoAscBorxNoAsc(
					custNo_0, facmNo_1, facmNo_2, workMonth_3, workMonth_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = pfDetailReposMon.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndWorkMonthGreaterThanEqualAndWorkMonthLessThanEqualOrderByPerfDateAscFacmNoAscBormNoAscBorxNoAsc(
					custNo_0, facmNo_1, facmNo_2, workMonth_3, workMonth_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = pfDetailReposHist
					.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndWorkMonthGreaterThanEqualAndWorkMonthLessThanEqualOrderByPerfDateAscFacmNoAscBormNoAscBorxNoAsc(custNo_0,
							facmNo_1, facmNo_2, workMonth_3, workMonth_4, pageable);
		else
			slice = pfDetailRepos.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndWorkMonthGreaterThanEqualAndWorkMonthLessThanEqualOrderByPerfDateAscFacmNoAscBormNoAscBorxNoAsc(
					custNo_0, facmNo_1, facmNo_2, workMonth_3, workMonth_4, pageable);
