...
public interface ClFacRepositoryHist extends JpaRepository<ClFac, ClFacId> {
	...
	public Slice<ClFac> findAllByApproveNoGreaterThanEqualAndApproveNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByClCode1AscClCode2AscClNoAscApproveNoAsc(int approveNo_0,
			int approveNo_1, int facmNo_2, int facmNo_3, Pageable pageable);

	// ClCode1 = ,AND ClCode2 = ,AND ClNo = ,AND ApproveNo >= ,AND ApproveNo <= ,AND
	...
	public Slice<ClFac> findAllByClCode1IsAndClCode2IsAndClNoIsAndApproveNoGreaterThanEqualAndApproveNoLessThanEqualAndCustNoGreaterThanEqualAndCustNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByClCode1AscClCode2AscClNoAscApproveNoAsc(
			int clCode1_0, int clCode2_1, int clNo_2, int approveNo_3, int approveNo_4, int custNo_5, int custNo_6, int facmNo_7, int facmNo_8, Pageable pageable);

	// ClCode1 >= ,AND ClCode1 <= ,AND ClCode2 >= ,AND ClCode2 <= ,AND ClNo >= ,AND
	// ClNo <= ,AND CustNo >= ,AND CustNo <= ,AND FacmNo >= ,AND FacmNo <= ,AND
	// ApproveNo >= ,AND ApproveNo <=
	public Slice<ClFac> (
			int clCode1_0, int clCode1_1, int clCode2_2, int clCode2_3, int clNo_4, int clNo_5, int custNo_6, int custNo_7, int facmNo_8, int facmNo_9, int approveNo_10, int approveNo_11,
			Pageable pageable);
