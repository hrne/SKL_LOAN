...
public class JcicZ063 implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3206852529556465546L;
	...
	// 結案原因
	/* A:資料key值報送錯誤，本行結案B:協商不成立C:更新變更還款條件 */
	...
	public String toString() {
		return "JcicZ063 [jcicZ063Id=" + jcicZ063Id + ", tranKey=" + tranKey + ", closedDate=" + closedDate + ", closedResult=" + closedResult + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey
