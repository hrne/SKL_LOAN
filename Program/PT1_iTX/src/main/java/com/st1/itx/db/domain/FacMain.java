...
public class FacMain implements Serializable {
	...
	/*
	 * 規定管制代碼
	 * 00:一般01:自然人第三戶(央行管制)02:自然人第三戶且為高價住宅(央行管制)03:自然人第四戶以上(央行管制)04:自然人第四戶以上且為高價住宅(
	 * 央行管制)05:自然人購置高價住宅(央行管制)06:法人購置住宅第一戶(央行管制)07:法人購置住宅第二戶以上(央行管制)08:購地貸款(央行管制)09:
	 * 餘屋貸款(央行管制)10:工業區閒置土地抵押貸款(央行管制)11:增貸管制戶(舊央行管制)12:自然人特定地區第2戶購屋貸款(舊央行管制)13:投資戶(
	 * 內部規範)
	 */
	...
	// 計件代碼
	/*
	 * A: 新貸件B: 其他額度C: 原額度D: 新增額度E: 展期1: 新貸件2: 其他額度3: 原額度4: 新增額度5: 展期件6: 六個月動支7:
	 * 服務件8: 特殊件9: 固特利契轉
	 */
	...
	// 提前清償原因
	/*
	 * 共用代碼檔00:無01:買賣02:自行還清03:軍功教勞工貸款轉貸04:利率過高轉貸05:增貸不准轉貸06:額度內動支不准轉貸07:內部代償08:
	 * 借新還舊09:其他10:買回11:綁約期還款
	 */
	...
	// 綠色支出類別
	/*
	 * CdCode.GrKindA:再生能源B:節能C:污染防制D:生命自然資源環境永續管理及土地利用環境永續管理E:地域與水域生物多樣性保護F:潔淨交通運輸G
	 * :永續水源及廢水處理H:氣候變遷調適I:具生態效率與環境經濟調適之產品J:綠能建築Z:其他(2022.4.21異動)by 昱衡
	 */
	...
	// 永續績效連結授信類別
	/*
	 * CdCode.EsGKind1:E環境2:S社會責任3:G公司治理 4:ES環境及社會責任 5:EG環境及公司治理 6:SG社會責任及公司治理
	 * 7:ESG環境、社會責任及公司治理(2022.4.21異動)by 昱衡
	 */
	...
	/**
	 * 核准科目<br>
	 * 共用代碼檔 310: 短期擔保放款 320: 中期擔保放款 330: 長期擔保放款 340: 三十年房貸
	 * 
	 * @return String
	 */
	...
	/**
	 * 攤還方式<br>
	 * 共用代碼檔 1.按月繳息(按期繳息到期還本) 2.到期取息(到期繳息還本) 3.本息平均法(期金) 4.本金平均法 5.按月撥款收息(逆向貸款)
	 * 
	 * @return String
	 */
	...
	/**
	 * 規定管制代碼<br>
	 * 規定管制代碼 00:一般 01:自然人第三戶(央行管制) 02:自然人第三戶且為高價住宅(央行管制) 03:自然人第四戶以上(央行管制)
	 * 04:自然人第四戶以上且為高價住宅(央行管制) 05:自然人購置高價住宅(央行管制) 06:法人購置住宅第一戶(央行管制)
	 * 07:法人購置住宅第二戶以上(央行管制) 08:購地貸款(央行管制) 09:餘屋貸款(央行管制) 10:工業區閒置土地抵押貸款(央行管制)
	 * 11:增貸管制戶(舊央行管制) 12:自然人特定地區第2戶購屋貸款(舊央行管制) 13:投資戶(內部規範)
	 * 
	 * @return String
	 */
	...
	/**
	 * 客戶別<br>
	 * 共用代碼檔 00 一般 01 員工 02 首購 03 關企公司 04 關企員工 05 保戶 07 員工二親等 09 新二階員工 10 保貸戶
	 * 
	 * @return String
	 */
	...
	/**
	 * 資金用途別<br>
	 * 共用代碼檔 01: 週轉金 02: 購置不動產 03: 營業用資產 04: 固定資產 05: 企業投資 06: 購置動產 09: 其他
	 * 
	 * @return String
	 */
	...
	/**
	 * 計件代碼<br>
	 * A: 新貸件 B: 其他額度 C: 原額度 D: 新增額度 E: 展期 1: 新貸件 2: 其他額度 3: 原額度 4: 新增額度 5: 展期件 6:
	 * 六個月動支 7: 服務件 8: 特殊件 9: 固特利契轉
	 * 
	 * @return String
	 */
	...
	/**
	 * 提前清償原因<br>
	 * 共用代碼檔 00:無 01:買賣 02:自行還清 03:軍功教勞工貸款轉貸 04:利率過高轉貸 05:增貸不准轉貸 06:額度內動支不准轉貸
	 * 07:內部代償 08:借新還舊 09:其他 10:買回 11:綁約期還款
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 綠色支出類別<br>
	 * CdCode.GrKind A:再生能源 B:節能 C:污染防制 D:生命自然資源環境永續管理及土地利用環境永續管理 E:地域與水域生物多樣性保護
	 * F:潔淨交通運輸 G:永續水源及廢水處理 H:氣候變遷調適 I:具生態效率與環境經濟調適之產品 J:綠能建築 Z:其他 (2022.4.21異動)by
	 * 昱衡
	 * 
	 * @return String
	 */
	...
	/**
	 * 永續績效連結授信類別<br>
	 * CdCode.EsGKind 1:E環境 2:S社會責任 3:G公司治理 4:ES環境及社會責任 5:EG環境及公司治理 6:SG社會責任及公司治理
	 * 7:ESG環境、社會責任及公司治理 (2022.4.21異動)by 昱衡
	 * 
	 * @return String
	 */
	...
	/**
	 * 額度設定日<br>
	 * 企金:額度核准時將申請檔內准駁日期寫入[額度設定日 ELOAN:擔保品案件在上送的時候，會回寫額度設定日，傳的日期就是上送當下的日期
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "FacMain [facMainId=" + facMainId + ", lastBormNo=" + lastBormNo + ", lastBormRvNo=" + lastBormRvNo + ", applNo=" + applNo + ", creditSysNo=" + creditSysNo + ", prodNo=" + prodNo
				+ ", baseRateCode=" + baseRateCode + ", rateIncr=" + rateIncr + ", individualIncr=" + individualIncr + ", approveRate=" + approveRate + ", annualIncr=" + annualIncr + ", emailIncr="
				+ emailIncr + ", graceIncr=" + graceIncr + ", rateCode=" + rateCode + ", firstRateAdjFreq=" + firstRateAdjFreq + ", rateAdjFreq=" + rateAdjFreq + ", currencyCode=" + currencyCode
				+ ", lineAmt=" + lineAmt + ", utilAmt=" + utilAmt + ", utilBal=" + utilBal + ", acctCode=" + acctCode + ", loanTermYy=" + loanTermYy + ", loanTermMm=" + loanTermMm + ", loanTermDd="
				+ loanTermDd + ", firstDrawdownDate=" + firstDrawdownDate + ", maturityDate=" + maturityDate + ", intCalcCode=" + intCalcCode + ", amortizedCode=" + amortizedCode + ", freqBase="
				+ freqBase + ", payIntFreq=" + payIntFreq + ", repayFreq=" + repayFreq + ", utilDeadline=" + utilDeadline + ", gracePeriod=" + gracePeriod + ", acctFee=" + acctFee + ", handlingFee="
				+ handlingFee + ", ruleCode=" + ruleCode + ", extraRepayCode=" + extraRepayCode + ", custTypeCode=" + custTypeCode + ", recycleCode=" + recycleCode + ", recycleDeadline="
				+ recycleDeadline + ", usageCode=" + usageCode + ", departmentCode=" + departmentCode + ", incomeTaxFlag=" + incomeTaxFlag + ", compensateFlag=" + compensateFlag + ", irrevocableFlag="
				+ irrevocableFlag + ", rateAdjNoticeCode=" + rateAdjNoticeCode + ", pieceCode=" + pieceCode + ", repayCode=" + repayCode + ", introducer=" + introducer + ", district=" + district
				+ ", fireOfficer=" + fireOfficer + ", estimate=" + estimate + ", creditOfficer=" + creditOfficer + ", loanOfficer=" + loanOfficer + ", businessOfficer=" + businessOfficer
				+ ", supervisor=" + supervisor + ", investigateOfficer=" + investigateOfficer + ", estimateReview=" + estimateReview + ", coorgnizer=" + coorgnizer + ", advanceCloseCode="
				+ advanceCloseCode + ", prodBreachFlag=" + prodBreachFlag + ", breachDescription=" + breachDescription + ", creditScore=" + creditScore + ", guaranteeDate=" + guaranteeDate
				+ ", contractNo=" + contractNo + ", colSetFlag=" + colSetFlag + ", actFg=" + actFg + ", lastAcctDate=" + lastAcctDate + ", lastKinbr=" + lastKinbr + ", lastTlrNo=" + lastTlrNo
				+ ", lastTxtNo=" + lastTxtNo + ", acDate=" + acDate + ", l9110Flag=" + l9110Flag + ", branchNo=" + branchNo + ", approvedLevel=" + approvedLevel + ", grcd=" + grcd + ", grKind="
				+ grKind + ", esGcd=" + esGcd + ", esGKind=" + esGKind + ", esGcnl=" + esGcnl + ", renewCnt=" + renewCnt + ", oldFacmNo=" + oldFacmNo + ", settingDate=" + settingDate
				+ ", starBuildingPeriod=" + starBuildingPeriod + ", starBuildingYM=" + starBuildingYM + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
