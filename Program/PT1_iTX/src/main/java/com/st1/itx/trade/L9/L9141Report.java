...
import com.st1.itx.db.service.springjpa.cm.L9141ServiceImpl;
...
@Component
@Scope("prototype")
public class L9141Report extends MakeReport {
	@Autowired
	L9141ServiceImpl L9141ServiceImpl;
	...
	private final String tranCode = "L9141";
	private final String tranName = "暫收款-火險費餘額表";

	public void exec(TitaVo titaVo) throws LogicException {
		this.info("L9141Report exec");
		
		// 1.撈資料
		try {
			resultList = L9141ServiceImpl.findAll(titaVo);
		} catch (LogicException e) {
			StringWriter errors = new StringWriter();
			e.printStackTrace(new PrintWriter(errors));
			this.error("L9141ServiceImpl.findAll error = " + errors.toString());
		}
	...
	private void makeReport(TitaVo titaVo) throws LogicException {
		this.info("L9141Report makeReport");
		...
		String defaultExcel = "L9141_底稿_暫收款-火險費餘額表.xlsx";
