...
public class L420BBatch extends TradeBuffer {
	...
	public ArrayList<TotaVo> run(TitaVo titaVo) throws LogicException {
		...
		if (iFunctionCode != 3) {
				...
				case 0: // 0:入帳
					...
					if (isCheck) {
						...
						try {
							...
							throw new LogicException(titaVo, "E0007",
									"L420BBatch update batxDetail " + tDetail + e.getErrorMsg());
						}
						this.batchTransaction.commitEnd();
						this.batchTransaction.init();
					}
			...
			this.batchTransaction.commitEnd();
			this.batchTransaction.init();
			this.info(" L420BBatch ProcessCnt= " + ProcessCnt);
		}
...
// 處理代碼 0:入帳 1:刪除 2:訂正 4.刪除回復
		...
		this.info("L420BBatch updateHead batxExeCode = " + batxExeCode + ", unCheckTotalCnt=" + unCheckTotalCnt
