...
public class CdEmp implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1498253555733688510L;
...
// 電腦編號
	...
	/**
	 * 業務人員任用狀況碼<br>
	 * [員工身份別] 0:單位報備 1:在職 2:離職 3:解聘 4:留職停薪 5:退休離職 9:未報聘/內勤
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "CdEmp [employeeNo=" + employeeNo + ", agentCode=" + agentCode + ", fullname=" + fullname + ", centerShortName=" + centerShortName + ", centerCodeName=" + centerCodeName
				+ ", centerCode1=" + centerCode1 + ", centerCode1Short=" + centerCode1Short + ", centerCode1Name=" + centerCode1Name + ", centerCode2=" + centerCode2 + ", centerCode2Short="
				+ centerCode2Short + ", centerCode2Name=" + centerCode2Name + ", centerCodeAcc1=" + centerCodeAcc1 + ", centerCodeAcc1Name=" + centerCodeAcc1Name + ", centerCodeAcc2=" + centerCodeAcc2
				+ ", centerCodeAcc2Name=" + centerCodeAcc2Name + ", commLineCode=" + commLineCode + ", commLineType=" + commLineType + ", origIntroducerId=" + origIntroducerId + ", introducerInd="
				+ introducerInd + ", registerLevel=" + registerLevel + ", registerDate=" + registerDate + ", centerCode=" + centerCode + ", administratId=" + administratId + ", inputDate=" + inputDate
				+ ", inputUser=" + inputUser + ", agStatusCode=" + agStatusCode + ", agStatusDate=" + agStatusDate + ", tranDate=" + tranDate + ", tranUser=" + tranUser + ", reRegisterDate="
				+ reRegisterDate + ", directorId=" + directorId + ", directorIdF=" + directorIdF + ", introducerId=" + introducerId + ", introducerIdF=" + introducerIdF + ", agLevel=" + agLevel
				+ ", lastLevel=" + lastLevel + ", levelDate=" + levelDate + ", topLevel=" + topLevel + ", occpInd=" + occpInd + ", quotaAmt=" + quotaAmt + ", applType=" + applType + ", taxRate="
				+ taxRate + ", socialInsuClass=" + socialInsuClass + ", promotLevelYM=" + promotLevelYM + ", directorYM=" + directorYM + ", recordDate=" + recordDate + ", exRecordDate=" + exRecordDate
				+ ", rxTrDate=" + rxTrDate + ", exTrIdent=" + exTrIdent + ", exTrIdent2=" + exTrIdent2 + ", exTrIdent3=" + exTrIdent3 + ", exTrDate=" + exTrDate + ", registerBefore=" + registerBefore
				+ ", directorAfter=" + directorAfter + ", medicalCode=" + medicalCode + ", exChgDate=" + exChgDate + ", exDelDate=" + exDelDate + ", applCode=" + applCode + ", firstRegDate="
				+ firstRegDate + ", aginSource=" + aginSource + ", aguiCenter=" + aguiCenter + ", agentId=" + agentId + ", topId=" + topId + ", agDegree=" + agDegree + ", collectInd=" + collectInd
				+ ", agType1=" + agType1 + ", contractInd=" + contractInd + ", contractIndYM=" + contractIndYM + ", agType2=" + agType2 + ", agType3=" + agType3 + ", agType4=" + agType4
				+ ", aginInd1=" + aginInd1 + ", agPoInd=" + agPoInd + ", agDocInd=" + agDocInd + ", newHireType=" + newHireType + ", agCurInd=" + agCurInd + ", agSendType=" + agSendType
				+ ", agSendNo=" + agSendNo + ", registerDate2=" + registerDate2 + ", agReturnDate=" + agReturnDate + ", agTransferDateF=" + agTransferDateF + ", agTransferDate=" + agTransferDate
				+ ", promotYM=" + promotYM + ", promotYMF=" + promotYMF + ", agPostChgDate=" + agPostChgDate + ", familiesTax=" + familiesTax + ", agentCodeI=" + agentCodeI + ", agLevelSys="
				+ agLevelSys + ", agPostIn=" + agPostIn + ", centerCodeAcc=" + centerCodeAcc + ", evalueInd=" + evalueInd + ", evalueInd1=" + evalueInd1 + ", batchNo=" + batchNo + ", evalueYM="
				+ evalueYM + ", agTransferCode=" + agTransferCode + ", birth=" + birth + ", education=" + education + ", lrInd=" + lrInd + ", proceccDate=" + proceccDate + ", quitDate=" + quitDate
				+ ", agPost=" + agPost + ", levelNameChs=" + levelNameChs + ", lrSystemType=" + lrSystemType + ", seniorityYY=" + seniorityYY + ", seniorityMM=" + seniorityMM + ", seniorityDD="
				+ seniorityDD + ", aglaProcessInd=" + aglaProcessInd + ", statusCode=" + statusCode + ", aglaCancelReason=" + aglaCancelReason + ", iSAnnApplDate=" + iSAnnApplDate + ", recordDateC="
				+ recordDateC + ", stopReason=" + stopReason + ", stopStrDate=" + stopStrDate + ", stopEndDate=" + stopEndDate + ", iFPDate=" + iFPDate + ", effectStrDate=" + effectStrDate
				+ ", effectEndDate=" + effectEndDate + ", annApplDate=" + annApplDate + ", centerCodeAccName=" + centerCodeAccName + ", reHireCode=" + reHireCode + ", rSVDAdminCode=" + rSVDAdminCode
				+ ", account=" + account + ", pRPDate=" + pRPDate + ", zip=" + zip + ", address=" + address + ", phoneH=" + phoneH + ", phoneC=" + phoneC + ", salesQualInd=" + salesQualInd
				+ ", agsqStartDate=" + agsqStartDate + ", pinYinNameIndi=" + pinYinNameIndi + ", email=" + email + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate="
