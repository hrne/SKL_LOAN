...
public class TxHoliday implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6876800778177577140L;
	...
	public String toString() {
		return "TxHoliday [txHolidayId=" + txHolidayId + ", typeCode=" + typeCode + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo="
				+ lastUpdateEmpNo + "]";
	}
}
