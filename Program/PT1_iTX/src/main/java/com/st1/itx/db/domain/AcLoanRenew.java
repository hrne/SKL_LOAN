...
public class AcLoanRenew implements Serializable {
	...
	/**
	 * 展期記號<br>
	 * 代碼檔: 02-業務作業 RenewCode展期記號 1:一般 2:協議
	 * 
	 * @return String
	 */
	...
	/**
	 * 主要記號<br>
	 * Y.新撥款找舊撥款時，取舊撥款第一筆為Y 新對舊為一對多時第一筆為Y,其餘為N
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "AcLoanRenew [acLoanRenewId=" + acLoanRenewId + ", renewCode=" + renewCode + ", mainFlag=" + mainFlag + ", acDate=" + acDate + ", otherFields=" + otherFields + ", createEmpNo="
