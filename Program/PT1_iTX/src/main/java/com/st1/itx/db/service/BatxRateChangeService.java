...
public interface BatxRateChangeService {
	...
	/**
	 * CustCode &gt;= ,AND CustCode &lt;= ,AND TxKind &gt;= ,AND TxKind &lt;= ,AND
	 * AdjCode &gt;= ,AND AdjCode &lt;= ,AND AdjDate &gt;= ,AND AdjDate &lt;=
	 *
	...
	/**
	 * AdjDate &gt;= ,AND AdjDate &lt;= ,AND CustCode &gt;= ,AND CustCode &lt;= ,AND
	 * TxKind = ,AND AdjCode &gt;= ,AND AdjCode &lt;= ,AND ConfirmFlag =
	 *
	 * @param adjDate_0     adjDate_0
	 * @param adjDate_1     adjDate_1
	 * @param custCode_2    custCode_2
