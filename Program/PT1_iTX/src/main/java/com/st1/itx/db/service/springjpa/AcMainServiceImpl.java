...
@Repository
public class AcMainServiceImpl extends ASpringJpaParm implements AcMainService, InitializingBean {
  @Autowired
  ...
  public AcMain findById(AcMainId acMainId, TitaVo... titaVo) {
    ...
    this.info("findById " + dbName + " " + acMainId);
...
em = null;
  ...
  public Slice<AcMain> findAll(int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by(Sort.Direction.ASC, "AcBookCode", "AcSubBookCode", "BranchNo", "CurrencyCode", "AcNoCode", "AcSubCode", "AcDtlCode", "AcDate"));
    else
  ...
  public Slice<AcMain> acmainAcDateRange(String acBookCode_0, String branchNo_1, String currencyCode_2, String acNoCode_3, String acSubCode_4, String acDtlCode_5, int acDate_6, int acDate_7, int index, int limit, TitaVo... titaVo) {
    ...
    this.info("acmainAcDateRange " + dbName + " : " + "acBookCode_0 : " + acBookCode_0 + " branchNo_1 : " +  branchNo_1 + " currencyCode_2 : " +  currencyCode_2 + " acNoCode_3 : " +  acNoCode_3 + " acSubCode_4 : " +  acSubCode_4 + " acDtlCode_5 : " +  acDtlCode_5 + " acDate_6 : " +  acDate_6 + " acDate_7 : " +  acDate_7);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<AcMain> acmainAcCodeRange(String acBookCode_0, String branchNo_1, String currencyCode_2, int acDate_3, String acNoCode_4, String acNoCode_5, String acSubCode_6, String acSubCode_7, String acDtlCode_8, String acDtlCode_9, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("acmainAcCodeRange " + dbName + " : " + "acBookCode_0 : " + acBookCode_0 + " branchNo_1 : " +  branchNo_1 + " currencyCode_2 : " +  currencyCode_2 + " acDate_3 : " +  acDate_3 + " acNoCode_4 : " +  acNoCode_4 + " acNoCode_5 : " +  acNoCode_5 + " acSubCode_6 : " +  acSubCode_6 + " acSubCode_7 : " +  acSubCode_7 + " acDtlCode_8 : " +  acDtlCode_8 + " acDtlCode_9 : " +  acDtlCode_9);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<AcMain> acmainAcBookCodeRange(String acBookCode_0, String acSubBookCode_1, String branchNo_2, String currencyCode_3, String acNoCode_4, String acSubCode_5, String acDtlCode_6, int acDate_7, int acDate_8, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("acmainAcBookCodeRange " + dbName + " : " + "acBookCode_0 : " + acBookCode_0 + " acSubBookCode_1 : " +  acSubBookCode_1 + " branchNo_2 : " +  branchNo_2 + " currencyCode_3 : " +  currencyCode_3 + " acNoCode_4 : " +  acNoCode_4 + " acSubCode_5 : " +  acSubCode_5 + " acDtlCode_6 : " +  acDtlCode_6 + " acDate_7 : " +  acDate_7 + " acDate_8 : " +  acDate_8);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<AcMain> acmainAcDateEq(int acDate_0, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("acmainAcDateEq " + dbName + " : " + "acDate_0 : " + acDate_0);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<AcMain> acctCodeEq(int acDate_0, String acctCode_1, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("acctCodeEq " + dbName + " : " + "acDate_0 : " + acDate_0 + " acctCode_1 : " +  acctCode_1);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<AcMain> acmainAcBookCodeRange2(String acBookCode_0, String acSubBookCode_1, String branchNo_2, String currencyCode_3, String acNoCode_4, String acSubCode_5, int acDate_6, int acDate_7, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("acmainAcBookCodeRange2 " + dbName + " : " + "acBookCode_0 : " + acBookCode_0 + " acSubBookCode_1 : " +  acSubBookCode_1 + " branchNo_2 : " +  branchNo_2 + " currencyCode_3 : " +  currencyCode_3 + " acNoCode_4 : " +  acNoCode_4 + " acSubCode_5 : " +  acSubCode_5 + " acDate_6 : " +  acDate_6 + " acDate_7 : " +  acDate_7);
    if (dbName.equals(ContentName.onDay))
      slice = acMainReposDay.findAllByAcBookCodeIsAndAcSubBookCodeLikeAndBranchNoIsAndCurrencyCodeIsAndAcNoCodeIsAndAcSubCodeIsAndAcDateGreaterThanEqualAndAcDateLessThanEqualOrderByAcDateAscAcSubBookCodeAscAcNoCodeAsc(acBookCode_0, acSubBookCode_1, branchNo_2, currencyCode_3, acNoCode_4, acSubCode_5, acDate_6, acDate_7, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = acMainReposMon.findAllByAcBookCodeIsAndAcSubBookCodeLikeAndBranchNoIsAndCurrencyCodeIsAndAcNoCodeIsAndAcSubCodeIsAndAcDateGreaterThanEqualAndAcDateLessThanEqualOrderByAcDateAscAcSubBookCodeAscAcNoCodeAsc(acBookCode_0, acSubBookCode_1, branchNo_2, currencyCode_3, acNoCode_4, acSubCode_5, acDate_6, acDate_7, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = acMainReposHist.findAllByAcBookCodeIsAndAcSubBookCodeLikeAndBranchNoIsAndCurrencyCodeIsAndAcNoCodeIsAndAcSubCodeIsAndAcDateGreaterThanEqualAndAcDateLessThanEqualOrderByAcDateAscAcSubBookCodeAscAcNoCodeAsc(acBookCode_0, acSubBookCode_1, branchNo_2, currencyCode_3, acNoCode_4, acSubCode_5, acDate_6, acDate_7, pageable);
    else 
      slice = acMainRepos.findAllByAcBookCodeIsAndAcSubBookCodeLikeAndBranchNoIsAndCurrencyCodeIsAndAcNoCodeIsAndAcSubCodeIsAndAcDateGreaterThanEqualAndAcDateLessThanEqualOrderByAcDateAscAcSubBookCodeAscAcNoCodeAsc(acBookCode_0, acSubBookCode_1, branchNo_2, currencyCode_3, acNoCode_4, acSubCode_5, acDate_6, acDate_7, pageable);
  ...
  @Override
  public Slice<AcMain> acmainAcBookCodeRange3(String acBookCode_0, String acSubBookCode_1, String branchNo_2, String currencyCode_3, int acDate_4, int acDate_5, int index, int limit, TitaVo... titaVo) {
    String dbName = "";
    Slice<AcMain> slice = null;
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("acmainAcBookCodeRange3 " + dbName + " : " + "acBookCode_0 : " + acBookCode_0 + " acSubBookCode_1 : " +  acSubBookCode_1 + " branchNo_2 : " +  branchNo_2 + " currencyCode_3 : " +  currencyCode_3 + " acDate_4 : " +  acDate_4 + " acDate_5 : " +  acDate_5);
    if (dbName.equals(ContentName.onDay))
      slice = acMainReposDay.findAllByAcBookCodeIsAndAcSubBookCodeLikeAndBranchNoIsAndCurrencyCodeIsAndAcDateGreaterThanEqualAndAcDateLessThanEqualOrderByAcDateAscAcSubBookCodeAscAcNoCodeAsc(acBookCode_0, acSubBookCode_1, branchNo_2, currencyCode_3, acDate_4, acDate_5, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = acMainReposMon.findAllByAcBookCodeIsAndAcSubBookCodeLikeAndBranchNoIsAndCurrencyCodeIsAndAcDateGreaterThanEqualAndAcDateLessThanEqualOrderByAcDateAscAcSubBookCodeAscAcNoCodeAsc(acBookCode_0, acSubBookCode_1, branchNo_2, currencyCode_3, acDate_4, acDate_5, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = acMainReposHist.findAllByAcBookCodeIsAndAcSubBookCodeLikeAndBranchNoIsAndCurrencyCodeIsAndAcDateGreaterThanEqualAndAcDateLessThanEqualOrderByAcDateAscAcSubBookCodeAscAcNoCodeAsc(acBookCode_0, acSubBookCode_1, branchNo_2, currencyCode_3, acDate_4, acDate_5, pageable);
    else 
      slice = acMainRepos.findAllByAcBookCodeIsAndAcSubBookCodeLikeAndBranchNoIsAndCurrencyCodeIsAndAcDateGreaterThanEqualAndAcDateLessThanEqualOrderByAcDateAscAcSubBookCodeAscAcNoCodeAsc(acBookCode_0, acSubBookCode_1, branchNo_2, currencyCode_3, acDate_4, acDate_5, pageable);
  ...
  public AcMain holdById(AcMainId acMainId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("Hold " + dbName + " " + acMainId);
    Optional<AcMain> acMain = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public AcMain holdById(AcMain acMain, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("Hold " + dbName + " " + acMain.getAcMainId());
  ...
  public AcMain insert(AcMain acMain, TitaVo... titaVo) throws DBException {
    ...
    this.info("Insert..." + dbName + " " + acMain.getAcMainId());
    if (this.findById(acMain.getAcMainId(), titaVo) != null)
  ...
  public AcMain update(AcMain acMain, TitaVo... titaVo) throws DBException {
    ...
    this.info("Update..." + dbName + " " + acMain.getAcMainId());
    if (!empNot.isEmpty())
      acMain.setLastUpdateEmpNo(empNot);
  ...
  public void delete(AcMain acMain, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("Delete..." + dbName + " " + acMain.getAcMainId());
    if (dbName.equals(ContentName.onDay)) {
