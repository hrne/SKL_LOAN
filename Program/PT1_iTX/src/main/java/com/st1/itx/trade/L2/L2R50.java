...
public class L2R50 extends TradeBuffer {
	...
	public ArrayList<TotaVo> run(TitaVo titaVo) throws LogicException {
		...
		this.totaVo.putParam("L2r50ApprovedLevel", "");
		...
		if (tFacMain != null) {
			...
			this.totaVo.putParam("L2r50ProdNo", tFacMain.getProdNo());
			...
			this.totaVo.putParam("L2r50CurrencyCode", tFacMain.getCurrencyCode());
			this.totaVo.putParam("L2r50LineAmt", tFacMain.getLineAmt());
			...
			this.totaVo.putParam("L2r50Introducer", tFacMain.getIntroducer());
			this.totaVo.putParam("L2r50District", tFacMain.getDistrict());
			this.totaVo.putParam("L2r50FireOfficer", tFacMain.getFireOfficer());
			this.totaVo.putParam("L2r50Estimate", tFacMain.getEstimate());
			this.totaVo.putParam("L2r50CreditOfficer", tFacMain.getCreditOfficer());
			this.totaVo.putParam("L2r50LoanOfficer", tFacMain.getLoanOfficer());
			this.totaVo.putParam("L2r50BusinessOfficer", tFacMain.getBusinessOfficer());
			this.totaVo.putParam("L2r50ApprovedLevel", tFacMain.getApprovedLevel());
			this.totaVo.putParam("L2r50Supervisor", tFacMain.getSupervisor());
			this.totaVo.putParam("L2r50Coorgnizer", tFacMain.getCoorgnizer());
