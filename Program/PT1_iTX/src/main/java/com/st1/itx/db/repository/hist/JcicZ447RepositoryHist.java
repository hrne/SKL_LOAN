 ...
 * @version 1.0.0
 */
public interface JcicZ447RepositoryHist extends JpaRepository<JcicZ447, JcicZ447Id> {
	...
	public Slice<JcicZ447> findAllBySubmitKeyIsAndCustIdIsAndApplyDateIsAndCourtCodeIsOrderByCreateDateDesc(String submitKey_0, String custId_1, int applyDate_2, String courtCode_3,
			Pageable pageable);
