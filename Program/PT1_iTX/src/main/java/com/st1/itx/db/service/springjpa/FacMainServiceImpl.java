...
public class FacMainServiceImpl extends ASpringJpaParm implements FacMainService, InitializingBean {
	...
	public Slice<FacMain> facmCustNoRange(int custNo_0, int custNo_1, int facmNo_2, int facmNo_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = facMainReposDay.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCustNoAscFacmNoAsc(custNo_0, custNo_1, facmNo_2,
					facmNo_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = facMainReposMon.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCustNoAscFacmNoAsc(custNo_0, custNo_1, facmNo_2,
					facmNo_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = facMainReposHist.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCustNoAscFacmNoAsc(custNo_0, custNo_1, facmNo_2,
					facmNo_3, pageable);
		else
			slice = facMainRepos.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCustNoAscFacmNoAsc(custNo_0, custNo_1, facmNo_2, facmNo_3,
					pageable);
	...
	public Slice<FacMain> facmApplNoRange(int applNo_0, int applNo_1, int facmNo_2, int facmNo_3, String colSetFlag_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info(
				"facmApplNoRange " + dbName + " : " + "applNo_0 : " + applNo_0 + " applNo_1 : " + applNo_1 + " facmNo_2 : " + facmNo_2 + " facmNo_3 : " + facmNo_3 + " colSetFlag_4 : " + colSetFlag_4);
		if (dbName.equals(ContentName.onDay))
			slice = facMainReposDay.findAllByApplNoGreaterThanEqualAndApplNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndColSetFlagLikeOrderByApplNoAscFacmNoAsc(applNo_0, applNo_1,
					facmNo_2, facmNo_3, colSetFlag_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = facMainReposMon.findAllByApplNoGreaterThanEqualAndApplNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndColSetFlagLikeOrderByApplNoAscFacmNoAsc(applNo_0, applNo_1,
					facmNo_2, facmNo_3, colSetFlag_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = facMainReposHist.findAllByApplNoGreaterThanEqualAndApplNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndColSetFlagLikeOrderByApplNoAscFacmNoAsc(applNo_0, applNo_1,
					facmNo_2, facmNo_3, colSetFlag_4, pageable);
		else
			slice = facMainRepos.findAllByApplNoGreaterThanEqualAndApplNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndColSetFlagLikeOrderByApplNoAscFacmNoAsc(applNo_0, applNo_1,
					facmNo_2, facmNo_3, colSetFlag_4, pageable);
	...
	public Slice<FacMain> facmCreditSysNoRange(int creditSysNo_0, int creditSysNo_1, int facmNo_2, int facmNo_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = facMainReposDay.findAllByCreditSysNoGreaterThanEqualAndCreditSysNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCreditSysNoAscFacmNoAsc(creditSysNo_0,
					creditSysNo_1, facmNo_2, facmNo_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = facMainReposMon.findAllByCreditSysNoGreaterThanEqualAndCreditSysNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCreditSysNoAscFacmNoAsc(creditSysNo_0,
					creditSysNo_1, facmNo_2, facmNo_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = facMainReposHist.findAllByCreditSysNoGreaterThanEqualAndCreditSysNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCreditSysNoAscFacmNoAsc(creditSysNo_0,
					creditSysNo_1, facmNo_2, facmNo_3, pageable);
		else
			slice = facMainRepos.findAllByCreditSysNoGreaterThanEqualAndCreditSysNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCreditSysNoAscFacmNoAsc(creditSysNo_0,
					creditSysNo_1, facmNo_2, facmNo_3, pageable);
	...
	public FacMain facmCreditSysNoFirst(int creditSysNo_0, int creditSysNo_1, int facmNo_2, int facmNo_3, TitaVo... titaVo) {
		...
		Optional<FacMain> facMainT = null;
		if (dbName.equals(ContentName.onDay))
			facMainT = facMainReposDay.findTopByCreditSysNoGreaterThanEqualAndCreditSysNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCreditSysNoAscFacmNoAsc(creditSysNo_0,
					creditSysNo_1, facmNo_2, facmNo_3);
		else if (dbName.equals(ContentName.onMon))
			facMainT = facMainReposMon.findTopByCreditSysNoGreaterThanEqualAndCreditSysNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCreditSysNoAscFacmNoAsc(creditSysNo_0,
					creditSysNo_1, facmNo_2, facmNo_3);
		else if (dbName.equals(ContentName.onHist))
			facMainT = facMainReposHist.findTopByCreditSysNoGreaterThanEqualAndCreditSysNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCreditSysNoAscFacmNoAsc(creditSysNo_0,
					creditSysNo_1, facmNo_2, facmNo_3);
		else
			facMainT = facMainRepos.findTopByCreditSysNoGreaterThanEqualAndCreditSysNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCreditSysNoAscFacmNoAsc(creditSysNo_0,
					creditSysNo_1, facmNo_2, facmNo_3);
	...
	public Slice<FacMain> facmCreditOfficerRange(String creditOfficer_0, String creditOfficer_1, int facmNo_2, int facmNo_3, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info(
				"facmCreditOfficerRange " + dbName + " : " + "creditOfficer_0 : " + creditOfficer_0 + " creditOfficer_1 : " + creditOfficer_1 + " facmNo_2 : " + facmNo_2 + " facmNo_3 : " + facmNo_3);
		if (dbName.equals(ContentName.onDay))
			slice = facMainReposDay.findAllByCreditOfficerGreaterThanEqualAndCreditOfficerLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCustNoAscFacmNoAsc(creditOfficer_0,
					creditOfficer_1, facmNo_2, facmNo_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = facMainReposMon.findAllByCreditOfficerGreaterThanEqualAndCreditOfficerLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCustNoAscFacmNoAsc(creditOfficer_0,
					creditOfficer_1, facmNo_2, facmNo_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = facMainReposHist.findAllByCreditOfficerGreaterThanEqualAndCreditOfficerLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCustNoAscFacmNoAsc(creditOfficer_0,
					creditOfficer_1, facmNo_2, facmNo_3, pageable);
		else
			slice = facMainRepos.findAllByCreditOfficerGreaterThanEqualAndCreditOfficerLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCustNoAscFacmNoAsc(creditOfficer_0,
					creditOfficer_1, facmNo_2, facmNo_3, pageable);
	...
	public Slice<FacMain> facmBusinessOfficerRange(String businessOfficer_0, String businessOfficer_1, int facmNo_2, int facmNo_3, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("facmBusinessOfficerRange " + dbName + " : " + "businessOfficer_0 : " + businessOfficer_0 + " businessOfficer_1 : " + businessOfficer_1 + " facmNo_2 : " + facmNo_2 + " facmNo_3 : "
				+ facmNo_3);
		if (dbName.equals(ContentName.onDay))
			slice = facMainReposDay.findAllByBusinessOfficerGreaterThanEqualAndBusinessOfficerLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCustNoAscFacmNoAsc(businessOfficer_0,
					businessOfficer_1, facmNo_2, facmNo_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = facMainReposMon.findAllByBusinessOfficerGreaterThanEqualAndBusinessOfficerLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCustNoAscFacmNoAsc(businessOfficer_0,
					businessOfficer_1, facmNo_2, facmNo_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = facMainReposHist.findAllByBusinessOfficerGreaterThanEqualAndBusinessOfficerLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCustNoAscFacmNoAsc(businessOfficer_0,
					businessOfficer_1, facmNo_2, facmNo_3, pageable);
		else
			slice = facMainRepos.findAllByBusinessOfficerGreaterThanEqualAndBusinessOfficerLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByCustNoAscFacmNoAsc(businessOfficer_0,
					businessOfficer_1, facmNo_2, facmNo_3, pageable);
	...
	@Override
	public FacMain findLastFacmNoFirst(int custNo_0, TitaVo... titaVo) {
		String dbName = "";
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("findLastFacmNoFirst " + dbName + " : " + "custNo_0 : " + custNo_0);
		Optional<FacMain> facMainT = null;
		if (dbName.equals(ContentName.onDay))
			facMainT = facMainReposDay.findTopByCustNoIsOrderByCustNoAscFacmNoDesc(custNo_0);
		else if (dbName.equals(ContentName.onMon))
			facMainT = facMainReposMon.findTopByCustNoIsOrderByCustNoAscFacmNoDesc(custNo_0);
		else if (dbName.equals(ContentName.onHist))
			facMainT = facMainReposHist.findTopByCustNoIsOrderByCustNoAscFacmNoDesc(custNo_0);
		else
			facMainT = facMainRepos.findTopByCustNoIsOrderByCustNoAscFacmNoDesc(custNo_0);
	...
	public FacMain insert(FacMain facMain, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(facMain.getFacMainId(), titaVo) != null)
