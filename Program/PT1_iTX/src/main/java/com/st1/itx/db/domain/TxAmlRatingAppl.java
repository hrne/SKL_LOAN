...
/**
 * TxAmlRatingAppl Eloan評級案件申請留存檔<br>
 * Gen By Tool
 * 
 * @author AdamPan
 * @version 1.0.0
...
@Table(name = "`TxAmlRatingAppl`")
public class TxAmlRatingAppl implements Serializable {


  /**
	 * 
	 */
	private static final long serialVersionUID = -9016683136285059836L;

// 序號
  @Id
  @Column(name = "`LogNo`")
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "`TxAmlRatingAppl_SEQ`")
  @SequenceGenerator(name = "`TxAmlRatingAppl_SEQ`", sequenceName = "`TxAmlRatingAppl_SEQ`", allocationSize = 1)
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "TxAmlRatingAppl [logNo=" + logNo + ", unit=" + unit + ", acceptanceUnit=" + acceptanceUnit + ", roleId=" + roleId + ", transactionId=" + transactionId + ", acctNo=" + acctNo
