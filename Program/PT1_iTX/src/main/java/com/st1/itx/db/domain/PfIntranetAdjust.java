...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "PfIntranetAdjust [logNo=" + logNo + ", custNo=" + custNo + ", facmNo=" + facmNo + ", bormNo=" + bormNo + ", perfDate=" + perfDate + ", workMonth=" + workMonth
           + ", workSeason=" + workSeason + ", introducer=" + introducer + ", bsOfficer=" + bsOfficer + ", perfAmt=" + perfAmt + ", perfCnt=" + perfCnt + ", unitType=" + unitType
           + ", unitCode=" + unitCode + ", distCode=" + distCode + ", deptCode=" + deptCode + ", sumAmt=" + sumAmt + ", sumCnt=" + sumCnt + ", createDate=" + createDate
