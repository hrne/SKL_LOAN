 ...
 * @version 1.0.0
 */
public interface MonthlyLM052OvduRepositoryDay extends JpaRepository<MonthlyLM052Ovdu, MonthlyLM052OvduId> {
  ...
  public void uspL9Monthlylm052ovduIns(int tbsdyf,  String empNo,  String jobTxSeq);
