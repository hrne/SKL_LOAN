 ...
 * @version 1.0.0
 */
public interface JcicZ040RepositoryHist extends JpaRepository<JcicZ040, JcicZ040Id> {
  ...
  public Slice<JcicZ040> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
