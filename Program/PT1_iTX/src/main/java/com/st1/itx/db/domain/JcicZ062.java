...
public class JcicZ062 implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -467136290012402197L;
	...
	public String toString() {
		return "JcicZ062 [jcicZ062Id=" + jcicZ062Id + ", tranKey=" + tranKey + ", completePeriod=" + completePeriod + ", period=" + period + ", rate=" + rate + ", expBalanceAmt=" + expBalanceAmt
				+ ", cashBalanceAmt=" + cashBalanceAmt + ", creditBalanceAmt=" + creditBalanceAmt + ", chaRepayAmt=" + chaRepayAmt + ", chaRepayAgreeDate=" + chaRepayAgreeDate + ", chaRepayViewDate="
				+ chaRepayViewDate + ", chaRepayEndDate=" + chaRepayEndDate + ", chaRepayFirstDate=" + chaRepayFirstDate + ", payAccount=" + payAccount + ", postAddr=" + postAddr + ", monthPayAmt="
				+ monthPayAmt + ", gradeType=" + gradeType + ", period2=" + period2 + ", rate2=" + rate2 + ", monthPayAmt2=" + monthPayAmt2 + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey
				+ ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + ", actualFilingDate=" + actualFilingDate
