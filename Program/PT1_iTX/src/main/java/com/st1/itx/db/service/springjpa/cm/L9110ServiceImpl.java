...
public class L9110ServiceImpl extends ASpringJpaParm implements InitializingBean {
	...
	public List<Map<String, String>> queryBuildingLand(TitaVo titaVo, String applNo) throws Exception {
		...
		sql += " SELECT ";
		sql += " \"Seq\" AS \"F0Seq\",  ";
		sql += " \"BdLandItem\"              AS \"F1類別\",  ";
		sql += " \"ClSeq\"  AS \"F2ClSeq\", ";
		sql += " CASE WHEN \"Seq\" = 1 THEN \"ClItem\" ELSE ' ' END                 AS \"F3擔保品別\"     , ";
		sql += " CASE WHEN \"BdLandItem\" = 2 THEN  TO_CHAR(\"LandSeq\") ELSE ' '  END               AS \"F4LandSeq\",  ";
		sql += " CASE WHEN \"BdLandItem\" = 1 THEN \"ClCode1\" ||'-'|| \"ClCode2\" ||'-'|| \"ClNo\"      ";
		sql += " 	  WHEN \"ClCode1\" 	  = 2 THEN \"ClCode1\" ||'-'|| \"ClCode2\" ||'-'|| \"ClNo\"  ELSE ' ' END     AS \"F5擔保品號碼\" ,  ";
		sql += " \"Owner\"                   AS \"F6擔保品提供人\",  ";
		sql += " \"Location\"                AS \"F7門牌坐落\",  ";
		sql += " CASE WHEN \"BdLandItem\" =1 THEN \"BdNo\"   ";
		sql += "      WHEN \"BdLandItem\" =2 THEN  \"LandLandNo\" ELSE ' ' END AS \"F8土地及主建物建號\",  ";
		sql += " \"BdPublicDdNo\"            AS \"F9公社建號\",   ";
		sql += " CASE WHEN \"BdLandItem\" = 1 AND \"ClSeq\" = 1 THEN \"BdArea\"   ";
		sql += "      WHEN \"BdLandItem\" = 2 THEN \"LandArea\" ELSE ' '  END AS \"F10土地及主建物面積\",   ";
		sql += " CASE WHEN \"BdLandItem\" = 1 AND \"ClSeq\" = 1 THEN  \"BdSubArea\" ELSE ' ' END AS \"F11附屬建物\",  ";
		sql += " CASE WHEN \"BdLandItem\" = 1 AND \"ClSeq\" = 1 THEN  \"BdPublicArea\"  ELSE ' ' END AS \"F12公設面積\",  ";
		sql += " CASE WHEN \"BdLandItem\" = 1 AND \"ClSeq\" = 1 THEN  \"BdParkingArea\" ELSE ' ' END AS \"F13車位\",  ";
		sql += " CASE WHEN \"BdLandItem\" = 1 AND \"ClSeq\" = 1 THEN  \"SettingAmt\"   ";
		sql += "      WHEN \"BdLandItem\" = 2 THEN \"SettingAmt\" ELSE ' ' END  AS \"F14設定金額\",  ";
		sql += " \"BdEvaunitprice\"          AS \"F15鑑定單價\",  ";
		sql += " \"BdSellerName\"            AS \"F16賣方姓名\",  ";
		sql += " \"BdSellerId\"              AS \"F17賣方ID\",  ";
		sql += " \"LandCityItem\"            AS \"F18土地縣市\",  ";
		sql += " \"LandAreaItem\"            AS \"F19土地鄉鎮區\",  ";
		sql += " \"LandIrItem\"              AS \"F20土地段小段\",  ";
		sql += " \"LandLandNo\"              AS \"F21土地地號\",  ";
		sql += " \"LandTransFeredYear\"      AS \"F22土地年度\",  ";
		sql += " \"LandLastTransferedAmt\"   AS \"F23土地前次移轉\",  ";
		sql += " \"LandEvaunitprice\"        AS \"F24土地鑑定單價\",  ";
		sql += " \"LandOwnerPart\"           AS \"F25土地持份比例\",  ";
		sql += " \"LandOwnerTotal\"          AS \"F26土地持份總比例\",  ";
		sql += " \"LandClItem\"              AS \"F27土地擔保品別\",  ";
		sql += " \"Cnt\"                     AS \"F28筆數\",  ";
		sql += " \"TotalLandArea\"           AS \"F29土地總面積\"  ";
		sql += " FROM (SELECT  ";
		sql += " ROW_NUMBER() OVER(  ";
		...
		sql += " ) AS \"Seq\",  ";
		sql += " s1.\"BdNo\"                    AS \"BdNo\",  ";
		sql += " s1.\"Owner\"                   AS \"Owner\",  ";
		sql += " s1.\"Location\"                AS \"Location\",  ";
		sql += " s1.\"ClItem\"                  AS \"ClItem\",  ";
		sql += " s1.\"BdPublicDdNo\"            AS \"BdPublicDdNo\",  ";
		sql += " TO_CHAR(s1.\"BdArea\") AS \"BdArea\",  ";
		sql += " TO_CHAR(s1.\"BdSubArea\") AS \"BdSubArea\",  ";
		sql += " TO_CHAR(s1.\"BdPublicArea\") AS \"BdPublicArea\",  ";
		sql += " TO_CHAR(s1.\"BdParkingArea\") AS \"BdParkingArea\",  ";
		sql += " TO_CHAR(s1.\"SettingAmt\")     AS \"SettingAmt\",   ";
		sql += " CASE 	 WHEN s1.\"BdLandItem\" = 2 THEN  TO_CHAR(s1.\"LandArea\") ELSE ' ' END AS \"LandArea\"  ";
		sql += " ,S1.\"ClCode1\" AS \"ClCode1\"    ";
		sql += " ,S1.\"ClCode2\" AS \"ClCode2\"    ";
		sql += " ,S1.\"ClNo\" AS \"ClNo\"    ";
		...
		sql += " ,S1.\"LandLandNo\" AS \"LandLandNo\"   ";
		sql += " ,S1.\"LandTransFeredYear\" AS \"LandTransFeredYear\"   ";
		sql += " ,S1.\"LandLastTransferedAmt\" AS \"LandLastTransferedAmt\"   ";
		sql += " ,S1.\"LandEvaunitprice\" AS \"LandEvaunitprice\"  ";
		sql += " ,S1.\"LandOwnerPart\" AS \"LandOwnerPart\"    ";
		sql += " ,S1.\"LandOwnerTotal\" AS \"LandOwnerTotal\"    ";
		sql += " ,S1.\"LandClItem\" AS \"LandClItem\"  ";
		sql += " ,S1.\"BdLandItem\" AS \"BdLandItem\"  ";
		sql += " ,S1.\"Cnt\" AS \"Cnt\"  ";
		sql += " ,S1.\"TotalLandArea\" AS \"TotalLandArea\"  ";
		sql += " ,ROW_NUMBER() OVER(  ";
		sql += "     PARTITION BY s1.\"ClCode1\", s1.\"ClCode2\", s1.\"ClNo\",s1.\"LandSeq\"  ";
		sql += "     ORDER BY  ";
		sql += "         s1.\"LandSeq\" ASC  ";
		sql += " ) AS \"ClSeq\"  ";
		sql += " FROM ";
		...
		sql += "             LEFT JOIN \"CdCode\"       cdc1 ON cdc1.\"DefCode\" = 'ClCode2' || cf.\"ClCode1\" ";
		sql += "                                        AND cdc1.\"Code\" = lpad(cf.\"ClCode2\", 2, '0') ";
		sql += "             LEFT JOIN (SELECT SUM(1)  AS \"Cnt\" ";
		sql += "             		, cbd1.\"ClCode1\" AS \"ClCode1\" ";
		sql += "             		, cbd1.\"ClCode2\" AS \"ClCode2\" ";
		sql += "             		, cbd1.\"ClNo\" AS \"ClNo\" ";
		sql += " 					FROM \"ClBuilding\" cbd1				";
		sql += " 					GROUP BY cbd1.\"ClCode1\" 				";
		sql += " 							,cbd1.\"ClCode2\" 				";
		sql += " 							,cbd1.\"ClNo\" ) cbd1 ON cbd1.\"ClCode1\" = cf.\"ClCode1\" ";
		sql += "                                            	 AND cbd1.\"ClCode2\" = cf.\"ClCode2\" ";
		sql += "                                            	 AND cbd1.\"ClNo\" 		= cf.\"ClNo\"  ";
		sql += "         WHERE ";
		...
		sql += "             cli.\"SettingAmt\"/l1.\"Cnt\"        AS \"SettingAmt\", ";
		...
		sql += "                                        AND cdc1.\"Code\" = lpad(cf.\"ClCode2\", 2, '0') ";
		sql += "             LEFT JOIN (SELECT SUM(1)  AS \"Cnt\" ";
		sql += "             		, l1.\"ClCode1\" AS \"ClCode1\" ";
		sql += "             		, l1.\"ClCode2\" AS \"ClCode2\" ";
		sql += "             		, l1.\"ClNo\" AS \"ClNo\" ";
		sql += " 					FROM \"ClLand\" l1				";
		sql += " 					GROUP BY l1.\"ClCode1\" 				";
		sql += " 							,l1.\"ClCode2\" 				";
		sql += " 							,l1.\"ClNo\" ) l1 ON l1.\"ClCode1\" = cf.\"ClCode1\" ";
