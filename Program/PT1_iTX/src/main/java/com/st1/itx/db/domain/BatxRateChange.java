...
public class BatxRateChange implements Serializable {
  ...
  // 調整記號
  /* 1:批次自動調整2:按地區別調整3:人工調整_按合約4.人工調整_按地區別8.確認失敗件9.檢核提醒件 */
  @Column(name = "`AdjCode`")
  ...
  // 加碼值
  /* 自訂利率時：0指標利率時：擬調利率(已調整時為調整後利率)減指標利率 */
...
/**
	...
	* 調整後之下次利率調整日
  *
  * @param preNextAdjDate 預定下次利率調整日
  * @throws LogicException when Date Is Warn	*/
...
/**
	...
	* 
  *
  * @param preNextAdjFreq 預定下次利率調整週期
	*/
