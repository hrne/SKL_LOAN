...
@Table(name = "`LoanBorHistory`")
public class LoanBorHistory implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3688904014661938469L;

	@EmbeddedId
	private LoanBorHistoryId loanBorHistoryId;
	...
	// 戶況
	/*
	 * 0: 正常戶1:展期2: 催收戶3: 結案戶4: 逾期戶5: 催收結案戶6: 呆帳戶7: 部分轉呆戶8: 債權轉讓戶9:
	 * 呆帳結案戶97:預約撥款已刪除98:預約已撥款99:預約撥款
	 */
	@Column(name = "`Status`")
	...
	// 計件代碼
	/*
	 * 共用代碼檔A: 新貸件B: 其他額度C: 原額度D: 新增額度E: 展期1: 新貸件2: 其他額度3: 原額度4: 新增額度5: 展期件6:
	 * 六個月動支7: 服務件8: 特殊件9: 固特利契轉
	 */
	@Column(name = "`PieceCode`", length = 1)
	private String pieceCode;

	// 用途別
	/* 共用代碼檔1: 週轉金2: 購置不動產3: 營業用資產4: 固定資產5: 企業投資6: 購置動產9: 其他 */
	...
	public LoanBorHistoryId getLoanBorHistoryId() {
		return this.loanBorHistoryId;
	}

	public void setLoanBorHistoryId(LoanBorHistoryId loanBorHistoryId) {
		this.loanBorHistoryId = loanBorHistoryId;
	}
	...
	/**
	 * 計件代碼<br>
	 * 共用代碼檔 A: 新貸件 B: 其他額度 C: 原額度 D: 新增額度 E: 展期 1: 新貸件 2: 其他額度 3: 原額度 4: 新增額度 5:
	 * 展期件 6: 六個月動支 7: 服務件 8: 特殊件 9: 固特利契轉
	 * 
	 * @return String
	 */
	...
	/**
	 * 用途別<br>
	 * 共用代碼檔 1: 週轉金 2: 購置不動產 3: 營業用資產 4: 固定資產 5: 企業投資 6: 購置動產 9: 其他
	 * 
	 * @return String
	 */
	...
	/**
	 * 與借款人關係<br>
	 * 共用代碼檔 00:本人 01: 夫 02: 妻 03: 父 04: 母 05: 子 06: 女 07: 兄 08: 弟 09: 姊 10: 妹 11:
	 * 姪子 99: 其他
	 * 
	 * @return String
	 */
	...
	/**
	 * 交易進行記號<br>
	 * 1STEP TX -&amp;gt; 0 2STEP TX -&amp;gt; 5 6 3STEP TX -&amp;gt; 1 2 3 4
	 * 
	 * @return Integer
	 */
	public int getActFg() {
	...
	public String toString() {
		return "LoanBorHistory [loanBorHistoryId=" + loanBorHistoryId + ", lastBorxNo=" + lastBorxNo + ", lastOvduNo=" + lastOvduNo + ", status=" + status + ", rateIncr=" + rateIncr
				+ ", individualIncr=" + individualIncr + ", approveRate=" + approveRate + ", storeRate=" + storeRate + ", rateCode=" + rateCode + ", rateAdjFreq=" + rateAdjFreq + ", drawdownCode="
				+ drawdownCode + ", currencyCode=" + currencyCode + ", drawdownAmt=" + drawdownAmt + ", loanBal=" + loanBal + ", drawdownDate=" + drawdownDate + ", loanTermYy=" + loanTermYy
				+ ", loanTermMm=" + loanTermMm + ", loanTermDd=" + loanTermDd + ", maturityDate=" + maturityDate + ", intCalcCode=" + intCalcCode + ", amortizedCode=" + amortizedCode + ", freqBase="
				+ freqBase + ", payIntFreq=" + payIntFreq + ", repayFreq=" + repayFreq + ", totalPeriod=" + totalPeriod + ", repaidPeriod=" + repaidPeriod + ", paidTerms=" + paidTerms
				+ ", prevPayIntDate=" + prevPayIntDate + ", prevRepaidDate=" + prevRepaidDate + ", nextPayIntDate=" + nextPayIntDate + ", nextRepayDate=" + nextRepayDate + ", dueAmt=" + dueAmt
				+ ", gracePeriod=" + gracePeriod + ", graceDate=" + graceDate + ", specificDd=" + specificDd + ", specificDate=" + specificDate + ", firstDueDate=" + firstDueDate
				+ ", firstAdjRateDate=" + firstAdjRateDate + ", nextAdjRateDate=" + nextAdjRateDate + ", acctFee=" + acctFee + ", finalBal=" + finalBal + ", notYetFlag=" + notYetFlag + ", renewFlag="
				+ renewFlag + ", pieceCode=" + pieceCode + ", usageCode=" + usageCode + ", syndNo=" + syndNo + ", relationCode=" + relationCode + ", relationName=" + relationName + ", relationId="
				+ relationId + ", relationBirthday=" + relationBirthday + ", relationGender=" + relationGender + ", actFg=" + actFg + ", lastEntDy=" + lastEntDy + ", lastKinbr=" + lastKinbr
				+ ", lastTlrNo=" + lastTlrNo + ", lastTxtNo=" + lastTxtNo + ", remitBank=" + remitBank + ", remitBranch=" + remitBranch + ", remitAcctNo=" + remitAcctNo + ", compensateAcct="
				+ compensateAcct + ", paymentBank=" + paymentBank + ", remark=" + remark + ", acDate=" + acDate + ", nextAcDate=" + nextAcDate + ", branchNo=" + branchNo + ", createDate=" + createDate
