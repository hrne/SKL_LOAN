...
public class LM014Report extends MakeReport {
	...
	private enum ReportType {
		All("總表", EntCodeCondition.All, DepartmentCodeCondition.All), Enterprise("企金", EntCodeCondition.Enterprise, DepartmentCodeCondition.All),
		Natural("房貸", EntCodeCondition.Natural, DepartmentCodeCondition.All), IsDepartment("企金通路", EntCodeCondition.All, DepartmentCodeCondition.Yes),
