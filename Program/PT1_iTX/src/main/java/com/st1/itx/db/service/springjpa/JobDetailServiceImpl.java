...
em = null;
  ...
  @Override
  public Slice<JobDetail> findExecDateIn(String jobCode_0, int execDate_1, int execDate_2, int index, int limit, TitaVo... titaVo) {
    String dbName = "";
    Slice<JobDetail> slice = null;
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("findExecDateIn " + dbName + " : " + "jobCode_0 : " + jobCode_0 + " execDate_1 : " +  execDate_1 + " execDate_2 : " +  execDate_2);
    if (dbName.equals(ContentName.onDay))
      slice = jobDetailReposDay.findAllByJobCodeIsAndExecDateGreaterThanEqualAndExecDateLessThanEqualOrderByStepStartTimeDesc(jobCode_0, execDate_1, execDate_2, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = jobDetailReposMon.findAllByJobCodeIsAndExecDateGreaterThanEqualAndExecDateLessThanEqualOrderByStepStartTimeDesc(jobCode_0, execDate_1, execDate_2, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = jobDetailReposHist.findAllByJobCodeIsAndExecDateGreaterThanEqualAndExecDateLessThanEqualOrderByStepStartTimeDesc(jobCode_0, execDate_1, execDate_2, pageable);
    else 
      slice = jobDetailRepos.findAllByJobCodeIsAndExecDateGreaterThanEqualAndExecDateLessThanEqualOrderByStepStartTimeDesc(jobCode_0, execDate_1, execDate_2, pageable);
  ...
  public Slice<JobDetail> findStatusExecDateIn(String jobCode_0, int execDate_1, int execDate_2, String status_3, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("findStatusExecDateIn " + dbName + " : " + "jobCode_0 : " + jobCode_0 + " execDate_1 : " +  execDate_1 + " execDate_2 : " +  execDate_2 + " status_3 : " +  status_3);
    if (dbName.equals(ContentName.onDay))
      slice = jobDetailReposDay.findAllByJobCodeIsAndExecDateGreaterThanEqualAndExecDateLessThanEqualAndStatusIsOrderByStepStartTimeDesc(jobCode_0, execDate_1, execDate_2, status_3, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = jobDetailReposMon.findAllByJobCodeIsAndExecDateGreaterThanEqualAndExecDateLessThanEqualAndStatusIsOrderByStepStartTimeDesc(jobCode_0, execDate_1, execDate_2, status_3, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = jobDetailReposHist.findAllByJobCodeIsAndExecDateGreaterThanEqualAndExecDateLessThanEqualAndStatusIsOrderByStepStartTimeDesc(jobCode_0, execDate_1, execDate_2, status_3, pageable);
    else 
      slice = jobDetailRepos.findAllByJobCodeIsAndExecDateGreaterThanEqualAndExecDateLessThanEqualAndStatusIsOrderByStepStartTimeDesc(jobCode_0, execDate_1, execDate_2, status_3, pageable);
