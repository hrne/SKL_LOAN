...
public class AcAcctCheck implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4786087585242423223L;
	...
	public String toString() {
		return "AcAcctCheck [acAcctCheckId=" + acAcctCheckId + ", acctItem=" + acctItem + ", tdBal=" + tdBal + ", tdCnt=" + tdCnt + ", tdNewCnt=" + tdNewCnt + ", tdClsCnt=" + tdClsCnt + ", tdExtCnt="
				+ tdExtCnt + ", tdExtAmt=" + tdExtAmt + ", receivableBal=" + receivableBal + ", acctMasterBal=" + acctMasterBal + ", createEmpNo=" + createEmpNo + ", createDate=" + createDate
