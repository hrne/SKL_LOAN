 ...
 * @version 1.0.0
 */
public interface MlaundryDetailRepositoryHist extends JpaRepository<MlaundryDetail, MlaundryDetailId> {
  ...
  // EntryDate >= ,AND EntryDate <= ,AND Factor = , AND Rational ^i
  public Slice<MlaundryDetail> findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsAndRationalInOrderByEntryDateAscCustNoAsc(int entryDate_0, int entryDate_1, int factor_2, List<String> rational_3, Pageable pageable);

  // EntryDate >= ,AND EntryDate <= ,AND Factor =
  public Slice<MlaundryDetail> findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsOrderByEntryDateAscCustNoAsc(int entryDate_0, int entryDate_1, int factor_2, Pageable pageable);
