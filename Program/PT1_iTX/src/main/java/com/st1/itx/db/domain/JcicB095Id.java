...
// 資料日期
	...
	public boolean equals(Object obj) {
		...
		return dataYM == jcicB095Id.dataYM && clActNo.equals(jcicB095Id.clActNo) && ownerId.equals(jcicB095Id.ownerId) && cityJCICCode.equals(jcicB095Id.cityJCICCode)
				&& areaJCICCode == jcicB095Id.areaJCICCode && irCode.equals(jcicB095Id.irCode) && bdNo1 == jcicB095Id.bdNo1 && bdNo2 == jcicB095Id.bdNo2;
	}

	@Override
	public String toString() {
		return "JcicB095Id [dataYM=" + dataYM + ", clActNo=" + clActNo + ", ownerId=" + ownerId + ", cityJCICCode=" + cityJCICCode + ", areaJCICCode=" + areaJCICCode + ", irCode=" + irCode
				+ ", bdNo1=" + bdNo1 + ", bdNo2=" + bdNo2 + "]";
	}
}
