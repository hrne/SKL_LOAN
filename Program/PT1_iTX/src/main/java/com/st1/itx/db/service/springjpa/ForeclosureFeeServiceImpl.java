...
public class ForeclosureFeeServiceImpl extends ASpringJpaParm implements ForeclosureFeeService, InitializingBean {
	...
	public Slice<ForeclosureFee> selectForL2078(int receiveDate_0, int receiveDate_1, int custNo_2, int custNo_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = foreclosureFeeReposDay.findAllByReceiveDateGreaterThanEqualAndReceiveDateLessThanEqualAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscReceiveDateAsc(receiveDate_0,
					receiveDate_1, custNo_2, custNo_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = foreclosureFeeReposMon.findAllByReceiveDateGreaterThanEqualAndReceiveDateLessThanEqualAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscReceiveDateAsc(receiveDate_0,
					receiveDate_1, custNo_2, custNo_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = foreclosureFeeReposHist.findAllByReceiveDateGreaterThanEqualAndReceiveDateLessThanEqualAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscReceiveDateAsc(receiveDate_0,
					receiveDate_1, custNo_2, custNo_3, pageable);
		else
			slice = foreclosureFeeRepos.findAllByReceiveDateGreaterThanEqualAndReceiveDateLessThanEqualAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscReceiveDateAsc(receiveDate_0,
					receiveDate_1, custNo_2, custNo_3, pageable);
	...
	public Slice<ForeclosureFee> receiveDatecloseZero(int receiveDate_0, int receiveDate_1, int closeDate_2, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = foreclosureFeeReposDay.findAllByReceiveDateGreaterThanEqualAndReceiveDateLessThanEqualAndCloseDateIsOrderByCustNoAscReceiveDateAsc(receiveDate_0, receiveDate_1, closeDate_2,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = foreclosureFeeReposMon.findAllByReceiveDateGreaterThanEqualAndReceiveDateLessThanEqualAndCloseDateIsOrderByCustNoAscReceiveDateAsc(receiveDate_0, receiveDate_1, closeDate_2,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = foreclosureFeeReposHist.findAllByReceiveDateGreaterThanEqualAndReceiveDateLessThanEqualAndCloseDateIsOrderByCustNoAscReceiveDateAsc(receiveDate_0, receiveDate_1, closeDate_2,
					pageable);
		else
			slice = foreclosureFeeRepos.findAllByReceiveDateGreaterThanEqualAndReceiveDateLessThanEqualAndCloseDateIsOrderByCustNoAscReceiveDateAsc(receiveDate_0, receiveDate_1, closeDate_2,
					pageable);
