...
public interface JcicZ444RepositoryHist extends JpaRepository<JcicZ444, JcicZ444Id> {
  ...
  public Slice<JcicZ444> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
