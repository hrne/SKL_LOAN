...
// 序號
	...
	public String toString() {
		return "TxInquiry [logNo=" + logNo + ", entdy=" + entdy + ", calDate=" + calDate + ", brNo=" + brNo + ", tlrNo=" + tlrNo + ", supNo=" + supNo + ", tranNo=" + tranNo + ", mrKey=" + mrKey
				+ ", custNo=" + custNo + ", txResult=" + txResult + ", msgId=" + msgId + ", errMsg=" + errMsg + ", tranData=" + tranData + ", importFg=" + importFg + ", createDate=" + createDate
