...
public class L9701ServiceImpl extends ASpringJpaParm implements InitializingBean {
	...
	public List<Map<String, String>> doQuery1(boolean isCalcuExcessive,TitaVo titaVo) throws Exception {
		...
		sql += "        FROM";
		sql += "            \"LoanBorTx\" T";
		sql += "            LEFT JOIN \"InsuRenew\" IR ON IR.\"TitaTxtNo\" =T.\"TitaTxtNo\"";
		sql += "            						AND IR.\"TitaTlrNo\" =T.\"TitaTlrNo\"";
		...
		sql += "        T.\"CustNo\",";
		sql += "        CASE";
		sql += "            WHEN T.\"TitaTxCd\" = 'L3210' AND T.\"AcctCode\" ='900' THEN";
		sql += "                (";
		sql += "                    SELECT";
		sql += "                        M.\"FacmNo\"";
		sql += "                    FROM";
		...
		sql += "                SUM(";
		sql += "                    CASE";
		sql += "                        WHEN TO_NUMBER(NVL( JSON_VALUE(T.\"OtherFields\", '$.Excessive'), 0)) < 0 THEN";
		sql += "                            CASE";
		sql += "                                WHEN T.\"TitaHCode\" IN( 2, 4 ) THEN";
		sql += "                                    TO_NUMBER(NVL( JSON_VALUE(T.\"OtherFields\", '$.Excessive'), 0))";
		sql += "                                ELSE";
		sql += "                                    - TO_NUMBER(NVL( JSON_VALUE(T.\"OtherFields\", '$.Excessive'), 0))";
		sql += "                            END";
		sql += "                        ELSE";
		...
		sql += "            FROM";
		sql += "                \"LoanBorTx\" T";
		sql += "                LEFT JOIN \"InsuRenew\" IR";
		sql += "                ON IR.\"TitaTxtNo\" =T.\"TitaTxtNo\"";
		sql += "                AND IR.\"TitaTlrNo\" =T.\"TitaTlrNo\"";
		sql += "                AND IR.\"CustNo\" = T.\"CustNo\"";
		sql += "            WHERE";
		sql += "                T.\"CustNo\" = :ICUSTNO";
		...
		sql += "            GROUP BY";
		sql += "                T.\"CustNo\", NVL(IR.\"FacmNo\", T.\"FacmNo\"), T.\"AcDate\", T.\"IntStartDate\", T.\"IntEndDate\", T.\"Rate\", T.\"Desc\", T.\"TxDescCode\", T.\"AcctCode\", T.\"TitaTlrNo\", T.\"TitaTxtNo\", T.\"TitaHCode\", T.\"RepayCode\"";
		sql += "        )            T";
