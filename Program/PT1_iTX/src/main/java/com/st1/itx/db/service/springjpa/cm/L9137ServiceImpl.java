...
@Service
@Repository
public class L9137ServiceImpl extends ASpringJpaParm implements InitializingBean {
	...
	public List<Map<String, String>> findAll(int rptType, String acSubBookCode, TitaVo titaVo) throws Exception {
		this.info("L9137 findAll rptType = " + rptType + " , acSubBookCode = " + acSubBookCode);
	...
	public List<Map<String, String>> findAll_SubBookCodes(TitaVo titaVo) throws Exception {
		this.info("L9137 findAll_SubBookCodes initiated");
...
//		sql += " FROM DUAL ";
	...
	public List<Map<String, String>> findAll_related(int rptType, String acSubBookCode, TitaVo titaVo)
		...
		sql += "                               WHEN D.\"AcctCode\" = '310'                                    THEN 3 ";
		sql += " 						       WHEN D.\"AcctCode\" = '320' AND C.\"EntCode\" IN ('1')         THEN 5 ";
		sql += "                               WHEN D.\"AcctCode\" = '320'                                    THEN 6 ";
		sql += " 						       WHEN D.\"AcctCode\" = '330' AND C.\"EntCode\" IN ('1')         THEN 8 ";
		sql += "                               WHEN D.\"AcctCode\" = '330'                                    THEN 9 ";
		sql += "                               WHEN D.\"AcctCode\" = '340' AND C.\"EntCode\" IN ('1')         THEN 8 ";
		sql += "                               WHEN D.\"AcctCode\" = '340'                                    THEN 9 ";
