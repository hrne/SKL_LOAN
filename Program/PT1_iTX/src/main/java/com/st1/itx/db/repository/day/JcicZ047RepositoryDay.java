 ...
 * @version 1.0.0
 */
public interface JcicZ047RepositoryDay extends JpaRepository<JcicZ047, JcicZ047Id> {
  ...
  public Slice<JcicZ047> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
