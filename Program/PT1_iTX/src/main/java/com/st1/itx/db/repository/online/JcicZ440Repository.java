 ...
 * @version 1.0.0
 */
public interface JcicZ440Repository extends JpaRepository<JcicZ440, JcicZ440Id> {
  ...
  public Slice<JcicZ440> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
