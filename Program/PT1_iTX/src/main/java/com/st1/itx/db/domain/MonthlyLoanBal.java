...
public class MonthlyLoanBal implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -5977348544333827967L;
...
@EmbeddedId
  ...
  // 累計回收本金
  /* 資料轉換來源LA$MSTP */
  @Column(name = "`SumRcvPrin`")
  private BigDecimal sumRcvPrin = new BigDecimal("0");

  // 催收還款金額
  /* 資料轉換來源LA$MSTP */
  @Column(name = "`OvduRcvAmt`")
  private BigDecimal ovduRcvAmt = new BigDecimal("0");
...
/**
	...
	* @return BigDecimal
	*/
  public BigDecimal getSumRcvPrin() {
    return this.sumRcvPrin;
  }
...
/**
	...
	* 資料轉換來源LA$MSTP
  *
  * @param sumRcvPrin 累計回收本金
	*/
  public void setSumRcvPrin(BigDecimal sumRcvPrin) {
    this.sumRcvPrin = sumRcvPrin;
  }
...
/**
	...
	* @return BigDecimal
	*/
  public BigDecimal getOvduRcvAmt() {
    return this.ovduRcvAmt;
  }
...
/**
	...
	* 資料轉換來源LA$MSTP
  *
  * @param ovduRcvAmt 催收還款金額
	*/
  public void setOvduRcvAmt(BigDecimal ovduRcvAmt) {
    this.ovduRcvAmt = ovduRcvAmt;
  }
  ...
  * @param acSubBookCode 區隔帳冊
  ...
  public String toString() {
    return "MonthlyLoanBal [monthlyLoanBalId=" + monthlyLoanBalId + ", acctCode=" + acctCode + ", facAcctCode=" + facAcctCode
           ...
           + ", cityCode=" + cityCode + ", ovduPrinAmt=" + ovduPrinAmt + ", ovduIntAmt=" + ovduIntAmt + ", sumRcvPrin=" + sumRcvPrin + ", ovduRcvAmt=" + ovduRcvAmt + ", badDebtAmt=" + badDebtAmt
           + ", prevPayIntDate=" + prevPayIntDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + ", acSubBookCode=" + acSubBookCode
           + "]";
  }
}
