...
public class LM003ServiceImpl extends ASpringJpaParm implements InitializingBean {
	...
	public List<Map<String, String>> findAll(TitaVo titaVo) throws Exception {
		...
		sql += "            (";
		sql += "                SELECT";
		sql += "                    substr(lbtx.\"EntryDate\", 1, 6) \"YearMonth\"";
		sql += "                    , CASE";
		...
		sql += "                    mlb.\"YearMonth\"";
		sql += "                    , CASE";
		sql += "                        WHEN  fm.\"AdvanceCloseCode\" = 0 THEN";
		sql += "                            'CloseAmt0'";
		sql += "                        WHEN  fm.\"AdvanceCloseCode\" = 1 THEN";
		sql += "                            'CloseAmt1'";
		sql += "                        WHEN  fm.\"AdvanceCloseCode\" = 2 THEN";
		sql += "                            'CloseAmt2'";
		sql += "                        WHEN  fm.\"AdvanceCloseCode\" = 3 THEN";
		sql += "                            'CloseAmt3'";
		sql += "                        WHEN  fm.\"AdvanceCloseCode\" = 4 THEN";
		sql += "                            'CloseAmt4'";
		sql += "                        WHEN  fm.\"AdvanceCloseCode\" = 5 THEN";
		sql += "                            'CloseAmt5'";
		sql += "                        WHEN  fm.\"AdvanceCloseCode\" = 6 THEN";
		sql += "                            'CloseAmt6'";
		sql += "                        WHEN  fm.\"AdvanceCloseCode\" = 7 THEN";
		sql += "                            'CloseAmt7'";
		sql += "                        WHEN  fm.\"AdvanceCloseCode\" = 8 THEN";
		sql += "                            'CloseAmt8'";
		sql += "                        WHEN  fm.\"AdvanceCloseCode\" = 9 THEN";
		sql += "                            'CloseAmt9'";
		sql += "                        WHEN  fm.\"AdvanceCloseCode\"= 11 THEN";
		sql += "                            'CloseAmt11'";
		sql += "                        WHEN  fm.\"AdvanceCloseCode\"= 12 THEN";
		sql += "                            'CloseAmt11'";
		sql += "                        WHEN  fm.\"AdvanceCloseCode\"= 14 THEN";
		sql += "                            'CloseAmt14'";
		sql += "                        ELSE";
		sql += "                            'CloseElse'";
		sql += "                    END AS \"Type\"";
