...
public class CdBonusServiceImpl extends ASpringJpaParm implements CdBonusService, InitializingBean {
	...
	public Slice<CdBonus> findCondition(int workMonth_0, int conditionCode_1, String condition_2, String condition_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = cdBonusReposDay.findAllByWorkMonthIsAndConditionCodeIsAndConditionGreaterThanEqualAndConditionLessThanEqualOrderByWorkMonthAscConditionCodeAscConditionAsc(workMonth_0,
					conditionCode_1, condition_2, condition_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = cdBonusReposMon.findAllByWorkMonthIsAndConditionCodeIsAndConditionGreaterThanEqualAndConditionLessThanEqualOrderByWorkMonthAscConditionCodeAscConditionAsc(workMonth_0,
					conditionCode_1, condition_2, condition_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = cdBonusReposHist.findAllByWorkMonthIsAndConditionCodeIsAndConditionGreaterThanEqualAndConditionLessThanEqualOrderByWorkMonthAscConditionCodeAscConditionAsc(workMonth_0,
					conditionCode_1, condition_2, condition_3, pageable);
		else
			slice = cdBonusRepos.findAllByWorkMonthIsAndConditionCodeIsAndConditionGreaterThanEqualAndConditionLessThanEqualOrderByWorkMonthAscConditionCodeAscConditionAsc(workMonth_0,
					conditionCode_1, condition_2, condition_3, pageable);
