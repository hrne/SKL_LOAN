...
public class CollList implements Serializable {
	...
	// 戶況
	/*
	 * 00:正常戶 02:催收戶03:結案戶04:逾期戶(逾期期數&amp;gt;=1)05:催收結案戶06:呆帳戶
	 * 07:部分轉呆戶08:債權轉讓戶09:呆帳結案戶
	 */
	@Column(name = "`Status`")
	...
	/**
	 * 戶況<br>
	 * 00:正常戶 02:催收戶 03:結案戶 04:逾期戶(逾期期數&amp;gt;=1) 05:催收結案戶 06:呆帳戶 07:部分轉呆戶 08:債權轉讓戶
	 * 09:呆帳結案戶
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 是否指定<br>
	 * 空白 Y:是 N:否 若催收或法務人員非CdCity裡設定的人，則此欄位為Y，否則預設N
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "CollList [collListId=" + collListId + ", caseCode=" + caseCode + ", txDate=" + txDate + ", txCode=" + txCode + ", prevIntDate=" + prevIntDate + ", nextIntDate=" + nextIntDate
				...
				+ ", legalPsn=" + legalPsn + ", status=" + status + ", acctCode=" + acctCode + ", facAcctCode=" + facAcctCode + ", clCustNo=" + clCustNo + ", clFacmNo=" + clFacmNo + ", clRowNo="
				+ clRowNo + ", clCode1=" + clCode1 + ", clCode2=" + clCode2 + ", clNo=" + clNo + ", renewCode=" + renewCode + ", acDate=" + acDate + ", isSpecify=" + isSpecify + ", cityCode="
				+ cityCode + ", accTelArea=" + accTelArea + ", accTelNo=" + accTelNo + ", accTelExt=" + accTelExt + ", legalArea=" + legalArea + ", legalNo=" + legalNo + ", legalExt=" + legalExt
