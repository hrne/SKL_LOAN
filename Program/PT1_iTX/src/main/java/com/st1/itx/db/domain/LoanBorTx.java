...
public class LoanBorTx implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -657827064001767322L;
	...
	/**
	 * 還款來源<br>
	 * CdCode.RepayCode 01:匯款轉帳 02:銀行扣款 03:員工扣薪 04:支票 05:特約金 06:人事特約金 07:定存特約
	 * 08:劃撥存款 09:其他
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 交易金額<br>
	 * 1.回收金額 2.轉出金額(負值)轉入金額(正值) 3.催呆轉帳金額
	 * 
	 * @return BigDecimal
	 */
	...
	/**
	 * 實收本金<br>
	 * 扣除短繳本金、含收回短收本金 催收結案時：沖催收款項+利息收入=實收本金+實收利息
	 * 
	 * @return BigDecimal
	 */
	...
	public String toString() {
		return "LoanBorTx [loanBorTxId=" + loanBorTxId + ", titaCalDy=" + titaCalDy + ", titaCalTm=" + titaCalTm + ", titaKinBr=" + titaKinBr + ", titaTlrNo=" + titaTlrNo + ", titaTxtNo=" + titaTxtNo
				+ ", acSeq=" + acSeq + ", titaTxCd=" + titaTxCd + ", titaCrDb=" + titaCrDb + ", titaHCode=" + titaHCode + ", titaCurCd=" + titaCurCd + ", titaEmpNoS=" + titaEmpNoS + ", repayCode="
				+ repayCode + ", desc=" + desc + ", acDate=" + acDate + ", correctSeq=" + correctSeq + ", displayflag=" + displayflag + ", entryDate=" + entryDate + ", dueDate=" + dueDate + ", txAmt="
				+ txAmt + ", loanBal=" + loanBal + ", intStartDate=" + intStartDate + ", intEndDate=" + intEndDate + ", paidTerms=" + paidTerms + ", rate=" + rate + ", principal=" + principal
				+ ", interest=" + interest + ", delayInt=" + delayInt + ", breachAmt=" + breachAmt + ", closeBreachAmt=" + closeBreachAmt + ", feeAmt=" + feeAmt + ", tempAmt=" + tempAmt
				+ ", extraRepay=" + extraRepay + ", unpaidInterest=" + unpaidInterest + ", unpaidPrincipal=" + unpaidPrincipal + ", unpaidCloseBreach=" + unpaidCloseBreach + ", shortfall=" + shortfall
				+ ", overflow=" + overflow + ", otherFields=" + otherFields + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo="
				+ lastUpdateEmpNo + "]";
	}
}
