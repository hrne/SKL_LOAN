...
//				Initial
				...
				InsuRenew tInsuRenew = insuRenewService.prevInsuNoFirst(parse.stringToInteger(tempOccursList.get("CustNo").trim()), parse.stringToInteger(tempOccursList.get("FacmNo").trim()), insuNo,
						titaVo);
