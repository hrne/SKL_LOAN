...
public class CdReport implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 9154645891613812830L;
...
// 報表代號
	...
	/**
	 * 報表週期<br>
	 * 01.日報 02.月報 03.週報 04.季報 05.半年報 06.年報 07.隨機
	 * 
	 * @return Integer
	 */
	public int getCycle() {
	...
	public String toString() {
		return "CdReport [formNo=" + formNo + ", formName=" + formName + ", cycle=" + cycle + ", sendCode=" + sendCode + ", letterFg=" + letterFg + ", messageFg=" + messageFg + ", emailFg=" + emailFg
				+ ", letter=" + letter + ", message=" + message + ", email=" + email + ", usageDesc=" + usageDesc + ", signCode=" + signCode + ", watermarkFlag=" + watermarkFlag + ", enable=" + enable
