...
em = null;
  ...
  public Slice<CdCode> defItemEq2(String defCode_0, int defType_1, String item_2, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("defItemEq2 " + dbName + " : " + "defCode_0 : " + defCode_0 + " defType_1 : " +  defType_1 + " item_2 : " +  item_2);
    if (dbName.equals(ContentName.onDay))
      slice = cdCodeReposDay.findAllByDefCodeIsAndDefTypeIsAndItemLikeOrderByCodeAsc(defCode_0, defType_1, item_2, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = cdCodeReposMon.findAllByDefCodeIsAndDefTypeIsAndItemLikeOrderByCodeAsc(defCode_0, defType_1, item_2, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = cdCodeReposHist.findAllByDefCodeIsAndDefTypeIsAndItemLikeOrderByCodeAsc(defCode_0, defType_1, item_2, pageable);
    else 
      slice = cdCodeRepos.findAllByDefCodeIsAndDefTypeIsAndItemLikeOrderByCodeAsc(defCode_0, defType_1, item_2, pageable);
  ...
  public Slice<CdCode> getL6064(int defType_0, String defCode_1, String item_2, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("getL6064 " + dbName + " : " + "defType_0 : " + defType_0 + " defCode_1 : " +  defCode_1 + " item_2 : " +  item_2);
    if (dbName.equals(ContentName.onDay))
      slice = cdCodeReposDay.findAllByDefTypeIsOrDefCodeLikeOrItemLikeOrderByCodeAsc(defType_0, defCode_1, item_2, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = cdCodeReposMon.findAllByDefTypeIsOrDefCodeLikeOrItemLikeOrderByCodeAsc(defType_0, defCode_1, item_2, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = cdCodeReposHist.findAllByDefTypeIsOrDefCodeLikeOrItemLikeOrderByCodeAsc(defType_0, defCode_1, item_2, pageable);
    else 
      slice = cdCodeRepos.findAllByDefTypeIsOrDefCodeLikeOrItemLikeOrderByCodeAsc(defType_0, defCode_1, item_2, pageable);
  ...
  public Slice<CdCode> getL60642(String defCode_0, String item_1, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("getL60642 " + dbName + " : " + "defCode_0 : " + defCode_0 + " item_1 : " +  item_1);
    if (dbName.equals(ContentName.onDay))
      slice = cdCodeReposDay.findAllByDefCodeLikeOrItemLikeOrderByCodeAsc(defCode_0, item_1, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = cdCodeReposMon.findAllByDefCodeLikeOrItemLikeOrderByCodeAsc(defCode_0, item_1, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = cdCodeReposHist.findAllByDefCodeLikeOrItemLikeOrderByCodeAsc(defCode_0, item_1, pageable);
    else 
      slice = cdCodeRepos.findAllByDefCodeLikeOrItemLikeOrderByCodeAsc(defCode_0, item_1, pageable);
  ...
  public CdCode insert(CdCode cdCode, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(cdCode.getCdCodeId(), titaVo) != null)
