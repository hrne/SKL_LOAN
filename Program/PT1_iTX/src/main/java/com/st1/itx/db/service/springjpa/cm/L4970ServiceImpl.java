...
public class L4970ServiceImpl extends ASpringJpaParm implements InitializingBean {
  ...
  // ref L4961 qc2627
	...
	public List<Map<String, String>> findAll(int startDate, int endDate, TitaVo titaVo) throws Exception {
		this.info("Start L4970ServiceImpl");
		...
		sql += " ,i.\"PrevInsuNo\"               as \"PrevInsuNo\"         "; // 原保單號碼
		sql += " ,i.\"NowInsuNo\"                as \"NowInsuNo\"          "; // 新保單號碼
		sql += " ,i.\"InsuStartDate\" - 19110000 as \"InsuStartDate\"      "; // 保險起日
		sql += " ,i.\"InsuEndDate\" - 19110000   as \"InsuEndDate\"        "; // 保險迄日
		sql += " ,i.\"CustNo\"                   as \"CustNo\"             "; // 戶號+額度
		sql += " ,i.\"FacmNo\"                   as \"FacmNo\"             ";    
		sql += " ,c.\"CustName\"                 as \"CustName\"           "; // 戶名
		sql += " ,i.\"TotInsuPrem\"              as \"TotInsuPrem\"        "; // 總保費
		sql += " ,i.\"RepayCode\"                as \"RepayCode\"          "; // 繳款方式
		sql += " ,i.\"StatusCode\"               as \"StatusCode\"         ";
		sql += " ,a.\"TavBal\"                   as \"TavBal\"             "; // 暫收可抵繳金額
