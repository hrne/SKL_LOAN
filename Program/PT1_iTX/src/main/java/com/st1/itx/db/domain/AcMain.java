...
@EmbeddedId
  ...
  // 核心借方筆數
  /* 1.業務銷帳科目如以維護方式寫入則由核心出帳。ex.暫付火險費借方2.CdAcCode.ClsChkFlag日結餘額檢查=1－不過餘額(借貸分由放款及核心系統出帳)時，借、貸金額同時寫入核心貸、借欄，餘額歸零。Ex.暫收款－非核心資金運用 */
...
/**
	* 核心借方筆數<br>
	* 1.業務銷帳科目如以維護方式寫入則由核心出帳。ex.暫付火險費借方
2.CdAcCode.ClsChkFlag日結餘額檢查=1－不過餘額(借貸分由放款及核心系統出帳)時，借、貸金額同時寫入核心貸、借欄，餘額歸零。Ex.暫收款－非核心資金運用
	* @return Integer
	*/
