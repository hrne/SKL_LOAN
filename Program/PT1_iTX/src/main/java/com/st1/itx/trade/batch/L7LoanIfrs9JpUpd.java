...
@Service("L7LoanIfrs9JpUpd")
@Scope("step")
/**
 * (每月日終批次)維護 LoanIfrs9Jp 每月IFRS9欄位清單J檔
 *
 * @author Chih Wei
 * @version 1.0.0
 */
public class L7LoanIfrs9JpUpd extends BatchBase implements Tasklet, InitializingBean {
	...
	public void run() throws LogicException {
		this.info("active L7LoanIfrs9JpUpd ");
		...
		this.info("active L7LoanIfrs9JpUpd tbsdyf=" + tbsdyf);
		this.info("active L7LoanIfrs9JpUpd empNo =" + empNo);
...
//		this.titaVo.putParam(ContentName.dataBase, ContentName.onLine);
		...
		sJobMainService.Usp_L7_LoanIfrs9Jp_Upd(tbsdyf, empNo, txSeq, titaVo);
	}
