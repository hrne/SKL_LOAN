 ...
 * @version 1.0.0
 */
public interface JcicZ046RepositoryHist extends JpaRepository<JcicZ046, JcicZ046Id> {
  ...
  public Slice<JcicZ046> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
