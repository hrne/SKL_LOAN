...
public class CdAreaServiceImpl extends ASpringJpaParm implements CdAreaService, InitializingBean {
	...
	public Slice<CdArea> areaCodeRange(String cityCode_0, String cityCode_1, String areaCode_2, String areaCode_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = cdAreaReposDay.findAllByCityCodeGreaterThanEqualAndCityCodeLessThanEqualAndAreaCodeGreaterThanEqualAndAreaCodeLessThanEqualOrderByCityCodeAscAreaCodeAsc(cityCode_0, cityCode_1,
					areaCode_2, areaCode_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = cdAreaReposMon.findAllByCityCodeGreaterThanEqualAndCityCodeLessThanEqualAndAreaCodeGreaterThanEqualAndAreaCodeLessThanEqualOrderByCityCodeAscAreaCodeAsc(cityCode_0, cityCode_1,
					areaCode_2, areaCode_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = cdAreaReposHist.findAllByCityCodeGreaterThanEqualAndCityCodeLessThanEqualAndAreaCodeGreaterThanEqualAndAreaCodeLessThanEqualOrderByCityCodeAscAreaCodeAsc(cityCode_0, cityCode_1,
					areaCode_2, areaCode_3, pageable);
		else
			slice = cdAreaRepos.findAllByCityCodeGreaterThanEqualAndCityCodeLessThanEqualAndAreaCodeGreaterThanEqualAndAreaCodeLessThanEqualOrderByCityCodeAscAreaCodeAsc(cityCode_0, cityCode_1,
					areaCode_2, areaCode_3, pageable);
