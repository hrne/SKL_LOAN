...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "LoanIfrs9Hp [loanIfrs9HpId=" + loanIfrs9HpId + ", custId=" + custId + ", applNo=" + applNo + ", custKind=" + custKind
           + ", approveDate=" + approveDate + ", firstDrawdownDate=" + firstDrawdownDate + ", lineAmt=" + lineAmt + ", ifrs9ProdCode=" + ifrs9ProdCode + ", avblBal=" + avblBal + ", recycleCode=" + recycleCode
