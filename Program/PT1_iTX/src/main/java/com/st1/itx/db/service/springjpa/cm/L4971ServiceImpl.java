...
//	private int functionCode = 0;
	...
	public List<Map<String, String>> findAll(int inputAcDate, String iReconCode, TitaVo titaVo) throws Exception {
		this.info("Start L4971ServiceImpl");
		this.info("inputAcDate    = " + inputAcDate);
// L4971 匯款轉帳短繳查詢 1110411
// 輸入 ref L4211
//  會計日期
...
//  輸出
		...
		sql += "    , TX0.\"ShortAmt\"          AS \"ShortAmt\"      "; // 短繳金額
		sql += "    , TX0.\"OpenAcDate\"        AS \"OpenAcDate\"    "; // 連結L3005使用 ref L6909
		sql += "    , TX0.\"OpenTlrNo\"         AS \"OpenTlrNo\"     "; // 連結L3005使用
		sql += "    , TX0.\"OpenTxtNo\"         AS \"OpenTxtNo\"     "; // 連結L3005使用
		sql += " FROM TX0                                          ";
