...
public class JcicZ451 implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2999882637590553727L;
	...
	public String toString() {
		return "JcicZ451 [jcicZ451Id=" + jcicZ451Id + ", tranKey=" + tranKey + ", delayCode=" + delayCode + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey + ", createDate=" + createDate
