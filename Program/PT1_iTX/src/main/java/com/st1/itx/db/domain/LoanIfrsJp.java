...
@Table(name = "`LoanIfrsJp`")
public class LoanIfrsJp implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5468655282867160065L;

	@EmbeddedId
	private LoanIfrsJpId loanIfrsJpId;
	...
	public LoanIfrsJpId getLoanIfrsJpId() {
		return this.loanIfrsJpId;
	}

	public void setLoanIfrsJpId(LoanIfrsJpId loanIfrsJpId) {
		this.loanIfrsJpId = loanIfrsJpId;
	}
	...
	public String toString() {
		return "LoanIfrsJp [loanIfrsJpId=" + loanIfrsJpId + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
