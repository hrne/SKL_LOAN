...
// 借款人戶號
	...
	public String toString() {
		return "CustDataCtrl [custNo=" + custNo + ", custUKey=" + custUKey + ", applMark=" + applMark + ", reason=" + reason + ", custId=" + custId + ", custName=" + custName + ", setDate=" + setDate
				+ ", setEmpNo=" + setEmpNo + ", reSetDate=" + reSetDate + ", reSetEmpNo=" + reSetEmpNo + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
