...
// 序號
	...
	public String toString() {
		return "TxAmlLog [logNo=" + logNo + ", entdy=" + entdy + ", brNo=" + brNo + ", refNo=" + refNo + ", caseNo=" + caseNo + ", acctNo=" + acctNo + ", transactionId=" + transactionId + ", msgRg="
				+ msgRg + ", msgRs=" + msgRs + ", status=" + status + ", statusCode=" + statusCode + ", statusDesc=" + statusDesc + ", isSimilar=" + isSimilar + ", isSan=" + isSan + ", isBanNation="
				+ isBanNation + ", confirmStatus=" + confirmStatus + ", confirmCode=" + confirmCode + ", confirmEmpNo=" + confirmEmpNo + ", confirmTranCode=" + confirmTranCode + ", custId=" + custId
