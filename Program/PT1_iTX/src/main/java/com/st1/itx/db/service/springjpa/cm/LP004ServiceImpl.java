...
public class LP004ServiceImpl extends ASpringJpaParm implements InitializingBean {
	...
	public List<Map<String, String>> findDist(TitaVo titaVo, Map<String, String> wkVo) throws Exception {
		...
		sql += "      , tab1.\"DistItem\" AS \"DistItem\" ";
		sql += "      , tab1.\"Fullname\" AS \"mFullname\"";
		sql += "      , tab4.\"Fullname\" AS \"bFullname\" ";
		sql += "      , CASE ";
		...
		sql += "             WHERE \"WorkMonth\"= :iyymm ";
		sql += "               AND \"DeptCode\" IN ('A0B000','A0F000','A0E000','A0M000') ";
		sql += "               AND \"DistCode\" is not null ";
		sql += "             GROUP BY \"DistCode\" ";
		sql += "           ) tab2 ON tab1.\"DistCode\" = tab2.\"DistCode\" ";
		sql += " LEFT JOIN ( SELECT \"DistCode\" ";
		sql += "                  , SUM(\"PerfCnt\") AS \"sumPerfCnt\" ";
		sql += "                  , SUM(\"PerfAmt\") AS \"sumPerfAmt\" ";
		sql += "             FROM \"PfItDetail\" ";
		...
		sql += "               AND \"DeptCode\" IN('A0B000','A0F000','A0E000','A0M000') ";
		sql += "               AND \"DistItem\" <> '房貸部專'  ";
		sql += "           ) tab4 ON SUBSTR(tab4.\"DistCode\",0,2) = SUBSTR(tab1.\"DistCode\",0,2) ";
		sql += "          		  OR SUBSTR(tab4.\"DistCode\",4,2) = SUBSTR(tab1.\"DistCode\",0,2) ";
