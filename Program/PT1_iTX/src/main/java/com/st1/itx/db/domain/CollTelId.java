...
// 案件種類
  ...
  public CollTelId(String caseCode, int custNo, int facmNo, int acDate, String titaTlrNo, String titaTxtNo) {
  ...
  * @param titaTxtNo 交易序號
  ...
  public boolean equals(Object obj) {
    ...
    if(obj == null || getClass() != obj.getClass())
      return false;
    CollTelId collTelId = (CollTelId) obj;
    return caseCode.equals(collTelId.caseCode) && custNo == collTelId.custNo && facmNo == collTelId.facmNo && acDate == collTelId.acDate && titaTlrNo.equals(collTelId.titaTlrNo) && titaTxtNo.equals(collTelId.titaTxtNo);
  }

  @Override
  public String toString() {
    return "CollTelId [caseCode=" + caseCode + ", custNo=" + custNo + ", facmNo=" + facmNo + ", acDate=" + acDate + ", titaTlrNo=" + titaTlrNo + ", titaTxtNo=" + titaTxtNo + "]";
  }
}
