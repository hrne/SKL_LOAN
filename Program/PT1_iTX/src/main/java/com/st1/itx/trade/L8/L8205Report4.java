...
//	自訂表頭
	...
	public void printHeader() {
		...
		this.print(-5, this.getMidXAxis(), "疑似洗錢樣態4、5延遲交易確認報表", "C");
...
//		print(-66, this.getMidXAxis(), "　經辦:　　　　　　　　　　　　　　經理:　　　　　　　　　　　　　　協理:　　　　　　　　　　　　　　", "C");
	...
	public void makeReport(TitaVo titaVo) throws LogicException {
		...
		ReportVo reportVo = ReportVo.builder().setBrno(titaVo.getKinbr()).setRptDate(titaVo.getEntDyI())
				.setSecurity("機密").setRptCode("L8205").setRptItem("疑似洗錢樣態4、5延遲交易確認報表").setPageOrientation("P")
		...
		if (listL8205 != null && listL8205.size() > 0) {
			...
			for (Map<String, String> tL8205Vo : listL8205) {
				...
				// 同意日
				print(0, 72,
						tL8205Vo.get("F10") == "0" || tL8205Vo.get("F10") == null || tL8205Vo.get("F10").length() == 0
								|| tL8205Vo.get("F10").equals(" ") ? " " : showDate(tL8205Vo.get("F10"), 1));

				// 異動日
				print(0, 83, tL8205Vo.get("F7") == "0" || tL8205Vo.get("F7") == null || tL8205Vo.get("F7").length() == 0
...
//				}
	...
	public void makeExcel(TitaVo titaVo) throws LogicException {
		...
		makeExcel.open(titaVo, titaVo.getEntDyI(), titaVo.getKinbr(), "L8205", "疑似洗錢樣態4、5延遲交易確認報表",
				"L8205" + "_" + "疑似洗錢樣態4、5延遲交易確認報表");
		printExcelHeader();
			...
			for (Map<String, String> tL8205Vo : listL8205) {
				...
				makeExcel
						.setValue(rowCursor, 8,
								tL8205Vo.get("F10") == "0" || tL8205Vo.get("F10") == null
										|| tL8205Vo.get("F10").length() == 0 || tL8205Vo.get("F10").equals(" ") ? " "
												: showDate(tL8205Vo.get("F10"), 1));

				makeExcel
						.setValue(rowCursor, 9,
