...
public class LoanBookServiceImpl extends ASpringJpaParm implements LoanBookService, InitializingBean {
	...
	public Slice<LoanBook> bookBormNoRange(int custNo_0, int facmNo_1, int bormNo_2, int bookDate_3, int bookDate_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info(
				"bookBormNoRange " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " + facmNo_1 + " bormNo_2 : " + bormNo_2 + " bookDate_3 : " + bookDate_3 + " bookDate_4 : " + bookDate_4);
		if (dbName.equals(ContentName.onDay))
			slice = loanBookReposDay.findAllByCustNoIsAndFacmNoIsAndBormNoIsAndBookDateGreaterThanEqualAndBookDateLessThanEqualOrderByBookDateAsc(custNo_0, facmNo_1, bormNo_2, bookDate_3, bookDate_4,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = loanBookReposMon.findAllByCustNoIsAndFacmNoIsAndBormNoIsAndBookDateGreaterThanEqualAndBookDateLessThanEqualOrderByBookDateAsc(custNo_0, facmNo_1, bormNo_2, bookDate_3, bookDate_4,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = loanBookReposHist.findAllByCustNoIsAndFacmNoIsAndBormNoIsAndBookDateGreaterThanEqualAndBookDateLessThanEqualOrderByBookDateAsc(custNo_0, facmNo_1, bormNo_2, bookDate_3, bookDate_4,
					pageable);
		else
			slice = loanBookRepos.findAllByCustNoIsAndFacmNoIsAndBormNoIsAndBookDateGreaterThanEqualAndBookDateLessThanEqualOrderByBookDateAsc(custNo_0, facmNo_1, bormNo_2, bookDate_3, bookDate_4,
					pageable);
	...
	public Slice<LoanBook> bookCustNoRange(int custNo_0, int custNo_1, int facmNo_2, int facmNo_3, int bormNo_4, int bormNo_5, int bookDate_6, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("bookCustNoRange " + dbName + " : " + "custNo_0 : " + custNo_0 + " custNo_1 : " + custNo_1 + " facmNo_2 : " + facmNo_2 + " facmNo_3 : " + facmNo_3 + " bormNo_4 : " + bormNo_4
				+ " bormNo_5 : " + bormNo_5 + " bookDate_6 : " + bookDate_6);
		if (dbName.equals(ContentName.onDay))
			slice = loanBookReposDay
					.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndBookDateGreaterThanEqualOrderByBookDateAsc(
							custNo_0, custNo_1, facmNo_2, facmNo_3, bormNo_4, bormNo_5, bookDate_6, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = loanBookReposMon
					.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndBookDateGreaterThanEqualOrderByBookDateAsc(
							custNo_0, custNo_1, facmNo_2, facmNo_3, bormNo_4, bormNo_5, bookDate_6, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = loanBookReposHist
					.findAllByCustNoGreaterThanEqualAndCustNoLessThanEqualAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndBookDateGreaterThanEqualOrderByBookDateAsc(
							custNo_0, custNo_1, facmNo_2, facmNo_3, bormNo_4, bormNo_5, bookDate_6, pageable);
		else
			slice = loanBookRepos
	...
	public LoanBook facmNoLastBookDateFirst(int custNo_0, int facmNo_1, int facmNo_2, int bormNo_3, int bormNo_4, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info(
				"facmNoLastBookDateFirst " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " + facmNo_1 + " facmNo_2 : " + facmNo_2 + " bormNo_3 : " + bormNo_3 + " bormNo_4 : " + bormNo_4);
		Optional<LoanBook> loanBookT = null;
		if (dbName.equals(ContentName.onDay))
			loanBookT = loanBookReposDay.findTopByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualOrderByBookDateDesc(custNo_0, facmNo_1,
					facmNo_2, bormNo_3, bormNo_4);
		else if (dbName.equals(ContentName.onMon))
			loanBookT = loanBookReposMon.findTopByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualOrderByBookDateDesc(custNo_0, facmNo_1,
					facmNo_2, bormNo_3, bormNo_4);
		else if (dbName.equals(ContentName.onHist))
			loanBookT = loanBookReposHist.findTopByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualOrderByBookDateDesc(custNo_0, facmNo_1,
					facmNo_2, bormNo_3, bormNo_4);
		else
			loanBookT = loanBookRepos.findTopByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualOrderByBookDateDesc(custNo_0, facmNo_1, facmNo_2,
					bormNo_3, bormNo_4);
	...
	public LoanBook insert(LoanBook loanBook, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(loanBook.getLoanBookId(), titaVo) != null)
