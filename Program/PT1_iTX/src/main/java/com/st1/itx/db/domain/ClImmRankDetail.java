...
public class ClImmRankDetail implements Serializable {
	...
	public String toString() {
		return "ClImmRankDetail [clImmRankDetailId=" + clImmRankDetailId + ", firstCreditor=" + firstCreditor + ", firstAmt=" + firstAmt + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
