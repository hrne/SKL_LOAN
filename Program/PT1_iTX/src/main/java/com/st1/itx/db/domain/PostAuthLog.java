...
public class PostAuthLog implements Serializable {
	...
	// 狀況代號，授權狀態
	/*
	 * CdCode.AuthErrorCode空:再次授權空白:未授權00:成功03:已終止代繳06:凍結警示戶07:支票專戶08:帳號錯誤09:終止戶10:
	 * 身分證不符11:轉出戶12:拒絕往來戶13:無此編號14:編號已存在16:管制帳戶17:掛失戶18:異常帳戶19:編號非英數91:期限未扣款98:其他
	 */
	...
	/**
	 * 申請代號，狀態碼<br>
	 * CdCode.AuthApplCode 1:申請 2:終止 3:郵局終止 4:誤終止 9:暫停授權(DeleteDate &amp;gt; 0時，顯示用)
	 * 
	 * @return String
	 */
	...
	/**
	 * 核印註記<br>
	 * CdCode.StampCode 1:帳號不符 2:戶名不符 3:身分證號不符 4:印鑑不符 9:其他
	 * 
	 * @return String
	 */
	...
	/**
	 * 狀況代號，授權狀態<br>
	 * CdCode.AuthErrorCode 空:再次授權 空白:未授權 00:成功 03:已終止代繳 06:凍結警示戶 07:支票專戶 08:帳號錯誤
	 * 09:終止戶 10:身分證不符 11:轉出戶 12:拒絕往來戶 13:無此編號 14:編號已存在 16:管制帳戶 17:掛失戶 18:異常帳戶
	 * 19:編號非英數 91:期限未扣款 98:其他
	 * 
	 * @return String
	 */
	...
	/**
	 * 授權方式<br>
	 * CdCode.AchAuthCode A:紙本新增 O:舊檔轉換 X:紙本終止 R:申請恢復
	 * 
	 * @return String
	 */
	...
	/**
	 * 與借款人關係<br>
	 * CdCode.RelationCode 00:本人 01:夫 02:妻 03:父 04:母 05:子 06:女 07:兄 08:弟 09:姊 10:妹
	 * 11:姪子 99:其他
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "PostAuthLog [postAuthLogId=" + postAuthLogId + ", facmNo=" + facmNo + ", custId=" + custId + ", limitAmt=" + limitAmt + ", repayAcctSeq=" + repayAcctSeq + ", processDate="
				+ processDate + ", processTime=" + processTime + ", stampFinishDate=" + stampFinishDate + ", stampCancelDate=" + stampCancelDate + ", stampCode=" + stampCode + ", postMediaCode="
				+ postMediaCode + ", authErrorCode=" + authErrorCode + ", authMeth=" + authMeth + ", fileSeq=" + fileSeq + ", propDate=" + propDate + ", retrDate=" + retrDate + ", deleteDate="
				+ deleteDate + ", relationCode=" + relationCode + ", relAcctName=" + relAcctName + ", relationId=" + relationId + ", relAcctBirthday=" + relAcctBirthday + ", relAcctGender="
				+ relAcctGender + ", amlRsp=" + amlRsp + ", titaTxCd=" + titaTxCd + ", createEmpNo=" + createEmpNo + ", createDate=" + createDate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
