...
// 聯貸編號
	...
	public String toString() {
		return "LoanSynd [syndNo=" + syndNo + ", syndName=" + syndName + ", leadingBank=" + leadingBank + ", agentBank=" + agentBank + ", signingDate=" + signingDate + ", syndTypeCodeFlag="
				+ syndTypeCodeFlag + ", partRate=" + partRate + ", currencyCode=" + currencyCode + ", syndAmt=" + syndAmt + ", partAmt=" + partAmt + ", createDate=" + createDate + ", createEmpNo="
