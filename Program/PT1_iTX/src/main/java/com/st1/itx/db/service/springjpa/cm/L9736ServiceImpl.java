 ...
 *
 */
@Service("L9736ServiceImpl")
@Repository
public class L9736ServiceImpl extends ASpringJpaParm implements InitializingBean {
	...
	public List<Map<String, String>> getNormalCustomerLoanData(int inputDrawdownDate, TitaVo titaVo) {
		...
		sql += "          THEN 0 ";
		sql += "        ELSE TRUNC(FM.\"LineAmt\" / CS.\"EvaNetWorth\" * 100, 2)";
