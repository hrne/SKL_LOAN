 ...
 * @version 1.0.0
 */
public class L4104Batch extends TradeBuffer {
	@Autowired
...
//TODO: 回銷檔名稱待訂
			if (filename.indexOf("LNM24r") >= 0) {
				...
				try {
					...
					this.info("L4104Batch(" + filePath1 + ") : " + e.getMessage());
				}
				try {
...
//			每次執行setValue後，需初始化occursList
			...
			try {
				...
				this.info("L4104Batch(" + filePath + ") : " + e.getMessage());
			}
