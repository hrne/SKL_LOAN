...
/**
	...
	* 
  *
  * @param flowNo 流程控制序號((單位+使用者編號+交易序號)
	*/
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "TxFlow [txFlowId=" + txFlowId + ", tranNo=" + tranNo + ", flowType=" + flowType + ", flowStep=" + flowStep + ", flowMode=" + flowMode
           + ", brNo=" + brNo + ", groupNo=" + groupNo + ", conBrNo=" + conBrNo + ", conGroupNo=" + conGroupNo + ", flowBrNo=" + flowBrNo + ", flowGroupNo=" + flowGroupNo
           + ", txNo1=" + txNo1 + ", txNo2=" + txNo2 + ", txNo3=" + txNo3 + ", txNo4=" + txNo4 + ", lockCustNo=" + lockCustNo + ", lockNo=" + lockNo
           + ", secNo=" + secNo + ", bookAc=" + bookAc + ", acCnt=" + acCnt + ", rejectReason=" + rejectReason + ", submitFg=" + submitFg + ", createDate=" + createDate
