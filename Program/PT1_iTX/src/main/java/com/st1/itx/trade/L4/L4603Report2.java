	...
	public long exec(TitaVo titaVo, InsuRenew tInsuRenew, TxBuffer txbuffer) throws LogicException {
		...
		if (tInsuRenew.getInsuStartDate() != 0) {
			if (String.valueOf(tInsuRenew.getInsuStartDate()).length() == 7) {
				InsuStartDate = String.valueOf(tInsuRenew.getInsuStartDate()).substring(0, 3) + "/" + String.valueOf(tInsuRenew.getInsuStartDate()).substring(3, 5) + "/"
						+ String.valueOf(tInsuRenew.getInsuStartDate()).substring(5, 7);
			} else {
				InsuStartDate = String.valueOf(tInsuRenew.getInsuStartDate()).substring(0, 2) + "/" + String.valueOf(tInsuRenew.getInsuStartDate()).substring(2, 4) + "/"
		...
		if (tInsuRenew.getInsuEndDate() != 0) {
			if (String.valueOf(tInsuRenew.getInsuEndDate()).length() == 7) {
				InsuEndDate = String.valueOf(tInsuRenew.getInsuEndDate()).substring(0, 3) + "/" + String.valueOf(tInsuRenew.getInsuEndDate()).substring(3, 5) + "/"
						+ String.valueOf(tInsuRenew.getInsuEndDate()).substring(5, 7);
			} else {
				InsuEndDate = String.valueOf(tInsuRenew.getInsuEndDate()).substring(0, 2) + "/" + String.valueOf(tInsuRenew.getInsuEndDate()).substring(2, 4) + "/"
		...
		if (String.valueOf(iEntryDate).length() == 7) {
			sEntryDate = String.valueOf(iEntryDate).substring(0, 3) + "/" + String.valueOf(iEntryDate).substring(3, 5) + "/" + String.valueOf(iEntryDate).substring(5, 7);
		} else {
			sEntryDate = String.valueOf(iEntryDate).substring(0, 2) + "/" + String.valueOf(iEntryDate).substring(2, 4) + "/" + String.valueOf(iEntryDate).substring(4, 6);
		}
