...
public class JcicZ443 implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7478185027098469088L;
	...
	public String toString() {
		return "JcicZ443 [jcicZ443Id=" + jcicZ443Id + ", tranKey=" + tranKey + ", isMaxMain=" + isMaxMain + ", guarantyType=" + guarantyType + ", loanAmt=" + loanAmt + ", creditAmt=" + creditAmt
				+ ", principal=" + principal + ", interest=" + interest + ", penalty=" + penalty + ", other=" + other + ", terminalPayAmt=" + terminalPayAmt + ", latestPayAmt=" + latestPayAmt
				+ ", finalPayDay=" + finalPayDay + ", notyetacQuit=" + notyetacQuit + ", mothPayDay=" + mothPayDay + ", beginDate=" + beginDate + ", endDate=" + endDate + ", outJcicTxtDate="
