...
public class JcicZ575 implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -73543885736151686L;
	...
	public String toString() {
		return "JcicZ575 [jcicZ575Id=" + jcicZ575Id + ", tranKey=" + tranKey + ", modifyType=" + modifyType + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey + ", createDate=" + createDate
