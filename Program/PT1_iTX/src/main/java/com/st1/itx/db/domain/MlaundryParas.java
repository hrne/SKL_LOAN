...
public class MlaundryParas implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = 2282386535693270236L;
...
// 業務類型
  ...
  // 樣態二統計期間天數
  /* L8201維護：統計期間天數 */
  @Column(name = "`FactorDays2`")
  private int factorDays2 = 0;
...
/**
	...
	* @return Integer
	*/
  public int getFactorDays2() {
    return this.factorDays2;
  }
...
/**
	...
	* L8201維護：統計期間天數
  *
  * @param factorDays2 樣態二統計期間天數
	*/
  public void setFactorDays2(int factorDays2) {
    this.factorDays2 = factorDays2;
  }
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "MlaundryParas [businessType=" + businessType + ", factor1TotLimit=" + factor1TotLimit + ", factor2Count=" + factor2Count + ", factor2AmtStart=" + factor2AmtStart + ", factor2AmtEnd=" + factor2AmtEnd + ", factor3TotLimit=" + factor3TotLimit
           + ", factorDays=" + factorDays + ", factorDays3=" + factorDays3 + ", factorDays2=" + factorDays2 + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
