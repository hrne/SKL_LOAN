...
@Service("L9MonthlyLM052AssetClassIns")
@Scope("step")
/**
 * (月底日日終批次)維護MonthlyLM052AssetClass
 * 
 * @author Chih Wei
 * @version 1.0.0
 */
public class L9MonthlyLM052AssetClassIns extends BatchBase implements Tasklet, InitializingBean {
...
//		this.titaVo.putParam(ContentName.dataBase, ContentName.onLine);
		...
		sJobMainService.Usp_L9_MonthlyLM052AssetClass_Ins(tbsdyf, empNo, txSeq, titaVo);
	}
