...
@Table(name = "`JcicZ570`")
public class JcicZ570 implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1412341602408998240L;

	@EmbeddedId
	private JcicZ570Id jcicZ570Id;

	// 交易代碼
	/* A:新增C:異動X:補件D:刪除(僅限補件之資料刪除) */
	...
	public JcicZ570Id getJcicZ570Id() {
		return this.jcicZ570Id;
	}

	public void setJcicZ570Id(JcicZ570Id jcicZ570Id) {
		this.jcicZ570Id = jcicZ570Id;
	}
	...
	public String toString() {
		return "JcicZ570 [jcicZ570Id=" + jcicZ570Id + ", tranKey=" + tranKey + ", adjudicateDate=" + adjudicateDate + ", bankCount=" + bankCount + ", bank1=" + bank1 + ", bank2=" + bank2 + ", bank3="
				...
				+ ", bank28=" + bank28 + ", bank29=" + bank29 + ", bank30=" + bank30 + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey + ", createDate=" + createDate + ", createEmpNo="
				+ createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + ", actualFilingDate=" + actualFilingDate + ", actualFilingMark=" + actualFilingMark + "]";
	}
}
