...
public class LoanBorTxServiceImpl extends ASpringJpaParm implements LoanBorTxService, InitializingBean {
	...
	@Override
	public Slice<LoanBorTx> borxAcDateRange(int custNo_0, int facmNo_1, int facmNo_2, int bormNo_3, int bormNo_4, int acDate_5, int acDate_6, List<String> displayflag_7, int index, int limit,
			TitaVo... titaVo) {
		String dbName = "";
		Slice<LoanBorTx> slice = null;
		if (titaVo.length != 0)
		...
		this.info("borxAcDateRange " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " + facmNo_1 + " facmNo_2 : " + facmNo_2 + " bormNo_3 : " + bormNo_3 + " bormNo_4 : " + bormNo_4
				+ " acDate_5 : " + acDate_5 + " acDate_6 : " + acDate_6 + " displayflag_7 : " + displayflag_7);
		if (dbName.equals(ContentName.onDay))
			slice = loanBorTxReposDay
					.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndAcDateGreaterThanEqualAndAcDateLessThanEqualAndDisplayflagInOrderByAcDateAscTitaTlrNoAscTitaTxtNoAscDisplayflagAscFacmNoAscBormNoAsc(
							custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, acDate_5, acDate_6, displayflag_7, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = loanBorTxReposMon
					.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndAcDateGreaterThanEqualAndAcDateLessThanEqualAndDisplayflagInOrderByAcDateAscTitaTlrNoAscTitaTxtNoAscDisplayflagAscFacmNoAscBormNoAsc(
							custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, acDate_5, acDate_6, displayflag_7, pageable);
		else if (dbName.equals(ContentName.onHist))
	...
	public Slice<LoanBorTx> borxBormNoEq(int custNo_0, int facmNo_1, int bormNo_2, int borxNo_3, int borxNo_4, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = loanBorTxReposDay.findAllByCustNoIsAndFacmNoIsAndBormNoIsAndBorxNoGreaterThanEqualAndBorxNoLessThanEqualOrderByBorxNoAsc(custNo_0, facmNo_1, bormNo_2, borxNo_3, borxNo_4,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = loanBorTxReposMon.findAllByCustNoIsAndFacmNoIsAndBormNoIsAndBorxNoGreaterThanEqualAndBorxNoLessThanEqualOrderByBorxNoAsc(custNo_0, facmNo_1, bormNo_2, borxNo_3, borxNo_4,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = loanBorTxReposHist.findAllByCustNoIsAndFacmNoIsAndBormNoIsAndBorxNoGreaterThanEqualAndBorxNoLessThanEqualOrderByBorxNoAsc(custNo_0, facmNo_1, bormNo_2, borxNo_3, borxNo_4,
					pageable);
		else
	...
	@Override
	public Slice<LoanBorTx> borxEntryDateRange(int custNo_0, int facmNo_1, int facmNo_2, int bormNo_3, int bormNo_4, int entryDate_5, int entryDate_6, List<String> displayflag_7, int index, int limit,
			TitaVo... titaVo) {
		String dbName = "";
		Slice<LoanBorTx> slice = null;
		if (titaVo.length != 0)
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("borxEntryDateRange " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " + facmNo_1 + " facmNo_2 : " + facmNo_2 + " bormNo_3 : " + bormNo_3 + " bormNo_4 : " + bormNo_4
				+ " entryDate_5 : " + entryDate_5 + " entryDate_6 : " + entryDate_6 + " displayflag_7 : " + displayflag_7);
		if (dbName.equals(ContentName.onDay))
			slice = loanBorTxReposDay
					.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndDisplayflagInOrderByAcDateAscTitaKinBrAscTitaTlrNoAscTitaTxtNoAsc(
	...
	public LoanBorTx custNoTxtNoFirst(int custNo_0, int facmNo_1, int bormNo_2, int acDate_3, String titaTlrNo_4, String titaTxtNo_5, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("custNoTxtNoFirst " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " + facmNo_1 + " bormNo_2 : " + bormNo_2 + " acDate_3 : " + acDate_3 + " titaTlrNo_4 : " + titaTlrNo_4
				+ " titaTxtNo_5 : " + titaTxtNo_5);
		Optional<LoanBorTx> loanBorTxT = null;
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<LoanBorTx> custNoTxtNoEq(int custNo_0, int acDate_1, String titaKinBr_2, String titaTlrNo_3, String titaTxtNo_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("custNoTxtNoEq " + dbName + " : " + "custNo_0 : " + custNo_0 + " acDate_1 : " + acDate_1 + " titaKinBr_2 : " + titaKinBr_2 + " titaTlrNo_3 : " + titaTlrNo_3 + " titaTxtNo_4 : "
				+ titaTxtNo_4);
		if (dbName.equals(ContentName.onDay))
			slice = loanBorTxReposDay.findAllByCustNoIsAndAcDateIsAndTitaKinBrIsAndTitaTlrNoIsAndTitaTxtNoIsOrderByFacmNoAscBormNoAsc(custNo_0, acDate_1, titaKinBr_2, titaTlrNo_3, titaTxtNo_4,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = loanBorTxReposMon.findAllByCustNoIsAndAcDateIsAndTitaKinBrIsAndTitaTlrNoIsAndTitaTxtNoIsOrderByFacmNoAscBormNoAsc(custNo_0, acDate_1, titaKinBr_2, titaTlrNo_3, titaTxtNo_4,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = loanBorTxReposHist.findAllByCustNoIsAndAcDateIsAndTitaKinBrIsAndTitaTlrNoIsAndTitaTxtNoIsOrderByFacmNoAscBormNoAsc(custNo_0, acDate_1, titaKinBr_2, titaTlrNo_3, titaTxtNo_4,
					pageable);
		else
	...
	public Slice<LoanBorTx> findDueDateRange(int custNo_0, int facmNo_1, int facmNo_2, int bormNo_3, int bormNo_4, int dueDate_5, int dueDate_6, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findDueDateRange " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " + facmNo_1 + " facmNo_2 : " + facmNo_2 + " bormNo_3 : " + bormNo_3 + " bormNo_4 : " + bormNo_4
				+ " dueDate_5 : " + dueDate_5 + " dueDate_6 : " + dueDate_6);
		if (dbName.equals(ContentName.onDay))
			slice = loanBorTxReposDay
					.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndDueDateGreaterThanEqualAndDueDateLessThanEqualOrderByDueDateAscFacmNoAscBormNoAsc(
							custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, dueDate_5, dueDate_6, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = loanBorTxReposMon
					.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndDueDateGreaterThanEqualAndDueDateLessThanEqualOrderByDueDateAscFacmNoAscBormNoAsc(
							custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, dueDate_5, dueDate_6, pageable);
	...
	public Slice<LoanBorTx> findAcDateRange(int acDate_0, int acDate_1, List<String> titaHCode_2, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = loanBorTxReposDay.findAllByAcDateGreaterThanEqualAndAcDateLessThanEqualAndTitaHCodeInOrderByAcDateAscCustNoAscFacmNoAscBormNoAscBorxNoAsc(acDate_0, acDate_1, titaHCode_2,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = loanBorTxReposMon.findAllByAcDateGreaterThanEqualAndAcDateLessThanEqualAndTitaHCodeInOrderByAcDateAscCustNoAscFacmNoAscBormNoAscBorxNoAsc(acDate_0, acDate_1, titaHCode_2,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = loanBorTxReposHist.findAllByAcDateGreaterThanEqualAndAcDateLessThanEqualAndTitaHCodeInOrderByAcDateAscCustNoAscFacmNoAscBormNoAscBorxNoAsc(acDate_0, acDate_1, titaHCode_2,
					pageable);
		else
	...
	@Override
	public Slice<LoanBorTx> findIntEndDateEq(int custNo_0, int facmNo_1, int bormNo_2, int bormNo_3, int intEndDate_4, List<String> titaHCode_5, int acDate_6, String titaTlrNo_7, String titaTxtNo_8,
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findIntEndDateEq " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " + facmNo_1 + " bormNo_2 : " + bormNo_2 + " bormNo_3 : " + bormNo_3 + " intEndDate_4 : "
				+ intEndDate_4 + " titaHCode_5 : " + titaHCode_5 + " acDate_6 : " + acDate_6 + " titaTlrNo_7 : " + titaTlrNo_7 + " titaTxtNo_8 : " + titaTxtNo_8);
		if (dbName.equals(ContentName.onDay))
			slice = loanBorTxReposDay.findAllByCustNoIsAndFacmNoIsAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndIntEndDateIsAndTitaHCodeInAndAcDateIsAndTitaTlrNoIsAndTitaTxtNoIsOrderByBormNoAsc(
					custNo_0, facmNo_1, bormNo_2, bormNo_3, intEndDate_4, titaHCode_5, acDate_6, titaTlrNo_7, titaTxtNo_8, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = loanBorTxReposMon.findAllByCustNoIsAndFacmNoIsAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndIntEndDateIsAndTitaHCodeInAndAcDateIsAndTitaTlrNoIsAndTitaTxtNoIsOrderByBormNoAsc(
					custNo_0, facmNo_1, bormNo_2, bormNo_3, intEndDate_4, titaHCode_5, acDate_6, titaTlrNo_7, titaTxtNo_8, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = loanBorTxReposHist.findAllByCustNoIsAndFacmNoIsAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndIntEndDateIsAndTitaHCodeInAndAcDateIsAndTitaTlrNoIsAndTitaTxtNoIsOrderByBormNoAsc(
					custNo_0, facmNo_1, bormNo_2, bormNo_3, intEndDate_4, titaHCode_5, acDate_6, titaTlrNo_7, titaTxtNo_8, pageable);
		else
			slice = loanBorTxRepos.findAllByCustNoIsAndFacmNoIsAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndIntEndDateIsAndTitaHCodeInAndAcDateIsAndTitaTlrNoIsAndTitaTxtNoIsOrderByBormNoAsc(
					custNo_0, facmNo_1, bormNo_2, bormNo_3, intEndDate_4, titaHCode_5, acDate_6, titaTlrNo_7, titaTxtNo_8, pageable);
	...
	@Override
	public Slice<LoanBorTx> borxIntEndDateDescRange(int custNo_0, int facmNo_1, int facmNo_2, int bormNo_3, int bormNo_4, int entryDate_5, int entryDate_6, List<String> displayflag_7, int index,
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("borxIntEndDateDescRange " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " + facmNo_1 + " facmNo_2 : " + facmNo_2 + " bormNo_3 : " + bormNo_3 + " bormNo_4 : " + bormNo_4
				+ " entryDate_5 : " + entryDate_5 + " entryDate_6 : " + entryDate_6 + " displayflag_7 : " + displayflag_7);
		if (dbName.equals(ContentName.onDay))
			slice = loanBorTxReposDay
