...
public class JcicB095 implements Serializable {
	...
	public String toString() {
		return "JcicB095 [jcicB095Id=" + jcicB095Id + ", dataType=" + dataType + ", bankItem=" + bankItem + ", branchItem=" + branchItem + ", filler4=" + filler4
				...
				+ ", totalFloor=" + totalFloor + ", floorNo=" + floorNo + ", bdDate=" + bdDate + ", totalArea=" + totalArea + ", floorArea=" + floorArea + ", bdSubArea=" + bdSubArea + ", publicArea="
				+ publicArea + ", filler33=" + filler33 + ", jcicDataYM=" + jcicDataYM + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
