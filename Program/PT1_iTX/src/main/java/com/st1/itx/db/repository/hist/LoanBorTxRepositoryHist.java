...
public interface LoanBorTxRepositoryHist extends JpaRepository<LoanBorTx, LoanBorTxId> {
  ...
  public Slice<LoanBorTx> findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndAcDateGreaterThanEqualAndAcDateLessThanEqualAndDisplayflagInOrderByAcDateAscCreateDateAscDisplayflagAscFacmNoAscBormNoAsc(int custNo_0, int facmNo_1, int facmNo_2, int bormNo_3, int bormNo_4, int acDate_5, int acDate_6, List<String> displayflag_7, Pageable pageable);
  ...
  public Slice<LoanBorTx> findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndDisplayflagInOrderByAcDateAscCreateDateAscDisplayflagAsc(int custNo_0, int facmNo_1, int facmNo_2, int bormNo_3, int bormNo_4, int entryDate_5, int entryDate_6, List<String> displayflag_7, Pageable pageable);
