...
//					}
	...
	private void genExcel(TitaVo titaVo, List<Map<String, String>> LBList) throws LogicException {
		...
		inf = "總行代號(1~3),分行代號(4~7),交易代碼(8),帳號屬性註記(9),本筆撥款帳號(10~59),"
				...
				+ "債權處理案號(321~334),債權轉讓年月/債權轉讓後原債權機構買回年月(335~339),購地貸款註記(340),約定動工年月(341~345),擔保品組合型態(346),擔保品(合計)鑑估值(347~356),"
				+ "擔保品類別(357~358),國內或國際聯貸(359),聯貸合約訂定日期(360~367),聯貸參貸比例(368~371),空白(372~374),"
