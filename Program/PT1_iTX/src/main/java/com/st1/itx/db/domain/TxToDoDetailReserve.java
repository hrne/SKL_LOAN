...
// 序號
  @Id
  @Column(name = "`LogNo`")
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "`TxToDoDetailReserve_SEQ`")
  @SequenceGenerator(name = "`TxToDoDetailReserve_SEQ`", sequenceName = "`TxToDoDetailReserve_SEQ`", allocationSize = 1)
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "TxToDoDetailReserve [logNo=" + logNo + ", itemCode=" + itemCode + ", custNo=" + custNo + ", facmNo=" + facmNo + ", bormNo=" + bormNo + ", dtlValue=" + dtlValue
           + ", status=" + status + ", processNote=" + processNote + ", excuteTxcd=" + excuteTxcd + ", dataDate=" + dataDate + ", titaEntdy=" + titaEntdy + ", titaKinbr=" + titaKinbr
