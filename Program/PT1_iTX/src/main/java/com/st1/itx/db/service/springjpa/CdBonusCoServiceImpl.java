...
@Repository
public class CdBonusCoServiceImpl extends ASpringJpaParm implements CdBonusCoService, InitializingBean {
	@Autowired
	...
	public CdBonusCo findById(CdBonusCoId cdBonusCoId, TitaVo... titaVo) {
		...
		this.info("findById " + dbName + " " + cdBonusCoId);
	...
	public Slice<CdBonusCo> findCondition(int workMonth_0, int conditionCode_1, String condition_2, String condition_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = cdBonusCoReposDay.findAllByWorkMonthIsAndConditionCodeIsAndConditionGreaterThanEqualAndConditionLessThanEqualOrderByWorkMonthAscConditionCodeAscConditionAsc(workMonth_0,
					conditionCode_1, condition_2, condition_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = cdBonusCoReposMon.findAllByWorkMonthIsAndConditionCodeIsAndConditionGreaterThanEqualAndConditionLessThanEqualOrderByWorkMonthAscConditionCodeAscConditionAsc(workMonth_0,
					conditionCode_1, condition_2, condition_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = cdBonusCoReposHist.findAllByWorkMonthIsAndConditionCodeIsAndConditionGreaterThanEqualAndConditionLessThanEqualOrderByWorkMonthAscConditionCodeAscConditionAsc(workMonth_0,
					conditionCode_1, condition_2, condition_3, pageable);
		else
			slice = cdBonusCoRepos.findAllByWorkMonthIsAndConditionCodeIsAndConditionGreaterThanEqualAndConditionLessThanEqualOrderByWorkMonthAscConditionCodeAscConditionAsc(workMonth_0,
					conditionCode_1, condition_2, condition_3, pageable);
	...
	public CdBonusCo holdById(CdBonusCoId cdBonusCoId, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Hold " + dbName + " " + cdBonusCoId);
		Optional<CdBonusCo> cdBonusCo = null;
		if (dbName.equals(ContentName.onDay))
	...
	public CdBonusCo holdById(CdBonusCo cdBonusCo, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Hold " + dbName + " " + cdBonusCo.getCdBonusCoId());
		Optional<CdBonusCo> cdBonusCoT = null;
		if (dbName.equals(ContentName.onDay))
	...
	public CdBonusCo insert(CdBonusCo cdBonusCo, TitaVo... titaVo) throws DBException {
		...
		this.info("Insert..." + dbName + " " + cdBonusCo.getCdBonusCoId());
	...
	public CdBonusCo update(CdBonusCo cdBonusCo, TitaVo... titaVo) throws DBException {
		...
		this.info("Update..." + dbName + " " + cdBonusCo.getCdBonusCoId());
		if (!empNot.isEmpty())
			cdBonusCo.setLastUpdateEmpNo(empNot);
	...
	public void delete(CdBonusCo cdBonusCo, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Delete..." + dbName + " " + cdBonusCo.getCdBonusCoId());
		if (dbName.equals(ContentName.onDay)) {
