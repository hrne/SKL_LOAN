...
public class NegFinShare implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 534609580323414753L;
	...
	public String toString() {
		return "NegFinShare [negFinShareId=" + negFinShareId + ", contractAmt=" + contractAmt + ", amtRatio=" + amtRatio + ", dueAmt=" + dueAmt + ", cancelDate=" + cancelDate + ", cancelAmt="
				+ cancelAmt + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
