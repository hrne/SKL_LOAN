...
public class HlThreeLaqhcp implements Serializable {
	...
	// 年月日
	@Column(name = "`CalDate`", insertable = false, updatable = false)
	...
	public String toString() {
		return "HlThreeLaqhcp [hlThreeLaqhcpId=" + hlThreeLaqhcpId + ", empNo=" + empNo + ", unitName=" + unitName + ", distName=" + distName + ", deptName=" + deptName + ", empName=" + empName
				+ ", departOfficer=" + departOfficer + ", directorCode=" + directorCode + ", goalNum=" + goalNum + ", goalAmt=" + goalAmt + ", actNum=" + actNum + ", actAmt=" + actAmt + ", actRate="
				+ actRate + ", tGoalNum=" + tGoalNum + ", tGoalAmt=" + tGoalAmt + ", tActNum=" + tActNum + ", tActAmt=" + tActAmt + ", tActRate=" + tActRate + ", upNo=" + upNo + ", processDate="
				+ processDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
