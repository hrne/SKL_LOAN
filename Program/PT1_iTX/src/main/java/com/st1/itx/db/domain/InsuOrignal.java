...
@EmbeddedId
  ...
  // 保險類別
  /* CdCode.InsuTypeCode01:住宅火險地震險02:住宅火險(長單)03:地震險04:汽車全險(目前已停用)05:綜合營造險(目前已停用)06:動產火險07:其他08:商業火災保險 */
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "InsuOrignal [insuOrignalId=" + insuOrignalId + ", insuCompany=" + insuCompany
           ...
           + ", insuEndDate=" + insuEndDate + ", commericalFlag=" + commericalFlag + ", insuReceiptDate=" + insuReceiptDate + ", remark=" + remark + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
