...
em = null;
  ...
  public TxAmlRating caseNoDescFirst(String caseNo_0, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("caseNoDescFirst " + dbName + " : " + "caseNo_0 : " + caseNo_0);
    Optional<TxAmlRating> txAmlRatingT = null;
    if (dbName.equals(ContentName.onDay))
      txAmlRatingT = txAmlRatingReposDay.findTopByCaseNoIsOrderByCaseNoAsc(caseNo_0);
    else if (dbName.equals(ContentName.onMon))
      txAmlRatingT = txAmlRatingReposMon.findTopByCaseNoIsOrderByCaseNoAsc(caseNo_0);
    else if (dbName.equals(ContentName.onHist))
      txAmlRatingT = txAmlRatingReposHist.findTopByCaseNoIsOrderByCaseNoAsc(caseNo_0);
    else 
      txAmlRatingT = txAmlRatingRepos.findTopByCaseNoIsOrderByCaseNoAsc(caseNo_0);
  ...
  public TxAmlRating insert(TxAmlRating txAmlRating, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(txAmlRating.getLogNo(), titaVo) != null)
