...
public class CdBankOld implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7241917622352364421L;
	...
	public String toString() {
		return "CdBankOld [cdBankOldId=" + cdBankOldId + ", bankItem=" + bankItem + ", branchItem=" + branchItem + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate="
