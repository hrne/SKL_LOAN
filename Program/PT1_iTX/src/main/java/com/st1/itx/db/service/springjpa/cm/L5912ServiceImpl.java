...
public class L5912ServiceImpl extends ASpringJpaParm implements InitializingBean {
	...
	public List<Map<String, String>> findDetail(int StartDate, int EndDate, TitaVo titaVo) throws Exception {
		...
		String sql = "select a.\"CustNo\"," + " a.\"FacmNo\"," + " a.\"BormNo\"," + " a.\"DrawdownAmt\"," + " a.\"DrawdownDate\"," + " d.\"MaturityDate\"," + " b.\"RepayBank\"," + " a.\"PieceCode\","
				+ " a.\"BsOfficer\"," + " c.\"Fullname\"," + " e.\"DepItem\"," + " e.\"DistItem\"" + " from \"PfBsDetail\" a  "
	...
	public List<Map<String, String>> findData(int StartDate, int EndDate, TitaVo titaVo) throws Exception {
		Query query;
		EntityManager em = this.baseEntityManager.getCurrentEntityManager(titaVo);
		String sql = "select * from (select y.\"BsOfficer\",y.\"Fullname\",y.\"DistItem\",y.\"DepItem\",count(y.\"BsOfficer\") as \"Total\" from (" + "select " + "a.\"CustNo\", " + "a.\"FacmNo\", "
				+ "a.\"BormNo\", " + "a.\"DrawdownAmt\", " + "a.\"DrawdownDate\", " + "d.\"MaturityDate\", " + "b.\"RepayBank\"," + "a.\"PieceCode\"," + "a.\"BsOfficer\"," + "c.\"Fullname\","
				+ "e.\"DepItem\"," + "e.\"DistItem\" " + "from \"PfBsDetail\" a  " + "left join \"BankAuthAct\" b on a.\"CustNo\" = b.\"CustNo\" and a.\"FacmNo\" = b.\"FacmNo\"  "
				+ "left join \"CdEmp\" c on c.\"EmployeeNo\" = a.\"BsOfficer\"  "
				+ "left join \"LoanBorMain\" d on a.\"CustNo\" = d.\"CustNo\" and a.\"FacmNo\" = d.\"FacmNo\" and a.\"BormNo\" = d.\"BormNo\"  "
				+ "left join \"PfBsOfficer\" e on a.\"WorkMonth\" = e.\"WorkMonth\" and a.\"BsOfficer\" = e.\"EmpNo\" where b.\"Status\" != '1'       "
				+ "and a.\"DrawdownDate\" between :StartDate and :EndDate      and a.\"BsOfficer\" is not null and e.\"DepItem\" is not null and e.\"DistItem\" is not null and b.\"AuthType\" in ('00','01')"
				...
				+ "select " + "a.\"CustNo\", " + "a.\"FacmNo\", " + "a.\"BormNo\", " + "a.\"DrawdownAmt\", " + "a.\"DrawdownDate\", " + "d.\"MaturityDate\", " + "b.\"RepayBank\"," + "a.\"PieceCode\","
				+ "a.\"BsOfficer\"," + "c.\"Fullname\"," + "e.\"DepItem\"," + "e.\"DistItem\" " + "from \"PfBsDetail\" a  "
				+ "left join \"BankAuthAct\" b on a.\"CustNo\" = b.\"CustNo\" and a.\"FacmNo\" = b.\"FacmNo\"  " + "left join \"CdEmp\" c on c.\"EmployeeNo\" = a.\"BsOfficer\"  "
				+ "left join \"LoanBorMain\" d on a.\"CustNo\" = d.\"CustNo\" and a.\"FacmNo\" = d.\"FacmNo\" and a.\"BormNo\" = d.\"BormNo\"  "
				+ "left join \"PfBsOfficer\" e on a.\"WorkMonth\" = e.\"WorkMonth\" and a.\"BsOfficer\" = e.\"EmpNo\" where b.\"Status\" != '1'       "
