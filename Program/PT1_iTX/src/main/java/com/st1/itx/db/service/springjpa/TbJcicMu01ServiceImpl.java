...
em = null;
  ...
  public Slice<TbJcicMu01> findAll(int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by(Sort.Direction.ASC, "HeadOfficeCode", "BranchCode", "EmpId"));
    else
         pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "HeadOfficeCode", "BranchCode", "EmpId"));
  ...
  public TbJcicMu01 insert(TbJcicMu01 tbJcicMu01, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(tbJcicMu01.getTbJcicMu01Id(), titaVo) != null)
