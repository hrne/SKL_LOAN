 ...
 * @version 1.0.0
 */
public class L6CdStockIns extends BatchBase implements Tasklet, InitializingBean {
	...
	public void run() throws LogicException {
		this.info("active L6CdStockIns ");

		String empNo = titaVo.getTlrNo();

		String txSeq = titaVo.getParam("JobTxSeq");

		sJobMainService.Usp_L6_CdStock_Ins(empNo, txSeq, titaVo);
	}
