...
public class JcicZ440 implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5544472523235502167L;
	...
	public String toString() {
		return "JcicZ440 [jcicZ440Id=" + jcicZ440Id + ", tranKey=" + tranKey + ", agreeDate=" + agreeDate + ", startDate=" + startDate + ", remindDate=" + remindDate + ", applyType=" + applyType
				+ ", reportYn=" + reportYn + ", notBankId1=" + notBankId1 + ", notBankId2=" + notBankId2 + ", notBankId3=" + notBankId3 + ", notBankId4=" + notBankId4 + ", notBankId5=" + notBankId5
