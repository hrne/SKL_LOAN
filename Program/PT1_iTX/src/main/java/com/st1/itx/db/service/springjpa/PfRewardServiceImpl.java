...
em = null;
  ...
  public Slice<PfReward> findByWorkMonth(int workMonth_0, int workMonth_1, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      slice = pfRewardReposDay.findAllByWorkMonthGreaterThanEqualAndWorkMonthLessThanEqualOrderByCustNoAscFacmNoAscBormNoAscWorkMonthDesc(workMonth_0, workMonth_1, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = pfRewardReposMon.findAllByWorkMonthGreaterThanEqualAndWorkMonthLessThanEqualOrderByCustNoAscFacmNoAscBormNoAscWorkMonthDesc(workMonth_0, workMonth_1, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = pfRewardReposHist.findAllByWorkMonthGreaterThanEqualAndWorkMonthLessThanEqualOrderByCustNoAscFacmNoAscBormNoAscWorkMonthDesc(workMonth_0, workMonth_1, pageable);
    else 
      slice = pfRewardRepos.findAllByWorkMonthGreaterThanEqualAndWorkMonthLessThanEqualOrderByCustNoAscFacmNoAscBormNoAscWorkMonthDesc(workMonth_0, workMonth_1, pageable);
  ...
  public PfReward insert(PfReward pfReward, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(pfReward.getLogNo(), titaVo) != null)
