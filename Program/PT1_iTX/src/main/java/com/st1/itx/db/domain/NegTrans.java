...
public class NegTrans implements Serializable {
	 ...
	 * 期款3:提前還本-匯入款 &amp;gt;= 5期期款4:結清-匯入款＋溢收款 &amp;gt;=最後一期期款5:提前清償-匯入款＋溢收款
	 * &amp;gt;= 剩餘期款9:未處理※入帳訂正需在撥付產擋前，依反向順序訂正
	 */
	 ...
	 * 3:提前還本-匯入款 &amp;gt;= 5期期款 4:結清-匯入款＋溢收款 &amp;gt;=最後一期期款 5:提前清償-匯入款＋溢收款
	 * &amp;gt;= 剩餘期款 9:未處理 ※入帳訂正需在撥付產擋前，依反向順序訂正
	 * 
	 * @return String
	 */
	...
	/**
	 * 溢收抵繳金額<br>
	 * 暫收金額減還款金額，為負時 溢繳款=轉入溢收金額 - 溢收抵繳金額
	 * 
	 * @return BigDecimal
	 */
