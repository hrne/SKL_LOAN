...
public class LoanCustRmk implements Serializable {
	...
	public String toString() {
		return "LoanCustRmk [loanCustRmkId=" + loanCustRmkId + ", rmkCode=" + rmkCode + ", rmkDesc=" + rmkDesc + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate="
