...
public class JcicZ574 implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -2616894050920097184L;
...
/**
  ...
  * @param actualFilingMark 實際報送記號
  ...
  public String toString() {
    return "JcicZ574 [jcicZ574Id=" + jcicZ574Id + ", tranKey=" + tranKey + ", closeDate=" + closeDate + ", closeMark=" + closeMark
           + ", phoneNo=" + phoneNo + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
