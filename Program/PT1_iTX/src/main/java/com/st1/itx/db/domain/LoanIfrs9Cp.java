...
@Table(name = "`LoanIfrs9Cp`")
public class LoanIfrs9Cp implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -776474839271056369L;

	@EmbeddedId
	private LoanIfrs9CpId loanIfrs9CpId;
	...
	public LoanIfrs9CpId getLoanIfrs9CpId() {
		return this.loanIfrs9CpId;
	}

	public void setLoanIfrs9CpId(LoanIfrs9CpId loanIfrs9CpId) {
		this.loanIfrs9CpId = loanIfrs9CpId;
	}
	...
	public String toString() {
		return "LoanIfrs9Cp [loanIfrs9CpId=" + loanIfrs9CpId + ", custId=" + custId + ", amortizedCode=" + amortizedCode + ", payIntFreq=" + payIntFreq + ", repayFreq=" + repayFreq + ", createDate="
