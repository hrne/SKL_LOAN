...
public class LC004ServiceImpl extends ASpringJpaParm implements InitializingBean {
	...
	public List<Map<String, String>> findAll(TitaVo titaVo, int index, int limit) throws Exception {
		...
		sql += " left join \"TxRecord\" E on E.\"OrgEntdy\"=A.\"Entdy\" ";
		sql += "                         and E.\"TxNo\" = A.\"TxNo2\" ";
		...
		sql += "   and A.\"FlowMode\"= 2 "; // 流程模式 1.待放行 2.待審核 3.待提交 9.已結案
		sql += "   and A.\"FlowStep\" in (2) "; // 流程步驟 1.登錄 2.放行 3.審核 4.審核放行
		sql += "   and A.\"FlowType\" in (4) "; // 流程類別 2:兩段式 4.四段式
		sql += "   and A.\"BrNo\"=:brno";
		...
		this.info("LC004ServiceImpl sql=" + sql);
		Query query;
