...
em = null;
  ...
  public Slice<CustDataCtrl> findCustId(String custId_0, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("findCustId " + dbName + " : " + "custId_0 : " + custId_0);
    if (dbName.equals(ContentName.onDay))
      slice = custDataCtrlReposDay.findAllByCustIdIs(custId_0, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = custDataCtrlReposMon.findAllByCustIdIs(custId_0, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = custDataCtrlReposHist.findAllByCustIdIs(custId_0, pageable);
    else 
      slice = custDataCtrlRepos.findAllByCustIdIs(custId_0, pageable);
  ...
  public Slice<CustDataCtrl> applMarkCustNo(List<Integer> applMark_0, int custNo_1, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("applMarkCustNo " + dbName + " : " + "applMark_0 : " + applMark_0 + " custNo_1 : " +  custNo_1);
    if (dbName.equals(ContentName.onDay))
      slice = custDataCtrlReposDay.findAllByApplMarkInAndCustNoIs(applMark_0, custNo_1, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = custDataCtrlReposMon.findAllByApplMarkInAndCustNoIs(applMark_0, custNo_1, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = custDataCtrlReposHist.findAllByApplMarkInAndCustNoIs(applMark_0, custNo_1, pageable);
    else 
      slice = custDataCtrlRepos.findAllByApplMarkInAndCustNoIs(applMark_0, custNo_1, pageable);
  ...
  public Slice<CustDataCtrl> applMarkCustUKey(List<Integer> applMark_0, String custUKey_1, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("applMarkCustUKey " + dbName + " : " + "applMark_0 : " + applMark_0 + " custUKey_1 : " +  custUKey_1);
    if (dbName.equals(ContentName.onDay))
      slice = custDataCtrlReposDay.findAllByApplMarkInAndCustUKeyIs(applMark_0, custUKey_1, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = custDataCtrlReposMon.findAllByApplMarkInAndCustUKeyIs(applMark_0, custUKey_1, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = custDataCtrlReposHist.findAllByApplMarkInAndCustUKeyIs(applMark_0, custUKey_1, pageable);
    else 
      slice = custDataCtrlRepos.findAllByApplMarkInAndCustUKeyIs(applMark_0, custUKey_1, pageable);
  ...
  public Slice<CustDataCtrl> applMarkCustId(List<Integer> applMark_0, String custId_1, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("applMarkCustId " + dbName + " : " + "applMark_0 : " + applMark_0 + " custId_1 : " +  custId_1);
    if (dbName.equals(ContentName.onDay))
      slice = custDataCtrlReposDay.findAllByApplMarkInAndCustIdIs(applMark_0, custId_1, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = custDataCtrlReposMon.findAllByApplMarkInAndCustIdIs(applMark_0, custId_1, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = custDataCtrlReposHist.findAllByApplMarkInAndCustIdIs(applMark_0, custId_1, pageable);
    else 
      slice = custDataCtrlRepos.findAllByApplMarkInAndCustIdIs(applMark_0, custId_1, pageable);
  ...
  public Slice<CustDataCtrl> applMarkAll(List<Integer> applMark_0, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("applMarkAll " + dbName + " : " + "applMark_0 : " + applMark_0);
    if (dbName.equals(ContentName.onDay))
      slice = custDataCtrlReposDay.findAllByApplMarkInOrderByCustNoAsc(applMark_0, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = custDataCtrlReposMon.findAllByApplMarkInOrderByCustNoAsc(applMark_0, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = custDataCtrlReposHist.findAllByApplMarkInOrderByCustNoAsc(applMark_0, pageable);
    else 
      slice = custDataCtrlRepos.findAllByApplMarkInOrderByCustNoAsc(applMark_0, pageable);
  ...
  public CustDataCtrl insert(CustDataCtrl custDataCtrl, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(custDataCtrl.getCustNo(), titaVo) != null)
