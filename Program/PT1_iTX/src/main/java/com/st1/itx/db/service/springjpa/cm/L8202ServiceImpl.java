...
public class L8202ServiceImpl extends ASpringJpaParm implements InitializingBean {
	...
	public List<Map<String, String>> findAll1(TitaVo titaVo) throws Exception {
...
//		this.info("findAll1 iFactor2AmtEnd = " + iFactor2AmtEnd);
		this.info("findAll1 iFactorDays = " + iFactorDays);
		...
		sql += ", summaryCustNo AS (                       ";//本次區間的筆數與金額統計BY戶號
		sql += "    SELECT \"CustNo\"                         AS \"CustNo\"      ";
		sql += "         , SUM(\"Factor1Cnt\")                AS \"Factor1Cnt\"  ";
		sql += "         , SUM(\"Factor1Amt\")                AS \"Factor1Amt\"  ";
		sql += "         , SUM(\"Factor2Cnt\")                AS \"Factor2Cnt\"  ";
		sql += "         , SUM(\"Factor2Amt\")                AS \"Factor2Amt\"  ";
		sql += "    FROM summaryData  ";
		sql += "    GROUP BY \"CustNo\" ";
		sql += ")  ";
...
//		sql += "        THEN 2 ";
	...
	public List<Map<String, String>> findAll2(TitaVo titaVo) throws Exception {
		...
		String iFactor2AmtStart = titaVo.getParam("Factor2AmtStart"); // 洗錢樣態二單筆起始金額
		String iFactor2AmtEnd = titaVo.getParam("Factor2AmtEnd"); // 洗錢樣態二單筆迄止金額
		String iFactorDays = titaVo.getParam("FactorDays2"); // 統計期間天數
		int iEntryDateS = Integer.parseInt(titaVo.getParam("EntryDateSL2")) + 19110000; // 入帳日期起日
...
//		sql += "        THEN 1 ";
	...
	public List<Map<String, String>> findAll3(TitaVo titaVo) throws Exception {
		...
		sql += ", summaryCustNo AS (                       ";//本次區間的筆數與金額統計BY戶號
		sql += "    SELECT \"CustNo\"                         AS \"CustNo\"      ";
		sql += "         , SUM(\"Factor3Cnt\")                AS \"Factor3Cnt\"  ";
		sql += "         , SUM(\"Factor3Amt\")                AS \"Factor3Amt\"  ";
		sql += "    FROM bankRmtfData  ";
		sql += "    GROUP BY \"CustNo\" ";
		sql += ")  ";
...
//		sql += "     , F.\"Factor3Amt\"                          AS F9 \n"; // 洗錢樣態三累計金額
	...
	public List<Map<String, String>> findChkDtl1(TitaVo titaVo) throws Exception {
//		String iFactor2AmtStart = titaVo.getParam("Factor2AmtStart"); // 洗錢樣態二單筆起始金額
//		String iFactor2AmtEnd = titaVo.getParam("Factor2AmtEnd"); // 洗錢樣態二單筆迄止金額
		String sql = "　";
		int iEntryDateS = Integer.parseInt(titaVo.getParam("EntryDateSL")) + 19110000; // 入帳日期起日
...
//		sql += "                  THEN 1                                 \n";
	...
	public List<Map<String, String>> findChkDtl2(TitaVo titaVo) throws Exception {
		String iFactor2AmtStart = titaVo.getParam("Factor2AmtStart"); // 洗錢樣態二單筆起始金額
		String iFactor2AmtEnd = titaVo.getParam("Factor2AmtEnd"); // 洗錢樣態二單筆迄止金額
		String sql = "　";
		int iEntryDateS = Integer.parseInt(titaVo.getParam("EntryDateSL2")) + 19110000; // 入帳日期起日
...
//		sql += " WHERE (CASE WHEN F.\"Factor\" = 1                       \n";
//		sql += "                  THEN 1                                 \n";
		sql += " WHERE (CASE WHEN F.\"Factor\" = 2                       \n";
		sql += "              AND F.\"TxAmt\" >= " + iFactor2AmtStart + "\n";
		sql += "              AND F.\"TxAmt\" <= " + iFactor2AmtEnd + "\n";
		sql += "                  THEN 1                                 \n";
		sql += "        END ) > 0                                        \n";
