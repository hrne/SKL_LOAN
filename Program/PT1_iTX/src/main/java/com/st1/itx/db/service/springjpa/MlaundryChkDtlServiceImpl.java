...
em = null;
  ...
  public Slice<MlaundryChkDtl> findEntryDateRangeFactorCustNo(int entryDate_0, int entryDate_1, int factor_2, int custNo_3, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("findEntryDateRangeFactorCustNo " + dbName + " : " + "entryDate_0 : " + entryDate_0 + " entryDate_1 : " +  entryDate_1 + " factor_2 : " +  factor_2 + " custNo_3 : " +  custNo_3);
    if (dbName.equals(ContentName.onDay))
      slice = mlaundryChkDtlReposDay.findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsAndCustNoIsOrderByEntryDateAscDtlSeqAsc(entryDate_0, entryDate_1, factor_2, custNo_3, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = mlaundryChkDtlReposMon.findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsAndCustNoIsOrderByEntryDateAscDtlSeqAsc(entryDate_0, entryDate_1, factor_2, custNo_3, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = mlaundryChkDtlReposHist.findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsAndCustNoIsOrderByEntryDateAscDtlSeqAsc(entryDate_0, entryDate_1, factor_2, custNo_3, pageable);
    else 
      slice = mlaundryChkDtlRepos.findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsAndCustNoIsOrderByEntryDateAscDtlSeqAsc(entryDate_0, entryDate_1, factor_2, custNo_3, pageable);
  ...
  @Override
  public Slice<MlaundryChkDtl> findDtlEntryDate(int dtlEntryDate_0, int dtlEntryDate_1, int index, int limit, TitaVo... titaVo) {
    String dbName = "";
    Slice<MlaundryChkDtl> slice = null;
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
  ...
  @Override
  public Slice<MlaundryChkDtl> DtlEntryDateFactor(int dtlEntryDate_0, int dtlEntryDate_1, int factor_2, int index, int limit, TitaVo... titaVo) {
    String dbName = "";
    Slice<MlaundryChkDtl> slice = null;
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("DtlEntryDateFactor " + dbName + " : " + "dtlEntryDate_0 : " + dtlEntryDate_0 + " dtlEntryDate_1 : " +  dtlEntryDate_1 + " factor_2 : " +  factor_2);
    if (dbName.equals(ContentName.onDay))
      slice = mlaundryChkDtlReposDay.findAllByDtlEntryDateGreaterThanEqualAndDtlEntryDateLessThanEqualAndFactorIsOrderByDtlEntryDateAscCustNoAscDtlSeqAsc(dtlEntryDate_0, dtlEntryDate_1, factor_2, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = mlaundryChkDtlReposMon.findAllByDtlEntryDateGreaterThanEqualAndDtlEntryDateLessThanEqualAndFactorIsOrderByDtlEntryDateAscCustNoAscDtlSeqAsc(dtlEntryDate_0, dtlEntryDate_1, factor_2, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = mlaundryChkDtlReposHist.findAllByDtlEntryDateGreaterThanEqualAndDtlEntryDateLessThanEqualAndFactorIsOrderByDtlEntryDateAscCustNoAscDtlSeqAsc(dtlEntryDate_0, dtlEntryDate_1, factor_2, pageable);
    else 
      slice = mlaundryChkDtlRepos.findAllByDtlEntryDateGreaterThanEqualAndDtlEntryDateLessThanEqualAndFactorIsOrderByDtlEntryDateAscCustNoAscDtlSeqAsc(dtlEntryDate_0, dtlEntryDate_1, factor_2, pageable);
  ...
  @Override
  public Slice<MlaundryChkDtl> findDtlEntryDateRangeFactorCustNo(int dtlEntryDate_0, int dtlEntryDate_1, int factor_2, int custNo_3, int index, int limit, TitaVo... titaVo) {
    String dbName = "";
    Slice<MlaundryChkDtl> slice = null;
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("findDtlEntryDateRangeFactorCustNo " + dbName + " : " + "dtlEntryDate_0 : " + dtlEntryDate_0 + " dtlEntryDate_1 : " +  dtlEntryDate_1 + " factor_2 : " +  factor_2 + " custNo_3 : " +  custNo_3);
    if (dbName.equals(ContentName.onDay))
      slice = mlaundryChkDtlReposDay.findAllByDtlEntryDateGreaterThanEqualAndDtlEntryDateLessThanEqualAndFactorIsAndCustNoIsOrderByDtlEntryDateAscDtlSeqAsc(dtlEntryDate_0, dtlEntryDate_1, factor_2, custNo_3, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = mlaundryChkDtlReposMon.findAllByDtlEntryDateGreaterThanEqualAndDtlEntryDateLessThanEqualAndFactorIsAndCustNoIsOrderByDtlEntryDateAscDtlSeqAsc(dtlEntryDate_0, dtlEntryDate_1, factor_2, custNo_3, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = mlaundryChkDtlReposHist.findAllByDtlEntryDateGreaterThanEqualAndDtlEntryDateLessThanEqualAndFactorIsAndCustNoIsOrderByDtlEntryDateAscDtlSeqAsc(dtlEntryDate_0, dtlEntryDate_1, factor_2, custNo_3, pageable);
    else 
      slice = mlaundryChkDtlRepos.findAllByDtlEntryDateGreaterThanEqualAndDtlEntryDateLessThanEqualAndFactorIsAndCustNoIsOrderByDtlEntryDateAscDtlSeqAsc(dtlEntryDate_0, dtlEntryDate_1, factor_2, custNo_3, pageable);
  ...
  public MlaundryChkDtl insert(MlaundryChkDtl mlaundryChkDtl, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(mlaundryChkDtl.getMlaundryChkDtlId(), titaVo) != null)
