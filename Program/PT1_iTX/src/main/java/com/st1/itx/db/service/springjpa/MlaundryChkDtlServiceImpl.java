...
public class MlaundryChkDtlServiceImpl extends ASpringJpaParm implements MlaundryChkDtlService, InitializingBean {
	...
	public Slice<MlaundryChkDtl> findEntryDateRangeFactorCustNo(int entryDate_0, int entryDate_1, int factor_2, int custNo_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = mlaundryChkDtlReposDay.findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsAndCustNoIsOrderByEntryDateAscDtlSeqAsc(entryDate_0, entryDate_1, factor_2, custNo_3,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = mlaundryChkDtlReposMon.findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsAndCustNoIsOrderByEntryDateAscDtlSeqAsc(entryDate_0, entryDate_1, factor_2, custNo_3,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = mlaundryChkDtlReposHist.findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsAndCustNoIsOrderByEntryDateAscDtlSeqAsc(entryDate_0, entryDate_1, factor_2, custNo_3,
					pageable);
		else
			slice = mlaundryChkDtlRepos.findAllByEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndFactorIsAndCustNoIsOrderByEntryDateAscDtlSeqAsc(entryDate_0, entryDate_1, factor_2, custNo_3,
					pageable);
