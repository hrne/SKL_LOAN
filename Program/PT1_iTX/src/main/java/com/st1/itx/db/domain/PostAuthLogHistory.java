...
// 序號
	...
	// 核印註記
	/* CdCode.StampCode1:局帳號不符2:戶名不符3:身分證號不符4:印鑑不符9:其他 */
	...
	/**
	 * 核印註記<br>
	 * CdCode.StampCode 1:局帳號不符 2:戶名不符 3:身分證號不符 4:印鑑不符 9:其他
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "PostAuthLogHistory [logNo=" + logNo + ", custNo=" + custNo + ", facmNo=" + facmNo + ", authCode=" + authCode + ", authCreateDate=" + authCreateDate + ", authApplCode=" + authApplCode
				...
				+ ", processTime=" + processTime + ", stampFinishDate=" + stampFinishDate + ", stampCancelDate=" + stampCancelDate + ", stampCode=" + stampCode + ", postMediaCode=" + postMediaCode
				+ ", authErrorCode=" + authErrorCode + ", fileSeq=" + fileSeq + ", propDate=" + propDate + ", retrDate=" + retrDate + ", deleteDate=" + deleteDate + ", relationCode=" + relationCode
