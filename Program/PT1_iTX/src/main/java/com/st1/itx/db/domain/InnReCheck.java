...
public class InnReCheck implements Serializable {
	...
	// 條件代碼
	/*
	 * 01-個金3000萬以上02-企金3000萬以上03-個金2000萬以上小於3000萬、指定複審&amp;lt;&amp;gt;01,02,05,0604
	 * -個金100萬以上小於2000萬(新件)05-企金未達3000萬06-土地追蹤99-指定複審名單
	 */
	...
	/**
	 * 條件代碼<br>
	 * 01-個金3000萬以上 02-企金3000萬以上 03-個金2000萬以上小於3000萬、指定複審&amp;lt;&amp;gt;01,02,05,06
	 * 04-個金100萬以上小於2000萬(新件) 05-企金未達3000萬 06-土地追蹤 99-指定複審名單
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "InnReCheck [innReCheckId=" + innReCheckId + ", reCheckCode=" + reCheckCode + ", followMark=" + followMark + ", reChkYearMonth=" + reChkYearMonth + ", drawdownDate=" + drawdownDate
				+ ", loanBal=" + loanBal + ", evaluation=" + evaluation + ", custTypeItem=" + custTypeItem + ", usageItem=" + usageItem + ", cityItem=" + cityItem + ", reChkUnit=" + reChkUnit
				+ ", specifyFg=" + specifyFg + ", remark=" + remark + ", traceMonth=" + traceMonth + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
