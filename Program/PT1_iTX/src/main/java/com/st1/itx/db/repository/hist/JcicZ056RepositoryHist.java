...
public interface JcicZ056RepositoryHist extends JpaRepository<JcicZ056, JcicZ056Id> {
  ...
  public Slice<JcicZ056> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
