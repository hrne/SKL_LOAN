...
public class TxInquiryServiceImpl extends ASpringJpaParm implements TxInquiryService, InitializingBean {
	...
	public Slice<TxInquiry> findImportFg(int calDate_0, int calDate_1, String importFg_2, int custNo_3, int custNo_4, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = txInquiryReposDay.findAllByCalDateGreaterThanEqualAndCalDateLessThanEqualAndImportFgIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCreateDateAsc(calDate_0, calDate_1,
					importFg_2, custNo_3, custNo_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txInquiryReposMon.findAllByCalDateGreaterThanEqualAndCalDateLessThanEqualAndImportFgIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCreateDateAsc(calDate_0, calDate_1,
					importFg_2, custNo_3, custNo_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txInquiryReposHist.findAllByCalDateGreaterThanEqualAndCalDateLessThanEqualAndImportFgIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCreateDateAsc(calDate_0, calDate_1,
					importFg_2, custNo_3, custNo_4, pageable);
		else
			slice = txInquiryRepos.findAllByCalDateGreaterThanEqualAndCalDateLessThanEqualAndImportFgIsAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCreateDateAsc(calDate_0, calDate_1,
					importFg_2, custNo_3, custNo_4, pageable);
