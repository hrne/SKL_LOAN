...
public class TxAmlCreditServiceImpl extends ASpringJpaParm implements TxAmlCreditService, InitializingBean {
	...
	public Slice<TxAmlCredit> processAll(List<String> reviewType_0, int dataDt_1, int dataDt_2, String processType_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = txAmlCreditReposDay.findAllByReviewTypeInAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeOrderByDataDtAscCustKeyAsc(reviewType_0, dataDt_1, dataDt_2,
					processType_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txAmlCreditReposMon.findAllByReviewTypeInAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeOrderByDataDtAscCustKeyAsc(reviewType_0, dataDt_1, dataDt_2,
					processType_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txAmlCreditReposHist.findAllByReviewTypeInAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeOrderByDataDtAscCustKeyAsc(reviewType_0, dataDt_1, dataDt_2,
					processType_3, pageable);
		else
			slice = txAmlCreditRepos.findAllByReviewTypeInAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeOrderByDataDtAscCustKeyAsc(reviewType_0, dataDt_1, dataDt_2, processType_3,
					pageable);
	...
	public Slice<TxAmlCredit> processNo(List<String> reviewType_0, int dataDt_1, int dataDt_2, String processType_3, int processCount_4, int index, int limit, TitaVo... titaVo) {
		...
		this.info("processNo " + dbName + " : " + "reviewType_0 : " + reviewType_0 + " dataDt_1 : " + dataDt_1 + " dataDt_2 : " + dataDt_2 + " processType_3 : " + processType_3 + " processCount_4 : "
				+ processCount_4);
		if (dbName.equals(ContentName.onDay))
			slice = txAmlCreditReposDay.findAllByReviewTypeInAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeAndProcessCountIsOrderByDataDtAscCustKeyAsc(reviewType_0, dataDt_1,
					dataDt_2, processType_3, processCount_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txAmlCreditReposMon.findAllByReviewTypeInAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeAndProcessCountIsOrderByDataDtAscCustKeyAsc(reviewType_0, dataDt_1,
					dataDt_2, processType_3, processCount_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txAmlCreditReposHist.findAllByReviewTypeInAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeAndProcessCountIsOrderByDataDtAscCustKeyAsc(reviewType_0, dataDt_1,
					dataDt_2, processType_3, processCount_4, pageable);
		else
			slice = txAmlCreditRepos.findAllByReviewTypeInAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeAndProcessCountIsOrderByDataDtAscCustKeyAsc(reviewType_0, dataDt_1, dataDt_2,
	...
	public Slice<TxAmlCredit> processYes(List<String> reviewType_0, int dataDt_1, int dataDt_2, String processType_3, int processCount_4, int index, int limit, TitaVo... titaVo) {
		...
		this.info("processYes " + dbName + " : " + "reviewType_0 : " + reviewType_0 + " dataDt_1 : " + dataDt_1 + " dataDt_2 : " + dataDt_2 + " processType_3 : " + processType_3 + " processCount_4 : "
				+ processCount_4);
		if (dbName.equals(ContentName.onDay))
			slice = txAmlCreditReposDay.findAllByReviewTypeInAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeAndProcessCountGreaterThanOrderByDataDtAscCustKeyAsc(reviewType_0,
					dataDt_1, dataDt_2, processType_3, processCount_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txAmlCreditReposMon.findAllByReviewTypeInAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeAndProcessCountGreaterThanOrderByDataDtAscCustKeyAsc(reviewType_0,
					dataDt_1, dataDt_2, processType_3, processCount_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txAmlCreditReposHist.findAllByReviewTypeInAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeAndProcessCountGreaterThanOrderByDataDtAscCustKeyAsc(reviewType_0,
					dataDt_1, dataDt_2, processType_3, processCount_4, pageable);
		else
			slice = txAmlCreditRepos.findAllByReviewTypeInAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeAndProcessCountGreaterThanOrderByDataDtAscCustKeyAsc(reviewType_0, dataDt_1,
					dataDt_2, processType_3, processCount_4, pageable);
