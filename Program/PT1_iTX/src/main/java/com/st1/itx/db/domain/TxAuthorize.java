...
// 序號
	...
	public String toString() {
		return "TxAuthorize [autoSeq=" + autoSeq + ", supNo=" + supNo + ", tlrNo=" + tlrNo + ", tradeReason=" + tradeReason + ", reasonFAJson=" + reasonFAJson + ", entdy=" + entdy + ", txcd=" + txcd
				+ ", txSeq=" + txSeq + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
