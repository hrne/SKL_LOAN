...
public interface JcicZ442RepositoryDay extends JpaRepository<JcicZ442, JcicZ442Id> {
  ...
  public Slice<JcicZ442> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
