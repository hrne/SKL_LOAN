...
// 資料年月
	...
	public boolean equals(Object obj) {
		...
		return dataYM == jcicB201Id.dataYM && bankItem.equals(jcicB201Id.bankItem) && branchItem.equals(jcicB201Id.branchItem) && tranCode.equals(jcicB201Id.tranCode)
				&& subTranCode.equals(jcicB201Id.subTranCode) && acctNo.equals(jcicB201Id.acctNo) && seqNo == jcicB201Id.seqNo;
	}

	@Override
	public String toString() {
		return "JcicB201Id [dataYM=" + dataYM + ", bankItem=" + bankItem + ", branchItem=" + branchItem + ", tranCode=" + tranCode + ", subTranCode=" + subTranCode + ", acctNo=" + acctNo + ", seqNo="
				+ seqNo + "]";
	}
}
