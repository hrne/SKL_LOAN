...
em = null;
  ...
  public Slice<TxDataLog> findByCustNo3(int txDate_0, int txDate_1, String tranNo_2, int custNo_3, int facmNo_4, int bormNo_5, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("findByCustNo3 " + dbName + " : " + "txDate_0 : " + txDate_0 + " txDate_1 : " +  txDate_1 + " tranNo_2 : " +  tranNo_2 + " custNo_3 : " +  custNo_3 + " facmNo_4 : " +  facmNo_4 + " bormNo_5 : " +  bormNo_5);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<TxDataLog> findByCustNo6(int txDate_0, int txDate_1, List<String> tranNo_2, int custNo_3, int facmNo_4, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      slice = txDataLogReposDay.findAllByTxDateGreaterThanEqualAndTxDateLessThanEqualAndTranNoInAndCustNoIsAndFacmNoIsOrderByCreateDateDesc(txDate_0, txDate_1, tranNo_2, custNo_3, facmNo_4, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = txDataLogReposMon.findAllByTxDateGreaterThanEqualAndTxDateLessThanEqualAndTranNoInAndCustNoIsAndFacmNoIsOrderByCreateDateDesc(txDate_0, txDate_1, tranNo_2, custNo_3, facmNo_4, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = txDataLogReposHist.findAllByTxDateGreaterThanEqualAndTxDateLessThanEqualAndTranNoInAndCustNoIsAndFacmNoIsOrderByCreateDateDesc(txDate_0, txDate_1, tranNo_2, custNo_3, facmNo_4, pageable);
    else 
      slice = txDataLogRepos.findAllByTxDateGreaterThanEqualAndTxDateLessThanEqualAndTranNoInAndCustNoIsAndFacmNoIsOrderByCreateDateDesc(txDate_0, txDate_1, tranNo_2, custNo_3, facmNo_4, pageable);
  ...
  public Slice<TxDataLog> findByCustNo7(int txDate_0, int txDate_1, List<String> tranNo_2, int custNo_3, int facmNo_4, int bormNo_5, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("findByCustNo7 " + dbName + " : " + "txDate_0 : " + txDate_0 + " txDate_1 : " +  txDate_1 + " tranNo_2 : " +  tranNo_2 + " custNo_3 : " +  custNo_3 + " facmNo_4 : " +  facmNo_4 + " bormNo_5 : " +  bormNo_5);
    if (dbName.equals(ContentName.onDay))
      slice = txDataLogReposDay.findAllByTxDateGreaterThanEqualAndTxDateLessThanEqualAndTranNoInAndCustNoIsAndFacmNoIsAndBormNoIsOrderByCreateDateDesc(txDate_0, txDate_1, tranNo_2, custNo_3, facmNo_4, bormNo_5, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = txDataLogReposMon.findAllByTxDateGreaterThanEqualAndTxDateLessThanEqualAndTranNoInAndCustNoIsAndFacmNoIsAndBormNoIsOrderByCreateDateDesc(txDate_0, txDate_1, tranNo_2, custNo_3, facmNo_4, bormNo_5, pageable);
    else if (dbName.equals(ContentName.onHist))
  ...
  @Override
  public TxDataLog findByTranNoFirst(String tranNo_0, String mrKey_1, TitaVo... titaVo) {
    String dbName = "";
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("findByTranNoFirst " + dbName + " : " + "tranNo_0 : " + tranNo_0 + " mrKey_1 : " +  mrKey_1);
    Optional<TxDataLog> txDataLogT = null;
    if (dbName.equals(ContentName.onDay))
      txDataLogT = txDataLogReposDay.findTopByTranNoIsAndMrKeyIsOrderByTxDateAsc(tranNo_0, mrKey_1);
    else if (dbName.equals(ContentName.onMon))
      txDataLogT = txDataLogReposMon.findTopByTranNoIsAndMrKeyIsOrderByTxDateAsc(tranNo_0, mrKey_1);
    else if (dbName.equals(ContentName.onHist))
      txDataLogT = txDataLogReposHist.findTopByTranNoIsAndMrKeyIsOrderByTxDateAsc(tranNo_0, mrKey_1);
    else 
      txDataLogT = txDataLogRepos.findTopByTranNoIsAndMrKeyIsOrderByTxDateAsc(tranNo_0, mrKey_1);
