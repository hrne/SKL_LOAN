...
public class JcicZ454ServiceImpl extends ASpringJpaParm implements JcicZ454Service, InitializingBean {
	...
	public Slice<JcicZ454> otherEq(String submitKey_0, String custId_1, int applyDate_2, String courtCode_3, String maxMainCode_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("otherEq " + dbName + " : " + "submitKey_0 : " + submitKey_0 + " custId_1 : " + custId_1 + " applyDate_2 : " + applyDate_2 + " courtCode_3 : " + courtCode_3 + " maxMainCode_4 : "
				+ maxMainCode_4);
		if (dbName.equals(ContentName.onDay))
			slice = jcicZ454ReposDay.findAllBySubmitKeyIsAndCustIdIsAndApplyDateIsAndCourtCodeIsAndMaxMainCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, applyDate_2, courtCode_3, maxMainCode_4,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = jcicZ454ReposMon.findAllBySubmitKeyIsAndCustIdIsAndApplyDateIsAndCourtCodeIsAndMaxMainCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, applyDate_2, courtCode_3, maxMainCode_4,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = jcicZ454ReposHist.findAllBySubmitKeyIsAndCustIdIsAndApplyDateIsAndCourtCodeIsAndMaxMainCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, applyDate_2, courtCode_3, maxMainCode_4,
					pageable);
		else
			slice = jcicZ454Repos.findAllBySubmitKeyIsAndCustIdIsAndApplyDateIsAndCourtCodeIsAndMaxMainCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, applyDate_2, courtCode_3, maxMainCode_4,
					pageable);
	...
	public JcicZ454 otherFirst(String submitKey_0, String custId_1, int applyDate_2, String courtCode_3, String maxMainCode_4, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("otherFirst " + dbName + " : " + "submitKey_0 : " + submitKey_0 + " custId_1 : " + custId_1 + " applyDate_2 : " + applyDate_2 + " courtCode_3 : " + courtCode_3 + " maxMainCode_4 : "
				+ maxMainCode_4);
		Optional<JcicZ454> jcicZ454T = null;
		if (dbName.equals(ContentName.onDay))
			jcicZ454T = jcicZ454ReposDay.findTopBySubmitKeyIsAndCustIdIsAndApplyDateIsAndCourtCodeIsAndMaxMainCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, applyDate_2, courtCode_3,
					maxMainCode_4);
		else if (dbName.equals(ContentName.onMon))
			jcicZ454T = jcicZ454ReposMon.findTopBySubmitKeyIsAndCustIdIsAndApplyDateIsAndCourtCodeIsAndMaxMainCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, applyDate_2, courtCode_3,
					maxMainCode_4);
		else if (dbName.equals(ContentName.onHist))
			jcicZ454T = jcicZ454ReposHist.findTopBySubmitKeyIsAndCustIdIsAndApplyDateIsAndCourtCodeIsAndMaxMainCodeIsOrderByCreateDateDesc(submitKey_0, custId_1, applyDate_2, courtCode_3,
					maxMainCode_4);
		else
	...
	public JcicZ454 insert(JcicZ454 jcicZ454, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(jcicZ454.getJcicZ454Id(), titaVo) != null)
