...
public class InnDocRecord implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8424760447478424872L;
	...
	/**
	 * 用途<br>
	 * CdCode.UsageCodeX 01:清償 02:法拍 03:增貸 04:展期 05:撥款 06:查閱 07:重估 08:其他
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "InnDocRecord [innDocRecordId=" + innDocRecordId + ", titaActFg=" + titaActFg + ", applCode=" + applCode + ", applEmpNo=" + applEmpNo + ", keeperEmpNo=" + keeperEmpNo + ", usageCode="
				+ usageCode + ", copyCode=" + copyCode + ", applDate=" + applDate + ", returnDate=" + returnDate + ", returnEmpNo=" + returnEmpNo + ", remark=" + remark + ", applObj=" + applObj
				+ ", titaEntDy=" + titaEntDy + ", titaTlrNo=" + titaTlrNo + ", titaTxtNo=" + titaTxtNo + ", jsonFields=" + jsonFields + ", facmNoMemo=" + facmNoMemo + ", createDate=" + createDate
