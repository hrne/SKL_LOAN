...
public class InsuRenewServiceImpl extends ASpringJpaParm implements InsuRenewService, InitializingBean {
	...
	public Slice<InsuRenew> selectI(int insuYearMonth_0, int repayCode_1, int acDate_2, int statusCode_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = insuRenewReposDay.findAllByInsuYearMonthIsAndRepayCodeIsAndAcDateIsAndStatusCodeIsOrderByInsuEndDateDescInsuStartDateAsc(insuYearMonth_0, repayCode_1, acDate_2, statusCode_3,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = insuRenewReposMon.findAllByInsuYearMonthIsAndRepayCodeIsAndAcDateIsAndStatusCodeIsOrderByInsuEndDateDescInsuStartDateAsc(insuYearMonth_0, repayCode_1, acDate_2, statusCode_3,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = insuRenewReposHist.findAllByInsuYearMonthIsAndRepayCodeIsAndAcDateIsAndStatusCodeIsOrderByInsuEndDateDescInsuStartDateAsc(insuYearMonth_0, repayCode_1, acDate_2, statusCode_3,
					pageable);
		else
			slice = insuRenewRepos.findAllByInsuYearMonthIsAndRepayCodeIsAndAcDateIsAndStatusCodeIsOrderByInsuEndDateDescInsuStartDateAsc(insuYearMonth_0, repayCode_1, acDate_2, statusCode_3,
					pageable);
	...
	public Slice<InsuRenew> selectJ(int insuYearMonth_0, int repayCode_1, int acDate_2, int statusCode_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = insuRenewReposDay.findAllByInsuYearMonthIsAndRepayCodeIsAndAcDateGreaterThanAndStatusCodeIsOrderByInsuEndDateDescInsuStartDateAsc(insuYearMonth_0, repayCode_1, acDate_2,
					statusCode_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = insuRenewReposMon.findAllByInsuYearMonthIsAndRepayCodeIsAndAcDateGreaterThanAndStatusCodeIsOrderByInsuEndDateDescInsuStartDateAsc(insuYearMonth_0, repayCode_1, acDate_2,
					statusCode_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = insuRenewReposHist.findAllByInsuYearMonthIsAndRepayCodeIsAndAcDateGreaterThanAndStatusCodeIsOrderByInsuEndDateDescInsuStartDateAsc(insuYearMonth_0, repayCode_1, acDate_2,
					statusCode_3, pageable);
		else
			slice = insuRenewRepos.findAllByInsuYearMonthIsAndRepayCodeIsAndAcDateGreaterThanAndStatusCodeIsOrderByInsuEndDateDescInsuStartDateAsc(insuYearMonth_0, repayCode_1, acDate_2, statusCode_3,
					pageable);
	...
	public Slice<InsuRenew> findL4604A(int insuYearMonth_0, int renewCode_1, int acDate_2, int acDate_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = insuRenewReposDay.findAllByInsuYearMonthIsAndRenewCodeIsAndAcDateGreaterThanEqualAndAcDateLessThanEqualOrderByInsuEndDateDescInsuStartDateAsc(insuYearMonth_0, renewCode_1,
					acDate_2, acDate_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = insuRenewReposMon.findAllByInsuYearMonthIsAndRenewCodeIsAndAcDateGreaterThanEqualAndAcDateLessThanEqualOrderByInsuEndDateDescInsuStartDateAsc(insuYearMonth_0, renewCode_1,
					acDate_2, acDate_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = insuRenewReposHist.findAllByInsuYearMonthIsAndRenewCodeIsAndAcDateGreaterThanEqualAndAcDateLessThanEqualOrderByInsuEndDateDescInsuStartDateAsc(insuYearMonth_0, renewCode_1,
					acDate_2, acDate_3, pageable);
		else
			slice = insuRenewRepos.findAllByInsuYearMonthIsAndRenewCodeIsAndAcDateGreaterThanEqualAndAcDateLessThanEqualOrderByInsuEndDateDescInsuStartDateAsc(insuYearMonth_0, renewCode_1, acDate_2,
					acDate_3, pageable);
