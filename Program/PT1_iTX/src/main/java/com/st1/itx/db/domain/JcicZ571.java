...
public class JcicZ571 implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -875102411958594067L;
...
/**
  ...
  * @param actualFilingMark 實際報送記號
  ...
  public String toString() {
    return "JcicZ571 [jcicZ571Id=" + jcicZ571Id + ", tranKey=" + tranKey + ", ownerYn=" + ownerYn
           + ", payYn=" + payYn + ", ownerAmt=" + ownerAmt + ", allotAmt=" + allotAmt + ", unallotAmt=" + unallotAmt + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey
