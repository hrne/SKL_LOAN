...
em = null;
  ...
  public Slice<CdLandOffice> findAll(int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by(Sort.Direction.ASC, "CityCode", "LandOfficeCode", "RecWord"));
    else
         pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "CityCode", "LandOfficeCode", "RecWord"));
  ...
  public Slice<CdLandOffice> findLandOfficeCode(String cityCode_0, String landOfficeCode_1, int index, int limit, TitaVo... titaVo) {
    ...
    this.info("findLandOfficeCode " + dbName + " : " + "cityCode_0 : " + cityCode_0 + " landOfficeCode_1 : " +  landOfficeCode_1);
    if (dbName.equals(ContentName.onDay))
      slice = cdLandOfficeReposDay.findAllByCityCodeIsAndLandOfficeCodeIsOrderByRecWordAsc(cityCode_0, landOfficeCode_1, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = cdLandOfficeReposMon.findAllByCityCodeIsAndLandOfficeCodeIsOrderByRecWordAsc(cityCode_0, landOfficeCode_1, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = cdLandOfficeReposHist.findAllByCityCodeIsAndLandOfficeCodeIsOrderByRecWordAsc(cityCode_0, landOfficeCode_1, pageable);
    else 
      slice = cdLandOfficeRepos.findAllByCityCodeIsAndLandOfficeCodeIsOrderByRecWordAsc(cityCode_0, landOfficeCode_1, pageable);
  ...
  public CdLandOffice findRecWordFirst(String cityCode_0, String landOfficeCode_1, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("findRecWordFirst " + dbName + " : " + "cityCode_0 : " + cityCode_0 + " landOfficeCode_1 : " +  landOfficeCode_1);
    Optional<CdLandOffice> cdLandOfficeT = null;
    if (dbName.equals(ContentName.onDay))
      cdLandOfficeT = cdLandOfficeReposDay.findTopByCityCodeIsAndLandOfficeCodeIsOrderByRecWordDesc(cityCode_0, landOfficeCode_1);
    else if (dbName.equals(ContentName.onMon))
      cdLandOfficeT = cdLandOfficeReposMon.findTopByCityCodeIsAndLandOfficeCodeIsOrderByRecWordDesc(cityCode_0, landOfficeCode_1);
    else if (dbName.equals(ContentName.onHist))
      cdLandOfficeT = cdLandOfficeReposHist.findTopByCityCodeIsAndLandOfficeCodeIsOrderByRecWordDesc(cityCode_0, landOfficeCode_1);
    else 
      cdLandOfficeT = cdLandOfficeRepos.findTopByCityCodeIsAndLandOfficeCodeIsOrderByRecWordDesc(cityCode_0, landOfficeCode_1);
  ...
  public CdLandOffice insert(CdLandOffice cdLandOffice, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(cdLandOffice.getCdLandOfficeId(), titaVo) != null)
