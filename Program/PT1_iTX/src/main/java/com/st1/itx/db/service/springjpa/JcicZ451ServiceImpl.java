...
public class JcicZ451ServiceImpl extends ASpringJpaParm implements JcicZ451Service, InitializingBean {
	...
	public Slice<JcicZ451> otherEq(String submitKey_0, String custId_1, int applyDate_2, String courtCode_3, int delayYM_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("otherEq " + dbName + " : " + "submitKey_0 : " + submitKey_0 + " custId_1 : " + custId_1 + " applyDate_2 : " + applyDate_2 + " courtCode_3 : " + courtCode_3 + " delayYM_4 : "
				+ delayYM_4);
		if (dbName.equals(ContentName.onDay))
			...
			slice = jcicZ451ReposHist.findAllBySubmitKeyIsAndCustIdIsAndApplyDateIsAndCourtCodeIsAndDelayYMIsOrderByCreateDateDesc(submitKey_0, custId_1, applyDate_2, courtCode_3, delayYM_4,
					pageable);
		else
	...
	public JcicZ451 otherFirst(String submitKey_0, String custId_1, int applyDate_2, String courtCode_3, int delayYM_4, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("otherFirst " + dbName + " : " + "submitKey_0 : " + submitKey_0 + " custId_1 : " + custId_1 + " applyDate_2 : " + applyDate_2 + " courtCode_3 : " + courtCode_3 + " delayYM_4 : "
				+ delayYM_4);
		Optional<JcicZ451> jcicZ451T = null;
		if (dbName.equals(ContentName.onDay))
