 ...
 * @version 1.0.0
 */
public interface JcicZ574RepositoryMon extends JpaRepository<JcicZ574, JcicZ574Id> {
  ...
  public Slice<JcicZ574> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
