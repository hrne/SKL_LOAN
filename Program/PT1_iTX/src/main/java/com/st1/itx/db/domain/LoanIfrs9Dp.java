...
public class LoanIfrs9Dp implements Serializable {
	...
	public String toString() {
		return "LoanIfrs9Dp [loanIfrs9DpId=" + loanIfrs9DpId + ", custId=" + custId + ", dataFg=" + dataFg + ", acCode=" + acCode + ", status=" + status + ", firstDrawdownDate=" + firstDrawdownDate
				...
				+ ", clTypeJCIC=" + clTypeJCIC + ", areaCode=" + areaCode + ", prodCode=" + prodCode + ", custKind=" + custKind + ", ifrs9ProdCode=" + ifrs9ProdCode + ", createDate=" + createDate
