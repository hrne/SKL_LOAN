...
public interface JcicZ451RepositoryHist extends JpaRepository<JcicZ451, JcicZ451Id> {
  ...
  public Slice<JcicZ451> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
