...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "SlipMedia [slipMediaId=" + slipMediaId
           + ", acBookItem=" + acBookItem + ", acNoCode=" + acNoCode + ", acSubCode=" + acSubCode + ", acNoItem=" + acNoItem + ", currencyCode=" + currencyCode
           + ", dbCr=" + dbCr + ", txAmt=" + txAmt + ", receiveCode=" + receiveCode + ", deptCode=" + deptCode + ", slipRmk=" + slipRmk + ", costMonth=" + costMonth
           + ", acSubBookCode=" + acSubBookCode + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
  }
}
