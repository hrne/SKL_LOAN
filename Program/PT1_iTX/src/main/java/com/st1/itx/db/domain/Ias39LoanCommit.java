...
public class Ias39LoanCommit implements Serializable {
	...
	// 信用風險轉換係數
	/*
	 * 以【貸款區間】判斷，轉換成”月數”，不足1個月者視為1個月；當【貸款期間起(月)】&amp;lt;=月數&amp;lt;=【貸款期間迄(月)】，取對應的【
	 * 風險轉換係數(LCTCCF)】
	 */
	@Column(name = "`Ccf`")
	...
	public String toString() {
		return "Ias39LoanCommit [ias39LoanCommitId=" + ias39LoanCommitId + ", approveDate=" + approveDate + ", firstDrawdownDate=" + firstDrawdownDate + ", maturityDate=" + maturityDate
				+ ", loanTermYy=" + loanTermYy + ", loanTermMm=" + loanTermMm + ", loanTermDd=" + loanTermDd + ", utilDeadline=" + utilDeadline + ", recycleDeadline=" + recycleDeadline + ", lineAmt="
				+ lineAmt + ", utilBal=" + utilBal + ", avblBal=" + avblBal + ", recycleCode=" + recycleCode + ", irrevocableFlag=" + irrevocableFlag + ", acBookCode=" + acBookCode
