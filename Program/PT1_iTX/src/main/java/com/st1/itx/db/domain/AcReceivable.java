...
public class AcReceivable implements Serializable {
	...
	// 銷帳編號
	/*
	 * 1:暫收款－可抵繳 : ''primary key 不可有null, 放一個空白2:擔保放款、催收款項 :
	 * 撥款序號(3)3:會計銷帳科目：系統自編(AC+西元年後兩碼+流水號六碼)4:暫收款－支票：支票帳號(9)-支票號碼(7)
	 * 5:未收帳管費：第一筆撥款序號(3)
	 * 6:未收契變手續費：契變日期(8,西元)+契變序號(02)7:未收、暫收、暫付、催收火險保費：原保險單號碼8:暫付、催收法務費：記錄號碼(8)9:短繳期金
	 * ：撥款序號(3)10:暫收款－借新還舊: 'FacmNo' + 額度編號(3)11:聯貸手續費:SL-費用代號(2)-流水號(3)-攤提年月(YYYMM)
	 */
	...
	/**
	 * 銷帳編號<br>
	 * 1:暫收款－可抵繳 : ''primary key 不可有null, 放一個空白 2:擔保放款、催收款項 : 撥款序號(3)
	 * 3:會計銷帳科目：系統自編(AC+西元年後兩碼+流水號六碼) 4:暫收款－支票：支票帳號(9)-支票號碼(7) 5:未收帳管費：第一筆撥款序號(3)
	 * 6:未收契變手續費：契變日期(8,西元)+契變序號(02) 7:未收、暫收、暫付、催收火險保費：原保險單號碼 8:暫付、催收法務費：記錄號碼(8)
	 * 9:短繳期金：撥款序號(3) 10:暫收款－借新還舊: 'FacmNo' + 額度編號(3)
	...
	/**
	 * 銷帳科目記號<br>
	 * 1:會計銷帳科目 2:業務銷帳科目 3:未收費用 4:短繳期金 5:另收欠款
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "AcReceivable [acReceivableId=" + acReceivableId + ", acNoCode=" + acNoCode + ", acSubCode=" + acSubCode + ", acDtlCode=" + acDtlCode + ", branchNo=" + branchNo + ", currencyCode="
				+ currencyCode + ", clsFlag=" + clsFlag + ", acctFlag=" + acctFlag + ", receivableFlag=" + receivableFlag + ", rvAmt=" + rvAmt + ", rvBal=" + rvBal + ", acBal=" + acBal + ", slipNote="
				+ slipNote + ", acBookCode=" + acBookCode + ", acSubBookCode=" + acSubBookCode + ", openAcDate=" + openAcDate + ", openTxCd=" + openTxCd + ", openKinBr=" + openKinBr + ", openTlrNo="
				+ openTlrNo + ", openTxtNo=" + openTxtNo + ", lastAcDate=" + lastAcDate + ", lastTxDate=" + lastTxDate + ", titaTxCd=" + titaTxCd + ", titaKinBr=" + titaKinBr + ", titaTlrNo="
				+ titaTlrNo + ", titaTxtNo=" + titaTxtNo + ", jsonFields=" + jsonFields + ", createEmpNo=" + createEmpNo + ", createDate=" + createDate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
