...
// 資料日期
	...
	public boolean equals(Object obj) {
		...
		return dataYM == jcicB092Id.dataYM && clActNo.equals(jcicB092Id.clActNo) && clTypeJCIC.equals(jcicB092Id.clTypeJCIC) && ownerId.equals(jcicB092Id.ownerId)
				&& cityJCICCode.equals(jcicB092Id.cityJCICCode) && areaJCICCode == jcicB092Id.areaJCICCode && irCode.equals(jcicB092Id.irCode) && landNo1 == jcicB092Id.landNo1
				&& landNo2 == jcicB092Id.landNo2 && bdNo1 == jcicB092Id.bdNo1 && bdNo2 == jcicB092Id.bdNo2;
	}

	@Override
	public String toString() {
		return "JcicB092Id [dataYM=" + dataYM + ", clActNo=" + clActNo + ", clTypeJCIC=" + clTypeJCIC + ", ownerId=" + ownerId + ", cityJCICCode=" + cityJCICCode + ", areaJCICCode=" + areaJCICCode
				+ ", irCode=" + irCode + ", landNo1=" + landNo1 + ", landNo2=" + landNo2 + ", bdNo1=" + bdNo1 + ", bdNo2=" + bdNo2 + "]";
	}
}
