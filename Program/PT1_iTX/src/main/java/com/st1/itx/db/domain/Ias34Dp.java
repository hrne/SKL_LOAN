...
public class Ias34Dp implements Serializable {
	...
	public String toString() {
		return "Ias34Dp [ias34DpId=" + ias34DpId + ", custId=" + custId + ", acCode=" + acCode + ", status=" + status + ", firstDrawdownDate=" + firstDrawdownDate + ", drawdownDate=" + drawdownDate
				+ ", maturityDate=" + maturityDate + ", lineAmt=" + lineAmt + ", drawdownAmt=" + drawdownAmt + ", loanBal=" + loanBal + ", intAmt=" + intAmt + ", fee=" + fee + ", ovduDays=" + ovduDays
				+ ", ovduDate=" + ovduDate + ", badDebtDate=" + badDebtDate + ", badDebtAmt=" + badDebtAmt + ", derDate=" + derDate + ", derRate=" + derRate + ", derLoanBal=" + derLoanBal
				+ ", derIntAmt=" + derIntAmt + ", derFee=" + derFee + ", derY1Amt=" + derY1Amt + ", derY2Amt=" + derY2Amt + ", derY3Amt=" + derY3Amt + ", derY4Amt=" + derY4Amt + ", derY5Amt="
				+ derY5Amt + ", derY1Int=" + derY1Int + ", derY2Int=" + derY2Int + ", derY3Int=" + derY3Int + ", derY4Int=" + derY4Int + ", derY5Int=" + derY5Int + ", derY1Fee=" + derY1Fee
				+ ", derY2Fee=" + derY2Fee + ", derY3Fee=" + derY3Fee + ", derY4Fee=" + derY4Fee + ", derY5Fee=" + derY5Fee + ", industryCode=" + industryCode + ", clTypeJCIC=" + clTypeJCIC
				+ ", zip3=" + zip3 + ", prodCode=" + prodCode + ", custKind=" + custKind + ", ifrs9ProdCode=" + ifrs9ProdCode + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
