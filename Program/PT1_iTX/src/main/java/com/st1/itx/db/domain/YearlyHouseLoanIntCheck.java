...
public class YearlyHouseLoanIntCheck implements Serializable {
	...
	public String toString() {
		return "YearlyHouseLoanIntCheck [yearlyHouseLoanIntCheckId=" + yearlyHouseLoanIntCheckId + ", r1=" + r1 + ", r2=" + r2 + ", r3=" + r3 + ", r4=" + r4 + ", r5=" + r5 + ", r6=" + r6 + ", r7="
				+ r7 + ", r8=" + r8 + ", r10=" + r10 + ", r11=" + r11 + ", r12=" + r12 + ", c1=" + c1 + ", c2=" + c2 + ", c3=" + c3 + ", c4=" + c4 + ", c5=" + c5 + ", jsonFields=" + jsonFields
