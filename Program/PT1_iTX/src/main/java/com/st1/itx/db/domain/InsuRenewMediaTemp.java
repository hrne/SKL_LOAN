...
// 序號
	@Id
	@Column(name = "`LogNo`")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "`InsuRenewMediaTemp_SEQ`")
	@SequenceGenerator(name = "`InsuRenewMediaTemp_SEQ`", sequenceName = "`InsuRenewMediaTemp_SEQ`", allocationSize = 1)
	...
	// 檢核結果A
	@Column(name = "`CheckResultA`", length = 30)
	private String checkResultA;

	// 檢核結果B
	@Column(name = "`CheckResultB`", length = 30)
	private String checkResultB;

	// 檢核結果C
	@Column(name = "`CheckResultC`", length = 30)
	...
	public String getCheckResultA() {
		return this.checkResultA == null ? "" : this.checkResultA;
	}
	...
	public String getCheckResultB() {
		return this.checkResultB == null ? "" : this.checkResultB;
	}
	...
	public String getCheckResultC() {
		return this.checkResultC == null ? "" : this.checkResultC;
	}
	...
	public String toString() {
		return "InsuRenewMediaTemp [logNo=" + logNo + ", fireInsuMonth=" + fireInsuMonth + ", returnCode=" + returnCode + ", insuCampCode=" + insuCampCode + ", insuCustId=" + insuCustId
				+ ", insuCustName=" + insuCustName + ", loanCustId=" + loanCustId + ", loanCustName=" + loanCustName + ", postalCode=" + postalCode + ", address=" + address + ", buildingSquare="
				+ buildingSquare + ", buildingCode=" + buildingCode + ", buildingYears=" + buildingYears + ", buildingFloors=" + buildingFloors + ", roofCode=" + roofCode + ", businessUnit="
				+ businessUnit + ", clCode1=" + clCode1 + ", clCode2=" + clCode2 + ", clNo=" + clNo + ", seq=" + seq + ", insuNo=" + insuNo + ", insuStartDate=" + insuStartDate + ", insuEndDate="
				+ insuEndDate + ", fireInsuAmt=" + fireInsuAmt + ", fireInsuFee=" + fireInsuFee + ", eqInsuAmt=" + eqInsuAmt + ", eqInsuFee=" + eqInsuFee + ", custNo=" + custNo + ", facmNo=" + facmNo
				+ ", space=" + space + ", sendDate=" + sendDate + ", newInusNo=" + newInusNo + ", newInsuStartDate=" + newInsuStartDate + ", newInsuEndDate=" + newInsuEndDate + ", newFireInsuAmt="
				+ newFireInsuAmt + ", newFireInsuFee=" + newFireInsuFee + ", newEqInsuAmt=" + newEqInsuAmt + ", newEqInsuFee=" + newEqInsuFee + ", newTotalFee=" + newTotalFee + ", remark1=" + remark1
				+ ", mailingAddress=" + mailingAddress + ", remark2=" + remark2 + ", sklSalesName=" + sklSalesName + ", sklUnitCode=" + sklUnitCode + ", sklUnitName=" + sklUnitName + ", sklSalesCode="
				+ sklSalesCode + ", renewTrlCode=" + renewTrlCode + ", renewUnit=" + renewUnit + ", checkResultA=" + checkResultA + ", checkResultB=" + checkResultB + ", checkResultC=" + checkResultC
				+ ", repayCode=" + repayCode + ", noticeFlag=" + noticeFlag + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo="
				+ lastUpdateEmpNo + "]";
	}
}
