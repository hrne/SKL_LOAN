 ...
 * @version 1.0.0
 */
public interface PfDetailRepositoryHist extends JpaRepository<PfDetail, Long> {
	...
	public Slice<PfDetail> findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndWorkMonthGreaterThanEqualAndWorkMonthLessThanEqualOrderByPerfDateAscFacmNoAscBormNoAscBorxNoAsc(
			int custNo_0, int facmNo_1, int facmNo_2, int workMonth_3, int workMonth_4, Pageable pageable);
