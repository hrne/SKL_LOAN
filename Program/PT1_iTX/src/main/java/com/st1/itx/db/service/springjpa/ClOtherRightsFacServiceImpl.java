...
em = null;
  ...
  public Slice<ClOtherRightsFac> findChoiceDateEq(ClOtherRightsFacId choiceDate_0, String lastUpdateEmpNo_1, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      slice = clOtherRightsFacReposDay.findAllByChoiceDateIsAndLastUpdateEmpNoIsOrderByCustNoAscCloseNoAsc(choiceDate_0, lastUpdateEmpNo_1, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = clOtherRightsFacReposMon.findAllByChoiceDateIsAndLastUpdateEmpNoIsOrderByCustNoAscCloseNoAsc(choiceDate_0, lastUpdateEmpNo_1, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = clOtherRightsFacReposHist.findAllByChoiceDateIsAndLastUpdateEmpNoIsOrderByCustNoAscCloseNoAsc(choiceDate_0, lastUpdateEmpNo_1, pageable);
    else 
      slice = clOtherRightsFacRepos.findAllByChoiceDateIsAndLastUpdateEmpNoIsOrderByCustNoAscCloseNoAsc(choiceDate_0, lastUpdateEmpNo_1, pageable);
