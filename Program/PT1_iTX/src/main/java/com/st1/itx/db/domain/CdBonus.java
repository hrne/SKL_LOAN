...
public class CdBonus implements Serializable {
	...
	/**
	 * 條件記號<br>
	 * 1.篩選條件-計件代碼 2.排除條件-商品代號 3.金額級距 4.排除部門別 5.是否排除15日薪非業績人員
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 標準條件<br>
	 * 條件記號=1時為計件代碼1位 條件記號=2時為商品代號5位 條件記號=3時為金額級距序號2位
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "CdBonus [cdBonusId=" + cdBonusId + ", amtStartRange=" + amtStartRange + ", amtEndRange=" + amtEndRange + ", bonus=" + bonus + ", createDate=" + createDate + ", createEmpNo="
