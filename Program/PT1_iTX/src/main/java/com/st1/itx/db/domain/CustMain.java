...
// 客戶識別碼
	...
	// 建檔身分別
	/*
	 * 0:借戶1:保證人2:擔保品提供人3:交易關係人4:借款戶關係人2021/08/24新增欄位(2021/08/25上DB)by
	 * eric(2021/09/17)新增4. by昱衡
	 */
	...
	/**
	 * 客戶別<br>
	 * 共用代碼檔 00:一般 01:員工 02:首購 03:關企公司 04:關企員工 05:保戶 06:團體戶 07:員工二親等 09:新二階員工
	 * 
	 * @return String
	 */
	 ...
	 * 國籍對照檔 比照ELOAN (2021/08/27上DB)by eric
	 * 
	 * @return String
	 */
	...
	/**
	 * 教育程度代號<br>
	 * 共用代碼檔 1:小學以下 2:國中 3:高中職 4:專科學校 5:大學 6:研究所 7:博士
	 * 
	 * @return String
	 */
	...
	/**
	 * 房貸專員/企金人員<br>
	 * 2022/02/17新增欄位 by eric 原DAT_CU$CUSP.CUSEM2
	 * 
	 * @return String
	 */
	 ...
	 * Y/N 2021/08/06新增欄位(2021/08/06上DB)by eric
	 * 
	 * @return String
	 */
	...
	/**
	 * 建檔身分別<br>
	 * 0:借戶 1:保證人 2:擔保品提供人 3:交易關係人 4:借款戶關係人 2021/08/24新增欄位 (2021/08/25上DB)by eric
	 * (2021/09/17)新增4. by昱衡
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 站別<br>
	 * 2022/02/17新增欄位 by eric 原DAT_CU$CUSP.CUSSTN
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "CustMain [custUKey=" + custUKey + ", custId=" + custId + ", custNo=" + custNo + ", branchNo=" + branchNo + ", custName=" + custName + ", birthday=" + birthday + ", sex=" + sex
				+ ", custTypeCode=" + custTypeCode + ", industryCode=" + industryCode + ", nationalityCode=" + nationalityCode + ", bussNationalityCode=" + bussNationalityCode + ", spouseId="
				+ spouseId + ", spouseName=" + spouseName + ", regZip3=" + regZip3 + ", regZip2=" + regZip2 + ", regCityCode=" + regCityCode + ", regAreaCode=" + regAreaCode + ", regRoad=" + regRoad
				+ ", regSection=" + regSection + ", regAlley=" + regAlley + ", regLane=" + regLane + ", regNum=" + regNum + ", regNumDash=" + regNumDash + ", regFloor=" + regFloor + ", regFloorDash="
				+ regFloorDash + ", currZip3=" + currZip3 + ", currZip2=" + currZip2 + ", currCityCode=" + currCityCode + ", currAreaCode=" + currAreaCode + ", currRoad=" + currRoad + ", currSection="
				+ currSection + ", currAlley=" + currAlley + ", currLane=" + currLane + ", currNum=" + currNum + ", currNumDash=" + currNumDash + ", currFloor=" + currFloor + ", currFloorDash="
				+ currFloorDash + ", cuscCd=" + cuscCd + ", entCode=" + entCode + ", empNo=" + empNo + ", eName=" + eName + ", eduCode=" + eduCode + ", ownedHome=" + ownedHome + ", currCompName="
				+ currCompName + ", currCompId=" + currCompId + ", currCompTel=" + currCompTel + ", jobTitle=" + jobTitle + ", jobTenure=" + jobTenure + ", incomeOfYearly=" + incomeOfYearly
				+ ", incomeDataDate=" + incomeDataDate + ", passportNo=" + passportNo + ", aMLJobCode=" + aMLJobCode + ", aMLGroup=" + aMLGroup + ", indigenousName=" + indigenousName + ", lastFacmNo="
				+ lastFacmNo + ", lastSyndNo=" + lastSyndNo + ", allowInquire=" + allowInquire + ", email=" + email + ", actFg=" + actFg + ", introducer=" + introducer + ", businessOfficer="
				+ businessOfficer + ", isSuspected=" + isSuspected + ", isSuspectedCheck=" + isSuspectedCheck + ", isSuspectedCheckType=" + isSuspectedCheckType + ", isLimit=" + isLimit
				+ ", isRelated=" + isRelated + ", isLnrelNear=" + isLnrelNear + ", isDate=" + isDate + ", dataStatus=" + dataStatus + ", typeCode=" + typeCode + ", station=" + station
