  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "TxFile [fileNo=" + fileNo + ", fileDate=" + fileDate + ", fileCode=" + fileCode + ", fileItem=" + fileItem + ", fileType=" + fileType + ", fileOutput=" + fileOutput
           + ", fileFormat=" + fileFormat + ", fileData=" + fileData + ", fileZip=" + fileZip + ", brNo=" + brNo + ", signCode=" + signCode + ", groupNo=" + groupNo
           + ", tlrNo=" + tlrNo + ", supNo=" + supNo + ", batchNo=" + batchNo + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
