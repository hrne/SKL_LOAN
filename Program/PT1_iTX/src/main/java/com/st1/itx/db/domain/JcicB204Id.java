...
// 資料日期
	...
	public boolean equals(Object obj) {
		...
		return dataYMD == jcicB204Id.dataYMD && bankItem.equals(jcicB204Id.bankItem) && branchItem.equals(jcicB204Id.branchItem) && dataDate == jcicB204Id.dataDate && acctNo.equals(jcicB204Id.acctNo)
				&& custId.equals(jcicB204Id.custId) && acctCode.equals(jcicB204Id.acctCode) && subAcctCode.equals(jcicB204Id.subAcctCode) && subTranCode.equals(jcicB204Id.subTranCode)
				&& seqNo.equals(jcicB204Id.seqNo);
	}

	@Override
	public String toString() {
		return "JcicB204Id [dataYMD=" + dataYMD + ", bankItem=" + bankItem + ", branchItem=" + branchItem + ", dataDate=" + dataDate + ", acctNo=" + acctNo + ", custId=" + custId + ", acctCode="
				+ acctCode + ", subAcctCode=" + subAcctCode + ", subTranCode=" + subTranCode + ", seqNo=" + seqNo + "]";
	}
}
