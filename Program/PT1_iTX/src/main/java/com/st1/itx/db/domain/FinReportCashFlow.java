...
public class FinReportCashFlow implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = 4824851999341406919L;
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "FinReportCashFlow [finReportCashFlowId=" + finReportCashFlowId + ", busCash=" + busCash + ", investCash=" + investCash + ", finCash=" + finCash + ", accountItem01=" + accountItem01
           + ", accountItem02=" + accountItem02 + ", accountValue01=" + accountValue01 + ", accountValue02=" + accountValue02 + ", endCash=" + endCash + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
