...
public class JcicB201 implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = 2758337264283739355L;
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicB201 [jcicB201Id=" + jcicB201Id
           ...
           + ", guaId5=" + guaId5 + ", guaIdErr5=" + guaIdErr5 + ", guaRelCode5=" + guaRelCode5 + ", filler741=" + filler741 + ", graceStartYM=" + graceStartYM + ", graceEndYM=" + graceEndYM
           + ", greenFg=" + greenFg + ", greenCode=" + greenCode + ", sustainFg=" + sustainFg + ", sustainCode=" + sustainCode + ", sustainNoReachFg=" + sustainNoReachFg + ", badDebtDate=" + badDebtDate
