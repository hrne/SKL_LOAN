...
public class JcicB201 implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -4035862129831408686L;
...
@EmbeddedId
  ...
  // 融資分類
  /* 法人特殊融資分為五類 A:專案融資 B:商品融資 C:標的融資 D:收益型商用不動產融資 E:高風險商用不動產融資 K:非屬前述特殊融資之其他一般法人金融貸款個人(含非法人組織)金融貸款分類為L:購買住宅貸款(非自用) M:購買住宅貸款(自用) N:一般房屋抵押貸款(房屋修繕貸款) O:由信用卡衍生之小額信用貸款 R:由現金卡衍生之小額信用貸款 S:創業貸款 T:所營事業營運周轉金貸款 U:建築用融資貸款 V:代墊投標保證金貸款 W:農業用途貸款 X:參與都市更新更新計畫貸款 Y:企業員工認購股票(或可轉換公司債)貸款Z:其他個人金融貸款1:個人投資理財貸款 */
  ...
  // 額度可否撤銷
  /* Y:可撤銷N:不可撤銷可撤銷之定義，依據96年金管會銀行局發佈之【銀行自有資本與風險性資產之計算方法說明及表格】第7頁所示，如該筆授信符合信用轉換係數為0者屬之，意即：(1)銀行無需事先通知即得隨時無條件取消之承諾【註：若銀行對客戶之零售債權承諾，符合消費者保護法及相關法令規定，且銀行得隨時無條件取消該承諾者，得被認為係無條件可取消之承諾。】(2)當借款人信用貶落時，銀行有權自動取消之承諾否則該授信可視為不可撤銷 */
  ...
  // 甲類逾期放款分類
  /* 左靠右空白，a 如該筆授信屬甲類逾期放款，請填報其分類代號如下1:放款本金超過清償期三個月而未獲清償，或雖為屆滿三個月，但已向主、從債務人訴追獲處分擔保品者2:放款本金未超過清償期三個月，而利息未按期繳納超過六個月者3:分期償還放款未按期攤還超過六個月，或雖未屆滿六個月，但已向主、從債務人訴追獲處分擔保品者4:協議分期償還放款符合一定條件而曾經免列報逾期放款案件，於免列報期間再發生未依約清償超過三個月者X:非屬甲類逾期放款同一筆授信之分類，請於本欄位之分類代號與第40欄之分類代號中則一填報 */
  @Column(name = "`FirstDelayCode`", length = 3)
  private String firstDelayCode;

  // 乙類逾期放款分類
  /* a 如該筆授信與乙類逾期放款，請填報其分類代號如下1:放款本金未超過清償期三個月，惟利息未按期繳納超過清償期三個月，分期償還放款未按期攤還超過三個月至六個月者3:協議分期償還放款，協議條件符合規定，且借款戶依協議條件按期履約未滿六個月者4:已獲信用保證基金同意理賠款項或有足額存單或存款備償(需辦妥質權設定且徵得發單行拋棄抵銷權同意書)，而約定待其他債務人財產處分後再予沖償者5:已確定分配之債權，惟尚未接獲分配款者6:債務人兼擔保品提供人死亡，於辦理繼承期間，借期而為清償之放款，其繳息正常且有十足擔保者7:其他(如921震災展延本息之放款)X:非屬類逾期放款同一筆授信之分類，請於本欄位之分類代號與第39欄之分類代號中則一填報。 */
  @Column(name = "`SecondDelayCode`", length = 1)
  private String secondDelayCode;

  // 不良債權處理註記
  /* 如該筆授信債權於本月處理且結案者，請直接填報第42欄 債權結案註記 ，本欄位無須填報；本欄位僅處理當月報送處理註記代號即可，次月不需重複報送，左靠。P:不良債權主債務人自償Q:不良債權從債務人代位償還R:主、從債務人以外之第三人代位償還G:代物償還(指債權人受領其他給付，以消滅原債權之償還)E:債務承擔(指原有債務為第三人承擔)D:處分擔保品A:承受擔保品本欄位若有填報代號P、 Q、 R、G、 D及A者，亦請配合於第36、37或38欄填報收回金額；B轉銷呆帳，C 轉催收款，如無前述狀況請填空白，勿填0。 */
  @Column(name = "`BadDebtCode`", length = 3)
  private String badDebtCode;

  // 債權結束註記
  /* 左靠3:正常債權全額清償T:債權轉讓S:債權證券化P:不良債權主債務人自償Q:不良債權從債務人代位償還R:主、從債務人以外之第三人代位償還G:代物償還(指債權人受領其他給付以消滅原債權之償還)E:債務承擔(指原有債務為第三人承擔)D:處分擔保品A:承受擔保品H:債權和解N:債權拋棄J:合併或業務移轉X:債權轉讓後原債權機購買回F:信保基金退理賠Z:結清銷戶如無結案狀況請填空白，勿填0。 */
  ...
  // 購地貸款註記
  /* 購地貸款適用範圍依中央銀行之購地貸款相關規定辦理。如為 110/12/17 起新辦、續貸、轉貸之購地貸款案件，本欄請填'Y'，否則請填'N'。(因切結一定期間內動工規範係自110/12/17 起適用，爰 110/12/17 前之購地貸款案件本欄亦請填'N'。) */
  @Column(name = "`LandLoanFg`", length = 1)
  private String landLoanFg;

  // 約定動工年月
  /* 44.3 欄購地貸款註記為 Y，本欄為必填，請填寫購地貸款借款人切結約定動工之年月'YYYMM'，如約定 112 年 6 月以前應動工，則本欄填報'11206'；若因轉貸案件已動工，只知悉實際動工年月，無約定動工年月資料等情形，本欄請填報'00000'。若因額度核准尚未撥貸等原因未能確定約定動工年月，本欄請先填報'00000'，然確定約定動工年月後，即請確實填報。44.3 欄填報為 N，本欄請空白。 */
  @Column(name = "`PreStarBuildingYM`", length = 5)
  private String preStarBuildingYM;
  ...
  // 擔保品類別
  /* 擔保品類別代號表請參照附件九(本修訂版將原擔保品類別:信用保證機構保證細分為5項05:中小企業信用保證基金保證06:農業信用保證基金保證07:華僑貸款信用保證基金保證08:國際合作發展基金會信用保證09:原住民族綜合發展基金信用保證) */
  ...
  // 空白
  /* 備用 */
  @Column(name = "`Filler51`", length = 3)
  private String filler51;

  // 實際興建年月
  /* 44.3 欄購地貸款註記為 Y，本欄為必填，請填寫實際動工年月'YYYMM'，若尚未動工，請填報'00000'。44.3 欄填報為N，本欄請空白。 */
  ...
  // 補充揭露案件註記－案件屬性
  /* 請填報該授信案件屬經主管機關函釋之爭議屬性：請填報該授信案件屬經主管機關函釋之爭議屬性：A:遞延（預付）型消費性貸款B:客戶衍生性金融商品交易爭議案件C:協議分期償還放款依協議條件正常履約經報送為不良授信案件 */
  @Column(name = "`ExtraAttrCode`", length = 1)
  private String extraAttrCode;

  // 補充揭露案件註記－案件情形
  /* 請填報該授信案性屬經主管機關函釋之爭議案件：01:學承電腦倒閉02:威爾斯美語倒閉；源自衍生性爭議案件者，請填報：31:協商32:評議/調處33:仲裁34:訴訟；若同一授信有兩種以上情事者，請銀行自行判定以最主要/具強制力者為準。74.8欄如填案件屬性'C'之案件，本欄請填空白。 */
...
7:其他(如921震災展延本息之放款)
X:非屬類逾期放款
同一筆授信之分類，請於本欄位之分類代號與第39欄之分類代號中則一填報。
	* @return String
	*/
...
D:處分擔保品
A:承受擔保品
本欄位若有填報代號P、 Q、 R、G、 D及A者，亦請配合於第36、37或38欄填報收回金額；B轉銷呆帳，C 轉催收款，如無前述狀況請填空白，勿填0。
	* @return String
	*/
...
後，即請確實填報。44.3 欄填報為 N，本欄請空白。
	* @return String
	*/
  public String getPreStarBuildingYM() {
    return this.preStarBuildingYM == null ? "" : this.preStarBuildingYM;
  }
...
後，即請確實填報。44.3 欄填報為 N，本欄請空白。
  *
  * @param preStarBuildingYM 約定動工年月
	*/
  public void setPreStarBuildingYM(String preStarBuildingYM) {
    this.preStarBuildingYM = preStarBuildingYM;
  }
...
/**
	* 擔保品類別<br>
	* 擔保品類別代號表請參照附件九(本修訂版將原擔保品類別:信用保證機構保證細分為5項
05:中小企業信用保證基金保證
06:農業信用保證基金保證
07:華僑貸款信用保證基金保證
08:國際合作發展基金會信用保證
...
/**
	* 補充揭露案件註記－案件屬性<br>
	* 請填報該授信案件屬經主管機關函釋之爭議屬性：請填報該授信案件屬經主管機關函釋之爭議屬性：
A:遞延（預付）型消費性貸款
B:客戶衍生性金融商品交易爭議案件
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicB201 [jcicB201Id=" + jcicB201Id
           ...
           + ", negTransYM=" + negTransYM + ", landLoanFg=" + landLoanFg + ", preStarBuildingYM=" + preStarBuildingYM + ", clType=" + clType + ", clEvaAmt=" + clEvaAmt + ", clTypeCode=" + clTypeCode
           + ", syndKind=" + syndKind + ", syndContractDate=" + syndContractDate + ", syndRatio=" + syndRatio + ", filler51=" + filler51 + ", starBuildingYM=" + starBuildingYM + ", payablesFg=" + payablesFg
           + ", negFg=" + negFg + ", filler533=" + filler533 + ", guaTypeCode1=" + guaTypeCode1 + ", guaId1=" + guaId1 + ", guaIdErr1=" + guaIdErr1 + ", guaRelCode1=" + guaRelCode1
           ...
           + ", guaTypeCode5=" + guaTypeCode5 + ", guaId5=" + guaId5 + ", guaIdErr5=" + guaIdErr5 + ", guaRelCode5=" + guaRelCode5 + ", filler741=" + filler741 + ", graceStartYM=" + graceStartYM
           + ", graceEndYM=" + graceEndYM + ", greenFg=" + greenFg + ", greenCode=" + greenCode + ", sustainFg=" + sustainFg + ", sustainCode=" + sustainCode + ", sustainNoReachFg=" + sustainNoReachFg
           + ", badDebtDate=" + badDebtDate + ", syndCode=" + syndCode + ", bankruptDate=" + bankruptDate + ", bdLoanFg=" + bdLoanFg + ", smallAmt=" + smallAmt + ", extraAttrCode=" + extraAttrCode
           + ", extraStatusCode=" + extraStatusCode + ", filler74A=" + filler74A + ", jcicDataYM=" + jcicDataYM + ", dataEnd=" + dataEnd + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
