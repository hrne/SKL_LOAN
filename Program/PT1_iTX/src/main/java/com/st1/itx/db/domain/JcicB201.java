...
public class JcicB201 implements Serializable {
  ...
  // 購地貸款註記
  /* 金管會111/5/27函文:如為 110/12/17 後新辦、續貸、轉貸之購地貸款案件，本欄請填'Y'，否則請填'N'。(因切結一定期間內動工規範係自110/12/17 起適用，爰 110/12/17 前之購地貸款案件本欄亦請填'N'。) */
  @Column(name = "`LandLoanFg`", length = 1)
  private String landLoanFg;

  // 約定動工之一定期間
  /* 金管會111/5/27函文:51 欄購地貸款註記為 Y，本欄為必填，請填寫購地貸款借款人切結動工之一定期間，以月數表示，如約定 18 個月動工，則本欄填報'18'。51 欄填報為 N，本欄請空白。 */
  @Column(name = "`StarBuildingPeriod`", length = 2)
  private String starBuildingPeriod;

  // 實際興建年月
  /* 金管會111/5/27函文:51 欄購地貸款註記為 Y，本欄為必填，請填寫實際興建年月'YYYMM'，若尚未興建，請填報'00000'。51 欄填報為 N，本欄請空白。 */
...
/**
	* 購地貸款註記<br>
	* 金管會111/5/27函文:如為 110/12/17 後新辦、續貸、轉貸之購地貸款案件，本
...
/**
	* 約定動工之一定期間<br>
	* 金管會111/5/27函文:51 欄購地貸款註記為 Y，本欄為必填，請填寫購地貸款借
...
/**
	* 實際興建年月<br>
	* 金管會111/5/27函文:51 欄購地貸款註記為 Y，本欄為必填，請填寫實際興建年
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicB201 [jcicB201Id=" + jcicB201Id
           ...
           + ", syndContractDate=" + syndContractDate + ", syndRatio=" + syndRatio + ", landLoanFg=" + landLoanFg + ", starBuildingPeriod=" + starBuildingPeriod + ", starBuildingYM=" + starBuildingYM + ", payablesFg=" + payablesFg
