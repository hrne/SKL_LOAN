...
public class ClBuildingReason implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1326069011620118038L;
	...
	public String toString() {
		return "ClBuildingReason [clBuildingReasonId=" + clBuildingReasonId + ", reason=" + reason + ", otherReason=" + otherReason + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
