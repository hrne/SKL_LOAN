...
public class ClLandServiceImpl extends ASpringJpaParm implements ClLandService, InitializingBean {
	...
	@Override
	public Slice<ClLand> findIrCode(String cityCode_0, String areaCode_1, String irCode_2, String landNo1_3, String landNo1_4, String landNo2_5, String landNo2_6, int index, int limit,
			TitaVo... titaVo) {
		String dbName = "";
		Slice<ClLand> slice = null;
		if (titaVo.length != 0)
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findIrCode " + dbName + " : " + "cityCode_0 : " + cityCode_0 + " areaCode_1 : " + areaCode_1 + " irCode_2 : " + irCode_2 + " landNo1_3 : " + landNo1_3 + " landNo1_4 : " + landNo1_4
				+ " landNo2_5 : " + landNo2_5 + " landNo2_6 : " + landNo2_6);
		if (dbName.equals(ContentName.onDay))
			slice = clLandReposDay.findAllByCityCodeIsAndAreaCodeIsAndIrCodeIsAndLandNo1GreaterThanEqualAndLandNo1LessThanEqualAndLandNo2GreaterThanEqualAndLandNo2LessThanEqual(cityCode_0, areaCode_1,
					irCode_2, landNo1_3, landNo1_4, landNo2_5, landNo2_6, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = clLandReposMon.findAllByCityCodeIsAndAreaCodeIsAndIrCodeIsAndLandNo1GreaterThanEqualAndLandNo1LessThanEqualAndLandNo2GreaterThanEqualAndLandNo2LessThanEqual(cityCode_0, areaCode_1,
					irCode_2, landNo1_3, landNo1_4, landNo2_5, landNo2_6, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = clLandReposHist.findAllByCityCodeIsAndAreaCodeIsAndIrCodeIsAndLandNo1GreaterThanEqualAndLandNo1LessThanEqualAndLandNo2GreaterThanEqualAndLandNo2LessThanEqual(cityCode_0,
					areaCode_1, irCode_2, landNo1_3, landNo1_4, landNo2_5, landNo2_6, pageable);
		else
			slice = clLandRepos.findAllByCityCodeIsAndAreaCodeIsAndIrCodeIsAndLandNo1GreaterThanEqualAndLandNo1LessThanEqualAndLandNo2GreaterThanEqualAndLandNo2LessThanEqual(cityCode_0, areaCode_1,
					irCode_2, landNo1_3, landNo1_4, landNo2_5, landNo2_6, pageable);
	...
	public Slice<ClLand> findLandLocationEq(String cityCode_0, String areaCode_1, String irCode_2, String landNo1_3, String landNo2_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findLandLocationEq " + dbName + " : " + "cityCode_0 : " + cityCode_0 + " areaCode_1 : " + areaCode_1 + " irCode_2 : " + irCode_2 + " landNo1_3 : " + landNo1_3 + " landNo2_4 : "
				+ landNo2_4);
		if (dbName.equals(ContentName.onDay))
			slice = clLandReposDay.findAllByCityCodeIsAndAreaCodeIsAndIrCodeIsAndLandNo1IsAndLandNo2IsOrderByClCode1AscClCode2AscClNoAsc(cityCode_0, areaCode_1, irCode_2, landNo1_3, landNo2_4,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = clLandReposMon.findAllByCityCodeIsAndAreaCodeIsAndIrCodeIsAndLandNo1IsAndLandNo2IsOrderByClCode1AscClCode2AscClNoAsc(cityCode_0, areaCode_1, irCode_2, landNo1_3, landNo2_4,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = clLandReposHist.findAllByCityCodeIsAndAreaCodeIsAndIrCodeIsAndLandNo1IsAndLandNo2IsOrderByClCode1AscClCode2AscClNoAsc(cityCode_0, areaCode_1, irCode_2, landNo1_3, landNo2_4,
					pageable);
		else
