...
public class AchDeductMedia implements Serializable {
  ...
  // 退件理由代號
  /* 提回規格00:成功01:存款不足02:非委託用戶03:已終止委託用戶04:無此帳號05:收受者統編錯誤06:無此用戶號碼07:用戶號碼不符08:信用卡額度不足09:未開卡10:部分存款不足11:超過扣款限額22:帳戶已結清23:靜止戶24:凍結戶25:帳戶存款遭法院強制執行26:警示戶27:該用戶已死亡28:發動行申請停止入扣帳91:請參考備註一99:其他 */
  ...
  * @param relCustIdErrFg 身份證字號/統一編號錯誤註記
  ...
  public String toString() {
    return "AchDeductMedia [achDeductMediaId=" + achDeductMediaId + ", custNo=" + custNo + ", facmNo=" + facmNo + ", repayType=" + repayType
           ...
           + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + ", relCustIdErrFg=" + relCustIdErrFg + "]";
  }
}
