...
public class JcicZ447 implements Serializable {
	...
	public String toString() {
		return "JcicZ447 [jcicZ447Id=" + jcicZ447Id + ", tranKey=" + tranKey + ", civil323Amt=" + civil323Amt + ", totalAmt=" + totalAmt + ", signDate=" + signDate + ", firstPayDate=" + firstPayDate
				+ ", period=" + period + ", rate=" + rate + ", monthPayAmt=" + monthPayAmt + ", payAccount=" + payAccount + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey + ", createDate="
