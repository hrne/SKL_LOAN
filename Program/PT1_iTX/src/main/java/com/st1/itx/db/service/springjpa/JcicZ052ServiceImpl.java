...
em = null;
  ...
  public Slice<JcicZ052> custSubEq(String submitKey_0, String custId_1, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("custSubEq " + dbName + " : " + "submitKey_0 : " + submitKey_0 + " custId_1 : " +  custId_1);
    if (dbName.equals(ContentName.onDay))
      slice = jcicZ052ReposDay.findAllBySubmitKeyIsAndCustIdIsOrderByCreateDateDesc(submitKey_0, custId_1, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = jcicZ052ReposMon.findAllBySubmitKeyIsAndCustIdIsOrderByCreateDateDesc(submitKey_0, custId_1, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = jcicZ052ReposHist.findAllBySubmitKeyIsAndCustIdIsOrderByCreateDateDesc(submitKey_0, custId_1, pageable);
    else 
      slice = jcicZ052Repos.findAllBySubmitKeyIsAndCustIdIsOrderByCreateDateDesc(submitKey_0, custId_1, pageable);
  ...
  @Override
  public Slice<JcicZ052> findkeyFilingDate(int actualFilingDate_0, String actualFilingMark_1, int index, int limit, TitaVo... titaVo) {
    String dbName = "";
    Slice<JcicZ052> slice = null;
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    ...
    if (dbName.equals(ContentName.onDay))
      slice = jcicZ052ReposDay.findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(actualFilingDate_0, actualFilingMark_1, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = jcicZ052ReposMon.findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(actualFilingDate_0, actualFilingMark_1, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = jcicZ052ReposHist.findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(actualFilingDate_0, actualFilingMark_1, pageable);
    else 
      slice = jcicZ052Repos.findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(actualFilingDate_0, actualFilingMark_1, pageable);
  ...
  public JcicZ052 insert(JcicZ052 jcicZ052, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(jcicZ052.getJcicZ052Id(), titaVo) != null)
