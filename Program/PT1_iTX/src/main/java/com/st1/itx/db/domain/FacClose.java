...
public class FacClose implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6616090886665217984L;
	...
	/*
	 * 共用代碼檔
	 * CaseCloseCode0:正常1:展期2:借新還舊3:轉催收4:催收戶本人清償5:催收戶保證人代償6:催收戶強制執行7:轉列呆帳8:催收部分轉呆
	 */
	...
	// 清償原因
	/*
	 * 00:無01:買賣02:自行還清03:軍功教勞工貸款轉貸04:利率過高轉貸05:增貸不准轉貸06:額度內動支不准轉貸07:內部代償08:借新還舊09:
	 * 其他10:買回11:綁約期還款
	 */
	...
	/**
	 * 結案區分<br>
	 * 共用代碼檔 CaseCloseCode 0:正常 1:展期 2:借新還舊 3:轉催收 4:催收戶本人清償 5:催收戶保證人代償 6:催收戶強制執行
	 * 7:轉列呆帳 8:催收部分轉呆
	 * 
	 * @return String
	 */
	...
	/**
	 * 清償原因<br>
	 * 00:無 01:買賣 02:自行還清 03:軍功教勞工貸款轉貸 04:利率過高轉貸 05:增貸不准轉貸 06:額度內動支不准轉貸 07:內部代償
	 * 08:借新還舊 09:其他 10:買回 11:綁約期還款
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "FacClose [facCloseId=" + facCloseId + ", facmNo=" + facmNo + ", actFlag=" + actFlag + ", funCode=" + funCode + ", carLoan=" + carLoan + ", applDate=" + applDate + ", closeDate="
				+ closeDate + ", closeInd=" + closeInd + ", closeReasonCode=" + closeReasonCode + ", closeAmt=" + closeAmt + ", collectFlag=" + collectFlag + ", collectWayCode=" + collectWayCode
				+ ", receiveDate=" + receiveDate + ", telNo1=" + telNo1 + ", telNo2=" + telNo2 + ", telNo3=" + telNo3 + ", entryDate=" + entryDate + ", agreeNo=" + agreeNo + ", docNo=" + docNo
				+ ", docNoE=" + docNoE + ", clsNo=" + clsNo + ", rmk=" + rmk + ", receiveFg=" + receiveFg + ", postAddress=" + postAddress + ", createDate=" + createDate + ", createEmpNo="
