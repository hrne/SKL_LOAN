...
public class JcicZ450 implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 219853828296142974L;
	...
	public String toString() {
		return "JcicZ450 [jcicZ450Id=" + jcicZ450Id + ", tranKey=" + tranKey + ", payAmt=" + payAmt + ", sumRepayActualAmt=" + sumRepayActualAmt + ", sumRepayShouldAmt=" + sumRepayShouldAmt
				+ ", payStatus=" + payStatus + ", outJcicTxtDate=" + outJcicTxtDate + ", ukey=" + ukey + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
