 ...
 * @version 1.0.0
 */
public class L6CdBcmIns extends BatchBase implements Tasklet, InitializingBean {
	...
	public void run() throws LogicException {
		this.info("active L6CdBcmIns ");

		String empNo = titaVo.getTlrNo();

		String txSeq = titaVo.getParam("JobTxSeq");

		sJobMainService.Usp_L6_CdBcm_Ins(empNo, txSeq, titaVo);
	}
