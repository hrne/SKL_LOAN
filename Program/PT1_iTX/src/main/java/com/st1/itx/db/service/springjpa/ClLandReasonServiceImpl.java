...
em = null;
  ...
  @Override
  public Slice<ClLandReason> clNoL2416Eq(int clCode1_0, int clCode2_1, int clNo_2, int index, int limit, TitaVo... titaVo) {
    String dbName = "";
    Slice<ClLandReason> slice = null;
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("clNoL2416Eq " + dbName + " : " + "clCode1_0 : " + clCode1_0 + " clCode2_1 : " +  clCode2_1 + " clNo_2 : " +  clNo_2);
    if (dbName.equals(ContentName.onDay))
      slice = clLandReasonReposDay.findAllByClCode1IsAndClCode2IsAndClNoIsOrderByClCode1AscClCode2AscClNoAscLandSeqAsc(clCode1_0, clCode2_1, clNo_2, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = clLandReasonReposMon.findAllByClCode1IsAndClCode2IsAndClNoIsOrderByClCode1AscClCode2AscClNoAscLandSeqAsc(clCode1_0, clCode2_1, clNo_2, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = clLandReasonReposHist.findAllByClCode1IsAndClCode2IsAndClNoIsOrderByClCode1AscClCode2AscClNoAscLandSeqAsc(clCode1_0, clCode2_1, clNo_2, pageable);
    else 
      slice = clLandReasonRepos.findAllByClCode1IsAndClCode2IsAndClNoIsOrderByClCode1AscClCode2AscClNoAscLandSeqAsc(clCode1_0, clCode2_1, clNo_2, pageable);
  ...
  public ClLandReason insert(ClLandReason clLandReason, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(clLandReason.getClLandReasonId(), titaVo) != null)
