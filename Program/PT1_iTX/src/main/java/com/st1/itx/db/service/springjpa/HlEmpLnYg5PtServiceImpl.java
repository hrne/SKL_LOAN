...
public class HlEmpLnYg5PtServiceImpl extends ASpringJpaParm implements HlEmpLnYg5PtService, InitializingBean {
	...
	public Slice<HlEmpLnYg5Pt> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by(Sort.Direction.ASC, "WorkYM", "EmpNo"));
		else
			pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "WorkYM", "EmpNo"));
	...
	@Override
	public Slice<HlEmpLnYg5Pt> findCalDate(int calDate_0, int index, int limit, TitaVo... titaVo) {
		String dbName = "";
		Slice<HlEmpLnYg5Pt> slice = null;
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		...
		if (dbName.equals(ContentName.onDay))
			slice = hlEmpLnYg5PtReposDay.findAllByCalDateIs(calDate_0, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = hlEmpLnYg5PtReposMon.findAllByCalDateIs(calDate_0, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = hlEmpLnYg5PtReposHist.findAllByCalDateIs(calDate_0, pageable);
		else
			slice = hlEmpLnYg5PtRepos.findAllByCalDateIs(calDate_0, pageable);
	...
	public HlEmpLnYg5Pt insert(HlEmpLnYg5Pt hlEmpLnYg5Pt, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(hlEmpLnYg5Pt.getHlEmpLnYg5PtId(), titaVo) != null)
