...
em = null;
  ...
  public Slice<TxRecord> findByCustNo(int calDate_0, int calDate_1, String brNo_2, int lockCustNo_3, String importFg_4, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("findByCustNo " + dbName + " : " + "calDate_0 : " + calDate_0 + " calDate_1 : " +  calDate_1 + " brNo_2 : " +  brNo_2 + " lockCustNo_3 : " +  lockCustNo_3 + " importFg_4 : " +  importFg_4);
    if (dbName.equals(ContentName.onDay))
      slice = txRecordReposDay.findAllByCalDateGreaterThanEqualAndCalDateLessThanEqualAndBrNoIsAndLockCustNoIsAndImportFgIsOrderByCreateDateAsc(calDate_0, calDate_1, brNo_2, lockCustNo_3, importFg_4, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = txRecordReposMon.findAllByCalDateGreaterThanEqualAndCalDateLessThanEqualAndBrNoIsAndLockCustNoIsAndImportFgIsOrderByCreateDateAsc(calDate_0, calDate_1, brNo_2, lockCustNo_3, importFg_4, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = txRecordReposHist.findAllByCalDateGreaterThanEqualAndCalDateLessThanEqualAndBrNoIsAndLockCustNoIsAndImportFgIsOrderByCreateDateAsc(calDate_0, calDate_1, brNo_2, lockCustNo_3, importFg_4, pageable);
    else 
      slice = txRecordRepos.findAllByCalDateGreaterThanEqualAndCalDateLessThanEqualAndBrNoIsAndLockCustNoIsAndImportFgIsOrderByCreateDateAsc(calDate_0, calDate_1, brNo_2, lockCustNo_3, importFg_4, pageable);
