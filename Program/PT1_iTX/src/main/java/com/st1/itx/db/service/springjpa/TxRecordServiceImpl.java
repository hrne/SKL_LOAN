...
public class TxRecordServiceImpl extends ASpringJpaParm implements TxRecordService, InitializingBean {
	...
	public Slice<TxRecord> findByLC001(int entdy_0, String brNo_1, String txResult_2, int canCancel_3, int actionFg_4, int hcode_5, String tlrNo_6, String tranNo_7, int index, int limit,
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findByLC001 " + dbName + " : " + "entdy_0 : " + entdy_0 + " brNo_1 : " + brNo_1 + " txResult_2 : " + txResult_2 + " canCancel_3 : " + canCancel_3 + " actionFg_4 : " + actionFg_4
	...
	public Slice<TxRecord> findByLC002(int entdy_0, String brNo_1, String txResult_2, int canModify_3, int actionFg_4, int hcode_5, String tlrNo_6, String tranNo_7, int index, int limit,
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findByLC002 " + dbName + " : " + "entdy_0 : " + entdy_0 + " brNo_1 : " + brNo_1 + " txResult_2 : " + txResult_2 + " canModify_3 : " + canModify_3 + " actionFg_4 : " + actionFg_4
				+ " hcode_5 : " + hcode_5 + " tlrNo_6 : " + tlrNo_6 + " tranNo_7 : " + tranNo_7);
		if (dbName.equals(ContentName.onDay))
	...
	public Slice<TxRecord> findByLC011(int entdy_0, int entdy_1, String brNo_2, String txResult_3, int actionFg_4, String tlrNo_5, String tranNo_6, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findByLC011 " + dbName + " : " + "entdy_0 : " + entdy_0 + " entdy_1 : " + entdy_1 + " brNo_2 : " + brNo_2 + " txResult_3 : " + txResult_3 + " actionFg_4 : " + actionFg_4
				+ " tlrNo_5 : " + tlrNo_5 + " tranNo_6 : " + tranNo_6);
		if (dbName.equals(ContentName.onDay))
			slice = txRecordReposDay.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndBrNoIsAndTxResultIsAndActionFgIsAndTlrNoLikeAndTranNoLikeOrderByCreateDateAsc(entdy_0, entdy_1, brNo_2,
					txResult_3, actionFg_4, tlrNo_5, tranNo_6, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txRecordReposMon.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndBrNoIsAndTxResultIsAndActionFgIsAndTlrNoLikeAndTranNoLikeOrderByCreateDateAsc(entdy_0, entdy_1, brNo_2,
					txResult_3, actionFg_4, tlrNo_5, tranNo_6, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txRecordReposHist.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndBrNoIsAndTxResultIsAndActionFgIsAndTlrNoLikeAndTranNoLikeOrderByCreateDateAsc(entdy_0, entdy_1, brNo_2,
					txResult_3, actionFg_4, tlrNo_5, tranNo_6, pageable);
		else
			slice = txRecordRepos.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndBrNoIsAndTxResultIsAndActionFgIsAndTlrNoLikeAndTranNoLikeOrderByCreateDateAsc(entdy_0, entdy_1, brNo_2,
					txResult_3, actionFg_4, tlrNo_5, tranNo_6, pageable);
	...
	public Slice<TxRecord> findByLC011All(int entdy_0, int entdy_1, String brNo_2, String txResult_3, String tlrNo_4, String tranNo_5, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findByLC011All " + dbName + " : " + "entdy_0 : " + entdy_0 + " entdy_1 : " + entdy_1 + " brNo_2 : " + brNo_2 + " txResult_3 : " + txResult_3 + " tlrNo_4 : " + tlrNo_4
				+ " tranNo_5 : " + tranNo_5);
		if (dbName.equals(ContentName.onDay))
			slice = txRecordReposDay.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndBrNoIsAndTxResultIsAndTlrNoLikeAndTranNoLikeOrderByCreateDateAsc(entdy_0, entdy_1, brNo_2, txResult_3,
					tlrNo_4, tranNo_5, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txRecordReposMon.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndBrNoIsAndTxResultIsAndTlrNoLikeAndTranNoLikeOrderByCreateDateAsc(entdy_0, entdy_1, brNo_2, txResult_3,
					tlrNo_4, tranNo_5, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txRecordReposHist.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndBrNoIsAndTxResultIsAndTlrNoLikeAndTranNoLikeOrderByCreateDateAsc(entdy_0, entdy_1, brNo_2, txResult_3,
					tlrNo_4, tranNo_5, pageable);
		else
			slice = txRecordRepos.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndBrNoIsAndTxResultIsAndTlrNoLikeAndTranNoLikeOrderByCreateDateAsc(entdy_0, entdy_1, brNo_2, txResult_3, tlrNo_4,
					tranNo_5, pageable);
	...
	public Slice<TxRecord> findByLC011Hcode(int entdy_0, int entdy_1, String brNo_2, String txResult_3, int hcode_4, String tlrNo_5, String tranNo_6, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findByLC011Hcode " + dbName + " : " + "entdy_0 : " + entdy_0 + " entdy_1 : " + entdy_1 + " brNo_2 : " + brNo_2 + " txResult_3 : " + txResult_3 + " hcode_4 : " + hcode_4
				+ " tlrNo_5 : " + tlrNo_5 + " tranNo_6 : " + tranNo_6);
		if (dbName.equals(ContentName.onDay))
			slice = txRecordReposDay.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndBrNoIsAndTxResultIsAndHcodeIsAndTlrNoLikeAndTranNoLikeOrderByCreateDateAsc(entdy_0, entdy_1, brNo_2,
					txResult_3, hcode_4, tlrNo_5, tranNo_6, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txRecordReposMon.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndBrNoIsAndTxResultIsAndHcodeIsAndTlrNoLikeAndTranNoLikeOrderByCreateDateAsc(entdy_0, entdy_1, brNo_2,
					txResult_3, hcode_4, tlrNo_5, tranNo_6, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txRecordReposHist.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndBrNoIsAndTxResultIsAndHcodeIsAndTlrNoLikeAndTranNoLikeOrderByCreateDateAsc(entdy_0, entdy_1, brNo_2,
					txResult_3, hcode_4, tlrNo_5, tranNo_6, pageable);
		else
			slice = txRecordRepos.findAllByEntdyGreaterThanEqualAndEntdyLessThanEqualAndBrNoIsAndTxResultIsAndHcodeIsAndTlrNoLikeAndTranNoLikeOrderByCreateDateAsc(entdy_0, entdy_1, brNo_2, txResult_3,
					hcode_4, tlrNo_5, tranNo_6, pageable);
	...
	public Slice<TxRecord> findImportFg(int calDate_0, String brNo_1, String importFg_2, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findImportFg " + dbName + " : " + "calDate_0 : " + calDate_0 + " brNo_1 : " + brNo_1 + " importFg_2 : " + importFg_2);
		if (dbName.equals(ContentName.onDay))
			slice = txRecordReposDay.findAllByCalDateIsAndBrNoIsAndImportFgIsOrderByCreateDateAsc(calDate_0, brNo_1, importFg_2, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txRecordReposMon.findAllByCalDateIsAndBrNoIsAndImportFgIsOrderByCreateDateAsc(calDate_0, brNo_1, importFg_2, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txRecordReposHist.findAllByCalDateIsAndBrNoIsAndImportFgIsOrderByCreateDateAsc(calDate_0, brNo_1, importFg_2, pageable);
		else
			slice = txRecordRepos.findAllByCalDateIsAndBrNoIsAndImportFgIsOrderByCreateDateAsc(calDate_0, brNo_1, importFg_2, pageable);
	...
	public Slice<TxRecord> findByCalDate(int calDate_0, int calDate_1, String brNo_2, String importFg_3, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findByCalDate " + dbName + " : " + "calDate_0 : " + calDate_0 + " calDate_1 : " + calDate_1 + " brNo_2 : " + brNo_2 + " importFg_3 : " + importFg_3);
		if (dbName.equals(ContentName.onDay))
			slice = txRecordReposDay.findAllByCalDateGreaterThanEqualAndCalDateLessThanEqualAndBrNoIsAndImportFgIsOrderByCreateDateAsc(calDate_0, calDate_1, brNo_2, importFg_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txRecordReposMon.findAllByCalDateGreaterThanEqualAndCalDateLessThanEqualAndBrNoIsAndImportFgIsOrderByCreateDateAsc(calDate_0, calDate_1, brNo_2, importFg_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txRecordReposHist.findAllByCalDateGreaterThanEqualAndCalDateLessThanEqualAndBrNoIsAndImportFgIsOrderByCreateDateAsc(calDate_0, calDate_1, brNo_2, importFg_3, pageable);
		else
			slice = txRecordRepos.findAllByCalDateGreaterThanEqualAndCalDateLessThanEqualAndBrNoIsAndImportFgIsOrderByCreateDateAsc(calDate_0, calDate_1, brNo_2, importFg_3, pageable);
	...
	public Slice<TxRecord> findByCustNo(int calDate_0, int calDate_1, String brNo_2, int lockCustNo_3, String importFg_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findByCustNo " + dbName + " : " + "calDate_0 : " + calDate_0 + " calDate_1 : " + calDate_1 + " brNo_2 : " + brNo_2 + " lockCustNo_3 : " + lockCustNo_3 + " importFg_4 : "
				+ importFg_4);
		if (dbName.equals(ContentName.onDay))
			slice = txRecordReposDay.findAllByCalDateGreaterThanEqualAndCalDateLessThanEqualAndBrNoIsAndLockCustNoIsAndImportFgIsOrderByCreateDateAsc(calDate_0, calDate_1, brNo_2, lockCustNo_3,
					importFg_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txRecordReposMon.findAllByCalDateGreaterThanEqualAndCalDateLessThanEqualAndBrNoIsAndLockCustNoIsAndImportFgIsOrderByCreateDateAsc(calDate_0, calDate_1, brNo_2, lockCustNo_3,
					importFg_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txRecordReposHist.findAllByCalDateGreaterThanEqualAndCalDateLessThanEqualAndBrNoIsAndLockCustNoIsAndImportFgIsOrderByCreateDateAsc(calDate_0, calDate_1, brNo_2, lockCustNo_3,
					importFg_4, pageable);
		else
			slice = txRecordRepos.findAllByCalDateGreaterThanEqualAndCalDateLessThanEqualAndBrNoIsAndLockCustNoIsAndImportFgIsOrderByCreateDateAsc(calDate_0, calDate_1, brNo_2, lockCustNo_3,
					importFg_4, pageable);
	...
	public TxRecord insert(TxRecord txRecord, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(txRecord.getTxRecordId(), titaVo) != null)
