...
public class JcicB680 implements Serializable {
	...
	// 貸款餘額扣除擔保品鑑估值之金額
	/*
	 * 右靠左補0，單位新台幣千元，本欄位金額請四捨五入後填報，不足千元者以一千元計。為該授信戶於上述總分行機構辦理之擔保放款餘額加上部分擔保、
	 * 副擔保貸款餘額扣除所提供之擔保品鑑估值後所得之金額，上開所得之金額如小於0，則金額報送"0"。
	 */
	@Column(name = "`Amt`")
	...
	public String toString() {
		return "JcicB680 [jcicB680Id=" + jcicB680Id + ", bankItem=" + bankItem + ", branchItem=" + branchItem + ", custIdErr=" + custIdErr + ", filler6=" + filler6 + ", amt=" + amt + ", jcicDataYM="
				+ jcicDataYM + ", filler9=" + filler9 + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
