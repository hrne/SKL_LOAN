  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "LoanBook [loanBookId=" + loanBookId + ", actualDate=" + actualDate + ", status=" + status
           + ", currencyCode=" + currencyCode + ", includeIntFlag=" + includeIntFlag + ", unpaidIntFlag=" + unpaidIntFlag + ", includeFeeFlag=" + includeFeeFlag + ", bookAmt=" + bookAmt + ", repayAmt=" + repayAmt
           + ", payMethod=" + payMethod + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
  }
}
