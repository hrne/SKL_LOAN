...
public class LoanBook implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 190300096212822441L;
	...
	// 是否內含費用
	@Column(name = "`IncludeFeeFlag`", length = 1)
	private String includeFeeFlag;
	 ...
	 * @return String
	 */
	public String getIncludeFeeFlag() {
		return this.includeFeeFlag == null ? "" : this.includeFeeFlag;
	}
	 ...
	 * 
	 *
	 * @param includeFeeFlag 是否內含費用
	 */
	public void setIncludeFeeFlag(String includeFeeFlag) {
		this.includeFeeFlag = includeFeeFlag;
	}
	...
	/**
	 * 繳納方式<br>
	 * 共用代碼檔 PayMethod 1:減少每期攤還金額 2:縮短應繳期數
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "LoanBook [loanBookId=" + loanBookId + ", actualDate=" + actualDate + ", status=" + status + ", currencyCode=" + currencyCode + ", includeIntFlag=" + includeIntFlag + ", unpaidIntFlag="
				+ unpaidIntFlag + ", includeFeeFlag=" + includeFeeFlag + ", bookAmt=" + bookAmt + ", repayAmt=" + repayAmt + ", payMethod=" + payMethod + ", createDate=" + createDate
