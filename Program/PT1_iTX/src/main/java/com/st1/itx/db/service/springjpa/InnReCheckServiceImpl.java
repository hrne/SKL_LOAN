...
em = null;
  ...
  public InnReCheck insert(InnReCheck innReCheck, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(innReCheck.getInnReCheckId(), titaVo) != null)
  ...
  public void Usp_L5_InnReCheck_Upd(int tbsdyf,  String empNo,  String jobTxSeq, TitaVo... titaVo) {
    ...
    dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    if (dbName.equals(ContentName.onDay))
      innReCheckReposDay.uspL5InnrecheckUpd(tbsdyf,  empNo,  jobTxSeq);
    else if (dbName.equals(ContentName.onMon))
      innReCheckReposMon.uspL5InnrecheckUpd(tbsdyf,  empNo,  jobTxSeq);
    else if (dbName.equals(ContentName.onHist))
      innReCheckReposHist.uspL5InnrecheckUpd(tbsdyf,  empNo,  jobTxSeq);
   else
      innReCheckRepos.uspL5InnrecheckUpd(tbsdyf,  empNo,  jobTxSeq);
  }
