...
public class LoanRateChange implements Serializable {
	...
	/**
	 * 利率區分<br>
	 * 共用代碼檔 1:機動 2:固動 3:定期機動 同撥款主檔指數型階梯式利率的固定利率與撥款主檔不同 (ex.中華郵政二年期定儲機動利率)
	 * 
	 * @return String
	 */
	...
	/**
	 * 指標利率代碼<br>
	 * 共用代碼檔 01:保單分紅利率 02:中華郵政二年期定儲機動利率 99:自訂利率 階梯式利率時可能與主檔不同
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "LoanRateChange [loanRateChangeId=" + loanRateChangeId + ", status=" + status + ", rateCode=" + rateCode + ", prodNo=" + prodNo + ", baseRateCode=" + baseRateCode + ", incrFlag="
				...
				+ ", txtNo=" + txtNo + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + ", otherFields="
				+ otherFields + "]";
	}
}
