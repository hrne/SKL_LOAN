...
@Service("L7LoanIfrs9FpUpd")
@Scope("step")
/**
 * (每月日終批次)維護 LoanIfrs9Fp 每月IFRS9欄位清單F檔
 *
 * @author Chih Wei
 * @version 1.0.0
 */
public class L7LoanIfrs9FpUpd extends BatchBase implements Tasklet, InitializingBean {
	...
	public void run() throws LogicException {
		this.info("active L7LoanIfrs9FpUpd ");
		...
		this.info("active L7LoanIfrs9FpUpd tbsdyf=" + tbsdyf);
		this.info("active L7LoanIfrs9FpUpd empNo =" + empNo);
...
//		this.titaVo.putParam(ContentName.dataBase, ContentName.onLine);
		...
		sJobMainService.Usp_L7_LoanIfrs9Fp_Upd(tbsdyf, empNo, txSeq, titaVo);
	}
