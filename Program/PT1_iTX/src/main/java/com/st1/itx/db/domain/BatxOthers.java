...
public class BatxOthers implements Serializable {
	...
	/**
	 * 來源<br>
	 * 05.法院扣薪 06.理賠金 07.代收款-債權協商 09.其他 11.匯款轉帳預先作業
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "BatxOthers [batxOthersId=" + batxOthersId + ", repayCode=" + repayCode + ", repayType=" + repayType + ", repayAcCode=" + repayAcCode + ", entryDate=" + entryDate + ", repayAmt="
				+ repayAmt + ", repayId=" + repayId + ", repayName=" + repayName + ", custNo=" + custNo + ", facmNo=" + facmNo + ", custNm=" + custNm + ", rvNo=" + rvNo + ", note=" + note
