...
public class BatxOthers implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -7169871019150459333L;
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "BatxOthers [batxOthersId=" + batxOthersId + ", repayCode=" + repayCode + ", repayType=" + repayType + ", repayAcCode=" + repayAcCode
           ...
           + ", custNm=" + custNm + ", rvNo=" + rvNo + ", note=" + note + ", titaEntdy=" + titaEntdy + ", titaTlrNo=" + titaTlrNo + ", titaTxtNo=" + titaTxtNo
