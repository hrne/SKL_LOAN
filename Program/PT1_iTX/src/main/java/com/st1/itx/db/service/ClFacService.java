...
public interface ClFacService {
	...
	/**
	 * ClCode1 = ,AND ClCode2 = ,AND ClNo = ,AND ApproveNo &gt;= ,AND ApproveNo
	 * &lt;= ,AND CustNo &gt;= ,AND CustNo &lt;= ,AND FacmNo &gt;= ,AND FacmNo &lt;=
	 *
	 * @param clCode1_0   clCode1_0
	 * @param clCode2_1   clCode2_1
	 * @param clNo_2      clNo_2
	 ...
	 * ClNo &gt;= ,AND ClNo &lt;= ,AND CustNo &gt;= ,AND CustNo &lt;= ,AND FacmNo
	 * &gt;= ,AND FacmNo &lt;= ,AND ApproveNo &gt;= ,AND ApproveNo &lt;=
	 *
	 * @param clCode1_0    clCode1_0
