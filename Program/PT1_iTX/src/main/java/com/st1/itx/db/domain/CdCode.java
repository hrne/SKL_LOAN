...
public class CdCode implements Serializable {
  ...
  // 是否為數字
  /* Y:限數字 */
  @Column(name = "`IsNumeric`", length = 1)
...
/**
  ...
  public String getIsNumeric() {
    return this.isNumeric == null ? "" : this.isNumeric;
  }
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "CdCode [cdCodeId=" + cdCodeId + ", defType=" + defType + ", item=" + item + ", enable=" + enable + ", effectFlag=" + effectFlag
           + ", minCodeLength=" + minCodeLength + ", maxCodeLength=" + maxCodeLength + ", isNumeric=" + isNumeric + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
