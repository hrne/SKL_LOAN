 ...
 * @version 1.0.0
 */
public interface JcicZ450RepositoryHist extends JpaRepository<JcicZ450, JcicZ450Id> {
  ...
  public Slice<JcicZ450> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
