...
em = null;
  ...
  public PfIntranetAdjust findByBormFirst(int custNo_0, int facmNo_1, int bormNo_2, int workMonth_3, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("findByBormFirst " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " +  facmNo_1 + " bormNo_2 : " +  bormNo_2 + " workMonth_3 : " +  workMonth_3);
    Optional<PfIntranetAdjust> pfIntranetAdjustT = null;
    if (dbName.equals(ContentName.onDay))
      pfIntranetAdjustT = pfIntranetAdjustReposDay.findTopByCustNoIsAndFacmNoIsAndBormNoIsAndWorkMonthIsOrderByCustNoAscFacmNoAscBormNoAsc(custNo_0, facmNo_1, bormNo_2, workMonth_3);
    else if (dbName.equals(ContentName.onMon))
      pfIntranetAdjustT = pfIntranetAdjustReposMon.findTopByCustNoIsAndFacmNoIsAndBormNoIsAndWorkMonthIsOrderByCustNoAscFacmNoAscBormNoAsc(custNo_0, facmNo_1, bormNo_2, workMonth_3);
    else if (dbName.equals(ContentName.onHist))
      pfIntranetAdjustT = pfIntranetAdjustReposHist.findTopByCustNoIsAndFacmNoIsAndBormNoIsAndWorkMonthIsOrderByCustNoAscFacmNoAscBormNoAsc(custNo_0, facmNo_1, bormNo_2, workMonth_3);
    else 
      pfIntranetAdjustT = pfIntranetAdjustRepos.findTopByCustNoIsAndFacmNoIsAndBormNoIsAndWorkMonthIsOrderByCustNoAscFacmNoAscBormNoAsc(custNo_0, facmNo_1, bormNo_2, workMonth_3);
  ...
  public PfIntranetAdjust insert(PfIntranetAdjust pfIntranetAdjust, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(pfIntranetAdjust.getLogNo(), titaVo) != null)
