...
import com.st1.itx.db.service.springjpa.cm.L5738ServiceImpl;
...
@Component
@Scope("prototype")
public class L5738Report extends MakeReport {

	@Autowired
	L5738ServiceImpl lL5738ServiceImpl;
...
//	private int reportDate = 0;
	private String reportCode = "L5738";
...
//		String pageOrientation = "P";
		...
		List<Map<String, String>> listL5738Data1 = null;

		List<Map<String, String>> listL5738Data2 = null;

		List<Map<String, String>> listL5738Data3 = null;
		...
		try {
			...
			// Q9309141 新撥款之戶號
			listL5738Data1 = lL5738ServiceImpl.findPage1(titaVo, drawDownDateA1, drawDownDateA2, acctCodeA, renewFlagA,yearMonth);

			// Q9309142 續期放款利率 最低、最高
			listL5738Data2 = lL5738ServiceImpl.findPage2(titaVo, drawDownDateB1, acctCodeB, statusB,yearMonth);

			// Q9309143 利率超過 X.XX% 之借戶
			listL5738Data3 = lL5738ServiceImpl.findPage3(titaVo, drawDownDateC1, acctCodeC, statusC, rateC,yearMonth);
		...
		exportData(listL5738Data1, listL5738Data2, listL5738Data3, titaVo);

		boolean result = true;

		if (listL5738Data1.size() == 0 && listL5738Data2.size() == 0 && listL5738Data3.size() == 0) {
			result = false;
		}
	...
	private void exportData(List<Map<String, String>> listL5738Data1, List<Map<String, String>> listL5738Data2,
			List<Map<String, String>> listL5738Data3, TitaVo titaVo) throws LogicException {
		...
		if (listL5738Data1.size() > 0) {
			this.print(1, 1, " ");
			// 因此表User說目前還沒看到過有資料，所以暫不確定有資料的格式(各個欄位的項目)
			int count = 1;
			for (Map<String, String> r : listL5738Data1) {
				count++;
...
//		printContinueNext();
		...
		if (listL5738Data2.size() > 0) {

			this.print(1, 10, "利率");

			this.print(2, 3, "FINAL TOTALS");
			BigDecimal minRate = listL5738Data2.get(0).get("minRate").isEmpty() ? new BigDecimal("0.0")
					: new BigDecimal(listL5738Data2.get(0).get("minRate"));
			BigDecimal maxRate = listL5738Data2.get(0).get("maxRate").isEmpty() ? new BigDecimal("0.0")
					: new BigDecimal(listL5738Data2.get(0).get("maxRate"));
...
//		printContinueNext();
		...
		if (listL5738Data3.size() > 0) {
			this.print(1, 1, " ");
			int count = 1;
			for (Map<String, String> r3 : listL5738Data3) {
				count++;
