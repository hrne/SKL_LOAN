...
public class JcicRel implements Serializable {
	...
	// 關係企業關係代號
	/*
	 * 左靠A:有控制與從屬關係B:相互投資關係C:董事長（或代表公司董事、執行業務股東）或總經理與他公司董事長（或代表公司董事、執行業務股東）
	 * 或總經理為同一人或具有配偶關係
	 */
	...
	public String toString() {
		return "JcicRel [jcicRelId=" + jcicRelId + ", relYM=" + relYM + ", filler6=" + filler6 + ", filler8=" + filler8 + ", relationCode=" + relationCode + ", filler10=" + filler10 + ", endCode="
				+ endCode + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
