 ...
 * @version 1.0.0
 */
public interface JcicZ575RepositoryHist extends JpaRepository<JcicZ575, JcicZ575Id> {
  ...
  public Slice<JcicZ575> findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(int actualFilingDate_0, String actualFilingMark_1, Pageable pageable);
