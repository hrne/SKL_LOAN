...
em = null;
  ...
  @Override
  public void Usp_L7_SlipMedia_Upd(int tbsdyf,  String empNo, int acDate, int batchNo, TitaVo... titaVo) {
    String dbName = "";
    
    if (titaVo.length != 0)
    dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    if (dbName.equals(ContentName.onDay))
      slipMedia2022ReposDay.uspL7SlipmediaUpd(tbsdyf,  empNo, acDate, batchNo);
    else if (dbName.equals(ContentName.onMon))
      slipMedia2022ReposMon.uspL7SlipmediaUpd(tbsdyf,  empNo, acDate, batchNo);
    else if (dbName.equals(ContentName.onHist))
      slipMedia2022ReposHist.uspL7SlipmediaUpd(tbsdyf,  empNo, acDate, batchNo);
   else
      slipMedia2022Repos.uspL7SlipmediaUpd(tbsdyf,  empNo, acDate, batchNo);
  }
