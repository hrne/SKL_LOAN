...
em = null;
  ...
  public JcicZ048 forL5075First(String custId_0, int rcDate_1, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("forL5075First " + dbName + " : " + "custId_0 : " + custId_0 + " rcDate_1 : " +  rcDate_1);
    Optional<JcicZ048> jcicZ048T = null;
    if (dbName.equals(ContentName.onDay))
      jcicZ048T = jcicZ048ReposDay.findTopByCustIdIsAndRcDateIsOrderByOutJcicTxtDateDesc(custId_0, rcDate_1);
    else if (dbName.equals(ContentName.onMon))
      jcicZ048T = jcicZ048ReposMon.findTopByCustIdIsAndRcDateIsOrderByOutJcicTxtDateDesc(custId_0, rcDate_1);
    else if (dbName.equals(ContentName.onHist))
      jcicZ048T = jcicZ048ReposHist.findTopByCustIdIsAndRcDateIsOrderByOutJcicTxtDateDesc(custId_0, rcDate_1);
    else 
      jcicZ048T = jcicZ048Repos.findTopByCustIdIsAndRcDateIsOrderByOutJcicTxtDateDesc(custId_0, rcDate_1);

    return jcicZ048T.isPresent() ? jcicZ048T.get() : null;
  }

  @Override
  public Slice<JcicZ048> findkeyFilingDate(int actualFilingDate_0, String actualFilingMark_1, int index, int limit, TitaVo... titaVo) {
    String dbName = "";
    Slice<JcicZ048> slice = null;
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    ...
    if (dbName.equals(ContentName.onDay))
      slice = jcicZ048ReposDay.findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(actualFilingDate_0, actualFilingMark_1, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = jcicZ048ReposMon.findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(actualFilingDate_0, actualFilingMark_1, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = jcicZ048ReposHist.findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(actualFilingDate_0, actualFilingMark_1, pageable);
    else 
      slice = jcicZ048Repos.findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(actualFilingDate_0, actualFilingMark_1, pageable);
  ...
  public JcicZ048 insert(JcicZ048 jcicZ048, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(jcicZ048.getJcicZ048Id(), titaVo) != null)
