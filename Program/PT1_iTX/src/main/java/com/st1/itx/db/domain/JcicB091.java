...
public class JcicB091 implements Serializable {
	...
	public String toString() {
		return "JcicB091 [jcicB091Id=" + jcicB091Id + ", dataType=" + dataType + ", bankItem=" + bankItem + ", branchItem=" + branchItem + ", filler4=" + filler4 + ", clTypeJCIC=" + clTypeJCIC
				+ ", evaAmt=" + evaAmt + ", evaDate=" + evaDate + ", loanLimitAmt=" + loanLimitAmt + ", settingDate=" + settingDate + ", companyCountry=" + companyCountry + ", stockCode=" + stockCode
				+ ", currency=" + currency + ", pledgeEndYM=" + pledgeEndYM + ", dispPrice=" + dispPrice + ", filler19=" + filler19 + ", jcicDataYM=" + jcicDataYM + ", createDate=" + createDate
