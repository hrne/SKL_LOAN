 ...
 * @version 1.0.0
 */
public interface CdCodeRepositoryHist extends JpaRepository<CdCode, CdCodeId> {
  ...
  // DefCode %,AND Code %
  public Slice<CdCode> findAllByDefCodeLikeAndCodeLikeOrderByCodeAsc(String defCode_0, String code_1, Pageable pageable);

  // DefCode = ,AND DefType = ,AND Item %
  public Slice<CdCode> findAllByDefCodeIsAndDefTypeIsAndItemLikeOrderByCodeAsc(String defCode_0, int defType_1, String item_2, Pageable pageable);

  // DefType = ,OR DefCode % ,OR Item %
  public Slice<CdCode> findAllByDefTypeIsOrDefCodeLikeOrItemLikeOrderByCodeAsc(int defType_0, String defCode_1, String item_2, Pageable pageable);

  // DefCode % ,OR Item %
  public Slice<CdCode> findAllByDefCodeLikeOrItemLikeOrderByCodeAsc(String defCode_0, String item_1, Pageable pageable);
