...
public interface LoanBorTxService {
	 ...
	 * &lt;= ,AND AcDate &gt;= ,AND AcDate &lt;=,AND Displayflag ^i
	 *
	...
	/**
	 * CustNo = ,AND FacmNo &gt;= ,AND FacmNo &lt;= ,AND BormNo &gt;= ,AND BormNo
	 * &lt;= ,AND EntryDate &gt;= ,AND EntryDate &lt;=,AND Displayflag ^i
	 *
	 * @param custNo_0      custNo_0
	 * @param facmNo_1      facmNo_1
	 * @param facmNo_2      facmNo_2
	...
	/**
	 * CustNo = ,AND FacmNo = ,AND BormNo &gt;= ,AND BormNo &lt;= ,AND IntEndDate =
	 * ,AND TitaHCode ^i ,AND AcDate = ,AND TitaTlrNo = ,AND TitaTxtNo =
	 *
	 * @param custNo_0     custNo_0
	 * @param facmNo_1     facmNo_1
	 * @param bormNo_2     bormNo_2
