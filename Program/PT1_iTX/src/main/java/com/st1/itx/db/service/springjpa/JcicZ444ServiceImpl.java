...
em = null;
  ...
  @Override
  public JcicZ444 forL5075First(String custId_0, int applyDate_1, TitaVo... titaVo) {
    String dbName = "";
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    this.info("forL5075First " + dbName + " : " + "custId_0 : " + custId_0 + " applyDate_1 : " +  applyDate_1);
    Optional<JcicZ444> jcicZ444T = null;
    if (dbName.equals(ContentName.onDay))
      jcicZ444T = jcicZ444ReposDay.findTopByCustIdIsAndApplyDateIsOrderByOutJcicTxtDateDesc(custId_0, applyDate_1);
    else if (dbName.equals(ContentName.onMon))
      jcicZ444T = jcicZ444ReposMon.findTopByCustIdIsAndApplyDateIsOrderByOutJcicTxtDateDesc(custId_0, applyDate_1);
    else if (dbName.equals(ContentName.onHist))
      jcicZ444T = jcicZ444ReposHist.findTopByCustIdIsAndApplyDateIsOrderByOutJcicTxtDateDesc(custId_0, applyDate_1);
    else 
      jcicZ444T = jcicZ444Repos.findTopByCustIdIsAndApplyDateIsOrderByOutJcicTxtDateDesc(custId_0, applyDate_1);

    return jcicZ444T.isPresent() ? jcicZ444T.get() : null;
  }

  @Override
  public Slice<JcicZ444> findkeyFilingDate(int actualFilingDate_0, String actualFilingMark_1, int index, int limit, TitaVo... titaVo) {
    String dbName = "";
    Slice<JcicZ444> slice = null;
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    ...
    if (dbName.equals(ContentName.onDay))
      slice = jcicZ444ReposDay.findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(actualFilingDate_0, actualFilingMark_1, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = jcicZ444ReposMon.findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(actualFilingDate_0, actualFilingMark_1, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = jcicZ444ReposHist.findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(actualFilingDate_0, actualFilingMark_1, pageable);
    else 
      slice = jcicZ444Repos.findAllByActualFilingDateIsAndActualFilingMarkIsOrderByCreateDateDesc(actualFilingDate_0, actualFilingMark_1, pageable);
  ...
  public JcicZ444 insert(JcicZ444 jcicZ444, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(jcicZ444.getJcicZ444Id(), titaVo) != null)
