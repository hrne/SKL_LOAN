...
public class LoanNotYet implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7571865354191217457L;
	...
	public String toString() {
		return "LoanNotYet [loanNotYetId=" + loanNotYetId + ", notYetItem=" + notYetItem + ", yetDate=" + yetDate + ", closeDate=" + closeDate + ", reMark=" + reMark + ", createDate=" + createDate
