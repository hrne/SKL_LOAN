...
public class Ias39IntMethod implements Serializable {
	...
	public String toString() {
		return "Ias39IntMethod [ias39IntMethodId=" + ias39IntMethodId + ", principal=" + principal + ", bookValue=" + bookValue + ", accumDPAmortized=" + accumDPAmortized + ", accumDPunAmortized="
				+ accumDPunAmortized + ", dPAmortized=" + dPAmortized + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo="
				+ lastUpdateEmpNo + "]";
	}
}
