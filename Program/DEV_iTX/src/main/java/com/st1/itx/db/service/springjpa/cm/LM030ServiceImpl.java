...
public class LM030ServiceImpl extends ASpringJpaParm implements InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(LM030ServiceImpl.class);
	...
	public List<Map<String, String>> findAll(TitaVo titaVo) throws Exception {
		...
		String sql = "";
                ...
                sql += "               AND (:CustNo = 0 OR M.\"FacmNo\" = :FacmNo) ";
		...
		query.setParameter("AcDate", titaVo.getParam("AcDate"));
