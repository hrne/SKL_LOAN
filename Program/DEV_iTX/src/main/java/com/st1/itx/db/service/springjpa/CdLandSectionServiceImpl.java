...
@Repository
public class CdLandSectionServiceImpl implements CdLandSectionService, InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(CdLandSectionServiceImpl.class);
	...
	public CdLandSection findById(CdLandSectionId cdLandSectionId, TitaVo... titaVo) {
		...
		logger.info("findById " + dbName + " " + cdLandSectionId);
	...
	public Slice<CdLandSection> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		Pageable pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "CityCode", "AreaCode", "IrCode"));
	...
	public Slice<CdLandSection> landOfficeCodeEq(String landOfficeCode_0, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("landOfficeCodeEq " + dbName + " : " + "landOfficeCode_0 : " + landOfficeCode_0);
		if (dbName.equals(ContentName.onDay))
	...
	public CdLandSection holdById(CdLandSectionId cdLandSectionId, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + cdLandSectionId);
		Optional<CdLandSection> cdLandSection = null;
		if (dbName.equals(ContentName.onDay))
	...
	public CdLandSection holdById(CdLandSection cdLandSection, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + cdLandSection.getCdLandSectionId());
	...
	public CdLandSection insert(CdLandSection cdLandSection, TitaVo... titaVo) throws DBException {
		...
		logger.info("Insert..." + dbName + " " + cdLandSection.getCdLandSectionId());
	...
	public CdLandSection update(CdLandSection cdLandSection, TitaVo... titaVo) throws DBException {
		...
		logger.info("Update..." + dbName + " " + cdLandSection.getCdLandSectionId());
		if (!empNot.isEmpty())
	...
	public void delete(CdLandSection cdLandSection, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Delete..." + dbName + " " + cdLandSection.getCdLandSectionId());
		if (dbName.equals(ContentName.onDay)) {
