...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "TxAttachment [fileNo=" + fileNo + ", tranNo=" + tranNo + ", custNo=" + custNo + ", facmNo=" + facmNo + ", bormNo=" + bormNo + ", mrKey=" + mrKey
           + ", typeItem=" + typeItem + ", fileItem=" + fileItem + ", fileData=" + fileData + ", desc=" + desc + ", status=" + status + ", createDate=" + createDate
