...
public class LNM34DPServiceImpl extends ASpringJpaParm implements InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(LNM34DPServiceImpl.class);
...
//		boolean onLineMode = true;
		...
		logger.info("----------- LNM34DP.findAll ---------------");
		logger.info("-----LNM34DP TitaVo=" + titaVo);
		logger.info("-----LNM34DP Tita ENTDY=" + titaVo.getEntDy().substring(0, 6));
...
//		}
		...
		sql = "SELECT "
				...
				+ ", \"IndustryCode\", \"ClTypeJCIC\", \"Zip3\", \"ProdCode\", \"CustKind\", \"IfrsProdCode\" "
				+ " FROM  \"Ias34Dp\" "
