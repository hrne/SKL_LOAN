...
em = null;
  ...
  public Slice<CustTelNo> findCustUKey(String custUKey_0, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      slice = custTelNoReposDay.findAllByCustUKeyIsOrderByLastUpdateDesc(custUKey_0, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = custTelNoReposMon.findAllByCustUKeyIsOrderByLastUpdateDesc(custUKey_0, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = custTelNoReposHist.findAllByCustUKeyIsOrderByLastUpdateDesc(custUKey_0, pageable);
    else 
      slice = custTelNoRepos.findAllByCustUKeyIsOrderByLastUpdateDesc(custUKey_0, pageable);
  ...
  public CustTelNo insert(CustTelNo custTelNo, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(custTelNo.getTelNoUKey(), titaVo) != null)
