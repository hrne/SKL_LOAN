...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "ClBuildingPublic [clBuildingPublicId=" + clBuildingPublicId + ", publicBdNo1=" + publicBdNo1 + ", publicBdNo2=" + publicBdNo2
           + ", area=" + area + ", ownerId=" + ownerId + ", ownerName=" + ownerName + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
