...
public class L5972 extends TradeBuffer {
	// private static final Logger logger = LoggerFactory.getLogger(L5972.class);
	/* DB服務注入 */
	@Autowired
	...
	public ArrayList<TotaVo> run(TitaVo titaVo) throws LogicException {
		...
		this.info("L5972 Input FunctionCode=["+FunctionCode+"],CustNo=["+CustNo+"],CaseSeq=["+CaseSeq+"],AcDate=["+AcDate+"],TitaTlrNo=["+TitaTlrNo+"],TitaTxtNo=["+TitaTxtNo+"],CustId=["+CustId+"],DateType=["+DateType+"],DateFrom=["+DateFrom+"],DateTo=["+DateTo+"]");
		int iCustNo=0;
		int IntAcDate=0;
