...
em = null;
  ...
  public void Usp_L9_MonthlyLM052AssetClass_Ins(int tbsdyf, String empNo, String loanType,  String loanItem, String relatedCode, TitaVo... titaVo) {
    ...
    dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    if (dbName.equals(ContentName.onDay))
      monthlyLM042RBCReposDay.uspL9Monthlylm052assetclassIns(tbsdyf, empNo, loanType,  loanItem, relatedCode);
    else if (dbName.equals(ContentName.onMon))
      monthlyLM042RBCReposMon.uspL9Monthlylm052assetclassIns(tbsdyf, empNo, loanType,  loanItem, relatedCode);
    else if (dbName.equals(ContentName.onHist))
      monthlyLM042RBCReposHist.uspL9Monthlylm052assetclassIns(tbsdyf, empNo, loanType,  loanItem, relatedCode);
   else
      monthlyLM042RBCRepos.uspL9Monthlylm052assetclassIns(tbsdyf, empNo, loanType,  loanItem, relatedCode);
  }
