...
public interface TxRecordRepositoryHist extends JpaRepository<TxRecord, TxRecordId> {
	...
	// Entdy = ,AND BrNo =,AND ImportFg =
	public Slice<TxRecord> findAllByEntdyIsAndBrNoIsAndImportFgIsOrderByCreateDateAsc(int entdy_0, String brNo_1, String importFg_2, Pageable pageable);
