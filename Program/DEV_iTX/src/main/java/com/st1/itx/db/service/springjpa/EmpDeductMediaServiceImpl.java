...
public class EmpDeductMediaServiceImpl extends ASpringJpaParm implements EmpDeductMediaService, InitializingBean {
	...
	public EmpDeductMedia receiveCheckFirst(String mediaKind_0, int custNo_1, int entryDate_2, int repayCode_3, BigDecimal repayAmt_4, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("receiveCheckFirst " + dbName + " : " + "mediaKind_0 : " + mediaKind_0 + " custNo_1 : " + custNo_1 + " entryDate_2 : " + entryDate_2 + " repayCode_3 : " + repayCode_3
				+ " repayAmt_4 : " + repayAmt_4);
		Optional<EmpDeductMedia> empDeductMediaT = null;
		if (dbName.equals(ContentName.onDay))
			empDeductMediaT = empDeductMediaReposDay.findTopByMediaKindIsAndCustNoIsAndEntryDateIsAndRepayCodeIsAndRepayAmtIsOrderByMediaDateDesc(mediaKind_0, custNo_1, entryDate_2, repayCode_3,
					repayAmt_4);
		else if (dbName.equals(ContentName.onMon))
			empDeductMediaT = empDeductMediaReposMon.findTopByMediaKindIsAndCustNoIsAndEntryDateIsAndRepayCodeIsAndRepayAmtIsOrderByMediaDateDesc(mediaKind_0, custNo_1, entryDate_2, repayCode_3,
					repayAmt_4);
		else if (dbName.equals(ContentName.onHist))
			empDeductMediaT = empDeductMediaReposHist.findTopByMediaKindIsAndCustNoIsAndEntryDateIsAndRepayCodeIsAndRepayAmtIsOrderByMediaDateDesc(mediaKind_0, custNo_1, entryDate_2, repayCode_3,
					repayAmt_4);
		else
			empDeductMediaT = empDeductMediaRepos.findTopByMediaKindIsAndCustNoIsAndEntryDateIsAndRepayCodeIsAndRepayAmtIsOrderByMediaDateDesc(mediaKind_0, custNo_1, entryDate_2, repayCode_3,
					repayAmt_4);
