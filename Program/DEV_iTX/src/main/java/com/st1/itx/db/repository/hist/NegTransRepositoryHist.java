 ...
 * @version 1.0.0
 */
public interface NegTransRepositoryHist extends JpaRepository<NegTrans, NegTransId> {
	...
	public Slice<NegTrans> findAllByCustNoIsAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualOrderByCustNoAscCaseSeqDescAcDateDesc(int custNo_0, int entryDate_1, int entryDate_2,
			Pageable pageable);
	...
	// ThisEntdy = , AND ThisKinbr = , AND ThisTlrNo = , AND ThisTxtNo = , AND
	// ThisSeqNo =
	public Slice<NegTrans> findAllByThisEntdyIsAndThisKinbrIsAndThisTlrNoIsAndThisTxtNoIsAndThisSeqNoIsOrderByThisEntdyAscThisSeqNoAsc(int thisEntdy_0, String thisKinbr_1, String thisTlrNo_2,
			String thisTxtNo_3, String thisSeqNo_4, Pageable pageable);
