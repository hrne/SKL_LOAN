...
public class AcMain implements Serializable {
	...
	public String toString() {
		return "AcMain [acMainId=" + acMainId + ", ydBal=" + ydBal + ", tdBal=" + tdBal + ", dbCnt=" + dbCnt + ", dbAmt=" + dbAmt + ", crCnt=" + crCnt + ", crAmt=" + crAmt + ", coreDbCnt=" + coreDbCnt
				+ ", coreDbAmt=" + coreDbAmt + ", coreCrCnt=" + coreCrCnt + ", coreCrAmt=" + coreCrAmt + ", acctCode=" + acctCode + ", monthEndYm=" + monthEndYm + ", createDate=" + createDate
