...
@Repository
public class JcicB093ServiceImpl implements JcicB093Service, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(JcicB093ServiceImpl.class);
  ...
  public JcicB093 findById(JcicB093Id jcicB093Id, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + jcicB093Id);
...
em = null;
  ...
  public JcicB093 holdById(JcicB093Id jcicB093Id, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicB093Id);
    Optional<JcicB093> jcicB093 = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicB093 holdById(JcicB093 jcicB093, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicB093.getJcicB093Id());
  ...
  public JcicB093 insert(JcicB093 jcicB093, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + jcicB093.getJcicB093Id());
  ...
  public JcicB093 update(JcicB093 jcicB093, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + jcicB093.getJcicB093Id());
    if (!empNot.isEmpty())
      jcicB093.setLastUpdateEmpNo(empNot);
  ...
  public void delete(JcicB093 jcicB093, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + jcicB093.getJcicB093Id());
    if (dbName.equals(ContentName.onDay)) {
