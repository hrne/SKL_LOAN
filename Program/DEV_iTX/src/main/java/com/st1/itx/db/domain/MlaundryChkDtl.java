...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "MlaundryChkDtl [mlaundryChkDtlId=" + mlaundryChkDtlId + ", dtlEntryDate=" + dtlEntryDate + ", repayItem=" + repayItem
           + ", dscptCode=" + dscptCode + ", txAmt=" + txAmt + ", totalCnt=" + totalCnt + ", totalAmt=" + totalAmt + ", startEntryDate=" + startEntryDate + ", createDate=" + createDate
