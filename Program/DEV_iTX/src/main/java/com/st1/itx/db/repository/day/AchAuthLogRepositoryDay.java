 ...
 * @version 1.0.0
 */
public interface AchAuthLogRepositoryDay extends JpaRepository<AchAuthLog, AchAuthLogId> {
	...
	public Slice<AchAuthLog> findAllByCustNoIsAndRepayBankIsAndAuthStatusInAndCreateFlagInOrderByRepayAcctDescAuthCreateDateDesc(int custNo_0, String repayBank_1, List<String> authStatus_2,
			List<String> createFlag_3, Pageable pageable);
