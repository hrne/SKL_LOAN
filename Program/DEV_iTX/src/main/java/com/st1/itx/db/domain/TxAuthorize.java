...
// 序號
	...
	public String toString() {
		return "TxAuthorize [autoSeq=" + autoSeq + ", supNo=" + supNo + ", tlrNo=" + tlrNo + ", reasonCode=" + reasonCode + ", reason=" + reason + ", entdy=" + entdy + ", txcd=" + txcd + ", txSeq="
				+ txSeq + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
