 ...
 * @version 1.0.0
 */
public interface ForeclosureFeeRepositoryHist extends JpaRepository<ForeclosureFee, Integer> {
	...
	public Slice<ForeclosureFee> findAllByReceiveDateGreaterThanEqualAndReceiveDateLessThanEqualAndCustNoGreaterThanEqualAndCustNoLessThanEqualOrderByCustNoAscReceiveDateAsc(int receiveDate_0,
			int receiveDate_1, int custNo_2, int custNo_3, Pageable pageable);
	...
	public Slice<ForeclosureFee> findAllByReceiveDateGreaterThanEqualAndReceiveDateLessThanEqualAndCloseDateIsOrderByCustNoAscReceiveDateAsc(int receiveDate_0, int receiveDate_1, int closeDate_2,
			Pageable pageable);
