...
@Repository
public class JcicZ049ServiceImpl implements JcicZ049Service, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(JcicZ049ServiceImpl.class);
  ...
  public JcicZ049 findById(JcicZ049Id jcicZ049Id, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + jcicZ049Id);
...
em = null;
  ...
  public JcicZ049 holdById(JcicZ049Id jcicZ049Id, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicZ049Id);
    Optional<JcicZ049> jcicZ049 = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicZ049 holdById(JcicZ049 jcicZ049, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicZ049.getJcicZ049Id());
    Optional<JcicZ049> jcicZ049T = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicZ049 insert(JcicZ049 jcicZ049, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + jcicZ049.getJcicZ049Id());
    if (this.findById(jcicZ049.getJcicZ049Id()) != null)
  ...
  public JcicZ049 update(JcicZ049 jcicZ049, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + jcicZ049.getJcicZ049Id());
    if (!empNot.isEmpty())
      jcicZ049.setLastUpdateEmpNo(empNot);
  ...
  public void delete(JcicZ049 jcicZ049, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + jcicZ049.getJcicZ049Id());
    if (dbName.equals(ContentName.onDay)) {
