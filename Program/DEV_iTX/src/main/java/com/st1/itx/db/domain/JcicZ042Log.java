...
public class JcicZ042Log implements Serializable {
	...
	public String toString() {
		return "JcicZ042Log [jcicZ042LogId=" + jcicZ042LogId + ", tranKey=" + tranKey + ", isClaims=" + isClaims + ", guarLoanCnt=" + guarLoanCnt + ", expLoanAmt=" + expLoanAmt + ", civil323ExpAmt="
				+ civil323ExpAmt + ", receExpAmt=" + receExpAmt + ", cashCardAmt=" + cashCardAmt + ", civil323CashAmt=" + civil323CashAmt + ", receCashAmt=" + receCashAmt + ", creditCardAmt="
				+ creditCardAmt + ", civil323CreditAmt=" + civil323CreditAmt + ", receCreditAmt=" + receCreditAmt + ", receExpPrin=" + receExpPrin + ", receExpInte=" + receExpInte + ", receExpPena="
				+ receExpPena + ", receExpOther=" + receExpOther + ", cashCardPrin=" + cashCardPrin + ", cashCardInte=" + cashCardInte + ", cashCardPena=" + cashCardPena + ", cashCardOther="
				+ cashCardOther + ", creditCardPrin=" + creditCardPrin + ", creditCardInte=" + creditCardInte + ", creditCardPena=" + creditCardPena + ", creditCardOther=" + creditCardOther
