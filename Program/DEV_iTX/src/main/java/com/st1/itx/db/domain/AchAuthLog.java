...
@EmbeddedId
  ...
  // 授權狀態
  /* CdCode:AuthStatus空白-未授權('':再次授權)0-成功授權/取消授權1-印鑑不符2-無此帳號3-委繳戶統一編號不符4-已核印成功在案5-原交易不存在6-電子資料與授權書內容不符7-帳戶已結清8-印鑑不清9-其他A-未收到授權書B-用戶號碼錯誤C-靜止戶D-未收到聲明書E-授權書資料不全F-警示戶G-本帳戶不適用授權扣繳H-已於他行授權扣款I-該用戶已死亡Z-未交易或匯入失敗資料 */
