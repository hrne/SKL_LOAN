...
em = null;
  ...
  public Slice<SlipMedia2022> findMediaSeq(int acDate_0, int batchNo_1, int mediaSeq_2, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      ...
      slice = slipMedia2022ReposMon.findAllByAcDateIsAndBatchNoIsAndMediaSeqIsOrderByAcDateAscBatchNoAscMediaSeqAscMediaSlipNoAscAcBookCodeAscSeqAsc(acDate_0, batchNo_1, mediaSeq_2, pageable);
    else if (dbName.equals(ContentName.onHist))
