...
public class BankRemitServiceImpl extends ASpringJpaParm implements BankRemitService, InitializingBean {
	...
	public Slice<BankRemit> findL4901B(int acDate_0, String batchNo_1, int drawdownCode_2, int drawdownCode_3, int statusCode_4, int statusCode_5, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findL4901B " + dbName + " : " + "acDate_0 : " + acDate_0 + " batchNo_1 : " + batchNo_1 + " drawdownCode_2 : " + drawdownCode_2 + " drawdownCode_3 : " + drawdownCode_3
				+ " statusCode_4 : " + statusCode_4 + " statusCode_5 : " + statusCode_5);
		if (dbName.equals(ContentName.onDay))
			slice = bankRemitReposDay
					.findAllByAcDateIsAndBatchNoIsAndDrawdownCodeGreaterThanEqualAndDrawdownCodeLessThanEqualAndStatusCodeGreaterThanEqualAndStatusCodeLessThanEqualOrderByCustNoAscFacmNoAscBormNoAsc(
							acDate_0, batchNo_1, drawdownCode_2, drawdownCode_3, statusCode_4, statusCode_5, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = bankRemitReposMon
					.findAllByAcDateIsAndBatchNoIsAndDrawdownCodeGreaterThanEqualAndDrawdownCodeLessThanEqualAndStatusCodeGreaterThanEqualAndStatusCodeLessThanEqualOrderByCustNoAscFacmNoAscBormNoAsc(
							acDate_0, batchNo_1, drawdownCode_2, drawdownCode_3, statusCode_4, statusCode_5, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = bankRemitReposHist
					.findAllByAcDateIsAndBatchNoIsAndDrawdownCodeGreaterThanEqualAndDrawdownCodeLessThanEqualAndStatusCodeGreaterThanEqualAndStatusCodeLessThanEqualOrderByCustNoAscFacmNoAscBormNoAsc(
							acDate_0, batchNo_1, drawdownCode_2, drawdownCode_3, statusCode_4, statusCode_5, pageable);
		else
			slice = bankRemitRepos
					.findAllByAcDateIsAndBatchNoIsAndDrawdownCodeGreaterThanEqualAndDrawdownCodeLessThanEqualAndStatusCodeGreaterThanEqualAndStatusCodeLessThanEqualOrderByCustNoAscFacmNoAscBormNoAsc(
							acDate_0, batchNo_1, drawdownCode_2, drawdownCode_3, statusCode_4, statusCode_5, pageable);
	...
	public Slice<BankRemit> findL4901C(int acDate_0, int drawdownCode_1, int drawdownCode_2, int statusCode_3, int statusCode_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findL4901C " + dbName + " : " + "acDate_0 : " + acDate_0 + " drawdownCode_1 : " + drawdownCode_1 + " drawdownCode_2 : " + drawdownCode_2 + " statusCode_3 : " + statusCode_3
				+ " statusCode_4 : " + statusCode_4);
		if (dbName.equals(ContentName.onDay))
			slice = bankRemitReposDay
					.findAllByAcDateIsAndDrawdownCodeGreaterThanEqualAndDrawdownCodeLessThanEqualAndStatusCodeGreaterThanEqualAndStatusCodeLessThanEqualOrderByCustNoAscFacmNoAscBormNoAsc(acDate_0,
							drawdownCode_1, drawdownCode_2, statusCode_3, statusCode_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = bankRemitReposMon
					.findAllByAcDateIsAndDrawdownCodeGreaterThanEqualAndDrawdownCodeLessThanEqualAndStatusCodeGreaterThanEqualAndStatusCodeLessThanEqualOrderByCustNoAscFacmNoAscBormNoAsc(acDate_0,
							drawdownCode_1, drawdownCode_2, statusCode_3, statusCode_4, pageable);
