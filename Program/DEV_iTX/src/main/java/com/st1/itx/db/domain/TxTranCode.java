...
// 交易代號
	...
	public String toString() {
		return "TxTranCode [tranNo=" + tranNo + ", tranItem=" + tranItem + ", desc=" + desc + ", typeFg=" + typeFg + ", cancelFg=" + cancelFg + ", modifyFg=" + modifyFg + ", menuNo=" + menuNo
				+ ", subMenuNo=" + subMenuNo + ", menuFg=" + menuFg + ", submitFg=" + submitFg + ", status=" + status + ", custDataCtrlFg=" + custDataCtrlFg + ", custRmkFg=" + custRmkFg
