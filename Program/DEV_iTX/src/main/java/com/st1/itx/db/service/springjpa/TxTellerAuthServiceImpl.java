...
@Repository
public class TxTellerAuthServiceImpl implements TxTellerAuthService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(TxTellerAuthServiceImpl.class);
  ...
  public TxTellerAuth findById(TxTellerAuthId txTellerAuthId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + txTellerAuthId);
...
em = null;
  ...
  public TxTellerAuth holdById(TxTellerAuthId txTellerAuthId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + txTellerAuthId);
    Optional<TxTellerAuth> txTellerAuth = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public TxTellerAuth holdById(TxTellerAuth txTellerAuth, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + txTellerAuth.getTxTellerAuthId());
  ...
  public TxTellerAuth insert(TxTellerAuth txTellerAuth, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + txTellerAuth.getTxTellerAuthId());
  ...
  public TxTellerAuth update(TxTellerAuth txTellerAuth, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + txTellerAuth.getTxTellerAuthId());
    if (!empNot.isEmpty())
      txTellerAuth.setLastUpdateEmpNo(empNot);
  ...
  public void delete(TxTellerAuth txTellerAuth, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + txTellerAuth.getTxTellerAuthId());
    if (dbName.equals(ContentName.onDay)) {
