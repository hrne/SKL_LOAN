...
public class InsuRenewMediaTemp implements Serializable {
	...
	public String toString() {
		return "InsuRenewMediaTemp [insuRenewMediaTempId=" + insuRenewMediaTempId + ", returnCode=" + returnCode + ", insuCampCode=" + insuCampCode + ", insuCustId=" + insuCustId + ", insuCustName="
				+ insuCustName + ", loanCustId=" + loanCustId + ", loanCustName=" + loanCustName + ", postalCode=" + postalCode + ", address=" + address + ", buildingSquare=" + buildingSquare
				+ ", buildingCode=" + buildingCode + ", buildingYears=" + buildingYears + ", buildingFloors=" + buildingFloors + ", roofCode=" + roofCode + ", businessUnit=" + businessUnit
				+ ", clCode1=" + clCode1 + ", clCode2=" + clCode2 + ", clNo=" + clNo + ", seq=" + seq + ", insuStartDate=" + insuStartDate + ", insuEndDate=" + insuEndDate + ", fireInsuAmt="
				+ fireInsuAmt + ", fireInsuFee=" + fireInsuFee + ", eqInsuAmt=" + eqInsuAmt + ", eqInsuFee=" + eqInsuFee + ", custNo=" + custNo + ", facmNo=" + facmNo + ", space=" + space
				+ ", sendDate=" + sendDate + ", newInusNo=" + newInusNo + ", newInsuStartDate=" + newInsuStartDate + ", newInsuEndDate=" + newInsuEndDate + ", newFireInsuAmt=" + newFireInsuAmt
				+ ", newFireInsuFee=" + newFireInsuFee + ", newEqInsuAmt=" + newEqInsuAmt + ", newEqInsuFee=" + newEqInsuFee + ", newTotalFee=" + newTotalFee + ", remark1=" + remark1
				...
				+ sklSalesCode + ", renewTrlCode=" + renewTrlCode + ", renewUnit=" + renewUnit + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
