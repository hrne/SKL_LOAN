...
@Repository
public class TxAuthGroupServiceImpl implements TxAuthGroupService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(TxAuthGroupServiceImpl.class);
  ...
  public TxAuthGroup findById(String authNo, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + authNo);
...
em = null;
  ...
  public Slice<TxAuthGroup> AuthNoLike(String authNo_0, int index, int limit, TitaVo... titaVo) {
    ...
    logger.info("AuthNoLike " + dbName + " : " + "authNo_0 : " + authNo_0);
    if (dbName.equals(ContentName.onDay))
      slice = txAuthGroupReposDay.findAllByAuthNoLikeOrderByAuthNoAsc(authNo_0, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = txAuthGroupReposMon.findAllByAuthNoLikeOrderByAuthNoAsc(authNo_0, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = txAuthGroupReposHist.findAllByAuthNoLikeOrderByAuthNoAsc(authNo_0, pageable);
    else 
      slice = txAuthGroupRepos.findAllByAuthNoLikeOrderByAuthNoAsc(authNo_0, pageable);
  ...
  public Slice<TxAuthGroup> BranchAll(String branchNo_0, int levelFg_1, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("BranchAll " + dbName + " : " + "branchNo_0 : " + branchNo_0 + " levelFg_1 : " +  levelFg_1);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<TxAuthGroup> BranchAuthNo(String branchNo_0, String authNo_1, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("BranchAuthNo " + dbName + " : " + "branchNo_0 : " + branchNo_0 + " authNo_1 : " +  authNo_1);
    if (dbName.equals(ContentName.onDay))
      slice = txAuthGroupReposDay.findAllByBranchNoIsAndAuthNoLikeOrderByBranchNoAscAuthNoAsc(branchNo_0, authNo_1, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = txAuthGroupReposMon.findAllByBranchNoIsAndAuthNoLikeOrderByBranchNoAscAuthNoAsc(branchNo_0, authNo_1, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = txAuthGroupReposHist.findAllByBranchNoIsAndAuthNoLikeOrderByBranchNoAscAuthNoAsc(branchNo_0, authNo_1, pageable);
    else 
      slice = txAuthGroupRepos.findAllByBranchNoIsAndAuthNoLikeOrderByBranchNoAscAuthNoAsc(branchNo_0, authNo_1, pageable);
  ...
  public TxAuthGroup holdById(String authNo, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + authNo);
    Optional<TxAuthGroup> txAuthGroup = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public TxAuthGroup holdById(TxAuthGroup txAuthGroup, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + txAuthGroup.getAuthNo());
  ...
  public TxAuthGroup insert(TxAuthGroup txAuthGroup, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + txAuthGroup.getAuthNo());
    if (this.findById(txAuthGroup.getAuthNo()) != null)
  ...
  public TxAuthGroup update(TxAuthGroup txAuthGroup, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + txAuthGroup.getAuthNo());
    if (!empNot.isEmpty())
      txAuthGroup.setLastUpdateEmpNo(empNot);
  ...
  public void delete(TxAuthGroup txAuthGroup, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + txAuthGroup.getAuthNo());
    if (dbName.equals(ContentName.onDay)) {
