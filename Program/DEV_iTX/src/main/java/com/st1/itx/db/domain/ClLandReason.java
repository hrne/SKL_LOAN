...
public class ClLandReason implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3302876454001785075L;
	...
	public String toString() {
		return "ClLandReason [clLandReasonId=" + clLandReasonId + ", reason=" + reason + ", otherReason=" + otherReason + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
