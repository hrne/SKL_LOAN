...
public class CdBaseRateServiceImpl extends ASpringJpaParm implements CdBaseRateService, InitializingBean {
	...
	public Slice<CdBaseRate> baseRateCodeEq(String currencyCode_0, String baseRateCode_1, int effectDate_2, int effectDate_3, int index, int limit, TitaVo... titaVo) {
		...
		this.info("baseRateCodeEq " + dbName + " : " + "currencyCode_0 : " + currencyCode_0 + " baseRateCode_1 : " + baseRateCode_1 + " effectDate_2 : " + effectDate_2 + " effectDate_3 : "
				+ effectDate_3);
		if (dbName.equals(ContentName.onDay))
			slice = cdBaseRateReposDay.findAllByCurrencyCodeIsAndBaseRateCodeIsAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByEffectDateAsc(currencyCode_0, baseRateCode_1, effectDate_2,
					effectDate_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = cdBaseRateReposMon.findAllByCurrencyCodeIsAndBaseRateCodeIsAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByEffectDateAsc(currencyCode_0, baseRateCode_1, effectDate_2,
					effectDate_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = cdBaseRateReposHist.findAllByCurrencyCodeIsAndBaseRateCodeIsAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByEffectDateAsc(currencyCode_0, baseRateCode_1,
					effectDate_2, effectDate_3, pageable);
		else
			slice = cdBaseRateRepos.findAllByCurrencyCodeIsAndBaseRateCodeIsAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByEffectDateAsc(currencyCode_0, baseRateCode_1, effectDate_2,
					effectDate_3, pageable);
	...
	public CdBaseRate baseRateCodeDescFirst(String currencyCode_0, String baseRateCode_1, int effectDate_2, int effectDate_3, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("baseRateCodeDescFirst " + dbName + " : " + "currencyCode_0 : " + currencyCode_0 + " baseRateCode_1 : " + baseRateCode_1 + " effectDate_2 : " + effectDate_2 + " effectDate_3 : "
				+ effectDate_3);
		Optional<CdBaseRate> cdBaseRateT = null;
		if (dbName.equals(ContentName.onDay))
			cdBaseRateT = cdBaseRateReposDay.findTopByCurrencyCodeIsAndBaseRateCodeIsAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByEffectDateDesc(currencyCode_0, baseRateCode_1,
					effectDate_2, effectDate_3);
		else if (dbName.equals(ContentName.onMon))
			cdBaseRateT = cdBaseRateReposMon.findTopByCurrencyCodeIsAndBaseRateCodeIsAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByEffectDateDesc(currencyCode_0, baseRateCode_1,
					effectDate_2, effectDate_3);
		else if (dbName.equals(ContentName.onHist))
			cdBaseRateT = cdBaseRateReposHist.findTopByCurrencyCodeIsAndBaseRateCodeIsAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByEffectDateDesc(currencyCode_0, baseRateCode_1,
					effectDate_2, effectDate_3);
		else
			cdBaseRateT = cdBaseRateRepos.findTopByCurrencyCodeIsAndBaseRateCodeIsAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByEffectDateDesc(currencyCode_0, baseRateCode_1,
					effectDate_2, effectDate_3);
	...
	public CdBaseRate baseRateCodeAscFirst(String currencyCode_0, String baseRateCode_1, int effectDate_2, int effectDate_3, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("baseRateCodeAscFirst " + dbName + " : " + "currencyCode_0 : " + currencyCode_0 + " baseRateCode_1 : " + baseRateCode_1 + " effectDate_2 : " + effectDate_2 + " effectDate_3 : "
				+ effectDate_3);
		Optional<CdBaseRate> cdBaseRateT = null;
		if (dbName.equals(ContentName.onDay))
			cdBaseRateT = cdBaseRateReposDay.findTopByCurrencyCodeIsAndBaseRateCodeIsAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByEffectDateAsc(currencyCode_0, baseRateCode_1,
					effectDate_2, effectDate_3);
		else if (dbName.equals(ContentName.onMon))
			cdBaseRateT = cdBaseRateReposMon.findTopByCurrencyCodeIsAndBaseRateCodeIsAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByEffectDateAsc(currencyCode_0, baseRateCode_1,
					effectDate_2, effectDate_3);
		else if (dbName.equals(ContentName.onHist))
			cdBaseRateT = cdBaseRateReposHist.findTopByCurrencyCodeIsAndBaseRateCodeIsAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByEffectDateAsc(currencyCode_0, baseRateCode_1,
					effectDate_2, effectDate_3);
		else
			cdBaseRateT = cdBaseRateRepos.findTopByCurrencyCodeIsAndBaseRateCodeIsAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByEffectDateAsc(currencyCode_0, baseRateCode_1,
					effectDate_2, effectDate_3);
	...
	public Slice<CdBaseRate> baseRateCodeRange(String currencyCode_0, String baseRateCode_1, String baseRateCode_2, int effectDate_3, int effectDate_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("baseRateCodeRange " + dbName + " : " + "currencyCode_0 : " + currencyCode_0 + " baseRateCode_1 : " + baseRateCode_1 + " baseRateCode_2 : " + baseRateCode_2 + " effectDate_3 : "
				+ effectDate_3 + " effectDate_4 : " + effectDate_4);
		if (dbName.equals(ContentName.onDay))
			slice = cdBaseRateReposDay
					.findAllByCurrencyCodeIsAndBaseRateCodeGreaterThanEqualAndBaseRateCodeLessThanEqualAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByBaseRateCodeAscEffectDateDesc(
							currencyCode_0, baseRateCode_1, baseRateCode_2, effectDate_3, effectDate_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = cdBaseRateReposMon
					.findAllByCurrencyCodeIsAndBaseRateCodeGreaterThanEqualAndBaseRateCodeLessThanEqualAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByBaseRateCodeAscEffectDateDesc(
							currencyCode_0, baseRateCode_1, baseRateCode_2, effectDate_3, effectDate_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = cdBaseRateReposHist
					.findAllByCurrencyCodeIsAndBaseRateCodeGreaterThanEqualAndBaseRateCodeLessThanEqualAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByBaseRateCodeAscEffectDateDesc(
							currencyCode_0, baseRateCode_1, baseRateCode_2, effectDate_3, effectDate_4, pageable);
		else
			slice = cdBaseRateRepos
					.findAllByCurrencyCodeIsAndBaseRateCodeGreaterThanEqualAndBaseRateCodeLessThanEqualAndEffectDateGreaterThanEqualAndEffectDateLessThanEqualOrderByBaseRateCodeAscEffectDateDesc(
							currencyCode_0, baseRateCode_1, baseRateCode_2, effectDate_3, effectDate_4, pageable);
	...
	public Slice<CdBaseRate> effectFlagEq(String currencyCode_0, String baseRateCode_1, int effectFlag_2, int effectDate_3, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("effectFlagEq " + dbName + " : " + "currencyCode_0 : " + currencyCode_0 + " baseRateCode_1 : " + baseRateCode_1 + " effectFlag_2 : " + effectFlag_2 + " effectDate_3 : "
				+ effectDate_3);
		if (dbName.equals(ContentName.onDay))
			slice = cdBaseRateReposDay.findAllByCurrencyCodeIsAndBaseRateCodeIsAndEffectFlagIsAndEffectDateGreaterThanEqualOrderByEffectDateAsc(currencyCode_0, baseRateCode_1, effectFlag_2,
					effectDate_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = cdBaseRateReposMon.findAllByCurrencyCodeIsAndBaseRateCodeIsAndEffectFlagIsAndEffectDateGreaterThanEqualOrderByEffectDateAsc(currencyCode_0, baseRateCode_1, effectFlag_2,
					effectDate_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = cdBaseRateReposHist.findAllByCurrencyCodeIsAndBaseRateCodeIsAndEffectFlagIsAndEffectDateGreaterThanEqualOrderByEffectDateAsc(currencyCode_0, baseRateCode_1, effectFlag_2,
					effectDate_3, pageable);
		else
			slice = cdBaseRateRepos.findAllByCurrencyCodeIsAndBaseRateCodeIsAndEffectFlagIsAndEffectDateGreaterThanEqualOrderByEffectDateAsc(currencyCode_0, baseRateCode_1, effectFlag_2, effectDate_3,
					pageable);
