...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "PfBsOfficer [pfBsOfficerId=" + pfBsOfficerId + ", fullname=" + fullname + ", areaCode=" + areaCode + ", areaItem=" + areaItem + ", deptCode=" + deptCode
           + ", depItem=" + depItem + ", distCode=" + distCode + ", distItem=" + distItem + ", stationName=" + stationName + ", goalAmt=" + goalAmt + ", smryGoalAmt=" + smryGoalAmt
