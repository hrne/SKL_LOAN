 ...
 * @version 1.0.0
 */
public interface NegAppr01RepositoryDay extends JpaRepository<NegAppr01, NegAppr01Id> {
  ...
  public Slice<NegAppr01> findAllByCustNoIsAndCaseSeqIsAndExportDateIsOrderByCreateDateDescFinCodeAsc(int custNo_0, int caseSeq_1, int exportDate_2, Pageable pageable);
