...
public class FinReportProfit implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6606936538189215001L;
	...
	public String toString() {
		return "FinReportProfit [finReportProfitId=" + finReportProfitId + ", busIncome=" + busIncome + ", growRate=" + growRate + ", busCost=" + busCost + ", busGrossProfit=" + busGrossProfit
				+ ", manageFee=" + manageFee + ", busLossProfit=" + busLossProfit + ", busOtherIncome=" + busOtherIncome + ", interest=" + interest + ", busOtherFee=" + busOtherFee + ", beforeTaxNet="
				+ beforeTaxNet + ", busTax=" + busTax + ", homeLossProfit=" + homeLossProfit + ", otherComLossProfit=" + otherComLossProfit + ", homeComLossProfit=" + homeComLossProfit
				+ ", uncontrolRight=" + uncontrolRight + ", parentCompanyRight=" + parentCompanyRight + ", ePS=" + ePS + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate="
