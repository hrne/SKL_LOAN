...
// 序號
	...
	/**
	 * 業績日期<br>
	 * 1.撥貸(計件代碼變更)，為撥款日期 2.部分償還、提前結案，為會計日
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "PfReward [logNo=" + logNo + ", perfDate=" + perfDate + ", custNo=" + custNo + ", facmNo=" + facmNo + ", bormNo=" + bormNo + ", repayType=" + repayType + ", pieceCode=" + pieceCode
				+ ", prodCode=" + prodCode + ", introducer=" + introducer + ", coorgnizer=" + coorgnizer + ", interviewerA=" + interviewerA + ", interviewerB=" + interviewerB + ", introducerBonus="
				+ introducerBonus + ", introducerBonusDate=" + introducerBonusDate + ", introducerAddBonus=" + introducerAddBonus + ", introducerAddBonusDate=" + introducerAddBonusDate
				+ ", coorgnizerBonus=" + coorgnizerBonus + ", coorgnizerBonusDate=" + coorgnizerBonusDate + ", workMonth=" + workMonth + ", workSeason=" + workSeason + ", createDate=" + createDate
