...
@Repository
public class LoanIfrsJpServiceImpl implements LoanIfrsJpService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(LoanIfrsJpServiceImpl.class);
  ...
  public LoanIfrsJp findById(LoanIfrsJpId loanIfrsJpId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + loanIfrsJpId);
...
em = null;
  ...
  public LoanIfrsJp holdById(LoanIfrsJpId loanIfrsJpId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + loanIfrsJpId);
    Optional<LoanIfrsJp> loanIfrsJp = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public LoanIfrsJp holdById(LoanIfrsJp loanIfrsJp, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + loanIfrsJp.getLoanIfrsJpId());
  ...
  public LoanIfrsJp insert(LoanIfrsJp loanIfrsJp, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + loanIfrsJp.getLoanIfrsJpId());
  ...
  public LoanIfrsJp update(LoanIfrsJp loanIfrsJp, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + loanIfrsJp.getLoanIfrsJpId());
    if (!empNot.isEmpty())
      loanIfrsJp.setLastUpdateEmpNo(empNot);
  ...
  public void delete(LoanIfrsJp loanIfrsJp, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + loanIfrsJp.getLoanIfrsJpId());
    if (dbName.equals(ContentName.onDay)) {
