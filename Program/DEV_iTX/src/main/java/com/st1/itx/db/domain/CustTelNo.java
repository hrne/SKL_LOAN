...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "CustTelNo [telNoUKey=" + telNoUKey + ", custUKey=" + custUKey + ", telTypeCode=" + telTypeCode + ", telArea=" + telArea + ", telNo=" + telNo + ", telExt=" + telExt
           + ", telChgRsnCode=" + telChgRsnCode + ", relationCode=" + relationCode + ", liaisonName=" + liaisonName + ", rmk=" + rmk + ", stopReason=" + stopReason + ", enable=" + enable
