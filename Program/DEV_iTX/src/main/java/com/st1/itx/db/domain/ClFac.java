...
public class ClFac implements Serializable {
	...
	/**
	 * 主要擔保品記號<br>
	 * 是否為主要擔保品(每個核准號碼只能有一筆擔保品為主要擔保品) Y:是 N:否
	 * 
	 * @return String
	 */
	...
	/**
	 * 分配金額<br>
	 * 放款餘額的佔用金額，運算用不更新 1.先占用單獨擔保品 2.再占用共同擔保品 3.其他額度優先占用其他擔保品
	 * 
	 * @return BigDecimal
	 */
	...
	public String toString() {
		return "ClFac [clFacId=" + clFacId + ", custNo=" + custNo + ", facmNo=" + facmNo + ", mainFlag=" + mainFlag + ", facShareFlag=" + facShareFlag + ", shareAmt=" + shareAmt + ", oriSettingAmt="
				+ oriSettingAmt + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
