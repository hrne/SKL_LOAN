...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "AcCheque [acChequeId=" + acChequeId + ", bankNo=" + bankNo + ", chequeAccount=" + chequeAccount + ", amt=" + amt
           + ", chequeDate=" + chequeDate + ", keyInDate=" + keyInDate + ", expectedExchangeDate=" + expectedExchangeDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
