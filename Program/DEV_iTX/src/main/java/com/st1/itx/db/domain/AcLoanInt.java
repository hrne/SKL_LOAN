...
public class AcLoanInt implements Serializable {
	...
	/**
	 * 業務科目代號<br>
	 * CdAcCode 會計科子細目設定檔 IC1 短擔息 IC2 中擔息 IC3 長擔息 IC4 三十年房貸息
	 * 
	 * @return String
	 */
	...
	/**
	 * 帳齡<br>
	 * 以放款主檔的下次應繳日~本營業日計算 0.一個月以下 1.一～三個月 2.三～六個月 3.六個月以上
	 * 
	 * @return Integer
	 */
	public int getAging() {
	...
	public String toString() {
		return "AcLoanInt [acLoanIntId=" + acLoanIntId + ", intStartDate=" + intStartDate + ", intEndDate=" + intEndDate + ", amount=" + amount + ", intRate=" + intRate + ", principal=" + principal
				+ ", interest=" + interest + ", delayInt=" + delayInt + ", breachAmt=" + breachAmt + ", rateIncr=" + rateIncr + ", individualIncr=" + individualIncr + ", acctCode=" + acctCode
				+ ", payIntDate=" + payIntDate + ", loanBal=" + loanBal + ", aging=" + aging + ", acBookCode=" + acBookCode + ", acSubBookCode=" + acSubBookCode + ", branchNo=" + branchNo
