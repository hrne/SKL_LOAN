...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "CreditRating [creditRatingId=" + creditRatingId + ", creditRatingCode=" + creditRatingCode + ", oriModel=" + oriModel
           + ", oriRatingDate=" + oriRatingDate + ", oriRating=" + oriRating + ", model=" + model + ", ratingDate=" + ratingDate + ", rating=" + rating + ", createDate=" + createDate
