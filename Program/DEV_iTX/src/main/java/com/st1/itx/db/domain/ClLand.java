...
@EmbeddedId
  ...
  // 地目
  /* 共用代碼檔01:建02:田03:旱04:雜05:水06:道07:溜08:原09:林10:養11:墓12:祠13:鐵14:暫未編定15:公16:堤17:池18:溝19:礦 */
  ...
  // 土地使用區分
  /* 共用代碼檔01:特定農業區02:一般農業區03:鄉村區04:工業區05:森林區06:山坡地保育區07:風景區08:特定專用區09:國家公園區10:住宅區11:商業區12:行政區13:工業區14:文教區15:農業區16:風景區17:保護區18:水岸發展區19:漁業區20:倉儲區21:保存區22:葬儀業區23:特定專用區24:其他分區25:道路26:公園27:綠地28:廣場29:兒童遊樂場30:民用航空站31:停車場32:河道33:港埠34:學校35:社教機構36:體育場37:市場38:醫療衛生機構39:機關40:公用事業41:綠帶42:加油站43:其他公共設施44:道路保留地45:公園保留地46:綠地保留地47:廣場保留地48:兒童樂園場保留地49:民用航空站保留地50:停車場保留地51:河道保留地52:港埠保留地53:學校保留地54:社教機構保留地55:體育場保留地56:市場保留地57:醫療衛生機構保留地58:機關保留地59:公用事業保留地60:加油站保留地61:其他保留地 */
  @Column(name = "`LandZoningCode`", length = 2)
  private String landZoningCode;

  // 使用地類別
  /* 01:甲種建築用地02:乙種建築用地03:丙種建築用地04:丁種建築用地05:農牧用地06:礦業用地07:交通用地08:水利用地09:遊憩用地10:古蹟保存用地11:生態保護用地12:國土保安13:墳墓用地14:特定目的事業用地15:鹽業用地16:窯業用地17:林業用地18:養殖用地19:都市用地20:暫未編定 */
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "ClLand [clLandId=" + clLandId + ", cityCode=" + cityCode + ", areaCode=" + areaCode
           + ", irCode=" + irCode + ", landNo1=" + landNo1 + ", landNo2=" + landNo2 + ", landLocation=" + landLocation + ", landCode=" + landCode + ", area=" + area
           + ", landZoningCode=" + landZoningCode + ", landUsageType=" + landUsageType + ", landUsageCode=" + landUsageCode + ", postedLandValue=" + postedLandValue + ", postedLandValueYearMonth=" + postedLandValueYearMonth + ", transferedYear=" + transferedYear
           + ", lastTransferedAmt=" + lastTransferedAmt + ", lVITax=" + lVITax + ", lVITaxYearMonth=" + lVITaxYearMonth + ", evaUnitPrice=" + evaUnitPrice + ", landRentStartDate=" + landRentStartDate + ", landRentEndDate=" + landRentEndDate
