 ...
 */
@Embeddable
public class LoanIfrsJpId implements Serializable {


  /**
	 * 
	 */
	private static final long serialVersionUID = 3511812677089355698L;
...
// 年月份
  ...
  public LoanIfrsJpId(int dataYM, int acDateYM, int custNo, int newFacmNo, int newBormNo, int oldFacmNo, int oldBormNo) {
    this.dataYM = dataYM;
  ...
  * @param oldBormNo 舊撥款序號
  ...
  public boolean equals(Object obj) {
    ...
    if(obj == null || getClass() != obj.getClass())
      return false;
    LoanIfrsJpId loanIfrsJpId = (LoanIfrsJpId) obj;
    return dataYM == loanIfrsJpId.dataYM && acDateYM == loanIfrsJpId.acDateYM && custNo == loanIfrsJpId.custNo && newFacmNo == loanIfrsJpId.newFacmNo && newBormNo == loanIfrsJpId.newBormNo && oldFacmNo == loanIfrsJpId.oldFacmNo && oldBormNo == loanIfrsJpId.oldBormNo;
  }

  @Override
  public String toString() {
    return "LoanIfrsJpId [dataYM=" + dataYM + ", acDateYM=" + acDateYM + ", custNo=" + custNo + ", newFacmNo=" + newFacmNo + ", newBormNo=" + newBormNo + ", oldFacmNo=" + oldFacmNo + ", oldBormNo=" + oldBormNo + "]";
  }
}
