...
@Repository
public class TxAmlNoticeServiceImpl implements TxAmlNoticeService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(TxAmlNoticeServiceImpl.class);
  ...
  public TxAmlNotice findById(TxAmlNoticeId txAmlNoticeId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + txAmlNoticeId);
...
em = null;
  ...
  public Slice<TxAmlNotice> processAll(int dataDt_0, String custKey_1, int index, int limit, TitaVo... titaVo) {
    ...
    logger.info("processAll " + dbName + " : " + "dataDt_0 : " + dataDt_0 + " custKey_1 : " +  custKey_1);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<TxAmlNotice> processDateAll(int processDate_0, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("processDateAll " + dbName + " : " + "processDate_0 : " + processDate_0);
    if (dbName.equals(ContentName.onDay))
  ...
  public TxAmlNotice holdById(TxAmlNoticeId txAmlNoticeId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + txAmlNoticeId);
    Optional<TxAmlNotice> txAmlNotice = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public TxAmlNotice holdById(TxAmlNotice txAmlNotice, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + txAmlNotice.getTxAmlNoticeId());
  ...
  public TxAmlNotice insert(TxAmlNotice txAmlNotice, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + txAmlNotice.getTxAmlNoticeId());
    if (this.findById(txAmlNotice.getTxAmlNoticeId()) != null)
  ...
  public TxAmlNotice update(TxAmlNotice txAmlNotice, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + txAmlNotice.getTxAmlNoticeId());
    if (!empNot.isEmpty())
  ...
  public void delete(TxAmlNotice txAmlNotice, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + txAmlNotice.getTxAmlNoticeId());
    if (dbName.equals(ContentName.onDay)) {
