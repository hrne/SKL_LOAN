...
public class JcicServiceImpl extends ASpringJpaParm implements InitializingBean {
	...
	public String sqlJcic(TitaVo titaVo,String chainCd) {
		...
		if(("L8R10").equals(chainCd)) {
			String sqlL8R10=SqlJcicZ040()+
					"AND Jcic.\"CustId\"=:CustId " +
					"AND Jcic.\"RcDate\"=:RcDate " + 
					"AND Jcic.\"SubmitKey\"=:SubmitKey ";
			sql=sqlL8R10;
		}
	...
	private String SqlJcicZ040() {
		String sqlJcicZ040="SELECT  " + 
			...
			"Jcic.\"NotBankId6\", " + 
			"Jcic.\"OutJcicTxtDate\", " + 
			"Cd0.\"Item\" AS \"SubmitKeyX\", " + 
			"Cd7.\"Item\" AS \"RefBankIdX\", " + 
			"Cd1.\"Item\" AS \"NotBankId1X\", " + 
			"Cd2.\"Item\" AS \"NotBankId2X\", " + 
			"Cd3.\"Item\" AS \"NotBankId3X\", " + 
			"Cd4.\"Item\" AS \"NotBankId4X\", " + 
			"Cd5.\"Item\" AS \"NotBankId5X\", " + 
			"Cd6.\"Item\" AS \"NotBankId6X\" " + 
			"FROM \"JcicZ040\" Jcic " + 
			...
			"LEFT JOIN \"CdCode\" Cd7 ON Cd7.\"DefCode\"='JcicBankCode' AND Cd7.\"Code\"=Jcic.\"RefBankId\" " + 
			"WHERE 1=1 ";
		return sqlJcicZ040;
	}
