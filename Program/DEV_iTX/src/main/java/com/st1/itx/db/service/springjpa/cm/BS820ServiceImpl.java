...
@Service("bS820ServiceImpl")
@Repository
/* 逾期放款明細 */
public class BS820ServiceImpl extends ASpringJpaParm implements InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(BS820ServiceImpl.class);
	...
	public List<Map<String, String>> findAll(TitaVo titaVo) throws Exception {
		...
		sql += "                  THEN 2                                        \n";
		sql += "             WHEN F.\"Factor3Amt\" >= " + iFactor3TotLimit;
		sql += "                  THEN 3                                        \n";
		sql += "             ELSE 0                                             \n";
		sql += "        END ) > 0                                               \n";
	...
	@SuppressWarnings("unchecked")
	public List<Map<String, String>> findChkDtl(TitaVo titaVo) throws Exception {
		String iFactorDays = titaVo.getParam("FactorDays"); // 統計期間天數
		String iFactor2AmtStart = titaVo.getParam("Factor2AmtStart"); // 洗錢樣態二單筆起始金額
		String iFactor2AmtEnd = titaVo.getParam("Factor2AmtEnd"); // 洗錢樣態二單筆迄止金額
		String sql = "　";
