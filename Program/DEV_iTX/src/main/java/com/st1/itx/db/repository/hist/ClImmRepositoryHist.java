 ...
 * @version 1.0.0
 */
public interface ClImmRepositoryHist extends JpaRepository<ClImm, ClImmId> {
  ...
  public Slice<ClImm> findAllBySettingStatGreaterThanEqualAndSettingStatLessThanEqualAndClStatGreaterThanEqualAndClStatLessThanEqual(String settingStat_0, String settingStat_1, String clStat_2, String clStat_3, Pageable pageable);
