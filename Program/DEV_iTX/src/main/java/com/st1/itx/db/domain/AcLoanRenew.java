...
public class AcLoanRenew implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6431026233019392004L;
	...
	public String toString() {
		return "AcLoanRenew [acLoanRenewId=" + acLoanRenewId + ", renewCode=" + renewCode + ", mainFlag=" + mainFlag + ", acDate=" + acDate + ", createEmpNo=" + createEmpNo + ", createDate="
				+ createDate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + ", lastUpdate=" + lastUpdate + "]";
	}
}
