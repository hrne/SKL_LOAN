...
@Repository
public class Ias34BpServiceImpl implements Ias34BpService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(Ias34BpServiceImpl.class);
  ...
  public Ias34Bp findById(Ias34BpId ias34BpId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + ias34BpId);
...
em = null;
  ...
  public Ias34Bp holdById(Ias34BpId ias34BpId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + ias34BpId);
    Optional<Ias34Bp> ias34Bp = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public Ias34Bp holdById(Ias34Bp ias34Bp, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + ias34Bp.getIas34BpId());
  ...
  public Ias34Bp insert(Ias34Bp ias34Bp, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + ias34Bp.getIas34BpId());
  ...
  public Ias34Bp update(Ias34Bp ias34Bp, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + ias34Bp.getIas34BpId());
    if (!empNot.isEmpty())
      ias34Bp.setLastUpdateEmpNo(empNot);
  ...
  public void delete(Ias34Bp ias34Bp, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + ias34Bp.getIas34BpId());
    if (dbName.equals(ContentName.onDay)) {
