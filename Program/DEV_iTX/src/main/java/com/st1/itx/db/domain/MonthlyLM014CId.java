...
1:企金推展課
  ...
  * @param departmentCode 案件隸屬單位
  ...
  public boolean equals(Object obj) {
    ...
    return dataYM == monthlyLM014CId.dataYM && acctCode.equals(monthlyLM014CId.acctCode) && accountType == monthlyLM014CId.accountType && acBookCode.equals(monthlyLM014CId.acBookCode) && relsFlag.equals(monthlyLM014CId.relsFlag) && clFlag.equals(monthlyLM014CId.clFlag) && departmentCode.equals(monthlyLM014CId.departmentCode);
  }

  @Override
  public String toString() {
    return "MonthlyLM014CId [dataYM=" + dataYM + ", acctCode=" + acctCode + ", accountType=" + accountType + ", acBookCode=" + acBookCode + ", relsFlag=" + relsFlag + ", clFlag=" + clFlag + ", departmentCode=" + departmentCode + "]";
  }
}
