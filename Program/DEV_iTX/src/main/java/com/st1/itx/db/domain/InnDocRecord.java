...
public class InnDocRecord implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8180415788499070348L;
	...
	public String toString() {
		return "InnDocRecord [innDocRecordId=" + innDocRecordId + ", titaActFg=" + titaActFg + ", applCode=" + applCode + ", applEmpNo=" + applEmpNo + ", keeperEmpNo=" + keeperEmpNo + ", usageCode="
				...
				+ ", titaEntDy=" + titaEntDy + ", titaTlrNo=" + titaTlrNo + ", titaTxtNo=" + titaTxtNo + ", jsonFields=" + jsonFields + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
