  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicB085 [jcicB085Id=" + jcicB085Id + ", dataType=" + dataType + ", renewYM=" + renewYM + ", custId=" + custId + ", befBankItem=" + befBankItem + ", befBranchItem=" + befBranchItem
           + ", filler6=" + filler6 + ", aftBankItem=" + aftBankItem + ", aftBranchItem=" + aftBranchItem + ", filler10=" + filler10
           + ", filler12=" + filler12 + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
  }
}
