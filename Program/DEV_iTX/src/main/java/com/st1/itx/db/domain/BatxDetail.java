...
public class BatxDetail implements Serializable {
	...
	// 對帳類別
	/*
	 * CdCode:ReconCodeP01銀行存款－郵局P02銀行存款－新光A1~A7
	 * (P03銀行存款－新光匯款轉帳)P04銀行存款－台新TEM員工扣薪15/非15???TCK支票
	 */
	 ...
	 * 07.代收款-債權協商 09.其他 11.匯款轉帳預先作業 90.暫收抵繳
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 對帳類別<br>
	 * CdCode:ReconCode P01銀行存款－郵局 P02銀行存款－新光 A1~A7 (P03銀行存款－新光匯款轉帳) P04銀行存款－台新
	 * TEM員工扣薪15/非15??? TCK支票
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "BatxDetail [batxDetailId=" + batxDetailId + ", repayCode=" + repayCode + ", fileName=" + fileName + ", entryDate=" + entryDate + ", custNo=" + custNo + ", facmNo=" + facmNo + ", rvNo="
				...
				+ ", disacctAmt=" + disacctAmt + ", procStsCode=" + procStsCode + ", procCode=" + procCode + ", procNote=" + procNote + ", titaTlrNo=" + titaTlrNo + ", titaTxtNo=" + titaTxtNo
