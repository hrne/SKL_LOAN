...
//	  		  this.print(0, 19, "109/05/21"); // 計息起日
				...
				sum = sum.add(parse.stringToBigDecimal(fnAllList.get(i).get("F6"))).add(parse.stringToBigDecimal(fnAllList.get(i).get("F7"))).add(parse.stringToBigDecimal(fnAllList.get(i).get("F8")))
						.add(parse.stringToBigDecimal(fnAllList.get(i).get("F10"))).add(parse.stringToBigDecimal(fnAllList.get(i).get("F11")));
...
//			  全部筆數統計
				...
				if (j != fnAllList.size()) {
					...
					if (!fnAllList.get(i).get("F0").equals(fnAllList.get(j).get("F0")) || !fnAllList.get(i).get("F15").equals(fnAllList.get(j).get("F15"))
							|| !fnAllList.get(i).get("F16").equals(fnAllList.get(j).get("F16")) || !fnAllList.get(i).get("F17").equals(fnAllList.get(j).get("F17"))) {
