...
public class MonthlyLM052AssetClass implements Serializable {
	...
	/**
	 * 資產五分類<br>
	 * 一類：11、12 二類：21、22、23 三類：3 四類：4 五類：5 折溢價與催收：6 應收利息提列：7
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "MonthlyLM052AssetClass [monthlyLM052AssetClassId=" + monthlyLM052AssetClassId + ", loanBal=" + loanBal + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate="
