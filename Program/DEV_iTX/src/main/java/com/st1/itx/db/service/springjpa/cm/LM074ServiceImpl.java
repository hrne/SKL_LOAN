...
@Service
@Repository
public class LM074ServiceImpl extends ASpringJpaParm implements InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(LM074ServiceImpl.class);
	...
	public List<Map<String, String>> findAll(TitaVo titaVo, String RptMonth) throws Exception {
		logger.info("LM074.findAll ");
		logger.info("LM074ServiceImpl RptMonth: " + RptMonth);
