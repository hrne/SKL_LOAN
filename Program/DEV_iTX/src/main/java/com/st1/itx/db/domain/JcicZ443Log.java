...
public class JcicZ443Log implements Serializable {
	...
	public String toString() {
		return "JcicZ443Log [jcicZ443LogId=" + jcicZ443LogId + ", tranKey=" + tranKey + ", isMaxMain=" + isMaxMain + ", account=" + account + ", guarantyType=" + guarantyType + ", loanAmt=" + loanAmt
				+ ", creditAmt=" + creditAmt + ", principal=" + principal + ", interest=" + interest + ", penalty=" + penalty + ", other=" + other + ", terminalPayAmt=" + terminalPayAmt
				+ ", latestPayAmt=" + latestPayAmt + ", finalPayDay=" + finalPayDay + ", notyetacQuit=" + notyetacQuit + ", mothPayDay=" + mothPayDay + ", beginDate=" + beginDate + ", endDate="
				+ endDate + ", outJcicTxtDate=" + outJcicTxtDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
				+ "]";
	}
}
