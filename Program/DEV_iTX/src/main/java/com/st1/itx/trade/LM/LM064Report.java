...
public class LM064Report extends MakeReport {
	// private static final Logger logger = LoggerFactory.getLogger(LM064Report.class);
	...
	public void exec(TitaVo titaVo) throws LogicException {
		...
		makeExcel.open(titaVo, titaVo.getEntDyI(), titaVo.getKinbr(), "LM064", "03-個金2000萬以上小於3000萬-" + yymmRoc,
				"LM064_03-個金2000萬以上小於3000萬-" + yymmRoc, "LM064_底稿_個金2000萬以上小於3000萬.xls", "簡表");
