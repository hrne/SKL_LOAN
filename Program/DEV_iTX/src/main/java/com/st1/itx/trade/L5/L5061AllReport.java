...
public class L5061AllReport extends MakeReport{
	// private static final Logger logger = LoggerFactory.getLogger(L5061AllReport.class);
	...
	public long exec(TitaVo titaVo) throws LogicException{
		...
		String fileName = "催收催繳明細表_"+sDateS+"_"+sdateE+"(逾期件全部查詢)";
		int iFlag=0;
		...
		//電催清單處理開始
		try {
			t5061SqlReturn = iL5061ServiceImpl.FindData(sDateS, sdateE, sCustNoS, sCustNoE, 1,titaVo);
		}catch (Exception e) {
			//E5004 讀取DB語法發生問題
...
//			throw new LogicException(titaVo, "E0001","查無資料");
		...
		//面催清單處理開始
		try {
			m5061SqlReturn = iL5061ServiceImpl.FindData(sDateS, sdateE, sCustNoS, sCustNoE, 2,titaVo);
		}catch (Exception e) {
			//E5004 讀取DB語法發生問題
			this.info("L5908 ErrorForSql="+e);
			throw new LogicException(titaVo, "E5004","");
...
//			throw new LogicException(titaVo, "E0001","查無資料");
		...
		try {
			l5061SqlReturn = iL5061ServiceImpl.FindData(sDateS, sdateE, sCustNoS, sCustNoE, 3,titaVo);
		}catch (Exception e) {
			//E5004 讀取DB語法發生問題
			this.info("L5908 ErrorForSql="+e);
			throw new LogicException(titaVo, "E5004","");
