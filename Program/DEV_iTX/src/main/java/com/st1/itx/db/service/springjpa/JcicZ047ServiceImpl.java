...
@Repository
public class JcicZ047ServiceImpl implements JcicZ047Service, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(JcicZ047ServiceImpl.class);
  ...
  public JcicZ047 findById(JcicZ047Id jcicZ047Id, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + jcicZ047Id);
...
em = null;
  ...
  public JcicZ047 holdById(JcicZ047Id jcicZ047Id, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicZ047Id);
    Optional<JcicZ047> jcicZ047 = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicZ047 holdById(JcicZ047 jcicZ047, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicZ047.getJcicZ047Id());
    Optional<JcicZ047> jcicZ047T = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicZ047 insert(JcicZ047 jcicZ047, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + jcicZ047.getJcicZ047Id());
    if (this.findById(jcicZ047.getJcicZ047Id()) != null)
  ...
  public JcicZ047 update(JcicZ047 jcicZ047, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + jcicZ047.getJcicZ047Id());
    if (!empNot.isEmpty())
      jcicZ047.setLastUpdateEmpNo(empNot);
  ...
  public void delete(JcicZ047 jcicZ047, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + jcicZ047.getJcicZ047Id());
    if (dbName.equals(ContentName.onDay)) {
