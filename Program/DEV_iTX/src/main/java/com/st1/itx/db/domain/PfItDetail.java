...
// 序號
	...
	/**
	 * 業績日期<br>
	 * 業績日期=系統營業日 1.撥貸(計件代碼變更)，為撥款日期；計件代碼變更不可跨工作月 2.部分償還、提前結案，為會計日
	 * 3.保費檢核追回，為該工作月的業績止日
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 產出媒體檔記號<br>
	 * 0:尚未產生媒體檔 1:已產生發放媒體-(不可刪除與異動) 2:人工維護後之原資料(不出媒體) 3.保費檢核結果為Y時已追回撥款，還款不用追回
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "PfItDetail [logNo=" + logNo + ", perfDate=" + perfDate + ", custNo=" + custNo + ", facmNo=" + facmNo + ", bormNo=" + bormNo + ", repayType=" + repayType + ", drawdownDate="
				+ drawdownDate + ", prodCode=" + prodCode + ", pieceCode=" + pieceCode + ", cntingCode=" + cntingCode + ", drawdownAmt=" + drawdownAmt + ", unitCode=" + unitCode + ", distCode="
				+ distCode + ", deptCode=" + deptCode + ", introducer=" + introducer + ", unitManager=" + unitManager + ", distManager=" + distManager + ", deptManager=" + deptManager + ", perfCnt="
				+ perfCnt + ", perfEqAmt=" + perfEqAmt + ", perfReward=" + perfReward + ", perfAmt=" + perfAmt + ", workMonth=" + workMonth + ", workSeason=" + workSeason + ", rewardDate="
				+ rewardDate + ", mediaDate=" + mediaDate + ", mediaFg=" + mediaFg + ", adjRange=" + adjRange + ", adjPerfEqAmt=" + adjPerfEqAmt + ", adjPerfReward=" + adjPerfReward + ", adjPerfAmt="
				+ adjPerfAmt + ", adjCntingCode=" + adjCntingCode + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo="
				+ lastUpdateEmpNo + "]";
	}
}
