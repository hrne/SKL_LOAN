...
@Repository
public class HlEmpLnYg5PtServiceImpl implements HlEmpLnYg5PtService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(HlEmpLnYg5PtServiceImpl.class);
  ...
  public HlEmpLnYg5Pt findById(HlEmpLnYg5PtId hlEmpLnYg5PtId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + hlEmpLnYg5PtId);
...
em = null;
  ...
  public Slice<HlEmpLnYg5Pt> FindHlEmpNo(String hlEmpNo_0, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("FindHlEmpNo " + dbName + " : " + "hlEmpNo_0 : " + hlEmpNo_0);
    if (dbName.equals(ContentName.onDay))
  ...
  public HlEmpLnYg5Pt holdById(HlEmpLnYg5PtId hlEmpLnYg5PtId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + hlEmpLnYg5PtId);
    Optional<HlEmpLnYg5Pt> hlEmpLnYg5Pt = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public HlEmpLnYg5Pt holdById(HlEmpLnYg5Pt hlEmpLnYg5Pt, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + hlEmpLnYg5Pt.getHlEmpLnYg5PtId());
  ...
  public HlEmpLnYg5Pt insert(HlEmpLnYg5Pt hlEmpLnYg5Pt, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + hlEmpLnYg5Pt.getHlEmpLnYg5PtId());
  ...
  public HlEmpLnYg5Pt update(HlEmpLnYg5Pt hlEmpLnYg5Pt, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + hlEmpLnYg5Pt.getHlEmpLnYg5PtId());
    if (!empNot.isEmpty())
  ...
  public void delete(HlEmpLnYg5Pt hlEmpLnYg5Pt, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + hlEmpLnYg5Pt.getHlEmpLnYg5PtId());
    if (dbName.equals(ContentName.onDay)) {
