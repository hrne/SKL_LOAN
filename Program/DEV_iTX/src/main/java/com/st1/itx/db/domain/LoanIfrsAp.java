...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "LoanIfrsAp [loanIfrsApId=" + loanIfrsApId + ", custId=" + custId + ", applNo=" + applNo
           ...
           + ", clTypeJCIC=" + clTypeJCIC + ", cityCode=" + cityCode + ", prodNo=" + prodNo + ", custKind=" + custKind + ", assetClass=" + assetClass + ", ifrsProdCode=" + ifrsProdCode
