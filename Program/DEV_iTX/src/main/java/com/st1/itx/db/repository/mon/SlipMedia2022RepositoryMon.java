 ...
 * @version 1.0.0
 */
public interface SlipMedia2022RepositoryMon extends JpaRepository<SlipMedia2022, SlipMedia2022Id> {

  // AcDate = ,AND BatchNo = ,AND MediaSeq =
  public Slice<SlipMedia2022> findAllByAcDateIsAndBatchNoIsAndMediaSeqIsOrderByAcDateAscBatchNoAscMediaSeqAscMediaSlipNoAscAcBookCodeAscSeqAsc(int acDate_0, int batchNo_1, int mediaSeq_2, Pageable pageable);
