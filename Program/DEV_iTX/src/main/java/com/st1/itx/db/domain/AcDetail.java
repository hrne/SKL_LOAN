...
public class AcDetail implements Serializable {
	 ...
	 * -另收欠款(銷帳檔帶入)8－核心銷帳碼科目，須以銷帳編號(銷帳碼彙總)上傳核心(會計科子細目設定檔帶入)
	 */
	...
	// 帳冊別記號
	/*
	 * CdAcCode會計科子細目設定檔帶入(0,1,2)0: 不細分，區隔帳冊固定為00A:傳統帳冊1: 細分，區隔帳冊By戶號設定(AcBookCom)2:
	 * 中介，應收調撥款科目 ※明細檔無(只寫入總帳檔)，應收調撥款之核心傳票媒體檔，係自動產生。3: 指定帳冊，區隔帳冊由業務交易指定
	 ...
	 * 匯款轉帳預先作業201:整批匯款202:單筆匯款204:退款台新(存款憑條)205:退款他行(整批匯款)211:退款新光(存款憑條)
	 */
	...
	// 傳票批號
	/*
	 * 01~10-關帳11-支票繳款90~99 提存帳務，不會更新AcMain總帳檔99-利息提存 98-迴轉上月96-放款承諾
	 * 97-迴轉上月95-未付火險費提存 94-迴轉上月
	 */
	 ...
	 * 3－未收費用、4-短繳期金、5-另收欠款(銷帳檔帶入) 8－核心銷帳碼科目，須以銷帳編號(銷帳碼彙總)上傳核心(會計科子細目設定檔帶入)
	 * 
	 * @return Integer
	 */
	 ...
	 * 109.其他 111.匯款轉帳預先作業 201:整批匯款 202:單筆匯款 204:退款台新(存款憑條) 205:退款他行(整批匯款)
	 * 211:退款新光(存款憑條)
	 * 
	 * @return String
	 */
