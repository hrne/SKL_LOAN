...
@Repository
public class JcicB091ServiceImpl implements JcicB091Service, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(JcicB091ServiceImpl.class);
  ...
  public JcicB091 findById(JcicB091Id jcicB091Id, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + jcicB091Id);
...
em = null;
  ...
  public JcicB091 holdById(JcicB091Id jcicB091Id, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicB091Id);
    Optional<JcicB091> jcicB091 = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicB091 holdById(JcicB091 jcicB091, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicB091.getJcicB091Id());
  ...
  public JcicB091 insert(JcicB091 jcicB091, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + jcicB091.getJcicB091Id());
  ...
  public JcicB091 update(JcicB091 jcicB091, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + jcicB091.getJcicB091Id());
    if (!empNot.isEmpty())
      jcicB091.setLastUpdateEmpNo(empNot);
  ...
  public void delete(JcicB091 jcicB091, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + jcicB091.getJcicB091Id());
    if (dbName.equals(ContentName.onDay)) {
