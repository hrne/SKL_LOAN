...
@Repository
public class JcicB211ServiceImpl implements JcicB211Service, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(JcicB211ServiceImpl.class);
  ...
  public JcicB211 findById(JcicB211Id jcicB211Id, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + jcicB211Id);
...
em = null;
  ...
  public JcicB211 holdById(JcicB211Id jcicB211Id, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicB211Id);
    Optional<JcicB211> jcicB211 = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicB211 holdById(JcicB211 jcicB211, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicB211.getJcicB211Id());
  ...
  public JcicB211 insert(JcicB211 jcicB211, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + jcicB211.getJcicB211Id());
  ...
  public JcicB211 update(JcicB211 jcicB211, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + jcicB211.getJcicB211Id());
    if (!empNot.isEmpty())
      jcicB211.setLastUpdateEmpNo(empNot);
  ...
  public void delete(JcicB211 jcicB211, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + jcicB211.getJcicB211Id());
    if (dbName.equals(ContentName.onDay)) {
