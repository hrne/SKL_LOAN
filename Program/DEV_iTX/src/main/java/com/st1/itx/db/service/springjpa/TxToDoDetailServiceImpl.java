...
public class TxToDoDetailServiceImpl extends ASpringJpaParm implements TxToDoDetailService, InitializingBean {
	...
	public Slice<TxToDoDetail> detailStatusRange(String itemCode_0, int status_1, int status_2, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = txToDoDetailReposDay.findAllByItemCodeIsAndStatusGreaterThanEqualAndStatusLessThanEqualOrderByStatusAscCustNoAscFacmNoAscBormNoAscDtlValueAsc(itemCode_0, status_1, status_2,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txToDoDetailReposMon.findAllByItemCodeIsAndStatusGreaterThanEqualAndStatusLessThanEqualOrderByStatusAscCustNoAscFacmNoAscBormNoAscDtlValueAsc(itemCode_0, status_1, status_2,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txToDoDetailReposHist.findAllByItemCodeIsAndStatusGreaterThanEqualAndStatusLessThanEqualOrderByStatusAscCustNoAscFacmNoAscBormNoAscDtlValueAsc(itemCode_0, status_1, status_2,
					pageable);
		else
			slice = txToDoDetailRepos.findAllByItemCodeIsAndStatusGreaterThanEqualAndStatusLessThanEqualOrderByStatusAscCustNoAscFacmNoAscBormNoAscDtlValueAsc(itemCode_0, status_1, status_2,
					pageable);
	...
	public Slice<TxToDoDetail> DtlValueRange(String itemCode_0, String dtlValue_1, String dtlValue_2, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = txToDoDetailReposDay.findAllByItemCodeIsAndDtlValueGreaterThanEqualAndDtlValueLessThanEqualOrderByStatusAscCustNoAscFacmNoAscBormNoAsc(itemCode_0, dtlValue_1, dtlValue_2,
					pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txToDoDetailReposMon.findAllByItemCodeIsAndDtlValueGreaterThanEqualAndDtlValueLessThanEqualOrderByStatusAscCustNoAscFacmNoAscBormNoAsc(itemCode_0, dtlValue_1, dtlValue_2,
					pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txToDoDetailReposHist.findAllByItemCodeIsAndDtlValueGreaterThanEqualAndDtlValueLessThanEqualOrderByStatusAscCustNoAscFacmNoAscBormNoAsc(itemCode_0, dtlValue_1, dtlValue_2,
					pageable);
		else
	...
	public Slice<TxToDoDetail> itemCodeRange(String itemCode_0, String dtlValue_1, int status_2, int status_3, int dataDate_4, int dataDate_5, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("itemCodeRange " + dbName + " : " + "itemCode_0 : " + itemCode_0 + " dtlValue_1 : " + dtlValue_1 + " status_2 : " + status_2 + " status_3 : " + status_3 + " dataDate_4 : "
				+ dataDate_4 + " dataDate_5 : " + dataDate_5);
		if (dbName.equals(ContentName.onDay))
			slice = txToDoDetailReposDay
					.findAllByItemCodeIsAndDtlValueIsAndStatusGreaterThanEqualAndStatusLessThanEqualAndDataDateGreaterThanEqualAndDataDateLessThanEqualOrderByStatusAscCustNoAscFacmNoAscBormNoAsc(
							itemCode_0, dtlValue_1, status_2, status_3, dataDate_4, dataDate_5, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txToDoDetailReposMon
					.findAllByItemCodeIsAndDtlValueIsAndStatusGreaterThanEqualAndStatusLessThanEqualAndDataDateGreaterThanEqualAndDataDateLessThanEqualOrderByStatusAscCustNoAscFacmNoAscBormNoAsc(
							itemCode_0, dtlValue_1, status_2, status_3, dataDate_4, dataDate_5, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txToDoDetailReposHist
					.findAllByItemCodeIsAndDtlValueIsAndStatusGreaterThanEqualAndStatusLessThanEqualAndDataDateGreaterThanEqualAndDataDateLessThanEqualOrderByStatusAscCustNoAscFacmNoAscBormNoAsc(
							itemCode_0, dtlValue_1, status_2, status_3, dataDate_4, dataDate_5, pageable);
		else
			slice = txToDoDetailRepos
					.findAllByItemCodeIsAndDtlValueIsAndStatusGreaterThanEqualAndStatusLessThanEqualAndDataDateGreaterThanEqualAndDataDateLessThanEqualOrderByStatusAscCustNoAscFacmNoAscBormNoAsc(
							itemCode_0, dtlValue_1, status_2, status_3, dataDate_4, dataDate_5, pageable);
	...
	public Slice<TxToDoDetail> DataDateRange(String itemCode_0, int status_1, int status_2, int dataDate_3, int dataDate_4, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			...
			slice = txToDoDetailRepos.findAllByItemCodeIsAndStatusGreaterThanEqualAndStatusLessThanEqualAndDataDateGreaterThanEqualAndDataDateLessThanEqualOrderByStatusAscCustNoAscFacmNoAscBormNoAsc(
					itemCode_0, status_1, status_2, dataDate_3, dataDate_4, pageable);
	...
	public Slice<TxToDoDetail> findTxNoEq(String itemCode_0, int titaEntdy_1, String titaKinbr_2, String titaTlrNo_3, int titaTxtNo_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("findTxNoEq " + dbName + " : " + "itemCode_0 : " + itemCode_0 + " titaEntdy_1 : " + titaEntdy_1 + " titaKinbr_2 : " + titaKinbr_2 + " titaTlrNo_3 : " + titaTlrNo_3
				+ " titaTxtNo_4 : " + titaTxtNo_4);
		if (dbName.equals(ContentName.onDay))
			slice = txToDoDetailReposDay.findAllByItemCodeIsAndTitaEntdyIsAndTitaKinbrIsAndTitaTlrNoIsAndTitaTxtNoIsOrderByItemCodeAscCustNoAscBormNoAscDtlValueAsc(itemCode_0, titaEntdy_1,
					titaKinbr_2, titaTlrNo_3, titaTxtNo_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txToDoDetailReposMon.findAllByItemCodeIsAndTitaEntdyIsAndTitaKinbrIsAndTitaTlrNoIsAndTitaTxtNoIsOrderByItemCodeAscCustNoAscBormNoAscDtlValueAsc(itemCode_0, titaEntdy_1,
					titaKinbr_2, titaTlrNo_3, titaTxtNo_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txToDoDetailReposHist.findAllByItemCodeIsAndTitaEntdyIsAndTitaKinbrIsAndTitaTlrNoIsAndTitaTxtNoIsOrderByItemCodeAscCustNoAscBormNoAscDtlValueAsc(itemCode_0, titaEntdy_1,
					titaKinbr_2, titaTlrNo_3, titaTxtNo_4, pageable);
		else
			slice = txToDoDetailRepos.findAllByItemCodeIsAndTitaEntdyIsAndTitaKinbrIsAndTitaTlrNoIsAndTitaTxtNoIsOrderByItemCodeAscCustNoAscBormNoAscDtlValueAsc(itemCode_0, titaEntdy_1, titaKinbr_2,
					titaTlrNo_3, titaTxtNo_4, pageable);
	...
	public TxToDoDetail insert(TxToDoDetail txToDoDetail, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(txToDoDetail.getTxToDoDetailId()) != null)
