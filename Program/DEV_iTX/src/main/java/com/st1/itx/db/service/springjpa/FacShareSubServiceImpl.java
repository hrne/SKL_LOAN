...
em = null;
  ...
  public Slice<FacShareSub> findCustNoEq(int shareCustNo_0, int shareFacmNo_1, int shareFacmNo_2, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      slice = facShareSubReposDay.findAllByShareCustNoIsAndShareFacmNoGreaterThanEqualAndShareFacmNoLessThanEqualOrderByCreditSysNoAscMainCustNoAscMainFacmNoAscShareSeqAscShareCustNoAscShareFacmNoAsc(shareCustNo_0, shareFacmNo_1, shareFacmNo_2, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = facShareSubReposMon.findAllByShareCustNoIsAndShareFacmNoGreaterThanEqualAndShareFacmNoLessThanEqualOrderByCreditSysNoAscMainCustNoAscMainFacmNoAscShareSeqAscShareCustNoAscShareFacmNoAsc(shareCustNo_0, shareFacmNo_1, shareFacmNo_2, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = facShareSubReposHist.findAllByShareCustNoIsAndShareFacmNoGreaterThanEqualAndShareFacmNoLessThanEqualOrderByCreditSysNoAscMainCustNoAscMainFacmNoAscShareSeqAscShareCustNoAscShareFacmNoAsc(shareCustNo_0, shareFacmNo_1, shareFacmNo_2, pageable);
    else 
      slice = facShareSubRepos.findAllByShareCustNoIsAndShareFacmNoGreaterThanEqualAndShareFacmNoLessThanEqualOrderByCreditSysNoAscMainCustNoAscMainFacmNoAscShareSeqAscShareCustNoAscShareFacmNoAsc(shareCustNo_0, shareFacmNo_1, shareFacmNo_2, pageable);
