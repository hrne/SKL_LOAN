...
@Repository
public class JcicZ046ServiceImpl implements JcicZ046Service, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(JcicZ046ServiceImpl.class);
  ...
  public JcicZ046 findById(JcicZ046Id jcicZ046Id, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + jcicZ046Id);
...
em = null;
  ...
  public Slice<JcicZ046> HadZ046(String custId_0, int rcDate_1, String submitKey_2, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("HadZ046 " + dbName + " : " + "custId_0 : " + custId_0 + " rcDate_1 : " +  rcDate_1 + " submitKey_2 : " +  submitKey_2);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<JcicZ046> otherEq(String submitKey_0, String custId_1, int rcDate_2, int closeDate_3, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("otherEq " + dbName + " : " + "submitKey_0 : " + submitKey_0 + " custId_1 : " +  custId_1 + " rcDate_2 : " +  rcDate_2 + " closeDate_3 : " +  closeDate_3);
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicZ046 otherFirst(String submitKey_0, String custId_1, int rcDate_2, int closeDate_3, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("otherFirst " + dbName + " : " + "submitKey_0 : " + submitKey_0 + " custId_1 : " +  custId_1 + " rcDate_2 : " +  rcDate_2 + " closeDate_3 : " +  closeDate_3);
    Optional<JcicZ046> jcicZ046T = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicZ046 holdById(JcicZ046Id jcicZ046Id, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicZ046Id);
    Optional<JcicZ046> jcicZ046 = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicZ046 holdById(JcicZ046 jcicZ046, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicZ046.getJcicZ046Id());
    Optional<JcicZ046> jcicZ046T = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicZ046 insert(JcicZ046 jcicZ046, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + jcicZ046.getJcicZ046Id());
  ...
  public JcicZ046 update(JcicZ046 jcicZ046, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + jcicZ046.getJcicZ046Id());
    if (!empNot.isEmpty())
      jcicZ046.setLastUpdateEmpNo(empNot);
  ...
  public void delete(JcicZ046 jcicZ046, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + jcicZ046.getJcicZ046Id());
    if (dbName.equals(ContentName.onDay)) {
