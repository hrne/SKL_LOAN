 ...
 * @version 1.0.0
 */
public interface LoanRateChangeRepositoryHist extends JpaRepository<LoanRateChange, LoanRateChangeId> {
  ...
  // CustNo = ,AND FacmNo = ,AND BormNo = ,AND EffectDate >=
  public Slice<LoanRateChange> findAllByCustNoIsAndFacmNoIsAndBormNoIsAndEffectDateGreaterThanEqualOrderByEffectDateAsc(int custNo_0, int facmNo_1, int bormNo_2, int effectDate_3, Pageable pageable);
