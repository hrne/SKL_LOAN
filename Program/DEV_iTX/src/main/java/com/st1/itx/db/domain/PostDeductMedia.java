...
public class PostDeductMedia implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5826953057041825563L;
	...
	// 還款類別
	/*
	 * CdCode:RepayType0.債協暫收款1.期款2.部分償還3.結案4.帳管費5.火險費6.契變手續費7.法務費9.其他11.債協匯入款(
	 * 虛擬帳號為9510500NNNNNNN)
	 */
	...
	// 區處代號
	/* 846(期款)0001(帳管及契變手續)0002(期款)53N(火險)空白 */
	...
	// 用戶編號
	/* 右靠左補空，大寫英數字，不得填寫中文(扣款人ID+郵局存款別(POSCDE)+戶號)預計補2位帳號碼 */
	...
	/**
	 * 還款類別<br>
	 * CdCode:RepayType 0.債協暫收款 1.期款 2.部分償還 3.結案 4.帳管費 5.火險費 6.契變手續費 7.法務費 9.其他
	...
	public String toString() {
		return "PostDeductMedia [postDeductMediaId=" + postDeductMediaId + ", custNo=" + custNo + ", facmNo=" + facmNo + ", repayType=" + repayType + ", repayAmt=" + repayAmt + ", procNoteCode="
				+ procNoteCode + ", postDepCode=" + postDepCode + ", outsrcCode=" + outsrcCode + ", distCode=" + distCode + ", transDate=" + transDate + ", repayAcctNo=" + repayAcctNo
