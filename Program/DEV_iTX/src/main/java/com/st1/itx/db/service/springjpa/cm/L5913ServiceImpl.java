...
@Service("l5913ServiceImpl")
public class L5913ServiceImpl extends ASpringJpaParm implements InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(L5913ServiceImpl.class);
	...
	public List<Map<String, String>> FindData(int YyyMm,TitaVo titaVo) throws Exception{
		...
		logger.info("L5913Service FindData=" + query.toString());
