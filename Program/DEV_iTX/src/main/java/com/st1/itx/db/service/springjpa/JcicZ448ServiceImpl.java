...
@Repository
public class JcicZ448ServiceImpl implements JcicZ448Service, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(JcicZ448ServiceImpl.class);
  ...
  public JcicZ448 findById(JcicZ448Id jcicZ448Id, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + jcicZ448Id);
...
em = null;
  ...
  public Slice<JcicZ448> otherEq(String submitKey_0, String custId_1, int applyDate_2, String courtCode_3, String maxMainCode_4, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("otherEq " + dbName + " : " + "submitKey_0 : " + submitKey_0 + " custId_1 : " +  custId_1 + " applyDate_2 : " +  applyDate_2 + " courtCode_3 : " +  courtCode_3 + " maxMainCode_4 : " +  maxMainCode_4);
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicZ448 otherFirst(String submitKey_0, String custId_1, int applyDate_2, String courtCode_3, String maxMainCode_4, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("otherFirst " + dbName + " : " + "submitKey_0 : " + submitKey_0 + " custId_1 : " +  custId_1 + " applyDate_2 : " +  applyDate_2 + " courtCode_3 : " +  courtCode_3 + " maxMainCode_4 : " +  maxMainCode_4);
    Optional<JcicZ448> jcicZ448T = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicZ448 holdById(JcicZ448Id jcicZ448Id, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicZ448Id);
    Optional<JcicZ448> jcicZ448 = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicZ448 holdById(JcicZ448 jcicZ448, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicZ448.getJcicZ448Id());
    Optional<JcicZ448> jcicZ448T = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicZ448 insert(JcicZ448 jcicZ448, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + jcicZ448.getJcicZ448Id());
  ...
  public JcicZ448 update(JcicZ448 jcicZ448, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + jcicZ448.getJcicZ448Id());
    if (!empNot.isEmpty())
      jcicZ448.setLastUpdateEmpNo(empNot);
  ...
  public void delete(JcicZ448 jcicZ448, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + jcicZ448.getJcicZ448Id());
    if (dbName.equals(ContentName.onDay)) {
