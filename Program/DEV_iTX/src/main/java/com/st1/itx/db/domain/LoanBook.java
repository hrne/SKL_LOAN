...
public class LoanBook implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1622715550308450755L;
	...
	public String toString() {
		return "LoanBook [loanBookId=" + loanBookId + ", status=" + status + ", currencyCode=" + currencyCode + ", bookAmt=" + bookAmt + ", repayAmt=" + repayAmt + ", createDate=" + createDate
