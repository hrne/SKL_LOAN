...
@Table(name = "`Ias34Bp`")
public class Ias34Bp implements Serializable {


  /**
	 * 
	 */
	private static final long serialVersionUID = -2082351487233367642L;

@EmbeddedId
  private Ias34BpId ias34BpId;
  ...
  public Ias34BpId getIas34BpId() {
    return this.ias34BpId;
  }

  public void setIas34BpId(Ias34BpId ias34BpId) {
    this.ias34BpId = ias34BpId;
  }
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "Ias34Bp [ias34BpId=" + ias34BpId + ", custId=" + custId + ", loanRate=" + loanRate
