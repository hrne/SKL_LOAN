...
em = null;
  ...
  public MonthlyLM052Ovdu insert(MonthlyLM052Ovdu monthlyLM052Ovdu, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(monthlyLM052Ovdu.getMonthlyLM052OvduId()) != null)
  ...
  public void Usp_L9_MonthlyLM052Ovdu_Ins(int tbsdyf,  String empNo, TitaVo... titaVo) {
    ...
    dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    if (dbName.equals(ContentName.onDay))
      monthlyLM052OvduReposDay.uspL9Monthlylm052ovduIns(tbsdyf,  empNo);
    else if (dbName.equals(ContentName.onMon))
      monthlyLM052OvduReposMon.uspL9Monthlylm052ovduIns(tbsdyf,  empNo);
    else if (dbName.equals(ContentName.onHist))
      monthlyLM052OvduReposHist.uspL9Monthlylm052ovduIns(tbsdyf,  empNo);
   else
      monthlyLM052OvduRepos.uspL9Monthlylm052ovduIns(tbsdyf,  empNo);
  }
