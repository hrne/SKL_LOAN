...
// 單位別
  /* 0000:放款部0025:信託部 0036:台中   0047:高雄   0058:台南   0069:中壢   0070:花蓮   0081:板橋   0092:東台北 0106:鳳山   0117:新竹 */
  @Id
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "CdBranch [branchNo=" + branchNo + ", acBranchNo=" + acBranchNo + ", cRH=" + cRH + ", branchStatusCode=" + branchStatusCode + ", branchShort=" + branchShort + ", branchItem=" + branchItem
           + ", branchAddress1=" + branchAddress1 + ", branchAddress2=" + branchAddress2 + ", zip3=" + zip3 + ", zip2=" + zip2 + ", owner=" + owner + ", businessID=" + businessID
           + ", rSOCode=" + rSOCode + ", mediaUnitCode=" + mediaUnitCode + ", cIFKey=" + cIFKey + ", lastestCustNo=" + lastestCustNo + ", group1=" + group1 + ", group2=" + group2
           + ", group3=" + group3 + ", group4=" + group4 + ", group5=" + group5 + ", group6=" + group6 + ", group7=" + group7 + ", group8=" + group8
           + ", group9=" + group9 + ", group10=" + group10 + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
           + "]";
  }
}
