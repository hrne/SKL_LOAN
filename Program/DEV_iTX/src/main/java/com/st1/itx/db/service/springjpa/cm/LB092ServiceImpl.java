...
public class LB092ServiceImpl extends ASpringJpaParm implements InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(LB092ServiceImpl.class);
...
//		boolean onLineMode = true;
		...
		logger.info("----------- LB092.findAll ---------------");
		logger.info("-----LB092 TitaVo=" + titaVo);
		logger.info("-----LB092 Tita ENTDY=" + titaVo.getEntDy().substring(0, 6));
