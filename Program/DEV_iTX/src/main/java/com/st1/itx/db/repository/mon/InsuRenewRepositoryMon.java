 ...
 * @version 1.0.0
 */
public interface InsuRenewRepositoryMon extends JpaRepository<InsuRenew, InsuRenewId> {
	...
	public Slice<InsuRenew> findAllByInsuYearMonthIsAndRepayCodeIsAndAcDateIsAndStatusCodeIsOrderByInsuEndDateDescInsuStartDateAsc(int insuYearMonth_0, int repayCode_1, int acDate_2, int statusCode_3,
			Pageable pageable);

	// InsuYearMonth = ,AND RepayCode = ,AND AcDate > ,AND StatusCode =
	public Slice<InsuRenew> findAllByInsuYearMonthIsAndRepayCodeIsAndAcDateGreaterThanAndStatusCodeIsOrderByInsuEndDateDescInsuStartDateAsc(int insuYearMonth_0, int repayCode_1, int acDate_2,
			int statusCode_3, Pageable pageable);
	...
	public Slice<InsuRenew> findAllByInsuYearMonthIsAndClCode1IsAndClCode2IsAndClNoIsOrderByInsuEndDateDescInsuStartDateAsc(int insuYearMonth_0, int clCode1_1, int clCode2_2, int clNo_3,
			Pageable pageable);

	// InsuYearMonth = ,AND RenewCode = ,AND AcDate >= ,AND AcDate <=
	public Slice<InsuRenew> findAllByInsuYearMonthIsAndRenewCodeIsAndAcDateGreaterThanEqualAndAcDateLessThanEqualOrderByInsuEndDateDescInsuStartDateAsc(int insuYearMonth_0, int renewCode_1,
			int acDate_2, int acDate_3, Pageable pageable);
	...
	public Slice<InsuRenew> findAllByClCode1IsAndClCode2IsAndClNoIsAndPrevInsuNoIsOrderByInsuEndDateDescInsuStartDateAsc(int clCode1_0, int clCode2_1, int clNo_2, String prevInsuNo_3,
			Pageable pageable);
	...
	// ClCode1 = ,AND ClCode2 = ,AND ClNo = ,AND NowInsuNo =
	public Slice<InsuRenew> findAllByClCode1IsAndClCode2IsAndClNoIsAndNowInsuNoIsOrderByInsuEndDateDescInsuStartDateAsc(int clCode1_0, int clCode2_1, int clNo_2, String nowInsuNo_3,
			Pageable pageable);
