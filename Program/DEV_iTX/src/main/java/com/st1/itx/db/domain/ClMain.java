...
public class ClMain implements Serializable {
	...
	// 可分配金額
	/*
	 * 1.若"評估淨值"有值取"評估淨值"否則取"鑑估總值")*貸放成數(四捨五入至個位數)2.若設定金額低於可分配金額則為設定金額3.擔保品塗銷/解除設定時(
	 * 該筆擔保品的可分配金額設為零)
	 */
	...
	/**
	 * 可分配金額<br>
	 * 1.若"評估淨值"有值取"評估淨值"否則取"鑑估總值")*貸放成數(四捨五入至個位數) 2.若設定金額低於可分配金額則為設定金額
	...
	public String toString() {
		return "ClMain [clMainId=" + clMainId + ", custUKey=" + custUKey + ", clTypeCode=" + clTypeCode + ", cityCode=" + cityCode + ", areaCode=" + areaCode + ", clStatus=" + clStatus + ", evaDate="
				+ evaDate + ", evaAmt=" + evaAmt + ", shareTotal=" + shareTotal + ", synd=" + synd + ", syndCode=" + syndCode + ", dispPrice=" + dispPrice + ", dispDate=" + dispDate + ", newNote="
				+ newNote + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
