...
@Repository
/* 逾期放款明細 */
public class LM021ServiceImpl extends ASpringJpaParm implements InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(LM021ServiceImpl.class);
	...
	public List<Map<String, String>> findAll(TitaVo titaVo) throws Exception {
		...
		sql += "		 	    AND \"LoanBal\" > 0 ";
		sql += "		 	    AND TRUNC(\"PayIntDate\") = TRUNC( :entdy /100 ) ";
