...
@Table(name = "`TxToDoDetail`")
public class TxToDoDetail implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6177029523844819482L;

	@EmbeddedId
	private TxToDoDetailId txToDoDetailId;
	...
	public TxToDoDetailId getTxToDoDetailId() {
		return this.txToDoDetailId;
	}

	public void setTxToDoDetailId(TxToDoDetailId txToDoDetailId) {
		this.txToDoDetailId = txToDoDetailId;
	}
	...
	public String toString() {
		return "TxToDoDetail [txToDoDetailId=" + txToDoDetailId + ", status=" + status + ", processNote=" + processNote + ", excuteTxcd=" + excuteTxcd + ", dataDate=" + dataDate + ", titaEntdy="
				+ titaEntdy + ", titaKinbr=" + titaKinbr + ", titaTlrNo=" + titaTlrNo + ", titaTxtNo=" + titaTxtNo + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate="
