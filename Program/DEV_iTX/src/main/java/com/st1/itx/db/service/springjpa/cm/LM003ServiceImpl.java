...
public class LM003ServiceImpl extends ASpringJpaParm implements InitializingBean {
	...
	public List<Map<String, String>> findAll(TitaVo titaVo) throws Exception {
		...
		query.setParameter("yearMonthMin", Integer.parseInt(titaVo.getParam("inputYearStart")) + 1911 + titaVo.getParam("inputMonthStart"));
		query.setParameter("yearMonthMax", Integer.parseInt(titaVo.getParam("inputYearEnd")) + 1911 + titaVo.getParam("inputMonthEnd"));
