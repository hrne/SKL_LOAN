 ...
 * @version 1.0.0
 */
public interface BankAuthActRepositoryHist extends JpaRepository<BankAuthAct, BankAuthActId> {
	...
	// CustNo =
	public Slice<BankAuthAct> findAllByCustNoIsOrderByFacmNoAsc(int custNo_0, Pageable pageable);
