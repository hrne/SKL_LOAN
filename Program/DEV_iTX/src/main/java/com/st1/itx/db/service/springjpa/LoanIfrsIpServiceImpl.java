...
@Repository
public class LoanIfrsIpServiceImpl implements LoanIfrsIpService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(LoanIfrsIpServiceImpl.class);
  ...
  public LoanIfrsIp findById(LoanIfrsIpId loanIfrsIpId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + loanIfrsIpId);
...
em = null;
  ...
  public LoanIfrsIp holdById(LoanIfrsIpId loanIfrsIpId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + loanIfrsIpId);
    Optional<LoanIfrsIp> loanIfrsIp = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public LoanIfrsIp holdById(LoanIfrsIp loanIfrsIp, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + loanIfrsIp.getLoanIfrsIpId());
  ...
  public LoanIfrsIp insert(LoanIfrsIp loanIfrsIp, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + loanIfrsIp.getLoanIfrsIpId());
  ...
  public LoanIfrsIp update(LoanIfrsIp loanIfrsIp, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + loanIfrsIp.getLoanIfrsIpId());
    if (!empNot.isEmpty())
      loanIfrsIp.setLastUpdateEmpNo(empNot);
  ...
  public void delete(LoanIfrsIp loanIfrsIp, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + loanIfrsIp.getLoanIfrsIpId());
    if (dbName.equals(ContentName.onDay)) {
