...
public class CustFin implements Serializable {
	...
	public String toString() {
		return "CustFin [custFinId=" + custFinId + ", assetTotal=" + assetTotal + ", cash=" + cash + ", shortInv=" + shortInv + ", aR=" + aR + ", inventory=" + inventory + ", longInv=" + longInv
				+ ", fixedAsset=" + fixedAsset + ", otherAsset=" + otherAsset + ", liabTotal=" + liabTotal + ", bankLoan=" + bankLoan + ", otherCurrLiab=" + otherCurrLiab + ", longLiab=" + longLiab
				+ ", otherLiab=" + otherLiab + ", netWorthTotal=" + netWorthTotal + ", capital=" + capital + ", retainEarning=" + retainEarning + ", opIncome=" + opIncome + ", opCost=" + opCost
				+ ", opProfit=" + opProfit + ", opExpense=" + opExpense + ", opRevenue=" + opRevenue + ", nopIncome=" + nopIncome + ", finExpense=" + finExpense + ", nopExpense=" + nopExpense
				+ ", netIncome=" + netIncome + ", accountant=" + accountant + ", accountDate=" + accountDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate="
