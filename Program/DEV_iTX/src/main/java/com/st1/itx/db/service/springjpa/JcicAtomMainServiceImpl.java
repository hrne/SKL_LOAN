...
@Repository
public class JcicAtomMainServiceImpl implements JcicAtomMainService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(JcicAtomMainServiceImpl.class);
  ...
  public JcicAtomMain findById(String functionCode, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + functionCode);
...
em = null;
  ...
  public JcicAtomMain holdById(String functionCode, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + functionCode);
    Optional<JcicAtomMain> jcicAtomMain = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicAtomMain holdById(JcicAtomMain jcicAtomMain, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicAtomMain.getFunctionCode());
  ...
  public JcicAtomMain insert(JcicAtomMain jcicAtomMain, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + jcicAtomMain.getFunctionCode());
  ...
  public JcicAtomMain update(JcicAtomMain jcicAtomMain, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + jcicAtomMain.getFunctionCode());
    if (!empNot.isEmpty())
  ...
  public void delete(JcicAtomMain jcicAtomMain, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + jcicAtomMain.getFunctionCode());
    if (dbName.equals(ContentName.onDay)) {
