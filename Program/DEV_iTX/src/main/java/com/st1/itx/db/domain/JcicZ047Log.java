...
@Table(name = "`JcicZ047Log`")
public class JcicZ047Log implements Serializable {


  /**
	 * 
	 */
	private static final long serialVersionUID = -8880144433212283197L;

@EmbeddedId
  private JcicZ047LogId jcicZ047LogId;
  ...
  // 屬二階段還款方案之階段註記
  /* 1:屬二階段還款,第一階段2:屬二階段還款,第二階段 :非屬二階段還款 */
  ...
  public JcicZ047LogId getJcicZ047LogId() {
    return this.jcicZ047LogId;
  }

  public void setJcicZ047LogId(JcicZ047LogId jcicZ047LogId) {
    this.jcicZ047LogId = jcicZ047LogId;
  }
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicZ047Log [jcicZ047LogId=" + jcicZ047LogId + ", tranKey=" + tranKey + ", period=" + period + ", rate=" + rate + ", civil323ExpAmt=" + civil323ExpAmt
           + ", expLoanAmt=" + expLoanAmt + ", civil323CashAmt=" + civil323CashAmt + ", cashCardAmt=" + cashCardAmt + ", civil323CreditAmt=" + civil323CreditAmt + ", creditCardAmt=" + creditCardAmt + ", civil323Amt=" + civil323Amt
           + ", totalAmt=" + totalAmt + ", passDate=" + passDate + ", interviewDate=" + interviewDate + ", signDate=" + signDate + ", limitDate=" + limitDate + ", firstPayDate=" + firstPayDate
           + ", monthPayAmt=" + monthPayAmt + ", payAccount=" + payAccount + ", postAddr=" + postAddr + ", gradeType=" + gradeType + ", payLastAmt=" + payLastAmt + ", period2=" + period2
           + ", rate2=" + rate2 + ", monthPayAmt2=" + monthPayAmt2 + ", payLastAmt2=" + payLastAmt2 + ", outJcicTxtDate=" + outJcicTxtDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
