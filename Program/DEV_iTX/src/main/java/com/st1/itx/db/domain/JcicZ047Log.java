...
public class JcicZ047Log implements Serializable {
	...
	/**
	 * 屬二階段還款方案之階段註記<br>
	 * 1:屬二階段還款,第一階段 2:屬二階段還款,第二階段 :非屬二階段還款
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "JcicZ047Log [jcicZ047LogId=" + jcicZ047LogId + ", tranKey=" + tranKey + ", period=" + period + ", rate=" + rate + ", civil323ExpAmt=" + civil323ExpAmt + ", expLoanAmt=" + expLoanAmt
				...
				+ period2 + ", rate2=" + rate2 + ", monthPayAmt2=" + monthPayAmt2 + ", payLastAmt2=" + payLastAmt2 + ", outJcicTxtDate=" + outJcicTxtDate + ", createDate=" + createDate
