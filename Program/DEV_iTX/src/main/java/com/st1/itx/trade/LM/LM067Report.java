...
public class LM067Report extends MakeReport {
	// private static final Logger logger = LoggerFactory.getLogger(LM067Report.class);
	...
	public void exec(TitaVo titaVo) throws LogicException {
		...
		makeExcel.open(titaVo, titaVo.getEntDyI(), titaVo.getKinbr(), "LM067", "06-土地追蹤-" + yymmRoc,
				"LM067_06-土地追蹤-" + yymmRoc, "LM067_底稿_土地追蹤.xls", "簡表");
