...
@Repository
public class HlThreeDetailServiceImpl implements HlThreeDetailService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(HlThreeDetailServiceImpl.class);
  ...
  public HlThreeDetail findById(HlThreeDetailId hlThreeDetailId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + hlThreeDetailId);
...
em = null;
  ...
  public HlThreeDetail holdById(HlThreeDetailId hlThreeDetailId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + hlThreeDetailId);
    Optional<HlThreeDetail> hlThreeDetail = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public HlThreeDetail holdById(HlThreeDetail hlThreeDetail, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + hlThreeDetail.getHlThreeDetailId());
  ...
  public HlThreeDetail insert(HlThreeDetail hlThreeDetail, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + hlThreeDetail.getHlThreeDetailId());
  ...
  public HlThreeDetail update(HlThreeDetail hlThreeDetail, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + hlThreeDetail.getHlThreeDetailId());
    if (!empNot.isEmpty())
  ...
  public void delete(HlThreeDetail hlThreeDetail, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + hlThreeDetail.getHlThreeDetailId());
    if (dbName.equals(ContentName.onDay)) {
