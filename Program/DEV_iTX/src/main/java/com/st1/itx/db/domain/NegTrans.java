...
public class NegTrans implements Serializable {
	...
	// 交易別
	/*
	 * 0:正常-匯入款＋溢收款 &amp;gt;= 期款1:溢繳(預收多期)-匯入款 &amp;gt; 期款2:短繳-匯入款＋溢收款 &amp;lt;
	 * 期款3:提前還本-匯入款＋溢收款 &amp;gt;= 5期期款4:結清-匯入款＋溢收款 &amp;gt;=最後一期期款5:提前清償-匯入款＋溢收款
	 * &amp;gt;= 剩餘期款6:待處理(批次用)9:未處理※入帳訂正需在撥付產擋前，依反向順序訂正
	 */
	@Column(name = "`TxKind`", length = 1)
	private String txKind;

	// 交易金額
	/* From AcReceivable-&amp;gt;RvAmt 起帳總額 */
	@Column(name = "`TxAmt`")
	private BigDecimal txAmt = new BigDecimal("0");

	// 本金餘額
	/* 由SERVICE處理 寫入這筆資料時就填好 */
	...
	/**
	 * 交易別<br>
	 * 0:正常-匯入款＋溢收款 &amp;gt;= 期款 1:溢繳(預收多期)-匯入款 &amp;gt; 期款 2:短繳-匯入款＋溢收款 &amp;lt; 期款
	 * 3:提前還本-匯入款＋溢收款 &amp;gt;= 5期期款 4:結清-匯入款＋溢收款 &amp;gt;=最後一期期款 5:提前清償-匯入款＋溢收款
	 * &amp;gt;= 剩餘期款 6:待處理(批次用) 9:未處理 ※入帳訂正需在撥付產擋前，依反向順序訂正
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "NegTrans [negTransId=" + negTransId + ", custNo=" + custNo + ", caseSeq=" + caseSeq + ", entryDate=" + entryDate + ", txStatus=" + txStatus + ", txKind=" + txKind + ", txAmt=" + txAmt
				+ ", principalBal=" + principalBal + ", returnAmt=" + returnAmt + ", sklShareAmt=" + sklShareAmt + ", apprAmt=" + apprAmt + ", exportDate=" + exportDate + ", exportAcDate="
				+ exportAcDate + ", tempRepayAmt=" + tempRepayAmt + ", overRepayAmt=" + overRepayAmt + ", principalAmt=" + principalAmt + ", interestAmt=" + interestAmt + ", overAmt=" + overAmt
				+ ", intStartDate=" + intStartDate + ", intEndDate=" + intEndDate + ", repayPeriod=" + repayPeriod + ", repayDate=" + repayDate + ", orgAccuOverAmt=" + orgAccuOverAmt
				+ ", accuOverAmt=" + accuOverAmt + ", shouldPayPeriod=" + shouldPayPeriod + ", dueAmt=" + dueAmt + ", thisEntdy=" + thisEntdy + ", thisKinbr=" + thisKinbr + ", thisTlrNo=" + thisTlrNo
				+ ", thisTxtNo=" + thisTxtNo + ", thisSeqNo=" + thisSeqNo + ", lastEntdy=" + lastEntdy + ", lastKinbr=" + lastKinbr + ", lastTlrNo=" + lastTlrNo + ", lastTxtNo=" + lastTxtNo
				+ ", lastSeqNo=" + lastSeqNo + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
