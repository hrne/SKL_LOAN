...
@EmbeddedId
  ...
  // 科目別註記
  /* 以 S 註記為十足擔保之授信，辦理保證或承兌業務發生墊款時，以M註記為已墊款有擔保之授信，以N註記為已墊款無擔保之授信，如無前述狀況請填X;若該擔保品於當月處理完畢，則當月份本欄位。屬部分擔保及副擔保之授信，本欄位亦請田X，但仍需將該部分擔保品或副擔保品相關資料填報於第45、46、47欄位;另辦理留學生就學貸款(授信科目Z)業務時，以R註記為留學生就學貸款，以X註記為高級中等以上學校就學貸款，請參考附件三之一科目別註記代號表；若本額度為非最低額度且為不同科目共用額度者，本欄位請填'*'。 */
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicB080 [jcicB080Id=" + jcicB080Id + ", dataType=" + dataType + ", branchItem=" + branchItem + ", tranCode=" + tranCode + ", filler4=" + filler4
           + ", custId=" + custId + ", currencyCode=" + currencyCode + ", drawdownAmt=" + drawdownAmt + ", drawdownAmtFx=" + drawdownAmtFx + ", drawdownDate=" + drawdownDate
           + ", maturityDate=" + maturityDate + ", recycleCode=" + recycleCode + ", irrevocableFlag=" + irrevocableFlag + ", upFacmNo=" + upFacmNo + ", acctCode=" + acctCode + ", subAcctCode=" + subAcctCode
           + ", clTypeCode=" + clTypeCode + ", filler18=" + filler18 + ", jcicDataYM=" + jcicDataYM + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
