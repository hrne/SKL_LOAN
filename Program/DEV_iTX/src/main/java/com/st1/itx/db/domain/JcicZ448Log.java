...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicZ448Log [jcicZ448LogId=" + jcicZ448LogId + ", tranKey=" + tranKey + ", signPrin=" + signPrin + ", signOther=" + signOther + ", ownPercentage=" + ownPercentage
           + ", acQuitAmt=" + acQuitAmt + ", outJcicTxtDate=" + outJcicTxtDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
           + "]";
  }
}
