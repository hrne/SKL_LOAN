...
// 客戶識別碼
	...
	// 客戶別
	/* 共用代碼檔00一般01員工02首購03關企公司04關企員工05保戶06團體戶07員工二親等09新二階員工 */
	...
	/**
	 * 客戶別<br>
	 * 共用代碼檔 00一般 01員工 02首購 03關企公司 04關企員工 05保戶 06團體戶 07員工二親等 09新二階員工
	 * 
	 * @return String
	 */
	 ...
	 * 國籍對照檔 比照ELOAN (2021/08/27上DB)by eric
	 *
	 * @param bussNationalityCode 法人:營業地國籍
	 */
	...
	/**
	 * 建檔身分別<br>
	 * 0.借戶1.保證人2.擔保品提供人3.交易關係人4.借款戶關係人 2021/08/24新增欄位 (2021/08/25上DB)by eric
	 * (2021/09/17)新增4. by昱衡
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "CustMain [custUKey=" + custUKey + ", custId=" + custId + ", custNo=" + custNo + ", branchNo=" + branchNo + ", custName=" + custName + ", birthday=" + birthday + ", sex=" + sex
				...
				+ lastFacmNo + ", lastSyndNo=" + lastSyndNo + ", allowInquire=" + allowInquire + ", email=" + email + ", actFg=" + actFg + ", introducer=" + introducer + ", isSuspected=" + isSuspected
				+ ", isSuspectedCheck=" + isSuspectedCheck + ", isSuspectedCheckType=" + isSuspectedCheckType + ", dataStatus=" + dataStatus + ", typeCode=" + typeCode + ", createDate=" + createDate
