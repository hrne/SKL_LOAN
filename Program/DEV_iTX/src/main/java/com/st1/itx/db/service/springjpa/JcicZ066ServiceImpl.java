...
@Repository
public class JcicZ066ServiceImpl implements JcicZ066Service, InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(JcicZ066ServiceImpl.class);
	...
	public JcicZ066 findById(JcicZ066Id jcicZ066Id, TitaVo... titaVo) {
		...
		logger.info("findById " + dbName + " " + jcicZ066Id);
	...
	public JcicZ066 holdById(JcicZ066Id jcicZ066Id, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + jcicZ066Id);
		Optional<JcicZ066> jcicZ066 = null;
		if (dbName.equals(ContentName.onDay))
	...
	public JcicZ066 holdById(JcicZ066 jcicZ066, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + jcicZ066.getJcicZ066Id());
	...
	public JcicZ066 insert(JcicZ066 jcicZ066, TitaVo... titaVo) throws DBException {
		...
		logger.info("Insert..." + dbName + " " + jcicZ066.getJcicZ066Id());
	...
	public JcicZ066 update(JcicZ066 jcicZ066, TitaVo... titaVo) throws DBException {
		...
		logger.info("Update..." + dbName + " " + jcicZ066.getJcicZ066Id());
		if (!empNot.isEmpty())
	...
	public void delete(JcicZ066 jcicZ066, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Delete..." + dbName + " " + jcicZ066.getJcicZ066Id());
		if (dbName.equals(ContentName.onDay)) {
