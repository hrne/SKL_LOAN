	...
	public ArrayList<TotaVo> run(TitaVo titaVo) throws LogicException {
		...
		case 2:
			...
			if (!uCustRelName.equals(uCustRelMain.getCustRelName())) {
				CustRelMain beforeCustRelMain = (CustRelMain) iDataLog.clone(uCustRelMain);
				...
				iDataLog.setEnv(titaVo, beforeCustRelMain, uCustRelMain);
				iDataLog.exec();
			}
			// 關聯戶姓名
			...
			if (!uRelName.equals(uCustRelMain.getCustRelName())) {
				CustRelMain beforeCustRelMain_1 = (CustRelMain) iDataLog.clone(uCustRelMain);
				...
				iDataLog.setEnv(titaVo, beforeCustRelMain_1, uCustRelMain);
				iDataLog.exec();
			}
			...
			CustRelDetail beforeCustDetail = (CustRelDetail) iDataLog.clone(uCustRelDetail);
			...
			iDataLog.setEnv(titaVo, beforeCustDetail, uCustRelDetail);
			iDataLog.exec();
			break;
		default:
			break;
