...
@Repository
public class ClImmServiceImpl implements ClImmService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(ClImmServiceImpl.class);
  ...
  public ClImm findById(ClImmId clImmId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + clImmId);
...
em = null;
  ...
  public Slice<ClImm> findRange(String settingStat_0, String settingStat_1, String clStat_2, String clStat_3, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("findRange " + dbName + " : " + "settingStat_0 : " + settingStat_0 + " settingStat_1 : " +  settingStat_1 + " clStat_2 : " +  clStat_2 + " clStat_3 : " +  clStat_3);
    if (dbName.equals(ContentName.onDay))
      slice = clImmReposDay.findAllBySettingStatGreaterThanEqualAndSettingStatLessThanEqualAndClStatGreaterThanEqualAndClStatLessThanEqual(settingStat_0, settingStat_1, clStat_2, clStat_3, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = clImmReposMon.findAllBySettingStatGreaterThanEqualAndSettingStatLessThanEqualAndClStatGreaterThanEqualAndClStatLessThanEqual(settingStat_0, settingStat_1, clStat_2, clStat_3, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = clImmReposHist.findAllBySettingStatGreaterThanEqualAndSettingStatLessThanEqualAndClStatGreaterThanEqualAndClStatLessThanEqual(settingStat_0, settingStat_1, clStat_2, clStat_3, pageable);
    else 
      slice = clImmRepos.findAllBySettingStatGreaterThanEqualAndSettingStatLessThanEqualAndClStatGreaterThanEqualAndClStatLessThanEqual(settingStat_0, settingStat_1, clStat_2, clStat_3, pageable);
  ...
  public ClImm holdById(ClImmId clImmId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + clImmId);
    Optional<ClImm> clImm = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public ClImm holdById(ClImm clImm, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + clImm.getClImmId());
  ...
  public ClImm insert(ClImm clImm, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + clImm.getClImmId());
  ...
  public ClImm update(ClImm clImm, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + clImm.getClImmId());
    if (!empNot.isEmpty())
      clImm.setLastUpdateEmpNo(empNot);
  ...
  public void delete(ClImm clImm, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + clImm.getClImmId());
    if (dbName.equals(ContentName.onDay)) {
