...
public class TxPrinter implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 27295167513832941L;
	...
	public String toString() {
		return "TxPrinter [txPrinterId=" + txPrinterId + ", serverIp=" + serverIp + ", printer=" + printer + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate="
