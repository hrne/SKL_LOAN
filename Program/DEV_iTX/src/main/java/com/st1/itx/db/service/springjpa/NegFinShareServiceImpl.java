...
@Repository
public class NegFinShareServiceImpl implements NegFinShareService, InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(NegFinShareServiceImpl.class);
	...
	public NegFinShare findById(NegFinShareId negFinShareId, TitaVo... titaVo) {
		...
		logger.info("findById " + dbName + " " + negFinShareId);
	...
	public Slice<NegFinShare> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		Pageable pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "CustNo", "CaseSeq", "FinCode"));
	...
	@Override
	public Slice<NegFinShare> FindAllFinCode(int custNo_0, int caseSeq_1, int index, int limit, TitaVo... titaVo) {
		String dbName = "";
		Slice<NegFinShare> slice = null;
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
	...
	public NegFinShare holdById(NegFinShareId negFinShareId, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + negFinShareId);
		Optional<NegFinShare> negFinShare = null;
		if (dbName.equals(ContentName.onDay))
	...
	public NegFinShare holdById(NegFinShare negFinShare, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + negFinShare.getNegFinShareId());
	...
	public NegFinShare insert(NegFinShare negFinShare, TitaVo... titaVo) throws DBException {
		...
		logger.info("Insert..." + dbName + " " + negFinShare.getNegFinShareId());
		if (this.findById(negFinShare.getNegFinShareId()) != null)
	...
	public NegFinShare update(NegFinShare negFinShare, TitaVo... titaVo) throws DBException {
		...
		logger.info("Update..." + dbName + " " + negFinShare.getNegFinShareId());
		if (!empNot.isEmpty())
	...
	public void delete(NegFinShare negFinShare, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Delete..." + dbName + " " + negFinShare.getNegFinShareId());
		if (dbName.equals(ContentName.onDay)) {
