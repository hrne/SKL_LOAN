...
public class CollMeet implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2629969541586130461L;
	...
	public String toString() {
		return "CollMeet [collMeetId=" + collMeetId + ", meetDate=" + meetDate + ", meetTime=" + meetTime + ", contactCode=" + contactCode + ", meetPsnCode=" + meetPsnCode + ", collPsnCode="
				+ collPsnCode + ", collPsnName=" + collPsnName + ", meetPlaceCode=" + meetPlaceCode + ", meetPlace=" + meetPlace + ", remark=" + remark + ", createDate=" + createDate
