...
@Repository
public class AcCloseServiceImpl implements AcCloseService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(AcCloseServiceImpl.class);
  ...
  public AcClose findById(AcCloseId acCloseId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + acCloseId);
...
em = null;
  ...
  public Slice<AcClose> acCloseBranchNoEq(int acDate_0, String branchNo_1, String secNo_2, int index, int limit, TitaVo... titaVo) {
    ...
    logger.info("acCloseBranchNoEq " + dbName + " : " + "acDate_0 : " + acDate_0 + " branchNo_1 : " +  branchNo_1 + " secNo_2 : " +  secNo_2);
    if (dbName.equals(ContentName.onDay))
  ...
  public AcClose holdById(AcCloseId acCloseId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + acCloseId);
    Optional<AcClose> acClose = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public AcClose holdById(AcClose acClose, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + acClose.getAcCloseId());
  ...
  public AcClose insert(AcClose acClose, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + acClose.getAcCloseId());
  ...
  public AcClose update(AcClose acClose, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + acClose.getAcCloseId());
    if (!empNot.isEmpty())
      acClose.setLastUpdateEmpNo(empNot);
  ...
  public void delete(AcClose acClose, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + acClose.getAcCloseId());
    if (dbName.equals(ContentName.onDay)) {
