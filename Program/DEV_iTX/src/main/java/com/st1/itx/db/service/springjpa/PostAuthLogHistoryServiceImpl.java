...
public class PostAuthLogHistoryServiceImpl extends ASpringJpaParm implements PostAuthLogHistoryService, InitializingBean {
	...
	public PostAuthLogHistory findById(PostAuthLogHistoryId postAuthLogHistoryId, TitaVo... titaVo) {
		...
		this.info("findById " + dbName + " " + postAuthLogHistoryId);
	...
	public PostAuthLogHistory pkFacmNoFirst(String authApplCode_0, int custNo_1, String postDepCode_2, String repayAcct_3, String authCode_4, int facmNo_5, TitaVo... titaVo) {
		...
		Optional<PostAuthLogHistory> postAuthLogHistoryT = null;
		if (dbName.equals(ContentName.onDay))
			postAuthLogHistoryT = postAuthLogHistoryReposDay.findTopByAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsAndFacmNoIsOrderByRepayAcctSeqDesc(authApplCode_0, custNo_1,
					postDepCode_2, repayAcct_3, authCode_4, facmNo_5);
		else if (dbName.equals(ContentName.onMon))
			postAuthLogHistoryT = postAuthLogHistoryReposMon.findTopByAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsAndFacmNoIsOrderByRepayAcctSeqDesc(authApplCode_0, custNo_1,
					postDepCode_2, repayAcct_3, authCode_4, facmNo_5);
		else if (dbName.equals(ContentName.onHist))
			postAuthLogHistoryT = postAuthLogHistoryReposHist.findTopByAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsAndFacmNoIsOrderByRepayAcctSeqDesc(authApplCode_0, custNo_1,
					postDepCode_2, repayAcct_3, authCode_4, facmNo_5);
		else
			postAuthLogHistoryT = postAuthLogHistoryRepos.findTopByAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsAndFacmNoIsOrderByRepayAcctSeqDesc(authApplCode_0, custNo_1,
					postDepCode_2, repayAcct_3, authCode_4, facmNo_5);
	...
	public Slice<PostAuthLogHistory> facmNoEq(int custNo_0, int facmNo_1, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = postAuthLogHistoryReposDay.findAllByCustNoIsAndFacmNoIsOrderByDetailSeqDescAuthCodeAsc(custNo_0, facmNo_1, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = postAuthLogHistoryReposMon.findAllByCustNoIsAndFacmNoIsOrderByDetailSeqDescAuthCodeAsc(custNo_0, facmNo_1, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = postAuthLogHistoryReposHist.findAllByCustNoIsAndFacmNoIsOrderByDetailSeqDescAuthCodeAsc(custNo_0, facmNo_1, pageable);
		else
			slice = postAuthLogHistoryRepos.findAllByCustNoIsAndFacmNoIsOrderByDetailSeqDescAuthCodeAsc(custNo_0, facmNo_1, pageable);
	...
	public PostAuthLogHistory repayAcctFirst(int custNo_0, String postDepCode_1, String repayAcct_2, String authCode_3, TitaVo... titaVo) {
		...
		Optional<PostAuthLogHistory> postAuthLogHistoryT = null;
		if (dbName.equals(ContentName.onDay))
			postAuthLogHistoryT = postAuthLogHistoryReposDay.findTopByCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsOrderByAuthCreateDateDescCreateDateDesc(custNo_0, postDepCode_1, repayAcct_2,
					authCode_3);
		else if (dbName.equals(ContentName.onMon))
			postAuthLogHistoryT = postAuthLogHistoryReposMon.findTopByCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsOrderByAuthCreateDateDescCreateDateDesc(custNo_0, postDepCode_1, repayAcct_2,
					authCode_3);
		else if (dbName.equals(ContentName.onHist))
			postAuthLogHistoryT = postAuthLogHistoryReposHist.findTopByCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsOrderByAuthCreateDateDescCreateDateDesc(custNo_0, postDepCode_1, repayAcct_2,
					authCode_3);
		else
			postAuthLogHistoryT = postAuthLogHistoryRepos.findTopByCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsOrderByAuthCreateDateDescCreateDateDesc(custNo_0, postDepCode_1, repayAcct_2,
					authCode_3);
	...
	public PostAuthLogHistory facmNoBFirst(int custNo_0, int facmNo_1, TitaVo... titaVo) {
		...
		Optional<PostAuthLogHistory> postAuthLogHistoryT = null;
		if (dbName.equals(ContentName.onDay))
			postAuthLogHistoryT = postAuthLogHistoryReposDay.findTopByCustNoIsAndFacmNoIsOrderByDetailSeqDescAuthCodeAsc(custNo_0, facmNo_1);
		else if (dbName.equals(ContentName.onMon))
			postAuthLogHistoryT = postAuthLogHistoryReposMon.findTopByCustNoIsAndFacmNoIsOrderByDetailSeqDescAuthCodeAsc(custNo_0, facmNo_1);
		else if (dbName.equals(ContentName.onHist))
			postAuthLogHistoryT = postAuthLogHistoryReposHist.findTopByCustNoIsAndFacmNoIsOrderByDetailSeqDescAuthCodeAsc(custNo_0, facmNo_1);
		else
			postAuthLogHistoryT = postAuthLogHistoryRepos.findTopByCustNoIsAndFacmNoIsOrderByDetailSeqDescAuthCodeAsc(custNo_0, facmNo_1);
	...
	public PostAuthLogHistory authLogFirst(int authCreateDate_0, String authApplCode_1, int custNo_2, String postDepCode_3, String repayAcct_4, String authCode_5, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("authLogFirst " + dbName + " : " + "authCreateDate_0 : " + authCreateDate_0 + " authApplCode_1 : " + authApplCode_1 + " custNo_2 : " + custNo_2 + " postDepCode_3 : " + postDepCode_3
				+ " repayAcct_4 : " + repayAcct_4 + " authCode_5 : " + authCode_5);
		Optional<PostAuthLogHistory> postAuthLogHistoryT = null;
		if (dbName.equals(ContentName.onDay))
			postAuthLogHistoryT = postAuthLogHistoryReposDay.findTopByAuthCreateDateIsAndAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsOrderByDetailSeqDesc(authCreateDate_0,
					authApplCode_1, custNo_2, postDepCode_3, repayAcct_4, authCode_5);
		else if (dbName.equals(ContentName.onMon))
			postAuthLogHistoryT = postAuthLogHistoryReposMon.findTopByAuthCreateDateIsAndAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsOrderByDetailSeqDesc(authCreateDate_0,
					authApplCode_1, custNo_2, postDepCode_3, repayAcct_4, authCode_5);
		else if (dbName.equals(ContentName.onHist))
			postAuthLogHistoryT = postAuthLogHistoryReposHist.findTopByAuthCreateDateIsAndAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsOrderByDetailSeqDesc(authCreateDate_0,
					authApplCode_1, custNo_2, postDepCode_3, repayAcct_4, authCode_5);
		else
			postAuthLogHistoryT = postAuthLogHistoryRepos.findTopByAuthCreateDateIsAndAuthApplCodeIsAndCustNoIsAndPostDepCodeIsAndRepayAcctIsAndAuthCodeIsOrderByDetailSeqDesc(authCreateDate_0,
					authApplCode_1, custNo_2, postDepCode_3, repayAcct_4, authCode_5);
	...
	public PostAuthLogHistory holdById(PostAuthLogHistoryId postAuthLogHistoryId, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Hold " + dbName + " " + postAuthLogHistoryId);
		Optional<PostAuthLogHistory> postAuthLogHistory = null;
		if (dbName.equals(ContentName.onDay))
	...
	public PostAuthLogHistory holdById(PostAuthLogHistory postAuthLogHistory, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Hold " + dbName + " " + postAuthLogHistory.getPostAuthLogHistoryId());
		Optional<PostAuthLogHistory> postAuthLogHistoryT = null;
		if (dbName.equals(ContentName.onDay))
	...
	public PostAuthLogHistory insert(PostAuthLogHistory postAuthLogHistory, TitaVo... titaVo) throws DBException {
		...
		this.info("Insert..." + dbName + " " + postAuthLogHistory.getPostAuthLogHistoryId());
	...
	public PostAuthLogHistory update(PostAuthLogHistory postAuthLogHistory, TitaVo... titaVo) throws DBException {
		...
		this.info("Update..." + dbName + " " + postAuthLogHistory.getPostAuthLogHistoryId());
		if (!empNot.isEmpty())
			postAuthLogHistory.setLastUpdateEmpNo(empNot);
	...
	public void delete(PostAuthLogHistory postAuthLogHistory, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		this.info("Delete..." + dbName + " " + postAuthLogHistory.getPostAuthLogHistoryId());
		if (dbName.equals(ContentName.onDay)) {
