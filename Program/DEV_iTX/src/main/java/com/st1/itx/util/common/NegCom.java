...
//		Map<String, String> mapNeg = new HashMap<String, String>();
		...
		BigDecimal CloseAmt = mainPrincipalBal
				.add(mainPrincipalBal.multiply(mainIntRate).divide(new BigDecimal(1200), 0, RoundingMode.HALF_UP));//
