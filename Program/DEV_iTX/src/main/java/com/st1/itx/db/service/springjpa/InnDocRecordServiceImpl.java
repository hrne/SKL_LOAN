...
em = null;
  ...
  public Slice<InnDocRecord> findL5903ARg(int custNo_0, int applDate_1, int applDate_2, String usageCode_3, String applCode_4, int index, int limit, TitaVo... titaVo) {
    ...
    this.info("findL5903ARg " + dbName + " : " + "custNo_0 : " + custNo_0 + " applDate_1 : " +  applDate_1 + " applDate_2 : " +  applDate_2 + " usageCode_3 : " +  usageCode_3 + " applCode_4 : " +  applCode_4);
    if (dbName.equals(ContentName.onDay))
      slice = innDocRecordReposDay.findAllByCustNoIsAndApplDateGreaterThanEqualAndApplDateLessThanEqualAndUsageCodeIsAndApplCodeIsOrderByCustNoAscApplDateAscUsageCodeAscApplCodeAsc(custNo_0, applDate_1, applDate_2, usageCode_3, applCode_4, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = innDocRecordReposMon.findAllByCustNoIsAndApplDateGreaterThanEqualAndApplDateLessThanEqualAndUsageCodeIsAndApplCodeIsOrderByCustNoAscApplDateAscUsageCodeAscApplCodeAsc(custNo_0, applDate_1, applDate_2, usageCode_3, applCode_4, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = innDocRecordReposHist.findAllByCustNoIsAndApplDateGreaterThanEqualAndApplDateLessThanEqualAndUsageCodeIsAndApplCodeIsOrderByCustNoAscApplDateAscUsageCodeAscApplCodeAsc(custNo_0, applDate_1, applDate_2, usageCode_3, applCode_4, pageable);
    else 
      slice = innDocRecordRepos.findAllByCustNoIsAndApplDateGreaterThanEqualAndApplDateLessThanEqualAndUsageCodeIsAndApplCodeIsOrderByCustNoAscApplDateAscUsageCodeAscApplCodeAsc(custNo_0, applDate_1, applDate_2, usageCode_3, applCode_4, pageable);
  ...
  public Slice<InnDocRecord> findL5903BRg(int custNo_0, int applDate_1, int applDate_2, String applCode_3, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      slice = innDocRecordReposDay.findAllByCustNoIsAndApplDateGreaterThanEqualAndApplDateLessThanEqualAndApplCodeIsOrderByCustNoAscApplDateAscUsageCodeAscApplCodeAsc(custNo_0, applDate_1, applDate_2, applCode_3, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = innDocRecordReposMon.findAllByCustNoIsAndApplDateGreaterThanEqualAndApplDateLessThanEqualAndApplCodeIsOrderByCustNoAscApplDateAscUsageCodeAscApplCodeAsc(custNo_0, applDate_1, applDate_2, applCode_3, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = innDocRecordReposHist.findAllByCustNoIsAndApplDateGreaterThanEqualAndApplDateLessThanEqualAndApplCodeIsOrderByCustNoAscApplDateAscUsageCodeAscApplCodeAsc(custNo_0, applDate_1, applDate_2, applCode_3, pageable);
    else 
      slice = innDocRecordRepos.findAllByCustNoIsAndApplDateGreaterThanEqualAndApplDateLessThanEqualAndApplCodeIsOrderByCustNoAscApplDateAscUsageCodeAscApplCodeAsc(custNo_0, applDate_1, applDate_2, applCode_3, pageable);
  ...
  public Slice<InnDocRecord> findL5903CRg(int custNo_0, int applDate_1, int applDate_2, String usageCode_3, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      slice = innDocRecordReposDay.findAllByCustNoIsAndApplDateGreaterThanEqualAndApplDateLessThanEqualAndUsageCodeIsOrderByCustNoAscApplDateAscUsageCodeAscApplCodeAsc(custNo_0, applDate_1, applDate_2, usageCode_3, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = innDocRecordReposMon.findAllByCustNoIsAndApplDateGreaterThanEqualAndApplDateLessThanEqualAndUsageCodeIsOrderByCustNoAscApplDateAscUsageCodeAscApplCodeAsc(custNo_0, applDate_1, applDate_2, usageCode_3, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = innDocRecordReposHist.findAllByCustNoIsAndApplDateGreaterThanEqualAndApplDateLessThanEqualAndUsageCodeIsOrderByCustNoAscApplDateAscUsageCodeAscApplCodeAsc(custNo_0, applDate_1, applDate_2, usageCode_3, pageable);
    else 
      slice = innDocRecordRepos.findAllByCustNoIsAndApplDateGreaterThanEqualAndApplDateLessThanEqualAndUsageCodeIsOrderByCustNoAscApplDateAscUsageCodeAscApplCodeAsc(custNo_0, applDate_1, applDate_2, usageCode_3, pageable);
  ...
  public Slice<InnDocRecord> findL5903DRg(int custNo_0, int applDate_1, int applDate_2, int index, int limit, TitaVo... titaVo) {
    ...
    if (dbName.equals(ContentName.onDay))
      slice = innDocRecordReposDay.findAllByCustNoIsAndApplDateGreaterThanEqualAndApplDateLessThanEqualOrderByCustNoAscApplDateAscUsageCodeAscApplCodeAsc(custNo_0, applDate_1, applDate_2, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = innDocRecordReposMon.findAllByCustNoIsAndApplDateGreaterThanEqualAndApplDateLessThanEqualOrderByCustNoAscApplDateAscUsageCodeAscApplCodeAsc(custNo_0, applDate_1, applDate_2, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = innDocRecordReposHist.findAllByCustNoIsAndApplDateGreaterThanEqualAndApplDateLessThanEqualOrderByCustNoAscApplDateAscUsageCodeAscApplCodeAsc(custNo_0, applDate_1, applDate_2, pageable);
    else 
      slice = innDocRecordRepos.findAllByCustNoIsAndApplDateGreaterThanEqualAndApplDateLessThanEqualOrderByCustNoAscApplDateAscUsageCodeAscApplCodeAsc(custNo_0, applDate_1, applDate_2, pageable);
  ...
  public InnDocRecord insert(InnDocRecord innDocRecord, TitaVo... titaVo) throws DBException {
    ...
    if (this.findById(innDocRecord.getInnDocRecordId()) != null)
