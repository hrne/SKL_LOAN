...
@Repository
public class JcicB094ServiceImpl implements JcicB094Service, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(JcicB094ServiceImpl.class);
  ...
  public JcicB094 findById(JcicB094Id jcicB094Id, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + jcicB094Id);
...
em = null;
  ...
  public JcicB094 holdById(JcicB094Id jcicB094Id, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicB094Id);
    Optional<JcicB094> jcicB094 = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicB094 holdById(JcicB094 jcicB094, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicB094.getJcicB094Id());
  ...
  public JcicB094 insert(JcicB094 jcicB094, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + jcicB094.getJcicB094Id());
  ...
  public JcicB094 update(JcicB094 jcicB094, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + jcicB094.getJcicB094Id());
    if (!empNot.isEmpty())
      jcicB094.setLastUpdateEmpNo(empNot);
  ...
  public void delete(JcicB094 jcicB094, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + jcicB094.getJcicB094Id());
    if (dbName.equals(ContentName.onDay)) {
