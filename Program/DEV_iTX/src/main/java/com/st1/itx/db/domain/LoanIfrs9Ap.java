...
public class LoanIfrs9Ap implements Serializable {
	...
	public String toString() {
		return "LoanIfrs9Ap [loanIfrs9ApId=" + loanIfrs9ApId + ", custId=" + custId + ", applNo=" + applNo + ", acCode=" + acCode + ", status=" + status + ", firstDrawdownDate=" + firstDrawdownDate
				...
				+ custKind + ", assetClass=" + assetClass + ", ifrs9ProdCode=" + ifrs9ProdCode + ", evaAmt=" + evaAmt + ", firstDueDate=" + firstDueDate + ", totalPeriod=" + totalPeriod + ", avblBal="
