...
public class TxAmlCreditServiceImpl extends ASpringJpaParm implements TxAmlCreditService, InitializingBean {
	...
	public Slice<TxAmlCredit> processAll(String reviewType_0, int dataDt_1, int dataDt_2, String processType_3, int index, int limit, TitaVo... titaVo) {
		...
		if (dbName.equals(ContentName.onDay))
			slice = txAmlCreditReposDay.findAllByReviewTypeIsAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeOrderByDataDtAscCustKeyAsc(reviewType_0, dataDt_1, dataDt_2,
					processType_3, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txAmlCreditReposMon.findAllByReviewTypeIsAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeOrderByDataDtAscCustKeyAsc(reviewType_0, dataDt_1, dataDt_2,
					processType_3, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txAmlCreditReposHist.findAllByReviewTypeIsAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeOrderByDataDtAscCustKeyAsc(reviewType_0, dataDt_1, dataDt_2,
					processType_3, pageable);
		else
			slice = txAmlCreditRepos.findAllByReviewTypeIsAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeOrderByDataDtAscCustKeyAsc(reviewType_0, dataDt_1, dataDt_2, processType_3,
					pageable);
	...
	public Slice<TxAmlCredit> processNo(String reviewType_0, int dataDt_1, int dataDt_2, String processType_3, int processCount_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("processNo " + dbName + " : " + "reviewType_0 : " + reviewType_0 + " dataDt_1 : " + dataDt_1 + " dataDt_2 : " + dataDt_2 + " processType_3 : " + processType_3 + " processCount_4 : "
				+ processCount_4);
		if (dbName.equals(ContentName.onDay))
			slice = txAmlCreditReposDay.findAllByReviewTypeIsAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeAndProcessCountIsOrderByDataDtAscCustKeyAsc(reviewType_0, dataDt_1,
					dataDt_2, processType_3, processCount_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txAmlCreditReposMon.findAllByReviewTypeIsAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeAndProcessCountIsOrderByDataDtAscCustKeyAsc(reviewType_0, dataDt_1,
					dataDt_2, processType_3, processCount_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txAmlCreditReposHist.findAllByReviewTypeIsAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeAndProcessCountIsOrderByDataDtAscCustKeyAsc(reviewType_0, dataDt_1,
					dataDt_2, processType_3, processCount_4, pageable);
		else
			slice = txAmlCreditRepos.findAllByReviewTypeIsAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeAndProcessCountIsOrderByDataDtAscCustKeyAsc(reviewType_0, dataDt_1, dataDt_2,
					processType_3, processCount_4, pageable);
	...
	public Slice<TxAmlCredit> processYes(String reviewType_0, int dataDt_1, int dataDt_2, String processType_3, int processCount_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info("processYes " + dbName + " : " + "reviewType_0 : " + reviewType_0 + " dataDt_1 : " + dataDt_1 + " dataDt_2 : " + dataDt_2 + " processType_3 : " + processType_3 + " processCount_4 : "
				+ processCount_4);
		if (dbName.equals(ContentName.onDay))
			slice = txAmlCreditReposDay.findAllByReviewTypeIsAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeAndProcessCountGreaterThanOrderByDataDtAscCustKeyAsc(reviewType_0,
					dataDt_1, dataDt_2, processType_3, processCount_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = txAmlCreditReposMon.findAllByReviewTypeIsAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeAndProcessCountGreaterThanOrderByDataDtAscCustKeyAsc(reviewType_0,
					dataDt_1, dataDt_2, processType_3, processCount_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = txAmlCreditReposHist.findAllByReviewTypeIsAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeAndProcessCountGreaterThanOrderByDataDtAscCustKeyAsc(reviewType_0,
					dataDt_1, dataDt_2, processType_3, processCount_4, pageable);
		else
			slice = txAmlCreditRepos.findAllByReviewTypeIsAndDataDtGreaterThanEqualAndDataDtLessThanEqualAndProcessTypeLikeAndProcessCountGreaterThanOrderByDataDtAscCustKeyAsc(reviewType_0, dataDt_1,
					dataDt_2, processType_3, processCount_4, pageable);
