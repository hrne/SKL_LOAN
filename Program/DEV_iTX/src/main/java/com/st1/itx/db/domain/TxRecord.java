...
public class TxRecord implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -2614708590103256037L;
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "TxRecord [txRecordId=" + txRecordId + ", brNo=" + brNo + ", tlrNo=" + tlrNo + ", txSeq=" + txSeq + ", tranNo=" + tranNo
           + ", groupNo=" + groupNo + ", trmType=" + trmType + ", mrKey=" + mrKey + ", secNo=" + secNo + ", deCr=" + deCr + ", bookAc=" + bookAc
           + ", acCnt=" + acCnt + ", curCode=" + curCode + ", curName=" + curName + ", txAmt=" + txAmt + ", supNo=" + supNo + ", hcode=" + hcode
           + ", calDate=" + calDate + ", calTime=" + calTime + ", txResult=" + txResult + ", msgId=" + msgId + ", errMsg=" + errMsg + ", flowNo=" + flowNo
           + ", flowType=" + flowType + ", flowStep=" + flowStep + ", lockCustNo=" + lockCustNo + ", lockNo=" + lockNo + ", canCancel=" + canCancel + ", canModify=" + canModify
           + ", actionFg=" + actionFg + ", orgEntdy=" + orgEntdy + ", orgTxNo=" + orgTxNo + ", tranData=" + tranData + ", importFg=" + importFg + ", createDate=" + createDate
