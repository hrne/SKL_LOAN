...
public class ClEva implements Serializable {
	...
	public String toString() {
		return "ClEva [clEvaId=" + clEvaId + ", evaDate=" + evaDate + ", evaAmt=" + evaAmt + ", evaNetWorth=" + evaNetWorth + ", rentEvaValue=" + rentEvaValue + ", evaCompanyId=" + evaCompanyId
				+ ", evaCompanyName=" + evaCompanyName + ", evaEmpno=" + evaEmpno + ", evaReason=" + evaReason + ", otherReason=" + otherReason + ", createDate=" + createDate + ", createEmpNo="
