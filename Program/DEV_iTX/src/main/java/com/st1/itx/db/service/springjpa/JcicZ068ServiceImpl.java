...
@Repository
public class JcicZ068ServiceImpl implements JcicZ068Service, InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(JcicZ068ServiceImpl.class);
	...
	public JcicZ068 findById(JcicZ068Id jcicZ068Id, TitaVo... titaVo) {
		...
		logger.info("findById " + dbName + " " + jcicZ068Id);
	...
	public JcicZ068 holdById(JcicZ068Id jcicZ068Id, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + jcicZ068Id);
		Optional<JcicZ068> jcicZ068 = null;
		if (dbName.equals(ContentName.onDay))
	...
	public JcicZ068 holdById(JcicZ068 jcicZ068, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + jcicZ068.getJcicZ068Id());
	...
	public JcicZ068 insert(JcicZ068 jcicZ068, TitaVo... titaVo) throws DBException {
		...
		logger.info("Insert..." + dbName + " " + jcicZ068.getJcicZ068Id());
	...
	public JcicZ068 update(JcicZ068 jcicZ068, TitaVo... titaVo) throws DBException {
		...
		logger.info("Update..." + dbName + " " + jcicZ068.getJcicZ068Id());
		if (!empNot.isEmpty())
	...
	public void delete(JcicZ068 jcicZ068, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Delete..." + dbName + " " + jcicZ068.getJcicZ068Id());
		if (dbName.equals(ContentName.onDay)) {
