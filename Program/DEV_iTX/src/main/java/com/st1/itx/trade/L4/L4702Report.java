...
public class L4702Report extends MakeReport {
	...
	// LoggerFactory.getLogger(L4702Report.class);
...
//	}
	...
	private void report(Map<String, String> tL4702Vo, TxBuffer txbuffer) throws LogicException {
		...
		try {
			...
			listBaTxVo = dBaTxCom.termsPay(parse.stringToInteger(titaVo.getParam("ENTDY")), parse.stringToInteger(tL4702Vo.get("F4")), parse.stringToInteger(tL4702Vo.get("F5")), 0, 6, titaVo);
			...
			this.print(1, 10, tmp);
			this.print(1, 1, "");
			this.print(1, 10, String.format("%07d", Integer.valueOf(tL4702Vo.get("F4"))) + "   " + tL4702Vo.get("F6"));
			this.print(1, 1, "");
			this.print(1, 1, "");
			this.print(1, 1, "");
			this.print(1, 1, "");
			...
			this.print(0, 16, String.format("%07d", Integer.valueOf(tL4702Vo.get("F4"))) + "-" + String.format("%03d", Integer.valueOf(tL4702Vo.get("F5"))));
