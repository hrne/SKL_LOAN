...
public class JcicB207 implements Serializable {
	...
	/**
	 * 教育程度代號<br>
	 * 附件二之二，無資料填空白，勿填0 1:博士 2:碩士 3:大學 4:專科 5:高中高職 6:其他
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "JcicB207 [jcicB207Id=" + jcicB207Id + ", tranCode=" + tranCode + ", filler3=" + filler3 + ", dataDate=" + dataDate + ", custName=" + custName + ", eName=" + eName + ", birthday="
				+ birthday + ", regAddr=" + regAddr + ", currZip=" + currZip + ", currAddr=" + currAddr + ", tel=" + tel + ", mobile=" + mobile + ", filler14=" + filler14 + ", eduCode=" + eduCode
				+ ", ownedHome=" + ownedHome + ", currCompName=" + currCompName + ", currCompId=" + currCompId + ", jobCode=" + jobCode + ", currCompTel=" + currCompTel + ", jobTitle=" + jobTitle
				+ ", jobTenure=" + jobTenure + ", incomeOfYearly=" + incomeOfYearly + ", incomeDataDate=" + incomeDataDate + ", sex=" + sex + ", nationalityCode=" + nationalityCode + ", passportNo="
				+ passportNo + ", preTaxNo=" + preTaxNo + ", fullCustName=" + fullCustName + ", filler30=" + filler30 + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate="
