...
@Repository
public class JcicZ454ServiceImpl implements JcicZ454Service, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(JcicZ454ServiceImpl.class);
  ...
  public JcicZ454 findById(JcicZ454Id jcicZ454Id, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + jcicZ454Id);
...
em = null;
  ...
  public JcicZ454 holdById(JcicZ454Id jcicZ454Id, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicZ454Id);
    Optional<JcicZ454> jcicZ454 = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicZ454 holdById(JcicZ454 jcicZ454, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + jcicZ454.getJcicZ454Id());
    Optional<JcicZ454> jcicZ454T = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public JcicZ454 insert(JcicZ454 jcicZ454, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + jcicZ454.getJcicZ454Id());
  ...
  public JcicZ454 update(JcicZ454 jcicZ454, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + jcicZ454.getJcicZ454Id());
    if (!empNot.isEmpty())
      jcicZ454.setLastUpdateEmpNo(empNot);
  ...
  public void delete(JcicZ454 jcicZ454, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + jcicZ454.getJcicZ454Id());
    if (dbName.equals(ContentName.onDay)) {
