...
@Table(name = "`LoanIfrs9Gp`")
public class LoanIfrs9Gp implements Serializable {


  /**
	 * 
	 */
	private static final long serialVersionUID = -797504414244200208L;

@EmbeddedId
  private LoanIfrs9GpId loanIfrs9GpId;
  ...
  public LoanIfrs9GpId getLoanIfrs9GpId() {
    return this.loanIfrs9GpId;
  }

  public void setLoanIfrs9GpId(LoanIfrs9GpId loanIfrs9GpId) {
    this.loanIfrs9GpId = loanIfrs9GpId;
  }
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "LoanIfrs9Gp [loanIfrs9GpId=" + loanIfrs9GpId + ", custId=" + custId + ", applNo=" + applNo
           + ", custKind=" + custKind + ", status=" + status + ", ovduDate=" + ovduDate + ", oriRating=" + oriRating + ", oriModel=" + oriModel + ", rating=" + rating
           + ", model=" + model + ", ovduDays=" + ovduDays + ", stage1=" + stage1 + ", stage2=" + stage2 + ", stage3=" + stage3 + ", stage4=" + stage4
           + ", stage5=" + stage5 + ", pdFlagToD=" + pdFlagToD + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
           + "]";
  }
}
