...
@Repository
public class NegFinAcctServiceImpl implements NegFinAcctService, InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(NegFinAcctServiceImpl.class);
	...
	public NegFinAcct findById(String finCode, TitaVo... titaVo) {
		...
		logger.info("findById " + dbName + " " + finCode);
	...
	public Slice<NegFinAcct> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		Pageable pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "FinCode"));
	...
	public NegFinAcct holdById(String finCode, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + finCode);
		Optional<NegFinAcct> negFinAcct = null;
		if (dbName.equals(ContentName.onDay))
	...
	public NegFinAcct holdById(NegFinAcct negFinAcct, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + negFinAcct.getFinCode());
	...
	public NegFinAcct insert(NegFinAcct negFinAcct, TitaVo... titaVo) throws DBException {
		...
		logger.info("Insert..." + dbName + " " + negFinAcct.getFinCode());
		if (this.findById(negFinAcct.getFinCode()) != null)
	...
	public NegFinAcct update(NegFinAcct negFinAcct, TitaVo... titaVo) throws DBException {
		...
		logger.info("Update..." + dbName + " " + negFinAcct.getFinCode());
		if (!empNot.isEmpty())
	...
	public void delete(NegFinAcct negFinAcct, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Delete..." + dbName + " " + negFinAcct.getFinCode());
		if (dbName.equals(ContentName.onDay)) {
