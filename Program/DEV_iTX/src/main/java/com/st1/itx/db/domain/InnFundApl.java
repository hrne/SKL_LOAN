...
public class InnFundApl implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7720069800540024690L;
...
// 日期
	...
	public String toString() {
		return "InnFundApl [acDate=" + acDate + ", resrvStndrd=" + resrvStndrd + ", posbleBorPsn=" + posbleBorPsn + ", posbleBorAmt=" + posbleBorAmt + ", alrdyBorAmt=" + alrdyBorAmt
				+ ", stockHoldersEqt=" + stockHoldersEqt + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
