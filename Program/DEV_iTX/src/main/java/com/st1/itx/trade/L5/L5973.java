...
public class L5973 extends TradeBuffer {
	// private static final Logger logger = LoggerFactory.getLogger(L5973.class);
	/* DB服務注入 */
	@Autowired
	...
	public ArrayList<TotaVo> run(TitaVo titaVo) throws LogicException {
		...
		this.limit=40;//查全部 Integer.MAX_VALUE
		...
		if(lNegAppr01!=null) {
			...
			for(NegAppr01 NegAppr01VO:lNegAppr01) {
				...
				//每筆的第一筆給1 其餘給0
				String Rank="";
				String Key=String.valueOf(ThisCustNo);
				...
				occursList.putParam("OORank",Rank);//
