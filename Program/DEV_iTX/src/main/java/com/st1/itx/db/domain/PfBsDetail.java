...
// 序號
	...
	public String toString() {
		return "PfBsDetail [logNo=" + logNo + ", perfDate=" + perfDate + ", custNo=" + custNo + ", facmNo=" + facmNo + ", bormNo=" + bormNo + ", repayType=" + repayType + ", bsOfficer=" + bsOfficer
				+ ", deptCode=" + deptCode + ", drawdownDate=" + drawdownDate + ", prodCode=" + prodCode + ", pieceCode=" + pieceCode + ", drawdownAmt=" + drawdownAmt + ", perfCnt=" + perfCnt
				+ ", perfAmt=" + perfAmt + ", adjPerfCnt=" + adjPerfCnt + ", adjPerfAmt=" + adjPerfAmt + ", workMonth=" + workMonth + ", workSeason=" + workSeason + ", createDate=" + createDate
