...
em = null;
  ...
  public Slice<LoanIntDetail> intDetailBreachGetCodeEq(int custNo_0, int facmNo_1, int facmNo_2, int bormNo_3, int bormNo_4, String breachGetCode_5, int index, int limit, TitaVo... titaVo) {
    ...
    this.info("intDetailBreachGetCodeEq " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " +  facmNo_1 + " facmNo_2 : " +  facmNo_2 + " bormNo_3 : " +  bormNo_3 + " bormNo_4 : " +  bormNo_4 + " breachGetCode_5 : " +  breachGetCode_5);
    if (dbName.equals(ContentName.onDay))
      slice = loanIntDetailReposDay.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndBreachGetCodeIsOrderByAcDateAsc(custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, breachGetCode_5, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = loanIntDetailReposMon.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndBreachGetCodeIsOrderByAcDateAsc(custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, breachGetCode_5, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = loanIntDetailReposHist.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndBreachGetCodeIsOrderByAcDateAsc(custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, breachGetCode_5, pageable);
    else 
      slice = loanIntDetailRepos.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndBreachGetCodeIsOrderByAcDateAsc(custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, breachGetCode_5, pageable);
  ...
  public Slice<LoanIntDetail> fildFacmNoEq(int custNo_0, int facmNo_1, int bormNo_2, int acDate_3, String tlrNo_4, String txtNo_5, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("fildFacmNoEq " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " +  facmNo_1 + " bormNo_2 : " +  bormNo_2 + " acDate_3 : " +  acDate_3 + " tlrNo_4 : " +  tlrNo_4 + " txtNo_5 : " +  txtNo_5);
    if (dbName.equals(ContentName.onDay))
