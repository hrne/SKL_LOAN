...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "CdAppraiser [appraiserCode=" + appraiserCode + ", appraiserItem=" + appraiserItem + ", company=" + company + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
