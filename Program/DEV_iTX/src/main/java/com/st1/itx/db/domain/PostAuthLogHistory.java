...
public class PostAuthLogHistory implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8998709489788419021L;

	@EmbeddedId
	private PostAuthLogHistoryId postAuthLogHistoryId;
	...
	// 狀況代號，授權狀態
	/*
	 * 空白:未授權00:成功03:已終止代繳06:凍結警示戶07:支票專戶08:帳號錯誤09:終止戶10:身分證不符11:轉出戶12:拒絕往來戶13:
	 * 無此編號14:編號已存在16:管制帳戶17:掛失戶18:異常帳戶19:編號非英數91:期限未扣款98:其他
	 */
	...
	public PostAuthLogHistoryId getPostAuthLogHistoryId() {
		return this.postAuthLogHistoryId;
	}

	public void setPostAuthLogHistoryId(PostAuthLogHistoryId postAuthLogHistoryId) {
		this.postAuthLogHistoryId = postAuthLogHistoryId;
	}
	...
	/**
	 * 明細序號<br>
	 * 1.該戶號、額度之授權帳號歷程序號 2.刪除回復時，該筆刪除
	 * 
	 * @return Integer
	 */
	...
	/**
	 * 核印註記<br>
	 * 1局帳號不符 2戶名不符 3身分證號不符 4印鑑不符 9其他
	 * 
	 * @return String
	 */
	...
	/**
	 * 狀況代號，授權狀態<br>
	 * 空白:未授權 00:成功 03:已終止代繳 06:凍結警示戶 07:支票專戶 08:帳號錯誤 09:終止戶 10:身分證不符 11:轉出戶
	 * 12:拒絕往來戶 13:無此編號 14:編號已存在 16:管制帳戶 17:掛失戶 18:異常帳戶 19:編號非英數 91:期限未扣款 98:其他
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "PostAuthLogHistory [postAuthLogHistoryId=" + postAuthLogHistoryId + ", authCreateDate=" + authCreateDate + ", authApplCode=" + authApplCode + ", postDepCode=" + postDepCode
				+ ", repayAcct=" + repayAcct + ", custId=" + custId + ", repayAcctSeq=" + repayAcctSeq + ", processDate=" + processDate + ", stampFinishDate=" + stampFinishDate + ", stampCancelDate="
				+ stampCancelDate + ", stampCode=" + stampCode + ", postMediaCode=" + postMediaCode + ", authErrorCode=" + authErrorCode + ", fileSeq=" + fileSeq + ", propDate=" + propDate
				+ ", retrDate=" + retrDate + ", deleteDate=" + deleteDate + ", relationCode=" + relationCode + ", relAcctName=" + relAcctName + ", relationId=" + relationId + ", relAcctBirthday="
				+ relAcctBirthday + ", relAcctGender=" + relAcctGender + ", amlRsp=" + amlRsp + ", createEmpNo=" + createEmpNo + ", createDate=" + createDate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
