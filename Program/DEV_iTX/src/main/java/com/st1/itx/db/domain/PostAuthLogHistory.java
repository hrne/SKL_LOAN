...
@EmbeddedId
  ...
  // 狀況代號，授權狀態
  /* 空白:未授權00:成功03:已終止代繳06:凍結警示戶07:支票專戶08:帳號錯誤09:終止戶10:身分證不符11:轉出戶12:拒絕往來戶13:無此編號14:編號已存在16:管制帳戶17:掛失戶18:異常帳戶19:編號非英數91:期限未扣款98:其他 */
...
/**
  ...
  * @param lastUpdate 異動日期
  ...
  public String toString() {
    return "PostAuthLogHistory [postAuthLogHistoryId=" + postAuthLogHistoryId + ", authCreateDate=" + authCreateDate + ", authApplCode=" + authApplCode
           + ", postDepCode=" + postDepCode + ", repayAcct=" + repayAcct + ", custId=" + custId + ", repayAcctSeq=" + repayAcctSeq + ", processDate=" + processDate + ", stampFinishDate=" + stampFinishDate
           ...
           + ", relAcctGender=" + relAcctGender + ", amlRsp=" + amlRsp + ", createEmpNo=" + createEmpNo + ", createDate=" + createDate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + ", lastUpdate=" + lastUpdate
           + "]";
  }
}
