...
public class L4510R2ServiceImpl extends ASpringJpaParm implements InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(L4510R2ServiceImpl.class);
	...
	public List<Map<String, String>> findAll(int iEntryDate, String iProcCode, TitaVo titaVo)
			throws Exception {
