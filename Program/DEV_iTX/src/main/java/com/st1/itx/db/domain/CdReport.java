...
// 報表代號
	...
	public String toString() {
		return "CdReport [formNo=" + formNo + ", formName=" + formName + ", cycle=" + cycle + ", sendCode=" + sendCode + ", letter=" + letter + ", message=" + message + ", email=" + email
				+ ", usageDesc=" + usageDesc + ", signCode=" + signCode + ", watermarkFlag=" + watermarkFlag + ", enable=" + enable + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
