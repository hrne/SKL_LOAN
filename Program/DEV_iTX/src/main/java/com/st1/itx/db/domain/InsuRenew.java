...
public class InsuRenew implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7210527510557106797L;
	...
	/**
	 * 保險類別<br>
	 * CdCode:InsuTypeCode 01:住宅火險地震險 02:火險 03:地震險 04:汽車全險 05:綜合營造險 06:動產火險 07:其他
	 * 
	 * @return String
	 */
	...
	/**
	 * 繳款方式<br>
	 * CdCode:RepayCode 1:匯款轉帳 2:銀行扣款 3:員工扣薪 4:支票 5:特約金 6:人事特約金 7:定存特約 8:劃撥存款
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "InsuRenew [insuRenewId=" + insuRenewId + ", insuYearMonth=" + insuYearMonth + ", custNo=" + custNo + ", facmNo=" + facmNo + ", nowInsuNo=" + nowInsuNo + ", origInsuNo=" + origInsuNo
				+ ", renewCode=" + renewCode + ", insuCompany=" + insuCompany + ", insuTypeCode=" + insuTypeCode + ", repayCode=" + repayCode + ", fireInsuCovrg=" + fireInsuCovrg + ", ethqInsuCovrg="
				+ ethqInsuCovrg + ", fireInsuPrem=" + fireInsuPrem + ", ethqInsuPrem=" + ethqInsuPrem + ", insuStartDate=" + insuStartDate + ", insuEndDate=" + insuEndDate + ", totInsuPrem="
				+ totInsuPrem + ", acDate=" + acDate + ", titaTlrNo=" + titaTlrNo + ", titaTxtNo=" + titaTxtNo + ", notiTempFg=" + notiTempFg + ", statusCode=" + statusCode + ", ovduDate=" + ovduDate
				+ ", ovduNo=" + ovduNo + ", commericalFlag=" + commericalFlag + ", remark=" + remark + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
