...
@Repository
public class LoanBorTxServiceImpl implements LoanBorTxService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(LoanBorTxServiceImpl.class);
  ...
  public LoanBorTx findById(LoanBorTxId loanBorTxId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + loanBorTxId);
...
em = null;
  ...
  public Slice<LoanBorTx> borxAcDateRange(int custNo_0, int facmNo_1, int facmNo_2, int bormNo_3, int bormNo_4, int acDate_5, int acDate_6, List<String> displayflag_7, int index, int limit, TitaVo... titaVo) {
    ...
    logger.info("borxAcDateRange " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " +  facmNo_1 + " facmNo_2 : " +  facmNo_2 + " bormNo_3 : " +  bormNo_3 + " bormNo_4 : " +  bormNo_4 + " acDate_5 : " +  acDate_5 + " acDate_6 : " +  acDate_6 + " displayflag_7 : " +  displayflag_7);
    if (dbName.equals(ContentName.onDay))
      slice = loanBorTxReposDay.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndAcDateGreaterThanEqualAndAcDateLessThanEqualAndDisplayflagInOrderByAcDateAscTitaTlrNoAscTitaTxtNoAscDisplayflagAscFacmNoAscBormNoAsc(custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, acDate_5, acDate_6, displayflag_7, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = loanBorTxReposMon.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndAcDateGreaterThanEqualAndAcDateLessThanEqualAndDisplayflagInOrderByAcDateAscTitaTlrNoAscTitaTxtNoAscDisplayflagAscFacmNoAscBormNoAsc(custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, acDate_5, acDate_6, displayflag_7, pageable);
    else if (dbName.equals(ContentName.onHist))
  ...
  public Slice<LoanBorTx> borxFacmNoEq(int custNo_0, int facmNo_1, int bormNo_2, int bormNo_3, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("borxFacmNoEq " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " +  facmNo_1 + " bormNo_2 : " +  bormNo_2 + " bormNo_3 : " +  bormNo_3);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<LoanBorTx> borxBormNoEq(int custNo_0, int facmNo_1, int bormNo_2, int borxNo_3, int borxNo_4, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("borxBormNoEq " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " +  facmNo_1 + " bormNo_2 : " +  bormNo_2 + " borxNo_3 : " +  borxNo_3 + " borxNo_4 : " +  borxNo_4);
    if (dbName.equals(ContentName.onDay))
  ...
  public LoanBorTx borxTxtNoFirst(int acDate_0, String titaTlrNo_1, String titaTxtNo_2, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("borxTxtNoFirst " + dbName + " : " + "acDate_0 : " + acDate_0 + " titaTlrNo_1 : " +  titaTlrNo_1 + " titaTxtNo_2 : " +  titaTxtNo_2);
  ...
  public Slice<LoanBorTx> borxEntryDateRange(int custNo_0, int facmNo_1, int facmNo_2, int bormNo_3, int bormNo_4, int entryDate_5, int entryDate_6, List<String> displayflag_7, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("borxEntryDateRange " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " +  facmNo_1 + " facmNo_2 : " +  facmNo_2 + " bormNo_3 : " +  bormNo_3 + " bormNo_4 : " +  bormNo_4 + " entryDate_5 : " +  entryDate_5 + " entryDate_6 : " +  entryDate_6 + " displayflag_7 : " +  displayflag_7);
    if (dbName.equals(ContentName.onDay))
      slice = loanBorTxReposDay.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndDisplayflagInOrderByAcDateAscTitaKinBrAscTitaTlrNoAscTitaTxtNoAsc(custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, entryDate_5, entryDate_6, displayflag_7, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = loanBorTxReposMon.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndEntryDateGreaterThanEqualAndEntryDateLessThanEqualAndDisplayflagInOrderByAcDateAscTitaKinBrAscTitaTlrNoAscTitaTxtNoAsc(custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, entryDate_5, entryDate_6, displayflag_7, pageable);
    else if (dbName.equals(ContentName.onHist))
  ...
  public LoanBorTx custNoTxtNoFirst(int custNo_0, int facmNo_1, int bormNo_2, int acDate_3, String titaTlrNo_4, String titaTxtNo_5, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("custNoTxtNoFirst " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " +  facmNo_1 + " bormNo_2 : " +  bormNo_2 + " acDate_3 : " +  acDate_3 + " titaTlrNo_4 : " +  titaTlrNo_4 + " titaTxtNo_5 : " +  titaTxtNo_5);
    Optional<LoanBorTx> loanBorTxT = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public LoanBorTx bormNoDescFirst(int custNo_0, int facmNo_1, int bormNo_2, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("bormNoDescFirst " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " +  facmNo_1 + " bormNo_2 : " +  bormNo_2);
    Optional<LoanBorTx> loanBorTxT = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<LoanBorTx> findByCustNoandFacmNo(int custNo_0, int facmNo_1, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("findByCustNoandFacmNo " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " +  facmNo_1);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<LoanBorTx> custNoTxtNoEq(int custNo_0, int acDate_1, String titaKinBr_2, String titaTlrNo_3, String titaTxtNo_4, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("custNoTxtNoEq " + dbName + " : " + "custNo_0 : " + custNo_0 + " acDate_1 : " +  acDate_1 + " titaKinBr_2 : " +  titaKinBr_2 + " titaTlrNo_3 : " +  titaTlrNo_3 + " titaTxtNo_4 : " +  titaTxtNo_4);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<LoanBorTx> findDueDateRange(int custNo_0, int facmNo_1, int facmNo_2, int bormNo_3, int bormNo_4, int dueDate_5, int dueDate_6, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("findDueDateRange " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " +  facmNo_1 + " facmNo_2 : " +  facmNo_2 + " bormNo_3 : " +  bormNo_3 + " bormNo_4 : " +  bormNo_4 + " dueDate_5 : " +  dueDate_5 + " dueDate_6 : " +  dueDate_6);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<LoanBorTx> findAcDateRange(int acDate_0, int acDate_1, List<String> titaHCode_2, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("findAcDateRange " + dbName + " : " + "acDate_0 : " + acDate_0 + " acDate_1 : " +  acDate_1 + " titaHCode_2 : " +  titaHCode_2);
    if (dbName.equals(ContentName.onDay))
  ...
  public LoanBorTx holdById(LoanBorTxId loanBorTxId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + loanBorTxId);
    Optional<LoanBorTx> loanBorTx = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public LoanBorTx holdById(LoanBorTx loanBorTx, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + loanBorTx.getLoanBorTxId());
    Optional<LoanBorTx> loanBorTxT = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public LoanBorTx insert(LoanBorTx loanBorTx, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + loanBorTx.getLoanBorTxId());
  ...
  public LoanBorTx update(LoanBorTx loanBorTx, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + loanBorTx.getLoanBorTxId());
    if (!empNot.isEmpty())
      loanBorTx.setLastUpdateEmpNo(empNot);
  ...
  public void delete(LoanBorTx loanBorTx, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + loanBorTx.getLoanBorTxId());
    if (dbName.equals(ContentName.onDay)) {
