...
@Table(name = "`JcicZ064`")
public class JcicZ064 implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 9193130489593094729L;

	@EmbeddedId
	private JcicZ064Id jcicZ064Id;
	...
	// 債權金融機構代號1
	@Column(name = "`Bank1`", length = 10)
	private String bank1;

	// 債權金融機構代號2
	@Column(name = "`Bank2`", length = 10)
	private String bank2;

	// 債權金融機構代號3
	@Column(name = "`Bank3`", length = 10)
	private String bank3;

	// 債權金融機構代號4
	@Column(name = "`Bank4`", length = 10)
	private String bank4;

	// 債權金融機構代號5
	@Column(name = "`Bank5`", length = 10)
	private String bank5;

	// 債權金融機構代號6
	@Column(name = "`Bank6`", length = 10)
	private String bank6;

	// 債權金融機構代號7
	@Column(name = "`Bank7`", length = 10)
	private String bank7;

	// 債權金融機構代號8
	@Column(name = "`Bank8`", length = 10)
	private String bank8;

	// 債權金融機構代號9
	@Column(name = "`Bank9`", length = 10)
	private String bank9;

	// 債權金融機構代號10
	@Column(name = "`Bank10`", length = 10)
	private String bank10;

	// 債權金融機構代號11
	@Column(name = "`Bank11`", length = 10)
	private String bank11;

	// 債權金融機構代號12
	@Column(name = "`Bank12`", length = 10)
	private String bank12;

	// 債權金融機構代號13
	@Column(name = "`Bank13`", length = 10)
	private String bank13;

	// 債權金融機構代號14
	@Column(name = "`Bank14`", length = 10)
	private String bank14;

	// 債權金融機構代號15
	@Column(name = "`Bank15`", length = 10)
	private String bank15;

	// 債權金融機構代號16
	@Column(name = "`Bank16`", length = 10)
	private String bank16;

	// 債權金融機構代號17
	@Column(name = "`Bank17`", length = 10)
	private String bank17;

	// 債權金融機構代號18
	@Column(name = "`Bank18`", length = 10)
	private String bank18;

	// 債權金融機構代號19
	@Column(name = "`Bank19`", length = 10)
	private String bank19;

	// 債權金融機構代號20
	@Column(name = "`Bank20`", length = 10)
	private String bank20;

	// 債權金融機構代號21
	@Column(name = "`Bank21`", length = 10)
	private String bank21;

	// 債權金融機構代號22
	@Column(name = "`Bank22`", length = 10)
	private String bank22;

	// 債權金融機構代號23
	@Column(name = "`Bank23`", length = 10)
	private String bank23;

	// 債權金融機構代號24
	@Column(name = "`Bank24`", length = 10)
	private String bank24;

	// 債權金融機構代號25
	@Column(name = "`Bank25`", length = 10)
	private String bank25;

	// 債權金融機構代號26
	@Column(name = "`Bank26`", length = 10)
	private String bank26;

	// 債權金融機構代號27
	@Column(name = "`Bank27`", length = 10)
	private String bank27;

	// 債權金融機構代號28
	@Column(name = "`Bank28`", length = 10)
	private String bank28;

	// 債權金融機構代號29
	@Column(name = "`Bank29`", length = 10)
	private String bank29;

	// 債權金融機構代號30
	@Column(name = "`Bank30`", length = 10)
	...
	public JcicZ064Id getJcicZ064Id() {
		return this.jcicZ064Id;
	}

	public void setJcicZ064Id(JcicZ064Id jcicZ064Id) {
		this.jcicZ064Id = jcicZ064Id;
	}
	...
	public String toString() {
		return "JcicZ064 [jcicZ064Id=" + jcicZ064Id + ", tranKey=" + tranKey + ", adjudicateDate=" + adjudicateDate + ", bankCount=" + bankCount + ", bank1=" + bank1 + ", bank2=" + bank2 + ", bank3="
				+ bank3 + ", bank4=" + bank4 + ", bank5=" + bank5 + ", bank6=" + bank6 + ", bank7=" + bank7 + ", bank8=" + bank8 + ", bank9=" + bank9 + ", bank10=" + bank10 + ", bank11=" + bank11
				+ ", bank12=" + bank12 + ", bank13=" + bank13 + ", bank14=" + bank14 + ", bank15=" + bank15 + ", bank16=" + bank16 + ", bank17=" + bank17 + ", bank18=" + bank18 + ", bank19=" + bank19
				+ ", bank20=" + bank20 + ", bank21=" + bank21 + ", bank22=" + bank22 + ", bank23=" + bank23 + ", bank24=" + bank24 + ", bank25=" + bank25 + ", bank26=" + bank26 + ", bank27=" + bank27
				+ ", bank28=" + bank28 + ", bank29=" + bank29 + ", bank30=" + bank30 + ", outJcicTxtDate=" + outJcicTxtDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
