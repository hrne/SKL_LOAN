 ...
 * @version 1.0.0
 */
public interface ClNoMapRepository extends JpaRepository<ClNoMap, ClNoMapId> {
	...
	public Slice<ClNoMap> findAllByMainGdrId1IsAndMainGdrId2IsAndMainGdrNumIsAndMainLgtSeqIsOrderByGdrId1AscGdrId2AscGdrNumAscLgtSeqAsc(int mainGdrId1_0, int mainGdrId2_1, int mainGdrNum_2,
			int mainLgtSeq_3, Pageable pageable);
