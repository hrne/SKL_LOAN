...
public class BankAuthActServiceImpl extends ASpringJpaParm implements BankAuthActService, InitializingBean {
	...
	public Slice<BankAuthAct> findAcctNo(int custNo_0, String repayAcct_1, String repayBank_2, int facmNo_3, int facmNo_4, int index, int limit, TitaVo... titaVo) {
		...
		if (limit == Integer.MAX_VALUE)
			...
			pageable = PageRequest.of(index, limit);
		this.info(
				"findAcctNo " + dbName + " : " + "custNo_0 : " + custNo_0 + " repayAcct_1 : " + repayAcct_1 + " repayBank_2 : " + repayBank_2 + " facmNo_3 : " + facmNo_3 + " facmNo_4 : " + facmNo_4);
		if (dbName.equals(ContentName.onDay))
			slice = bankAuthActReposDay.findAllByCustNoIsAndRepayAcctIsAndRepayBankIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByFacmNoAsc(custNo_0, repayAcct_1, repayBank_2, facmNo_3,
					facmNo_4, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = bankAuthActReposMon.findAllByCustNoIsAndRepayAcctIsAndRepayBankIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByFacmNoAsc(custNo_0, repayAcct_1, repayBank_2, facmNo_3,
					facmNo_4, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = bankAuthActReposHist.findAllByCustNoIsAndRepayAcctIsAndRepayBankIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByFacmNoAsc(custNo_0, repayAcct_1, repayBank_2, facmNo_3,
					facmNo_4, pageable);
		else
			slice = bankAuthActRepos.findAllByCustNoIsAndRepayAcctIsAndRepayBankIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualOrderByFacmNoAsc(custNo_0, repayAcct_1, repayBank_2, facmNo_3,
					facmNo_4, pageable);
	...
	public BankAuthAct insert(BankAuthAct bankAuthAct, TitaVo... titaVo) throws DBException {
		...
		if (this.findById(bankAuthAct.getBankAuthActId()) != null)
