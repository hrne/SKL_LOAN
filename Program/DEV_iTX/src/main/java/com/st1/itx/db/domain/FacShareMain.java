...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "FacShareMain [facShareMainId=" + facShareMainId + ", currencyCode=" + currencyCode + ", lineAmt=" + lineAmt + ", lineAmtCycle=" + lineAmtCycle + ", jcicMiainCustFlag=" + jcicMiainCustFlag
