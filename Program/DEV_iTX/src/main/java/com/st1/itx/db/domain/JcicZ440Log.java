...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicZ440Log [jcicZ440LogId=" + jcicZ440LogId + ", tranKey=" + tranKey + ", agreeDate=" + agreeDate + ", startDate=" + startDate + ", remindDate=" + remindDate
           + ", applyType=" + applyType + ", reportYn=" + reportYn + ", notBankId1=" + notBankId1 + ", notBankId2=" + notBankId2 + ", notBankId3=" + notBankId3 + ", notBankId4=" + notBankId4
           + ", notBankId5=" + notBankId5 + ", notBankId6=" + notBankId6 + ", outJcicTxtDate=" + outJcicTxtDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
