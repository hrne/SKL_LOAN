...
@Repository
public class LoanOverdueServiceImpl implements LoanOverdueService, InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(LoanOverdueServiceImpl.class);
	...
	public LoanOverdue findById(LoanOverdueId loanOverdueId, TitaVo... titaVo) {
		...
		logger.info("findById " + dbName + " " + loanOverdueId);
	...
	public Slice<LoanOverdue> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		Pageable pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "CustNo", "FacmNo", "BormNo", "OvduNo"));
	...
	@Override
	public Slice<LoanOverdue> ovduCustNoRange(int custNo_0, int facmNo_1, int facmNo_2, int bormNo_3, int bormNo_4, int ovduNo_5, int ovduNo_6, List<Integer> status_7, int index, int limit,
			TitaVo... titaVo) {
		String dbName = "";
		Slice<LoanOverdue> slice = null;
		if (titaVo.length != 0)
		...
		if (limit == Integer.MAX_VALUE)
			pageable = Pageable.unpaged();
		logger.info("ovduCustNoRange " + dbName + " : " + "custNo_0 : " + custNo_0 + " facmNo_1 : " + facmNo_1 + " facmNo_2 : " + facmNo_2 + " bormNo_3 : " + bormNo_3 + " bormNo_4 : " + bormNo_4
				+ " ovduNo_5 : " + ovduNo_5 + " ovduNo_6 : " + ovduNo_6 + " status_7 : " + status_7);
		if (dbName.equals(ContentName.onDay))
			slice = loanOverdueReposDay
					.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndOvduNoGreaterThanEqualAndOvduNoLessThanEqualAndStatusInOrderByAcDateAscFacmNoAscBormNoAsc(
							custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, ovduNo_5, ovduNo_6, status_7, pageable);
		else if (dbName.equals(ContentName.onMon))
			slice = loanOverdueReposMon
					.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndOvduNoGreaterThanEqualAndOvduNoLessThanEqualAndStatusInOrderByAcDateAscFacmNoAscBormNoAsc(
							custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, ovduNo_5, ovduNo_6, status_7, pageable);
		else if (dbName.equals(ContentName.onHist))
			slice = loanOverdueReposHist
					.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndOvduNoGreaterThanEqualAndOvduNoLessThanEqualAndStatusInOrderByAcDateAscFacmNoAscBormNoAsc(
							custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, ovduNo_5, ovduNo_6, status_7, pageable);
		else
			slice = loanOverdueRepos
					.findAllByCustNoIsAndFacmNoGreaterThanEqualAndFacmNoLessThanEqualAndBormNoGreaterThanEqualAndBormNoLessThanEqualAndOvduNoGreaterThanEqualAndOvduNoLessThanEqualAndStatusInOrderByAcDateAscFacmNoAscBormNoAsc(
							custNo_0, facmNo_1, facmNo_2, bormNo_3, bormNo_4, ovduNo_5, ovduNo_6, status_7, pageable);
	...
	public LoanOverdue holdById(LoanOverdueId loanOverdueId, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + loanOverdueId);
		Optional<LoanOverdue> loanOverdue = null;
		if (dbName.equals(ContentName.onDay))
	...
	public LoanOverdue holdById(LoanOverdue loanOverdue, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + loanOverdue.getLoanOverdueId());
	...
	public LoanOverdue insert(LoanOverdue loanOverdue, TitaVo... titaVo) throws DBException {
		...
		logger.info("Insert..." + dbName + " " + loanOverdue.getLoanOverdueId());
	...
	public LoanOverdue update(LoanOverdue loanOverdue, TitaVo... titaVo) throws DBException {
		...
		logger.info("Update..." + dbName + " " + loanOverdue.getLoanOverdueId());
		if (!empNot.isEmpty())
	...
	public void delete(LoanOverdue loanOverdue, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Delete..." + dbName + " " + loanOverdue.getLoanOverdueId());
		if (dbName.equals(ContentName.onDay)) {
