...
public class PostAuthLog implements Serializable {
	...
	// 狀況代號，授權狀態
	/*
	 * CdCode:AuthErrorCode空白:未授權('':再次授權)00:成功03:已終止代繳06:凍結警示戶07:支票專戶08:帳號錯誤09:
	 * 終止戶10:身分證不符11:轉出戶12:拒絕往來戶13:無此編號14:編號已存在16:管制帳戶17:掛失戶18:異常帳戶19:編號非英數91:
	 * 期限未扣款98:其他
	 */
	...
	/**
	 * 核印註記<br>
	 * CdCode:StampCode 1帳號不符 2戶名不符 3身分證號不符 4印鑑不符 9其他
	 * 
	 * @return String
	 */
	...
	/**
	 * 狀況代號，授權狀態<br>
	 * CdCode:AuthErrorCode 空白:未授權('':再次授權) 00:成功 03:已終止代繳 06:凍結警示戶 07:支票專戶 08:帳號錯誤
	...
	public String toString() {
		return "PostAuthLog [postAuthLogId=" + postAuthLogId + ", facmNo=" + facmNo + ", custId=" + custId + ", repayAcctSeq=" + repayAcctSeq + ", processDate=" + processDate + ", stampFinishDate="
				...
				+ relationId + ", relAcctBirthday=" + relAcctBirthday + ", relAcctGender=" + relAcctGender + ", amlRsp=" + amlRsp + ", titaTxCd=" + titaTxCd + ", createEmpNo=" + createEmpNo
