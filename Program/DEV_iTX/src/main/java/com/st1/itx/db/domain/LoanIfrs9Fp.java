...
@Table(name = "`LoanIfrs9Fp`")
public class LoanIfrs9Fp implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8795794710005830115L;

	@EmbeddedId
	private LoanIfrs9FpId loanIfrs9FpId;
	...
	public LoanIfrs9FpId getLoanIfrs9FpId() {
		return this.loanIfrs9FpId;
	}

	public void setLoanIfrs9FpId(LoanIfrs9FpId loanIfrs9FpId) {
		this.loanIfrs9FpId = loanIfrs9FpId;
	}
	...
	public String toString() {
		return "LoanIfrs9Fp [loanIfrs9FpId=" + loanIfrs9FpId + ", custId=" + custId + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
