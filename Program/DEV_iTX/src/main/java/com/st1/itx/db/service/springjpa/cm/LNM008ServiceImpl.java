...
public class LNM008ServiceImpl extends ASpringJpaParm implements InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(LNM008ServiceImpl.class);
...
//		boolean onLineMode = true;
		...
		logger.info("----------- LNM008.findAll ---------------");
		logger.info("-----LNM008 TitaVo=" + titaVo);
		logger.info("-----LNM008 Tita ENTDY=" + titaVo.getEntDy().substring(0, 6));
