...
em = null;
  ...
  public Slice<JobDetail> findAll(int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         pageable = PageRequest.of(0, Integer.MAX_VALUE, Sort.by(Sort.Direction.ASC, "ExecDate", "JobCode", "StepId"));
    else
         pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "ExecDate", "JobCode", "StepId"));
