...
@Service("cdClService")
@Repository
public class CdClServiceImpl implements CdClService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(CdClServiceImpl.class);
  ...
  public CdCl findById(CdClId cdClId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + cdClId);
...
em = null;
  ...
  public Slice<CdCl> clCode1Eq(int clCode1_0, int clCode1_1, int index, int limit, TitaVo... titaVo) {
    ...
    logger.info("clCode1Eq " + dbName + " : " + "clCode1_0 : " + clCode1_0 + " clCode1_1 : " +  clCode1_1);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<CdCl> clTypeJCICEq(String clTypeJCIC_0, String clTypeJCIC_1, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("clTypeJCICEq " + dbName + " : " + "clTypeJCIC_0 : " + clTypeJCIC_0 + " clTypeJCIC_1 : " +  clTypeJCIC_1);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<CdCl> clCode1Range(int clCode1_0, int clCode1_1, int clCode2_2, int clCode2_3, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("clCode1Range " + dbName + " : " + "clCode1_0 : " + clCode1_0 + " clCode1_1 : " +  clCode1_1 + " clCode2_2 : " +  clCode2_2 + " clCode2_3 : " +  clCode2_3);
    if (dbName.equals(ContentName.onDay))
      slice = cdClReposDay.findAllByClCode1GreaterThanEqualAndClCode1LessThanEqualAndClCode2GreaterThanEqualAndClCode2LessThanEqualOrderByClCode1AscClCode2Asc(clCode1_0, clCode1_1, clCode2_2, clCode2_3, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = cdClReposMon.findAllByClCode1GreaterThanEqualAndClCode1LessThanEqualAndClCode2GreaterThanEqualAndClCode2LessThanEqualOrderByClCode1AscClCode2Asc(clCode1_0, clCode1_1, clCode2_2, clCode2_3, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = cdClReposHist.findAllByClCode1GreaterThanEqualAndClCode1LessThanEqualAndClCode2GreaterThanEqualAndClCode2LessThanEqualOrderByClCode1AscClCode2Asc(clCode1_0, clCode1_1, clCode2_2, clCode2_3, pageable);
    else 
      slice = cdClRepos.findAllByClCode1GreaterThanEqualAndClCode1LessThanEqualAndClCode2GreaterThanEqualAndClCode2LessThanEqualOrderByClCode1AscClCode2Asc(clCode1_0, clCode1_1, clCode2_2, clCode2_3, pageable);
  ...
  public CdCl holdById(CdClId cdClId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + cdClId);
    Optional<CdCl> cdCl = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public CdCl holdById(CdCl cdCl, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + cdCl.getCdClId());
  ...
  public CdCl insert(CdCl cdCl, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + cdCl.getCdClId());
  ...
  public CdCl update(CdCl cdCl, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + cdCl.getCdClId());
    if (!empNot.isEmpty())
      cdCl.setLastUpdateEmpNo(empNot);
  ...
  public void delete(CdCl cdCl, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + cdCl.getCdClId());
    if (dbName.equals(ContentName.onDay)) {
