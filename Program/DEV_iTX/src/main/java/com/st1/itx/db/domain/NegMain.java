...
public class NegMain implements Serializable {
	...
	// 二階段註記
	/* YN若有N階段還款的情況,此區會存入大於0之自然數代表N:第N階段還款 */
	...
	/**
	 * 案件種類<br>
	 * 共用代碼檔(CdCode.CaseKindCode) 1:債協 2:調解 3:更生 4:清算
	 * 
	 * @return String
	 */
	...
	/**
	 * 債權戶況<br>
	 * 共用代碼檔(CdCode.NegStatus) 0:正常 1:已變更 2:毀諾 3:結案 4:未生效
	 * 
	 * @return String
	 */
	...
	/**
	 * 債權戶別<br>
	 * 共用代碼檔(CdCode.CustLoanKind) 1:放款戶 2:保貸戶 3:保證人
	 * 
	 * @return String
	 */
	...
	/**
	 * 二階段註記<br>
	 * Y N 若有N階段還款的情況,此區會存入大於0之自然數代表N:第N階段還款
	 * 
	 * @return String
	 */
	...
	public String toString() {
		return "NegMain [negMainId=" + negMainId + ", caseKindCode=" + caseKindCode + ", status=" + status + ", custLoanKind=" + custLoanKind + ", payerCustNo=" + payerCustNo + ", deferYMStart="
				+ deferYMStart + ", deferYMEnd=" + deferYMEnd + ", applDate=" + applDate + ", dueAmt=" + dueAmt + ", totalPeriod=" + totalPeriod + ", intRate=" + intRate + ", firstDueDate="
				+ firstDueDate + ", lastDueDate=" + lastDueDate + ", isMainFin=" + isMainFin + ", totalContrAmt=" + totalContrAmt + ", mainFinCode=" + mainFinCode + ", principalBal=" + principalBal
				+ ", accuTempAmt=" + accuTempAmt + ", accuOverAmt=" + accuOverAmt + ", accuDueAmt=" + accuDueAmt + ", accuSklShareAmt=" + accuSklShareAmt + ", repaidPeriod=" + repaidPeriod
				+ ", twoStepCode=" + twoStepCode + ", chgCondDate=" + chgCondDate + ", nextPayDate=" + nextPayDate + ", payIntDate=" + payIntDate + ", repayPrincipal=" + repayPrincipal
				+ ", repayInterest=" + repayInterest + ", statusDate=" + statusDate + ", courtCode=" + courtCode + ", thisAcDate=" + thisAcDate + ", thisTitaTlrNo=" + thisTitaTlrNo
				+ ", thisTitaTxtNo=" + thisTitaTxtNo + ", lastAcDate=" + lastAcDate + ", lastTitaTlrNo=" + lastTitaTlrNo + ", lastTitaTxtNo=" + lastTitaTxtNo + ", createDate=" + createDate
