...
public class NegAppr implements Serializable {
	...
	public String toString() {
		return "NegAppr [negApprId=" + negApprId + ", exportDate=" + exportDate + ", apprAcDate=" + apprAcDate + ", bringUpDate=" + bringUpDate + ", exportMark=" + exportMark + ", apprAcMark="
				+ apprAcMark + ", bringUpMark=" + bringUpMark + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo
				+ "]";
	}
}
