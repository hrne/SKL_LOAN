...
public class LoanOverdue implements Serializable {
	...
	/**
	 * 狀態<br>
	 * 1: 催收 2. 部分轉呆 3: 呆帳 4: 催收回復 5.催收收回
	 * 
	 * @return Integer
	 */
	...
	public String toString() {
		return "LoanOverdue [loanOverdueId=" + loanOverdueId + ", status=" + status + ", acctCode=" + acctCode + ", ovduDate=" + ovduDate + ", badDebtDate=" + badDebtDate + ", replyDate=" + replyDate
				+ ", ovduPrinAmt=" + ovduPrinAmt + ", ovduIntAmt=" + ovduIntAmt + ", ovduBreachAmt=" + ovduBreachAmt + ", ovduAmt=" + ovduAmt + ", ovduPrinBal=" + ovduPrinBal + ", ovduIntBal="
				+ ovduIntBal + ", ovduBreachBal=" + ovduBreachBal + ", ovduBal=" + ovduBal + ", reduceInt=" + reduceInt + ", reduceBreach=" + reduceBreach + ", badDebtAmt=" + badDebtAmt
				+ ", badDebtBal=" + badDebtBal + ", replyReduceAmt=" + replyReduceAmt + ", processDate=" + processDate + ", ovduSituaction=" + ovduSituaction + ", remark=" + remark + ", acDate="
				+ acDate + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo=" + lastUpdateEmpNo + "]";
	}
}
