...
public class LM074Report extends MakeReport {
	// private static final Logger logger = LoggerFactory.getLogger(LM074Report.class);
	...
	public boolean exec(TitaVo titaVo) throws LogicException {
		...
		try {
			lLM074 = lM074ServiceImpl.findAll(titaVo, Integer.toString(iAcDate).substring(0,6));
		} catch (Exception e) {
	...
	private void exportExcel(TitaVo titaVo, List<Map<String, String>> lList, int date) throws LogicException {
		...
		makeExcel.open(titaVo, titaVo.getEntDyI(), titaVo.getKinbr(), "LM074", "B040金融機構承作｢公司法人購置住宅貸款｣統計表",
				"LM074_B040金融機構承作｢公司法人購置住宅貸款｣統計表" + showRocDate(entdy, 0).substring(0, 7), "LM074_底稿_B040金融機構承作｢公司法人購置住宅貸款｣統計表.xlsx", 1, "FOA");
			...
			for (Map<String, String> tLDVo : lList) {
				...
				for (int i = 0; i < tLDVo.size(); i++) {
					...
					case 1:
						...
						//           07 - col 7~10 (+4)
						if (tmpValue.equals("06")) { colShift = 0; } 
