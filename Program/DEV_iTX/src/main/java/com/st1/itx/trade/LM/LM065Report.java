...
public class LM065Report extends MakeReport {
	// private static final Logger logger = LoggerFactory.getLogger(LM065Report.class);
	...
	public void exec(TitaVo titaVo) throws LogicException {
		...
		makeExcel.open(titaVo, titaVo.getEntDyI(), titaVo.getKinbr(), "LM065", "04-個金100萬以上小於2000萬-" + yymmRoc,
				"LM065_04-個金100萬以上小於2000萬-" + yymmRoc, "LM065_底稿_個金100萬以上小於2000萬.xls", "簡表");
		// 設定欄寬
