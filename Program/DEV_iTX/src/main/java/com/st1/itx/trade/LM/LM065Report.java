...
//		int iEntdy = Integer.valueOf(titaVo.get("ENTDY")) + 19110000;
		...
		makeExcel.open(titaVo, titaVo.getEntDyI(), titaVo.getKinbr(), "LM065", "04-個金100萬以上小於2000萬-" + iYearMonth, "LM065_04-個金100萬以上小於2000萬-" + iYearMonth, "LM065_底稿_個金100萬以上小於2000萬.xls", "簡表");
		// 設定欄寬
				...
				for (int col = 0; col < tLDVo.size(); col++) {
					...
					case 2:
						...
						if (!tempNo.equals(tLDVo.get(fdnm))) {
							...
							makeExcel.setValue(row, i, tLDVo.get(fdnm) == null || tLDVo.get(fdnm).length() == 0 ? 0 : Integer.valueOf(tLDVo.get(fdnm)), "R");
						} else {
					...
					case 6:
						// F欄 覆審單位
						makeExcel.setValue(row, i, tLDVo.get(fdnm) == null || tLDVo.get(fdnm).length() == 0 ? "(空白)" : tLDVo.get(fdnm).equals("") ? "(空白)" : " ", "C");
						break;
					...
					case 8:
						// H欄 撥款日期
						makeExcel.setValue(row, i, tLDVo.get(fdnm) == null || tLDVo.get(fdnm).length() == 0 ? 0 : Integer.parseInt(tLDVo.get(fdnm)) - 19110000, "C");
					...
					case 13:
						// M欄 評等
						makeExcel.setValue(row, i, tLDVo.get(fdnm) == null || tLDVo.get(fdnm).length() == 0 || tLDVo.get(fdnm) == "0" ? "" : tLDVo.get(fdnm).equals("0") ? "" : tLDVo.get(fdnm), "C");
						break;
					default:
