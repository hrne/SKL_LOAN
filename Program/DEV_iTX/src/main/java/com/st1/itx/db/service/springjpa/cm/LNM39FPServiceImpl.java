...
public class LNM39FPServiceImpl extends ASpringJpaParm implements InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(LNM39FPServiceImpl.class);
...
//		boolean onLineMode = true;
		...
		logger.info("----------- LNM39FP.findAll ---------------");
		logger.info("-----LNM39FP TitaVo=" + titaVo);
		logger.info("-----LNM39FP Tita ENTDY=" + titaVo.getEntDy().substring(0, 6));
