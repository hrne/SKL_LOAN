...
@Repository
public class CustRmkServiceImpl implements CustRmkService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(CustRmkServiceImpl.class);
  ...
  public CustRmk findById(CustRmkId custRmkId, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + custRmkId);
...
em = null;
  ...
  public Slice<CustRmk> findRmkCode(String rmkCode_0, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("findRmkCode " + dbName + " : " + "rmkCode_0 : " + rmkCode_0);
    if (dbName.equals(ContentName.onDay))
  ...
  public CustRmk maxRmkNoFirst(int custNo_0, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("maxRmkNoFirst " + dbName + " : " + "custNo_0 : " + custNo_0);
  ...
  public CustRmk holdById(CustRmkId custRmkId, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + custRmkId);
    Optional<CustRmk> custRmk = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public CustRmk holdById(CustRmk custRmk, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + custRmk.getCustRmkId());
    Optional<CustRmk> custRmkT = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public CustRmk insert(CustRmk custRmk, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + custRmk.getCustRmkId());
  ...
  public CustRmk update(CustRmk custRmk, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + custRmk.getCustRmkId());
    if (!empNot.isEmpty())
      custRmk.setLastUpdateEmpNo(empNot);
  ...
  public void delete(CustRmk custRmk, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + custRmk.getCustRmkId());
    if (dbName.equals(ContentName.onDay)) {
