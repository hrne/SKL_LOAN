...
public class MonthlyLM028 implements Serializable {
	...
	public String toString() {
		return "MonthlyLM028 [monthlyLM028Id=" + monthlyLM028Id + ", lMSSTS=" + lMSSTS + ", cUSENT=" + cUSENT + ", cUSBRH=" + cUSBRH + ", iRTRAT=" + iRTRAT + ", lMSISC=" + lMSISC + ", lMSPBK="
				+ lMSPBK + ", aPLMON=" + aPLMON + ", aPLDAY=" + aPLDAY + ", lMSLBL=" + lMSLBL + ", aILIRT=" + aILIRT + ", pOSCDE=" + pOSCDE + ", lMSPDY=" + lMSPDY + ", iRTFSC=" + iRTFSC + ", iRTBCD="
				+ iRTBCD + ", iRTRATYR1=" + iRTRATYR1 + ", iRTRATYR2=" + iRTRATYR2 + ", iRTRATYR3=" + iRTRATYR3 + ", iRTRATYR4=" + iRTRATYR4 + ", iRTRATYR5=" + iRTRATYR5 + ", gDRID1=" + gDRID1
				+ ", gDRID2=" + gDRID2 + ", yYYY=" + yYYY + ", mONTH=" + mONTH + ", dAY=" + dAY + ", w08CDE=" + w08CDE + ", rELATION=" + rELATION + ", dPTLVL=" + dPTLVL + ", aCTFSC=" + aCTFSC
				+ ", lIRTRATYR=" + lIRTRATYR + ", lIRTDAY=" + lIRTDAY + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate + ", lastUpdateEmpNo="
				+ lastUpdateEmpNo + "]";
	}
}
