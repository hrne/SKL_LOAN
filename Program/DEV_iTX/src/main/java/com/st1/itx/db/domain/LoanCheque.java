  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "LoanCheque [loanChequeId=" + loanChequeId + ", custNo=" + custNo + ", statusCode=" + statusCode + ", processCode=" + processCode + ", acDate=" + acDate
           ...
           + ", chequeAmt=" + chequeAmt + ", chequeName=" + chequeName + ", chequeDate=" + chequeDate + ", areaCode=" + areaCode + ", bankCode=" + bankCode + ", outsideCode=" + outsideCode
           + ", bktwFlag=" + bktwFlag + ", tsibFlag=" + tsibFlag + ", mediaFlag=" + mediaFlag + ", usageCode=" + usageCode + ", serviceCenter=" + serviceCenter + ", creditorId=" + creditorId
           + ", creditorBankCode=" + creditorBankCode + ", otherAcctCode=" + otherAcctCode + ", receiptNo=" + receiptNo + ", repaidAmt=" + repaidAmt + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
