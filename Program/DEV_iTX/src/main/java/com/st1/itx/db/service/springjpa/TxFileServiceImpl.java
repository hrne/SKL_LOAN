...
@Repository
public class TxFileServiceImpl implements TxFileService, InitializingBean {
  private static final Logger logger = LoggerFactory.getLogger(TxFileServiceImpl.class);
  ...
  public TxFile findById(Long fileNo, TitaVo... titaVo) {
    ...
    logger.info("findById " + dbName + " " + fileNo);
...
em = null;
  ...
  public Slice<TxFile> findByDate(int fileDate_0, String brNo_1, int index, int limit, TitaVo... titaVo) {
    ...
    logger.info("findByDate " + dbName + " : " + "fileDate_0 : " + fileDate_0 + " brNo_1 : " +  brNo_1);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<TxFile> findByLC009(int fileDate_0, int fileDate_1, String brNo_2, String createEmpNo_3, String fileCode_4, String fileItem_5, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("findByLC009 " + dbName + " : " + "fileDate_0 : " + fileDate_0 + " fileDate_1 : " +  fileDate_1 + " brNo_2 : " +  brNo_2 + " createEmpNo_3 : " +  createEmpNo_3 + " fileCode_4 : " +  fileCode_4 + " fileItem_5 : " +  fileItem_5);
    if (dbName.equals(ContentName.onDay))
      slice = txFileReposDay.findAllByFileDateGreaterThanEqualAndFileDateLessThanEqualAndBrNoIsAndCreateEmpNoLikeAndFileCodeLikeAndFileItemLikeOrderByCreateDateDesc(fileDate_0, fileDate_1, brNo_2, createEmpNo_3, fileCode_4, fileItem_5, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = txFileReposMon.findAllByFileDateGreaterThanEqualAndFileDateLessThanEqualAndBrNoIsAndCreateEmpNoLikeAndFileCodeLikeAndFileItemLikeOrderByCreateDateDesc(fileDate_0, fileDate_1, brNo_2, createEmpNo_3, fileCode_4, fileItem_5, pageable);
    else if (dbName.equals(ContentName.onHist))
      slice = txFileReposHist.findAllByFileDateGreaterThanEqualAndFileDateLessThanEqualAndBrNoIsAndCreateEmpNoLikeAndFileCodeLikeAndFileItemLikeOrderByCreateDateDesc(fileDate_0, fileDate_1, brNo_2, createEmpNo_3, fileCode_4, fileItem_5, pageable);
    else 
      slice = txFileRepos.findAllByFileDateGreaterThanEqualAndFileDateLessThanEqualAndBrNoIsAndCreateEmpNoLikeAndFileCodeLikeAndFileItemLikeOrderByCreateDateDesc(fileDate_0, fileDate_1, brNo_2, createEmpNo_3, fileCode_4, fileItem_5, pageable);

    return slice != null && !slice.isEmpty() ? slice : null;
  }

  @Override
  public Slice<TxFile> findByLC009WithCreateDate(int fileDate_0, int fileDate_1, String brNo_2, String createEmpNo_3, String fileCode_4, String fileItem_5, java.sql.Timestamp createDate_6, java.sql.Timestamp createDate_7, int index, int limit, TitaVo... titaVo) {
    String dbName = "";
    Slice<TxFile> slice = null;
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    logger.info("findByLC009WithCreateDate " + dbName + " : " + "fileDate_0 : " + fileDate_0 + " fileDate_1 : " +  fileDate_1 + " brNo_2 : " +  brNo_2 + " createEmpNo_3 : " +  createEmpNo_3 + " fileCode_4 : " +  fileCode_4 + " fileItem_5 : " +  fileItem_5 + " createDate_6 : " +  createDate_6 + " createDate_7 : " +  createDate_7);
    if (dbName.equals(ContentName.onDay))
      slice = txFileReposDay.findAllByFileDateGreaterThanEqualAndFileDateLessThanEqualAndBrNoIsAndCreateEmpNoLikeAndFileCodeLikeAndFileItemLikeAndCreateDateGreaterThanEqualAndCreateDateLessThanOrderByCreateDateDesc(fileDate_0, fileDate_1, brNo_2, createEmpNo_3, fileCode_4, fileItem_5, createDate_6, createDate_7, pageable);
    else if (dbName.equals(ContentName.onMon))
      slice = txFileReposMon.findAllByFileDateGreaterThanEqualAndFileDateLessThanEqualAndBrNoIsAndCreateEmpNoLikeAndFileCodeLikeAndFileItemLikeAndCreateDateGreaterThanEqualAndCreateDateLessThanOrderByCreateDateDesc(fileDate_0, fileDate_1, brNo_2, createEmpNo_3, fileCode_4, fileItem_5, createDate_6, createDate_7, pageable);
    else if (dbName.equals(ContentName.onHist))
      ...
      slice = txFileRepos.findAllByFileDateGreaterThanEqualAndFileDateLessThanEqualAndBrNoIsAndCreateEmpNoLikeAndFileCodeLikeAndFileItemLikeAndCreateDateGreaterThanEqualAndCreateDateLessThanOrderByCreateDateDesc(fileDate_0, fileDate_1, brNo_2, createEmpNo_3, fileCode_4, fileItem_5, createDate_6, createDate_7, pageable);
  ...
  public TxFile holdById(Long fileNo, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + fileNo);
    Optional<TxFile> txFile = null;
    if (dbName.equals(ContentName.onDay))
  ...
  public TxFile holdById(TxFile txFile, TitaVo... titaVo) {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Hold " + dbName + " " + txFile.getFileNo());
  ...
  public TxFile insert(TxFile txFile, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Insert..." + dbName + " " + txFile.getFileNo());
    if (this.findById(txFile.getFileNo()) != null)
  ...
  public TxFile update(TxFile txFile, TitaVo... titaVo) throws DBException {
    ...
    logger.info("Update..." + dbName + " " + txFile.getFileNo());
    if (!empNot.isEmpty())
      txFile.setLastUpdateEmpNo(empNot);
  ...
  public void delete(TxFile txFile, TitaVo... titaVo) throws DBException {
    ...
    if (titaVo.length != 0)
      dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
    logger.info("Delete..." + dbName + " " + txFile.getFileNo());
    if (dbName.equals(ContentName.onDay)) {
