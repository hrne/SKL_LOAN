...
em = null;
  ...
  public Slice<TxFile> findByLC009(int fileDate_0, int fileDate_1, String brNo_2, String createEmpNo_3, String fileCode_4, String fileItem_5, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("findByLC009 " + dbName + " : " + "fileDate_0 : " + fileDate_0 + " fileDate_1 : " +  fileDate_1 + " brNo_2 : " +  brNo_2 + " createEmpNo_3 : " +  createEmpNo_3 + " fileCode_4 : " +  fileCode_4 + " fileItem_5 : " +  fileItem_5);
    if (dbName.equals(ContentName.onDay))
  ...
  public Slice<TxFile> findByLC009WithCreateDate(int fileDate_0, int fileDate_1, String brNo_2, String createEmpNo_3, String fileCode_4, String fileItem_5, java.sql.Timestamp createDate_6, java.sql.Timestamp createDate_7, int index, int limit, TitaVo... titaVo) {
    ...
    if(limit == Integer.MAX_VALUE)
         ...
         pageable = PageRequest.of(index, limit);
    this.info("findByLC009WithCreateDate " + dbName + " : " + "fileDate_0 : " + fileDate_0 + " fileDate_1 : " +  fileDate_1 + " brNo_2 : " +  brNo_2 + " createEmpNo_3 : " +  createEmpNo_3 + " fileCode_4 : " +  fileCode_4 + " fileItem_5 : " +  fileItem_5 + " createDate_6 : " +  createDate_6 + " createDate_7 : " +  createDate_7);
    if (dbName.equals(ContentName.onDay))
