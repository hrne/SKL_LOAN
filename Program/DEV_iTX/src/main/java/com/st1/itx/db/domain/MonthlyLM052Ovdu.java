...
public class MonthlyLM052Ovdu implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8001803046554799991L;
	...
	public String toString() {
		return "MonthlyLM052Ovdu [monthlyLM052OvduId=" + monthlyLM052OvduId + ", loanBal=" + loanBal + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo + ", lastUpdate=" + lastUpdate
