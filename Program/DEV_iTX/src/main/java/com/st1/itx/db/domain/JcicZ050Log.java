...
public class JcicZ050Log implements Serializable {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -7367431049473559461L;
...
/**
  ...
  * @param lastUpdateEmpNo 最後更新人員
  ...
  public String toString() {
    return "JcicZ050Log [jcicZ050LogId=" + jcicZ050LogId + ", tranKey=" + tranKey + ", submitKey=" + submitKey + ", payAmt=" + payAmt + ", sumRepayActualAmt=" + sumRepayActualAmt
           + ", sumRepayShouldAmt=" + sumRepayShouldAmt + ", status=" + status + ", outJcicTxtDate=" + outJcicTxtDate + ", secondRepayYM=" + secondRepayYM + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
