...
public class LM082Report extends MakeReport {
	// private static final Logger logger = LoggerFactory.getLogger(LM082Report.class);
	...
	public boolean exec(TitaVo titaVo) throws LogicException {
		...
		try {
			lLM082 = lM082ServiceImpl.findAll(titaVo, Integer.toString(iAcDate).substring(0,6));
		} catch (Exception e) {
			...
			for (Map<String, String> tLDVo : lList) {
				...
				for (int i = 0; i < tLDVo.size(); i++) {
					...
					case 1:
						...
						else if (tmpValue.equals("02") || tmpValue.equals("04")) { colShift = 4; } 
						else 
						{ 
							this.info("LM082Report exportExcel: RuleCodeException, got " + tmpValue);
							break; 
						};
