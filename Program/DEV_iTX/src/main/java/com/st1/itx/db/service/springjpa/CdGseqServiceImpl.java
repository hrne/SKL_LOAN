...
@Repository
public class CdGseqServiceImpl implements CdGseqService, InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(CdGseqServiceImpl.class);
	...
	public CdGseq findById(CdGseqId cdGseqId, TitaVo... titaVo) {
		...
		logger.info("findById " + dbName + " " + cdGseqId);
	...
	public Slice<CdGseq> findAll(int index, int limit, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		Pageable pageable = PageRequest.of(index, limit, Sort.by(Sort.Direction.ASC, "GseqDate", "GseqCode", "GseqType", "GseqKind"));
	...
	public CdGseq holdById(CdGseqId cdGseqId, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + cdGseqId);
		Optional<CdGseq> cdGseq = null;
		if (dbName.equals(ContentName.onDay))
	...
	public CdGseq holdById(CdGseq cdGseq, TitaVo... titaVo) {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Hold " + dbName + " " + cdGseq.getCdGseqId());
	...
	public CdGseq insert(CdGseq cdGseq, TitaVo... titaVo) throws DBException {
		...
		logger.info("Insert..." + dbName + " " + cdGseq.getCdGseqId());
		if (this.findById(cdGseq.getCdGseqId()) != null)
	...
	public CdGseq update(CdGseq cdGseq, TitaVo... titaVo) throws DBException {
		...
		logger.info("Update..." + dbName + " " + cdGseq.getCdGseqId());
		if (!empNot.isEmpty())
	...
	public void delete(CdGseq cdGseq, TitaVo... titaVo) throws DBException {
		...
		if (titaVo.length != 0)
			dbName = titaVo[0].getDataBase() != null ? titaVo[0].getDataBase() : ContentName.onLine;
		logger.info("Delete..." + dbName + " " + cdGseq.getCdGseqId());
		if (dbName.equals(ContentName.onDay)) {
