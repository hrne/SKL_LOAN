...
public class EmpDeductMedia implements Serializable {
	...
	public String toString() {
		return "EmpDeductMedia [empDeductMediaId=" + empDeductMediaId + ", custNo=" + custNo + ", repayCode=" + repayCode + ", perfRepayCode=" + perfRepayCode + ", repayAmt=" + repayAmt
				+ ", perfMonth=" + perfMonth + ", flowCode=" + flowCode + ", unitCode=" + unitCode + ", custId=" + custId + ", entryDate=" + entryDate + ", txAmt=" + txAmt + ", errorCode=" + errorCode
				+ ", acctCode=" + acctCode + ", acDate=" + acDate + ", batchNo=" + batchNo + ", detailSeq=" + detailSeq + ", createDate=" + createDate + ", createEmpNo=" + createEmpNo
