...
@Service
@Repository
public class LM079ServiceImpl extends ASpringJpaParm implements InitializingBean {
	private static final Logger logger = LoggerFactory.getLogger(LM079ServiceImpl.class);
	...
	public List<Map<String, String>> findAll(TitaVo titaVo, String RptMonth) throws Exception {
		logger.info("LM079.findAll ");
		logger.info("LM079ServiceImpl RptMonth: " + RptMonth);
